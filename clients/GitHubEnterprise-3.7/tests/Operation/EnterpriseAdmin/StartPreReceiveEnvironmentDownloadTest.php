...
final class StartPreReceiveEnvironmentDownloadTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function httpCode_202_responseContentType_application_json()
    {
        ...
        $client->call(\ApiClients\Client\GitHubEnterprise\Operation\EnterpriseAdmin\StartPreReceiveEnvironmentDownload::OPERATION_MATCH, (static function (array $data) : array {
