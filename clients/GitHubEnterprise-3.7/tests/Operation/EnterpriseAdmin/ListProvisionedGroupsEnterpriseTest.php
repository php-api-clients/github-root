...
use ApiClients\Client\GitHubEnterprise\Operation\EnterpriseAdmin\ListProvisionedGroupsEnterprise;
...
final class ListProvisionedGroupsEnterpriseTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_scim_json(): void
    {
        ...
        $browser->request('GET', '/scim/v2/Groups?filter=generated_null&excludedAttributes=generated_null&startIndex=13&count=13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(ListProvisionedGroupsEnterprise::OPERATION_MATCH, (static function (array $data): array {
