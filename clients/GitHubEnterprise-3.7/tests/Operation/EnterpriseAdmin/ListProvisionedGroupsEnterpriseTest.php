...
final class ListProvisionedGroupsEnterpriseTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_scim_json()
    {
        ...
        $browser->request('GET', '/scim/v2/Groups?filter=generated_null&excludedAttributes=generated_null&startIndex=13&count=13', \Prophecy\Argument::type('array'), \Prophecy\Argument::any())->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterprise\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterprise\Operation\EnterpriseAdmin\ListProvisionedGroupsEnterprise::OPERATION_MATCH, (static function (array $data) : array {
