...
use ApiClients\Client\GitHubEnterprise\Operation\EnterpriseAdmin\GetAllAuthorizedSshKeys;
...
final class GetAllAuthorizedSshKeysTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $client->call(GetAllAuthorizedSshKeys::OPERATION_MATCH, (static function (array $data): array {
            return $data;
        })([]));
    }
}
