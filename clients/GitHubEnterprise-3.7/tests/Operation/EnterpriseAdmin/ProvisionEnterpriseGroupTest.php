...
use ApiClients\Client\GitHubEnterprise\Operation\EnterpriseAdmin\ProvisionEnterpriseGroup;
...
final class ProvisionEnterpriseGroupTest extends AsyncTestCase
{
    ...
    {
        $response = new Response(201, ['Content-Type' => 'application/scim+json'], Schema\ScimEnterpriseGroupResponse::SCHEMA_EXAMPLE_DATA);
        ...
        $client->call(ProvisionEnterpriseGroup::OPERATION_MATCH, (static function (array $data): array {
            return $data;
