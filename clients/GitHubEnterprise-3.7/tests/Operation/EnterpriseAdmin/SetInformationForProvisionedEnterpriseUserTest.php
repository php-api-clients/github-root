...
final class SetInformationForProvisionedEnterpriseUserTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function t200te721a100ec95fd3067a83a0920ca7a5e()
    {
        ...
        $browser->request('PUT', '/scim/v2/Users/generated_null', \Prophecy\Argument::type('array'), Schema\User::SCHEMA_EXAMPLE_DATA)->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterprise\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterprise\Operation\EnterpriseAdmin\SetInformationForProvisionedEnterpriseUser::OPERATION_MATCH, (static function (array $data) : array {
