...
final class ReRunJobForWorkflowRunTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function t201td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('POST', '/repos/generated_null/generated_null/actions/jobs/13/rerun', \Prophecy\Argument::type('array'), Schema\Actions\ReRunJobForWorkflowRun\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterprise\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterprise\Operation\Actions\ReRunJobForWorkflowRun::OPERATION_MATCH, (static function (array $data) : array {
