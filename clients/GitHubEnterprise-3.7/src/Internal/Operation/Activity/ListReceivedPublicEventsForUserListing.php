...
final class ListReceivedPublicEventsForUserListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Users\Username\ReceivedEvents\Public_ $hydrator, string $username, int $perPage = 30, int $page = 1)
    {
