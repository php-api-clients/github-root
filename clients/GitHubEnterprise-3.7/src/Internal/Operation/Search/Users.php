...
final class Users
{
    ...
    private string $q;
    /**Sorts the results of your query by number of `followers` or `repositories`, or when the person `joined` GitHub Enterprise Server. Default: [best match](https://docs.github.com/enterprise-server@3.7/rest/search/search#ranking-search-results) **/
    private string $sort;
