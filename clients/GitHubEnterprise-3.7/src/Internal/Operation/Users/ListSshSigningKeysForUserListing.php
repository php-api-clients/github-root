...
final class ListSshSigningKeysForUserListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Users\Username\SshSigningKeys $hydrator, string $username, int $perPage = 30, int $page = 1)
    {
