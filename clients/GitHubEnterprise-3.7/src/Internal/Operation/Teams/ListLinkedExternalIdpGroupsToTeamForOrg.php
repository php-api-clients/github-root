...
final class ListLinkedExternalIdpGroupsToTeamForOrg
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Orgs\Org\Teams\TeamSlug\ExternalGroups $hydrator, string $org, string $teamSlug)
    {
        $this->org      = $org;
    ...
    {
        return new Request('GET', str_replace(['{org}', '{team_slug}'], [$this->org, $this->teamSlug], '/orgs/{org}/teams/{team_slug}/external-groups'));
    }
