...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Projects\ProjectId;
...
class Columns implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️ProjectColumn(array $payload): ProjectColumn
    {
        $properties    = [];
        $missingFields = [];
        try {
