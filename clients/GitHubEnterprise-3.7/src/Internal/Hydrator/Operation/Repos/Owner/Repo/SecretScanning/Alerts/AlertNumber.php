...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Repos\Owner\Repo\SecretScanning\Alerts;
...
class AlertNumber implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️SecretScanningAlert(array $payload): SecretScanningAlert
    {
        $properties    = [];
        $missingFields = [];
        try {
