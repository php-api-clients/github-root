...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Repos\Owner\Repo\Git\Blobs;
...
class FileSha implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Blob(array $payload): Blob
    {
        $properties    = [];
        $missingFields = [];
        try {
