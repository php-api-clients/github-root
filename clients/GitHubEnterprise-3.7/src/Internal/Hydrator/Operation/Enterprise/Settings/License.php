...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Enterprise\Settings;
...
class License implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️LicenseInfo(array $payload): LicenseInfo
    {
        $properties    = [];
        $missingFields = [];
        try {
