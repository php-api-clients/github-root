...
use ApiClients\Client\GitHubEnterprise\Schema\WebhookInstallationCreated\Requester;
...
class Installation implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookInstallationCreated⚡️Requester(array $payload): Requester
    {
        $properties    = [];
        $missingFields = [];
        try {
