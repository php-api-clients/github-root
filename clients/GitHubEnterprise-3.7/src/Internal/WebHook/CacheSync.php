...
/** @internal */
final class CacheSync implements WebHookInterface
{
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly Internal\Hydrator\WebHook\CacheSync $hydrator)
    {
    }
    ...
    public function resolve(array $headers, array $data): Schema\WebhookCacheSync
    {
        ...
        if ($headers['content-type'] === 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($data, Reader::readFromJson(Schema\WebhookCacheSync::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
