...
final readonly class ListPublicEventsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Activity\ListPublicEventsListing($this->responseSchemaValidator, $this->hydrator, $perPage, $page);
