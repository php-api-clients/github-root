...
final readonly class AddSelfHostedRunnerToGroupForEnterprise
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\EnterpriseAdmin\AddSelfHostedRunnerToGroupForEnterprise($enterprise, $runnerGroupId, $runnerId);
