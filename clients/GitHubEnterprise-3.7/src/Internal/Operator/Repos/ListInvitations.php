...
final readonly class ListInvitations
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Repos\ListInvitations($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
