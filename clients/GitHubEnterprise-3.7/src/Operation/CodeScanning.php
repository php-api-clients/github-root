...
final class CodeScanning
{
    ...
    public function listAlertsForEnterprise(string $enterprise, string $toolName, string|null $toolGuid, string $before, string $after, string $state, int $page, int $perPage, string $direction, string $sort): Schema\CodeScanningOrganizationAlertItems
    {
    ...
    public function listAlertsForEnterpriseListing(string $enterprise, string $toolName, string|null $toolGuid, string $before, string $after, string $state, int $page, int $perPage, string $direction, string $sort): Schema\CodeScanningOrganizationAlertItems
    {
        if (array_key_exists(Operator\CodeScanning\ListAlertsForEnterpriseListing::class, $this->operator) === false) {
            $this->operator[Operator\CodeScanning\ListAlertsForEnterpriseListing::class] = new Operator\CodeScanning\ListAlertsForEnterpriseListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀CodeScanning🌀Alerts());
        }

        return $this->operator[Operator\CodeScanning\ListAlertsForEnterpriseListing::class]->call($enterprise, $toolName, $toolGuid, $before, $after, $state, $page, $perPage, $direction, $sort);
    }

    public function listAlertsForOrg(string $org, string $toolName, string|null $toolGuid, string $before, string $after, string $state, int $page, int $perPage, string $direction, string $sort): Schema\CodeScanningOrganizationAlertItems
    {
    ...
    public function listAlertsForOrgListing(string $org, string $toolName, string|null $toolGuid, string $before, string $after, string $state, int $page, int $perPage, string $direction, string $sort): Schema\CodeScanningOrganizationAlertItems
    {
        ...
        return $this->operator[Operator\CodeScanning\ListAlertsForOrgListing::class]->call($org, $toolName, $toolGuid, $before, $after, $state, $page, $perPage, $direction, $sort);
    }
