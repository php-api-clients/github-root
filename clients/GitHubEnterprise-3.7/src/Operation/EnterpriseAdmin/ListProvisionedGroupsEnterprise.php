...
final class ListProvisionedGroupsEnterprise
{
    ...
    /**
     * @return Schema\ScimEnterpriseGroupList|Schema\ScimError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\ScimEnterpriseGroupList|Schema\ScimError
    {
            ...
            case 200:
                switch ($contentType) {
                    case 'application/scim+json':
                        ...
                        return $this->hydrator->hydrateObject('Schema\\ScimEnterpriseGroupList', $body);
                }
                break;
            /**Internal server error**/
            case 400:
