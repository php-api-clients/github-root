...
final class ProvisionEnterpriseUser
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $requestSchemaValidator, \League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Scim\V2\Users $hydrator)
    {
    ...
    /**
     * @return Schema\ScimEnterpriseUserResponse|Schema\ScimError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\ScimEnterpriseUserResponse|Schema\ScimError
    {
