...
final class ListPreReceiveHooksForRepoListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Repos\Owner\Repo\PreReceiveHooks $hydrator, string $owner, string $repo, int $perPage = 30, int $page = 1, string $direction = 'desc', private string $sort = 'created')
    {
        $this->owner     = $owner;
        $this->repo      = $repo;
