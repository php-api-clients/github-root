...
final class GetOrCreateAuthorizationForApp
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $requestSchemaValidator, \League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Authorizations\Clients\CbClientIdRcb $hydrator, string $client_id)
    {
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(Schema\OauthAuthorizations\GetOrCreateAuthorizationForApp\Request\Applicationjson::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));
