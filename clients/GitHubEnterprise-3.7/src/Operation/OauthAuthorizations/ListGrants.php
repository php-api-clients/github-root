...
final class ListGrants
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Applications\Grants $hydrator, string $clientId, int $perPage = 30, int $page = 1)
    {
