...
final class GetActionsCacheUsageForOrg
{
    ...
    private readonly Hydrator\Operation\Orgs\Org\Actions\Cache\Usage $hydrator;

    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Orgs\Org\Actions\Cache\Usage $hydrator, string $org)
    {
        $this->org                     = $org;
