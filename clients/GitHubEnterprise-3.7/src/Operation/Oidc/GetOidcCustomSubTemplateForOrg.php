...
namespace ApiClients\Client\GitHubEnterprise\Operation\Oidc;
...
final class GetOidcCustomSubTemplateForOrg
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Orgs\CbOrgRcb\Actions\Oidc\Customization\Sub $hydrator, string $org)
    {
        $this->org                     = $org;
        ...
        switch ($contentType) {
            case 'application/json':
                ...
                switch ($code) {
                    ...
                    **/
                    case 200:
                        $this->responseSchemaValidator->validate($body, Reader::readFromJson(Schema\OidcCustomSub::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
