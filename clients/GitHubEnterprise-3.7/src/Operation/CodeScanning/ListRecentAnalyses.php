...
final class ListRecentAnalyses
{
    ...
    /**
     * @return \Rx\Observable<Schema\CodeScanningAnalysis>|Schema\BasicError|Schema\Operation\CodeScanning\ListAlertsForEnterprise\Response\Applicationjson\H503
     */
