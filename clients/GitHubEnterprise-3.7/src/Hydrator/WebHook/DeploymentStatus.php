...
class DeploymentStatus implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated($payload),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Workflow' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Workflow($payload),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️PullRequests($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Base' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️PullRequests⚡️Base($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Base\Repo' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️PullRequests⚡️Base⚡️Repo($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Head' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️PullRequests⚡️Head($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Head\Repo' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️PullRequests⚡️Head⚡️Repo($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\ReferencedWorkflows' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️ReferencedWorkflows($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Workflow($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️CheckRun(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\CheckRun
    {
        $properties = []; 
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\CheckRun::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\CheckRun(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\CheckRun', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment
    {
        $properties = []; 
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️Creator(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\Creator
    {
        $properties = []; 
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\Creator::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\Creator(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\Creator', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️PerformedViaGithubApp(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp
    {
        $properties = []; 
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️PerformedViaGithubApp⚡️Owner(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp\Owner
    {
        $properties = []; 
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp\Owner::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp\Owner(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp\Owner', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️PerformedViaGithubApp⚡️Permissions(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp\Permissions
    {
        $properties = []; 
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp\Permissions::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp\Permissions(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp\Permissions', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Workflow(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Workflow
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Workflow', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Workflow::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Workflow(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Workflow', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun
    {
        $properties = []; 
        $missingFields = [];
        try {
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookDeploymentStatusCreated\\WorkflowRun\\PullRequests',
));
            }
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookDeploymentStatusCreated\\WorkflowRun\\ReferencedWorkflows',
));
            }
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️Actor(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\Actor
    {
        $properties = []; 
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\Actor::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\Actor(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\Actor', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️HeadRepository(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\HeadRepository
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'owner';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️HeadRepository⚡️Owner($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\HeadRepository::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\HeadRepository(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\HeadRepository', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️PullRequests(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️PullRequests⚡️Base($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️PullRequests⚡️Head($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️PullRequests⚡️Base(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Base
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️PullRequests⚡️Base⚡️Repo($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Base', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Base::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Base(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Base', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️PullRequests⚡️Base⚡️Repo(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Base\Repo
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Base\Repo', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Base\Repo::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Base\Repo(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Base\Repo', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️PullRequests⚡️Head(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Head
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'repo';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️PullRequests⚡️Head⚡️Repo($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Head', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Head::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Head(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Head', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️PullRequests⚡️Head⚡️Repo(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Head\Repo
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Head\Repo', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Head\Repo::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Head\Repo(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Head\Repo', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️ReferencedWorkflows(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\ReferencedWorkflows
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\ReferencedWorkflows', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\ReferencedWorkflows::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\ReferencedWorkflows(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\ReferencedWorkflows', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️Repository(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\Repository
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'owner';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️Repository⚡️Owner($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\Repository::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\Repository(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\Repository', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️TriggeringActor(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\TriggeringActor
    {
        $properties = []; 
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\TriggeringActor::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\TriggeringActor(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\TriggeringActor', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            ...
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Workflow' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Workflow($object),
            ...
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️PullRequests($object),
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Base' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️PullRequests⚡️Base($object),
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Base\Repo' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️PullRequests⚡️Base⚡️Repo($object),
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Head' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️PullRequests⚡️Head($object),
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Head\Repo' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️PullRequests⚡️Head⚡️Repo($object),
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\ReferencedWorkflows' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️ReferencedWorkflows($object),
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated);
        $result = [];
        ...
        $workflow = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Workflow($workflow);
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\CheckRun);
        $result = [];
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment);
        $result = [];
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\Creator);
        $result = [];
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp);
        $result = [];
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp\Owner);
        $result = [];
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp\Permissions);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Workflow(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Workflow);
        $result = [];
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun);
        $result = [];
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookDeploymentStatusCreated\\WorkflowRun\\ReferencedWorkflows',
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\Actor);
        $result = [];
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\HeadRepository);
        $result = [];
        ...
        $owner = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️HeadRepository⚡️Owner($owner);
        after_owner:        $result['owner'] = $owner;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️PullRequests(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests);
        $result = [];

        $base = $object->base;
        $base = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️PullRequests⚡️Base($base);
        after_base:        $result['base'] = $base;

        
        $head = $object->head;
        $head = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️PullRequests⚡️Head($head);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️PullRequests⚡️Base(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Base);
        $result = [];
        ...
        $repo = $object->repo;
        $repo = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️PullRequests⚡️Base⚡️Repo($repo);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️PullRequests⚡️Base⚡️Repo(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Base\Repo);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️PullRequests⚡️Head(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Head);
        $result = [];
        ...
        $repo = $object->repo;
        $repo = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️PullRequests⚡️Head⚡️Repo($repo);
        after_repo:        $result['repo'] = $repo;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️PullRequests⚡️Head⚡️Repo(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\PullRequests\Head\Repo);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️ReferencedWorkflows(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\ReferencedWorkflows);
        $result = [];
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\Repository);
        $result = [];
        ...
        $owner = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️Repository⚡️Owner($owner);
        after_owner:        $result['owner'] = $owner;
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\TriggeringActor);
        $result = [];
