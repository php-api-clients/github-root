...
class Status implements ObjectMapper
{
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookStatus\\Branches',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookStatus⚡️Commit(mixed $object): mixed
    {
        ...
        $committer = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookStatus⚡️Commit⚡️Author($committer);
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookStatus\\Commit\\Parents',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookStatus⚡️Commit⚡️Commit(mixed $object): mixed
    {
        ...
        $committer = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookStatus⚡️Commit⚡️Commit⚡️Author($committer);
        after_committer:        $result['committer'] = $committer;
