...
class IssueComment implements ObjectMapper
{
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookDiscussionLabeled\\Label',
        ...
        $performed_via_github_app = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookIssueCommentCreated⚡️Issue⚡️PerformedViaGithubApp($performed_via_github_app);
        after_performed_via_github_app:        $result['performed_via_github_app'] = $performed_via_github_app;

        
        $pull_request = $object->pull_request;
        $pull_request = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookIssueCommentCreated⚡️Issue⚡️PullRequest($pull_request);
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookDiscussionLabeled\\Label',
        ...
        $performed_via_github_app = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookIssueCommentDeleted⚡️Issue⚡️PerformedViaGithubApp($performed_via_github_app);
        after_performed_via_github_app:        $result['performed_via_github_app'] = $performed_via_github_app;
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookDiscussionLabeled\\Label',
        ...
        $performed_via_github_app = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookIssueCommentEdited⚡️Issue⚡️PerformedViaGithubApp($performed_via_github_app);
        after_performed_via_github_app:        $result['performed_via_github_app'] = $performed_via_github_app;
