...
class Team implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookLabelEdited⚡️Changes⚡️Name(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookLabelEdited\Changes\Name
        {
            $properties = []; 
            $missingFields = [];
            try {
            ...
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookLabelEdited\Changes\Name::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookLabelEdited\Changes\Name(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookLabelEdited\Changes\Name', $exception, stack: $this->hydrationStack);
            }
        }
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookTeamAddedToRepository(mixed $object): mixed
    {
        ...
        $repository = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookIssuesOpened⚡️Changes⚡️OldRepository($repository);
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookLabelEdited\Changes\Name);
        $result = [];
