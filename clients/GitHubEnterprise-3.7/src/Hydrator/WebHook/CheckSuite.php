...
class CheckSuite implements ObjectMapper
{
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookCheckSuiteCompleted\\CheckSuite\\PullRequests',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookCheckSuiteCompleted(mixed $object): mixed
    {
        ...
        $check_suite = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookCheckSuiteCompleted⚡️CheckSuite($check_suite);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookCheckSuiteCompleted⚡️CheckSuite(mixed $object): mixed
    {
        ...
        $head_commit = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookCheckSuiteCompleted⚡️CheckSuite⚡️HeadCommit($head_commit);
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookCheckSuiteCompleted\\CheckSuite\\PullRequests',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookCheckSuiteCompleted⚡️CheckSuite⚡️PullRequests(mixed $object): mixed
    {
        ...
        $head = $object->head;
        $head = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookCheckSuiteCompleted⚡️CheckSuite⚡️PullRequests⚡️Base($head);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookCheckSuiteRequested(mixed $object): mixed
    {
        ...
        $check_suite = $object->check_suite;
        $check_suite = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookCheckSuiteRequested⚡️CheckSuite($check_suite);
        after_check_suite:        $result['check_suite'] = $check_suite;
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookCheckSuiteCompleted\\CheckSuite\\PullRequests',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookCheckSuiteRerequested(mixed $object): mixed
    {
        ...
        $actions_meta = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookCheckSuiteRerequested⚡️ActionsMeta($actions_meta);
        after_actions_meta:        $result['actions_meta'] = $actions_meta;

        
        $check_suite = $object->check_suite;
        $check_suite = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookCheckSuiteRerequested⚡️CheckSuite($check_suite);
        after_check_suite:        $result['check_suite'] = $check_suite;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookCheckSuiteRerequested⚡️ActionsMeta(mixed $object): mixed
    {
        ...
        $rerun_info = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookCheckSuiteRerequested⚡️ActionsMeta⚡️RerunInfo($rerun_info);
