...
class PullRequestReviewComment implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\Comment' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️Comment($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\Comment\Links' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️Comment⚡️Links($payload),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\PullRequest' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️PullRequest($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Links' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Links($payload),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Base' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Base($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Base\Repo' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Base⚡️Repo($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookFork\Forkee\License' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookFork⚡️Forkee⚡️License($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookFork\Forkee\Permissions' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookFork⚡️Forkee⚡️Permissions($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Head' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️PullRequest⚡️Head($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Head\Repo' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️PullRequest⚡️Head⚡️Repo($payload),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipAdded\Team' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipAdded⚡️Team($payload),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentDeleted' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentDeleted($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentDeleted\Comment' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentDeleted⚡️Comment($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentDeleted\PullRequest' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentDeleted⚡️PullRequest($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentDeleted\PullRequest\Head' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentDeleted⚡️PullRequest⚡️Head($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Head\Repo' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Head⚡️Repo($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookIssuesDeleted\Issue\Milestone' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookIssuesDeleted⚡️Issue⚡️Milestone($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentEdited' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentEdited($payload),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentEdited\PullRequest' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentEdited⚡️PullRequest($payload),
            default => throw UnableToHydrateObject::noHydrationDefined($className, $this->hydrationStack),
        };
    }
    
            
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️Comment($value);
                } finally {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️PullRequest($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️Comment(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\Comment
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️Comment⚡️Links($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\Comment', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\Comment::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\Comment(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\Comment', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️Comment⚡️Links(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\Comment\Links
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\Comment\Links', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\Comment\Links::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\Comment\Links(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\Comment\Links', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️PullRequest(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\PullRequest
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = '_links';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Links($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookIssueCommentCreated\\Issue\\Assignee',
));
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️AutoMerge($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Base($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️PullRequest⚡️Head($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookMembershipAdded\\Team',
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\PullRequest', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\PullRequest::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\PullRequest(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\PullRequest', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Links(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Links
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Links', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Links::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Links(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Links', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️AutoMerge(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\AutoMerge
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\AutoMerge', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\AutoMerge::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\AutoMerge(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\AutoMerge', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Base(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Base
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Base⚡️Repo($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Base', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Base::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Base(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Base', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Base⚡️Repo(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Base\Repo
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookFork⚡️Forkee⚡️License($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookFork⚡️Forkee⚡️Permissions($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Base\Repo', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Base\Repo::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Base\Repo(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Base\Repo', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookFork⚡️Forkee⚡️License(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookFork\Forkee\License
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookFork\Forkee\License', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookFork\Forkee\License::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookFork\Forkee\License(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookFork\Forkee\License', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookFork⚡️Forkee⚡️Permissions(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookFork\Forkee\Permissions
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookFork\Forkee\Permissions', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookFork\Forkee\Permissions::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookFork\Forkee\Permissions(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookFork\Forkee\Permissions', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️PullRequest⚡️Head(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Head
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'repo';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️PullRequest⚡️Head⚡️Repo($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Head', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Head::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Head(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Head', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️PullRequest⚡️Head⚡️Repo(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Head\Repo
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Head\Repo', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Head\Repo::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Head\Repo(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Head\Repo', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDiscussionLabeled⚡️Label(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookDiscussionLabeled\Label
    {
        ...
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDiscussionLabeled\Label', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookDiscussionLabeled\Label::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookDiscussionLabeled\Label(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDiscussionLabeled\Label', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipAdded⚡️Team(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipAdded\Team
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipAdded\Team', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipAdded\Team::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipAdded\Team(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipAdded\Team', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentDeleted(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentDeleted
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'comment';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentDeleted⚡️Comment($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'pull_request';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentDeleted⚡️PullRequest($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentDeleted', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentDeleted::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentDeleted(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentDeleted', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentDeleted⚡️Comment(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentDeleted\Comment
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentDeleted\Comment', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentDeleted\Comment::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentDeleted\Comment(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentDeleted\Comment', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentDeleted⚡️PullRequest(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentDeleted\PullRequest
    {
        $properties = []; 
        $missingFields = [];
        try {
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\Discussion\\AnswerChosenBy',
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'head';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentDeleted⚡️PullRequest⚡️Head($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookDiscussionLabeled\\Label',
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'milestone';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookIssuesDeleted⚡️Issue⚡️Milestone($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookMembershipAdded\\Team',
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentDeleted\PullRequest', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentDeleted\PullRequest::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentDeleted\PullRequest(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentDeleted\PullRequest', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentDeleted⚡️PullRequest⚡️Head(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentDeleted\PullRequest\Head
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'repo';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Head⚡️Repo($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentDeleted\PullRequest\Head', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentDeleted\PullRequest\Head::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentDeleted\PullRequest\Head(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentDeleted\PullRequest\Head', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Head⚡️Repo(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Head\Repo
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Head\Repo', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Head\Repo::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Head\Repo(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Head\Repo', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookIssuesDeleted⚡️Issue⚡️Milestone(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookIssuesDeleted\Issue\Milestone
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookIssuesDeleted\Issue\Milestone', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookIssuesDeleted\Issue\Milestone::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookIssuesDeleted\Issue\Milestone(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookIssuesDeleted\Issue\Milestone', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentEdited(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentEdited
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'pull_request';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentEdited⚡️PullRequest($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentEdited', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentEdited::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentEdited(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentEdited', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentEdited⚡️PullRequest(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentEdited\PullRequest
    {
        $properties = []; 
        $missingFields = [];
        try {
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookMembershipAdded\\Team',
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentEdited\PullRequest', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentEdited\PullRequest::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentEdited\PullRequest(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentEdited\PullRequest', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            ...
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated($object),
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\Comment' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️Comment($object),
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\Comment\Links' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️Comment⚡️Links($object),
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Links\Comments' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Links⚡️Comments($object),
            ...
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\PullRequest' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️PullRequest($object),
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Links' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Links($object),
            ...
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Base' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Base($object),
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Base\Repo' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Base⚡️Repo($object),
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookFork\Forkee\License' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookFork⚡️Forkee⚡️License($object),
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookFork\Forkee\Permissions' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookFork⚡️Forkee⚡️Permissions($object),
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Head' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️PullRequest⚡️Head($object),
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Head\Repo' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️PullRequest⚡️Head⚡️Repo($object),
            ...
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipAdded\Team' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipAdded⚡️Team($object),
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipAdded\Team\Parent_' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipAdded⚡️Team⚡️Parent_($object),
            ...
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentDeleted' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentDeleted($object),
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentDeleted\Comment' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentDeleted⚡️Comment($object),
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentDeleted\PullRequest' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentDeleted⚡️PullRequest($object),
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentDeleted\PullRequest\Head' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentDeleted⚡️PullRequest⚡️Head($object),
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Head\Repo' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Head⚡️Repo($object),
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookIssuesDeleted\Issue\Milestone' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookIssuesDeleted⚡️Issue⚡️Milestone($object),
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentEdited' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentEdited($object),
            ...
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentEdited\PullRequest' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentEdited⚡️PullRequest($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated);
        $result = [];
        ...
        $comment = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️Comment($comment);
        ...
        $pull_request = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️PullRequest($pull_request);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️Comment(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\Comment);
        $result = [];

        $_links = $object->_links;
        $_links = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️Comment⚡️Links($_links);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️Comment⚡️Links(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\Comment\Links);
        $result = [];

        $html = $object->html;
        $html = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Links⚡️Comments($html);
        after_html:        $result['html'] = $html;

        
        $pull_request = $object->pull_request;
        $pull_request = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Links⚡️Comments($pull_request);
        after_pull_request:        $result['pull_request'] = $pull_request;

        
        $self = $object->self;
        $self = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Links⚡️Comments($self);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Links⚡️Comments(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Links\Comments);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️PullRequest(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\PullRequest);
        $result = [];

        $_links = $object->_links;
        $_links = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Links($_links);
        after__links:        $result['_links'] = $_links;
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookIssueCommentCreated\\Issue\\Assignee',
        ...
        $auto_merge = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️AutoMerge($auto_merge);
        after_auto_merge:        $result['auto_merge'] = $auto_merge;

        
        $base = $object->base;
        $base = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Base($base);
        ...
        $head = $object->head;
        $head = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️PullRequest⚡️Head($head);
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookMembershipAdded\\Team',
        ...
        $user = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookIssueCommentCreated⚡️Issue⚡️Assignee($user);
        after_user:        $result['user'] = $user;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Links(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Links);
        $result = [];
        ...
        $commits = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Links⚡️Comments($commits);
        ...
        $issue = $object->issue;
        $issue = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Links⚡️Comments($issue);
        after_issue:        $result['issue'] = $issue;

        
        $review_comment = $object->review_comment;
        $review_comment = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Links⚡️Comments($review_comment);
        after_review_comment:        $result['review_comment'] = $review_comment;

        
        $review_comments = $object->review_comments;
        $review_comments = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Links⚡️Comments($review_comments);
        ...
        $statuses = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Links⚡️Comments($statuses);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️AutoMerge(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\AutoMerge);
        $result = [];
        ...
        $enabled_by = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Discussion⚡️AnswerChosenBy($enabled_by);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Base(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Base);
        $result = [];
        ...
        $repo = $object->repo;
        $repo = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Base⚡️Repo($repo);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Base⚡️Repo(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Base\Repo);
        $result = [];
        ...
        $license = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookFork⚡️Forkee⚡️License($license);
        ...
        $permissions = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookFork⚡️Forkee⚡️Permissions($permissions);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookFork⚡️Forkee⚡️License(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookFork\Forkee\License);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookFork⚡️Forkee⚡️Permissions(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookFork\Forkee\Permissions);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️PullRequest⚡️Head(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Head);
        $result = [];
        ...
        $repo = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️PullRequest⚡️Head⚡️Repo($repo);
        after_repo:        $result['repo'] = $repo;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️PullRequest⚡️Head⚡️Repo(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Head\Repo);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDiscussionLabeled⚡️Label(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookDiscussionLabeled\Label);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookIssueCommentCreated⚡️Issue⚡️Milestone(mixed $object): mixed
    {
        ...
        $creator = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookIssueCommentCreated⚡️Issue⚡️Assignee($creator);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipAdded⚡️Team(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipAdded\Team);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipAdded⚡️Team⚡️Parent_(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipAdded\Team\Parent_);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Repository(mixed $object): mixed
    {
        ...
        $template_repository = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Repository⚡️TemplateRepository($template_repository);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentDeleted(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentDeleted);
        $result = [];
        ...
        $comment = $object->comment;
        $comment = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentDeleted⚡️Comment($comment);
        after_comment:        $result['comment'] = $comment;
        ...
        $pull_request = $object->pull_request;
        $pull_request = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentDeleted⚡️PullRequest($pull_request);
        after_pull_request:        $result['pull_request'] = $pull_request;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentDeleted⚡️Comment(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentDeleted\Comment);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentDeleted⚡️PullRequest(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentDeleted\PullRequest);
        $result = [];
        ...
        $assignee = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Discussion⚡️AnswerChosenBy($assignee);
        after_assignee:        $result['assignee'] = $assignee;
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\Discussion\\AnswerChosenBy',
        ...
        $head = $object->head;
        $head = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentDeleted⚡️PullRequest⚡️Head($head);
        after_head:        $result['head'] = $head;
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookDiscussionLabeled\\Label',
        ...
        $milestone = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookIssuesDeleted⚡️Issue⚡️Milestone($milestone);
        after_milestone:        $result['milestone'] = $milestone;
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookMembershipAdded\\Team',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentDeleted⚡️PullRequest⚡️Head(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentDeleted\PullRequest\Head);
        $result = [];
        ...
        $repo = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Head⚡️Repo($repo);
        after_repo:        $result['repo'] = $repo;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️Head⚡️Repo(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\Head\Repo);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookIssuesDeleted⚡️Issue⚡️Milestone(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookIssuesDeleted\Issue\Milestone);
        $result = [];
        ...
        $creator = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Discussion⚡️AnswerChosenBy($creator);
        after_creator:        $result['creator'] = $creator;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentEdited(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentEdited);
        $result = [];
        ...
        $pull_request = $object->pull_request;
        $pull_request = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentEdited⚡️PullRequest($pull_request);
        after_pull_request:        $result['pull_request'] = $pull_request;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentEdited⚡️PullRequest(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentEdited\PullRequest);
        $result = [];
