...
class PullRequestReviewComment implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewCommentCreated' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewCommentCreated($payload),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookIssuesAssigned\Issue\Milestone' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookIssuesAssigned⚡️Issue⚡️Milestone($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\RequestedReviewers' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️RequestedReviewers($payload),
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookDiscussionLabeled\\Label',
                ...
                if (is_array($value)) {
                    try {
                        ...
                        $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookIssuesAssigned⚡️Issue⚡️Milestone($value);
                    } finally {
                        array_pop($this->hydrationStack);
                    }
                }
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookMembershipAdded\\Team',
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookIssuesAssigned⚡️Issue⚡️Milestone(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookIssuesAssigned\Issue\Milestone
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookIssuesAssigned\Issue\Milestone', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookIssuesAssigned\Issue\Milestone::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookIssuesAssigned\Issue\Milestone(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookIssuesAssigned\Issue\Milestone', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️RequestedReviewers(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\RequestedReviewers
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\RequestedReviewers', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\RequestedReviewers::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\RequestedReviewers(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\RequestedReviewers', $exception, stack: $this->hydrationStack);
            }
        }
    ...
    public function serializeObject(object $object): mixed
    {
        try {
            ...
            return match($className) {
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookIssuesAssigned\Issue\Milestone' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookIssuesAssigned⚡️Issue⚡️Milestone($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\RequestedReviewers' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️RequestedReviewers($object),
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookDiscussionLabeled\\Label',
        ...
        $milestone = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookIssuesAssigned⚡️Issue⚡️Milestone($milestone);
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookMembershipAdded\\Team',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookIssuesAssigned⚡️Issue⚡️Milestone(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookIssuesAssigned\Issue\Milestone);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestAssigned⚡️PullRequest⚡️RequestedReviewers(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestAssigned\PullRequest\RequestedReviewers);
        $result = [];
