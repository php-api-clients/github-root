...
namespace ApiClients\Client\GitHubEnterprise\Hydrator\Operation\Gists;
...
class CbGistIdRcb implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubEnterprise\Schema\GistSimple' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️GistSimple($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\Operation\Gists\Get\Response\Applicationjson\H403' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Operation⚡️Gists⚡️Get⚡️Response⚡️Applicationjson⚡️H403($payload),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\Operation\Gists\Get\Response\Applicationjson\H403\Block' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Operation⚡️Gists⚡️Get⚡️Response⚡️Applicationjson⚡️H403⚡️Block($payload),
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Operation⚡️Gists⚡️Get⚡️Response⚡️Applicationjson⚡️H403(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\Operation\Gists\Get\Response\Applicationjson\H403
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                if (is_array($value)) {
                    try {
                        ...
                        $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Operation⚡️Gists⚡️Get⚡️Response⚡️Applicationjson⚡️H403⚡️Block($value);
                    } finally {
                        array_pop($this->hydrationStack);
                    }
                }
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\Operation\Gists\Get\Response\Applicationjson\H403', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\Operation\Gists\Get\Response\Applicationjson\H403::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubEnterprise\Schema\Operation\Gists\Get\Response\Applicationjson\H403(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\Operation\Gists\Get\Response\Applicationjson\H403', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️GistSimple⚡️Files(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\GistSimple\Files
        {
            $properties = []; 
            $missingFields = [];
            try {
            ...
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\GistSimple\Files::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubEnterprise\Schema\GistSimple\Files(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\GistSimple\Files', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Operation⚡️Gists⚡️Get⚡️Response⚡️Applicationjson⚡️H403⚡️Block(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\Operation\Gists\Get\Response\Applicationjson\H403\Block
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\Operation\Gists\Get\Response\Applicationjson\H403\Block', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\Operation\Gists\Get\Response\Applicationjson\H403\Block::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubEnterprise\Schema\Operation\Gists\Get\Response\Applicationjson\H403\Block(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\Operation\Gists\Get\Response\Applicationjson\H403\Block', $exception, stack: $this->hydrationStack);
            }
        }
    ...
    public function serializeObject(object $object): mixed
    {
        try {
            ...
            return match($className) {
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\Operation\Gists\Get\Response\Applicationjson\H403' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Operation⚡️Gists⚡️Get⚡️Response⚡️Applicationjson⚡️H403($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️GistSimple(mixed $object): mixed
    {
        ...
        $fork_of = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️GistSimple⚡️ForkOf($fork_of);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Operation⚡️Gists⚡️Get⚡️Response⚡️Applicationjson⚡️H403(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\Operation\Gists\Get\Response\Applicationjson\H403);
        $result = [];
        ...
        $block = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Operation⚡️Gists⚡️Get⚡️Response⚡️Applicationjson⚡️H403⚡️Block($block);
