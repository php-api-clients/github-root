...
final class Hydrators implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            ...
            '\\ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookRubygemsMetadata\\Metadata' => $this->getObjectMapperOperation🌀Emojis()->hydrateObject($className, $payload),
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        return match ($className) {
            ...
            '\\ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookRubygemsMetadata\\Metadata' => $this->getObjectMapperOperation🌀Emojis()->serializeObject($object),
