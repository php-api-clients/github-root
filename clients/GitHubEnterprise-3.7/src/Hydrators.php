...
final class Hydrators implements \EventSauce\ObjectHydrator\ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload) : object
    {
        return match ($className) {
            ...
            'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookMergeGroupChecksRequested', 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookMergeGroupChecksRequested\\MergeGroup', 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookMergeGroupChecksRequested\\MergeGroup\\HeadCommit', 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookMergeGroupChecksRequested\\MergeGroup\\HeadCommit\\Author', 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookMergeGroupChecksRequested\\MergeGroup\\HeadCommit\\Committer' => $this->getObjectMapperWebHook🪝MergeGroup()->hydrateObject($className, $payload),
    ...
    public function serializeObjectOfType(object $object, string $className) : mixed
    {
        return match ($className) {
            ...
            'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookMergeGroupChecksRequested', 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookMergeGroupChecksRequested\\MergeGroup', 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookMergeGroupChecksRequested\\MergeGroup\\HeadCommit', 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookMergeGroupChecksRequested\\MergeGroup\\HeadCommit\\Author', 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookMergeGroupChecksRequested\\MergeGroup\\HeadCommit\\Committer' => $this->getObjectMapperWebHook🪝MergeGroup()->serializeObject($object),
