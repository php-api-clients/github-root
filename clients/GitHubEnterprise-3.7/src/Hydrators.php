...
final class Hydrators implements \EventSauce\ObjectHydrator\ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload) : object
    {
        return match ($className) {
            ...
            'ApiClients\\Client\\Github\\Schema\\LdapMappingTeam' => $this->getObjectMapperOperation🌀Admin🌀Ldap🌀Teams🌀CbTeamIdRcb🌀Mapping()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\SyncLdapMappingForTeam\\Response\\Applicationjson\\H201' => $this->getObjectMapperOperation🌀Admin🌀Ldap🌀Teams🌀CbTeamIdRcb🌀Sync()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\LdapMappingUser', 'ApiClients\\Client\\Github\\Schema\\LdapMappingUser\\Plan' => $this->getObjectMapperOperation🌀Admin🌀Ldap🌀Users🌀CbUsernameRcb🌀Mapping()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\SyncLdapMappingForUser\\Response\\Applicationjson\\H201' => $this->getObjectMapperOperation🌀Admin🌀Ldap🌀Users🌀CbUsernameRcb🌀Sync()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\PreReceiveHook', 'ApiClients\\Client\\Github\\Schema\\PreReceiveHook\\ScriptRepository', 'ApiClients\\Client\\Github\\Schema\\PreReceiveHook\\Environment', 'ApiClients\\Client\\Github\\Schema\\PreReceiveHook\\Environment\\Download' => $this->getObjectMapperOperation🌀Admin🌀PreReceiveHooks()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\SimpleUser' => $this->getObjectMapperOperation🌀Admin🌀Users()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\UpdateUsernameForUser\\Response\\Applicationjson\\H202' => $this->getObjectMapperOperation🌀Admin🌀Users🌀CbUsernameRcb()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\ApplicationGrant', 'ApiClients\\Client\\Github\\Schema\\ApplicationGrant\\App' => $this->getObjectMapperOperation🌀Applications🌀Grants()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\ActionsCacheUsageOrgEnterprise' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀Actions🌀Cache🌀Usage()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\ActionsCacheUsagePolicyEnterprise' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀Actions🌀Cache🌀UsagePolicy()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\ActionsGetDefaultWorkflowPermissions' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀Actions🌀Permissions🌀Workflow()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\ListOrgAccessToSelfHostedRunnerGroupInEnterprise\\Response\\Applicationjson\\H200' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀Actions🌀RunnerDashGroups🌀CbRunnerGroupIdRcb🌀Organizations()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\CodeScanningOrganizationAlertItems', 'ApiClients\\Client\\Github\\Schema\\CodeScanningAlertRule', 'ApiClients\\Client\\Github\\Schema\\CodeScanningAnalysisTool', 'ApiClients\\Client\\Github\\Schema\\CodeScanningAlertInstance', 'ApiClients\\Client\\Github\\Schema\\CodeScanningAlertInstance\\Message', 'ApiClients\\Client\\Github\\Schema\\CodeScanningAlertLocation', 'ApiClients\\Client\\Github\\Schema\\SimpleRepository', 'ApiClients\\Client\\Github\\Schema\\Operation\\CodeScanning\\ListAlertsForEnterprise\\Response\\Applicationjson\\H503' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀CodeScanning🌀Alerts()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\OrganizationSecretScanningAlert' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀SecretScanning🌀Alerts()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\AdvancedSecurityActiveCommitters', 'ApiClients\\Client\\Github\\Schema\\AdvancedSecurityActiveCommittersRepository', 'ApiClients\\Client\\Github\\Schema\\AdvancedSecurityActiveCommittersUser' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀Settings🌀Billing🌀AdvancedSecurity()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\Operation\\Orgs\\ListCustomRoles\\Response\\Applicationjson\\H200', 'ApiClients\\Client\\Github\\Schema\\OrganizationCustomRepositoryRole' => $this->getObjectMapperOperation🌀Organizations🌀CbOrganizationIdRcb🌀CustomRoles()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\Operation\\Actions\\ListRepoAccessToSelfHostedRunnerGroupInOrg\\Response\\Applicationjson\\H200' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀Actions🌀RunnerDashGroups🌀CbRunnerGroupIdRcb🌀Repositories()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\Operation\\Actions\\ListSelfHostedRunnersInGroupForOrg\\Response\\Applicationjson\\H200' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀Actions🌀RunnerDashGroups🌀CbRunnerGroupIdRcb🌀Runners()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\Operation\\Actions\\RemoveAllCustomLabelsFromSelfHostedRunnerForOrg\\Response\\Applicationjson\\H200' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀Actions🌀Runners🌀CbRunnerIdRcb🌀Labels()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\OrgPreReceiveHook' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀PreReceiveHooks()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\ActionsCacheUsagePolicyForRepository' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀Actions🌀Cache🌀UsagePolicy()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\RepositoryPreReceiveHook' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀PreReceiveHooks()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\Operation\\Repos\\ListCacheInfo\\Response\\Applicationjson\\H200', 'ApiClients\\Client\\Github\\Schema\\Operation\\Repos\\ListCacheInfo\\Response\\Applicationjson\\H200\\Git' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀Replicas🌀Caches()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\ScimEnterpriseGroupList', 'ApiClients\\Client\\Github\\Schema\\GroupResponse', 'ApiClients\\Client\\Github\\Schema\\GroupResponse\\Members', 'ApiClients\\Client\\Github\\Schema\\ScimEnterpriseGroupResponse' => $this->getObjectMapperOperation🌀Scim🌀V2🌀Groups()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\ScimEnterpriseUserList', 'ApiClients\\Client\\Github\\Schema\\UserResponse', 'ApiClients\\Client\\Github\\Schema\\UserNameResponse', 'ApiClients\\Client\\Github\\Schema\\UserEmailsResponse', 'ApiClients\\Client\\Github\\Schema\\UserRole', 'ApiClients\\Client\\Github\\Schema\\ScimEnterpriseUserResponse' => $this->getObjectMapperOperation🌀Scim🌀V2🌀Users()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\ConfigurationStatus', 'ApiClients\\Client\\Github\\Schema\\ConfigurationStatus\\Progress' => $this->getObjectMapperOperation🌀Setup🌀Api🌀Configcheck()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\MaintenanceStatus', 'ApiClients\\Client\\Github\\Schema\\MaintenanceStatus\\ConnectionServices' => $this->getObjectMapperOperation🌀Setup🌀Api🌀Maintenance()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\Avatar', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\Customer', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\License', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\GithubSsl', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\Ldap', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\Ldap\\Reconciliation', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\Ldap\\Profile', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\Cas', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\Saml', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\GithubOauth', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\Smtp', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\Ntp', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\Snmp', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\Syslog', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\Pages', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\Collectd', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\Mapping' => $this->getObjectMapperOperation🌀Setup🌀Api🌀Settings()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\SshKey' => $this->getObjectMapperOperation🌀Setup🌀Api🌀Settings🌀AuthorizedKeys()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\Email' => $this->getObjectMapperOperation🌀User🌀Emails()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\WebhookCacheSync' => $this->getObjectMapperWebHook🪝CacheSync()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\WebhookEnterpriseAnonymousAccessDisabled', 'ApiClients\\Client\\Github\\Schema\\WebhookEnterpriseAnonymousAccessEnabled' => $this->getObjectMapperWebHook🪝Enterprise()->hydrateObject($className, $payload),
    ...
    public function serializeObjectOfType(object $object, string $className) : mixed
    {
        return match ($className) {
            ...
            'ApiClients\\Client\\Github\\Schema\\LdapMappingTeam' => $this->getObjectMapperOperation🌀Admin🌀Ldap🌀Teams🌀CbTeamIdRcb🌀Mapping()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\SyncLdapMappingForTeam\\Response\\Applicationjson\\H201' => $this->getObjectMapperOperation🌀Admin🌀Ldap🌀Teams🌀CbTeamIdRcb🌀Sync()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\LdapMappingUser', 'ApiClients\\Client\\Github\\Schema\\LdapMappingUser\\Plan' => $this->getObjectMapperOperation🌀Admin🌀Ldap🌀Users🌀CbUsernameRcb🌀Mapping()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\SyncLdapMappingForUser\\Response\\Applicationjson\\H201' => $this->getObjectMapperOperation🌀Admin🌀Ldap🌀Users🌀CbUsernameRcb🌀Sync()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\PreReceiveHook', 'ApiClients\\Client\\Github\\Schema\\PreReceiveHook\\ScriptRepository', 'ApiClients\\Client\\Github\\Schema\\PreReceiveHook\\Environment', 'ApiClients\\Client\\Github\\Schema\\PreReceiveHook\\Environment\\Download' => $this->getObjectMapperOperation🌀Admin🌀PreReceiveHooks()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\SimpleUser' => $this->getObjectMapperOperation🌀Admin🌀Users()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\UpdateUsernameForUser\\Response\\Applicationjson\\H202' => $this->getObjectMapperOperation🌀Admin🌀Users🌀CbUsernameRcb()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\ApplicationGrant', 'ApiClients\\Client\\Github\\Schema\\ApplicationGrant\\App' => $this->getObjectMapperOperation🌀Applications🌀Grants()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\ActionsCacheUsageOrgEnterprise' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀Actions🌀Cache🌀Usage()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\ActionsCacheUsagePolicyEnterprise' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀Actions🌀Cache🌀UsagePolicy()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\ActionsGetDefaultWorkflowPermissions' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀Actions🌀Permissions🌀Workflow()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\Operation\\EnterpriseAdmin\\ListOrgAccessToSelfHostedRunnerGroupInEnterprise\\Response\\Applicationjson\\H200' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀Actions🌀RunnerDashGroups🌀CbRunnerGroupIdRcb🌀Organizations()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\OrganizationSecretScanningAlert' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀SecretScanning🌀Alerts()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\AdvancedSecurityActiveCommitters', 'ApiClients\\Client\\Github\\Schema\\AdvancedSecurityActiveCommittersRepository', 'ApiClients\\Client\\Github\\Schema\\AdvancedSecurityActiveCommittersUser' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀Settings🌀Billing🌀AdvancedSecurity()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\Operation\\Orgs\\ListCustomRoles\\Response\\Applicationjson\\H200', 'ApiClients\\Client\\Github\\Schema\\OrganizationCustomRepositoryRole' => $this->getObjectMapperOperation🌀Organizations🌀CbOrganizationIdRcb🌀CustomRoles()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\Operation\\Actions\\ListRepoAccessToSelfHostedRunnerGroupInOrg\\Response\\Applicationjson\\H200' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀Actions🌀RunnerDashGroups🌀CbRunnerGroupIdRcb🌀Repositories()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\Operation\\Actions\\ListSelfHostedRunnersInGroupForOrg\\Response\\Applicationjson\\H200' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀Actions🌀RunnerDashGroups🌀CbRunnerGroupIdRcb🌀Runners()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\Operation\\Actions\\RemoveAllCustomLabelsFromSelfHostedRunnerForOrg\\Response\\Applicationjson\\H200' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀Actions🌀Runners🌀CbRunnerIdRcb🌀Labels()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\Operation\\Orgs\\ConvertMemberToOutsideCollaborator\\Response\\Applicationjson\\H202', 'ApiClients\\Client\\Github\\Schema\\Operation\\Orgs\\RemoveOutsideCollaborator\\Response\\Applicationjson\\H422' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀OutsideCollaborators🌀CbUsernameRcb()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\OrgPreReceiveHook' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀PreReceiveHooks()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\ActionsCacheUsagePolicyForRepository' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀Actions🌀Cache🌀UsagePolicy()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\RepositoryPreReceiveHook' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀PreReceiveHooks()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\Operation\\Repos\\ListCacheInfo\\Response\\Applicationjson\\H200', 'ApiClients\\Client\\Github\\Schema\\Operation\\Repos\\ListCacheInfo\\Response\\Applicationjson\\H200\\Git' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀Replicas🌀Caches()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\ScimEnterpriseGroupList', 'ApiClients\\Client\\Github\\Schema\\GroupResponse', 'ApiClients\\Client\\Github\\Schema\\GroupResponse\\Members', 'ApiClients\\Client\\Github\\Schema\\ScimEnterpriseGroupResponse' => $this->getObjectMapperOperation🌀Scim🌀V2🌀Groups()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\ScimEnterpriseUserList', 'ApiClients\\Client\\Github\\Schema\\UserResponse', 'ApiClients\\Client\\Github\\Schema\\UserNameResponse', 'ApiClients\\Client\\Github\\Schema\\UserEmailsResponse', 'ApiClients\\Client\\Github\\Schema\\UserRole', 'ApiClients\\Client\\Github\\Schema\\ScimEnterpriseUserResponse' => $this->getObjectMapperOperation🌀Scim🌀V2🌀Users()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\ConfigurationStatus', 'ApiClients\\Client\\Github\\Schema\\ConfigurationStatus\\Progress' => $this->getObjectMapperOperation🌀Setup🌀Api🌀Configcheck()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\MaintenanceStatus', 'ApiClients\\Client\\Github\\Schema\\MaintenanceStatus\\ConnectionServices' => $this->getObjectMapperOperation🌀Setup🌀Api🌀Maintenance()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\Avatar', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\Customer', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\License', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\GithubSsl', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\Ldap', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\Ldap\\Reconciliation', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\Ldap\\Profile', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\Cas', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\Saml', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\GithubOauth', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\Smtp', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\Ntp', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\Snmp', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\Syslog', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\Pages', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\Collectd', 'ApiClients\\Client\\Github\\Schema\\EnterpriseSettings\\Enterprise\\Mapping' => $this->getObjectMapperOperation🌀Setup🌀Api🌀Settings()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\SshKey' => $this->getObjectMapperOperation🌀Setup🌀Api🌀Settings🌀AuthorizedKeys()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\Email' => $this->getObjectMapperOperation🌀User🌀Emails()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\WebhookCacheSync' => $this->getObjectMapperWebHook🪝CacheSync()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\WebhookEnterpriseAnonymousAccessDisabled', 'ApiClients\\Client\\Github\\Schema\\WebhookEnterpriseAnonymousAccessEnabled' => $this->getObjectMapperWebHook🪝Enterprise()->serializeObject($object),
