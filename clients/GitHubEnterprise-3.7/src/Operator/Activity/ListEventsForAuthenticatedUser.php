...
final readonly class ListEventsForAuthenticatedUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Activity\ListEventsForAuthenticatedUser($this->responseSchemaValidator, $this->hydrator, $username, $perPage, $page);
