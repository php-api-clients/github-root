...
final readonly class SetGithubActionsDefaultWorkflowPermissionsRepository
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Actions\SetGithubActionsDefaultWorkflowPermissionsRepository($this->requestSchemaValidator, $owner, $repo);
