...
final readonly class ListSelfHostedRunnersForOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Actions\ListSelfHostedRunnersForOrg($this->responseSchemaValidator, $this->hydrator, $org, $perPage, $page);
