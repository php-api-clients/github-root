...
namespace ApiClients\Client\GitHubEnterprise\Operator\DependencyGraph;
...
final readonly class CreateRepositorySnapshot
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\DependencyGraph\CreateRepositorySnapshot($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo);
