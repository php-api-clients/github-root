...
final readonly class ListSshSigningKeysForUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Users\ListSshSigningKeysForUser($this->responseSchemaValidator, $this->hydrator, $username, $perPage, $page);
