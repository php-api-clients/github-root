...
final readonly class ListAlertsForOrgListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\CodeScanning\ListAlertsForOrgListing($this->responseSchemaValidator, $this->hydrator, $org, $toolName, $toolGuid, $before, $after, $state, $page, $perPage, $direction, $sort);
