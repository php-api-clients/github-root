...
final readonly class GetMembershipForUserInOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Teams\GetMembershipForUserInOrg($this->responseSchemaValidator, $this->hydrator, $org, $teamSlug, $username);
