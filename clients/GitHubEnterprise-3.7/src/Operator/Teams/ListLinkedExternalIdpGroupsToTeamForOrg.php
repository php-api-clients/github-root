...
final readonly class ListLinkedExternalIdpGroupsToTeamForOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Teams\ListLinkedExternalIdpGroupsToTeamForOrg($this->responseSchemaValidator, $this->hydrator, $org, $teamSlug);
