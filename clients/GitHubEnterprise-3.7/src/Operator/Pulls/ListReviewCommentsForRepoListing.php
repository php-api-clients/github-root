...
final readonly class ListReviewCommentsForRepoListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Pulls\ListReviewCommentsForRepoListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $sort, $direction, $since, $perPage, $page);
