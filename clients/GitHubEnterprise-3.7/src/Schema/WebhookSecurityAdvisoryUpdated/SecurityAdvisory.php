...
namespace ApiClients\Client\GitHubEnterprise\Schema\WebhookSecurityAdvisoryUpdated;
...
final readonly class SecurityAdvisory
{
    ...
    /**
     * @param array<\ApiClients\Client\GitHubEnterprise\Schema\WebhookSecurityAdvisoryUpdated\SecurityAdvisory\Cwes> $cwes
     * @param array<\ApiClients\Client\GitHubEnterprise\Schema\WebhookSecurityAdvisoryUpdated\SecurityAdvisory\Identifiers> $identifiers
     * @param array<\ApiClients\Client\GitHubEnterprise\Schema\WebhookSecurityAdvisoryUpdated\SecurityAdvisory\References> $references
     * @param array<\ApiClients\Client\GitHubEnterprise\Schema\WebhookSecurityAdvisoryUpdated\SecurityAdvisory\Vulnerabilities> $vulnerabilities
     */
    public function __construct(public Schema\WebhookSecurityAdvisoryUpdated\SecurityAdvisory\Cvss $cvss, #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\WebhookSecurityAdvisoryUpdated\SecurityAdvisory\Cwes::class)] public array $cwes, public string $description, #[\EventSauce\ObjectHydrator\MapFrom('ghsa_id')] public string $ghsaId, #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\WebhookSecurityAdvisoryUpdated\SecurityAdvisory\Identifiers::class)] public array $identifiers, #[\EventSauce\ObjectHydrator\MapFrom('published_at')] public string $publishedAt, #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\WebhookSecurityAdvisoryUpdated\SecurityAdvisory\References::class)] public array $references, public string $severity, public string $summary, #[\EventSauce\ObjectHydrator\MapFrom('updated_at')] public string $updatedAt, #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\WebhookSecurityAdvisoryUpdated\SecurityAdvisory\Vulnerabilities::class)] public array $vulnerabilities, #[\EventSauce\ObjectHydrator\MapFrom('withdrawn_at')] public ?string $withdrawnAt)
    {
    }
}
