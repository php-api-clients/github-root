...
final readonly class StatusCheckPolicy
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"url":"https:\\/\\/api.github.com\\/repos\\/octocat\\/Hello-World\\/branches\\/master\\/protection\\/required_status_checks","strict":true,"contexts":["continuous-integration\\/travis-ci"],"checks":[null],"contexts_url":"https:\\/\\/api.github.com\\/repos\\/octocat\\/Hello-World\\/branches\\/master\\/protection\\/required_status_checks\\/contexts"}';
    public ?string $url;
    public ?bool $strict;
    /**
     * @var array<string>
    ...
    /**
     * @var array<Schema\StatusCheckPolicy\Checks>
     */
    public ?array $checks;
