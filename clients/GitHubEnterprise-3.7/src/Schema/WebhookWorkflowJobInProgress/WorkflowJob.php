...
final readonly class WorkflowJob
{
     ...
     * @param array<\ApiClients\Client\GitHubEnterprise\Schema\WebhookWorkflowJobInProgress\WorkflowJob\Steps> $steps
     */
