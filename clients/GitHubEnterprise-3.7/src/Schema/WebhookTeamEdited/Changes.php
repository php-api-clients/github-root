...
namespace ApiClients\Client\GitHubEnterprise\Schema\WebhookTeamEdited;
...
final readonly class Changes
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"description":{"from":"generated"},"name":{"from":"generated"},"privacy":{"from":"generated"},"repository":{"permissions":{"from":{"admin":false,"pull":false,"push":false}}}}';

    public function __construct(public Schema\WebhookTeamEdited\Changes\Description|null $description, public Schema\WebhookTeamEdited\Changes\Name|null $name, public Schema\WebhookTeamEdited\Changes\Privacy|null $privacy, public Schema\WebhookTeamEdited\Changes\Repository|null $repository)
    {
    }
}
