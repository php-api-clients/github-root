...
namespace ApiClients\Client\GitHubEnterprise\Schema\WebhookIssuesDemilestoned;
...
final readonly class Issue
{
     ...
     */
    public ?Schema\WebhookIssuesAssigned\Issue\Milestone $milestone;
