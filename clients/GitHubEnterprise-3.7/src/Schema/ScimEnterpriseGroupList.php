...
final readonly class ScimEnterpriseGroupList
{
     ...
     * @param ?array<\ApiClients\Client\GitHubEnterprise\Schema\ScimEnterpriseGroupList\Resources> $Resources
     * startIndex: A starting index for the returned page
     * itemsPerPage: Number of objects per page
     */
    public function __construct(public ?array $schemas, public ?int $totalResults, #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\ScimEnterpriseGroupList\Resources::class)] public ?array $Resources, public ?int $startIndex, public ?int $itemsPerPage)
    {
    }
}
