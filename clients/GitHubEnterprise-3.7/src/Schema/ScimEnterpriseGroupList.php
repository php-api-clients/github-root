...
final readonly class ScimEnterpriseGroupList
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"schemas":["urn:ietf:params:scim:api:messages:2.0:ListResponse"],"totalResults":1,"Resources":[{"schemas":["urn:ietf:params:scim:schemas:core:2.0:Group"],"externalId":"8aa1a0c0-c4c3-4bc0-b4a5-2ef676900159","displayName":"Engineering","members":[{"value":"23a35c27-23d3-4c03-b4c5-6443c09e7173","ref":"generated_ref_null","display":"Monalisa Octocat"}]}],"startIndex":1,"itemsPerPage":20}';
    /**
     ...
     */
    public function __construct(public array $schemas, public int $totalResults, #[\EventSauce\ObjectHydrator\MapFrom('Resources')] #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\GroupResponse::class)] public array $resources, public int $startIndex, public int $itemsPerPage)
    {
    }
}
