...
final readonly class NpmMetadata
{
    ...
    public function __construct(string $name, string $version, string $npm_user, mixed $author, mixed $bugs, Schema\AuditLogEvent\Config $dependencies, Schema\AuditLogEvent\Config $dev_dependencies, Schema\AuditLogEvent\Config $peer_dependencies, Schema\AuditLogEvent\Config $optional_dependencies, string $description, mixed $dist, string $git_head, string $homepage, string $license, string $main, mixed $repository, Schema\AuditLogEvent\Config $scripts, string $id, string $node_version, string $npm_version, bool $has_shrinkwrap, array $maintainers, array $contributors, Schema\AuditLogEvent\Config $engines, array $keywords, array $files, Schema\AuditLogEvent\Config $bin, Schema\AuditLogEvent\Config $man, mixed $directories, array $os, array $cpu, string $readme, string $installation_command, int $release_id, string $commit_oid, bool $published_via_actions, int $deleted_by_id)
    {
        $this->name = $name;
