...
final readonly class ScimError
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"message":"generated_message","documentation_url":"generated_documentation_url","detail":"generated_detail","status":13,"scimType":"generated_scimType","schemas":[null]}';
