...
namespace ApiClients\Client\GitHubEnterprise\Schema\AliasAbstract\TietD313820D\TietA0F9C29B\Tiet2EACF123;

use EventSauce\ObjectHydrator\MapFrom;

abstract readonly class Tiet34669F88
{
    ...
    public const SCHEMA_DESCRIPTION  = 'The [`deploy key`](https://docs.github.com/enterprise-server@3.7/rest/deploy-keys/deploy-keys#get-a-deploy-key) resource.';
