...
final readonly class Applicationjson
{
     ...
     */
    public function __construct(public string $name, public ?string $visibility, #[MapFrom('selected_organization_ids')] public ?array $selectedOrganizationIds, public ?array $runners, #[MapFrom('allows_public_repositories')] public ?bool $allowsPublicRepositories, #[MapFrom('restricted_to_workflows')] public ?bool $restrictedToWorkflows, #[MapFrom('selected_workflows')] public ?array $selectedWorkflows)
    {
    }
}
