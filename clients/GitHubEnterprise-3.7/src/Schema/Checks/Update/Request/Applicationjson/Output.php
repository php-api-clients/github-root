...
final readonly class Output
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"title":"generated_title","summary":"generated_summary","text":"generated_text","annotations":[null],"images":[null]}';
    /**
     * **Required**.
     */
    public string $title;
