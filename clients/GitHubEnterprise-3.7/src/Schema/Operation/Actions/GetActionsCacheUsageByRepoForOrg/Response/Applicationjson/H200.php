...
namespace ApiClients\Client\GitHubEnterprise\Schema\Operation\Actions\GetActionsCacheUsageByRepoForOrg\Response\Applicationjson;
...
final readonly class H200
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"total_count":13,"repository_cache_usages":[null]}';
    public ?int $total_count;
    /**
     * @var array<Schema\ActionsCacheUsageByRepository>
     */
