...
final readonly class RepositoryPreReceiveHook
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"id":13,"name":"generated_name_null","enforcement":"generated_enforcement_null","configurationUrl":"generated_configuration_url_null"}';
