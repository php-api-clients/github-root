...
namespace ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryTransferred\Changes\Owner;
...
final readonly class From
{
    ...
    public ?Schema\WebhookRepositoryTransferred\Changes\Owner\From\Organization $organization;
    public ?Schema\Discussion\AnswerChosenBy $user;
    public function __construct(Schema\WebhookRepositoryTransferred\Changes\Owner\From\Organization $organization, Schema\Discussion\AnswerChosenBy $user)
    {
