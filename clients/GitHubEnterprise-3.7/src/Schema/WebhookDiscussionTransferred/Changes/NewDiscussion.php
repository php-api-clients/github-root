...
namespace ApiClients\Client\GitHubEnterprise\Schema\WebhookDiscussionTransferred\Changes;

use ApiClients\Client\GitHubEnterprise\Hydrator;
use ApiClients\Client\GitHubEnterprise\Operation;
use ApiClients\Client\GitHubEnterprise\Schema;
use ApiClients\Client\GitHubEnterprise\WebHook;
final readonly class NewDiscussion
{
    ...
    public ?Schema\Discussion\AnswerChosenBy $answer_chosen_by;
    ...
    public ?string $body;
    public ?Schema\Discussion\Category $category;
    public ?int $comments;
    ...
    public function __construct(string $active_lock_reason, string $answer_chosen_at, Schema\Discussion\AnswerChosenBy $answer_chosen_by, string $answer_html_url, string $author_association, string $body, Schema\Discussion\Category $category, int $comments, string $created_at, string $html_url, int $id, bool $locked, string $node_id, int $number, Schema\Discussion\Reactions $reactions, string $repository_url, string $state, string $timeline_url, string $title, string $updated_at, Schema\Discussion\AnswerChosenBy $user)
    {
