...
final readonly class SecretScanningAlert
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"number":13,"created_at":"generated_created_at","updated_at":"generated_updated_at","url":"generated_url","html_url":"generated_html_url","locations_url":"generated_locations_url","state":"generated_state","resolution":"generated_resolution","resolved_at":"generated_resolved_at","resolved_by":"generated_resolved_by","secret_type":"generated_secret_type","secret_type_display_name":"generated_secret_type_display_name","secret":"generated_secret","push_protection_bypassed":false,"push_protection_bypassed_by":"generated_push_protection_bypassed_by","push_protection_bypassed_at":"generated_push_protection_bypassed_at"}';
    /**
    ...
    */
    ...
    public mixed $push_protection_bypassed_by;
    /**
     * The time that push protection was bypassed in ISO 8601 format: `YYYY-MM-DDTHH:MM:SSZ`.
     */
    public ?string $push_protection_bypassed_at;
    public function __construct(int $number, string $created_at, mixed $updated_at, string $url, string $html_url, string $locations_url, string $state, string $resolution, string $resolved_at, mixed $resolved_by, string $secret_type, string $secret_type_display_name, string $secret, bool $push_protection_bypassed, mixed $push_protection_bypassed_by, string $push_protection_bypassed_at)
    {
        $this->number = $number;
