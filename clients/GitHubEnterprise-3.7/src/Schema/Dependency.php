...
final readonly class Dependency
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"packageUrl":"pkg:\\/npm\\/%40actions\\/http-client@1.0.11","metadata":null,"relationship":"direct","scope":"runtime","dependencies":["@actions\\/http-client"]}';
    /**
     ...
     */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('package_url')] public ?string $packageUrl, public mixed $metadata, public ?string $relationship, public ?string $scope, public ?array $dependencies)
    {
    }
}
