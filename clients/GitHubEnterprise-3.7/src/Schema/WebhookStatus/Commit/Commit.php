...
final readonly class Commit
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"author":"generated_author","comment_count":13,"committer":"generated_committer","message":"generated_message","tree":{"sha":"generated_sha","url":"generated_url"},"url":"generated_url","verification":{"payload":"generated_payload","reason":"generated_reason","signature":"generated_signature","verified":false}}';
    public mixed $author;
    ...
    public function __construct(mixed $author, int $comment_count, mixed $committer, string $message, Schema\ShortBranch\Commit $tree, string $url, Schema\WebhookStatus\Commit\Commit\Verification $verification)
    {
        $this->author = $author;
