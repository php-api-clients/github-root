...
final class Operators
{
    ...
    private Operator\CodeScanning\ListAlertsForEnterprise|null $codeScanning👷ListAlertsForEnterprise                                                                       = null;
    private Operator\CodeScanning\ListAlertsForEnterpriseListing|null $codeScanning👷ListAlertsForEnterpriseListing                                                         = null;
    private Operator\SecretScanning\GetSecurityAnalysisSettingsForEnterprise|null $secretScanning👷GetSecurityAnalysisSettingsForEnterprise                                 = null;
    private Operator\SecretScanning\PatchSecurityAnalysisSettingsForEnterprise|null $secretScanning👷PatchSecurityAnalysisSettingsForEnterprise                             = null;
    ...
    private Operator\SecretScanning\PostSecurityProductEnablementForEnterprise|null $secretScanning👷PostSecurityProductEnablementForEnterprise                             = null;
    ...
    private Operator\EnterpriseAdmin\GetConfigNodes|null $enterpriseAdmin👷GetConfigNodes                                                                                   = null;
    private Operator\EnterpriseAdmin\GetReplicationStatus|null $enterpriseAdmin👷GetReplicationStatus                                                                       = null;
    private Operator\EnterpriseAdmin\GetVersion|null $enterpriseAdmin👷GetVersion                                                                                           = null;
    ...
    private Operator\AnnouncementBanners\GetAnnouncementBannerForOrg|null $announcementBanners👷GetAnnouncementBannerForOrg                                                 = null;
    private Operator\AnnouncementBanners\RemoveAnnouncementBannerForOrg|null $announcementBanners👷RemoveAnnouncementBannerForOrg                                           = null;
    private Operator\AnnouncementBanners\SetAnnouncementBannerForOrg|null $announcementBanners👷SetAnnouncementBannerForOrg                                                 = null;
    ...
    private Operator\Orgs\ListCustomRepoRoles|null $orgs👷ListCustomRepoRoles                                                                                               = null;
    private Operator\Orgs\CreateCustomRepoRole|null $orgs👷CreateCustomRepoRole                                                                                             = null;
    private Operator\Orgs\GetCustomRepoRole|null $orgs👷GetCustomRepoRole                                                                                                   = null;
    private Operator\Orgs\DeleteCustomRepoRole|null $orgs👷DeleteCustomRepoRole                                                                                             = null;
    private Operator\Orgs\UpdateCustomRepoRole|null $orgs👷UpdateCustomRepoRole                                                                                             = null;
    ...
    private Operator\Orgs\ListRepoFineGrainedPermissions|null $orgs👷ListRepoFineGrainedPermissions                                                                         = null;
    ...
    public function codeScanning👷ListAlertsForEnterprise(): Operator\CodeScanning\ListAlertsForEnterprise
    {
        if ($this->codeScanning👷ListAlertsForEnterprise instanceof Operator\CodeScanning\ListAlertsForEnterprise === false) {
            $this->codeScanning👷ListAlertsForEnterprise = new Operator\CodeScanning\ListAlertsForEnterprise($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀CodeScanning🌀Alerts());
        }

        return $this->codeScanning👷ListAlertsForEnterprise;
    }

    public function codeScanning👷ListAlertsForEnterpriseListing(): Operator\CodeScanning\ListAlertsForEnterpriseListing
    {
        if ($this->codeScanning👷ListAlertsForEnterpriseListing instanceof Operator\CodeScanning\ListAlertsForEnterpriseListing === false) {
            $this->codeScanning👷ListAlertsForEnterpriseListing = new Operator\CodeScanning\ListAlertsForEnterpriseListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀CodeScanning🌀Alerts());
        }

        return $this->codeScanning👷ListAlertsForEnterpriseListing;
    }

    public function secretScanning👷GetSecurityAnalysisSettingsForEnterprise(): Operator\SecretScanning\GetSecurityAnalysisSettingsForEnterprise
    {
        if ($this->secretScanning👷GetSecurityAnalysisSettingsForEnterprise instanceof Operator\SecretScanning\GetSecurityAnalysisSettingsForEnterprise === false) {
            $this->secretScanning👷GetSecurityAnalysisSettingsForEnterprise = new Operator\SecretScanning\GetSecurityAnalysisSettingsForEnterprise($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀CodeSecurityAndAnalysis());
        }

        return $this->secretScanning👷GetSecurityAnalysisSettingsForEnterprise;
    }

    public function secretScanning👷PatchSecurityAnalysisSettingsForEnterprise(): Operator\SecretScanning\PatchSecurityAnalysisSettingsForEnterprise
    {
        if ($this->secretScanning👷PatchSecurityAnalysisSettingsForEnterprise instanceof Operator\SecretScanning\PatchSecurityAnalysisSettingsForEnterprise === false) {
            $this->secretScanning👷PatchSecurityAnalysisSettingsForEnterprise = new Operator\SecretScanning\PatchSecurityAnalysisSettingsForEnterprise($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀CodeSecurityAndAnalysis());
        }
    ...
    public function secretScanning👷PostSecurityProductEnablementForEnterprise(): Operator\SecretScanning\PostSecurityProductEnablementForEnterprise
    {
        if ($this->secretScanning👷PostSecurityProductEnablementForEnterprise instanceof Operator\SecretScanning\PostSecurityProductEnablementForEnterprise === false) {
            $this->secretScanning👷PostSecurityProductEnablementForEnterprise = new Operator\SecretScanning\PostSecurityProductEnablementForEnterprise($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀SecurityProduct🌀Enablement());
        }
    ...
    public function enterpriseAdmin👷GetConfigNodes(): Operator\EnterpriseAdmin\GetConfigNodes
    {
        if ($this->enterpriseAdmin👷GetConfigNodes instanceof Operator\EnterpriseAdmin\GetConfigNodes === false) {
            $this->enterpriseAdmin👷GetConfigNodes = new Operator\EnterpriseAdmin\GetConfigNodes($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Manage🌀V1🌀Config🌀Nodes());
        }

        return $this->enterpriseAdmin👷GetConfigNodes;
    }

    public function enterpriseAdmin👷GetReplicationStatus(): Operator\EnterpriseAdmin\GetReplicationStatus
    {
        if ($this->enterpriseAdmin👷GetReplicationStatus instanceof Operator\EnterpriseAdmin\GetReplicationStatus === false) {
            $this->enterpriseAdmin👷GetReplicationStatus = new Operator\EnterpriseAdmin\GetReplicationStatus($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Manage🌀V1🌀Replication🌀Status());
        }

        return $this->enterpriseAdmin👷GetReplicationStatus;
    }

    public function enterpriseAdmin👷GetVersion(): Operator\EnterpriseAdmin\GetVersion
    {
        if ($this->enterpriseAdmin👷GetVersion instanceof Operator\EnterpriseAdmin\GetVersion === false) {
            $this->enterpriseAdmin👷GetVersion = new Operator\EnterpriseAdmin\GetVersion($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Manage🌀V1🌀Version());
        }
    ...
    public function announcementBanners👷GetAnnouncementBannerForOrg(): Operator\AnnouncementBanners\GetAnnouncementBannerForOrg
    {
        if ($this->announcementBanners👷GetAnnouncementBannerForOrg instanceof Operator\AnnouncementBanners\GetAnnouncementBannerForOrg === false) {
            $this->announcementBanners👷GetAnnouncementBannerForOrg = new Operator\AnnouncementBanners\GetAnnouncementBannerForOrg($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Announcement());
        }

        return $this->announcementBanners👷GetAnnouncementBannerForOrg;
    }

    public function announcementBanners👷RemoveAnnouncementBannerForOrg(): Operator\AnnouncementBanners\RemoveAnnouncementBannerForOrg
    {
        if ($this->announcementBanners👷RemoveAnnouncementBannerForOrg instanceof Operator\AnnouncementBanners\RemoveAnnouncementBannerForOrg === false) {
            $this->announcementBanners👷RemoveAnnouncementBannerForOrg = new Operator\AnnouncementBanners\RemoveAnnouncementBannerForOrg($this->browser, $this->authentication);
        }

        return $this->announcementBanners👷RemoveAnnouncementBannerForOrg;
    }

    public function announcementBanners👷SetAnnouncementBannerForOrg(): Operator\AnnouncementBanners\SetAnnouncementBannerForOrg
    {
        if ($this->announcementBanners👷SetAnnouncementBannerForOrg instanceof Operator\AnnouncementBanners\SetAnnouncementBannerForOrg === false) {
            $this->announcementBanners👷SetAnnouncementBannerForOrg = new Operator\AnnouncementBanners\SetAnnouncementBannerForOrg($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Announcement());
        }
    ...
    public function orgs👷ListCustomRepoRoles(): Operator\Orgs\ListCustomRepoRoles
    {
        if ($this->orgs👷ListCustomRepoRoles instanceof Operator\Orgs\ListCustomRepoRoles === false) {
            $this->orgs👷ListCustomRepoRoles = new Operator\Orgs\ListCustomRepoRoles($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀CustomRepositoryRoles());
        }

        return $this->orgs👷ListCustomRepoRoles;
    }

    public function orgs👷CreateCustomRepoRole(): Operator\Orgs\CreateCustomRepoRole
    {
        if ($this->orgs👷CreateCustomRepoRole instanceof Operator\Orgs\CreateCustomRepoRole === false) {
            $this->orgs👷CreateCustomRepoRole = new Operator\Orgs\CreateCustomRepoRole($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀CustomRepositoryRoles());
        }

        return $this->orgs👷CreateCustomRepoRole;
    }

    public function orgs👷GetCustomRepoRole(): Operator\Orgs\GetCustomRepoRole
    {
        if ($this->orgs👷GetCustomRepoRole instanceof Operator\Orgs\GetCustomRepoRole === false) {
            $this->orgs👷GetCustomRepoRole = new Operator\Orgs\GetCustomRepoRole($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀CustomRepositoryRoles🌀RoleId());
        }

        return $this->orgs👷GetCustomRepoRole;
    }

    public function orgs👷DeleteCustomRepoRole(): Operator\Orgs\DeleteCustomRepoRole
    {
        if ($this->orgs👷DeleteCustomRepoRole instanceof Operator\Orgs\DeleteCustomRepoRole === false) {
            $this->orgs👷DeleteCustomRepoRole = new Operator\Orgs\DeleteCustomRepoRole($this->browser, $this->authentication);
        }

        return $this->orgs👷DeleteCustomRepoRole;
    }

    public function orgs👷UpdateCustomRepoRole(): Operator\Orgs\UpdateCustomRepoRole
    {
        if ($this->orgs👷UpdateCustomRepoRole instanceof Operator\Orgs\UpdateCustomRepoRole === false) {
            $this->orgs👷UpdateCustomRepoRole = new Operator\Orgs\UpdateCustomRepoRole($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀CustomRepositoryRoles🌀RoleId());
        }
    ...
    public function orgs👷ListRepoFineGrainedPermissions(): Operator\Orgs\ListRepoFineGrainedPermissions
    {
        if ($this->orgs👷ListRepoFineGrainedPermissions instanceof Operator\Orgs\ListRepoFineGrainedPermissions === false) {
            $this->orgs👷ListRepoFineGrainedPermissions = new Operator\Orgs\ListRepoFineGrainedPermissions($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀RepositoryFineGrainedPermissions());
        }
    ...
    public function orgs👷EnableOrDisableSecurityProductOnAllOrgRepos(): Operator\Orgs\EnableOrDisableSecurityProductOnAllOrgRepos
    {
        if ($this->orgs👷EnableOrDisableSecurityProductOnAllOrgRepos instanceof Operator\Orgs\EnableOrDisableSecurityProductOnAllOrgRepos === false) {
            $this->orgs👷EnableOrDisableSecurityProductOnAllOrgRepos = new Operator\Orgs\EnableOrDisableSecurityProductOnAllOrgRepos($this->browser, $this->authentication);
        }
