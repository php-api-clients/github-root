...
namespace ApiClients\Client\GitHubEnterprise\Schema\AliasAbstract\Tiet6F5C9E0E\Tiet5BF3676D\Tiet2B1929FC;

use ApiClients\Client\GitHubEnterprise\Schema;
use EventSauce\ObjectHydrator\MapFrom;

abstract readonly class Tiet0C4E0F52
{
    ...
    "description": "The [comment](https:\\/\\/docs.github.com\\/enterprise-server@3.9\\/rest\\/pulls\\/comments#get-a-review-comment-for-a-pull-request) itself."
}';
    public const SCHEMA_TITLE        = 'Pull Request Review Comment';
    public const SCHEMA_DESCRIPTION  = 'The [comment](https://docs.github.com/enterprise-server@3.9/rest/pulls/comments#get-a-review-comment-for-a-pull-request) itself.';
