...
abstract readonly class Tiet51D9106A
{
    ...
    public string|null $nodeId, public Schema\WebhookMembershipAdded\Team\Parent_|null $parent, public string|null $permission, public string|null $privacy, #[MapFrom('repositories_url')]
