...
final readonly class WebhookDeployKeyDeleted
{
    ...
    "properties": {
        ...
        "key": {
            ...
            "description": "The [`deploy key`](https:\\/\\/docs.github.com\\/enterprise-server@3.9\\/rest\\/deploy-keys\\/deploy-keys#get-a-deploy-key) resource."
        },
        "organization": {
     ...
     * key: The [`deploy key`](https://docs.github.com/enterprise-server@3.9/rest/deploy-keys/deploy-keys#get-a-deploy-key) resource.
