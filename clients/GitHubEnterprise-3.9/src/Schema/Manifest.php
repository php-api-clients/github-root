...
final readonly class Manifest
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"name":"package-lock.json","file":{"source_location":"\\/src\\/build\\/package-lock.json"},"metadata":"generated","resolved":"generated"}';
     ...
     */
    public function __construct(public string $name, public ?Schema\Manifest\File $file, public string $metadata, public string $resolved)
    {
    }
}
