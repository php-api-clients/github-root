...
namespace ApiClients\Client\GitHubEnterprise\Schema\WebhookCheckSuiteRequested;
...
final readonly class CheckSuite
{
    ...
    "description": "The [check_suite](https:\\/\\/docs.github.com\\/enterprise-server@3.9\\/rest\\/checks\\/suites#get-a-check-suite)."
}';
    public const SCHEMA_TITLE        = '';
    public const SCHEMA_DESCRIPTION  = 'The [check_suite](https://docs.github.com/enterprise-server@3.9/rest/checks/suites#get-a-check-suite).';
