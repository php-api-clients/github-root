...
final readonly class WebhookProjectsV2ItemReordered
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookProjectsV2ItemReordered\Changes $changes, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimple $organization, #[MapFrom('projects_v2_item')]
