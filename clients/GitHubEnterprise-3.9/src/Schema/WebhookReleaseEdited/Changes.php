...
namespace ApiClients\Client\GitHubEnterprise\Schema\WebhookReleaseEdited;
...
final readonly class Changes
{
    ...
    public function __construct(public ?Schema\WebhookProjectEdited\Changes\Body $body, public ?Schema\WebhookLabelEdited\Changes\Name $name, #[MapFrom('make_latest')] public ?Schema\WebhookReleaseEdited\Changes\MakeLatest $makeLatest)
    {
    }
}
