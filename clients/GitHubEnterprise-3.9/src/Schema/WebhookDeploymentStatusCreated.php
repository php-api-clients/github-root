...
final readonly class WebhookDeploymentStatusCreated
{
    ...
    "properties": {
        ...
        "deployment": {
            ...
            "description": "The [deployment](https:\\/\\/docs.github.com\\/enterprise-server@3.9\\/rest\\/deployments\\/deployments#list-deployments)."
        },
        "deployment_status": {
            "required": [
                "url",
            ...
            "description": "The [deployment status](https:\\/\\/docs.github.com\\/enterprise-server@3.9\\/rest\\/deployments\\/statuses#list-deployment-statuses)."
        },
        "enterprise": {
            "title": "Enterprise",
            "required": [
    ...
    /**
     * deployment: The [deployment](https://docs.github.com/enterprise-server@3.9/rest/deployments/deployments#list-deployments).
     * deploymentStatus: The [deployment status](https://docs.github.com/enterprise-server@3.9/rest/deployments/statuses#list-deployment-statuses).
