...
namespace ApiClients\Client\GitHubEnterprise\Schema\Actions\CreateRequiredWorkflow\Request;
...
final readonly class ApplicationJson
{
     ...
     * selectedRepositoryIds: A list of repository IDs where you want to enable the required workflow. You can only provide a list of repository ids when the `scope` is set to `selected`.
     */
    public function __construct(#[MapFrom('workflow_file_path')]
    public string $workflowFilePath, #[MapFrom('repository_id')]
    public string $repositoryId, public string|null $scope, #[MapFrom('selected_repository_ids')]
