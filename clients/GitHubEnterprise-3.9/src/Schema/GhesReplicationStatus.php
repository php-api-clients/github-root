...
{
    public const SCHEMA_JSON         = '{"type":"object","properties":{"status":{"enum":["UNKNOWN","OK","WARNING","CRITICAL"],"type":"string"},"nodes":{"type":"array","items":{"type":"object","properties":{"hostname":{"type":"string"},"status":{"enum":["UNKNOWN","OK","WARNING","CRITICAL"],"type":"string"},"services":{"type":"array","items":{"type":"object","properties":{"status":{"enum":["UNKNOWN","OK","WARNING","CRITICAL"],"type":"string"},"name":{"type":"string"},"details":{"type":"string"}}}}}}}}}';
