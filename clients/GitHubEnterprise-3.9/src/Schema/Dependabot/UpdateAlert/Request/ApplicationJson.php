...
namespace ApiClients\Client\GitHubEnterprise\Schema\Dependabot\UpdateAlert\Request;
...
final readonly class ApplicationJson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"state":"dismissed","dismissed_reason":"tolerable_risk","dismissed_comment":"generated"}';
     ...
     */
    public function __construct(public string $state, #[MapFrom('dismissed_reason')] public ?string $dismissedReason, #[MapFrom('dismissed_comment')] public ?string $dismissedComment)
    {
    }
}
