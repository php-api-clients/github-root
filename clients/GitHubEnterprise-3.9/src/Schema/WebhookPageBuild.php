...
final readonly class WebhookPageBuild
{
    ...
    "properties": {
        "build": {
            ...
            "description": "The [List GitHub Pages builds](https:\\/\\/docs.github.com\\/enterprise-server@3.9\\/rest\\/pages\\/pages#list-github-pages-builds) itself."
        },
        "enterprise": {
            "title": "Enterprise",
            "required": [
    ...
    /**
     * build: The [List GitHub Pages builds](https://docs.github.com/enterprise-server@3.9/rest/pages/pages#list-github-pages-builds) itself.
