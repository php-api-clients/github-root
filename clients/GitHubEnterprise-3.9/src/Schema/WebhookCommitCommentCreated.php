...
final readonly class WebhookCommitCommentCreated
{
    ...
    "properties": {
        ...
        "comment": {
            ...
            "description": "The [commit comment](https:\\/\\/docs.github.com\\/enterprise-server@3.9\\/rest\\/commits\\/comments#get-a-commit-comment) resource."
        },
        "enterprise": {
            "title": "Enterprise",
            "required": [
     ...
     * comment: The [commit comment](https://docs.github.com/enterprise-server@3.9/rest/commits/comments#get-a-commit-comment) resource.
