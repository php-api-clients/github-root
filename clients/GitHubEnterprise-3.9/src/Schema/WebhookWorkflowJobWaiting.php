...
final readonly class WebhookWorkflowJobWaiting
{
    ...
    public Schema\WebhookWorkflowJobWaiting\WorkflowJob $workflowJob, public Schema\Deployment|null $deployment,)
    {
    }
}
