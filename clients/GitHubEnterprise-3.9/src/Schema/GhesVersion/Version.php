...
{
    public const SCHEMA_JSON         = '{"type":"object","properties":{"version":{"pattern":"[0-9]\\\\.[0-9]{2}\\\\.[0-9]","type":"string"},"platform":{"enum":["ami","azure","esx","gce","hyperv","kvm"],"type":"string"},"build_id":{"pattern":"[0-9a-f]{8}","type":"string"},"build_date":{"type":"string","format":"date"}}}';
