...
final class Hydrators implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            ...
            '\\ApiClients\\Client\\GitHubEnterprise\\Schema\\OrganizationCustomRepositoryRole' => $this->getObjectMapperOperation🌀Orgs🌀Org🌀CustomRepositoryRoles()->hydrateObject($className, $payload),
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        return match ($className) {
            ...
            '\\ApiClients\\Client\\GitHubEnterprise\\Schema\\OrganizationCustomRepositoryRole' => $this->getObjectMapperOperation🌀Orgs🌀Org🌀CustomRepositoryRoles()->serializeObject($object),
