...
final readonly class GetAllPackageVersionsForPackageOwnedByOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Packages\GetAllPackageVersionsForPackageOwnedByOrg($this->responseSchemaValidator, $this->hydrator, $packageType, $packageName, $org, $page, $perPage, $state);
