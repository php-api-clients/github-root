...
final readonly class DeletePackageVersionForUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Packages\DeletePackageVersionForUser($this->responseSchemaValidator, $this->hydrator, $packageType, $packageName, $username, $packageVersionId);
