...
final readonly class GetPackageForUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Packages\GetPackageForUser($this->responseSchemaValidator, $this->hydrator, $packageType, $packageName, $username);
