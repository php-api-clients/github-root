...
final readonly class ListPackagesForUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Packages\ListPackagesForUser($this->responseSchemaValidator, $this->hydrator, $packageType, $visibility, $username, $page, $perPage);
