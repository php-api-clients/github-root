...
final readonly class ListPackagesForOrganizationListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Packages\ListPackagesForOrganizationListing($this->responseSchemaValidator, $this->hydrator, $packageType, $org, $visibility, $page, $perPage);
