...
final readonly class DeletePackageVersionForOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Packages\DeletePackageVersionForOrg($this->responseSchemaValidator, $this->hydrator, $packageType, $packageName, $org, $packageVersionId);
