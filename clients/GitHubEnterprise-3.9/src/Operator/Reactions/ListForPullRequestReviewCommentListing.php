...
final readonly class ListForPullRequestReviewCommentListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Reactions\ListForPullRequestReviewCommentListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $commentId, $content, $perPage, $page);
