...
namespace ApiClients\Client\GitHubEnterprise\Operator\RateLimit;
...
final readonly class Get
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\RateLimit\Get($this->responseSchemaValidator, $this->hydrator);
