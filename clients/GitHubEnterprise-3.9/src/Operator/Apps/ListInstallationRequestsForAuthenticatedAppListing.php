...
final readonly class ListInstallationRequestsForAuthenticatedAppListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Apps\ListInstallationRequestsForAuthenticatedAppListing($this->responseSchemaValidator, $this->hydrator, $perPage, $page);
