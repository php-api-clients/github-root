...
final readonly class CreateInstallationAccessToken
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Apps\CreateInstallationAccessToken($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $installationId);
