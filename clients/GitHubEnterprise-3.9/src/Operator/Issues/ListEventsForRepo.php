...
final readonly class ListEventsForRepo
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Issues\ListEventsForRepo($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
