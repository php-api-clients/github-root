...
use ApiClients\Client\GitHubEnterprise\Schema\Operations\Actions\ListRepoRequiredWorkflows\Response\ApplicationJson\Ok;
...
final readonly class ListRepoRequiredWorkflows
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $responseSchemaValidator, private Hydrator\Operation\Repos\Org\Repo\Actions\RequiredWorkflows $hydrator)
    {
    }
