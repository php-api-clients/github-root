...
final readonly class GetEnvironmentSecret
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Actions\GetEnvironmentSecret($this->responseSchemaValidator, $this->hydrator, $repositoryId, $environmentName, $secretName);
