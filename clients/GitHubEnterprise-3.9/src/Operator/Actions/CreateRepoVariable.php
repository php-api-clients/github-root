...
final readonly class CreateRepoVariable
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Actions\CreateRepoVariable($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo);
