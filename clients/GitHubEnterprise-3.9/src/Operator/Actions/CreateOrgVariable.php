...
final readonly class CreateOrgVariable
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Actions\CreateOrgVariable($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $org);
