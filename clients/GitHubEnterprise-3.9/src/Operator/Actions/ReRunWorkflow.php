...
final readonly class ReRunWorkflow
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Actions\ReRunWorkflow($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $runId);
