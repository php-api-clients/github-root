...
use ApiClients\Client\GitHubEnterprise\Schema\Operations\Actions\ListRequiredWorkflows\Response\ApplicationJson\Ok;
...
final readonly class ListRequiredWorkflows
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Actions\ListRequiredWorkflows($this->responseSchemaValidator, $this->hydrator, $org, $perPage, $page);
