...
final readonly class ListWorkflowRunArtifacts
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Actions\ListWorkflowRunArtifacts($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $runId, $perPage, $page);
