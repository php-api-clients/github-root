...
final readonly class ListReleasesListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Repos\ListReleasesListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
