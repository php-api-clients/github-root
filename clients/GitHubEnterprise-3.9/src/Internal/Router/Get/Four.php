...
final class Four
{
    ...
    /** @return |Observable<Schema\HookDeliveryItem>|Schema\ApplicationGrant|array{code:int}|Observable<Schema\AuditLogEvent>|Observable<Schema\GistComment>|Observable<Schema\GistCommit>|Observable<Schema\GistSimple>|Schema\GitignoreTemplate|Observable<Schema\GhesVersion>|Schema\Thread|Observable<Schema\Event>|Observable<Schema\OrgHook>|Observable<Schema\Issue>|Observable<Schema\SimpleUser>|Observable<Schema\Migration>|Observable<Schema\Package>|Observable<Schema\OrgPreReceiveHook>|Observable<Schema\Project>|Observable<Schema\MinimalRepository>|Observable<Schema\RepositoryFineGrainedPermission>|Observable<Schema\TeamSimple>|Observable<Schema\Team>|Schema\ProjectColumn|Observable<Schema\ProjectColumn>|Schema\ScimEnterpriseGroupList|Schema\ScimEnterpriseUserList|Schema\ConfigurationStatus|Schema\MaintenanceStatus|Schema\EnterpriseSettings|Observable<Schema\TeamDiscussion>|Observable<Schema\TeamProject>|Schema\GpgKey|Schema\Key|Observable<Schema\OrgMembership>|Schema\SshSigningKey|Observable<Schema\BaseGist>|Observable<Schema\GpgKey>|Observable<Schema\KeySimple>|Observable<Schema\OrganizationSimple>|Observable<Schema\SocialAccount>|Observable<Schema\SshSigningKey> */
