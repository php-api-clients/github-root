...
final class Six
{
    ...
    /** @return Schema\PreReceiveEnvironmentDownloadStatus|Schema\ActionsCacheUsageOrgEnterprise|Schema\ActionsCacheUsagePolicyEnterprise|Schema\Operations\EnterpriseAdmin\ListSelectedOrganizationsEnabledGithubActionsEnterprise\Response\ApplicationJson\Ok|Schema\SelectedActions|Schema\ActionsGetDefaultWorkflowPermissions|Schema\RunnerGroupsEnterprise|iterable<Schema\RunnerApplication>|Schema\Runner|Schema\AdvancedSecurityActiveCommitters|Schema\Operations\Actions\GetActionsCacheUsageByRepoForOrg\Response\ApplicationJson\Ok|Schema\Operations\Actions\ListSelectedRepositoriesEnabledGithubActionsOrganization\Response\ApplicationJson\Ok|Schema\RunnerGroupsOrg|Schema\ActionsPublicKey|Schema\OrganizationActionsSecret|Schema\OrganizationActionsVariable|Schema\DependabotPublicKey|Schema\OrganizationDependabotSecret|Schema\WebhookConfig|iterable<Schema\HookDeliveryItem>|array{code:int}|iterable<Schema\MinimalRepository>|Schema\Package|iterable<Schema\TeamDiscussion>|Schema\ExternalGroups|iterable<Schema\SimpleUser>|iterable<Schema\TeamProject>|iterable<Schema\Team>|Schema\ProjectCollaboratorPermission|Schema\Operations\Actions\ListArtifactsForRepo\Response\ApplicationJson\Ok|Schema\ActionsCacheList|Schema\Operations\Actions\ListRepoOrganizationSecrets\Response\ApplicationJson\Ok|Schema\Operations\Actions\ListRepoOrganizationVariables\Response\ApplicationJson\Ok|Schema\ActionsRepositoryPermissions|Schema\Operations\Actions\ListSelfHostedRunnersForRepo\Response\ApplicationJson\Ok\Application\Json|Schema\Operations\Actions\ListWorkflowRunsForRepo\Response\ApplicationJson\Ok|Schema\Operations\Actions\ListRepoSecrets\Response\ApplicationJson\Ok\Application\Json|Schema\Operations\Actions\ListRepoVariables\Response\ApplicationJson\Ok\Application\Json|Schema\Operations\Actions\ListRepoWorkflows\Response\ApplicationJson\Ok|Schema\Autolink|Schema\BranchWithProtection|Schema\BasicError|Schema\CheckRun|Schema\CheckSuite|iterable<Schema\CodeScanningAlertItems>|iterable<Schema\CodeScanningAnalysis>|Schema\CodeScanningDefaultSetup|Schema\CodeownersErrors|Schema\CommitComment|Schema\Commit|Schema\CommitComparison|Schema\ContentDirectory|Schema\ContentFile|Schema\ContentSymlink|Schema\ContentSubmodule|iterable<Schema\DependabotAlert>|Schema\Operations\Dependabot\ListRepoSecrets\Response\ApplicationJson\Ok|Schema\DependencyGraphSpdxSbom|Schema\Deployment|Schema\Environment|Schema\Hook|iterable<Schema\IssueComment>|iterable<Schema\IssueEvent>|Schema\Issue|Schema\DeployKey|Schema\Label|Schema\Milestone|iterable<Schema\PageBuild>|Schema\RepositoryPreReceiveHook|iterable<Schema\PullRequestReviewComment>|Schema\PullRequest|Schema\Release|iterable<Schema\Operations\Repos\ListCacheInfo\Response\ApplicationJson\Ok>|iterable<Schema\SecretScanningAlert>|iterable<int>|Schema\Operations\Repos\GetCodeFrequencyStats\Response\ApplicationJson\Accepted\Application\Json|iterable<Schema\CommitActivity>|Schema\Operations\Repos\GetCommitActivityStats\Response\ApplicationJson\Accepted\Application\Json|iterable<Schema\ContributorActivity>|Schema\Operations\Repos\GetContributorsStats\Response\ApplicationJson\Accepted\Application\Json|Schema\ParticipationStats|iterable<Schema\TagProtection>|array{code:int,location:string}|Schema\Operations\Actions\ListEnvironmentSecrets\Response\ApplicationJson\Ok\Application\Json|Schema\Operations\Actions\ListEnvironmentVariables\Response\ApplicationJson\Ok\Application\Json|iterable<Schema\TeamDiscussionComment>|iterable<Schema\Reaction>|Schema\TeamRepository|iterable<Schema\PackageVersion>|iterable<Schema\Event> */
