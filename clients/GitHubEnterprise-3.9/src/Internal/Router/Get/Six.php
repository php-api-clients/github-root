...
final class Six
{
    ...
    /** @return |Schema\Operations\EnterpriseAdmin\ListSelectedOrganizationsEnabledGithubActionsEnterprise\Response\ApplicationJson\Ok|Observable<Schema\RunnerApplication>|Schema\AdvancedSecurityActiveCommitters|Schema\Operations\Actions\GetActionsCacheUsageByRepoForOrg\Response\ApplicationJson\Ok|Schema\Operations\Actions\ListSelectedRepositoriesEnabledGithubActionsOrganization\Response\ApplicationJson\Ok|iterable<int,Schema\HookDeliveryItem>|iterable<int,Schema\MinimalRepository>|iterable<int,Schema\TeamDiscussion>|iterable<int,Schema\SimpleUser>|iterable<int,Schema\TeamProject>|iterable<int,Schema\Team>|Schema\Operations\Actions\ListArtifactsForRepo\Response\ApplicationJson\Ok|Schema\ActionsCacheList|Schema\Operations\Actions\ListRepoOrganizationSecrets\Response\ApplicationJson\Ok|Schema\Operations\Actions\ListRepoOrganizationVariables\Response\ApplicationJson\Ok|Schema\Operations\Actions\ListSelfHostedRunnersForRepo\Response\ApplicationJson\Ok\Application\Json|Schema\Operations\Actions\ListWorkflowRunsForRepo\Response\ApplicationJson\Ok|Schema\Operations\Actions\ListRepoSecrets\Response\ApplicationJson\Ok\Application\Json|Schema\Operations\Actions\ListRepoVariables\Response\ApplicationJson\Ok\Application\Json|Schema\Operations\Actions\ListRepoWorkflows\Response\ApplicationJson\Ok|iterable<int,Schema\CodeScanningAlertItems>|\ApiClients\Tools\OpenApiClient\Utils\Response\WithoutBody|iterable<int,Schema\CodeScanningAnalysis>|Schema\Commit|Schema\CommitComparison|iterable<int,Schema\DependabotAlert>|Schema\Operations\Dependabot\ListRepoSecrets\Response\ApplicationJson\Ok|iterable<int,Schema\IssueComment>|iterable<int,Schema\IssueEvent>|iterable<int,Schema\PageBuild>|iterable<int,Schema\PullRequestReviewComment>|iterable<int,Schema\Operations\Repos\ListCacheInfo\Response\ApplicationJson\Ok>|iterable<int,Schema\SecretScanningAlert>|Observable<int>|Schema\Operations\Repos\GetCodeFrequencyStats\Response\ApplicationJson\Accepted\Application\Json|WithoutBody|Observable<Schema\CommitActivity>|Schema\Operations\Repos\GetCommitActivityStats\Response\ApplicationJson\Accepted\Application\Json|Observable<Schema\ContributorActivity>|Schema\Operations\Repos\GetContributorsStats\Response\ApplicationJson\Accepted\Application\Json|Observable<Schema\TagProtection>|Schema\Operations\Actions\ListEnvironmentSecrets\Response\ApplicationJson\Ok\Application\Json|Schema\Operations\Actions\ListEnvironmentVariables\Response\ApplicationJson\Ok\Application\Json|iterable<int,Schema\TeamDiscussionComment>|iterable<int,Schema\Reaction>|iterable<int,Schema\PackageVersion>|iterable<int,Schema\Event> */
