...
final class Four
{
    ...
    /** @return Schema\Integration|Schema\Authorization|Schema\GistComment|array{code:int}|Schema\BaseGist|Schema\OrganizationCustomRepositoryRole|Schema\OrgHook|Schema\Migration|Schema\Project|Schema\Repository|Schema\TeamFull|Schema\ProjectColumn|Schema\GroupResponse|Schema\UserResponse|Schema\MaintenanceStatus|Schema\TeamDiscussion */
    public function call(string $call, array $params, array $pathChunks): Integration|Authorization|GistComment|BaseGist|OrganizationCustomRepositoryRole|OrgHook|Migration|Project|Repository|TeamFull|ProjectColumn|GroupResponse|UserResponse|MaintenanceStatus|TeamDiscussion|array
    {
        if ($pathChunks[0] === '') {
