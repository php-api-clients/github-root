...
final readonly class SetSelectedReposForOrgSecret
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Dependabot\SetSelectedReposForOrgSecret($this->requestSchemaValidator, $org, $secretName);
