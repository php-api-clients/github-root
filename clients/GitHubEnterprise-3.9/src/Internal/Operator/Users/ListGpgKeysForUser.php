...
final readonly class ListGpgKeysForUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Users\ListGpgKeysForUser($this->responseSchemaValidator, $this->hydrator, $username, $perPage, $page);
