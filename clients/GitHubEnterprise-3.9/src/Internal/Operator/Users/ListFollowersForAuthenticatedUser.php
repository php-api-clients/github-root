...
final readonly class ListFollowersForAuthenticatedUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Users\ListFollowersForAuthenticatedUser($this->responseSchemaValidator, $this->hydrator, $perPage, $page);
