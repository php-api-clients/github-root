...
final readonly class ListReceivedPublicEventsForUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Activity\ListReceivedPublicEventsForUser($this->responseSchemaValidator, $this->hydrator, $username, $perPage, $page);
