...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Notifications\Threads;
...
use ApiClients\Client\GitHubEnterprise\Schema\Thread\Subject;
...
class ThreadId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Thread(array $payload): Thread
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Thread⚡️Subject(array $payload): Subject
    {
        $properties    = [];
        $missingFields = [];
        try {
