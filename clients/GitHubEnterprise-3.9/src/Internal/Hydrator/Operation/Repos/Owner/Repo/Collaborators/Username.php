...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Repos\Owner\Repo\Collaborators;
...
class Username implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️RepositoryInvitation(array $payload): RepositoryInvitation
    {
        $properties    = [];
        $missingFields = [];
        try {
