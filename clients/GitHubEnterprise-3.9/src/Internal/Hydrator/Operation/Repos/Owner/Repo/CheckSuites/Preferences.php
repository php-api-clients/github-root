...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Repos\Owner\Repo\CheckSuites;
...
class Preferences implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️CheckSuitePreference(array $payload): CheckSuitePreference
    {
        $properties    = [];
        $missingFields = [];
        try {
