...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Repos\Owner\Repo\Actions\Oidc\Customization;
...
class Sub implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️OidcCustomSubRepo(array $payload): OidcCustomSubRepo
    {
        $properties    = [];
        $missingFields = [];
        try {
