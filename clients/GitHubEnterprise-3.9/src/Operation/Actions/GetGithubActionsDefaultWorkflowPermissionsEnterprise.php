...
final class GetGithubActionsDefaultWorkflowPermissionsEnterprise
{
    ...
    private readonly Hydrator\Operation\Enterprises\Enterprise\Actions\Permissions\Workflow $hydrator;

    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Enterprises\Enterprise\Actions\Permissions\Workflow $hydrator, string $enterprise)
    {
