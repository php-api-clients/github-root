...
final class ListSocialAccountsForAuthenticatedUserListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\User\SocialAccounts $hydrator, int $perPage = 30, int $page = 1)
    {
