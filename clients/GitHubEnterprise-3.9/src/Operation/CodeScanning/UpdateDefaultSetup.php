...
final class UpdateDefaultSetup
{
    ...
    private readonly Hydrator\Operation\Repos\Owner\Repo\CodeScanning\DefaultSetup $hydrator;

    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\Owner\Repo\CodeScanning\DefaultSetup $hydrator, string $owner, string $repo)
    {
