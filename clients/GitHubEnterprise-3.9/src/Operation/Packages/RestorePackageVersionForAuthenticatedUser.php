...
final class RestorePackageVersionForAuthenticatedUser
{
    ...
    private readonly Hydrator\Operation\User\Packages\PackageType\PackageName\Versions\PackageVersionId\Restore $hydrator;

    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\User\Packages\PackageType\PackageName\Versions\PackageVersionId\Restore $hydrator, string $packageType, string $packageName, int $packageVersionId)
    {
