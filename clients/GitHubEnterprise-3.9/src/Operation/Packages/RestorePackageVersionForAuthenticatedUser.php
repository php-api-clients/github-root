...
final class RestorePackageVersionForAuthenticatedUser
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\User\Packages\PackageType\PackageName\Versions\PackageVersionId\Restore $hydrator, string $packageType, string $packageName, int $packageVersionId)
    {
