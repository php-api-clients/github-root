...
final class ListCacheInfo
{
    ...
    private readonly Hydrator\Operation\Repos\Owner\Repo\Replicas\Caches $hydrator;

    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\Owner\Repo\Replicas\Caches $hydrator, string $owner, string $repo, int $perPage = 30, int $page = 1)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
