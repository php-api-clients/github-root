...
final class Four
{
    ...
    /** @return |iterable<Schema\HookDeliveryItem>|Schema\ApplicationGrant|array{code:int}|iterable<Schema\AuditLogEvent>|iterable<Schema\GistComment>|iterable<Schema\GistCommit>|iterable<Schema\GistSimple>|Schema\GitignoreTemplate|iterable<Schema\GhesVersion>|Schema\Thread|iterable<Schema\Event>|iterable<Schema\OrgHook>|iterable<Schema\Issue>|iterable<Schema\SimpleUser>|iterable<Schema\Migration>|iterable<Schema\Package>|iterable<Schema\OrgPreReceiveHook>|iterable<Schema\Project>|iterable<Schema\MinimalRepository>|iterable<Schema\RepositoryFineGrainedPermission>|iterable<Schema\TeamSimple>|iterable<Schema\Team>|Schema\ProjectColumn|iterable<Schema\ProjectColumn>|Schema\ScimEnterpriseGroupList|Schema\ScimEnterpriseUserList|Schema\ConfigurationStatus|Schema\MaintenanceStatus|Schema\EnterpriseSettings|iterable<Schema\TeamDiscussion>|iterable<Schema\TeamProject>|Schema\GpgKey|Schema\Key|iterable<Schema\OrgMembership>|Schema\SshSigningKey|iterable<Schema\BaseGist>|iterable<Schema\GpgKey>|iterable<Schema\KeySimple>|iterable<Schema\OrganizationSimple>|iterable<Schema\SocialAccount>|iterable<Schema\SshSigningKey>|Schema\StarredRepository|Schema\Repository */
