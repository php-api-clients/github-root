...
final class Orgs
{
    ...
    public function listCustomRoles(array $params): Ok|array
    {
        ...
        $operator = new Operator\Orgs\ListCustomRoles($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Organizations🌀OrganizationId🌀CustomRoles());
    ...
    public function listCustomRepoRoles(array $params): Json|array
    {
        ...
        $arguments['org'] = $params['org'];
        unset($params['org']);
        $operator = new Operator\Orgs\ListCustomRepoRoles($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀CustomRepositoryRoles());
    ...
    public function listPublicMembers(array $params): iterable
    {
        ...
        $arguments['page'] = $params['page'];
        unset($params['page']);
        $operator = new Operator\Orgs\ListPublicMembers($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀PublicMembers());
    ...
    public function listRepoFineGrainedPermissions(array $params): iterable
    {
        ...
        $arguments['org'] = $params['org'];
        unset($params['org']);
        $operator = new Operator\Orgs\ListRepoFineGrainedPermissions($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀RepositoryFineGrainedPermissions());
    ...
    public function listSecurityManagerTeams(array $params): iterable
    {
        ...
        $arguments['org'] = $params['org'];
        unset($params['org']);
        $operator = new Operator\Orgs\ListSecurityManagerTeams($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀SecurityManagers());
    ...
    public function getCustomRepoRole(array $params): OrganizationCustomRepositoryRole|array
    {
        ...
        $operator = new Operator\Orgs\GetCustomRepoRole($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀CustomRepositoryRoles🌀RoleId());
