...
final class OauthAuthorizations
{
    ...
    public function deleteGrant(array $params): array
    {
        ...
        $operator = new Operator\OauthAuthorizations\DeleteGrant($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Applications🌀Grants🌀GrantId());
    ...
    public function deleteAuthorization(array $params): array
    {
        ...
        $operator = new Operator\OauthAuthorizations\DeleteAuthorization($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Authorizations🌀AuthorizationId());
