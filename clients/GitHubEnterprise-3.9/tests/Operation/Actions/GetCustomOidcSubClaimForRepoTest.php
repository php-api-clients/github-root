...
final class GetCustomOidcSubClaimForRepoTest extends AsyncTestCase
{
    ...
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], Schema\OidcCustomSubRepo::SCHEMA_EXAMPLE_DATA);
        ...
        $result = $client->call(Operation\Actions\GetCustomOidcSubClaimForRepo::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repos/generated/generated/actions/oidc/customization/sub', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = await($client->operations()->actions()->getCustomOidcSubClaimForRepo('generated', 'generated'));
    }
