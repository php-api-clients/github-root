...
final class ListSelectedRepositoriesRequiredWorkflowTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/orgs/generated/actions/required_workflows/20/repositories', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Operation\Actions\ListSelectedRepositoriesRequiredWorkflow::OPERATION_MATCH, (static function (array $data): array {
            $data['org']                  = 'generated';
