...
final class CreateCustomRepoRoleTest extends AsyncTestCase
{
    ...
    public function call_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/orgs/generated/custom-repository-roles', Argument::type('array'), Schema\OrganizationCustomRepositoryRoleCreateSchema::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Operation\Orgs\CreateCustomRepoRole::OPERATION_MATCH, (static function (array $data): array {
            $data['org'] = 'generated';
