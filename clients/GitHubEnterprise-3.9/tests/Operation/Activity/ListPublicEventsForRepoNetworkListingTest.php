...
/** @covers \ApiClients\Client\GitHubEnterprise\Operation\Activity\ListPublicEventsForRepoNetworkListing */
final class ListPublicEventsForRepoNetworkListingTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/networks/generated/generated/events?per_page=8&page=1', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Operation\Activity\ListPublicEventsForRepoNetworkListing::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/networks/generated/generated/events?per_page=8&page=1', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->activity()->listPublicEventsForRepoNetworkListing('generated', 'generated', 8, 1);
        foreach ($result as $item) {
        }
    }
