...
final readonly class ClientCallReturnTypes implements DynamicMethodReturnTypeExtension
{
    ...
    public function getTypeFromMethodCall(MethodReflection $methodReflection, MethodCall $methodCall, Scope $scope): Type|null
    {
        ...
        if ($call === 'GET /manage/v1/access/ssh') {
            return $this->typeResolver->resolve('Observable<Schema\\GhesGetSsh>|WithoutBody');
        }

        if ($call === 'POST /manage/v1/access/ssh') {
            return $this->typeResolver->resolve('Observable<Schema\\GhesSetSshResponse>|WithoutBody');
        }

        if ($call === 'DELETE /manage/v1/access/ssh') {
            return $this->typeResolver->resolve('Observable<Schema\\GhesDeleteSshResponse>|WithoutBody');
        }
        ...
        if ($call === 'PUT /manage/v1/config/license') {
            return $this->typeResolver->resolve('Observable<Schema\\GhesLicenseUpload>|WithoutBody');
        }
