...
final readonly class ApplicationJson
{
    ...
    "properties": {
        ...
        "events": {
            ...
            "description": "Determines what [events](https:\\/\\/docs.github.com\\/enterprise-server@3.12\\/webhooks\\/event-payloads) the hook is triggered for. This replaces the entire array of events.",
            "default": [
                "push"
            ]
        },
     ...
     * events: Determines what [events](https://docs.github.com/enterprise-server@3.12/webhooks/event-payloads) the hook is triggered for. This replaces the entire array of events.
