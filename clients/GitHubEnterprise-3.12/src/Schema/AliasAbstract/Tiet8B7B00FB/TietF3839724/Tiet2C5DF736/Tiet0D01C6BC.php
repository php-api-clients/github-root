...
namespace ApiClients\Client\GitHubEnterprise\Schema\AliasAbstract\Tiet8B7B00FB\TietF3839724\Tiet2C5DF736;

use ApiClients\Client\GitHubEnterprise\Schema;
use EventSauce\ObjectHydrator\MapFrom;

abstract readonly class Tiet0D01C6BC
{
    ...
    public const SCHEMA_DESCRIPTION  = 'The [release](https://docs.github.com/enterprise-server@3.12/rest/releases/releases/#get-a-release) object.';
