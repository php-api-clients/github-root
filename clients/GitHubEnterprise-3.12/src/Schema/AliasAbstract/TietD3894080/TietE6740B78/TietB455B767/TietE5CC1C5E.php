...
namespace ApiClients\Client\GitHubEnterprise\Schema\AliasAbstract\TietD3894080\TietE6740B78\TietB455B767;

use EventSauce\ObjectHydrator\MapFrom;

abstract readonly class TietE5CC1C5E
{
     ...
     * secret: If provided, the `secret` will be used as the `key` to generate the HMAC hex digest value for [delivery signature headers](https://docs.github.com/enterprise-server@3.12/webhooks/event-payloads/#delivery-headers).
     */
