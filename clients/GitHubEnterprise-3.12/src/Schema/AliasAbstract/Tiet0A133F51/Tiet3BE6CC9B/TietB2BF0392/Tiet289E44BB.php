...
namespace ApiClients\Client\GitHubEnterprise\Schema\AliasAbstract\Tiet0A133F51\Tiet3BE6CC9B\TietB2BF0392;

use EventSauce\ObjectHydrator\MapFrom;

abstract readonly class Tiet289E44BB
{
    ...
    public const SCHEMA_DESCRIPTION  = 'The [`deploy key`](https://docs.github.com/enterprise-server@3.12/rest/deploy-keys/deploy-keys#get-a-deploy-key) resource.';
