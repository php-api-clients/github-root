                ...
                if ($pathChunks[2] === 'v1') {
                    if ($pathChunks[3] === 'config') {
                        if ($pathChunks[4] === 'license') {
                            if ($call === 'PUT /manage/v1/config/license') {
                                return $this->routers->internal🔀Router🔀Put🔀EnterpriseAdmin()->licenseUpload($params);
                            }
                        } elseif ($pathChunks[4] === 'settings') {
                            if ($call === 'PUT /manage/v1/config/settings') {
                                return $this->routers->internal🔀Router🔀Put🔀EnterpriseAdmin()->setManageSettings($params);
                            }
                        }
                    }
                }
