...
final readonly class EnableOrDisableSecurityProductOnAllOrgRepos
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Orgs\EnableOrDisableSecurityProductOnAllOrgRepos($this->requestSchemaValidator, $org, $securityProduct, $enablement);
