...
final readonly class RemoveOutsideCollaborator
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Orgs\RemoveOutsideCollaborator($this->responseSchemaValidator, $this->hydrator, $org, $username);
