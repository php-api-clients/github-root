...
final readonly class ListRepoWorkflows
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Actions\ListRepoWorkflows($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
