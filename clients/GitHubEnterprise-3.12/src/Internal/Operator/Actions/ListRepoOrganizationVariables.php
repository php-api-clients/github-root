...
final readonly class ListRepoOrganizationVariables
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Actions\ListRepoOrganizationVariables($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
