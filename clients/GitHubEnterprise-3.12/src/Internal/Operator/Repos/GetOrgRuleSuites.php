...
final readonly class GetOrgRuleSuites
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Repos\GetOrgRuleSuites($this->responseSchemaValidator, $this->hydrator, $org, $repositoryName, $actorName, $timePeriod, $ruleSuiteResult, $perPage, $page);
