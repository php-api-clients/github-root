...
final class Operators
{
    ...
    public function enterpriseAdmin👷LicenseUpload(): Internal\Operator\EnterpriseAdmin\LicenseUpload
    {
        if ($this->enterpriseAdmin👷LicenseUpload instanceof Internal\Operator\EnterpriseAdmin\LicenseUpload === false) {
            $this->enterpriseAdmin👷LicenseUpload = new Internal\Operator\EnterpriseAdmin\LicenseUpload($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Manage🌀V1🌀Config🌀License());
        }
