...
final class GetRepoRuleSuite
{
    ...
    To get this ID, you can use [GET /repos/{owner}/{repo}/rulesets/rule-suites](https://docs.github.com/enterprise-server@3.12/rest/repos/rule-suites#list-repository-rule-suites)
    for repositories and [GET /orgs/{org}/rulesets/rule-suites](https://docs.github.com/enterprise-server@3.12/rest/orgs/rule-suites#list-organization-rule-suites)
    for organizations. **/
