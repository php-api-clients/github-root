...
final class ListPublicOrgEventsListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Orgs\Org\Events $hydrator, string $org, int $perPage = 30, int $page = 1)
    {
        $this->org     = $org;
