...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Admin\PreReceiveEnvironments\PreReceiveEnvironmentId;

use ApiClients\Client\GitHubEnterprise\Schema\Operations\EnterpriseAdmin\StartPreReceiveEnvironmentDownload\Response\ApplicationJson\UnprocessableEntity\Application\Json;
...
class Downloads implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️PreReceiveEnvironmentDownloadStatus(array $payload): PreReceiveEnvironmentDownloadStatus
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Operations⚡️EnterpriseAdmin⚡️StartPreReceiveEnvironmentDownload⚡️Response⚡️ApplicationJson⚡️UnprocessableEntity⚡️Application⚡️Json(array $payload): Json
    {
        $properties    = [];
        $missingFields = [];
        try {
