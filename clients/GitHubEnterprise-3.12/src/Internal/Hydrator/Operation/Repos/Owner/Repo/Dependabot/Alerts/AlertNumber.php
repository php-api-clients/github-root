...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Repos\Owner\Repo\Dependabot\Alerts;
...
class AlertNumber implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️DependabotAlert(array $payload): DependabotAlert
    {
        $properties    = [];
        $missingFields = [];
        try {
