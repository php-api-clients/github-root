...
use ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnCreated;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnDeleted;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnEdited;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnEdited\Changes;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnEdited\Changes\Name;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnMoved;
...
class ProjectColumn implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnCreated' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnCreated($payload),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnCreated\ProjectColumn' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnCreated⚡️ProjectColumn($payload),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnDeleted' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnDeleted($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnDeleted\ProjectColumn' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnDeleted⚡️ProjectColumn($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnEdited' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnEdited($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnEdited\Changes' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnEdited⚡️Changes($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnEdited\Changes\Name' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnEdited⚡️Changes⚡️Name($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnEdited\ProjectColumn' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnEdited⚡️ProjectColumn($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnMoved' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnMoved($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnMoved\ProjectColumn' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnMoved⚡️ProjectColumn($payload),
            default => throw UnableToHydrateObject::noHydrationDefined($className, $this->hydrationStack),
        };
    }

    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnCreated(array $payload): WebhookProjectColumnCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnCreated⚡️ProjectColumn($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnCreated', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnCreated⚡️ProjectColumn(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnCreated\ProjectColumn
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnCreated\ProjectColumn', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnCreated\ProjectColumn::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnCreated\ProjectColumn(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnCreated\ProjectColumn', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnDeleted(array $payload): WebhookProjectColumnDeleted
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'projectColumn';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnDeleted⚡️ProjectColumn($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnDeleted', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnDeleted⚡️ProjectColumn(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnDeleted\ProjectColumn
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnDeleted\ProjectColumn', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnDeleted\ProjectColumn::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnDeleted\ProjectColumn(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnDeleted\ProjectColumn', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnEdited(array $payload): WebhookProjectColumnEdited
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnEdited⚡️Changes($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'projectColumn';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnEdited⚡️ProjectColumn($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnEdited', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnEdited⚡️Changes(array $payload): Changes
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnEdited⚡️Changes⚡️Name($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnEdited\Changes', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnEdited⚡️Changes⚡️Name(array $payload): Name
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnEdited\Changes\Name', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnEdited⚡️ProjectColumn(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnEdited\ProjectColumn
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnEdited\ProjectColumn', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnEdited\ProjectColumn::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnEdited\ProjectColumn(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnEdited\ProjectColumn', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnMoved(array $payload): WebhookProjectColumnMoved
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'projectColumn';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnMoved⚡️ProjectColumn($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnMoved', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnMoved⚡️ProjectColumn(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnMoved\ProjectColumn
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnMoved\ProjectColumn', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnMoved\ProjectColumn::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnMoved\ProjectColumn(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnMoved\ProjectColumn', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnCreated' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnCreated($object),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnCreated\ProjectColumn' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnCreated⚡️ProjectColumn($object),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnDeleted' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnDeleted($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnDeleted\ProjectColumn' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnDeleted⚡️ProjectColumn($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnEdited' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnEdited($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnEdited\Changes' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnEdited⚡️Changes($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnEdited\Changes\Name' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnEdited⚡️Changes⚡️Name($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnCreated(mixed $object): mixed
    {
        ...
        $projectColumn                                        = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnCreated⚡️ProjectColumn($projectColumn);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnCreated⚡️ProjectColumn(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnCreated\ProjectColumn);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnDeleted(mixed $object): mixed
    {
        ...
        $projectColumn                                        = $object->projectColumn;
        $projectColumn                                        = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnDeleted⚡️ProjectColumn($projectColumn);
        after_projectColumn:        $result['project_column'] = $projectColumn;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnDeleted⚡️ProjectColumn(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnDeleted\ProjectColumn);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnEdited(mixed $object): mixed
    {
        ...
        $changes                                 = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnEdited⚡️Changes($changes);
        ...
        $projectColumn                                        = $object->projectColumn;
        $projectColumn                                        = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnEdited⚡️ProjectColumn($projectColumn);
        after_projectColumn:        $result['project_column'] = $projectColumn;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnEdited⚡️Changes(mixed $object): mixed
    {
        ...
        $name                              = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnEdited⚡️Changes⚡️Name($name);
        after_name:        $result['name'] = $name;

        return $result;
    }

    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnEdited⚡️Changes⚡️Name(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnEdited⚡️ProjectColumn(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnEdited\ProjectColumn);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnMoved(mixed $object): mixed
    {
        ...
        $projectColumn                                        = $object->projectColumn;
        $projectColumn                                        = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnMoved⚡️ProjectColumn($projectColumn);
        after_projectColumn:        $result['project_column'] = $projectColumn;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectColumnMoved⚡️ProjectColumn(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectColumnMoved\ProjectColumn);
        $result = [];
