...
assertType('', $client->call('GET /repositories/{repository_id}/environments/{environment_name}/secrets'));
...
assertType('', $client->call('GET /repositories/{repository_id}/environments/{environment_name}/variables'));
