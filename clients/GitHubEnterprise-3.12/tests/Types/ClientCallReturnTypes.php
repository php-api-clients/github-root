...
assertType('', $client->call('PATCH /admin/ldap/teams/{team_id}/mapping'));
assertType('', $client->call('POST /admin/ldap/teams/{team_id}/sync'));
assertType('', $client->call('PATCH /admin/ldap/users/{username}/mapping'));
assertType('', $client->call('POST /admin/ldap/users/{username}/sync'));
...
assertType('Observable<Schema\\PreReceiveHook>', $client->call('GET /admin/pre-receive-hooks'));
assertType('Observable<Schema\\PreReceiveHook>', $client->call('LIST /admin/pre-receive-hooks'));
assertType('', $client->call('POST /admin/pre-receive-hooks'));
assertType('', $client->call('GET /admin/pre-receive-hooks/{pre_receive_hook_id}'));
assertType('', $client->call('DELETE /admin/pre-receive-hooks/{pre_receive_hook_id}'));
assertType('', $client->call('PATCH /admin/pre-receive-hooks/{pre_receive_hook_id}'));
...
assertType('', $client->call('POST /admin/users'));
assertType('', $client->call('DELETE /admin/users/{username}'));
assertType('', $client->call('PATCH /admin/users/{username}'));
...
assertType('Observable<Schema\\ApplicationGrant>|WithoutBody', $client->call('GET /applications/grants'));
assertType('Observable<Schema\\ApplicationGrant>|WithoutBody', $client->call('LIST /applications/grants'));
assertType('', $client->call('GET /applications/grants/{grant_id}'));
assertType('', $client->call('DELETE /applications/grants/{grant_id}'));
...
assertType('Observable<Schema\\Authorization>|WithoutBody', $client->call('GET /authorizations'));
assertType('Observable<Schema\\Authorization>|WithoutBody', $client->call('LIST /authorizations'));
assertType('', $client->call('POST /authorizations'));
assertType('', $client->call('PUT /authorizations/clients/{client_id}'));
assertType('', $client->call('PUT /authorizations/clients/{client_id}/{fingerprint}'));
assertType('', $client->call('GET /authorizations/{authorization_id}'));
assertType('', $client->call('DELETE /authorizations/{authorization_id}'));
assertType('', $client->call('PATCH /authorizations/{authorization_id}'));
...
assertType('', $client->call('GET /enterprise/stats/security-products'));
assertType('', $client->call('GET /enterprise/stats/users'));
assertType('', $client->call('GET /enterprises/{enterprise}/actions/cache/usage'));
assertType('', $client->call('GET /enterprises/{enterprise}/actions/cache/usage-policy'));
assertType('', $client->call('PATCH /enterprises/{enterprise}/actions/cache/usage-policy'));
...
assertType('', $client->call('GET /enterprises/{enterprise}/actions/permissions/workflow'));
assertType('', $client->call('PUT /enterprises/{enterprise}/actions/permissions/workflow'));
...
assertType('', $client->call('GET /enterprises/{enterprise}/actions/runner-groups/{runner_group_id}/organizations'));
assertType('', $client->call('PUT /enterprises/{enterprise}/actions/runner-groups/{runner_group_id}/organizations'));
assertType('', $client->call('PUT /enterprises/{enterprise}/actions/runner-groups/{runner_group_id}/organizations/{org_id}'));
assertType('', $client->call('DELETE /enterprises/{enterprise}/actions/runner-groups/{runner_group_id}/organizations/{org_id}'));
...
assertType('', $client->call('GET /enterprises/{enterprise}/actions/runners/{runner_id}/labels'));
assertType('', $client->call('PUT /enterprises/{enterprise}/actions/runners/{runner_id}/labels'));
assertType('', $client->call('POST /enterprises/{enterprise}/actions/runners/{runner_id}/labels'));
assertType('', $client->call('DELETE /enterprises/{enterprise}/actions/runners/{runner_id}/labels'));
assertType('', $client->call('DELETE /enterprises/{enterprise}/actions/runners/{runner_id}/labels/{name}'));
...
assertType('Observable<Schema\\GhesGetSsh>|WithoutBody', $client->call('GET /manage/v1/access/ssh'));
assertType('Observable<Schema\\GhesSetSshResponse>|WithoutBody', $client->call('POST /manage/v1/access/ssh'));
assertType('Observable<Schema\\GhesDeleteSshResponse>|WithoutBody', $client->call('DELETE /manage/v1/access/ssh'));
assertType('', $client->call('GET /manage/v1/checks/system-requirements'));
assertType('', $client->call('POST /manage/v1/config/init'));
assertType('', $client->call('GET /manage/v1/config/license'));
assertType('Observable<Schema\\GhesLicenseUpload>|WithoutBody', $client->call('PUT /manage/v1/config/license'));
assertType('', $client->call('GET /manage/v1/config/license/check'));
assertType('', $client->call('GET /manage/v1/config/nodes'));
assertType('', $client->call('GET /manage/v1/config/settings'));
assertType('', $client->call('PUT /manage/v1/config/settings'));
assertType('Observable<Schema\\GhesGetMaintenance>|WithoutBody', $client->call('GET /manage/v1/maintenance'));
assertType('Observable<Schema\\GhesSetMaintenanceResponse>|WithoutBody', $client->call('POST /manage/v1/maintenance'));
assertType('', $client->call('GET /manage/v1/replication/status'));
assertType('Observable<Schema\\GhesVersion>|WithoutBody', $client->call('GET /manage/v1/version'));
...
assertType('', $client->call('GET /orgs/{org}/custom-repository-roles'));
assertType('', $client->call('POST /orgs/{org}/custom-repository-roles'));
assertType('', $client->call('GET /orgs/{org}/custom-repository-roles/{role_id}'));
assertType('', $client->call('DELETE /orgs/{org}/custom-repository-roles/{role_id}'));
assertType('', $client->call('PATCH /orgs/{org}/custom-repository-roles/{role_id}'));
...
assertType('Observable<Schema\\OrgPreReceiveHook>', $client->call('GET /orgs/{org}/pre-receive-hooks'));
assertType('Observable<Schema\\OrgPreReceiveHook>', $client->call('LIST /orgs/{org}/pre-receive-hooks'));
assertType('', $client->call('GET /orgs/{org}/pre-receive-hooks/{pre_receive_hook_id}'));
assertType('', $client->call('DELETE /orgs/{org}/pre-receive-hooks/{pre_receive_hook_id}'));
assertType('', $client->call('PATCH /orgs/{org}/pre-receive-hooks/{pre_receive_hook_id}'));
...
assertType('', $client->call('GET /orgs/{org}/teams/{team_slug}/external-groups'));
...
assertType('', $client->call('GET /repos/{owner}/{repo}/actions/cache/usage-policy'));
assertType('', $client->call('PATCH /repos/{owner}/{repo}/actions/cache/usage-policy'));
...
assertType('', $client->call('DELETE /repos/{owner}/{repo}/pre-receive-hooks/{pre_receive_hook_id}'));
assertType('', $client->call('PATCH /repos/{owner}/{repo}/pre-receive-hooks/{pre_receive_hook_id}'));
...
assertType('Observable<Schema\\Operations\\Repos\\ListCacheInfo\\Response\\ApplicationJson\\Ok>', $client->call('GET /repos/{owner}/{repo}/replicas/caches'));
assertType('Observable<Schema\\Operations\\Repos\\ListCacheInfo\\Response\\ApplicationJson\\Ok>', $client->call('LIST /repos/{owner}/{repo}/replicas/caches'));
...
assertType('', $client->call('GET /scim/v2/Groups'));
assertType('', $client->call('POST /scim/v2/Groups'));
assertType('', $client->call('GET /scim/v2/Groups/{scim_group_id}'));
assertType('', $client->call('PUT /scim/v2/Groups/{scim_group_id}'));
assertType('', $client->call('DELETE /scim/v2/Groups/{scim_group_id}'));
assertType('', $client->call('PATCH /scim/v2/Groups/{scim_group_id}'));
assertType('', $client->call('GET /scim/v2/Users'));
assertType('', $client->call('POST /scim/v2/Users'));
assertType('', $client->call('GET /scim/v2/Users/{scim_user_id}'));
assertType('', $client->call('PUT /scim/v2/Users/{scim_user_id}'));
assertType('', $client->call('DELETE /scim/v2/Users/{scim_user_id}'));
assertType('', $client->call('PATCH /scim/v2/Users/{scim_user_id}'));
...
assertType('', $client->call('GET /setup/api/configcheck'));
assertType('', $client->call('POST /setup/api/configure'));
assertType('', $client->call('GET /setup/api/maintenance'));
assertType('', $client->call('POST /setup/api/maintenance'));
assertType('', $client->call('GET /setup/api/settings'));
assertType('', $client->call('PUT /setup/api/settings'));
assertType('Observable<Schema\\SshKey>|WithoutBody', $client->call('GET /setup/api/settings/authorized-keys'));
assertType('Observable<Schema\\SshKey>|WithoutBody', $client->call('POST /setup/api/settings/authorized-keys'));
assertType('Observable<Schema\\SshKey>|WithoutBody', $client->call('DELETE /setup/api/settings/authorized-keys'));
assertType('', $client->call('POST /setup/api/start'));
assertType('', $client->call('POST /setup/api/upgrade'));
...
assertType('', $client->call('PUT /users/{username}/site_admin'));
assertType('', $client->call('DELETE /users/{username}/site_admin'));
