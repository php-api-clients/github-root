...
/** @covers \ApiClients\Client\GitHubEnterprise\Internal\Operation\OauthAuthorizations\GetOrCreateAuthorizationForApp */
final class GetOrCreateAuthorizationForAppTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/authorizations/clients/generated', Argument::type('array'), json_encode(json_decode(Schema\OauthAuthorizations\GetOrCreateAuthorizationForApp\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\OauthAuthorizations\GetOrCreateAuthorizationForApp::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/authorizations/clients/generated', Argument::type('array'), json_encode(json_decode(Schema\OauthAuthorizations\GetOrCreateAuthorizationForApp\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->oauthAuthorizations()->getOrCreateAuthorizationForApp('generated', json_decode(Schema\OauthAuthorizations\GetOrCreateAuthorizationForApp\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
