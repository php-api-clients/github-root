...
/** @covers \ApiClients\Client\GitHubEnterprise\Internal\Operation\EnterpriseAdmin\SetManageSsh */
final class SetManageSshTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_400_requestContentType_application_json_empty(): void
    {
        ...
        $browser->request('POST', '/manage/v1/access/ssh', Argument::type('array'), json_encode(json_decode(Schema\GhesSetSshRequest::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\EnterpriseAdmin\SetManageSsh::OPERATION_MATCH, (static function (array $data): array {
            return $data;
        })(json_decode(Schema\GhesSetSshRequest::SCHEMA_EXAMPLE_DATA, true)));
    }
    ...
    public function operations_httpCode_400_requestContentType_application_json_empty(): void
    {
        ...
        $browser->request('POST', '/manage/v1/access/ssh', Argument::type('array'), json_encode(json_decode(Schema\GhesSetSshRequest::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->enterpriseAdmin()->setManageSsh(json_decode(Schema\GhesSetSshRequest::SCHEMA_EXAMPLE_DATA, true));
