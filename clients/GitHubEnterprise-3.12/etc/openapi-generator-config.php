...
return (static function (): Configuration {
    ...
    return new Configuration(
        ...
        new Gathering(
            '../../../etc/specs/GitHubEnterprise-3.12/current.spec.yaml',
            null,
        ...
        [
            new Package(
                new Package\Metadata(
                    'GitHub Enterprise (v3.12)',
                    'Fully type safe generated Non-Blocking first GitHub Enterprise (v3.12) REST API client',
                    [],
                ),
                'api-clients',
                'github-enterprise',
