...
class PullRequestReview implements ObjectMapper
{
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookPullRequestReviewDismissed⚡️PullRequest(mixed $object): mixed
    {
        ...
        $assignee = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookIssueCommentDeleted⚡️Comment⚡️User($assignee);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookIssuesAssigned⚡️Issue⚡️Milestone(mixed $object): mixed
    {
        ...
        $creator = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookIssueCommentDeleted⚡️Comment⚡️User($creator);
        after_creator:        $result['creator'] = $creator;
