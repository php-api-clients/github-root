...
class Discussion implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubAE\Schema\WebhookDiscussionAnswered' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDiscussionAnswered($payload),
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookDiscussionLabeled\Discussion' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDiscussionLabeled⚡️Discussion($payload),
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookDiscussionTransferred\Changes\NewDiscussion' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDiscussionTransferred⚡️Changes⚡️NewDiscussion($payload),
                'ApiClients\Client\GitHubAE\Schema\WebhookDiscussionTransferred\Changes\NewRepository' => $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDiscussionTransferred⚡️Changes⚡️NewRepository($payload),
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDiscussionLabeled(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookDiscussionLabeled
        {
            ...
            try {
                ...
                if (is_array($value)) {
                    try {
                        $this->hydrationStack[] = 'discussion';
                        $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDiscussionLabeled⚡️Discussion($value);
                    } finally {
                        array_pop($this->hydrationStack);
                    }
                }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDiscussionLabeled⚡️Discussion(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookDiscussionLabeled\Discussion
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookDiscussionLabeled\Discussion', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WebhookDiscussionLabeled\Discussion::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\WebhookDiscussionLabeled\Discussion(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookDiscussionLabeled\Discussion', $exception, stack: $this->hydrationStack);
            }
        }
            ...
            try {
                ...
                if (is_array($value)) {
                    try {
                        ...
                        $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDiscussionTransferred⚡️Changes⚡️NewDiscussion($value);
                    } finally {
                        array_pop($this->hydrationStack);
                    }
                }
                ...
                if (is_array($value)) {
                    try {
                        ...
                        $value = $this->hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDiscussionTransferred⚡️Changes⚡️NewRepository($value);
                    } finally {
                        array_pop($this->hydrationStack);
                    }
                }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDiscussionTransferred⚡️Changes⚡️NewDiscussion(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookDiscussionTransferred\Changes\NewDiscussion
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookDiscussionTransferred\Changes\NewDiscussion', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WebhookDiscussionTransferred\Changes\NewDiscussion::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\WebhookDiscussionTransferred\Changes\NewDiscussion(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookDiscussionTransferred\Changes\NewDiscussion', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDiscussionTransferred⚡️Changes⚡️NewRepository(array $payload): \ApiClients\Client\GitHubAE\Schema\WebhookDiscussionTransferred\Changes\NewRepository
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookDiscussionTransferred\Changes\NewRepository', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubAE\Schema\WebhookDiscussionTransferred\Changes\NewRepository::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubAE\Schema\WebhookDiscussionTransferred\Changes\NewRepository(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubAE\Schema\WebhookDiscussionTransferred\Changes\NewRepository', $exception, stack: $this->hydrationStack);
            }
        }
    ...
    public function serializeObject(object $object): mixed
    {
        try {
            ...
            return match($className) {
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookDiscussionLabeled\Discussion' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDiscussionLabeled⚡️Discussion($object),
                ...
                'ApiClients\Client\GitHubAE\Schema\WebhookDiscussionTransferred\Changes\NewDiscussion' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDiscussionTransferred⚡️Changes⚡️NewDiscussion($object),
                'ApiClients\Client\GitHubAE\Schema\WebhookDiscussionTransferred\Changes\NewRepository' => $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDiscussionTransferred⚡️Changes⚡️NewRepository($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDiscussionLabeled(mixed $object): mixed
    {
        ...
        $discussion = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDiscussionLabeled⚡️Discussion($discussion);
        after_discussion:        $result['discussion'] = $discussion;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDiscussionLabeled⚡️Discussion(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WebhookDiscussionLabeled\Discussion);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDiscussionTransferred⚡️Changes(mixed $object): mixed
    {
        ...
        $new_discussion = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDiscussionTransferred⚡️Changes⚡️NewDiscussion($new_discussion);
        ...
        $new_repository = $this->serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDiscussionTransferred⚡️Changes⚡️NewRepository($new_repository);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDiscussionTransferred⚡️Changes⚡️NewDiscussion(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WebhookDiscussionTransferred\Changes\NewDiscussion);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubAE⚡️Schema⚡️WebhookDiscussionTransferred⚡️Changes⚡️NewRepository(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubAE\Schema\WebhookDiscussionTransferred\Changes\NewRepository);
        $result = [];
