...
final readonly class Commit
{
    ...
    public function __construct(Schema\CommitSearchResultItem\Commit\Author $author, Schema\GitUser $committer, int $comment_count, string $message, Schema\ShortBranch\Commit $tree, string $url, Schema\Verification $verification)
    {
        $this->author = $author;
