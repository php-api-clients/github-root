...
final readonly class Changes
{
    ...
    public ?Schema\WebhookProjectEdited\Changes\Name $name;
    public function __construct(Schema\WebhookProjectEdited\Changes\Body $body, Schema\WebhookProjectEdited\Changes\Name $name)
    {
        $this->body = $body;
        $this->name = $name;
    }
