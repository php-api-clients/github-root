...
final readonly class TimelineCommitCommentedEvent
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"event":"generated_event","node_id":"generated_node_id","commit_id":"generated_commit_id","comments":[null]}';
    public ?string $event;
    public ?string $node_id;
    public ?string $commit_id;
    /**
     * @var array<Schema\CommitComment>
     */
    public ?array $comments;
    public function __construct(string $event, string $node_id, string $commit_id, array $comments)
    {
        $this->event = $event;
