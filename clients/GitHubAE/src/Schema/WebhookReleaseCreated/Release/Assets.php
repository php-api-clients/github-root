...
final readonly class Assets
{
    ...
    public ?Schema\Discussion\AnswerChosenBy $uploader;
    public ?string $url;
    public function __construct(string $browser_download_url, string $content_type, string $created_at, int $download_count, int $id, string $label, string $name, string $node_id, int $size, string $state, string $updated_at, Schema\Discussion\AnswerChosenBy $uploader, string $url)
    {
