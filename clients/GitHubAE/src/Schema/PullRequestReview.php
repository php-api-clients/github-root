...
final readonly class PullRequestReview
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"id":42,"node_id":"MDE3OlB1bGxSZXF1ZXN0UmV2aWV3ODA=","user":"generated_user","body":"This looks great.","state":"CHANGES_REQUESTED","html_url":"https:\\/\\/github.com\\/octocat\\/Hello-World\\/pull\\/12#pullrequestreview-80","pull_request_url":"https:\\/\\/api.github.com\\/repos\\/octocat\\/Hello-World\\/pulls\\/12","_links":{"html":{"href":"generated_href"},"pull_request":{"href":"generated_href"}},"submitted_at":"generated_submitted_at","commit_id":"54bb654c9e6025347f57900a4a5c2313a96b8035","body_html":"generated_body_html","body_text":"generated_body_text","author_association":"OWNER"}';
    /**
    ...
    public function __construct(int $id, string $node_id, mixed $user, string $body, string $state, string $html_url, string $pull_request_url, Schema\TimelineReviewedEvent\Links $_links, string $submitted_at, string $commit_id, string $body_html, string $body_text, string $author_association)
    {
        $this->id = $id;
