        ...
        [
            new Package(
                new Package\Metadata(
                    'GitHub AE',
                    'Fully type safe generated Non-Blocking first GitHub AE REST API client',
                    [],
                ),
                'api-clients',
                'github-ae',
                'git@github.com:php-api-clients/github-ae.git',
                'v0.1.x',
                null,
                ...
                new Namespace_(
                    'ApiClients\Client\GitHubAE',
                    'ApiClients\Tests\Client\GitHubAE',
                ),
                new Package\QA(
