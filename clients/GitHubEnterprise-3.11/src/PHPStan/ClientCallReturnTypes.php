...
final readonly class ClientCallReturnTypes implements DynamicMethodReturnTypeExtension
{
    ...
    public function getTypeFromMethodCall(MethodReflection $methodReflection, MethodCall $methodCall, Scope $scope): Type|null
    {
        ...
        if ($call === 'PATCH /admin/ldap/teams/{team_id}/mapping') {
            return $this->typeResolver->resolve('Schema\\LdapMappingTeam');
        }

        if ($call === 'POST /admin/ldap/teams/{team_id}/sync') {
            return $this->typeResolver->resolve('Schema\\Operations\\EnterpriseAdmin\\SyncLdapMappingForTeam\\Response\\ApplicationJson\\Created');
        }

        if ($call === 'PATCH /admin/ldap/users/{username}/mapping') {
            return $this->typeResolver->resolve('Schema\\LdapMappingUser');
        }

        if ($call === 'POST /admin/ldap/users/{username}/sync') {
            return $this->typeResolver->resolve('Schema\\Operations\\EnterpriseAdmin\\SyncLdapMappingForUser\\Response\\ApplicationJson\\Created\\Application\\Json');
        }
        ...
        if ($call === 'GET /admin/pre-receive-hooks') {
            return $this->typeResolver->resolve('iterable<int,Schema\\PreReceiveHook>');
        }
        ...
        if ($call === 'POST /admin/pre-receive-hooks') {
            return $this->typeResolver->resolve('Schema\\PreReceiveHook');
        }
        ...
        if ($call === 'POST /admin/users') {
            return $this->typeResolver->resolve('Schema\\SimpleUser');
        }
        ...
        if ($call === 'PATCH /admin/users/{username}') {
            return $this->typeResolver->resolve('Schema\\Operations\\EnterpriseAdmin\\UpdateUsernameForUser\\Response\\ApplicationJson\\Accepted\\Application\\Json');
        }
        ...
        if ($call === 'GET /advisories/{ghsa_id}') {
            return $this->typeResolver->resolve('Schema\\GlobalAdvisory');
        }
        ...
        if ($call === 'GET /applications/grants') {
            return $this->typeResolver->resolve('iterable<int,Schema\\ApplicationGrant>|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
        ...
        if ($call === 'GET /applications/grants/{grant_id}') {
            return $this->typeResolver->resolve('Schema\\ApplicationGrant|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
        ...
        if ($call === 'GET /authorizations') {
            return $this->typeResolver->resolve('iterable<int,Schema\\Authorization>|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
        ...
        if ($call === 'POST /authorizations') {
            return $this->typeResolver->resolve('Schema\\Authorization|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
        ...
        if ($call === 'GET /enterprise/stats/security-products') {
            return $this->typeResolver->resolve('Schema\\EnterpriseSecurityProductsOverview');
        }
        ...
        if ($call === 'GET /enterprises/{enterprise}/actions/cache/usage') {
            return $this->typeResolver->resolve('Schema\\ActionsCacheUsageOrgEnterprise');
        }

        if ($call === 'GET /enterprises/{enterprise}/actions/cache/usage-policy') {
            return $this->typeResolver->resolve('Schema\\ActionsCacheUsagePolicyEnterprise');
        }
        ...
        if ($call === 'GET /enterprises/{enterprise}/actions/runner-groups/{runner_group_id}/organizations') {
            return $this->typeResolver->resolve('Schema\\Operations\\EnterpriseAdmin\\ListOrgAccessToSelfHostedRunnerGroupInEnterprise\\Response\\ApplicationJson\\Ok\\Application\\Json');
        }
        ...
        if ($call === 'GET /enterprises/{enterprise}/actions/runners/{runner_id}/labels') {
            return $this->typeResolver->resolve('Schema\\Operations\\EnterpriseAdmin\\ListLabelsForSelfHostedRunnerForEnterprise\\Response\\ApplicationJson\\Ok');
        }
        ...
        if ($call === 'DELETE /enterprises/{enterprise}/actions/runners/{runner_id}/labels') {
            return $this->typeResolver->resolve('Schema\\Operations\\EnterpriseAdmin\\RemoveAllCustomLabelsFromSelfHostedRunnerForEnterprise\\Response\\ApplicationJson\\Ok\\Application\\Json');
        }
        ...
        if ($call === 'GET /enterprises/{enterprise}/code_security_and_analysis') {
            return $this->typeResolver->resolve('Schema\\EnterpriseSecurityAnalysisSettings');
        }
        ...
        if ($call === 'GET /events') {
            return $this->typeResolver->resolve('iterable<int,Schema\\Event>|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
        ...
        if ($call === 'GET /manage/v1/config/nodes') {
            return $this->typeResolver->resolve('Schema\\GhesConfigNodes|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }

        if ($call === 'GET /manage/v1/maintenance') {
            return $this->typeResolver->resolve('iterable<int,Schema\\GhesGetMaintenance>|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }

        if ($call === 'POST /manage/v1/maintenance') {
            return $this->typeResolver->resolve('iterable<int,Schema\\GhesSetMaintenanceResponse>|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }

        if ($call === 'GET /manage/v1/replication/status') {
            return $this->typeResolver->resolve('Schema\\GhesReplicationStatus|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }

        if ($call === 'GET /manage/v1/version') {
            return $this->typeResolver->resolve('iterable<int,Schema\\GhesVersion>|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
        ...
        if ($call === 'GET /networks/{owner}/{repo}/events') {
            return $this->typeResolver->resolve('iterable<int,Schema\\Event>|Schema\\BasicError|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
        ...
        if ($call === 'GET /organizations/{organization_id}/custom_roles') {
            return $this->typeResolver->resolve('Schema\\Operations\\Orgs\\ListCustomRoles\\Response\\ApplicationJson\\Ok');
        }
        ...
        if ($call === 'DELETE /orgs/{org}') {
            return $this->typeResolver->resolve('Schema\\Operations\\Orgs\\Delete\\Response\\ApplicationJson\\Accepted\\Application\\Json');
        }
        ...
        if ($call === 'GET /orgs/{org}/actions/cache/usage-by-repository') {
            return $this->typeResolver->resolve('Schema\\Operations\\Actions\\GetActionsCacheUsageByRepoForOrg\\Response\\ApplicationJson\\Ok');
        }

        if ($call === 'GET /orgs/{org}/actions/oidc/customization/sub') {
            return $this->typeResolver->resolve('Schema\\OidcCustomSub');
        }
        ...
        if ($call === 'GET /orgs/{org}/actions/runner-groups/{runner_group_id}/runners') {
            return $this->typeResolver->resolve('Schema\\Operations\\Actions\\ListSelfHostedRunnersInGroupForOrg\\Response\\ApplicationJson\\Ok\\Application\\Json');
        }
        ...
        if ($call === 'DELETE /orgs/{org}/actions/runners/{runner_id}/labels') {
            return $this->typeResolver->resolve('Schema\\Operations\\Actions\\RemoveAllCustomLabelsFromSelfHostedRunnerForOrg\\Response\\ApplicationJson\\Ok\\Application\\Json');
        }
        ...
        if ($call === 'GET /orgs/{org}/actions/variables') {
            return $this->typeResolver->resolve('Schema\\Operations\\Actions\\ListOrgVariables\\Response\\ApplicationJson\\Ok');
        }
        ...
        if ($call === 'GET /orgs/{org}/actions/variables/{name}') {
            return $this->typeResolver->resolve('Schema\\OrganizationActionsVariable');
        }
        ...
        if ($call === 'GET /orgs/{org}/actions/variables/{name}/repositories') {
            return $this->typeResolver->resolve('Schema\\Operations\\Actions\\ListSelectedReposForOrgVariable\\Response\\ApplicationJson\\Ok\\Application\\Json|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
        ...
        if ($call === 'GET /orgs/{org}/announcement') {
            return $this->typeResolver->resolve('Schema\\AnnouncementBanner');
        }
        ...
        if ($call === 'GET /orgs/{org}/custom-repository-roles') {
            return $this->typeResolver->resolve('Schema\\Operations\\Orgs\\ListCustomRepoRoles\\Response\\ApplicationJson\\Ok\\Application\\Json');
        }

        if ($call === 'POST /orgs/{org}/custom-repository-roles') {
            return $this->typeResolver->resolve('Schema\\OrganizationCustomRepositoryRole');
        }
        ...
        if ($call === 'GET /orgs/{org}/dependabot/secrets') {
            return $this->typeResolver->resolve('Schema\\Operations\\Dependabot\\ListOrgSecrets\\Response\\ApplicationJson\\Ok');
        }

        if ($call === 'GET /orgs/{org}/dependabot/secrets/public-key') {
            return $this->typeResolver->resolve('Schema\\DependabotPublicKey');
        }

        if ($call === 'GET /orgs/{org}/dependabot/secrets/{secret_name}') {
            return $this->typeResolver->resolve('Schema\\OrganizationDependabotSecret');
        }
        ...
        if ($call === 'GET /orgs/{org}/dependabot/secrets/{secret_name}/repositories') {
            return $this->typeResolver->resolve('Schema\\Operations\\Dependabot\\ListSelectedReposForOrgSecret\\Response\\ApplicationJson\\Ok\\Application\\Json');
        }
        ...
        if ($call === 'GET /orgs/{org}/docker/conflicts') {
            return $this->typeResolver->resolve('iterable<int,Schema\\Package>');
        }
        ...
        if ($call === 'GET /orgs/{org}/packages') {
            return $this->typeResolver->resolve('iterable<int,Schema\\Package>|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
        ...
        if ($call === 'GET /orgs/{org}/packages/{package_type}/{package_name}') {
            return $this->typeResolver->resolve('Schema\\Package');
        }
        ...
        if ($call === 'GET /orgs/{org}/packages/{package_type}/{package_name}/versions') {
            return $this->typeResolver->resolve('iterable<int,Schema\\PackageVersion>');
        }
        ...
        if ($call === 'GET /orgs/{org}/packages/{package_type}/{package_name}/versions/{package_version_id}') {
            return $this->typeResolver->resolve('Schema\\PackageVersion');
        }
        ...
        if ($call === 'POST /orgs/{org}/personal-access-token-requests') {
            return $this->typeResolver->resolve('Schema\\Operations\\Orgs\\ReviewPatGrantRequestsInBulk\\Response\\ApplicationJson\\Accepted\\Application\\Json');
        }
        ...
        if ($call === 'POST /orgs/{org}/personal-access-tokens') {
            return $this->typeResolver->resolve('Schema\\Operations\\Orgs\\UpdatePatAccesses\\Response\\ApplicationJson\\Accepted\\Application\\Json');
        }
        ...
        if ($call === 'GET /orgs/{org}/pre-receive-hooks') {
            return $this->typeResolver->resolve('iterable<int,Schema\\OrgPreReceiveHook>');
        }
        ...
        if ($call === 'GET /orgs/{org}/pre-receive-hooks/{pre_receive_hook_id}') {
            return $this->typeResolver->resolve('Schema\\OrgPreReceiveHook');
        }
        ...
        if ($call === 'GET /orgs/{org}/repository-fine-grained-permissions') {
            return $this->typeResolver->resolve('iterable<int,Schema\\RepositoryFineGrainedPermission>');
        }
        ...
        if ($call === 'GET /orgs/{org}/security-managers') {
            return $this->typeResolver->resolve('iterable<int,Schema\\TeamSimple>');
        }
        ...
        if ($call === 'GET /repos/{owner}/{repo}/actions/cache/usage') {
            return $this->typeResolver->resolve('Schema\\ActionsCacheUsageByRepository');
        }

        if ($call === 'GET /repos/{owner}/{repo}/actions/cache/usage-policy') {
            return $this->typeResolver->resolve('Schema\\ActionsCacheUsagePolicyForRepository');
        }
        ...
        if ($call === 'GET /repos/{owner}/{repo}/actions/caches') {
            return $this->typeResolver->resolve('Schema\\ActionsCacheList');
        }
        ...
        if ($call === 'GET /repos/{owner}/{repo}/actions/oidc/customization/sub') {
            return $this->typeResolver->resolve('Schema\\OidcCustomSubRepo');
        }
        ...
        if ($call === 'GET /repos/{owner}/{repo}/actions/organization-variables') {
            return $this->typeResolver->resolve('Schema\\Operations\\Actions\\ListRepoOrganizationVariables\\Response\\ApplicationJson\\Ok');
        }
        ...
        if ($call === 'GET /repos/{owner}/{repo}/actions/permissions/access') {
            return $this->typeResolver->resolve('Schema\\ActionsWorkflowAccessToRepository');
        }
        ...
        if ($call === 'DELETE /repos/{owner}/{repo}/actions/runners/{runner_id}/labels') {
            return $this->typeResolver->resolve('Schema\\Operations\\Actions\\RemoveAllCustomLabelsFromSelfHostedRunnerForRepo\\Response\\ApplicationJson\\Ok\\Application\\Json');
        }
        ...
        if ($call === 'GET /repos/{owner}/{repo}/actions/runs/{run_id}/approvals') {
            return $this->typeResolver->resolve('iterable<int,Schema\\EnvironmentApprovals>');
        }
        ...
        if ($call === 'GET /repos/{owner}/{repo}/actions/runs/{run_id}/pending_deployments') {
            return $this->typeResolver->resolve('iterable<int,Schema\\PendingDeployment>');
        }
        ...
        if ($call === 'GET /repos/{owner}/{repo}/actions/variables') {
            return $this->typeResolver->resolve('Schema\\Operations\\Actions\\ListRepoVariables\\Response\\ApplicationJson\\Ok\\Application\\Json');
        }
        ...
        if ($call === 'GET /repos/{owner}/{repo}/activity') {
            return $this->typeResolver->resolve('iterable<int,Schema\\Activity>');
        }
        ...
        if ($call === 'POST /repos/{owner}/{repo}/branches/{branch}/rename') {
            return $this->typeResolver->resolve('Schema\\BranchWithProtection');
        }
        ...
        if ($call === 'GET /repos/{owner}/{repo}/code-scanning/default-setup') {
            return $this->typeResolver->resolve('Schema\\CodeScanningDefaultSetup');
        }

        if ($call === 'PATCH /repos/{owner}/{repo}/code-scanning/default-setup') {
            return $this->typeResolver->resolve('Schema\\EmptyObject|Schema\\CodeScanningDefaultSetupUpdateResponse');
        }
        ...
        if ($call === 'GET /repos/{owner}/{repo}/dependabot/alerts/{alert_number}') {
            return $this->typeResolver->resolve('Schema\\DependabotAlert|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }

        if ($call === 'PATCH /repos/{owner}/{repo}/dependabot/alerts/{alert_number}') {
            return $this->typeResolver->resolve('Schema\\DependabotAlert');
        }

        if ($call === 'GET /repos/{owner}/{repo}/dependabot/secrets') {
            return $this->typeResolver->resolve('Schema\\Operations\\Dependabot\\ListRepoSecrets\\Response\\ApplicationJson\\Ok');
        }
        ...
        if ($call === 'GET /repos/{owner}/{repo}/dependabot/secrets/{secret_name}') {
            return $this->typeResolver->resolve('Schema\\DependabotSecret');
        }
        ...
        if ($call === 'GET /repos/{owner}/{repo}/dependency-graph/sbom') {
            return $this->typeResolver->resolve('Schema\\DependencyGraphSpdxSbom');
        }

        if ($call === 'POST /repos/{owner}/{repo}/dependency-graph/snapshots') {
            return $this->typeResolver->resolve('Schema\\Operations\\DependencyGraph\\CreateRepositorySnapshot\\Response\\ApplicationJson\\Created');
        }
        ...
        if ($call === 'GET /repos/{owner}/{repo}/pre-receive-hooks') {
            return $this->typeResolver->resolve('iterable<int,Schema\\RepositoryPreReceiveHook>');
        }
        ...
        if ($call === 'GET /repos/{owner}/{repo}/pre-receive-hooks/{pre_receive_hook_id}') {
            return $this->typeResolver->resolve('Schema\\RepositoryPreReceiveHook');
        }
        ...
        if ($call === 'POST /repos/{owner}/{repo}/releases/generate-notes') {
            return $this->typeResolver->resolve('Schema\\ReleaseNotesContent');
        }
        ...
        if ($call === 'GET /repos/{owner}/{repo}/replicas/caches') {
            return $this->typeResolver->resolve('iterable<int,Schema\\Operations\\Repos\\ListCacheInfo\\Response\\ApplicationJson\\Ok>');
        }
        ...
        if ($call === 'GET /repos/{owner}/{repo}/tags/protection') {
            return $this->typeResolver->resolve('iterable<int,Schema\\TagProtection>');
        }

        if ($call === 'POST /repos/{owner}/{repo}/tags/protection') {
            return $this->typeResolver->resolve('Schema\\TagProtection');
        }
        ...
        if ($call === 'GET /setup/api/configcheck') {
            return $this->typeResolver->resolve('Schema\\ConfigurationStatus|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
        ...
        if ($call === 'GET /setup/api/maintenance') {
            return $this->typeResolver->resolve('Schema\\MaintenanceStatus|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
        ...
        if ($call === 'GET /setup/api/settings') {
            return $this->typeResolver->resolve('Schema\\EnterpriseSettings|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
        ...
        if ($call === 'GET /setup/api/settings/authorized-keys') {
            return $this->typeResolver->resolve('iterable<int,Schema\\SshKey>|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
        ...
        if ($call === 'GET /user/emails') {
            return $this->typeResolver->resolve('iterable<int,Schema\\Email>|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
        ...
        if ($call === 'GET /user/social_accounts') {
            return $this->typeResolver->resolve('iterable<int,Schema\\SocialAccount>|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
        ...
        if ($call === 'GET /user/ssh_signing_keys') {
            return $this->typeResolver->resolve('iterable<int,Schema\\SshSigningKey>|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
        ...
        if ($call === 'POST /user/ssh_signing_keys') {
            return $this->typeResolver->resolve('Schema\\SshSigningKey|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
        ...
        if ($call === 'GET /users/{username}/social_accounts') {
            return $this->typeResolver->resolve('iterable<int,Schema\\SocialAccount>');
        }
        ...
        if ($call === 'GET /users/{username}/ssh_signing_keys') {
            return $this->typeResolver->resolve('iterable<int,Schema\\SshSigningKey>');
        }
