...
final readonly class WebhookReleaseDeleted
{
    ...
    "properties": {
        ...
        "release": {
            ...
            "description": "The [release](https:\\/\\/docs.github.com\\/enterprise-server@3.11\\/rest\\/releases\\/releases\\/#get-a-release) object."
        },
        "repository": {
            "title": "Repository",
            "required": [
    ...
    organization, or when the event occurs from activity in a repository owned by an organization.
     * release: The [release](https://docs.github.com/enterprise-server@3.11/rest/releases/releases/#get-a-release) object.
