...
final readonly class Deployment
{
    ...
    "description": "The [deployment](https:\\/\\/docs.github.com\\/enterprise-server@3.11\\/rest\\/deployments\\/deployments#list-deployments)."
}';
    public const SCHEMA_TITLE        = 'Deployment';
    public const SCHEMA_DESCRIPTION  = 'The [deployment](https://docs.github.com/enterprise-server@3.11/rest/deployments/deployments#list-deployments).';
