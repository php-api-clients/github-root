...
final readonly class WebhookDeploymentStatusCreated
{
    ...
    /**
     * deployment: The [deployment](https://docs.github.com/enterprise-server@3.11/rest/deployments/deployments#list-deployments).
     * deploymentStatus: The [deployment status](https://docs.github.com/enterprise-server@3.11/rest/deployments/statuses#list-deployment-statuses).
