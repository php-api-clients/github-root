...
final readonly class WebhookCacheSync
{
     ...
     */
    public function __construct(public string $after, public string $before, #[MapFrom('cache_location')]
    public string $cacheLocation, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public string $ref, public Schema\RepositoryWebhooks|null $repository, public Schema\SimpleUserWebhooks|null $sender,)
    {
    }
}
