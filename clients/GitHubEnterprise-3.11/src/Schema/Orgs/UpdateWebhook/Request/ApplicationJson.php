...
final readonly class ApplicationJson
{
    ...
    "properties": {
        ...
        "events": {
            ...
            "description": "Determines what [events](https:\\/\\/docs.github.com\\/enterprise-server@3.11\\/webhooks\\/event-payloads) the hook is triggered for.",
            "default": [
                "push"
            ]
        },
     ...
     * events: Determines what [events](https://docs.github.com/enterprise-server@3.11/webhooks/event-payloads) the hook is triggered for.
