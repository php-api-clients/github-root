...
final readonly class RequiredPullRequestReviews
{
    ...
    "properties": {
        ...
        "require_code_owner_reviews": {
            "type": "boolean",
            "description": "Blocks merging pull requests until [code owners](https:\\/\\/docs.github.com\\/enterprise-server@3.11\\/articles\\/about-code-owners\\/) review them."
        },
     ...
     * requireCodeOwnerReviews: Blocks merging pull requests until [code owners](https://docs.github.com/enterprise-server@3.11/articles/about-code-owners/) review them.
