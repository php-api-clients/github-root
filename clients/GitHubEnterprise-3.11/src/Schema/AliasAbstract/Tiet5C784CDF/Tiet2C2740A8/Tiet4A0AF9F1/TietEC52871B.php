...
namespace ApiClients\Client\GitHubEnterprise\Schema\AliasAbstract\Tiet5C784CDF\Tiet2C2740A8\Tiet4A0AF9F1;

use ApiClients\Client\GitHubEnterprise\Schema;
use EventSauce\ObjectHydrator\MapFrom;

abstract readonly class TietEC52871B
{
    ...
    public const SCHEMA_DESCRIPTION  = 'The [release](https://docs.github.com/enterprise-server@3.11/rest/releases/releases/#get-a-release) object.';
