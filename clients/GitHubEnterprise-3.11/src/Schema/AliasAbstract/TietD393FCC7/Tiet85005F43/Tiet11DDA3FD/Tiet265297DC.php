...
namespace ApiClients\Client\GitHubEnterprise\Schema\AliasAbstract\TietD393FCC7\Tiet85005F43\Tiet11DDA3FD;

use ApiClients\Client\GitHubEnterprise\Schema;
use EventSauce\ObjectHydrator\MapFrom;

abstract readonly class Tiet265297DC
{
    ...
    public const SCHEMA_DESCRIPTION  = 'The [comment](https://docs.github.com/enterprise-server@3.11/rest/issues/comments#get-an-issue-comment) itself.';
