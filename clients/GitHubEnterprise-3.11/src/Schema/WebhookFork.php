...
final readonly class WebhookFork
{
    ...
    "properties": {
        ...
        "forkee": {
            ...
            "description": "The created [`repository`](https:\\/\\/docs.github.com\\/enterprise-server@3.11\\/rest\\/repos\\/repos#get-a-repository) resource."
        },
        "installation": {
     ...
     * forkee: The created [`repository`](https://docs.github.com/enterprise-server@3.11/rest/repos/repos#get-a-repository) resource.
