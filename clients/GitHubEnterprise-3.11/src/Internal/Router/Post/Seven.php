...
final class Seven
{
    ...
    /** @return |Schema\DeploymentBranchPolicy|\ApiClients\Tools\OpenApiClient\Utils\Response\WithoutBody|Schema\DeploymentProtectionRule|Observable<Schema\Label>|Schema\BasicError */
