...
final class Two
{
    ...
    /** @return iterable<int,Schema\GlobalAdvisory>||iterable<int,Schema\Authorization>|\ApiClients\Tools\OpenApiClient\Utils\Response\WithoutBody|Observable<Schema\CodeOfConduct>|WithoutBody|iterable<int,Schema\Event>|iterable<int,Schema\BaseGist>|iterable<int,Schema\Issue>|iterable<int,Schema\LicenseSimple>|iterable<int,Schema\Thread>|iterable<int,Schema\OrganizationSimple>|Observable<Schema\MinimalRepository>|iterable<int,Schema\SimpleUser> */
