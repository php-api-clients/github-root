...
final class Four
{
    ...
    public function call(string $call, array $params, array $pathChunks): GlobalHook2|Accepted|PreReceiveEnvironment|PreReceiveHook|Json|WebhookConfig|Authorization|WithoutBody|AnnouncementBanner|ProjectColumn|FullRepository|BasicError
    {
        if ($pathChunks[0] === '') {
            if ($pathChunks[1] === 'admin') {
                ...
                if ($pathChunks[2] === '{enterprise}') {
                    if ($pathChunks[3] === 'code_security_and_analysis') {
