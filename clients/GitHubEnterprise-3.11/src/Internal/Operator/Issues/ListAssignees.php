...
final readonly class ListAssignees
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Issues\ListAssignees($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
