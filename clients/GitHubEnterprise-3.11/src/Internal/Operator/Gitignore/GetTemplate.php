...
namespace ApiClients\Client\GitHubEnterprise\Internal\Operator\Gitignore;
...
final readonly class GetTemplate
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Gitignore\GetTemplate($this->responseSchemaValidator, $this->hydrator, $name);
