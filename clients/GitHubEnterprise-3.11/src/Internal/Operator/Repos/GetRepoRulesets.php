...
final readonly class GetRepoRulesets
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Repos\GetRepoRulesets($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page, $includesParents);
