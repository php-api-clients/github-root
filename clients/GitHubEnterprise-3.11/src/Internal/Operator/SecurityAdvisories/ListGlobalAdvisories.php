...
final readonly class ListGlobalAdvisories
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\SecurityAdvisories\ListGlobalAdvisories($this->responseSchemaValidator, $this->hydrator, $ghsaId, $cveId, $ecosystem, $severity, $cwes, $isWithdrawn, $affects, $published, $updated, $modified, $before, $after, $type, $direction, $perPage, $sort);
