...
final readonly class RemoveMembershipForUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Orgs\RemoveMembershipForUser($this->responseSchemaValidator, $this->hydrator, $org, $username);
