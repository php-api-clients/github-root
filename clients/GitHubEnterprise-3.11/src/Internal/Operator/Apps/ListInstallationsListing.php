...
final readonly class ListInstallationsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Apps\ListInstallationsListing($this->responseSchemaValidator, $this->hydrator, $since, $outdated, $perPage, $page);
