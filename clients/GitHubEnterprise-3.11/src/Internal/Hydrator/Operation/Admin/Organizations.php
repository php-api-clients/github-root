...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Admin;
...
class Organizations implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️OrganizationSimple(array $payload): OrganizationSimple
    {
        $properties    = [];
        $missingFields = [];
        try {
