...
use ApiClients\Client\GitHubEnterprise\Schema\RepositoryRuleset\Links;
...
use ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetCreated;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetDeleted;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetEdited;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetEdited\Changes;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetEdited\Changes\Enforcement;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetEdited\Changes\Name;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetEdited\Changes\Rules;
...
class RepositoryRuleset implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetCreated' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetCreated($payload),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\RepositoryRuleset' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️RepositoryRuleset($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\RepositoryRuleset\Links' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️RepositoryRuleset⚡️Links($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\RepositoryRuleset\Links\Self_' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️RepositoryRuleset⚡️Links⚡️Self_($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\RepositoryRuleset\Links\Html' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️RepositoryRuleset⚡️Links⚡️Html($payload),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetDeleted' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetDeleted($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetEdited' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetEdited($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetEdited\Changes' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetEdited\Changes\Name' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Name($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetCreated(array $payload): WebhookRepositoryRulesetCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            $value = $payload['repository_ruleset'] ?? null;

            if ($value === null) {
                $missingFields[] = 'repository_ruleset';
                goto after_repositoryRuleset;
            }

            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'repositoryRuleset';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️RepositoryRuleset($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }

            $properties['repositoryRuleset'] = $value;

            after_repositoryRuleset:
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetCreated', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookRepositoryRulesetCreated::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookRepositoryRulesetCreated(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetCreated', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️RepositoryRuleset(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\RepositoryRuleset
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️RepositoryRuleset⚡️Links($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\RepositoryRuleset', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\RepositoryRuleset::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\RepositoryRuleset(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\RepositoryRuleset', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️RepositoryRuleset⚡️Links(array $payload): Links
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️RepositoryRuleset⚡️Links⚡️Self_($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️RepositoryRuleset⚡️Links⚡️Html($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\RepositoryRuleset\Links', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️RepositoryRuleset⚡️Links⚡️Self_(array $payload): Self_
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\RepositoryRuleset\Links\Self_', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️RepositoryRuleset⚡️Links⚡️Html(array $payload): Html
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\RepositoryRuleset\Links\Html', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetDeleted(array $payload): WebhookRepositoryRulesetDeleted
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetDeleted', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookRepositoryRulesetDeleted::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookRepositoryRulesetDeleted(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetDeleted', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetEdited(array $payload): WebhookRepositoryRulesetEdited
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetEdited', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookRepositoryRulesetEdited::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookRepositoryRulesetEdited(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetEdited', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes(array $payload): Changes
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Name($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'enforcement';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Enforcement($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Conditions($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'rules';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Rules($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetEdited\Changes', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Name(array $payload): Name
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetEdited\Changes\Name', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Enforcement(array $payload): Enforcement
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetEdited\Changes\Enforcement', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(Enforcement::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new Enforcement(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetEdited\Changes\Enforcement', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Conditions(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetEdited\Changes\Conditions
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetEdited\Changes\Conditions', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetEdited\Changes\Conditions::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetEdited\Changes\Conditions(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetEdited\Changes\Conditions', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Rules(array $payload): Rules
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetEdited\Changes\Rules', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(Rules::class, $missingFields, stack: $this->hydrationStack);
        }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetCreated' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetCreated($object),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\RepositoryRuleset' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️RepositoryRuleset($object),
                'ApiClients\Client\GitHubEnterprise\Schema\RepositoryRuleset\Links' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️RepositoryRuleset⚡️Links($object),
                'ApiClients\Client\GitHubEnterprise\Schema\RepositoryRuleset\Links\Self_' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️RepositoryRuleset⚡️Links⚡️Self_($object),
                'ApiClients\Client\GitHubEnterprise\Schema\RepositoryRuleset\Links\Html' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️RepositoryRuleset⚡️Links⚡️Html($object),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetDeleted' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetDeleted($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetEdited' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetEdited($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetEdited\Changes' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetEdited\Changes\Name' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Name($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetEdited\Changes\Enforcement' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Enforcement($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetEdited\Changes\Conditions' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Conditions($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetEdited\Changes\Rules' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Rules($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetCreated(mixed $object): mixed
    {
        assert($object instanceof WebhookRepositoryRulesetCreated);
        $result = [];
        ...
        $repositoryRuleset                                            = $object->repositoryRuleset;
        $repositoryRuleset                                            = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️RepositoryRuleset($repositoryRuleset);
        after_repositoryRuleset:        $result['repository_ruleset'] = $repositoryRuleset;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️RepositoryRuleset(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\RepositoryRuleset);
        $result = [];
        ...
        $links                                = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️RepositoryRuleset⚡️Links($links);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️RepositoryRuleset⚡️Links(mixed $object): mixed
    {
        ...
        $self                              = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️RepositoryRuleset⚡️Links⚡️Self_($self);
        ...
        $html                              = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️RepositoryRuleset⚡️Links⚡️Html($html);
        after_html:        $result['html'] = $html;

        return $result;
    }

    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️RepositoryRuleset⚡️Links⚡️Self_(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️RepositoryRuleset⚡️Links⚡️Html(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetDeleted(mixed $object): mixed
    {
        assert($object instanceof WebhookRepositoryRulesetDeleted);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetEdited(mixed $object): mixed
    {
        assert($object instanceof WebhookRepositoryRulesetEdited);
        $result = [];
        ...
        $changes                                 = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes($changes);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes(mixed $object): mixed
    {
        ...
        $name                              = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Name($name);
        after_name:        $result['name'] = $name;
        ...
        $enforcement                                     = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Enforcement($enforcement);
        after_enforcement:        $result['enforcement'] = $enforcement;
        ...
        $conditions                                    = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Conditions($conditions);
        after_conditions:        $result['conditions'] = $conditions;
        ...
        $rules                               = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Rules($rules);
        after_rules:        $result['rules'] = $rules;

        return $result;
    }

    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Name(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Enforcement(mixed $object): mixed
    {
        assert($object instanceof Enforcement);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Conditions(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryRulesetEdited\Changes\Conditions);
        $result = [];
        ...
        static $deletedSerializer0;

        if ($deletedSerializer0 === null) {
            $deletedSerializer0 = new SerializeArrayItems(...[]);
        }

        $deleted                                 = $deletedSerializer0->serialize($deleted, $this);
        ...
        static $updatedSerializer0;

        if ($updatedSerializer0 === null) {
            $updatedSerializer0 = new SerializeArrayItems(...[]);
        }

        $updated                                 = $updatedSerializer0->serialize($updated, $this);
        after_updated:        $result['updated'] = $updated;

        return $result;
    }

    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Rules(mixed $object): mixed
    {
        assert($object instanceof Rules);
        $result = [];
