...
use ApiClients\Client\GitHubEnterprise\Schema\WebhookMetaDeleted;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookMetaDeleted\Hook;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookMetaDeleted\Hook\Config;
...
class Meta implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookMetaDeleted' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMetaDeleted($payload),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookMetaDeleted\Hook' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMetaDeleted⚡️Hook($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookMetaDeleted\Hook\Config' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMetaDeleted⚡️Hook⚡️Config($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMetaDeleted(array $payload): WebhookMetaDeleted
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMetaDeleted⚡️Hook($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookMetaDeleted', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMetaDeleted⚡️Hook(array $payload): Hook
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMetaDeleted⚡️Hook⚡️Config($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookMetaDeleted\Hook', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMetaDeleted⚡️Hook⚡️Config(array $payload): Config
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookMetaDeleted\Hook\Config', $exception, stack: $this->hydrationStack);
        }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookMetaDeleted' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMetaDeleted($object),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookMetaDeleted\Hook' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMetaDeleted⚡️Hook($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookMetaDeleted\Hook\Config' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMetaDeleted⚡️Hook⚡️Config($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMetaDeleted(mixed $object): mixed
    {
        ...
        $hook                              = $object->hook;
        $hook                              = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMetaDeleted⚡️Hook($hook);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMetaDeleted⚡️Hook(mixed $object): mixed
    {
        ...
        $config                                = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMetaDeleted⚡️Hook⚡️Config($config);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMetaDeleted⚡️Hook⚡️Config(mixed $object): mixed
    {
