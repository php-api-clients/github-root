...
use ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Workflow;
...
class DeploymentStatus implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Workflow(array $payload): Workflow
    {
        $properties    = [];
        $missingFields = [];
        try {
