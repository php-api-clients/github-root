...
use ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryDispatchSample;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryDispatchSample\ClientPayload;
...
class RepositoryDispatch implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryDispatchSample' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryDispatchSample($payload),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryDispatchSample\ClientPayload' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryDispatchSample⚡️ClientPayload($payload),
            default => throw UnableToHydrateObject::noHydrationDefined($className, $this->hydrationStack),
        };
    }

    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryDispatchSample(array $payload): WebhookRepositoryDispatchSample
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryDispatchSample⚡️ClientPayload($value);
                } finally {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryDispatchSample', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryDispatchSample⚡️ClientPayload(array $payload): ClientPayload
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryDispatchSample\ClientPayload', $exception, stack: $this->hydrationStack);
        }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryDispatchSample' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryDispatchSample($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryDispatchSample(mixed $object): mixed
    {
        ...
        $clientPayload                                        = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryDispatchSample⚡️ClientPayload($clientPayload);
