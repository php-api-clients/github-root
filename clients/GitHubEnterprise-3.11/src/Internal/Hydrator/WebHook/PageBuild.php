...
use ApiClients\Client\GitHubEnterprise\Schema\WebhookPageBuild;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookPageBuild\Build;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookPageBuild\Build\Error;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookPageBuild\Build\Pusher;
...
class PageBuild implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookPageBuild' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPageBuild($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookPageBuild\Build' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPageBuild⚡️Build($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookPageBuild\Build\Error' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPageBuild⚡️Build⚡️Error($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookPageBuild\Build\Pusher' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPageBuild⚡️Build⚡️Pusher($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPageBuild(array $payload): WebhookPageBuild
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPageBuild⚡️Build($value);
                } finally {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPageBuild', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPageBuild⚡️Build(array $payload): Build
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPageBuild⚡️Build⚡️Error($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPageBuild⚡️Build⚡️Pusher($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPageBuild\Build', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPageBuild⚡️Build⚡️Error(array $payload): Error
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPageBuild\Build\Error', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPageBuild⚡️Build⚡️Pusher(array $payload): Pusher
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPageBuild\Build\Pusher', $exception, stack: $this->hydrationStack);
        }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookPageBuild' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPageBuild($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookPageBuild\Build' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPageBuild⚡️Build($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookPageBuild\Build\Error' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPageBuild⚡️Build⚡️Error($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookPageBuild\Build\Pusher' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPageBuild⚡️Build⚡️Pusher($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPageBuild(mixed $object): mixed
    {
        assert($object instanceof WebhookPageBuild);
        $result = [];

        $build                               = $object->build;
        $build                               = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPageBuild⚡️Build($build);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPageBuild⚡️Build(mixed $object): mixed
    {
        ...
        $error                               = $object->error;
        $error                               = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPageBuild⚡️Build⚡️Error($error);
        ...
        $pusher                                = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPageBuild⚡️Build⚡️Pusher($pusher);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPageBuild⚡️Build⚡️Error(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPageBuild⚡️Build⚡️Pusher(mixed $object): mixed
    {
