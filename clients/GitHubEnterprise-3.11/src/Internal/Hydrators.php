...
final class Hydrators implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            ...
            '\\ApiClients\\Client\\GitHubEnterprise\\Schema\\GlobalAdvisory', '\\ApiClients\\Client\\GitHubEnterprise\\Schema\\GlobalAdvisory\\Cvss' => $this->getObjectMapperOperation🌀Advisories🌀GhsaId()->hydrateObject($className, $payload),
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        return match ($className) {
            ...
            '\\ApiClients\\Client\\GitHubEnterprise\\Schema\\GlobalAdvisory', '\\ApiClients\\Client\\GitHubEnterprise\\Schema\\GlobalAdvisory\\Cvss' => $this->getObjectMapperOperation🌀Advisories🌀GhsaId()->serializeObject($object),
