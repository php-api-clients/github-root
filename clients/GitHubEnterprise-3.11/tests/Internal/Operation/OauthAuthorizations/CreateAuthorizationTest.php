...
/** @covers \ApiClients\Client\GitHubEnterprise\Internal\Operation\OauthAuthorizations\CreateAuthorization */
final class CreateAuthorizationTest extends AsyncTestCase
{
    ...
    public function call_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/authorizations', Argument::type('array'), json_encode(json_decode(Schema\OauthAuthorizations\CreateAuthorization\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\OauthAuthorizations\CreateAuthorization::OPERATION_MATCH, (static function (array $data): array {
            return $data;
    ...
    public function operations_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/authorizations', Argument::type('array'), json_encode(json_decode(Schema\OauthAuthorizations\CreateAuthorization\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->oauthAuthorizations()->createAuthorization(json_decode(Schema\OauthAuthorizations\CreateAuthorization\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
