 ...
 * @property string $url
 * @property \ApiClients\Client\GitHub\Schema\Codespace\GitStatus $gitStatus
 ...
 * @property ?\ApiClients\Client\GitHub\Schema\Codespace\RuntimeConstraints $runtimeConstraints
 ...
 * @property ?string $lastKnownStopNotice
 */
interface Codespace
{
}
