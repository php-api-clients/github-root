 ...
 * @property \ApiClients\Client\GitHub\Schema\WebhookCheckSuiteCompleted\CheckSuite\App $app
 * @property ?string $before
 * @property string $checkRunsUrl
 * @property ?string $conclusion
 * @property string $createdAt
 * @property ?string $headBranch
 * @property \ApiClients\Client\GitHub\Schema\WebhookCheckSuiteCompleted\CheckSuite\HeadCommit $headCommit
