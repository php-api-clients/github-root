 ...
 * @property \ApiClients\Client\GitHub\Schema\WebhookCheckSuiteRequested\CheckSuite\App $app
 * @property ?string $before
 * @property string $checkRunsUrl
 * @property ?string $conclusion
 * @property string $createdAt
 * @property ?string $headBranch
 * @property \ApiClients\Client\GitHub\Schema\WebhookCheckSuiteRequested\CheckSuite\HeadCommit $headCommit
