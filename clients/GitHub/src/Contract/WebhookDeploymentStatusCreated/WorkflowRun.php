...
/**
 * @property ?\ApiClients\Client\GitHub\Schema\WebhookDeploymentStatusCreated\WorkflowRun\Actor $actor
 ...
 * @property ?\ApiClients\Client\GitHub\Schema\WebhookDeploymentStatusCreated\WorkflowRun\HeadRepository $headRepository
 ...
 * @property ?\ApiClients\Client\GitHub\Schema\WebhookDeploymentStatusCreated\WorkflowRun\Repository $repository
 * @property ?string $rerunUrl
 * @property int $runAttempt
 * @property int $runNumber
 * @property string $runStartedAt
 * @property string $status
 * @property ?\ApiClients\Client\GitHub\Schema\WebhookDeploymentStatusCreated\WorkflowRun\TriggeringActor $triggeringActor
