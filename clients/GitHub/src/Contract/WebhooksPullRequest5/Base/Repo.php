...
use ApiClients\Client\GitHub\Schema\WebhooksPullRequest5\Base\Repo\License;
use ApiClients\Client\GitHub\Schema\WebhooksPullRequest5\Base\Repo\Owner;
use ApiClients\Client\GitHub\Schema\WebhooksPullRequest5\Base\Repo\Permissions;
