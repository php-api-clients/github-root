...
final class GetCodeFrequencyStats
{
    ...
    /**
     * @return \Rx\Observable<Schema\Operation\Repos\GetCodeFrequencyStats\Response\Applicationjson\H200>|Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata\Dependencies
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : \Rx\Observable|Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata\Dependencies
    {
