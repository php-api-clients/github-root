...
final class CreateRelease
{
    ...
    /**
     * @return Schema\Release|Schema\BasicError|Schema\ValidationError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\Release|Schema\BasicError|Schema\ValidationError
    {
