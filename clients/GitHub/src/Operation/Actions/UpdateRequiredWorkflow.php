...
final class UpdateRequiredWorkflow
{
    ...
    /**
     * @return Schema\RequiredWorkflow|Schema\ValidationErrorSimple
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\RequiredWorkflow|Schema\ValidationErrorSimple
    {
