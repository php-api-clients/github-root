...
final class GetGithubActionsDefaultWorkflowPermissionsRepository
{
    ...
    private readonly Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Actions\Permissions\Workflow $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Actions\Permissions\Workflow $hydrator, string $owner, string $repo)
    {
        $this->owner = $owner;
        $this->repo = $repo;
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return $this->hydrator->hydrateObject('Schema\\ActionsGetDefaultWorkflowPermissions', $body);
                }
                break;
        }
