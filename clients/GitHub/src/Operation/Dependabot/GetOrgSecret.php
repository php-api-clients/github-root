...
final class GetOrgSecret
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Orgs\CbOrgRcb\Dependabot\Secrets\CbSecretNameRcb $hydrator, string $org, string $secret_name)
    {
        $this->org = $org;
     ...
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\OrganizationDependabotSecret
    {
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return $this->hydrator->hydrateObject('Schema\\OrganizationDependabotSecret', $body);
                }
                break;
        }
