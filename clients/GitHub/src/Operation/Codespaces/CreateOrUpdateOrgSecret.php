...
final class CreateOrUpdateOrgSecret
{
    ...
    /**
     * @return Schema\EmptyObject|Schema\BasicError|Schema\ValidationError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\EmptyObject|Schema\BasicError|Schema\ValidationError
    {
