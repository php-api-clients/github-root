...
final class CreateInvitation
{
    ...
    /**
     * @return Schema\OrganizationInvitation|Schema\ValidationError|Schema\BasicError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\OrganizationInvitation|Schema\ValidationError|Schema\BasicError
    {
