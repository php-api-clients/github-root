...
final class StartImport
{
    ...
    /**
     * @return Schema\Import|Schema\ValidationError|Schema\BasicError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\Import|Schema\ValidationError|Schema\BasicError
    {
