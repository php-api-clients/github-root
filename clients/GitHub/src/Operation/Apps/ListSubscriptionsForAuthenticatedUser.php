...
final class ListSubscriptionsForAuthenticatedUser
{
    ...
    private readonly Hydrator\Operation\User\MarketplacePurchases $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\User\MarketplacePurchases $hydrator, int $per_page = 30, int $page = 1)
    {
    ...
    /**
     * @return \Rx\Observable<Schema\UserMarketplacePurchase>|Schema\BasicError
     */
