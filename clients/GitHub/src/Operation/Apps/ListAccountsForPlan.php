...
final class ListAccountsForPlan
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\MarketplaceListing\Plans\CbPlanIdRcb\Accounts $hydrator, int $plan_id, string $direction, string $sort = 'created', int $per_page = 30, int $page = 1)
    {
    ...
    /**
     * @return \Rx\Observable<Schema\MarketplacePurchase>|Schema\BasicError|Schema\ValidationError
     */
