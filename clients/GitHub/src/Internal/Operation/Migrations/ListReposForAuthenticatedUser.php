...
use ApiClients\Client\GitHub\Internal\Hydrator\Operation\User\Migrations\MigrationId\Repositories;
...
final class ListReposForAuthenticatedUser
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Repositories $hydrator, int $migrationId, int $perPage = 30, int $page = 1)
    {
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/user/migrations/{migration_id}/repositories{?page,per_page}'))->expand(['migration_id' => $this->migrationId, 'page' => $this->page, 'per_page' => $this->perPage]));
    }
