...
final class StartForAuthenticatedUser
{
    ...
    public function __construct(private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private Migrations $hydrator)
    {
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('POST', (string) (new UriTemplate('/user/migrations'))->expand([]), ['Content-Type' => 'application/json'], json_encode($data));
    }
