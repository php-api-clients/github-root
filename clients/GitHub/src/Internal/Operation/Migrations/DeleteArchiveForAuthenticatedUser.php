...
use ApiClients\Client\GitHub\Internal\Hydrator\Operation\User\Migrations\MigrationId\Archive;
...
final class DeleteArchiveForAuthenticatedUser
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Archive $hydrator, int $migrationId)
    {
    ...
    {
        return new Request('DELETE', (string) (new UriTemplate('/user/migrations/{migration_id}/archive'))->expand(['migration_id' => $this->migrationId]));
    }
