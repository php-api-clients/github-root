...
use ApiClients\Client\GitHub\Schema\Migrations\MapCommitAuthor\Request\ApplicationJson;
...
final class MapCommitAuthor
{
    ...
    public function __construct(private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private AuthorId $hydrator, string $owner, string $repo, private int $authorId)
    {
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('PATCH', (string) (new UriTemplate('/repos/{owner}/{repo}/import/authors/{author_id}'))->expand(['author_id' => $this->authorId, 'owner' => $this->owner, 'repo' => $this->repo]), ['Content-Type' => 'application/json'], json_encode($data));
    }

    public function createResponse(ResponseInterface $response): PorterAuthor
    {
        ...
        switch ($contentType) {
            case 'application/json':
                ...
                switch ($code) {
                     ...
                     **/
                    case 200:
                        $this->responseSchemaValidator->validate($body, Reader::readFromJson(PorterAuthor::SCHEMA_JSON, Schema::class));
