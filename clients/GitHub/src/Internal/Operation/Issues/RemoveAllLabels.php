...
final class RemoveAllLabels
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Labels $hydrator, string $owner, string $repo, int $issueNumber)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
    ...
    {
        return new Request('DELETE', (string) (new UriTemplate('/repos/{owner}/{repo}/issues/{issue_number}/labels'))->expand(['issue_number' => $this->issueNumber, 'owner' => $this->owner, 'repo' => $this->repo]));
    }
