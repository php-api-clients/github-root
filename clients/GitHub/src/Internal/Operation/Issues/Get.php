...
final class Get
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private IssueNumber $hydrator, string $owner, string $repo, int $issueNumber)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/repos/{owner}/{repo}/issues/{issue_number}'))->expand(['issue_number' => $this->issueNumber, 'owner' => $this->owner, 'repo' => $this->repo]));
    }

    public function createResponse(ResponseInterface $response): Issue|BasicError|WithoutBody
    {
