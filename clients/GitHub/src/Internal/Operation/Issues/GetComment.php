...
final class GetComment
{
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/repos/{owner}/{repo}/issues/comments/{comment_id}'))->expand(['comment_id' => $this->commentId, 'owner' => $this->owner, 'repo' => $this->repo]));
    }
