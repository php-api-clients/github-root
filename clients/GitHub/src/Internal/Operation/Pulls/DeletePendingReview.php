...
final class DeletePendingReview
{
    ...
    {
        return new Request('DELETE', (string) (new UriTemplate('/repos/{owner}/{repo}/pulls/{pull_number}/reviews/{review_id}'))->expand(['owner' => $this->owner, 'pull_number' => $this->pullNumber, 'repo' => $this->repo, 'review_id' => $this->reviewId]));
    }
