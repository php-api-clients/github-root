...
final class UpdateReview
{
    ...
    public function __construct(private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private ReviewId $hydrator, string $owner, string $repo, int $pullNumber, int $reviewId)
    {
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('PUT', (string) (new UriTemplate('/repos/{owner}/{repo}/pulls/{pull_number}/reviews/{review_id}'))->expand(['owner' => $this->owner, 'pull_number' => $this->pullNumber, 'repo' => $this->repo, 'review_id' => $this->reviewId]), ['Content-Type' => 'application/json'], json_encode($data));
    }
