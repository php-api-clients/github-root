...
final class DeleteReviewComment
{
    ...
    {
        return new Request('DELETE', (string) (new UriTemplate('/repos/{owner}/{repo}/pulls/comments/{comment_id}'))->expand(['comment_id' => $this->commentId, 'owner' => $this->owner, 'repo' => $this->repo]));
    }
