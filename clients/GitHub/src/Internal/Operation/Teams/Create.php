...
use ApiClients\Client\GitHub\Internal\Hydrator\Operation\Orgs\Org\Teams;
use ApiClients\Client\GitHub\Schema\BasicError;
use ApiClients\Client\GitHub\Schema\TeamFull;
use ApiClients\Client\GitHub\Schema\Teams\Create\Request\ApplicationJson;
...
final class Create
{
    ...
    public function __construct(private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private Teams $hydrator, string $org)
    {
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('POST', (string) (new UriTemplate('/orgs/{org}/teams'))->expand(['org' => $this->org]), ['Content-Type' => 'application/json'], json_encode($data));
    }
