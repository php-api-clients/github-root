...
final class ListDiscussionsLegacy
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Discussions $hydrator, int $teamId, string $direction = 'desc', int $perPage = 30, int $page = 1)
    {
        $this->teamId                  = $teamId;
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/teams/{team_id}/discussions{?direction,page,per_page}'))->expand(['direction' => $this->direction, 'page' => $this->page, 'per_page' => $this->perPage, 'team_id' => $this->teamId]));
    }
