...
final class DeleteLegacy
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private TeamId $hydrator, int $teamId)
    {
        $this->teamId                  = $teamId;
    ...
    {
        return new Request('DELETE', (string) (new UriTemplate('/teams/{team_id}'))->expand(['team_id' => $this->teamId]));
    }
