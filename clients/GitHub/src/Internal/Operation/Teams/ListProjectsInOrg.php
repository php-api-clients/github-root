...
final class ListProjectsInOrg
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Projects $hydrator, string $org, string $teamSlug, int $perPage = 30, int $page = 1)
    {
        $this->org                     = $org;
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/orgs/{org}/teams/{team_slug}/projects{?page,per_page}'))->expand(['org' => $this->org, 'page' => $this->page, 'per_page' => $this->perPage, 'team_slug' => $this->teamSlug]));
    }
