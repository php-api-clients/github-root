...
final class AddOrUpdateRepoPermissionsLegacy
{
    ...
    public function __construct(private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private Repo $hydrator, int $teamId, string $owner, string $repo)
    {
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('PUT', (string) (new UriTemplate('/teams/{team_id}/repos/{owner}/{repo}'))->expand(['owner' => $this->owner, 'repo' => $this->repo, 'team_id' => $this->teamId]), ['Content-Type' => 'application/json'], json_encode($data));
    }
