...
final class DeleteDiscussionCommentLegacy
{
    ...
    {
        return new Request('DELETE', (string) (new UriTemplate('/teams/{team_id}/discussions/{discussion_number}/comments/{comment_number}'))->expand(['comment_number' => $this->commentNumber, 'discussion_number' => $this->discussionNumber, 'team_id' => $this->teamId]));
    }
