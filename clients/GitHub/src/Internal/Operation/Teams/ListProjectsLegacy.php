...
final class ListProjectsLegacy
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Projects $hydrator, int $teamId, int $perPage = 30, int $page = 1)
    {
        $this->teamId                  = $teamId;
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/teams/{team_id}/projects{?page,per_page}'))->expand(['page' => $this->page, 'per_page' => $this->perPage, 'team_id' => $this->teamId]));
    }
