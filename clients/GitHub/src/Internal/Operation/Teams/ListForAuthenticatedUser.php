...
use ApiClients\Client\GitHub\Internal\Hydrator\Operation\User\Teams;
...
final class ListForAuthenticatedUser
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Teams $hydrator, int $perPage = 30, int $page = 1)
    {
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/user/teams{?page,per_page}'))->expand(['page' => $this->page, 'per_page' => $this->perPage]));
    }

    /** @return Observable<TeamFull>|WithoutBody */
