...
use ApiClients\Client\GitHub\Schema\Teams\UpdateInOrg\Request\ApplicationJson;
...
final class UpdateInOrg
{
    ...
    public function __construct(private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private TeamSlug $hydrator, string $org, string $teamSlug)
    {
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('PATCH', (string) (new UriTemplate('/orgs/{org}/teams/{team_slug}'))->expand(['org' => $this->org, 'team_slug' => $this->teamSlug]), ['Content-Type' => 'application/json'], json_encode($data));
    }
