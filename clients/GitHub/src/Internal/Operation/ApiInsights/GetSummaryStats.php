...
final class GetSummaryStats
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private SummaryStats $hydrator, string $org, string $minTimestamp, string $maxTimestamp)
    {
        $this->org                     = $org;
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/orgs/{org}/insights/api/summary-stats{?max_timestamp,min_timestamp}'))->expand(['max_timestamp' => $this->maxTimestamp, 'min_timestamp' => $this->minTimestamp, 'org' => $this->org]));
    }
