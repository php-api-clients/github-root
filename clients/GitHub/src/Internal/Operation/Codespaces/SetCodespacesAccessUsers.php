...
use ApiClients\Client\GitHub\Schema\Codespaces\SetCodespacesAccessUsers\Request\ApplicationJson;
...
final class SetCodespacesAccessUsers
{
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('POST', (string) (new UriTemplate('/orgs/{org}/codespaces/access/selected_users'))->expand(['org' => $this->org]), ['Content-Type' => 'application/json'], json_encode($data));
    }
