...
final class ListRepositoriesForSecretForAuthenticatedUser
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Repositories $hydrator, string $secretName)
    {
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/user/codespaces/secrets/{secret_name}/repositories'))->expand(['secret_name' => $this->secretName]));
    }
