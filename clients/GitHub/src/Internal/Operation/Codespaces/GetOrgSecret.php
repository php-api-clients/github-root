...
final class GetOrgSecret
{
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/orgs/{org}/codespaces/secrets/{secret_name}'))->expand(['org' => $this->org, 'secret_name' => $this->secretName]));
    }

    public function createResponse(ResponseInterface $response): CodespacesOrgSecret
    {
        ...
        switch ($contentType) {
            case 'application/json':
                ...
                switch ($code) {
                     ...
                     **/
                    case 200:
                        $this->responseSchemaValidator->validate($body, Reader::readFromJson(CodespacesOrgSecret::SCHEMA_JSON, Schema::class));

                        return $this->hydrator->hydrateObject(CodespacesOrgSecret::class, $body);
                }
