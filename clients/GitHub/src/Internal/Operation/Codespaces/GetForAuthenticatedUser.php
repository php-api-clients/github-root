...
final class GetForAuthenticatedUser
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private CodespaceName $hydrator, string $codespaceName)
    {
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/user/codespaces/{codespace_name}'))->expand(['codespace_name' => $this->codespaceName]));
    }
