...
use ApiClients\Client\GitHub\Internal\Hydrator\Operation\User\Codespaces\CodespaceName\Machines;
...
final class CodespaceMachinesForAuthenticatedUser
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Machines $hydrator, string $codespaceName)
    {
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/user/codespaces/{codespace_name}/machines'))->expand(['codespace_name' => $this->codespaceName]));
    }
