...
use ApiClients\Client\GitHub\Schema\Codespaces\CreateOrUpdateOrgSecret\Request\ApplicationJson;
...
final class CreateOrUpdateOrgSecret
{
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('PUT', (string) (new UriTemplate('/orgs/{org}/codespaces/secrets/{secret_name}'))->expand(['org' => $this->org, 'secret_name' => $this->secretName]), ['Content-Type' => 'application/json'], json_encode($data));
    }
