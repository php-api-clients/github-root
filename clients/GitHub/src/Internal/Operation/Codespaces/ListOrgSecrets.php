...
use ApiClients\Client\GitHub\Internal\Hydrator\Operation\Orgs\Org\Codespaces\Secrets;
...
final class ListOrgSecrets
{
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/orgs/{org}/codespaces/secrets{?page,per_page}'))->expand(['org' => $this->org, 'page' => $this->page, 'per_page' => $this->perPage]));
    }
