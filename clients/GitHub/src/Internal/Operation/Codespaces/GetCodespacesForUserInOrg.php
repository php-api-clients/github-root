...
use ApiClients\Client\GitHub\Internal\Hydrator\Operation\Orgs\Org\Members\Username\Codespaces;
...
final class GetCodespacesForUserInOrg
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Codespaces $hydrator, string $org, string $username, int $perPage = 30, int $page = 1)
    {
        $this->org                     = $org;
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/orgs/{org}/members/{username}/codespaces{?page,per_page}'))->expand(['org' => $this->org, 'page' => $this->page, 'per_page' => $this->perPage, 'username' => $this->username]));
    }
