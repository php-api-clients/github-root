...
final class DeleteFromOrganization
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private CodespaceName $hydrator, string $org, string $username, string $codespaceName)
    {
        $this->org                     = $org;
    ...
    {
        return new Request('DELETE', (string) (new UriTemplate('/orgs/{org}/members/{username}/codespaces/{codespace_name}'))->expand(['codespace_name' => $this->codespaceName, 'org' => $this->org, 'username' => $this->username]));
    }
