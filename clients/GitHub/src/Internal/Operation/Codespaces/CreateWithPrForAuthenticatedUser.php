...
use ApiClients\Client\GitHub\Internal\Hydrator\Operation\Repos\Owner\Repo\Pulls\PullNumber\Codespaces;
...
final class CreateWithPrForAuthenticatedUser
{
    ...
    public function __construct(private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private Codespaces $hydrator, string $owner, string $repo, int $pullNumber)
    {
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('POST', (string) (new UriTemplate('/repos/{owner}/{repo}/pulls/{pull_number}/codespaces'))->expand(['owner' => $this->owner, 'pull_number' => $this->pullNumber, 'repo' => $this->repo]), ['Content-Type' => 'application/json'], json_encode($data));
    }
