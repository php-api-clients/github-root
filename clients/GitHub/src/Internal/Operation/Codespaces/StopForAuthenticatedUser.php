...
use ApiClients\Client\GitHub\Internal\Hydrator\Operation\User\Codespaces\CodespaceName\Stop;
...
final class StopForAuthenticatedUser
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Stop $hydrator, string $codespaceName)
    {
    ...
    {
        return new Request('POST', (string) (new UriTemplate('/user/codespaces/{codespace_name}/stop'))->expand(['codespace_name' => $this->codespaceName]));
    }
