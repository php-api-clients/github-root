...
final class ListCodeqlDatabases
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Databases $hydrator, string $owner, string $repo)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/repos/{owner}/{repo}/code-scanning/codeql/databases'))->expand(['owner' => $this->owner, 'repo' => $this->repo]));
    }
