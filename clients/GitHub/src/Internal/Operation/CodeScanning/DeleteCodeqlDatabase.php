...
final class DeleteCodeqlDatabase
{
    ...
    {
        return new Request('DELETE', (string) (new UriTemplate('/repos/{owner}/{repo}/code-scanning/codeql/databases/{language}'))->expand(['language' => $this->language, 'owner' => $this->owner, 'repo' => $this->repo]));
    }
