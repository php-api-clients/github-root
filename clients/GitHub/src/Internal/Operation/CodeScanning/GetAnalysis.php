...
final class GetAnalysis
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private AnalysisId $hydrator, string $owner, string $repo, int $analysisId)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/repos/{owner}/{repo}/code-scanning/analyses/{analysis_id}'))->expand(['analysis_id' => $this->analysisId, 'owner' => $this->owner, 'repo' => $this->repo]));
    }

    public function createResponse(ResponseInterface $response): CodeScanningAnalysis
    {
        ...
        switch ($contentType) {
            case 'application/json':
                ...
                switch ($code) {
                     ...
                     **/
                    case 200:
                        $this->responseSchemaValidator->validate($body, Reader::readFromJson(CodeScanningAnalysis::SCHEMA_JSON, Schema::class));
