...
final class ListCollaborators
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Collaborators $hydrator, int $projectId, string $affiliation = 'all', int $perPage = 30, int $page = 1)
    {
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/projects/{project_id}/collaborators{?affiliation,page,per_page}'))->expand(['affiliation' => $this->affiliation, 'page' => $this->page, 'per_page' => $this->perPage, 'project_id' => $this->projectId]));
    }
