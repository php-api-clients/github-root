...
final class RemoveCollaborator
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Username $hydrator, int $projectId, string $username)
    {
    ...
    {
        return new Request('DELETE', (string) (new UriTemplate('/projects/{project_id}/collaborators/{username}'))->expand(['project_id' => $this->projectId, 'username' => $this->username]));
    }
