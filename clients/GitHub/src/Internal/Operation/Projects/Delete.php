...
use ApiClients\Client\GitHub\Schema\Operations\Projects\Delete\Response\ApplicationJson\Forbidden\Application\Json;
...
final class Delete
{
    ...
    {
        return new Request('DELETE', (string) (new UriTemplate('/projects/{project_id}'))->expand(['project_id' => $this->projectId]));
    }
            ...
            case 'application/json':
                ...
                switch ($code) {
                    ...
                    case 403:
                        ...
                        throw new \ApiClients\Client\GitHub\Error\Operations\Projects\Delete\Response\ApplicationJson\Forbidden\Application\Json(403, $this->hydrator->hydrateObject(Json::class, $body));
                    /**
