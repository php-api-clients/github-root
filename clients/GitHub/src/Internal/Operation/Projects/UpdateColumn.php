...
final class UpdateColumn
{
    ...
    public function __construct(private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private ColumnId $hydrator, int $columnId)
    {
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('PATCH', (string) (new UriTemplate('/projects/columns/{column_id}'))->expand(['column_id' => $this->columnId]), ['Content-Type' => 'application/json'], json_encode($data));
    }
