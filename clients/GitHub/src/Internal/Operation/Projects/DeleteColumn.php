...
final class DeleteColumn
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private ColumnId $hydrator, int $columnId)
    {
    ...
    {
        return new Request('DELETE', (string) (new UriTemplate('/projects/columns/{column_id}'))->expand(['column_id' => $this->columnId]));
    }
