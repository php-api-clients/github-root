...
use ApiClients\Client\GitHub\Internal\Hydrator\Operation\Repos\Owner\Repo\Pages\Deployments;
use ApiClients\Client\GitHub\Schema\BasicError;
use ApiClients\Client\GitHub\Schema\PageDeployment;
use ApiClients\Client\GitHub\Schema\Repos\CreatePagesDeployment\Request\ApplicationJson;
...
final class CreatePagesDeployment
{
    ...
    public const OPERATION_MATCH = 'POST /repos/{owner}/{repo}/pages/deployments';
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('POST', (string) (new UriTemplate('/repos/{owner}/{repo}/pages/deployments'))->expand(['owner' => $this->owner, 'repo' => $this->repo]), ['Content-Type' => 'application/json'], json_encode($data));
    }

    public function createResponse(ResponseInterface $response): PageDeployment
    {
        ...
        switch ($contentType) {
            case 'application/json':
                ...
                switch ($code) {
                     ...
                     **/
                    case 200:
                        $this->responseSchemaValidator->validate($body, Reader::readFromJson(PageDeployment::SCHEMA_JSON, Schema::class));

                        return $this->hydrator->hydrateObject(PageDeployment::class, $body);
                    /**
                     * Bad Request
                     **/
