...
final class UpdateRelease
{
    ...
    public function __construct(private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private ReleaseId $hydrator, string $owner, string $repo, int $releaseId)
    {
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('PATCH', (string) (new UriTemplate('/repos/{owner}/{repo}/releases/{release_id}'))->expand(['owner' => $this->owner, 'release_id' => $this->releaseId, 'repo' => $this->repo]), ['Content-Type' => 'application/json'], json_encode($data));
    }
