...
final class DeleteAdminBranchProtection
{
    ...
    {
        return new Request('DELETE', (string) (new UriTemplate('/repos/{owner}/{repo}/branches/{branch}/protection/enforce_admins'))->expand(['branch' => $this->branch, 'owner' => $this->owner, 'repo' => $this->repo]));
    }
