...
use ApiClients\Client\GitHub\Schema\ContentTraffic;
...
final class GetTopPaths
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Paths $hydrator, string $owner, string $repo)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/repos/{owner}/{repo}/traffic/popular/paths'))->expand(['owner' => $this->owner, 'repo' => $this->repo]));
    }
                    ...
                    case 200:
                        return Observable::fromArray($body, new ImmediateScheduler())->map(function (array $body): ContentTraffic {
                            ...
                            try {
                                ...
                                return $this->hydrator->hydrateObject(ContentTraffic::class, $body);
