...
final class UpdateWebhook
{
    ...
    public function __construct(private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private HookId $hydrator, string $owner, string $repo, int $hookId)
    {
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('PATCH', (string) (new UriTemplate('/repos/{owner}/{repo}/hooks/{hook_id}'))->expand(['hook_id' => $this->hookId, 'owner' => $this->owner, 'repo' => $this->repo]), ['Content-Type' => 'application/json'], json_encode($data));
    }
