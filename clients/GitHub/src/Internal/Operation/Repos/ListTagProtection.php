...
final class ListTagProtection
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Protection $hydrator, string $owner, string $repo)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/repos/{owner}/{repo}/tags/protection'))->expand(['owner' => $this->owner, 'repo' => $this->repo]));
    }
                    ...
                    case 200:
                        return Observable::fromArray($body, new ImmediateScheduler())->map(function (array $body): TagProtection {
                            ...
                            try {
                                ...
                                return $this->hydrator->hydrateObject(TagProtection::class, $body);
