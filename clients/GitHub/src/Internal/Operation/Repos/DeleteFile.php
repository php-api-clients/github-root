...
use ApiClients\Client\GitHub\Schema\Repos\DeleteFile\Request\ApplicationJson;
...
final class DeleteFile
{
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('DELETE', (string) (new UriTemplate('/repos/{owner}/{repo}/contents/{path}'))->expand(['owner' => $this->owner, 'path' => $this->path, 'repo' => $this->repo]), ['Content-Type' => 'application/json'], json_encode($data));
    }
