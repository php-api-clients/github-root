...
final class GetOrgRuleset
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private RulesetId $hydrator, string $org, int $rulesetId)
    {
        $this->org                     = $org;
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/orgs/{org}/rulesets/{ruleset_id}'))->expand(['org' => $this->org, 'ruleset_id' => $this->rulesetId]));
    }
