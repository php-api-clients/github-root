...
final class DeleteCommitSignatureProtection
{
    ...
    {
        return new Request('DELETE', (string) (new UriTemplate('/repos/{owner}/{repo}/branches/{branch}/protection/required_signatures'))->expand(['branch' => $this->branch, 'owner' => $this->owner, 'repo' => $this->repo]));
    }
