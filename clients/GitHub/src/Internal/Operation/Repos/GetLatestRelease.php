...
final class GetLatestRelease
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Latest $hydrator, string $owner, string $repo)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/repos/{owner}/{repo}/releases/latest'))->expand(['owner' => $this->owner, 'repo' => $this->repo]));
    }
