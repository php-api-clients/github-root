...
final class DeleteInvitation
{
    ...
    {
        return new Request('DELETE', (string) (new UriTemplate('/repos/{owner}/{repo}/invitations/{invitation_id}'))->expand(['invitation_id' => $this->invitationId, 'owner' => $this->owner, 'repo' => $this->repo]));
    }
