...
use ApiClients\Client\GitHub\Schema\Repos\UpdateInformationAboutPagesSite\Request\ApplicationJson;
...
final class UpdateInformationAboutPagesSite
{
    ...
    public function __construct(private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private Pages $hydrator, string $owner, string $repo)
    {
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('PUT', (string) (new UriTemplate('/repos/{owner}/{repo}/pages'))->expand(['owner' => $this->owner, 'repo' => $this->repo]), ['Content-Type' => 'application/json'], json_encode($data));
    }
