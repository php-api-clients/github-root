...
final class DeleteRepoRuleset
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private RulesetId $hydrator, string $owner, string $repo, int $rulesetId)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
    ...
    {
        return new Request('DELETE', (string) (new UriTemplate('/repos/{owner}/{repo}/rulesets/{ruleset_id}'))->expand(['owner' => $this->owner, 'repo' => $this->repo, 'ruleset_id' => $this->rulesetId]));
    }
