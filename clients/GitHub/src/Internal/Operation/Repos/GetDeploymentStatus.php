...
final class GetDeploymentStatus
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private StatusId $hydrator, string $owner, string $repo, int $deploymentId, private int $statusId)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/repos/{owner}/{repo}/deployments/{deployment_id}/statuses/{status_id}'))->expand(['deployment_id' => $this->deploymentId, 'owner' => $this->owner, 'repo' => $this->repo, 'status_id' => $this->statusId]));
    }
