...
final class SetUserAccessRestrictions
{
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('PUT', (string) (new UriTemplate('/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/users'))->expand(['branch' => $this->branch, 'owner' => $this->owner, 'repo' => $this->repo]), ['Content-Type' => 'application/json'], json_encode($data));
    }
