...
final class ListInvitationsForAuthenticatedUser
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private RepositoryInvitations $hydrator, int $perPage = 30, int $page = 1)
    {
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/user/repository_invitations{?page,per_page}'))->expand(['page' => $this->page, 'per_page' => $this->perPage]));
    }
