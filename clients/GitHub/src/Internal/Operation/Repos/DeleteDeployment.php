...
final class DeleteDeployment
{
    ...
    {
        return new Request('DELETE', (string) (new UriTemplate('/repos/{owner}/{repo}/deployments/{deployment_id}'))->expand(['deployment_id' => $this->deploymentId, 'owner' => $this->owner, 'repo' => $this->repo]));
    }
