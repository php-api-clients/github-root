...
final class RemoveTeamAccessRestrictions
{
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('DELETE', (string) (new UriTemplate('/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/teams'))->expand(['branch' => $this->branch, 'owner' => $this->owner, 'repo' => $this->repo]), ['Content-Type' => 'application/json'], json_encode($data));
    }
