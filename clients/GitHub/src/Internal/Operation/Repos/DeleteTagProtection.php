...
final class DeleteTagProtection
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private TagProtectionId $hydrator, string $owner, string $repo, int $tagProtectionId)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
    ...
    {
        return new Request('DELETE', (string) (new UriTemplate('/repos/{owner}/{repo}/tags/protection/{tag_protection_id}'))->expand(['owner' => $this->owner, 'repo' => $this->repo, 'tag_protection_id' => $this->tagProtectionId]));
    }
