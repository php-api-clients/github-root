...
use ApiClients\Client\GitHub\Schema\Repos\CreateOrgRuleset\Request\ApplicationJson;
...
final class CreateOrgRuleset
{
    ...
    public function __construct(private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private Rulesets $hydrator, string $org)
    {
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('POST', (string) (new UriTemplate('/orgs/{org}/rulesets'))->expand(['org' => $this->org]), ['Content-Type' => 'application/json'], json_encode($data));
    }
