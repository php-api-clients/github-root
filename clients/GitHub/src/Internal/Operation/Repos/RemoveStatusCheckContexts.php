...
use ApiClients\Client\GitHub\Schema\Repos\RemoveStatusCheckContexts\Request\ApplicationJson;
...
final class RemoveStatusCheckContexts
{
    ...
    public function __construct(private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private Contexts $hydrator, string $owner, string $repo, string $branch)
    {
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('DELETE', (string) (new UriTemplate('/repos/{owner}/{repo}/branches/{branch}/protection/required_status_checks/contexts'))->expand(['branch' => $this->branch, 'owner' => $this->owner, 'repo' => $this->repo]), ['Content-Type' => 'application/json'], json_encode($data));
    }
