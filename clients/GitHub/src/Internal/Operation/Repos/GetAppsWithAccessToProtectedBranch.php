...
final class GetAppsWithAccessToProtectedBranch
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Apps $hydrator, string $owner, string $repo, string $branch)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
        $this->branch                  = $branch;
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/apps'))->expand(['branch' => $this->branch, 'owner' => $this->owner, 'repo' => $this->repo]));
    }
