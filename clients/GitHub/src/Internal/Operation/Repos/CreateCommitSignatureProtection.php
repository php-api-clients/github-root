...
final class CreateCommitSignatureProtection
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private RequiredSignatures $hydrator, string $owner, string $repo, string $branch)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
        $this->branch                  = $branch;
    ...
    {
        return new Request('POST', (string) (new UriTemplate('/repos/{owner}/{repo}/branches/{branch}/protection/required_signatures'))->expand(['branch' => $this->branch, 'owner' => $this->owner, 'repo' => $this->repo]));
    }
