...
use ApiClients\Client\GitHub\Schema\Activity\SetThreadSubscription\Request\ApplicationJson;
...
final class SetThreadSubscription
{
    ...
    public function __construct(private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private Subscription $hydrator, int $threadId)
    {
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('PUT', (string) (new UriTemplate('/notifications/threads/{thread_id}/subscription'))->expand(['thread_id' => $this->threadId]), ['Content-Type' => 'application/json'], json_encode($data));
    }

    public function createResponse(ResponseInterface $response): ThreadSubscription|WithoutBody
    {
        ...
        switch ($contentType) {
            case 'application/json':
                ...
                switch ($code) {
                     ...
                     **/
                    case 200:
                        $this->responseSchemaValidator->validate($body, Reader::readFromJson(ThreadSubscription::SCHEMA_JSON, Schema::class));

                        return $this->hydrator->hydrateObject(ThreadSubscription::class, $body);
                    /**
                     * Forbidden
                     **/
