...
final class DeleteThreadSubscription
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Subscription $hydrator, int $threadId)
    {
    ...
    {
        return new Request('DELETE', (string) (new UriTemplate('/notifications/threads/{thread_id}/subscription'))->expand(['thread_id' => $this->threadId]));
    }
