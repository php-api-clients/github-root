...
final class GetConfiguration
{
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/orgs/{org}/code-security/configurations/{configuration_id}'))->expand(['configuration_id' => $this->configurationId, 'org' => $this->org]));
    }
