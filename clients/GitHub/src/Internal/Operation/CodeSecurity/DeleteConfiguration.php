...
final class DeleteConfiguration
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private ConfigurationId $hydrator, string $org, int $configurationId)
    {
        $this->org                     = $org;
    ...
    {
        return new Request('DELETE', (string) (new UriTemplate('/orgs/{org}/code-security/configurations/{configuration_id}'))->expand(['configuration_id' => $this->configurationId, 'org' => $this->org]));
    }
