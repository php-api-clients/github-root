...
use ApiClients\Client\GitHub\Internal\Hydrator\Operation\Orgs\Org\Copilot\Billing\Seats;
...
final class ListCopilotSeats
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Seats $hydrator, string $org, int $page = 1, int $perPage = 50)
    {
        $this->org                     = $org;
        $this->page                    = $page;
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/orgs/{org}/copilot/billing/seats{?page,per_page}'))->expand(['org' => $this->org, 'page' => $this->page, 'per_page' => $this->perPage]));
    }
