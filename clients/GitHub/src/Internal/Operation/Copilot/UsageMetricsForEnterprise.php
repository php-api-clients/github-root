...
final class UsageMetricsForEnterprise
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Usage $hydrator, string $enterprise, string $since, string $until, int $page = 1, int $perPage = 28)
    {
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/enterprises/{enterprise}/copilot/usage{?page,per_page,since,until}'))->expand(['enterprise' => $this->enterprise, 'page' => $this->page, 'per_page' => $this->perPage, 'since' => $this->since, 'until' => $this->until]));
    }
