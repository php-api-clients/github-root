...
final class CancelCopilotSeatAssignmentForUsers
{
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('DELETE', (string) (new UriTemplate('/orgs/{org}/copilot/billing/selected_users'))->expand(['org' => $this->org]), ['Content-Type' => 'application/json'], json_encode($data));
    }
