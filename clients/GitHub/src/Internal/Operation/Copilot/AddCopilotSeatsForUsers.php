...
use ApiClients\Client\GitHub\Internal\Hydrator\Operation\Orgs\Org\Copilot\Billing\SelectedUsers;
...
final class AddCopilotSeatsForUsers
{
    ...
    public function __construct(private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private SelectedUsers $hydrator, string $org)
    {
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('POST', (string) (new UriTemplate('/orgs/{org}/copilot/billing/selected_users'))->expand(['org' => $this->org]), ['Content-Type' => 'application/json'], json_encode($data));
    }
