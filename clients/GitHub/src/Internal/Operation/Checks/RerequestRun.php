...
final class RerequestRun
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Rerequest $hydrator, string $owner, string $repo, int $checkRunId)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
    ...
    {
        return new Request('POST', (string) (new UriTemplate('/repos/{owner}/{repo}/check-runs/{check_run_id}/rerequest'))->expand(['check_run_id' => $this->checkRunId, 'owner' => $this->owner, 'repo' => $this->repo]));
    }
