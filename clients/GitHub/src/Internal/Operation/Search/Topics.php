...
final class Topics
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private \ApiClients\Client\GitHub\Internal\Hydrator\Operation\Search\Topics $hydrator, string $q, int $perPage = 30, int $page = 1)
    {
        $this->q                       = $q;
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/search/topics{?page,per_page,q}'))->expand(['page' => $this->page, 'per_page' => $this->perPage, 'q' => $this->q]));
    }
