...
final class Delete
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private GistId $hydrator, string $gistId)
    {
        $this->gistId                  = $gistId;
    ...
    {
        return new Request('DELETE', (string) (new UriTemplate('/gists/{gist_id}'))->expand(['gist_id' => $this->gistId]));
    }
