...
final class ListStarred
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Starred $hydrator, string $since, int $perPage = 30, int $page = 1)
    {
        $this->since                   = $since;
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/gists/starred{?page,per_page,since}'))->expand(['page' => $this->page, 'per_page' => $this->perPage, 'since' => $this->since]));
    }
