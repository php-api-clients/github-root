...
final class CreateComment
{
    ...
    public function __construct(private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private Comments $hydrator, string $gistId)
    {
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('POST', (string) (new UriTemplate('/gists/{gist_id}/comments'))->expand(['gist_id' => $this->gistId]), ['Content-Type' => 'application/json'], json_encode($data));
    }
