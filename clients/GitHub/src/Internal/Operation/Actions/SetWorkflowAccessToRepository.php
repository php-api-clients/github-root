...
final class SetWorkflowAccessToRepository
{
    ...
    {
        $this->requestSchemaValidator->validate($data, Reader::readFromJson(ActionsWorkflowAccessToRepository::SCHEMA_JSON, Schema::class));

        return new Request('PUT', (string) (new UriTemplate('/repos/{owner}/{repo}/actions/permissions/access'))->expand(['owner' => $this->owner, 'repo' => $this->repo]), ['Content-Type' => 'application/json'], json_encode($data));
    }
