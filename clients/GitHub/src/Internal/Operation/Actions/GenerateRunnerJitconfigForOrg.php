...
use ApiClients\Client\GitHub\Schema\Actions\GenerateRunnerJitconfigForOrg\Request\ApplicationJson;
...
final class GenerateRunnerJitconfigForOrg
{
    ...
    public function __construct(private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private GenerateJitconfig $hydrator, string $org)
    {
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('POST', (string) (new UriTemplate('/orgs/{org}/actions/runners/generate-jitconfig'))->expand(['org' => $this->org]), ['Content-Type' => 'application/json'], json_encode($data));
    }
