...
final class EnableSelectedRepositoryGithubActionsOrganization
{
    ...
    {
        return new Request('PUT', (string) (new UriTemplate('/orgs/{org}/actions/permissions/repositories/{repository_id}'))->expand(['org' => $this->org, 'repository_id' => $this->repositoryId]));
    }
