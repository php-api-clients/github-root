...
final class SetAllowedActionsRepository
{
    ...
    {
        $this->requestSchemaValidator->validate($data, Reader::readFromJson(SelectedActions::SCHEMA_JSON, Schema::class));

        return new Request('PUT', (string) (new UriTemplate('/repos/{owner}/{repo}/actions/permissions/selected-actions'))->expand(['owner' => $this->owner, 'repo' => $this->repo]), ['Content-Type' => 'application/json'], json_encode($data));
    }
