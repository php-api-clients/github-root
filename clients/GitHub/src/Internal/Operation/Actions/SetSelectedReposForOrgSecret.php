...
use ApiClients\Client\GitHub\Schema\Actions\SetSelectedReposForOrgSecret\Request\ApplicationJson;
...
final class SetSelectedReposForOrgSecret
{
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('PUT', (string) (new UriTemplate('/orgs/{org}/actions/secrets/{secret_name}/repositories'))->expand(['org' => $this->org, 'secret_name' => $this->secretName]), ['Content-Type' => 'application/json'], json_encode($data));
    }
