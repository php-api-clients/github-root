...
final class GetActionsCacheUsageByRepoForOrg
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private UsageByRepository $hydrator, string $org, int $perPage = 30, int $page = 1)
    {
        $this->org                     = $org;
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/orgs/{org}/actions/cache/usage-by-repository{?page,per_page}'))->expand(['org' => $this->org, 'page' => $this->page, 'per_page' => $this->perPage]));
    }
