...
final class DisableWorkflow
{
    ...
    {
        return new Request('PUT', (string) (new UriTemplate('/repos/{owner}/{repo}/actions/workflows/{workflow_id}/disable'))->expand(['owner' => $this->owner, 'repo' => $this->repo, 'workflow_id' => $this->workflowId]));
    }
