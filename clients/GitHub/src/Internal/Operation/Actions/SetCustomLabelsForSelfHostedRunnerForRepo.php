...
final class SetCustomLabelsForSelfHostedRunnerForRepo
{
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('PUT', (string) (new UriTemplate('/repos/{owner}/{repo}/actions/runners/{runner_id}/labels'))->expand(['owner' => $this->owner, 'repo' => $this->repo, 'runner_id' => $this->runnerId]), ['Content-Type' => 'application/json'], json_encode($data));
    }
