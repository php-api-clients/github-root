...
final class CreateRemoveTokenForOrg
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private RemoveToken $hydrator, string $org)
    {
        $this->org                     = $org;
    ...
    {
        return new Request('POST', (string) (new UriTemplate('/orgs/{org}/actions/runners/remove-token'))->expand(['org' => $this->org]));
    }
