...
final class ListSelfHostedRunnersInGroupForOrg
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Runners $hydrator, string $org, int $runnerGroupId, int $perPage = 30, int $page = 1)
    {
        $this->org                     = $org;
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/orgs/{org}/actions/runner-groups/{runner_group_id}/runners{?page,per_page}'))->expand(['org' => $this->org, 'page' => $this->page, 'per_page' => $this->perPage, 'runner_group_id' => $this->runnerGroupId]));
    }
