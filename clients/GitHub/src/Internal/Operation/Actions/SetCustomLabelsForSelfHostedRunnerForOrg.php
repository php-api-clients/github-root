...
final class SetCustomLabelsForSelfHostedRunnerForOrg
{
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('PUT', (string) (new UriTemplate('/orgs/{org}/actions/runners/{runner_id}/labels'))->expand(['org' => $this->org, 'runner_id' => $this->runnerId]), ['Content-Type' => 'application/json'], json_encode($data));
    }
