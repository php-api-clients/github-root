...
final class ListSelectedRepositoriesEnabledGithubActionsOrganization
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Repositories $hydrator, string $org, int $perPage = 30, int $page = 1)
    {
        $this->org                     = $org;
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/orgs/{org}/actions/permissions/repositories{?page,per_page}'))->expand(['org' => $this->org, 'page' => $this->page, 'per_page' => $this->perPage]));
    }
