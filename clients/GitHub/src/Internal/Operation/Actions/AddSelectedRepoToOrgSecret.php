...
final class AddSelectedRepoToOrgSecret
{
    ...
    {
        return new Request('PUT', (string) (new UriTemplate('/orgs/{org}/actions/secrets/{secret_name}/repositories/{repository_id}'))->expand(['org' => $this->org, 'repository_id' => $this->repositoryId, 'secret_name' => $this->secretName]));
    }
