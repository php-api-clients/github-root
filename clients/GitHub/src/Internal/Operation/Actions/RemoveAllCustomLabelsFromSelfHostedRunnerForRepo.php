...
final class RemoveAllCustomLabelsFromSelfHostedRunnerForRepo
{
    ...
    {
        return new Request('DELETE', (string) (new UriTemplate('/repos/{owner}/{repo}/actions/runners/{runner_id}/labels'))->expand(['owner' => $this->owner, 'repo' => $this->repo, 'runner_id' => $this->runnerId]));
    }
