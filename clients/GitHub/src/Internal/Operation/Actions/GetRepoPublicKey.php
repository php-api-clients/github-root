...
use ApiClients\Client\GitHub\Internal\Hydrator\Operation\Repos\Owner\Repo\Actions\Secrets\PublicKey;
...
final class GetRepoPublicKey
{
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/repos/{owner}/{repo}/actions/secrets/public-key'))->expand(['owner' => $this->owner, 'repo' => $this->repo]));
    }
