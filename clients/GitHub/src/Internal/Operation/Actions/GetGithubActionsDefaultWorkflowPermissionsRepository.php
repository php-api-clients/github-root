...
use ApiClients\Client\GitHub\Internal\Hydrator\Operation\Repos\Owner\Repo\Actions\Permissions\Workflow;
...
final class GetGithubActionsDefaultWorkflowPermissionsRepository
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Workflow $hydrator, string $owner, string $repo)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/repos/{owner}/{repo}/actions/permissions/workflow'))->expand(['owner' => $this->owner, 'repo' => $this->repo]));
    }
