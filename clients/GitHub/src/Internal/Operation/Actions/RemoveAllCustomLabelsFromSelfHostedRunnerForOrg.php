...
final class RemoveAllCustomLabelsFromSelfHostedRunnerForOrg
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Labels $hydrator, string $org, int $runnerId)
    {
        $this->org                     = $org;
    ...
    {
        return new Request('DELETE', (string) (new UriTemplate('/orgs/{org}/actions/runners/{runner_id}/labels'))->expand(['org' => $this->org, 'runner_id' => $this->runnerId]));
    }
