...
final class RemoveRepoAccessToSelfHostedRunnerGroupInOrg
{
    ...
    {
        return new Request('DELETE', (string) (new UriTemplate('/orgs/{org}/actions/runner-groups/{runner_group_id}/repositories/{repository_id}'))->expand(['org' => $this->org, 'repository_id' => $this->repositoryId, 'runner_group_id' => $this->runnerGroupId]));
    }
