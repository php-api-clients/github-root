...
final class GenerateRunnerJitconfigForRepo
{
    ...
    public function __construct(private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private GenerateJitconfig $hydrator, string $owner, string $repo)
    {
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('POST', (string) (new UriTemplate('/repos/{owner}/{repo}/actions/runners/generate-jitconfig'))->expand(['owner' => $this->owner, 'repo' => $this->repo]), ['Content-Type' => 'application/json'], json_encode($data));
    }
