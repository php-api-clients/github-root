...
use ApiClients\Client\GitHub\Schema\Actions\SetGithubActionsPermissionsOrganization\Request\ApplicationJson;
...
final class SetGithubActionsPermissionsOrganization
{
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('PUT', (string) (new UriTemplate('/orgs/{org}/actions/permissions'))->expand(['org' => $this->org]), ['Content-Type' => 'application/json'], json_encode($data));
    }
