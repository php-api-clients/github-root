...
use ApiClients\Client\GitHub\Internal\Hydrator\Operation\Repos\Owner\Repo\Actions\Permissions\SelectedActions;
...
final class GetAllowedActionsRepository
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private SelectedActions $hydrator, string $owner, string $repo)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/repos/{owner}/{repo}/actions/permissions/selected-actions'))->expand(['owner' => $this->owner, 'repo' => $this->repo]));
    }
