...
final class AddCustomLabelsToSelfHostedRunnerForOrg
{
    ...
    public function __construct(private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private Labels $hydrator, string $org, int $runnerId)
    {
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('POST', (string) (new UriTemplate('/orgs/{org}/actions/runners/{runner_id}/labels'))->expand(['org' => $this->org, 'runner_id' => $this->runnerId]), ['Content-Type' => 'application/json'], json_encode($data));
    }
