...
final class CreateSshSigningKeyForAuthenticatedUser
{
    ...
    public function __construct(private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private SshSigningKeys $hydrator)
    {
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('POST', (string) (new UriTemplate('/user/ssh_signing_keys'))->expand([]), ['Content-Type' => 'application/json'], json_encode($data));
    }
