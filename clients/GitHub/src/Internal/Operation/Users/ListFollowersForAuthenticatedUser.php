...
final class ListFollowersForAuthenticatedUser
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Followers $hydrator, int $perPage = 30, int $page = 1)
    {
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/user/followers{?page,per_page}'))->expand(['page' => $this->page, 'per_page' => $this->perPage]));
    }
