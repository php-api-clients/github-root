...
use ApiClients\Client\GitHub\Internal\Hydrator\Operation\User\Blocks\Username;
...
final class Unblock
{
    ...
    {
        return new Request('DELETE', (string) (new UriTemplate('/user/blocks/{username}'))->expand(['username' => $this->username]));
    }
