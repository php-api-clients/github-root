...
use ApiClients\Client\GitHub\Internal\Hydrator\Operation\Users\Username\SocialAccounts;
...
final class ListSocialAccountsForUser
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private SocialAccounts $hydrator, string $username, int $perPage = 30, int $page = 1)
    {
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/users/{username}/social_accounts{?page,per_page}'))->expand(['page' => $this->page, 'per_page' => $this->perPage, 'username' => $this->username]));
    }
