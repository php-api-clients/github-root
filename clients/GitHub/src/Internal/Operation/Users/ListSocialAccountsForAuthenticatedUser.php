...
final class ListSocialAccountsForAuthenticatedUser
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private SocialAccounts $hydrator, int $perPage = 30, int $page = 1)
    {
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/user/social_accounts{?page,per_page}'))->expand(['page' => $this->page, 'per_page' => $this->perPage]));
    }
