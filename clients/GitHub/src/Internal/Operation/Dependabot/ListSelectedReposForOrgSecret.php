...
use ApiClients\Client\GitHub\Internal\Hydrator\Operation\Orgs\Org\Dependabot\Secrets\SecretName\Repositories;
...
final class ListSelectedReposForOrgSecret
{
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/orgs/{org}/dependabot/secrets/{secret_name}/repositories{?page,per_page}'))->expand(['org' => $this->org, 'page' => $this->page, 'per_page' => $this->perPage, 'secret_name' => $this->secretName]));
    }
