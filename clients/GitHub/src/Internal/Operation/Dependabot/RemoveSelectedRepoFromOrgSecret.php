...
final class RemoveSelectedRepoFromOrgSecret
{
    ...
    {
        return new Request('DELETE', (string) (new UriTemplate('/orgs/{org}/dependabot/secrets/{secret_name}/repositories/{repository_id}'))->expand(['org' => $this->org, 'repository_id' => $this->repositoryId, 'secret_name' => $this->secretName]));
    }
