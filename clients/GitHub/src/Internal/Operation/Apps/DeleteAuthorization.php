...
final class DeleteAuthorization
{
    ...
    public function __construct(private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private Grant $hydrator, string $clientId)
    {
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('DELETE', (string) (new UriTemplate('/applications/{client_id}/grant'))->expand(['client_id' => $this->clientId]), ['Content-Type' => 'application/json'], json_encode($data));
    }
