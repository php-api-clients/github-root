...
use ApiClients\Client\GitHub\Schema\UserMarketplacePurchase;
...
final class ListSubscriptionsForAuthenticatedUser
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private MarketplacePurchases $hydrator, int $perPage = 30, int $page = 1)
    {
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/user/marketplace_purchases{?page,per_page}'))->expand(['page' => $this->page, 'per_page' => $this->perPage]));
    }
                    ...
                    case 200:
                        return Observable::fromArray($body, new ImmediateScheduler())->map(function (array $body): UserMarketplacePurchase {
                            ...
                            try {
                                ...
                                return $this->hydrator->hydrateObject(UserMarketplacePurchase::class, $body);
