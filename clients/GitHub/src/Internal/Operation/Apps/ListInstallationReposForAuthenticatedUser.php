...
final class ListInstallationReposForAuthenticatedUser
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Repositories $hydrator, int $installationId, int $perPage = 30, int $page = 1)
    {
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/user/installations/{installation_id}/repositories{?page,per_page}'))->expand(['installation_id' => $this->installationId, 'page' => $this->page, 'per_page' => $this->perPage]));
    }
