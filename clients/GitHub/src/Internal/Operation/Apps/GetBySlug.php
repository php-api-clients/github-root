...
final class GetBySlug
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private AppSlug $hydrator, private string $appSlug)
    {
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/apps/{app_slug}'))->expand(['app_slug' => $this->appSlug]));
    }
