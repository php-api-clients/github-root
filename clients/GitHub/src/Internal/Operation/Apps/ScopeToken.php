...
final class ScopeToken
{
    ...
    public function __construct(private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private Scoped $hydrator, string $clientId)
    {
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('POST', (string) (new UriTemplate('/applications/{client_id}/token/scoped'))->expand(['client_id' => $this->clientId]), ['Content-Type' => 'application/json'], json_encode($data));
    }
