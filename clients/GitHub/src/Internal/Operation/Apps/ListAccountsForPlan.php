...
final class ListAccountsForPlan
{
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/marketplace_listing/plans/{plan_id}/accounts{?direction,page,per_page,sort}'))->expand(['direction' => $this->direction, 'page' => $this->page, 'per_page' => $this->perPage, 'plan_id' => $this->planId, 'sort' => $this->sort]));
    }
