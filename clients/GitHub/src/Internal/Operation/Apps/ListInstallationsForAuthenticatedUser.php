...
use ApiClients\Client\GitHub\Internal\Hydrator\Operation\User\Installations;
...
final class ListInstallationsForAuthenticatedUser
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Installations $hydrator, int $perPage = 30, int $page = 1)
    {
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/user/installations{?page,per_page}'))->expand(['page' => $this->page, 'per_page' => $this->perPage]));
    }
