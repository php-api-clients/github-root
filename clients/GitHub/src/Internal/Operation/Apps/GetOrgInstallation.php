...
final class GetOrgInstallation
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Installation $hydrator, string $org)
    {
        $this->org                     = $org;
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/orgs/{org}/installation'))->expand(['org' => $this->org]));
    }
