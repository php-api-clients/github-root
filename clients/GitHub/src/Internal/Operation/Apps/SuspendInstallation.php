...
final class SuspendInstallation
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Suspended $hydrator, int $installationId)
    {
    ...
    {
        return new Request('PUT', (string) (new UriTemplate('/app/installations/{installation_id}/suspended'))->expand(['installation_id' => $this->installationId]));
    }
