...
final class GetSubscriptionPlanForAccountStubbed
{
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/marketplace_listing/stubbed/accounts/{account_id}'))->expand(['account_id' => $this->accountId]));
    }

    public function createResponse(ResponseInterface $response): MarketplacePurchase|WithoutBody
    {
