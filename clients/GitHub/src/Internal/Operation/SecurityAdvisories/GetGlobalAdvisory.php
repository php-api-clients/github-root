...
final class GetGlobalAdvisory
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private GhsaId $hydrator, string $ghsaId)
    {
        $this->ghsaId                  = $ghsaId;
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/advisories/{ghsa_id}'))->expand(['ghsa_id' => $this->ghsaId]));
    }

    public function createResponse(ResponseInterface $response): GlobalAdvisory
    {
        ...
        switch ($contentType) {
            case 'application/json':
                ...
                switch ($code) {
                     ...
                     **/
                    case 200:
                        $this->responseSchemaValidator->validate($body, Reader::readFromJson(GlobalAdvisory::SCHEMA_JSON, Schema::class));
