...
final class DeletePackageVersionForUser
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private PackageVersionId $hydrator, string $packageType, string $packageName, string $username, int $packageVersionId)
    {
    ...
    {
        return new Request('DELETE', (string) (new UriTemplate('/users/{username}/packages/{package_type}/{package_name}/versions/{package_version_id}'))->expand(['package_name' => $this->packageName, 'package_type' => $this->packageType, 'package_version_id' => $this->packageVersionId, 'username' => $this->username]));
    }
