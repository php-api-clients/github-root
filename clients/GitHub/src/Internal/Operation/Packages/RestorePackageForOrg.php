...
final class RestorePackageForOrg
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Restore $hydrator, string $packageType, string $packageName, string $org, string $token)
    {
    ...
    {
        return new Request('POST', (string) (new UriTemplate('/orgs/{org}/packages/{package_type}/{package_name}/restore{?token}'))->expand(['org' => $this->org, 'package_name' => $this->packageName, 'package_type' => $this->packageType, 'token' => $this->token]));
    }
