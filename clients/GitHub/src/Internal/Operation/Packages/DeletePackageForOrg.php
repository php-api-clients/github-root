...
final class DeletePackageForOrg
{
    ...
    {
        return new Request('DELETE', (string) (new UriTemplate('/orgs/{org}/packages/{package_type}/{package_name}'))->expand(['org' => $this->org, 'package_name' => $this->packageName, 'package_type' => $this->packageType]));
    }
