...
final class DeletePackageForUser
{
    ...
    {
        return new Request('DELETE', (string) (new UriTemplate('/users/{username}/packages/{package_type}/{package_name}'))->expand(['package_name' => $this->packageName, 'package_type' => $this->packageType, 'username' => $this->username]));
    }
