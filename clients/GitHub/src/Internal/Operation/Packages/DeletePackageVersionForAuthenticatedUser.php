...
final class DeletePackageVersionForAuthenticatedUser
{
    ...
    {
        return new Request('DELETE', (string) (new UriTemplate('/user/packages/{package_type}/{package_name}/versions/{package_version_id}'))->expand(['package_name' => $this->packageName, 'package_type' => $this->packageType, 'package_version_id' => $this->packageVersionId]));
    }
