...
final class SetRestrictionsForAuthenticatedUser
{
    ...
    public function __construct(private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private InteractionLimits $hydrator)
    {
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('PUT', (string) (new UriTemplate('/user/interaction-limits'))->expand([]), ['Content-Type' => 'application/json'], json_encode($data));
    }
