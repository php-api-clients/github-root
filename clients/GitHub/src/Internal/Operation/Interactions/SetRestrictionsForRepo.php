...
final class SetRestrictionsForRepo
{
    ...
    public function __construct(private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private InteractionLimits $hydrator, string $owner, string $repo)
    {
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('PUT', (string) (new UriTemplate('/repos/{owner}/{repo}/interaction-limits'))->expand(['owner' => $this->owner, 'repo' => $this->repo]), ['Content-Type' => 'application/json'], json_encode($data));
    }

    public function createResponse(ResponseInterface $response): InteractionLimitResponse|WithoutBody
    {
