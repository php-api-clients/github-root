...
use ApiClients\Client\GitHub\Internal\Hydrator\Operation\Repos\Owner\Repo\Git\Ref\Ref;
...
final class GetRef
{
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/repos/{owner}/{repo}/git/ref/{ref}'))->expand(['owner' => $this->owner, 'ref' => $this->ref, 'repo' => $this->repo]));
    }
