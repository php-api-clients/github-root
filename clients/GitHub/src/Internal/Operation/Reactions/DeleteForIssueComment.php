...
final class DeleteForIssueComment
{
    ...
    {
        return new Request('DELETE', (string) (new UriTemplate('/repos/{owner}/{repo}/issues/comments/{comment_id}/reactions/{reaction_id}'))->expand(['comment_id' => $this->commentId, 'owner' => $this->owner, 'reaction_id' => $this->reactionId, 'repo' => $this->repo]));
    }
