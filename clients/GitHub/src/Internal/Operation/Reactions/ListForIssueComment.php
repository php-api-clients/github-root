...
final class ListForIssueComment
{
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/repos/{owner}/{repo}/issues/comments/{comment_id}/reactions{?content,page,per_page}'))->expand(['comment_id' => $this->commentId, 'content' => $this->content, 'owner' => $this->owner, 'page' => $this->page, 'per_page' => $this->perPage, 'repo' => $this->repo]));
    }
