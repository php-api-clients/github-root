...
use ApiClients\Client\GitHub\Schema\Reactions\CreateForPullRequestReviewComment\Request\ApplicationJson;
...
final class CreateForPullRequestReviewComment
{
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('POST', (string) (new UriTemplate('/repos/{owner}/{repo}/pulls/comments/{comment_id}/reactions'))->expand(['comment_id' => $this->commentId, 'owner' => $this->owner, 'repo' => $this->repo]), ['Content-Type' => 'application/json'], json_encode($data));
    }
