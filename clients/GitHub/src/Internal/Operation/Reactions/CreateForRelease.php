...
final class CreateForRelease
{
    ...
    public function __construct(private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private Reactions $hydrator, string $owner, string $repo, int $releaseId)
    {
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('POST', (string) (new UriTemplate('/repos/{owner}/{repo}/releases/{release_id}/reactions'))->expand(['owner' => $this->owner, 'release_id' => $this->releaseId, 'repo' => $this->repo]), ['Content-Type' => 'application/json'], json_encode($data));
    }
