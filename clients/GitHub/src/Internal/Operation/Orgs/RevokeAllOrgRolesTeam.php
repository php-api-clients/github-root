...
final class RevokeAllOrgRolesTeam
{
    ...
    {
        return new Request('DELETE', (string) (new UriTemplate('/orgs/{org}/organization-roles/teams/{team_slug}'))->expand(['org' => $this->org, 'team_slug' => $this->teamSlug]));
    }
