...
final class RemoveCustomProperty
{
    ...
    {
        return new Request('DELETE', (string) (new UriTemplate('/orgs/{org}/properties/schema/{custom_property_name}'))->expand(['custom_property_name' => $this->customPropertyName, 'org' => $this->org]));
    }
