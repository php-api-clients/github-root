...
use ApiClients\Client\GitHub\Internal\Hydrator\Operation\Orgs\Org\PersonalAccessTokenRequests\PatRequestId\Repositories;
...
final class ListPatGrantRequestRepositories
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Repositories $hydrator, string $org, int $patRequestId, int $perPage = 30, int $page = 1)
    {
        $this->org                     = $org;
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/orgs/{org}/personal-access-token-requests/{pat_request_id}/repositories{?page,per_page}'))->expand(['org' => $this->org, 'page' => $this->page, 'pat_request_id' => $this->patRequestId, 'per_page' => $this->perPage]));
    }
