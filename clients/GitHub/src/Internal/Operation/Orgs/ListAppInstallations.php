...
use ApiClients\Client\GitHub\Internal\Hydrator\Operation\Orgs\Org\Installations;
...
final class ListAppInstallations
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Installations $hydrator, string $org, int $perPage = 30, int $page = 1)
    {
        $this->org                     = $org;
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/orgs/{org}/installations{?page,per_page}'))->expand(['org' => $this->org, 'page' => $this->page, 'per_page' => $this->perPage]));
    }
