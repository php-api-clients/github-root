...
final class ListInvitationTeams
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Teams $hydrator, string $org, int $invitationId, int $perPage = 30, int $page = 1)
    {
        $this->org                     = $org;
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/orgs/{org}/invitations/{invitation_id}/teams{?page,per_page}'))->expand(['invitation_id' => $this->invitationId, 'org' => $this->org, 'page' => $this->page, 'per_page' => $this->perPage]));
    }
