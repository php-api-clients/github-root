...
use ApiClients\Client\GitHub\Internal\Hydrator\Operation\Orgs\Org\Hooks\HookId\Deliveries\DeliveryId\Attempts;
...
final class RedeliverWebhookDelivery
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Attempts $hydrator, string $org, int $hookId, private int $deliveryId)
    {
        $this->org                     = $org;
        $this->hookId                  = $hookId;
    ...
    {
        return new Request('POST', (string) (new UriTemplate('/orgs/{org}/hooks/{hook_id}/deliveries/{delivery_id}/attempts'))->expand(['delivery_id' => $this->deliveryId, 'hook_id' => $this->hookId, 'org' => $this->org]));
    }
