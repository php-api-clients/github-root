...
final class CreateOrUpdateCustomPropertiesValuesForRepos
{
    ...
    public function __construct(private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private Values $hydrator, string $org)
    {
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('PATCH', (string) (new UriTemplate('/orgs/{org}/properties/values'))->expand(['org' => $this->org]), ['Content-Type' => 'application/json'], json_encode($data));
    }
