...
final class GetAllCustomProperties
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private Schema $hydrator, string $org)
    {
        $this->org                     = $org;
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/orgs/{org}/properties/schema'))->expand(['org' => $this->org]));
    }
