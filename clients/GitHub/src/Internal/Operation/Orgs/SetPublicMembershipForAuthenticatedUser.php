...
use ApiClients\Client\GitHub\Internal\Hydrator\Operation\Orgs\Org\PublicMembers\Username;
...
final class SetPublicMembershipForAuthenticatedUser
{
    ...
    {
        return new Request('PUT', (string) (new UriTemplate('/orgs/{org}/public_members/{username}'))->expand(['org' => $this->org, 'username' => $this->username]));
    }
