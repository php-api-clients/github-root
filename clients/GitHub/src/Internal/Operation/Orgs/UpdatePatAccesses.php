...
use ApiClients\Client\GitHub\Schema\Orgs\UpdatePatAccesses\Request\ApplicationJson;
...
final class UpdatePatAccesses
{
    ...
    public function __construct(private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private PersonalAccessTokens $hydrator, string $org)
    {
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('POST', (string) (new UriTemplate('/orgs/{org}/personal-access-tokens'))->expand(['org' => $this->org]), ['Content-Type' => 'application/json'], json_encode($data));
    }
