...
final class ListOrgRoles
{
    ...
    public function __construct(private SchemaValidator $responseSchemaValidator, private OrganizationRoles $hydrator, string $org)
    {
        $this->org                     = $org;
    ...
    {
        return new Request('GET', (string) (new UriTemplate('/orgs/{org}/organization-roles'))->expand(['org' => $this->org]));
    }
