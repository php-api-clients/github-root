...
final class ReviewPatGrantRequest
{
    ...
    public function __construct(private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private PatRequestId $hydrator, string $org, int $patRequestId)
    {
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('POST', (string) (new UriTemplate('/orgs/{org}/personal-access-token-requests/{pat_request_id}'))->expand(['org' => $this->org, 'pat_request_id' => $this->patRequestId]), ['Content-Type' => 'application/json'], json_encode($data));
    }
