...
final class Eight
{
    ...
    /** @return Observable<ApiInsightsRouteStats>||Observable<ApiInsightsTimeStats>|Observable<TeamDiscussionComment>|Observable<Reaction>|Observable<EnvironmentApprovals>|Observable<PendingDeployment>|Observable<CodeScanningAlertInstance>|Observable<SecretScanningLocation>|WithoutBody */
