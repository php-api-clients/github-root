...
final class Three
{
    ...
    /** @return |Observable<IntegrationInstallationRequest>|WithoutBody|Observable<Installation>|Observable<BaseGist>|Observable<string>|Observable<MarketplaceListingPlan>|Observable<SimpleUser>|Observable<Email>|Observable<GpgKey>|Observable<Issue>|Observable<Key>|Observable<UserMarketplacePurchase>|Observable<Migration>|Observable<OrganizationSimple>|Observable<Package>|Observable<Repository>|Observable<RepositoryInvitation>|Observable<SocialAccount>|Observable<SshSigningKey>|Observable<MinimalRepository>|Observable<TeamFull> */
