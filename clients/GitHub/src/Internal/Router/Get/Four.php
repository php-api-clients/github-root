...
final class Four
{
    ...
    /** @return |Observable<HookDeliveryItem>|Observable<ClassroomAcceptedAssignment>|Observable<ClassroomAssignmentGrade>|Observable<SimpleClassroomAssignment>|Observable<GistComment>|WithoutBody|Observable<GistCommit>|Observable<GistSimple>|Observable<MarketplaceListingPlan>|Observable<SimpleUser>|Observable<Event>|Observable<OrganizationInvitation>|Observable<OrgHook>|Observable<Issue>|Observable<Migration>|Observable<Package>|Observable<OrganizationProgrammaticAccessGrantRequest>|Observable<OrganizationProgrammaticAccessGrant>|Observable<Project>|Observable<MinimalRepository>|Observable<RepositoryRuleset>|Observable<RepositoryAdvisory>|Observable<TeamSimple>|Observable<Team>|Observable<ProjectColumn>|Observable<TeamDiscussion>|Observable<TeamProject>|Observable<UserMarketplacePurchase>|Observable<OrgMembership>|Observable<BaseGist>|Observable<GpgKey>|Observable<KeySimple>|Observable<OrganizationSimple>|Observable<SocialAccount>|Observable<SshSigningKey> */
                ...
                if ($pathChunks[2] === '{assignment_id}') {
                    if ($pathChunks[3] === 'accepted_assignments') {
                        if ($call === 'GET /assignments/{assignment_id}/accepted_assignments') {
                            return $this->routers->internal🔀Router🔀Get🔀Classroom()->listAcceptedAssignmentsForAnAssignment($params);
                        }
