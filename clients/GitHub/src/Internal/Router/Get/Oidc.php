...
final class Oidc
{
    ...
    public function getOidcCustomSubTemplateForOrg(array $params): OidcCustomSub
    {
        ...
        unset($params['org']);
        $operator = new GetOidcCustomSubTemplateForOrg($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Actions🌀Oidc🌀Customization🌀Sub());
