...
final class CodeScanning
{
    ...
    /** @return Observable<CodeScanningOrganizationAlertItems> */
    public function listAlertsForOrg(array $params): iterable
    {
        ...
        unset($params['sort']);
        $operator = new ListAlertsForOrg($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀CodeScanning🌀Alerts());
    ...
    /** @return Observable<CodeScanningAlertItems>|WithoutBody */
    public function listAlertsForRepo(array $params): iterable|WithoutBody
    {
        ...
        $arguments['sort'] = $params['sort'];
        unset($params['sort']);
        $operator = new ListAlertsForRepo($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀CodeScanning🌀Alerts());
    ...
    public function listRecentAnalyses(array $params): iterable
    {
        ...
        $arguments['sort'] = $params['sort'];
        unset($params['sort']);
        $operator = new ListRecentAnalyses($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀CodeScanning🌀Analyses());
    ...
    public function getDefaultSetup(array $params): CodeScanningDefaultSetup
    {
        ...
        $arguments['repo'] = $params['repo'];
        unset($params['repo']);
        $operator = new GetDefaultSetup($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀CodeScanning🌀DefaultSetup());
    ...
    public function getAlert(array $params): CodeScanningAlert|WithoutBody
    {
        ...
        $operator = new GetAlert($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀CodeScanning🌀Alerts🌀AlertNumber());
    ...
    public function getAnalysis(array $params): CodeScanningAnalysis
    {
        ...
        $operator = new GetAnalysis($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀CodeScanning🌀Analyses🌀AnalysisId());

        return $operator->call($arguments['owner'], $arguments['repo'], $arguments['analysis_id']);
    }

    /** @return Observable<CodeScanningCodeqlDatabase> */
    public function listCodeqlDatabases(array $params): iterable
    {
        ...
        $arguments['repo'] = $params['repo'];
        unset($params['repo']);
        $operator = new ListCodeqlDatabases($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀CodeScanning🌀Codeql🌀Databases());
    ...
    public function getSarif(array $params): CodeScanningSarifsStatus|WithoutBody
    {
        ...
        $arguments['sarif_id'] = $params['sarif_id'];
        unset($params['sarif_id']);
        $operator = new GetSarif($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀CodeScanning🌀Sarifs🌀SarifId());
    ...
    public function listAlertInstances(array $params): iterable
    {
        ...
        $arguments['per_page'] = $params['per_page'];
        unset($params['per_page']);
        $operator = new ListAlertInstances($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀CodeScanning🌀Alerts🌀AlertNumber🌀Instances());
    ...
    public function getCodeqlDatabase(array $params): CodeScanningCodeqlDatabase|WithoutBody
    {
        ...
        $operator = new GetCodeqlDatabase($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀CodeScanning🌀Codeql🌀Databases🌀Language());
    ...
    public function getVariantAnalysis(array $params): CodeScanningVariantAnalysis
    {
        ...
        $operator = new GetVariantAnalysis($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀CodeScanning🌀Codeql🌀VariantAnalyses🌀CodeqlVariantAnalysisId());
    ...
    public function getVariantAnalysisRepoTask(array $params): CodeScanningVariantAnalysisRepoTask
    {
        ...
        $operator = new GetVariantAnalysisRepoTask($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀CodeScanning🌀Codeql🌀VariantAnalyses🌀CodeqlVariantAnalysisId🌀Repos🌀RepoOwner🌀RepoName());
