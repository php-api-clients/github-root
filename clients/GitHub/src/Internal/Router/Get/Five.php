...
final class Five
{
    ...
    /** @return |Observable<CopilotUsageMetricsDay>|Observable<CopilotUsageMetrics>|Observable<DependabotAlertWithRepository>|WithoutBody|Observable<OrganizationSecretScanningAlert>|Observable<MarketplacePurchase>|Observable<Event>|BasicError|Observable<CodeScanningOrganizationAlertItems>|Observable<CodeSecurityConfiguration>|Observable<Package>|Observable<CustomProperty>|Observable<OrgRepoCustomPropertyValues>|Observable<\ApiClients\Client\GitHub\Schema\RuleSuites>|Observable<ProjectCard>|Observable<\ApiClients\Client\GitHub\Schema\Activity>|Observable<SimpleUser>|Observable<Autolink>|Observable<ShortBranch>|Observable<Collaborator>|Observable<CommitComment>|Observable<Commit>|Observable<Contributor>|Observable<Deployment>|Observable<MinimalRepository>|Observable<Hook>|Observable<RepositoryInvitation>|Observable<Issue>|Observable<DeployKey>|Observable<Label>|Observable<Milestone>|Observable<Thread>|Observable<Project>|Observable<PullRequestSimple>|Observable<Release>|Observable<RepositoryRuleset>|Observable<RepositoryAdvisory>|Observable<Tag>|Observable<Team> */
