...
final class Migrations
{
    ...
    public function updateImport(array $params): Import
    {
        ...
        unset($params['repo']);
        $operator = new UpdateImport($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Import());
    ...
    public function setLfsPreference(array $params): Import
    {
        ...
        $arguments['repo'] = $params['repo'];
        unset($params['repo']);
        $operator = new SetLfsPreference($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Import🌀Lfs());
    ...
    public function mapCommitAuthor(array $params): PorterAuthor
    {
        ...
        $operator = new MapCommitAuthor($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Import🌀Authors🌀AuthorId());
