...
final class Activity
{
    ...
    public function markThreadAsRead(array $params): WithoutBody
    {
        ...
        $operator = new MarkThreadAsRead($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Notifications🌀Threads🌀ThreadId());
