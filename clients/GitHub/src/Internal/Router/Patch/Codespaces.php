...
final class Codespaces
{
    ...
    public function updateForAuthenticatedUser(array $params): Codespace
    {
        ...
        $operator = new UpdateForAuthenticatedUser($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀User🌀Codespaces🌀CodespaceName());
