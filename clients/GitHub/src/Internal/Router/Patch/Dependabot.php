...
use ApiClients\Client\GitHub\Internal\Operator\Dependabot\UpdateAlert;
...
final class Dependabot
{
    ...
    public function updateAlert(array $params): DependabotAlert
    {
        ...
        $operator = new UpdateAlert($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Dependabot🌀Alerts🌀AlertNumber());
