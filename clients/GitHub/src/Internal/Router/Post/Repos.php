...
use ApiClients\Client\GitHub\Internal\Operator\Repos\CreateForAuthenticatedUser;
...
use ApiClients\Client\GitHub\Internal\Operator\Repos\CreateWebhook;
...
use ApiClients\Client\GitHub\Internal\Operator\Repos\PingWebhook;
use ApiClients\Client\GitHub\Internal\Operator\Repos\RedeliverWebhookDelivery;
...
final class Repos
{
    ...
    public function createInOrg(array $params): FullRepository
    {
        ...
        unset($params['org']);
        $operator = new CreateInOrg($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Repos());
    ...
    public function createOrgRuleset(array $params): RepositoryRuleset
    {
        ...
        $arguments['org'] = $params['org'];
        unset($params['org']);
        $operator = new CreateOrgRuleset($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Rulesets());
    ...
    public function requestPagesBuild(array $params): PageBuildStatus
    {
        ...
        unset($params['repo']);
        $operator = new RequestPagesBuild($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Pages🌀Builds());
    ...
    public function createPagesDeployment(array $params): PageDeployment
    {
        ...
        $arguments['repo'] = $params['repo'];
        unset($params['repo']);
        $operator = new CreatePagesDeployment($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Pages🌀Deployments());
    ...
    public function generateReleaseNotes(array $params): ReleaseNotesContent
    {
        ...
        $arguments['repo'] = $params['repo'];
        unset($params['repo']);
        $operator = new GenerateReleaseNotes($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Releases🌀GenerateNotes());
    ...
    public function createCommitStatus(array $params): Status
    {
        ...
        unset($params['sha']);
        $operator = new CreateCommitStatus($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Statuses🌀Sha());
    ...
    public function createTagProtection(array $params): TagProtection
    {
        ...
        $arguments['repo'] = $params['repo'];
        unset($params['repo']);
        $operator = new CreateTagProtection($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Tags🌀Protection());
    ...
    public function createAttestation(array $params): Created
    {
        ...
        $arguments['repo'] = $params['repo'];
        unset($params['repo']);
        $operator = new CreateAttestation($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Attestations());
    ...
    public function createAutolink(array $params): Autolink
    {
        ...
        $arguments['repo'] = $params['repo'];
        unset($params['repo']);
        $operator = new CreateAutolink($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Autolinks());
    ...
    public function createDeployment(array $params): Deployment|Json|WithoutBody
    {
        ...
        $arguments['repo'] = $params['repo'];
        unset($params['repo']);
        $operator = new CreateDeployment($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Deployments());
    ...
    public function createDispatchEvent(array $params): WithoutBody
    {
        ...
        $arguments['repo'] = $params['repo'];
        unset($params['repo']);
        $operator = new CreateDispatchEvent($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Dispatches());
    ...
    public function createFork(array $params): FullRepository
    {
        ...
        $arguments['repo'] = $params['repo'];
        unset($params['repo']);
        $operator = new CreateFork($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Forks());
    ...
    public function createWebhook(array $params): Hook
    {
        ...
        $arguments['repo'] = $params['repo'];
        unset($params['repo']);
        $operator = new CreateWebhook($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Hooks());
    ...
    public function createDeployKey(array $params): DeployKey
    {
        ...
        $arguments['repo'] = $params['repo'];
        unset($params['repo']);
        $operator = new CreateDeployKey($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Keys());
    ...
    public function mergeUpstream(array $params): MergedUpstream|WithoutBody
    {
        ...
        $arguments['repo'] = $params['repo'];
        unset($params['repo']);
        $operator = new MergeUpstream($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀MergeUpstream());
    ...
    public function merge(array $params): Commit|WithoutBody
    {
        ...
        $arguments['repo'] = $params['repo'];
        unset($params['repo']);
        $operator = new Merge($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Merges());
    ...
    public function createPagesSite(array $params): Page
    {
        ...
        $arguments['repo'] = $params['repo'];
        unset($params['repo']);
        $operator = new CreatePagesSite($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Pages());
    ...
    public function createRelease(array $params): Release
    {
        ...
        $arguments['repo'] = $params['repo'];
        unset($params['repo']);
        $operator = new CreateRelease($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Releases());
    ...
    public function createRepoRuleset(array $params): RepositoryRuleset
    {
        ...
        $arguments['repo'] = $params['repo'];
        unset($params['repo']);
        $operator = new CreateRepoRuleset($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Rulesets());
    ...
    public function transfer(array $params): MinimalRepository
    {
        ...
        $arguments['repo'] = $params['repo'];
        unset($params['repo']);
        $operator = new Transfer($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Transfer());
    ...
    public function createUsingTemplate(array $params): FullRepository
    {
        ...
        $operator = new CreateUsingTemplate($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀TemplateOwner🌀TemplateRepo🌀Generate());
    ...
    {
        $operator = new CreateForAuthenticatedUser($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀User🌀Repos());
    ...
    public function renameBranch(array $params): BranchWithProtection
    {
        ...
        unset($params['branch']);
        $operator = new RenameBranch($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Branches🌀Branch🌀Rename());
    ...
    public function createCommitComment(array $params): CommitComment
    {
        ...
        $operator = new CreateCommitComment($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Commits🌀CommitSha🌀Comments());
    ...
    public function createDeploymentStatus(array $params): DeploymentStatus
    {
        ...
        $operator = new CreateDeploymentStatus($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Deployments🌀DeploymentId🌀Statuses());
    ...
    public function createDeploymentBranchPolicy(array $params): DeploymentBranchPolicy|WithoutBody
    {
        ...
        $operator = new CreateDeploymentBranchPolicy($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Environments🌀EnvironmentName🌀DeploymentBranchPolicies());
    ...
    public function createDeploymentProtectionRule(array $params): DeploymentProtectionRule
    {
        ...
        $arguments['owner'] = $params['owner'];
        unset($params['owner']);
        $operator = new CreateDeploymentProtectionRule($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Environments🌀EnvironmentName🌀DeploymentProtectionRules());
    ...
    public function pingWebhook(array $params): WithoutBody
    {
        ...
        $operator = new PingWebhook($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Hooks🌀HookId🌀Pings());
    ...
    public function testPushWebhook(array $params): WithoutBody
    {
        ...
        $arguments['hook_id'] = $params['hook_id'];
        unset($params['hook_id']);
        $operator = new TestPushWebhook($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Hooks🌀HookId🌀Tests());
    ...
    public function uploadReleaseAsset(array $params): ReleaseAsset|WithoutBody
    {
        ...
        unset($params['label']);
        $operator = new UploadReleaseAsset($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Releases🌀ReleaseId🌀Assets());
    ...
    public function setAdminBranchProtection(array $params): ProtectedBranchAdminEnforced
    {
        ...
        $arguments['branch'] = $params['branch'];
        unset($params['branch']);
        $operator = new SetAdminBranchProtection($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Branches🌀Branch🌀Protection🌀EnforceAdmins());
    ...
    public function createCommitSignatureProtection(array $params): ProtectedBranchAdminEnforced
    {
        ...
        $arguments['branch'] = $params['branch'];
        unset($params['branch']);
        $operator = new CreateCommitSignatureProtection($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Branches🌀Branch🌀Protection🌀RequiredSignatures());
    ...
    public function cancelPagesDeployment(array $params): WithoutBody
    {
        ...
        $operator = new CancelPagesDeployment($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Pages🌀Deployments🌀PagesDeploymentId🌀Cancel());
    ...
    public function addStatusCheckContexts(array $params): iterable
    {
        ...
        $arguments['branch'] = $params['branch'];
        unset($params['branch']);
        $operator = new AddStatusCheckContexts($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Branches🌀Branch🌀Protection🌀RequiredStatusChecks🌀Contexts());
    ...
    public function addAppAccessRestrictions(array $params): iterable
    {
        ...
        $arguments['branch'] = $params['branch'];
        unset($params['branch']);
        $operator = new AddAppAccessRestrictions($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Branches🌀Branch🌀Protection🌀Restrictions🌀Apps());
    ...
    public function addTeamAccessRestrictions(array $params): iterable
    {
        ...
        $arguments['branch'] = $params['branch'];
        unset($params['branch']);
        $operator = new AddTeamAccessRestrictions($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Branches🌀Branch🌀Protection🌀Restrictions🌀Teams());
    ...
    public function addUserAccessRestrictions(array $params): iterable
    {
        ...
        $arguments['branch'] = $params['branch'];
        unset($params['branch']);
        $operator = new AddUserAccessRestrictions($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Branches🌀Branch🌀Protection🌀Restrictions🌀Users());
    ...
    public function redeliverWebhookDelivery(array $params): \ApiClients\Client\GitHub\Schema\Operations\Repos\RedeliverWebhookDelivery\Response\ApplicationJson\Accepted\Application\Json
    {
        ...
        $operator = new RedeliverWebhookDelivery($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Hooks🌀HookId🌀Deliveries🌀DeliveryId🌀Attempts());
