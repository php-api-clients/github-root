...
use ApiClients\Client\GitHub\Internal\Operator\Projects\Delete;
...
final class Projects
{
    ...
    public function deleteColumn(array $params): WithoutBody
    {
        ...
        $operator = new DeleteColumn($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Projects🌀Columns🌀ColumnId());
    ...
    public function deleteCard(array $params): WithoutBody
    {
        ...
        $operator = new DeleteCard($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Projects🌀Columns🌀Cards🌀CardId());
    ...
    public function removeCollaborator(array $params): WithoutBody
    {
        ...
        $operator = new RemoveCollaborator($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Projects🌀ProjectId🌀Collaborators🌀Username());
    ...
    public function delete(array $params): WithoutBody
    {
        ...
        $arguments['project_id'] = $params['project_id'];
        unset($params['project_id']);
        $operator = new Delete($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Projects🌀ProjectId());
