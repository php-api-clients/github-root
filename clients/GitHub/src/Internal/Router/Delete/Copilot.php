...
final class Copilot
{
    ...
    public function cancelCopilotSeatAssignmentForTeams(array $params): Ok|WithoutBody
    {
        ...
        unset($params['org']);
        $operator = new CancelCopilotSeatAssignmentForTeams($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Copilot🌀Billing🌀SelectedTeams());
    ...
    public function cancelCopilotSeatAssignmentForUsers(array $params): \ApiClients\Client\GitHub\Schema\Operations\Copilot\CancelCopilotSeatAssignmentForUsers\Response\ApplicationJson\Ok|WithoutBody
    {
        ...
        $arguments['org'] = $params['org'];
        unset($params['org']);
        $operator = new CancelCopilotSeatAssignmentForUsers($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Copilot🌀Billing🌀SelectedUsers());
