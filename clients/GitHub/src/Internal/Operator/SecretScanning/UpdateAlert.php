...
final readonly class UpdateAlert
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Internal\Operation\SecretScanning\UpdateAlert($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $alertNumber);
