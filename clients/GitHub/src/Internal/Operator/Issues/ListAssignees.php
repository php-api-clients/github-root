...
final readonly class ListAssignees
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $responseSchemaValidator, private Assignees $hydrator)
    {
    }
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Internal\Operation\Issues\ListAssignees($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
