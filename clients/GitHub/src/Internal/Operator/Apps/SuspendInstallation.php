...
final readonly class SuspendInstallation
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $responseSchemaValidator, private Suspended $hydrator)
    {
    }
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Internal\Operation\Apps\SuspendInstallation($this->responseSchemaValidator, $this->hydrator, $installationId);
