...
final readonly class ListForOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Internal\Operation\Repos\ListForOrg($this->responseSchemaValidator, $this->hydrator, $org, $direction, $type, $sort, $perPage, $page);
