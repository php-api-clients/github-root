...
final readonly class GetStatusChecksProtection
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $responseSchemaValidator, private RequiredStatusChecks $hydrator)
    {
    }
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Internal\Operation\Repos\GetStatusChecksProtection($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $branch);
