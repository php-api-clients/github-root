...
final readonly class GetPagesDeployment
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $responseSchemaValidator, private PagesDeploymentId $hydrator)
    {
    }

    /** @return */
    public function call(string $owner, string $repo, int|string $pagesDeploymentId): PagesDeploymentStatus
    {
