...
final readonly class ListReleases
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $responseSchemaValidator, private Releases $hydrator)
    {
    }
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Internal\Operation\Repos\ListReleases($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
