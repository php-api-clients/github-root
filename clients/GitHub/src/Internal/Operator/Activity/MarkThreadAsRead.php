...
final readonly class MarkThreadAsRead
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $responseSchemaValidator, private ThreadId $hydrator)
    {
    }
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Internal\Operation\Activity\MarkThreadAsRead($this->responseSchemaValidator, $this->hydrator, $threadId);
