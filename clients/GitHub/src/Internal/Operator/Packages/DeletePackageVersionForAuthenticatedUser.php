...
final readonly class DeletePackageVersionForAuthenticatedUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Internal\Operation\Packages\DeletePackageVersionForAuthenticatedUser($this->responseSchemaValidator, $this->hydrator, $packageType, $packageName, $packageVersionId);
