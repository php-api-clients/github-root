...
final readonly class CreateWebhook
{
    ...
    {
        $operation = new \ApiClients\Client\GitHub\Internal\Operation\Orgs\CreateWebhook($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $org);
