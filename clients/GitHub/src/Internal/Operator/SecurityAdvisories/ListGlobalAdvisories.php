...
final readonly class ListGlobalAdvisories
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $responseSchemaValidator, private Advisories $hydrator)
    {
    }

    /** @return Observable<GlobalAdvisory> */
    public function call(string $ghsaId, string $cveId, string $ecosystem, string $severity, string|array $cwes, bool $isWithdrawn, string|array $affects, string $published, string $updated, string $modified, string $epssPercentage, string $epssPercentile, string $before, string $after, string $type = 'reviewed', string $direction = 'desc', int $perPage = 30, string $sort = 'published'): iterable
    {
