...
final readonly class IssueEvent implements \ApiClients\Client\GitHub\Contract\IssueEvent
{
    ...
    public string $nodeId, public string $url, public SimpleUser|null $actor, public string $event, #[MapFrom('commit_id')]
    public string|null $commitId, #[MapFrom('commit_url')]
    public string|null $commitUrl, #[MapFrom('created_at')]
    public string $createdAt, public Issue|null $issue, public IssueEventLabel|null $label, public SimpleUser|null $assignee, public SimpleUser|null $assigner, #[MapFrom('review_requester')]
    public SimpleUser|null $reviewRequester, #[MapFrom('requested_reviewer')]
    public SimpleUser|null $requestedReviewer, #[MapFrom('requested_team')]
    public Team|null $requestedTeam, #[MapFrom('dismissed_review')]
    public IssueEventDismissedReview|null $dismissedReview, public IssueEventMilestone|null $milestone, #[MapFrom('project_card')]
    public IssueEventProjectCard|null $projectCard, public IssueEventRename|null $rename, #[MapFrom('author_association')]
    public string|null $authorAssociation, #[MapFrom('lock_reason')]
    public string|null $lockReason, #[MapFrom('performed_via_github_app')]
    public Integration|null $performedViaGithubApp,)
    {
    }
}
