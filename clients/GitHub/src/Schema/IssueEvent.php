...
final readonly class IssueEvent implements \ApiClients\Client\GitHub\Contract\IssueEvent
{
    const SCHEMA_JSON = '{
    "title": "Issue Event",
    "required": [
     ...
     */
    public function __construct(public int $id, #[\EventSauce\ObjectHydrator\MapFrom('node_id')] public string $nodeId, public string $url, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $actor, public string $event, #[\EventSauce\ObjectHydrator\MapFrom('commit_id')] public ?string $commitId, #[\EventSauce\ObjectHydrator\MapFrom('commit_url')] public ?string $commitUrl, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public string $createdAt, public ?\ApiClients\Client\GitHub\Schema\Issue $issue, public ?\ApiClients\Client\GitHub\Schema\IssueEventLabel $label, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $assignee, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $assigner, #[\EventSauce\ObjectHydrator\MapFrom('review_requester')] public ?\ApiClients\Client\GitHub\Schema\SimpleUser $reviewRequester, #[\EventSauce\ObjectHydrator\MapFrom('requested_reviewer')] public ?\ApiClients\Client\GitHub\Schema\SimpleUser $requestedReviewer, #[\EventSauce\ObjectHydrator\MapFrom('requested_team')] public ?\ApiClients\Client\GitHub\Schema\Team $requestedTeam, #[\EventSauce\ObjectHydrator\MapFrom('dismissed_review')] public ?\ApiClients\Client\GitHub\Schema\IssueEventDismissedReview $dismissedReview, public ?\ApiClients\Client\GitHub\Schema\IssueEventMilestone $milestone, #[\EventSauce\ObjectHydrator\MapFrom('project_card')] public ?\ApiClients\Client\GitHub\Schema\IssueEventProjectCard $projectCard, public ?\ApiClients\Client\GitHub\Schema\IssueEventRename $rename, #[\EventSauce\ObjectHydrator\MapFrom('author_association')] public ?string $authorAssociation, #[\EventSauce\ObjectHydrator\MapFrom('lock_reason')] public ?string $lockReason, #[\EventSauce\ObjectHydrator\MapFrom('performed_via_github_app')] public ?\ApiClients\Client\GitHub\Schema\Integration $performedViaGithubApp)
    {
    }
}
