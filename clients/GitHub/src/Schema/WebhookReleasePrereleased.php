...
use ApiClients\Client\GitHub\Schema\WebhookReleasePrereleased\Release;
...
final readonly class WebhookReleasePrereleased implements \ApiClients\Client\GitHub\Contract\WebhookReleasePrereleased
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public Release $release, public RepositoryWebhooks $repository, public SimpleUser|null $sender)
    {
    }
}
