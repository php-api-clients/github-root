...
final readonly class CodeScanningCodeqlDatabase implements \ApiClients\Client\GitHub\Contract\CodeScanningCodeqlDatabase
{
    const SCHEMA_JSON = '{
     ...
     */
    public function __construct(public int $id, public string $name, public string $language, public \ApiClients\Client\GitHub\Schema\SimpleUser $uploader, #[\EventSauce\ObjectHydrator\MapFrom('content_type')] public string $contentType, public int $size, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public string $createdAt, #[\EventSauce\ObjectHydrator\MapFrom('updated_at')] public string $updatedAt, public string $url, #[\EventSauce\ObjectHydrator\MapFrom('commit_oid')] public ?string $commitOid)
    {
    }
}
