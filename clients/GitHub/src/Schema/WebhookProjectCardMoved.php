...
final readonly class WebhookProjectCardMoved implements \ApiClients\Client\GitHub\Contract\WebhookProjectCardMoved
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public string $action, public ?\ApiClients\Client\GitHub\Schema\WebhookProjectCardMoved\Changes $changes, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, #[\EventSauce\ObjectHydrator\MapFrom('project_card')] public \ApiClients\Client\GitHub\Schema\WebhookProjectCardMoved\ProjectCard $projectCard, public ?\ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
