...
final readonly class WebhookProjectCardMoved implements \ApiClients\Client\GitHub\Contract\WebhookProjectCardMoved
{
     ...
     */
    public function __construct(public string $action, public Changes|null $changes, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, #[MapFrom('project_card')]
    public ProjectCard $projectCard, public RepositoryWebhooks|null $repository, public SimpleUser $sender,)
    {
    }
}
