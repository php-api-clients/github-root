...
final readonly class NpmMetadata
{
    ...
    /**
     * @param ?array<\ApiClients\Client\GitHub\Schema\WebhookDeploymentStatusCreated\Deployment\Payload> $maintainers
     * @param ?array<\ApiClients\Client\GitHub\Schema\WebhookDeploymentStatusCreated\Deployment\Payload> $contributors
     * @param ?array<string> $keywords
     * @param ?array<string> $files
     * @param ?array<string> $os
     * @param ?array<string> $cpu
     */
    public function __construct(public ?string $name, public ?string $version, public ?string $npm_user, public ?Schema\WebhookCheckSuiteCompleted\ActionsMeta $author, public ?Schema\WebhookCheckSuiteCompleted\ActionsMeta $bugs, public ?Schema\WebhookDeploymentStatusCreated\Deployment\Payload $dependencies, public ?Schema\WebhookDeploymentStatusCreated\Deployment\Payload $dev_dependencies, public ?Schema\WebhookDeploymentStatusCreated\Deployment\Payload $peer_dependencies, public ?Schema\WebhookDeploymentStatusCreated\Deployment\Payload $optional_dependencies, public ?string $description, public ?Schema\WebhookCheckSuiteCompleted\ActionsMeta $dist, public ?string $git_head, public ?string $homepage, public ?string $license, public ?string $main, public ?Schema\WebhookCheckSuiteCompleted\ActionsMeta $repository, public ?Schema\WebhookDeploymentStatusCreated\Deployment\Payload $scripts, public ?string $id, public ?string $node_version, public ?string $npm_version, public ?bool $has_shrinkwrap, #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\WebhookDeploymentStatusCreated\Deployment\Payload::class)] public ?array $maintainers, #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\WebhookDeploymentStatusCreated\Deployment\Payload::class)] public ?array $contributors, public ?Schema\WebhookDeploymentStatusCreated\Deployment\Payload $engines, public ?array $keywords, public ?array $files, public ?Schema\WebhookDeploymentStatusCreated\Deployment\Payload $bin, public ?Schema\WebhookDeploymentStatusCreated\Deployment\Payload $man, public ?Schema\WebhookCheckSuiteCompleted\ActionsMeta $directories, public ?array $os, public ?array $cpu, public ?string $readme, public ?string $installation_command, public ?int $release_id, public ?string $commit_oid, public ?bool $published_via_actions, public ?int $deleted_by_id)
    {
    }
}
