...
use ApiClients\Client\GitHub\Schema\WebhookInstallationTargetRenamed\Account;
use ApiClients\Client\GitHub\Schema\WebhookInstallationTargetRenamed\Changes;
...
final readonly class WebhookInstallationTargetRenamed implements \ApiClients\Client\GitHub\Contract\WebhookInstallationTargetRenamed
{
     ...
     */
    public function __construct(public Account $account, public string $action, public Changes $changes, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation $installation, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks|null $repository, public SimpleUser|null $sender, #[MapFrom('target_type')]
