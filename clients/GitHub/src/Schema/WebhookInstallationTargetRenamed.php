...
final readonly class WebhookInstallationTargetRenamed implements \ApiClients\Client\GitHub\Contract\WebhookInstallationTargetRenamed
{
    const SCHEMA_JSON = '{
    "required": [
        "action",
    ...
    */
    public function __construct(public \ApiClients\Client\GitHub\Schema\WebhookInstallationTargetRenamed\Account $account, public string $action, public \ApiClients\Client\GitHub\Schema\WebhookInstallationTargetRenamed\Changes $changes, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public \ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public ?\ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $sender, #[\EventSauce\ObjectHydrator\MapFrom('target_type')] public string $targetType)
    {
    }
}
