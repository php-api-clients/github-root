...
final readonly class WebhookWorkflowJobCompleted implements \ApiClients\Client\GitHub\Contract\WebhookWorkflowJobCompleted
{
    const SCHEMA_JSON = '{
