...
use ApiClients\Client\GitHub\Schema\AddedToProjectIssueEvent\ProjectCard;
...
final readonly class AddedToProjectIssueEvent implements \ApiClients\Client\GitHub\Contract\AddedToProjectIssueEvent
{
    ...
    public Integration|null $performedViaGithubApp, #[MapFrom('project_card')]
    public ProjectCard|null $projectCard,)
    {
    }
}
