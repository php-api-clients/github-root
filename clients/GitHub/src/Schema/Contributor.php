...
final readonly class Contributor implements \ApiClients\Client\GitHub\Contract\Contributor
{
    const SCHEMA_JSON = '{
    "title": "Contributor",
    "required": [
