...
final readonly class ProjectCard implements \ApiClients\Client\GitHub\Contract\ProjectCard
{
     ...
     */
    public function __construct(public string $url, public int $id, #[\EventSauce\ObjectHydrator\MapFrom('node_id')] public string $nodeId, public ?string $note, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $creator, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public string $createdAt, #[\EventSauce\ObjectHydrator\MapFrom('updated_at')] public string $updatedAt, public ?bool $archived, #[\EventSauce\ObjectHydrator\MapFrom('column_name')] public ?string $columnName, #[\EventSauce\ObjectHydrator\MapFrom('project_id')] public ?string $projectId, #[\EventSauce\ObjectHydrator\MapFrom('column_url')] public string $columnUrl, #[\EventSauce\ObjectHydrator\MapFrom('content_url')] public ?string $contentUrl, #[\EventSauce\ObjectHydrator\MapFrom('project_url')] public string $projectUrl)
    {
    }
}
