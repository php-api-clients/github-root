...
final readonly class WebhookSecurityAdvisoryPublished implements \ApiClients\Client\GitHub\Contract\WebhookSecurityAdvisoryPublished
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks|null $repository, #[MapFrom('security_advisory')]
    public WebhooksSecurityAdvisory $securityAdvisory, public SimpleUser|null $sender,)
    {
    }
}
