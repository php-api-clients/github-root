...
final readonly class StarredRepository implements \ApiClients\Client\GitHub\Contract\StarredRepository
{
    const SCHEMA_JSON = '{
     ...
     */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('starred_at')] public string $starredAt, public \ApiClients\Client\GitHub\Schema\Repository $repo)
    {
    }
}
