...
final readonly class AuthenticationToken implements \ApiClients\Client\GitHub\Contract\AuthenticationToken
{
    const SCHEMA_JSON = '{
     ...
     */
    public function __construct(public string $token, #[\EventSauce\ObjectHydrator\MapFrom('expires_at')] public string $expiresAt, public ?\ApiClients\Client\GitHub\Schema\AuthenticationToken\Permissions $permissions, public ?array $repositories, #[\EventSauce\ObjectHydrator\MapFrom('single_file')] public ?string $singleFile, #[\EventSauce\ObjectHydrator\MapFrom('repository_selection')] public ?string $repositorySelection)
    {
    }
}
