...
use ApiClients\Client\GitHub\Schema\Codespace\GitStatus;
use ApiClients\Client\GitHub\Schema\Codespace\RuntimeConstraints;
...
final readonly class Codespace implements \ApiClients\Client\GitHub\Contract\Codespace
{
    ...
    public string|null $environmentId, public SimpleUser $owner, #[MapFrom('billable_owner')]
    public SimpleUser $billableOwner, public MinimalRepository $repository, public CodespaceMachine|null $machine, #[MapFrom('devcontainer_path')]
    ...
    public GitStatus $gitStatus, public string $location, #[MapFrom('idle_timeout_minutes')]
    ...
    public RuntimeConstraints|null $runtimeConstraints, #[MapFrom('pending_operation')]
    ...
    public string|null $retentionExpiresAt, #[MapFrom('last_known_stop_notice')]
    public string|null $lastKnownStopNotice,)
    {
    }
}
