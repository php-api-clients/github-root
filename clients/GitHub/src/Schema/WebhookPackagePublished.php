...
use ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package;
...
final readonly class WebhookPackagePublished implements \ApiClients\Client\GitHub\Contract\WebhookPackagePublished
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public Package $package, public RepositoryWebhooks|null $repository, public SimpleUser $sender)
    {
    }
}
