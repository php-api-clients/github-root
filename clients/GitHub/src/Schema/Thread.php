...
final readonly class Thread implements \ApiClients\Client\GitHub\Contract\Thread
{
     ...
     */
    public function __construct(public string $id, public MinimalRepository $repository, public Subject $subject, public string $reason, public bool $unread, #[MapFrom('updated_at')]
