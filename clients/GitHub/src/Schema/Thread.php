...
final readonly class Thread implements \ApiClients\Client\GitHub\Contract\Thread
{
    const SCHEMA_JSON = '{
    "title": "Thread",
    "required": [
     ...
     */
    public function __construct(public string $id, public \ApiClients\Client\GitHub\Schema\MinimalRepository $repository, public \ApiClients\Client\GitHub\Schema\Thread\Subject $subject, public string $reason, public bool $unread, #[\EventSauce\ObjectHydrator\MapFrom('updated_at')] public string $updatedAt, #[\EventSauce\ObjectHydrator\MapFrom('last_read_at')] public ?string $lastReadAt, public string $url, #[\EventSauce\ObjectHydrator\MapFrom('subscription_url')] public string $subscriptionUrl)
    {
    }
}
