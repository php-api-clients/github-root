...
final readonly class WebhookDeploymentReviewApproved implements \ApiClients\Client\GitHub\Contract\WebhookDeploymentReviewApproved
{
    const SCHEMA_JSON = '{
    "required": [
        "action",
    ...
    */
    public function __construct(public string $action, public ?\ApiClients\Client\GitHub\Schema\WebhooksApprover $approver, public ?string $comment, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public \ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public \ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public ?array $reviewers, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender, public string $since, #[\EventSauce\ObjectHydrator\MapFrom('workflow_job_run')] public ?\ApiClients\Client\GitHub\Schema\WebhooksWorkflowJobRun $workflowJobRun, #[\EventSauce\ObjectHydrator\MapFrom('workflow_job_runs')] public ?array $workflowJobRuns, #[\EventSauce\ObjectHydrator\MapFrom('workflow_run')] public ?\ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewApproved\WorkflowRun $workflowRun)
    {
    }
}
