...
final readonly class WebhookDeploymentReviewApproved implements \ApiClients\Client\GitHub\Contract\WebhookDeploymentReviewApproved
{
     ...
     */
    public function __construct(public string $action, public WebhooksApprover|null $approver, public string|null $comment, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks $organization, public RepositoryWebhooks $repository, public array|null $reviewers, public SimpleUser $sender, public string $since, #[MapFrom('workflow_job_run')]
    public WebhooksWorkflowJobRun|null $workflowJobRun, #[MapFrom('workflow_job_runs')]
    public array|null $workflowJobRuns, #[MapFrom('workflow_run')]
    public WorkflowRun|null $workflowRun,)
    {
    }
}
