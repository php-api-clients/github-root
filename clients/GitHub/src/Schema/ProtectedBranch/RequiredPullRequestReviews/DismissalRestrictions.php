...
final readonly class DismissalRestrictions implements \ApiClients\Client\GitHub\Contract\ProtectedBranch\RequiredPullRequestReviews\DismissalRestrictions
{
    const SCHEMA_JSON = '{
    "required": [
        "url",
    ...
    public function __construct(public string $url, #[\EventSauce\ObjectHydrator\MapFrom('users_url')] public string $usersUrl, #[\EventSauce\ObjectHydrator\MapFrom('teams_url')] public string $teamsUrl, public array $users, public array $teams, public ?array $apps)
    {
    }
}
