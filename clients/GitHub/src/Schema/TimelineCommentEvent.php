...
final readonly class TimelineCommentEvent implements \ApiClients\Client\GitHub\Contract\TimelineCommentEvent
{
     ...
     */
    public function __construct(public string $event, public SimpleUser $actor, public int $id, #[MapFrom('node_id')]
    ...
    public string $htmlUrl, public SimpleUser $user, #[MapFrom('created_at')]
