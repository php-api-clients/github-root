...
final readonly class WebhookStarCreated implements \ApiClients\Client\GitHub\Contract\WebhookStarCreated
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser $sender, #[MapFrom('starred_at')]
