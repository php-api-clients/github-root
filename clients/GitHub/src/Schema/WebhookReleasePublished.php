...
final readonly class WebhookReleasePublished implements \ApiClients\Client\GitHub\Contract\WebhookReleasePublished
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public WebhooksRelease1 $release, public RepositoryWebhooks $repository, public SimpleUser|null $sender)
    {
    }
}
