...
final readonly class WebhookPullRequestUnlabeled implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestUnlabeled
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public WebhooksLabel|null $label, public int $number, public OrganizationSimpleWebhooks|null $organization, #[MapFrom('pull_request')]
