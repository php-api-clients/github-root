...
final readonly class Activity implements \ApiClients\Client\GitHub\Contract\Activity
{
     ...
     */
    public function __construct(public int $id, #[\EventSauce\ObjectHydrator\MapFrom('node_id')] public string $nodeId, public string $before, public string $after, public string $ref, public string $timestamp, #[\EventSauce\ObjectHydrator\MapFrom('activity_type')] public string $activityType, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $actor)
    {
    }
}
