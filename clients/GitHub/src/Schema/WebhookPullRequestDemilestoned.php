...
final readonly class WebhookPullRequestDemilestoned implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestDemilestoned
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public Milestone|null $milestone, public int $number, public OrganizationSimpleWebhooks|null $organization, #[MapFrom('pull_request')]
    public WebhooksPullRequest5 $pullRequest, public RepositoryWebhooks $repository, public SimpleUser|null $sender,)
    {
    }
}
