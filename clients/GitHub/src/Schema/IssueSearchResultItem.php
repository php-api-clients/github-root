...
final readonly class IssueSearchResultItem implements \ApiClients\Client\GitHub\Contract\IssueSearchResultItem
{
    ...
    public string|null $activeLockReason, public array|null $assignees, public SimpleUser|null $user, public array $labels, #[MapFrom('sub_issues_summary')]
    public SubIssuesSummary|null $subIssuesSummary, public string $state, #[MapFrom('state_reason')]
    public string|null $stateReason, public SimpleUser|null $assignee, public Milestone|null $milestone, public int $comments, #[MapFrom('created_at')]
    ...
    public PullRequest|null $pullRequest, public string|null $body, public int|float $score, #[MapFrom('author_association')]
    public string $authorAssociation, public bool|null $draft, public Repository|null $repository, #[MapFrom('body_html')]
    ...
    public Integration|null $performedViaGithubApp, public ReactionRollup|null $reactions,)
    {
    }
}
