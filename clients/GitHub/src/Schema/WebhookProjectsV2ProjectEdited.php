...
final readonly class WebhookProjectsV2ProjectEdited implements \ApiClients\Client\GitHub\Contract\WebhookProjectsV2ProjectEdited
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public string $action, public \ApiClients\Client\GitHub\Schema\WebhookProjectsV2ProjectEdited\Changes $changes, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public \ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, #[\EventSauce\ObjectHydrator\MapFrom('projects_v2')] public \ApiClients\Client\GitHub\Schema\ProjectsV2 $projectsVTwo, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
