...
final readonly class WebhookProjectsV2ProjectEdited implements \ApiClients\Client\GitHub\Contract\WebhookProjectsV2ProjectEdited
{
     ...
     */
    public function __construct(public string $action, public Changes $changes, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks $organization, #[MapFrom('projects_v2')]
