...
final readonly class CheckSuite implements \ApiClients\Client\GitHub\Contract\WebhookCheckSuiteCompleted\CheckSuite
{
    const SCHEMA_JSON = '{
    "required": [
        "id",
