...
final readonly class WebhookMemberRemoved implements \ApiClients\Client\GitHub\Contract\WebhookMemberRemoved
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public WebhooksUser|null $member, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser $sender)
    {
    }
}
