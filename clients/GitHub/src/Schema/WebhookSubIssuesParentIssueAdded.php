...
final readonly class WebhookSubIssuesParentIssueAdded implements \ApiClients\Client\GitHub\Contract\WebhookSubIssuesParentIssueAdded
{
    ...
    public const SCHEMA_TITLE        = 'parent issue added event';
