...
use ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewEdited\Changes;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewEdited\PullRequest;
...
final readonly class WebhookPullRequestReviewEdited implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestReviewEdited
{
     ...
     */
    public function __construct(public string $action, public Changes $changes, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, #[MapFrom('pull_request')]
    public PullRequest $pullRequest, public RepositoryWebhooks $repository, public WebhooksReview $review, public SimpleUser $sender,)
    {
    }
}
