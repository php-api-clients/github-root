...
final readonly class WebhookProjectCardCreated implements \ApiClients\Client\GitHub\Contract\WebhookProjectCardCreated
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public string $action, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, #[\EventSauce\ObjectHydrator\MapFrom('project_card')] public \ApiClients\Client\GitHub\Schema\WebhooksProjectCard $projectCard, public ?\ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
