...
final readonly class WebhookPersonalAccessTokenRequestCreated implements \ApiClients\Client\GitHub\Contract\WebhookPersonalAccessTokenRequestCreated
{
    ...
    public PersonalAccessTokenRequest $personalAccessTokenRequest, public EnterpriseWebhooks|null $enterprise, public OrganizationSimpleWebhooks $organization, public SimpleUser $sender, public SimpleInstallation|null $installation,)
    {
    }
}
