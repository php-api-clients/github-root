...
final readonly class WebhookRepositoryRulesetCreated implements \ApiClients\Client\GitHub\Contract\WebhookRepositoryRulesetCreated
{
    const SCHEMA_JSON = '{
    ...
    public const SCHEMA_TITLE = 'repository ruleset created event';
    ...
    */
    public function __construct(public string $action, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public ?\ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, #[\EventSauce\ObjectHydrator\MapFrom('repository_ruleset')] public \ApiClients\Client\GitHub\Schema\RepositoryRuleset $repositoryRuleset, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
