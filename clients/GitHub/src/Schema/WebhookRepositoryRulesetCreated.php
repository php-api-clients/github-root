...
final readonly class WebhookRepositoryRulesetCreated implements \ApiClients\Client\GitHub\Contract\WebhookRepositoryRulesetCreated
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks|null $repository, #[MapFrom('repository_ruleset')]
    public RepositoryRuleset $repositoryRuleset, public SimpleUser $sender,)
    {
    }
}
