...
final readonly class WebhookDeploymentCreated implements \ApiClients\Client\GitHub\Contract\WebhookDeploymentCreated
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public string $action, public \ApiClients\Client\GitHub\Schema\WebhookDeploymentCreated\Deployment $deployment, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public \ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender, public ?\ApiClients\Client\GitHub\Schema\WebhooksWorkflow $workflow, #[\EventSauce\ObjectHydrator\MapFrom('workflow_run')] public ?\ApiClients\Client\GitHub\Schema\WebhookDeploymentCreated\WorkflowRun $workflowRun)
    {
    }
}
