...
final readonly class IntegrationInstallationRequest implements \ApiClients\Client\GitHub\Contract\IntegrationInstallationRequest
{
     ...
     */
    public function __construct(public int $id, #[\EventSauce\ObjectHydrator\MapFrom('node_id')] public ?string $nodeId, #[\ApiClients\Client\GitHub\Internal\Attribute\CastUnionToType\Single\Schema\IntegrationInstallationRequest\Account] public \ApiClients\Client\GitHub\Schema\SimpleUser|\ApiClients\Client\GitHub\Schema\Enterprise $account, public \ApiClients\Client\GitHub\Schema\SimpleUser $requester, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public string $createdAt)
    {
    }
}
