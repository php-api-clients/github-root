...
final readonly class WebhooksProjectCard implements \ApiClients\Client\GitHub\Contract\WebhooksProjectCard
{
    const SCHEMA_JSON = '{
    "title": "Project Card",
    "required": [
