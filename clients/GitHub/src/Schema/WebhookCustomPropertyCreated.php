...
final readonly class WebhookCustomPropertyCreated implements \ApiClients\Client\GitHub\Contract\WebhookCustomPropertyCreated
{
    ...
    */
    public function __construct(public string $action, public \ApiClients\Client\GitHub\Schema\CustomProperty $definition, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
