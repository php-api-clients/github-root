...
final readonly class CodeScanningOrganizationAlertItems implements \ApiClients\Client\GitHub\Contract\CodeScanningOrganizationAlertItems
{
    ...
    public string|null $dismissedComment, public CodeScanningAlertRuleSummary $rule, public CodeScanningAnalysisTool $tool, #[MapFrom('most_recent_instance')]
    public CodeScanningAlertInstance $mostRecentInstance, public SimpleRepository $repository,)
    {
    }
}
