...
final readonly class CheckRun implements \ApiClients\Client\GitHub\Contract\CheckRun
{
    const SCHEMA_JSON = '{
    "title": "CheckRun",
    "required": [
     ...
     */
    public function __construct(public int $id, #[\EventSauce\ObjectHydrator\MapFrom('head_sha')] public string $headSha, #[\EventSauce\ObjectHydrator\MapFrom('node_id')] public string $nodeId, #[\EventSauce\ObjectHydrator\MapFrom('external_id')] public ?string $externalId, public string $url, #[\EventSauce\ObjectHydrator\MapFrom('html_url')] public ?string $htmlUrl, #[\EventSauce\ObjectHydrator\MapFrom('details_url')] public ?string $detailsUrl, public string $status, public ?string $conclusion, #[\EventSauce\ObjectHydrator\MapFrom('started_at')] public ?string $startedAt, #[\EventSauce\ObjectHydrator\MapFrom('completed_at')] public ?string $completedAt, public \ApiClients\Client\GitHub\Schema\CheckRun\Output $output, public string $name, #[\EventSauce\ObjectHydrator\MapFrom('check_suite')] public ?\ApiClients\Client\GitHub\Schema\CheckRun\CheckSuite $checkSuite, public ?\ApiClients\Client\GitHub\Schema\Integration $app, #[\EventSauce\ObjectHydrator\MapFrom('pull_requests')] public array $pullRequests, public ?\ApiClients\Client\GitHub\Schema\DeploymentSimple $deployment)
    {
    }
}
