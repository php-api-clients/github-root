...
final readonly class CheckRun implements \ApiClients\Client\GitHub\Contract\CheckRun
{
    ...
    public string|null $completedAt, public Output $output, public string $name, #[MapFrom('check_suite')]
    public CheckSuite|null $checkSuite, public Integration|null $app, #[MapFrom('pull_requests')]
    public array $pullRequests, public DeploymentSimple|null $deployment,)
    {
    }
}
