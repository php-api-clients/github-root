...
final readonly class WebhookBranchProtectionRuleCreated implements \ApiClients\Client\GitHub\Contract\WebhookBranchProtectionRuleCreated
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public WebhooksRule $rule, public SimpleUser $sender)
    {
    }
}
