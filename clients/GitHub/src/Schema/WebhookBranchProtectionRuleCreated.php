...
final readonly class WebhookBranchProtectionRuleCreated implements \ApiClients\Client\GitHub\Contract\WebhookBranchProtectionRuleCreated
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public string $action, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public \ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public \ApiClients\Client\GitHub\Schema\WebhooksRule $rule, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
