...
final readonly class CodeScanningVariantAnalysisRepoTask implements \ApiClients\Client\GitHub\Contract\CodeScanningVariantAnalysisRepoTask
{
    const SCHEMA_JSON = '{
    "required": [
        "repository",
    ...
    "database_commit_sha": "generated",
    "source_location_prefix": "generated",
     ...
     */
    public function __construct(public \ApiClients\Client\GitHub\Schema\SimpleRepository $repository, #[\EventSauce\ObjectHydrator\MapFrom('analysis_status')] public string $analysisStatus, #[\EventSauce\ObjectHydrator\MapFrom('artifact_size_in_bytes')] public ?int $artifactSizeInBytes, #[\EventSauce\ObjectHydrator\MapFrom('result_count')] public ?int $resultCount, #[\EventSauce\ObjectHydrator\MapFrom('failure_message')] public ?string $failureMessage, #[\EventSauce\ObjectHydrator\MapFrom('database_commit_sha')] public ?string $databaseCommitSha, #[\EventSauce\ObjectHydrator\MapFrom('source_location_prefix')] public ?string $sourceLocationPrefix, #[\EventSauce\ObjectHydrator\MapFrom('artifact_url')] public ?string $artifactUrl)
    {
    }
}
