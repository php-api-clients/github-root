...
final readonly class CodeScanningVariantAnalysisRepoTask implements \ApiClients\Client\GitHub\Contract\CodeScanningVariantAnalysisRepoTask
{
     ...
     */
    public function __construct(public SimpleRepository $repository, #[MapFrom('analysis_status')]
    public string $analysisStatus, #[MapFrom('artifact_size_in_bytes')]
    public int|null $artifactSizeInBytes, #[MapFrom('result_count')]
    public int|null $resultCount, #[MapFrom('failure_message')]
    public string|null $failureMessage, #[MapFrom('database_commit_sha')]
    public string|null $databaseCommitSha, #[MapFrom('source_location_prefix')]
    public string|null $sourceLocationPrefix, #[MapFrom('artifact_url')]
    public string|null $artifactUrl,)
    {
    }
}
