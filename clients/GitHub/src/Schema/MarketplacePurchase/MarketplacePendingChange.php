...
final readonly class MarketplacePendingChange implements \ApiClients\Client\GitHub\Contract\MarketplacePurchase\MarketplacePendingChange
{
     ...
     */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('is_installed')] public ?bool $isInstalled, #[\EventSauce\ObjectHydrator\MapFrom('effective_date')] public ?string $effectiveDate, #[\EventSauce\ObjectHydrator\MapFrom('unit_count')] public ?int $unitCount, public ?int $id, public ?\ApiClients\Client\GitHub\Schema\MarketplaceListingPlan $plan)
    {
    }
}
