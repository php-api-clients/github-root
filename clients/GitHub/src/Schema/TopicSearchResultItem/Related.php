...
final readonly class Related
{
    ...
    public ?Schema\TopicSearchResultItem\Related\TopicRelation $topic_relation;
    public function __construct(Schema\TopicSearchResultItem\Related\TopicRelation $topic_relation)
    {
