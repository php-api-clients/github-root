...
final readonly class TeamRepository implements \ApiClients\Client\GitHub\Contract\TeamRepository
{
    ...
    public string $fullName, public LicenseSimple|null $license, public int $forks, public Permissions|null $permissions, #[MapFrom('role_name')]
    public string|null $roleName, public SimpleUser|null $owner, public bool $private, #[MapFrom('html_url')]
