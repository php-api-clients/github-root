...
use ApiClients\Client\GitHub\Contract\WebhookPullRequestAssigned\PullRequest\RequestedReviewers\One;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestAssigned\PullRequest\RequestedReviewers\One\Parent_;
use EventSauce\ObjectHydrator\MapFrom;

abstract readonly class T6848B990 implements One
{
    ...
    public string $nodeId, public Parent_|null $parent, public string $permission, public string $privacy, #[MapFrom('repositories_url')]
