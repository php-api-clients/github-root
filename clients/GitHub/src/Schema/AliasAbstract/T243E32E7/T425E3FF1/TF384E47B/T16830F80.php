...
namespace ApiClients\Client\GitHub\Schema\AliasAbstract\T243E32E7\T425E3FF1\TF384E47B;

abstract readonly class T16830F80 implements \ApiClients\Client\GitHub\Contract\WebhookCodeScanningAlertAppearedInBranch\Alert\MostRecentInstance
{
    const SCHEMA_JSON = '{
     ...
     */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('analysis_key')] public string $analysisKey, public ?string $category, public ?array $classifications, #[\EventSauce\ObjectHydrator\MapFrom('commit_sha')] public ?string $commitSha, public string $environment, public ?\ApiClients\Client\GitHub\Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\MostRecentInstance\Location $location, public ?\ApiClients\Client\GitHub\Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\MostRecentInstance\Message $message, public string $ref, public string $state)
    {
    }
}
