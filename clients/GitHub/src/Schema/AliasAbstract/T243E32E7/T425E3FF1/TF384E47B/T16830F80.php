...
use ApiClients\Client\GitHub\Contract\WebhookCodeScanningAlertAppearedInBranch\Alert\MostRecentInstance;
...
abstract readonly class T16830F80 implements MostRecentInstance
{
    ...
    public string|null $commitSha, public string $environment, public Location|null $location, public Message|null $message, public string $ref, public string $state,)
    {
    }
}
