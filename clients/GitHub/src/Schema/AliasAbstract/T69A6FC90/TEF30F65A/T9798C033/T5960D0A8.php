...
namespace ApiClients\Client\GitHub\Schema\AliasAbstract\T69A6FC90\TEF30F65A\T9798C033;

abstract readonly class T5960D0A8 implements \ApiClients\Client\GitHub\Contract\Operations\Orgs\ListAppInstallations\Response\ApplicationJson\Ok
{
    const SCHEMA_JSON = '{
    "required": [
        "total_count",
    ...
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('total_count')] public int $totalCount, public array $installations)
    {
    }
}
