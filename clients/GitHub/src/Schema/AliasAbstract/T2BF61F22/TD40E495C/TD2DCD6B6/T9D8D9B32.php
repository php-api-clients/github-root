...
use ApiClients\Client\GitHub\Contract\DependabotAlertWithRepository\Dependency;
use ApiClients\Client\GitHub\Schema\DependabotAlertPackage;
use EventSauce\ObjectHydrator\MapFrom;

abstract readonly class T9D8D9B32 implements Dependency
{
     ...
     */
    public function __construct(public DependabotAlertPackage|null $package, #[MapFrom('manifest_path')]
