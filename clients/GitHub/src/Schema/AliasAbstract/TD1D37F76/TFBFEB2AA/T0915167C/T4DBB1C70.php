...
use ApiClients\Client\GitHub\Contract\WebhookIssuesTransferred\Changes\NewRepository;
use ApiClients\Client\GitHub\Schema\WebhookIssuesTransferred\Changes\NewRepository\CustomProperties;
use ApiClients\Client\GitHub\Schema\WebhookIssuesTransferred\Changes\NewRepository\License;
use ApiClients\Client\GitHub\Schema\WebhookIssuesTransferred\Changes\NewRepository\Owner;
use ApiClients\Client\GitHub\Schema\WebhookIssuesTransferred\Changes\NewRepository\Permissions;
use EventSauce\ObjectHydrator\MapFrom;

abstract readonly class T4DBB1C70 implements NewRepository
{
