...
namespace ApiClients\Client\GitHub\Schema\AliasAbstract\TD1D37F76\TFBFEB2AA\T0915167C;

abstract readonly class T4DBB1C70 implements \ApiClients\Client\GitHub\Contract\WebhookIssuesTransferred\Changes\NewRepository
{
    const SCHEMA_JSON = '{
    "title": "Repository",
    "required": [
