...
use ApiClients\Client\GitHub\Contract\PullRequest\Head;
use ApiClients\Client\GitHub\Schema\Repository;
use ApiClients\Client\GitHub\Schema\SimpleUser;

abstract readonly class TE7315EF1 implements Head
{
     ...
     * user: A GitHub user.
     */
    public function __construct(public string $label, public string $ref, public Repository $repo, public string $sha, public SimpleUser $user)
    {
    }
}
