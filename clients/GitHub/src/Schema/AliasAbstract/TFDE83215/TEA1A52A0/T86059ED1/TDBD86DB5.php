...
namespace ApiClients\Client\GitHub\Schema\AliasAbstract\TFDE83215\TEA1A52A0\T86059ED1;

use ApiClients\Client\GitHub\Contract\WebhookDeploymentReviewApproved\WorkflowRun\HeadRepository;
use ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewApproved\WorkflowRun\HeadRepository\Owner;
use EventSauce\ObjectHydrator\MapFrom;

abstract readonly class TDBD86DB5 implements HeadRepository
{
    ...
    public string|null $notificationsUrl, public Owner|null $owner, public bool|null $private, #[MapFrom('pulls_url')]
