...
abstract readonly class TDBD86DB5 implements \ApiClients\Client\GitHub\Contract\WebhookDeploymentReviewApproved\WorkflowRun\HeadRepository
{
    const SCHEMA_JSON = '{
    "type": "object",
    "properties": {
