...
use ApiClients\Client\GitHub\Contract\PullRequestSimple\Head;
use ApiClients\Client\GitHub\Schema\Repository;
use ApiClients\Client\GitHub\Schema\SimpleUser;

abstract readonly class T163E6BD8 implements Head
{
     ...
     */
    public function __construct(public string $label, public string $ref, public Repository $repo, public string $sha, public SimpleUser|null $user)
    {
    }
}
