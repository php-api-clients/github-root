...
namespace ApiClients\Client\GitHub\Schema\AliasAbstract\T33AB0ED9\T45DEC305\TCF9E75E5;

abstract readonly class T163E6BD8 implements \ApiClients\Client\GitHub\Contract\PullRequestSimple\Head
{
    const SCHEMA_JSON = '{
    "required": [
        "label",
     ...
     */
    public function __construct(public string $label, public string $ref, public \ApiClients\Client\GitHub\Schema\Repository $repo, public string $sha, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $user)
    {
    }
}
