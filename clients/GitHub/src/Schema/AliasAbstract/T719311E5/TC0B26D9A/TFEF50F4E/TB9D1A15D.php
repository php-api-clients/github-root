...
namespace ApiClients\Client\GitHub\Schema\AliasAbstract\T719311E5\TC0B26D9A\TFEF50F4E;

abstract readonly class TB9D1A15D implements \ApiClients\Client\GitHub\Contract\Operations\Checks\ListForSuite\Response\ApplicationJson\Ok
{
    const SCHEMA_JSON = '{
    "required": [
        "total_count",
    ...
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('total_count')] public int $totalCount, #[\EventSauce\ObjectHydrator\MapFrom('check_runs')] public array $checkRuns)
    {
    }
}
