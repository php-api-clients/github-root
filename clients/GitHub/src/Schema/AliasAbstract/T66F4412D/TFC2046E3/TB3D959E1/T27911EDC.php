...
namespace ApiClients\Client\GitHub\Schema\AliasAbstract\T66F4412D\TFC2046E3\TB3D959E1;

abstract readonly class T27911EDC implements \ApiClients\Client\GitHub\Contract\Operations\Actions\ListWorkflowRunsForRepo\Response\ApplicationJson\Ok
{
    const SCHEMA_JSON = '{
    "required": [
        "total_count",
    ...
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('total_count')] public int $totalCount, #[\EventSauce\ObjectHydrator\MapFrom('workflow_runs')] public array $workflowRuns)
    {
    }
}
