...
abstract readonly class TBF973B47 implements \ApiClients\Client\GitHub\Contract\Operations\Actions\ListRepoOrganizationVariables\Response\ApplicationJson\Ok
{
    const SCHEMA_JSON = '{
    "required": [
        "total_count",
