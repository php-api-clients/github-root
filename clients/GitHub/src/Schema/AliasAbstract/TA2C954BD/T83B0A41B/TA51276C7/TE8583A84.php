...
abstract readonly class TE8583A84 implements \ApiClients\Client\GitHub\Contract\Repos\UpdateBranchProtection\Request\ApplicationJson\RequiredStatusChecks\Checks
{
    const SCHEMA_JSON = '{
    "required": [
        "context"
