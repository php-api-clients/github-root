...
namespace ApiClients\Client\GitHub\Schema\AliasAbstract\T8A806663\T007CE965\TE9A2CFD8;

abstract readonly class T7DAA4906 implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestAssigned\PullRequest\Head\Repo
{
    const SCHEMA_JSON = '{
    "title": "Repository",
    "required": [
