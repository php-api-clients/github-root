...
abstract readonly class TD6CFCAE8 implements \ApiClients\Client\GitHub\Contract\Actions\SetCustomLabelsForSelfHostedRunnerForOrg\Request\ApplicationJson
{
    const SCHEMA_JSON = '{
    "required": [
        "labels"
