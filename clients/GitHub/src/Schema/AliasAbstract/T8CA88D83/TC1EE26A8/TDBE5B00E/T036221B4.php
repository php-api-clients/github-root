...
namespace ApiClients\Client\GitHub\Schema\AliasAbstract\T8CA88D83\TC1EE26A8\TDBE5B00E;

abstract readonly class T036221B4 implements \ApiClients\Client\GitHub\Contract\Operations\Codespaces\RepoMachinesForAuthenticatedUser\Response\ApplicationJson\Ok
{
    const SCHEMA_JSON = '{
    "required": [
        "total_count",
    ...
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('total_count')] public int $totalCount, public array $machines)
    {
    }
}
