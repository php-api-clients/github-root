...
namespace ApiClients\Client\GitHub\Schema\AliasAbstract\T102A6290\T00A39E7A\T1FEDF082;

abstract readonly class TDD7A8765 implements \ApiClients\Client\GitHub\Contract\Operations\Actions\ListSelectedReposForOrgSecret\Response\ApplicationJson\Ok
{
    const SCHEMA_JSON = '{
    "required": [
        "total_count",
    ...
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('total_count')] public int $totalCount, public array $repositories)
    {
    }
}
