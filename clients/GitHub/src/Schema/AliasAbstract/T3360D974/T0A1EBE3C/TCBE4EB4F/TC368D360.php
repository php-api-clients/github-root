...
namespace ApiClients\Client\GitHub\Schema\AliasAbstract\T3360D974\T0A1EBE3C\TCBE4EB4F;

abstract readonly class TC368D360 implements \ApiClients\Client\GitHub\Contract\Operations\Codespaces\ListInOrganization\Response\ApplicationJson\Ok
{
    const SCHEMA_JSON = '{
    "required": [
        "total_count",
    ...
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('total_count')] public int $totalCount, public array $codespaces)
    {
    }
}
