...
use ApiClients\Client\GitHub\Contract\WebhooksPullRequest5\RequestedReviewers\One;
use ApiClients\Client\GitHub\Schema\WebhooksPullRequest5\RequestedReviewers\One\Parent_;
use EventSauce\ObjectHydrator\MapFrom;

abstract readonly class T51D9106A implements One
{
    ...
    public string|null $nodeId, public Parent_|null $parent, public string|null $permission, public string|null $privacy, #[MapFrom('repositories_url')]
