...
namespace ApiClients\Client\GitHub\Schema\AliasAbstract\T42EC1791\T8C42BE36\T94AEF7B4;

abstract readonly class T14ED59EB implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestAssigned\PullRequest\Base
{
    const SCHEMA_JSON = '{
    "required": [
        "label",
     ...
     */
    public function __construct(public string $label, public string $ref, public \ApiClients\Client\GitHub\Schema\WebhookPullRequestAssigned\PullRequest\Base\Repo $repo, public string $sha, public ?\ApiClients\Client\GitHub\Schema\WebhookPullRequestAssigned\PullRequest\Base\User $user)
    {
    }
}
