...
namespace ApiClients\Client\GitHub\Schema\AliasAbstract\TC622367A\T1B0AEBBF\T4F8F58BF;

abstract readonly class TAA9B571E implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestAssigned\PullRequest\Head
{
    const SCHEMA_JSON = '{
    "required": [
        "label",
     ...
     */
    public function __construct(public ?string $label, public string $ref, public ?\ApiClients\Client\GitHub\Schema\WebhookPullRequestAssigned\PullRequest\Head\Repo $repo, public string $sha, public ?\ApiClients\Client\GitHub\Schema\WebhookPullRequestAssigned\PullRequest\Head\User $user)
    {
    }
}
