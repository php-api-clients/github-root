...
namespace ApiClients\Client\GitHub\Schema\AliasAbstract\TDD3A8F60\T5469B35D\T20CEE77F;

abstract readonly class T915EA812 implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestReviewThreadResolved\PullRequest\Base
{
    const SCHEMA_JSON = '{
    "required": [
        "label",
     ...
     */
    public function __construct(public string $label, public string $ref, public \ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewThreadResolved\PullRequest\Base\Repo $repo, public string $sha, public ?\ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewThreadResolved\PullRequest\Base\User $user)
    {
    }
}
