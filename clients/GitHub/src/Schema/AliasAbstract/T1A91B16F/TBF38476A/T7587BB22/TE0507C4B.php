...
abstract readonly class TE0507C4B implements \ApiClients\Client\GitHub\Contract\Operations\Actions\ListArtifactsForRepo\Response\ApplicationJson\Ok
{
    const SCHEMA_JSON = '{
    "required": [
        "total_count",
    ...
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('total_count')] public int $totalCount, public array $artifacts)
    {
    }
}
