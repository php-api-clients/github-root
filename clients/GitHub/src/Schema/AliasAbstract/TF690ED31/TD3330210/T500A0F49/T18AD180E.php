...
namespace ApiClients\Client\GitHub\Schema\AliasAbstract\TF690ED31\TD3330210\T500A0F49;

abstract readonly class T18AD180E implements \ApiClients\Client\GitHub\Contract\Actions\GenerateRunnerJitconfigForOrg\Request\ApplicationJson
{
    const SCHEMA_JSON = '{
    "required": [
        "name",
     ...
     */
    public function __construct(public string $name, #[\EventSauce\ObjectHydrator\MapFrom('runner_group_id')] public int $runnerGroupId, public array $labels, #[\EventSauce\ObjectHydrator\MapFrom('work_folder')] public ?string $workFolder)
    {
    }
}
