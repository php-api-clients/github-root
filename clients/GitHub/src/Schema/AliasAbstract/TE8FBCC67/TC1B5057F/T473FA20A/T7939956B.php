...
abstract readonly class T7939956B implements \ApiClients\Client\GitHub\Contract\WebhookCheckSuiteCompleted\CheckSuite\HeadCommit
{
    const SCHEMA_JSON = '{
    "title": "SimpleCommit",
    "required": [
     ...
     */
    public function __construct(public \ApiClients\Client\GitHub\Schema\WebhookCheckSuiteCompleted\CheckSuite\HeadCommit\Author $author, public \ApiClients\Client\GitHub\Schema\WebhookCheckSuiteCompleted\CheckSuite\HeadCommit\Committer $committer, public string $id, public string $message, public string $timestamp, #[\EventSauce\ObjectHydrator\MapFrom('tree_id')] public string $treeId)
    {
    }
}
