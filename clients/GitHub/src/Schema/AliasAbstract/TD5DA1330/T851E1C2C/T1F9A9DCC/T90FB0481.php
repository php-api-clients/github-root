...
namespace ApiClients\Client\GitHub\Schema\AliasAbstract\TD5DA1330\T851E1C2C\T1F9A9DCC;

abstract readonly class T90FB0481 implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestReviewCommentDeleted\PullRequest\Head
{
    const SCHEMA_JSON = '{
    "required": [
        "label",
     ...
     */
    public function __construct(public string $label, public string $ref, public ?\ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewCommentDeleted\PullRequest\Head\Repo $repo, public string $sha, public ?\ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewCommentDeleted\PullRequest\Head\User $user)
    {
    }
}
