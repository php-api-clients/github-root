...
use ApiClients\Client\GitHub\Contract\WebhookPullRequestReviewCommentDeleted\PullRequest\Head;
...
abstract readonly class T90FB0481 implements Head
{
     ...
     */
    public function __construct(public string $label, public string $ref, public Repo|null $repo, public string $sha, public User|null $user)
    {
    }
}
