...
namespace ApiClients\Client\GitHub\Schema\AliasAbstract\T5D8672A2\T3F13F85C\T07317555;

abstract readonly class T37CADFA5 implements \ApiClients\Client\GitHub\Contract\WebhooksPullRequest5\Base
{
    const SCHEMA_JSON = '{
    "required": [
        "label",
     ...
     */
    public function __construct(public string $label, public string $ref, public \ApiClients\Client\GitHub\Schema\WebhooksPullRequest5\Base\Repo $repo, public string $sha, public ?\ApiClients\Client\GitHub\Schema\WebhooksPullRequest5\Base\User $user)
    {
    }
}
