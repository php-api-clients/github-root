...
namespace ApiClients\Client\GitHub\Schema\AliasAbstract\TF800B58D\TE457AE55\TB6D6702A;

abstract readonly class T18FEC578 implements \ApiClients\Client\GitHub\Contract\CodeSecurityConfiguration\SecretScanningDelegatedBypassOptions
{
    const SCHEMA_JSON = '{
    "type": "object",
    "properties": {
     ...
     */
    public function __construct(public ?array $reviewers)
    {
    }
}
