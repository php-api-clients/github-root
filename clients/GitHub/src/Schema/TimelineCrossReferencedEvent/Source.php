...
namespace ApiClients\Client\GitHub\Schema\TimelineCrossReferencedEvent;

final readonly class Source implements \ApiClients\Client\GitHub\Contract\TimelineCrossReferencedEvent\Source
{
    const SCHEMA_JSON = '{
    "type": "object",
    "properties": {
     ...
     */
    public function __construct(public ?string $type, public ?\ApiClients\Client\GitHub\Schema\Issue $issue)
    {
    }
}
