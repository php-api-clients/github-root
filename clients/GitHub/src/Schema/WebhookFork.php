...
final readonly class WebhookFork implements \ApiClients\Client\GitHub\Contract\WebhookFork
{
     ...
     */
    public function __construct(public EnterpriseWebhooks|null $enterprise, public Forkee $forkee, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser $sender)
    {
    }
}
