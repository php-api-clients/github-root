...
final readonly class WebhookProjectsV2StatusUpdateEdited implements \ApiClients\Client\GitHub\Contract\WebhookProjectsV2StatusUpdateEdited
{
    ...
    */
    public function __construct(public string $action, public ?\ApiClients\Client\GitHub\Schema\WebhookProjectsV2StatusUpdateEdited\Changes $changes, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public \ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, #[\EventSauce\ObjectHydrator\MapFrom('projects_v2_status_update')] public \ApiClients\Client\GitHub\Schema\ProjectsV2StatusUpdate $projectsVTwoStatusUpdate, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
