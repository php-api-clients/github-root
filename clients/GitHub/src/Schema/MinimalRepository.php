...
final readonly class MinimalRepository implements \ApiClients\Client\GitHub\Contract\MinimalRepository
{
    ...
    public string|null $updatedAt, public Permissions|null $permissions, #[MapFrom('role_name')]
    ...
    public CodeOfConduct|null $codeOfConduct, public License|null $license, public int|null $forks, #[MapFrom('open_issues')]
