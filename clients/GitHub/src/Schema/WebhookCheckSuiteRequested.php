...
final readonly class WebhookCheckSuiteRequested implements \ApiClients\Client\GitHub\Contract\WebhookCheckSuiteRequested
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public string $action, #[\EventSauce\ObjectHydrator\MapFrom('check_suite')] public \ApiClients\Client\GitHub\Schema\WebhookCheckSuiteRequested\CheckSuite $checkSuite, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public \ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
