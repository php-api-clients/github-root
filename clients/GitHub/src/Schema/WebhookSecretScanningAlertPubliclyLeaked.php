...
final readonly class WebhookSecretScanningAlertPubliclyLeaked implements \ApiClients\Client\GitHub\Contract\WebhookSecretScanningAlertPubliclyLeaked
{
    ...
    public const SCHEMA_TITLE        = 'secret_scanning_alert publicly leaked event';
