...
final readonly class WebhookDelete implements \ApiClients\Client\GitHub\Contract\WebhookDelete
{
    const SCHEMA_JSON = '{
    "title": "delete event",
    "required": [
    ...
    */
    public function __construct(public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, #[\EventSauce\ObjectHydrator\MapFrom('pusher_type')] public string $pusherType, public string $ref, #[\EventSauce\ObjectHydrator\MapFrom('ref_type')] public string $refType, public \ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
