...
final readonly class ProtectedBranch implements \ApiClients\Client\GitHub\Contract\ProtectedBranch
{
    const SCHEMA_JSON = '{
     ...
     */
    public function __construct(public string $url, #[\EventSauce\ObjectHydrator\MapFrom('required_status_checks')] public ?\ApiClients\Client\GitHub\Schema\StatusCheckPolicy $requiredStatusChecks, #[\EventSauce\ObjectHydrator\MapFrom('required_pull_request_reviews')] public ?\ApiClients\Client\GitHub\Schema\ProtectedBranch\RequiredPullRequestReviews $requiredPullRequestReviews, #[\EventSauce\ObjectHydrator\MapFrom('required_signatures')] public ?\ApiClients\Client\GitHub\Schema\ProtectedBranch\RequiredSignatures $requiredSignatures, #[\EventSauce\ObjectHydrator\MapFrom('enforce_admins')] public ?\ApiClients\Client\GitHub\Schema\ProtectedBranch\EnforceAdmins $enforceAdmins, #[\EventSauce\ObjectHydrator\MapFrom('required_linear_history')] public ?\ApiClients\Client\GitHub\Schema\ProtectedBranch\RequiredLinearHistory $requiredLinearHistory, #[\EventSauce\ObjectHydrator\MapFrom('allow_force_pushes')] public ?\ApiClients\Client\GitHub\Schema\ProtectedBranch\AllowForcePushes $allowForcePushes, #[\EventSauce\ObjectHydrator\MapFrom('allow_deletions')] public ?\ApiClients\Client\GitHub\Schema\ProtectedBranch\AllowDeletions $allowDeletions, public ?\ApiClients\Client\GitHub\Schema\BranchRestrictionPolicy $restrictions, #[\EventSauce\ObjectHydrator\MapFrom('required_conversation_resolution')] public ?\ApiClients\Client\GitHub\Schema\ProtectedBranch\RequiredConversationResolution $requiredConversationResolution, #[\EventSauce\ObjectHydrator\MapFrom('block_creations')] public ?\ApiClients\Client\GitHub\Schema\ProtectedBranch\BlockCreations $blockCreations, #[\EventSauce\ObjectHydrator\MapFrom('lock_branch')] public ?\ApiClients\Client\GitHub\Schema\ProtectedBranch\LockBranch $lockBranch, #[\EventSauce\ObjectHydrator\MapFrom('allow_fork_syncing')] public ?\ApiClients\Client\GitHub\Schema\ProtectedBranch\AllowForkSyncing $allowForkSyncing)
    {
    }
}
