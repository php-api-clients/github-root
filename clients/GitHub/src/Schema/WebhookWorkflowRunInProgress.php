...
final readonly class WebhookWorkflowRunInProgress implements \ApiClients\Client\GitHub\Contract\WebhookWorkflowRunInProgress
{
    const SCHEMA_JSON = '{
