...
final readonly class WebhookCheckRunRequestedAction implements \ApiClients\Client\GitHub\Contract\WebhookCheckRunRequestedAction
{
    ...
    public CheckRunWithSimpleCheckSuite $checkRun, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, #[MapFrom('requested_action')]
    public RequestedAction|null $requestedAction, public SimpleUser $sender,)
    {
    }
}
