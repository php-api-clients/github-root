...
final readonly class Payload implements \ApiClients\Client\GitHub\Contract\Event\Payload
{
    const SCHEMA_JSON = '{
    "type": "object",
    "properties": {
     ...
     */
    public function __construct(public ?string $action, public ?\ApiClients\Client\GitHub\Schema\Issue $issue, public ?\ApiClients\Client\GitHub\Schema\IssueComment $comment, public ?array $pages)
    {
    }
}
