...
final readonly class Repo implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestReviewCommentCreated\PullRequest\Head\Repo
{
    const SCHEMA_JSON = '{
    "title": "Repository",
    "required": [
