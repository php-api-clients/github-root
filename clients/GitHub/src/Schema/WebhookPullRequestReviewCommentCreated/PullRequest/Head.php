...
final readonly class Head implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestReviewCommentCreated\PullRequest\Head
{
    const SCHEMA_JSON = '{
    "required": [
        "label",
     ...
     */
    public function __construct(public string $label, public string $ref, public ?\ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Head\Repo $repo, public string $sha, public ?\ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Head\User $user)
    {
    }
}
