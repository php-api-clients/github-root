...
use ApiClients\Client\GitHub\Internal\Attribute\CastUnionToType\Multiple\Schema\WebhookPullRequestReviewCommentCreated\PullRequest\RequestedReviewers;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Assignee;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewCommentCreated\PullRequest\AutoMerge;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Base;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Head;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Links;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewCommentCreated\PullRequest\Milestone;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewCommentCreated\PullRequest\RequestedReviewers\One;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewCommentCreated\PullRequest\RequestedReviewers\Zero;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewCommentCreated\PullRequest\User;
...
final readonly class PullRequest implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestReviewCommentCreated\PullRequest
{
    ...
    public string $diffUrl, public bool|null $draft, public Head $head, #[MapFrom('html_url')]
