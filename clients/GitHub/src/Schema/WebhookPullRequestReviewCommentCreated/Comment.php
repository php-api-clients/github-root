...
final readonly class Comment implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestReviewCommentCreated\Comment
{
    const SCHEMA_JSON = '{
