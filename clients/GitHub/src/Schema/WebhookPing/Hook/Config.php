...
final readonly class Config implements \ApiClients\Client\GitHub\Contract\WebhookPing\Hook\Config
{
     ...
     */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('content_type')] public ?string $contentType, #[\EventSauce\ObjectHydrator\MapFrom('insecure_ssl')] public null|string|int|float $insecureSsl, public ?string $secret, public ?string $url)
    {
    }
}
