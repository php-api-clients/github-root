...
final readonly class OrgMembership implements \ApiClients\Client\GitHub\Contract\OrgMembership
{
     ...
     */
    public function __construct(public string $url, public string $state, public string $role, #[\EventSauce\ObjectHydrator\MapFrom('organization_url')] public string $organizationUrl, public \ApiClients\Client\GitHub\Schema\OrganizationSimple $organization, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $user, public ?\ApiClients\Client\GitHub\Schema\OrgMembership\Permissions $permissions)
    {
    }
}
