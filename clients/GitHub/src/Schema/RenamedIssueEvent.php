...
final readonly class RenamedIssueEvent implements \ApiClients\Client\GitHub\Contract\RenamedIssueEvent
{
    ...
    public Integration|null $performedViaGithubApp, public Rename $rename,)
    {
    }
}
