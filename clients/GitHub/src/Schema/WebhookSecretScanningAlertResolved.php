...
final readonly class WebhookSecretScanningAlertResolved implements \ApiClients\Client\GitHub\Contract\WebhookSecretScanningAlertResolved
{
     ...
     */
    public function __construct(public string $action, public SecretScanningAlertWebhook $alert, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser|null $sender)
    {
    }
}
