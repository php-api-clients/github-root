...
final readonly class WebhookProjectsV2ItemArchived implements \ApiClients\Client\GitHub\Contract\WebhookProjectsV2ItemArchived
{
    const SCHEMA_JSON = '{
    ...
    public const SCHEMA_TITLE = 'Projects v2 Item Archived Event';
    ...
    */
    public function __construct(public string $action, public \ApiClients\Client\GitHub\Schema\WebhooksProjectChanges $changes, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public \ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, #[\EventSauce\ObjectHydrator\MapFrom('projects_v2_item')] public \ApiClients\Client\GitHub\Schema\ProjectsV2Item $projectsVTwoItem, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
