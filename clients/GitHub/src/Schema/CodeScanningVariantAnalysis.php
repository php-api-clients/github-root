...
final readonly class CodeScanningVariantAnalysis implements \ApiClients\Client\GitHub\Contract\CodeScanningVariantAnalysis
{
     ...
     */
    public function __construct(public int $id, #[\EventSauce\ObjectHydrator\MapFrom('controller_repo')] public \ApiClients\Client\GitHub\Schema\SimpleRepository $controllerRepo, public \ApiClients\Client\GitHub\Schema\SimpleUser $actor, #[\EventSauce\ObjectHydrator\MapFrom('query_language')] public string $queryLanguage, #[\EventSauce\ObjectHydrator\MapFrom('query_pack_url')] public string $queryPackUrl, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public ?string $createdAt, #[\EventSauce\ObjectHydrator\MapFrom('updated_at')] public ?string $updatedAt, #[\EventSauce\ObjectHydrator\MapFrom('completed_at')] public ?string $completedAt, public string $status, #[\EventSauce\ObjectHydrator\MapFrom('actions_workflow_run_id')] public ?int $actionsWorkflowRunId, #[\EventSauce\ObjectHydrator\MapFrom('failure_reason')] public ?string $failureReason, #[\EventSauce\ObjectHydrator\MapFrom('scanned_repositories')] public ?array $scannedRepositories, #[\EventSauce\ObjectHydrator\MapFrom('skipped_repositories')] public ?\ApiClients\Client\GitHub\Schema\CodeScanningVariantAnalysis\SkippedRepositories $skippedRepositories)
    {
    }
}
