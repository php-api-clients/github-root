...
final readonly class DeploymentSimple implements \ApiClients\Client\GitHub\Contract\DeploymentSimple
{
    const SCHEMA_JSON = '{
    "title": "Deployment",
    "required": [
     ...
     */
    public function __construct(public string $url, public int $id, #[\EventSauce\ObjectHydrator\MapFrom('node_id')] public string $nodeId, public string $task, #[\EventSauce\ObjectHydrator\MapFrom('original_environment')] public ?string $originalEnvironment, public string $environment, public ?string $description, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public string $createdAt, #[\EventSauce\ObjectHydrator\MapFrom('updated_at')] public string $updatedAt, #[\EventSauce\ObjectHydrator\MapFrom('statuses_url')] public string $statusesUrl, #[\EventSauce\ObjectHydrator\MapFrom('repository_url')] public string $repositoryUrl, #[\EventSauce\ObjectHydrator\MapFrom('transient_environment')] public ?bool $transientEnvironment, #[\EventSauce\ObjectHydrator\MapFrom('production_environment')] public ?bool $productionEnvironment, #[\EventSauce\ObjectHydrator\MapFrom('performed_via_github_app')] public ?\ApiClients\Client\GitHub\Schema\Integration $performedViaGithubApp)
    {
    }
}
