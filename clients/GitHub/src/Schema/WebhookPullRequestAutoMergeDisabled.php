...
use ApiClients\Client\GitHub\Schema\WebhookPullRequestAutoMergeDisabled\PullRequest;
...
final readonly class WebhookPullRequestAutoMergeDisabled implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestAutoMergeDisabled
{
    ...
    public PullRequest $pullRequest, public string $reason, public RepositoryWebhooks $repository, public SimpleUser $sender,)
    {
    }
}
