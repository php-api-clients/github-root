...
final readonly class WebhookWorkflowRunCompleted implements \ApiClients\Client\GitHub\Contract\WebhookWorkflowRunCompleted
{
    const SCHEMA_JSON = '{
