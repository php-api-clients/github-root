...
final readonly class WebhookProjectEdited implements \ApiClients\Client\GitHub\Contract\WebhookProjectEdited
{
     ...
     */
    public function __construct(public string $action, public Changes|null $changes, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public WebhooksProject $project, public RepositoryWebhooks|null $repository, public SimpleUser|null $sender)
    {
    }
}
