...
final readonly class WebhookWorkflowJobInProgress implements \ApiClients\Client\GitHub\Contract\WebhookWorkflowJobInProgress
{
    const SCHEMA_JSON = '{
