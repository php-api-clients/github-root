...
use ApiClients\Client\GitHub\Schema\WebhookPullRequestEnqueued\PullRequest;
...
final readonly class WebhookPullRequestEnqueued implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestEnqueued
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public int $number, public OrganizationSimpleWebhooks|null $organization, #[MapFrom('pull_request')]
