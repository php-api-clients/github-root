...
namespace ApiClients\Client\GitHub\Schema\WebhookPullRequestAutoMergeDisabled\PullRequest\Base;

final readonly class Repo implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestAutoMergeDisabled\PullRequest\Base\Repo
{
    const SCHEMA_JSON = '{
    "title": "Repository",
    "required": [
