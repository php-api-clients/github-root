...
final readonly class Base implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestAutoMergeDisabled\PullRequest\Base
{
     ...
     */
    public function __construct(public string $label, public string $ref, public \ApiClients\Client\GitHub\Schema\WebhookPullRequestAutoMergeDisabled\PullRequest\Base\Repo $repo, public string $sha, public ?\ApiClients\Client\GitHub\Schema\WebhookPullRequestAutoMergeDisabled\PullRequest\Base\User $user)
    {
    }
}
