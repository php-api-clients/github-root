...
final readonly class CopilotSeatDetails implements \ApiClients\Client\GitHub\Contract\CopilotSeatDetails
{
    const SCHEMA_JSON = '{
     ...
     */
    public function __construct(public \ApiClients\Client\GitHub\Schema\SimpleUser $assignee, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimple $organization, #[\EventSauce\ObjectHydrator\MapFrom('assigning_team')] #[\ApiClients\Client\GitHub\Internal\Attribute\CastUnionToType\Single\Schema\CopilotSeatDetails\AssigningTeam] public null|\ApiClients\Client\GitHub\Schema\Team|\ApiClients\Client\GitHub\Schema\EnterpriseTeam $assigningTeam, #[\EventSauce\ObjectHydrator\MapFrom('pending_cancellation_date')] public ?string $pendingCancellationDate, #[\EventSauce\ObjectHydrator\MapFrom('last_activity_at')] public ?string $lastActivityAt, #[\EventSauce\ObjectHydrator\MapFrom('last_activity_editor')] public ?string $lastActivityEditor, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public string $createdAt, #[\EventSauce\ObjectHydrator\MapFrom('updated_at')] public ?string $updatedAt, #[\EventSauce\ObjectHydrator\MapFrom('plan_type')] public ?string $planType)
    {
    }
}
