...
final readonly class CopilotSeatDetails implements \ApiClients\Client\GitHub\Contract\CopilotSeatDetails
{
     ...
     */
    public function __construct(public SimpleUser $assignee, public OrganizationSimple|null $organization, #[MapFrom('assigning_team')]
    #[AssigningTeam]
    public Team|EnterpriseTeam|null $assigningTeam, #[MapFrom('pending_cancellation_date')]
