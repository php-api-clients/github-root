...
use ApiClients\Client\GitHub\Schema\WebhookPullRequestUnassigned\PullRequest;
...
final readonly class WebhookPullRequestUnassigned implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestUnassigned
{
     ...
     */
    public function __construct(public string $action, public WebhooksUserMannequin|null $assignee, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public int $number, public OrganizationSimpleWebhooks|null $organization, #[MapFrom('pull_request')]
    public PullRequest $pullRequest, public RepositoryWebhooks $repository, public SimpleUser|null $sender,)
    {
    }
}
