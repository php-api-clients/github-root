...
final readonly class PullRequestReview implements \ApiClients\Client\GitHub\Contract\PullRequestReview
{
    const SCHEMA_JSON = '{
     ...
     */
    public function __construct(public int $id, #[\EventSauce\ObjectHydrator\MapFrom('node_id')] public string $nodeId, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $user, public string $body, public string $state, #[\EventSauce\ObjectHydrator\MapFrom('html_url')] public string $htmlUrl, #[\EventSauce\ObjectHydrator\MapFrom('pull_request_url')] public string $pullRequestUrl, #[\EventSauce\ObjectHydrator\MapFrom('_links')] public \ApiClients\Client\GitHub\Schema\PullRequestReview\Links $links, #[\EventSauce\ObjectHydrator\MapFrom('submitted_at')] public ?string $submittedAt, #[\EventSauce\ObjectHydrator\MapFrom('commit_id')] public ?string $commitId, #[\EventSauce\ObjectHydrator\MapFrom('body_html')] public ?string $bodyHtml, #[\EventSauce\ObjectHydrator\MapFrom('body_text')] public ?string $bodyText, #[\EventSauce\ObjectHydrator\MapFrom('author_association')] public string $authorAssociation)
    {
    }
}
