...
use ApiClients\Client\GitHub\Schema\WebhookRepositoryTransferred\Changes;
...
final readonly class WebhookRepositoryTransferred implements \ApiClients\Client\GitHub\Contract\WebhookRepositoryTransferred
{
     ...
     */
    public function __construct(public string $action, public Changes $changes, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser $sender)
    {
    }
}
