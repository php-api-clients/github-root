...
final readonly class CodeSecurityConfigurationRepositories implements \ApiClients\Client\GitHub\Contract\CodeSecurityConfigurationRepositories
{
    const SCHEMA_JSON = '{
    "type": "object",
    "properties": {
     ...
     */
    public function __construct(public ?string $status, public ?\ApiClients\Client\GitHub\Schema\SimpleRepository $repository)
    {
    }
}
