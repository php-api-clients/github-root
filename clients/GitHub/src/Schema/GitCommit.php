...
final readonly class GitCommit
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"sha":"7638417db6d59f3c431d3e1f261cc637155684cd","node_id":"generated_node_id","url":"generated_url","author":{"date":"2014-08-09T08:02:04+12:00","email":"monalisa.octocat@example.com","name":"Monalisa Octocat"},"committer":{"date":"2014-08-09T08:02:04+12:00","email":"monalisa.octocat@example.com","name":"Monalisa Octocat"},"message":"Fix #42","tree":{"sha":"7638417db6d59f3c431d3e1f261cc637155684cd","url":"generated_url"},"parents":[null],"verification":{"verified":false,"reason":"generated_reason","signature":"generated_signature","payload":"generated_payload"},"html_url":"generated_html_url"}';
    /**
     * SHA for the commit
     */
    public ?string $sha;
    ...
    public function __construct(string $sha, string $node_id, string $url, Schema\GitCommit\Author $author, Schema\GitCommit\Author $committer, string $message, Schema\GitCommit\Tree $tree, array $parents, Schema\GitCommit\Verification $verification, string $html_url)
    {
        $this->sha = $sha;
