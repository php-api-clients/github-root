...
final readonly class Links
{
    ...
    public ?Schema\PullRequestReviewComment\Links\Self_ $self;
    public ?Schema\PullRequestReviewComment\Links\Html $html;
    public ?Schema\PullRequestReviewComment\Links\PullRequest $pull_request;
    public function __construct(Schema\PullRequestReviewComment\Links\Self_ $self, Schema\PullRequestReviewComment\Links\Html $html, Schema\PullRequestReviewComment\Links\PullRequest $pull_request)
    {
        $this->self = $self;
        $this->html = $html;
