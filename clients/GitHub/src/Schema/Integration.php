...
final readonly class Integration implements \ApiClients\Client\GitHub\Contract\Integration
{
    ...
    public string|null $clientId, public SimpleUser|null $owner, public string $name, public string|null $description, #[MapFrom('external_url')]
