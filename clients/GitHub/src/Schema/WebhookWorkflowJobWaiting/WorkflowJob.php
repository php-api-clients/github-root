...
final readonly class WorkflowJob
{
    ...
    /**
     * @var array<Schema\WebhookWorkflowJobWaiting\WorkflowJob\Steps>
     */
    public ?array $steps;
    public ?string $url;
