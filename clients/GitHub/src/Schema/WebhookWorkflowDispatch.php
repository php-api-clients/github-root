...
final readonly class WebhookWorkflowDispatch implements \ApiClients\Client\GitHub\Contract\WebhookWorkflowDispatch
{
     ...
     */
    public function __construct(public EnterpriseWebhooks|null $enterprise, public Inputs|null $inputs, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public string $ref, public RepositoryWebhooks $repository, public SimpleUser $sender, public string $workflow)
    {
    }
}
