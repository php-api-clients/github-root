...
final readonly class WebhookWorkflowDispatch implements \ApiClients\Client\GitHub\Contract\WebhookWorkflowDispatch
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public ?\ApiClients\Client\GitHub\Schema\WebhookWorkflowDispatch\Inputs $inputs, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public string $ref, public \ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender, public string $workflow)
    {
    }
}
