...
final readonly class WebhookDiscussionUnlabeled implements \ApiClients\Client\GitHub\Contract\WebhookDiscussionUnlabeled
{
     ...
     */
    public function __construct(public string $action, public Discussion $discussion, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public WebhooksLabel $label, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser $sender)
    {
    }
}
