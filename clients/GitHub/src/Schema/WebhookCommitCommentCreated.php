...
final readonly class WebhookCommitCommentCreated implements \ApiClients\Client\GitHub\Contract\WebhookCommitCommentCreated
{
     ...
     */
    public function __construct(public string $action, public Comment $comment, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser $sender)
    {
    }
}
