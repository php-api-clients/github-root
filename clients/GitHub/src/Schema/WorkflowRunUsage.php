...
final readonly class WorkflowRunUsage
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"billable":{"UBUNTU":{"total_ms":13,"jobs":13,"job_runs":[null]},"MACOS":{"total_ms":13,"jobs":13,"job_runs":[null]},"WINDOWS":{"total_ms":13,"jobs":13,"job_runs":[null]}},"run_duration_ms":13}';
    public ?Schema\WorkflowRunUsage\Billable $billable;
    public int $run_duration_ms;
    public function __construct(Schema\WorkflowRunUsage\Billable $billable, int $run_duration_ms)
    {
