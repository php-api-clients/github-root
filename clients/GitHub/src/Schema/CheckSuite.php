...
final readonly class CheckSuite implements \ApiClients\Client\GitHub\Contract\CheckSuite
{
    ...
    public array|null $pullRequests, public Integration|null $app, public MinimalRepository $repository, #[MapFrom('created_at')]
    public string|null $createdAt, #[MapFrom('updated_at')]
    public string|null $updatedAt, #[MapFrom('head_commit')]
    public SimpleCommit $headCommit, #[MapFrom('latest_check_runs_count')]
