...
final readonly class CheckSuite implements \ApiClients\Client\GitHub\Contract\CheckSuite
{
    const SCHEMA_JSON = '{
    "title": "CheckSuite",
    "required": [
     ...
     * headCommit: A commit.
     */
    public function __construct(public int $id, #[\EventSauce\ObjectHydrator\MapFrom('node_id')] public string $nodeId, #[\EventSauce\ObjectHydrator\MapFrom('head_branch')] public ?string $headBranch, #[\EventSauce\ObjectHydrator\MapFrom('head_sha')] public string $headSha, public ?string $status, public ?string $conclusion, public ?string $url, public ?string $before, public ?string $after, #[\EventSauce\ObjectHydrator\MapFrom('pull_requests')] public ?array $pullRequests, public ?\ApiClients\Client\GitHub\Schema\Integration $app, public \ApiClients\Client\GitHub\Schema\MinimalRepository $repository, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public ?string $createdAt, #[\EventSauce\ObjectHydrator\MapFrom('updated_at')] public ?string $updatedAt, #[\EventSauce\ObjectHydrator\MapFrom('head_commit')] public \ApiClients\Client\GitHub\Schema\SimpleCommit $headCommit, #[\EventSauce\ObjectHydrator\MapFrom('latest_check_runs_count')] public int $latestCheckRunsCount, #[\EventSauce\ObjectHydrator\MapFrom('check_runs_url')] public string $checkRunsUrl, public ?bool $rerequestable, #[\EventSauce\ObjectHydrator\MapFrom('runs_rerequestable')] public ?bool $runsRerequestable)
    {
    }
}
