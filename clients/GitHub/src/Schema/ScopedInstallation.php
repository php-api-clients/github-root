...
final readonly class ScopedInstallation implements \ApiClients\Client\GitHub\Contract\ScopedInstallation
{
     ...
     */
    public function __construct(public \ApiClients\Client\GitHub\Schema\AppPermissions $permissions, #[\EventSauce\ObjectHydrator\MapFrom('repository_selection')] public string $repositorySelection, #[\EventSauce\ObjectHydrator\MapFrom('single_file_name')] public ?string $singleFileName, #[\EventSauce\ObjectHydrator\MapFrom('has_multiple_single_files')] public ?bool $hasMultipleSingleFiles, #[\EventSauce\ObjectHydrator\MapFrom('single_file_paths')] public ?array $singleFilePaths, #[\EventSauce\ObjectHydrator\MapFrom('repositories_url')] public string $repositoriesUrl, public \ApiClients\Client\GitHub\Schema\SimpleUser $account)
    {
    }
}
