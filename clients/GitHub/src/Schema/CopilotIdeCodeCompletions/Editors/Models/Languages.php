...
final readonly class Languages implements \ApiClients\Client\GitHub\Contract\CopilotIdeCodeCompletions\Editors\Models\Languages
{
    const SCHEMA_JSON = '{
    "type": "object",
    "properties": {
     ...
     */
    public function __construct(public ?string $name, #[\EventSauce\ObjectHydrator\MapFrom('total_engaged_users')] public ?int $totalEngagedUsers, #[\EventSauce\ObjectHydrator\MapFrom('total_code_suggestions')] public ?int $totalCodeSuggestions, #[\EventSauce\ObjectHydrator\MapFrom('total_code_acceptances')] public ?int $totalCodeAcceptances, #[\EventSauce\ObjectHydrator\MapFrom('total_code_lines_suggested')] public ?int $totalCodeLinesSuggested, #[\EventSauce\ObjectHydrator\MapFrom('total_code_lines_accepted')] public ?int $totalCodeLinesAccepted)
    {
    }
}
