...
final readonly class RepositoryRuleRulesetInfo implements \ApiClients\Client\GitHub\Contract\RepositoryRuleRulesetInfo
{
     ...
     */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('ruleset_source_type')] public ?string $rulesetSourceType, #[\EventSauce\ObjectHydrator\MapFrom('ruleset_source')] public ?string $rulesetSource, #[\EventSauce\ObjectHydrator\MapFrom('ruleset_id')] public ?int $rulesetId)
    {
    }
}
