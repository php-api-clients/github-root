...
final readonly class WebhookSubIssuesSubIssueAdded implements \ApiClients\Client\GitHub\Contract\WebhookSubIssuesSubIssueAdded
{
    const SCHEMA_JSON = '{
    ...
    public const SCHEMA_TITLE = 'sub-issue added event';
    ...
    * subIssueRepo: A repository on GitHub.
    ...
    */
    public function __construct(public string $action, #[\EventSauce\ObjectHydrator\MapFrom('sub_issue_id')] public int|float $subIssueId, #[\EventSauce\ObjectHydrator\MapFrom('sub_issue')] public \ApiClients\Client\GitHub\Schema\Issue $subIssue, #[\EventSauce\ObjectHydrator\MapFrom('sub_issue_repo')] public \ApiClients\Client\GitHub\Schema\Repository $subIssueRepo, #[\EventSauce\ObjectHydrator\MapFrom('parent_issue_id')] public int|float $parentIssueId, #[\EventSauce\ObjectHydrator\MapFrom('parent_issue')] public \ApiClients\Client\GitHub\Schema\Issue $parentIssue, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public ?\ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
