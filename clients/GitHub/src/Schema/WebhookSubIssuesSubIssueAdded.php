...
final readonly class WebhookSubIssuesSubIssueAdded implements \ApiClients\Client\GitHub\Contract\WebhookSubIssuesSubIssueAdded
{
     ...
     */
    public function __construct(public string $action, #[MapFrom('sub_issue_id')]
    public int|float $subIssueId, #[MapFrom('sub_issue')]
    public Issue $subIssue, #[MapFrom('sub_issue_repo')]
    public Repository $subIssueRepo, #[MapFrom('parent_issue_id')]
    public int|float $parentIssueId, #[MapFrom('parent_issue')]
    public Issue $parentIssue, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks|null $repository, public SimpleUser|null $sender,)
    {
    }
}
