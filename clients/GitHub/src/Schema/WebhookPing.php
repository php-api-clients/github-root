...
final readonly class WebhookPing implements \ApiClients\Client\GitHub\Contract\WebhookPing
{
    const SCHEMA_JSON = '{
    "type": "object",
    "properties": {
    ...
    */
    public function __construct(public ?\ApiClients\Client\GitHub\Schema\WebhookPing\Hook $hook, #[\EventSauce\ObjectHydrator\MapFrom('hook_id')] public ?int $hookId, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public ?\ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $sender, public ?string $zen)
    {
    }
}
