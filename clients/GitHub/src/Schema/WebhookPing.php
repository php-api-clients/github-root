...
final readonly class WebhookPing implements \ApiClients\Client\GitHub\Contract\WebhookPing
{
     ...
     */
    public function __construct(public Hook|null $hook, #[MapFrom('hook_id')]
    public int|null $hookId, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks|null $repository, public SimpleUser|null $sender, public string|null $zen,)
    {
    }
}
