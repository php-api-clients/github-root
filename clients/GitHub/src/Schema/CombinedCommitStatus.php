...
final readonly class CombinedCommitStatus implements \ApiClients\Client\GitHub\Contract\CombinedCommitStatus
{
    const SCHEMA_JSON = '{
     ...
     */
    public function __construct(public string $state, public array $statuses, public string $sha, #[\EventSauce\ObjectHydrator\MapFrom('total_count')] public int $totalCount, public \ApiClients\Client\GitHub\Schema\MinimalRepository $repository, #[\EventSauce\ObjectHydrator\MapFrom('commit_url')] public string $commitUrl, public string $url)
    {
    }
}
