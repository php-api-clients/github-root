...
final readonly class ProtectedBranchRequiredStatusCheck implements \ApiClients\Client\GitHub\Contract\ProtectedBranchRequiredStatusCheck
{
    ...
    public function __construct(public ?string $url, #[\EventSauce\ObjectHydrator\MapFrom('enforcement_level')] public ?string $enforcementLevel, public array $contexts, public array $checks, #[\EventSauce\ObjectHydrator\MapFrom('contexts_url')] public ?string $contextsUrl, public ?bool $strict)
    {
    }
}
