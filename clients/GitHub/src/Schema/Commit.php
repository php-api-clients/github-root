...
final readonly class Commit implements \ApiClients\Client\GitHub\Contract\Commit
{
    ...
    public function __construct(public string $url, public string $sha, #[\EventSauce\ObjectHydrator\MapFrom('node_id')] public string $nodeId, #[\EventSauce\ObjectHydrator\MapFrom('html_url')] public string $htmlUrl, #[\EventSauce\ObjectHydrator\MapFrom('comments_url')] public string $commentsUrl, public \ApiClients\Client\GitHub\Schema\Commit\Commit $commit, #[\ApiClients\Client\GitHub\Internal\Attribute\CastUnionToType\Single\Schema\Commit\Author] public \ApiClients\Client\GitHub\Schema\SimpleUser|\ApiClients\Client\GitHub\Schema\EmptyObject $author, #[\ApiClients\Client\GitHub\Internal\Attribute\CastUnionToType\Single\Schema\Commit\Committer] public \ApiClients\Client\GitHub\Schema\SimpleUser|\ApiClients\Client\GitHub\Schema\EmptyObject $committer, public array $parents, public ?\ApiClients\Client\GitHub\Schema\Commit\Stats $stats, public ?array $files)
    {
    }
}
