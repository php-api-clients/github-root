...
final readonly class WebhookIssueCommentEdited implements \ApiClients\Client\GitHub\Contract\WebhookIssueCommentEdited
{
     ...
     */
    public function __construct(public string $action, public WebhooksChanges $changes, public WebhooksIssueComment $comment, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public Issue $issue, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser $sender)
    {
    }
}
