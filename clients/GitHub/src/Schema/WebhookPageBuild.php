...
final readonly class WebhookPageBuild implements \ApiClients\Client\GitHub\Contract\WebhookPageBuild
{
    const SCHEMA_JSON = '{
    ...
    /**
    * build: The [List GitHub Pages builds](https://docs.github.com/rest/pages/pages#list-github-pages-builds) itself.
    ...
    */
    public function __construct(public \ApiClients\Client\GitHub\Schema\WebhookPageBuild\Build $build, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public int $id, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public \ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
