...
final readonly class WebhookPageBuild implements \ApiClients\Client\GitHub\Contract\WebhookPageBuild
{
     ...
     */
    public function __construct(public Build $build, public EnterpriseWebhooks|null $enterprise, public int $id, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser $sender)
    {
    }
}
