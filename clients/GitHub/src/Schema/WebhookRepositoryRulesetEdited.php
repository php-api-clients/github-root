...
final readonly class WebhookRepositoryRulesetEdited implements \ApiClients\Client\GitHub\Contract\WebhookRepositoryRulesetEdited
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public string $action, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public ?\ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, #[\EventSauce\ObjectHydrator\MapFrom('repository_ruleset')] public \ApiClients\Client\GitHub\Schema\RepositoryRuleset $repositoryRuleset, public ?\ApiClients\Client\GitHub\Schema\WebhookRepositoryRulesetEdited\Changes $changes, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
