...
final readonly class ShortBranch implements \ApiClients\Client\GitHub\Contract\ShortBranch
{
    const SCHEMA_JSON = '{
    "title": "Short Branch",
    "required": [
     ...
     */
    public function __construct(public string $name, public \ApiClients\Client\GitHub\Schema\ShortBranch\Commit $commit, public bool $protected, public ?\ApiClients\Client\GitHub\Schema\BranchProtection $protection, #[\EventSauce\ObjectHydrator\MapFrom('protection_url')] public ?string $protectionUrl)
    {
    }
}
