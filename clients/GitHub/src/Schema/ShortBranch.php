...
final readonly class ShortBranch implements \ApiClients\Client\GitHub\Contract\ShortBranch
{
     ...
     */
    public function __construct(public string $name, public Commit $commit, public bool $protected, public BranchProtection|null $protection, #[MapFrom('protection_url')]
