...
final readonly class ConvertedNoteToIssueIssueEvent implements \ApiClients\Client\GitHub\Contract\ConvertedNoteToIssueIssueEvent
{
    const SCHEMA_JSON = '{
