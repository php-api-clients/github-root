...
final readonly class WebhookMarketplacePurchasePendingChangeCancelled implements \ApiClients\Client\GitHub\Contract\WebhookMarketplacePurchasePendingChangeCancelled
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public string $action, #[\EventSauce\ObjectHydrator\MapFrom('effective_date')] public string $effectiveDate, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, #[\EventSauce\ObjectHydrator\MapFrom('marketplace_purchase')] public \ApiClients\Client\GitHub\Schema\WebhookMarketplacePurchasePendingChangeCancelled\MarketplacePurchase $marketplacePurchase, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, #[\EventSauce\ObjectHydrator\MapFrom('previous_marketplace_purchase')] public ?\ApiClients\Client\GitHub\Schema\WebhooksPreviousMarketplacePurchase $previousMarketplacePurchase, public ?\ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
