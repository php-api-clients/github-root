...
final readonly class WebhookDeploymentProtectionRuleRequested implements \ApiClients\Client\GitHub\Contract\WebhookDeploymentProtectionRuleRequested
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public ?string $action, public ?string $environment, public ?string $event, #[\EventSauce\ObjectHydrator\MapFrom('deployment_callback_url')] public ?string $deploymentCallbackUrl, public ?\ApiClients\Client\GitHub\Schema\Deployment $deployment, #[\EventSauce\ObjectHydrator\MapFrom('pull_requests')] public ?array $pullRequests, public ?\ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
