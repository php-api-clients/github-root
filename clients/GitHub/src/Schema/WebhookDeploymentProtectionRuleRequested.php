...
final readonly class WebhookDeploymentProtectionRuleRequested implements \ApiClients\Client\GitHub\Contract\WebhookDeploymentProtectionRuleRequested
{
    ...
    public string|null $deploymentCallbackUrl, public Deployment|null $deployment, #[MapFrom('pull_requests')]
    public array|null $pullRequests, public RepositoryWebhooks|null $repository, public OrganizationSimpleWebhooks|null $organization, public SimpleInstallation|null $installation, public SimpleUser|null $sender,)
    {
    }
}
