...
final readonly class CommitSearchResultItem implements \ApiClients\Client\GitHub\Contract\CommitSearchResultItem
{
    ...
    public string $commentsUrl, public Commit $commit, public SimpleUser|null $author, public GitUser|null $committer, public array $parents, public MinimalRepository $repository, public int|float $score, #[MapFrom('node_id')]
