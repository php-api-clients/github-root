...
final readonly class CommitSearchResultItem implements \ApiClients\Client\GitHub\Contract\CommitSearchResultItem
{
    const SCHEMA_JSON = '{
     ...
     */
    public function __construct(public string $url, public string $sha, #[\EventSauce\ObjectHydrator\MapFrom('html_url')] public string $htmlUrl, #[\EventSauce\ObjectHydrator\MapFrom('comments_url')] public string $commentsUrl, public \ApiClients\Client\GitHub\Schema\CommitSearchResultItem\Commit $commit, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $author, public ?\ApiClients\Client\GitHub\Schema\GitUser $committer, public array $parents, public \ApiClients\Client\GitHub\Schema\MinimalRepository $repository, public int|float $score, #[\EventSauce\ObjectHydrator\MapFrom('node_id')] public string $nodeId, #[\EventSauce\ObjectHydrator\MapFrom('text_matches')] public ?array $textMatches)
    {
    }
}
