...
final readonly class EnvironmentApprovals implements \ApiClients\Client\GitHub\Contract\EnvironmentApprovals
{
     ...
     */
    public function __construct(public array $environments, public string $state, public \ApiClients\Client\GitHub\Schema\SimpleUser $user, public string $comment)
    {
    }
}
