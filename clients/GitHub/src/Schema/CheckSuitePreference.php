...
final readonly class CheckSuitePreference implements \ApiClients\Client\GitHub\Contract\CheckSuitePreference
{
    const SCHEMA_JSON = '{
     ...
     */
    public function __construct(public \ApiClients\Client\GitHub\Schema\CheckSuitePreference\Preferences $preferences, public \ApiClients\Client\GitHub\Schema\MinimalRepository $repository)
    {
    }
}
