...
final readonly class ProtectedBranchPullRequestReview implements \ApiClients\Client\GitHub\Contract\ProtectedBranchPullRequestReview
{
    const SCHEMA_JSON = '{
     ...
     */
    public function __construct(public ?string $url, #[\EventSauce\ObjectHydrator\MapFrom('dismissal_restrictions')] public ?\ApiClients\Client\GitHub\Schema\ProtectedBranchPullRequestReview\DismissalRestrictions $dismissalRestrictions, #[\EventSauce\ObjectHydrator\MapFrom('bypass_pull_request_allowances')] public ?\ApiClients\Client\GitHub\Schema\ProtectedBranchPullRequestReview\BypassPullRequestAllowances $bypassPullRequestAllowances, #[\EventSauce\ObjectHydrator\MapFrom('dismiss_stale_reviews')] public bool $dismissStaleReviews, #[\EventSauce\ObjectHydrator\MapFrom('require_code_owner_reviews')] public bool $requireCodeOwnerReviews, #[\EventSauce\ObjectHydrator\MapFrom('required_approving_review_count')] public ?int $requiredApprovingReviewCount, #[\EventSauce\ObjectHydrator\MapFrom('require_last_push_approval')] public ?bool $requireLastPushApproval)
    {
    }
}
