...
final readonly class WorkflowRun implements \ApiClients\Client\GitHub\Contract\WorkflowRun
{
    ...
    public string $updatedAt, public SimpleUser|null $actor, #[MapFrom('triggering_actor')]
    public SimpleUser|null $triggeringActor, #[MapFrom('run_started_at')]
    ...
    public SimpleCommit|null $headCommit, public MinimalRepository $repository, #[MapFrom('head_repository')]
    public MinimalRepository $headRepository, #[MapFrom('head_repository_id')]
