...
final readonly class WorkflowRun implements \ApiClients\Client\GitHub\Contract\WorkflowRun
{
    const SCHEMA_JSON = '{
    "title": "Workflow Run",
    "required": [
     ...
     */
    public function __construct(public int $id, public ?string $name, #[\EventSauce\ObjectHydrator\MapFrom('node_id')] public string $nodeId, #[\EventSauce\ObjectHydrator\MapFrom('check_suite_id')] public ?int $checkSuiteId, #[\EventSauce\ObjectHydrator\MapFrom('check_suite_node_id')] public ?string $checkSuiteNodeId, #[\EventSauce\ObjectHydrator\MapFrom('head_branch')] public ?string $headBranch, #[\EventSauce\ObjectHydrator\MapFrom('head_sha')] public string $headSha, public string $path, #[\EventSauce\ObjectHydrator\MapFrom('run_number')] public int $runNumber, #[\EventSauce\ObjectHydrator\MapFrom('run_attempt')] public ?int $runAttempt, #[\EventSauce\ObjectHydrator\MapFrom('referenced_workflows')] public ?array $referencedWorkflows, public string $event, public ?string $status, public ?string $conclusion, #[\EventSauce\ObjectHydrator\MapFrom('workflow_id')] public int $workflowId, public string $url, #[\EventSauce\ObjectHydrator\MapFrom('html_url')] public string $htmlUrl, #[\EventSauce\ObjectHydrator\MapFrom('pull_requests')] public ?array $pullRequests, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public string $createdAt, #[\EventSauce\ObjectHydrator\MapFrom('updated_at')] public string $updatedAt, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $actor, #[\EventSauce\ObjectHydrator\MapFrom('triggering_actor')] public ?\ApiClients\Client\GitHub\Schema\SimpleUser $triggeringActor, #[\EventSauce\ObjectHydrator\MapFrom('run_started_at')] public ?string $runStartedAt, #[\EventSauce\ObjectHydrator\MapFrom('jobs_url')] public string $jobsUrl, #[\EventSauce\ObjectHydrator\MapFrom('logs_url')] public string $logsUrl, #[\EventSauce\ObjectHydrator\MapFrom('check_suite_url')] public string $checkSuiteUrl, #[\EventSauce\ObjectHydrator\MapFrom('artifacts_url')] public string $artifactsUrl, #[\EventSauce\ObjectHydrator\MapFrom('cancel_url')] public string $cancelUrl, #[\EventSauce\ObjectHydrator\MapFrom('rerun_url')] public string $rerunUrl, #[\EventSauce\ObjectHydrator\MapFrom('previous_attempt_url')] public ?string $previousAttemptUrl, #[\EventSauce\ObjectHydrator\MapFrom('workflow_url')] public string $workflowUrl, #[\EventSauce\ObjectHydrator\MapFrom('head_commit')] public ?\ApiClients\Client\GitHub\Schema\SimpleCommit $headCommit, public \ApiClients\Client\GitHub\Schema\MinimalRepository $repository, #[\EventSauce\ObjectHydrator\MapFrom('head_repository')] public \ApiClients\Client\GitHub\Schema\MinimalRepository $headRepository, #[\EventSauce\ObjectHydrator\MapFrom('head_repository_id')] public ?int $headRepositoryId, #[\EventSauce\ObjectHydrator\MapFrom('display_title')] public string $displayTitle)
    {
    }
}
