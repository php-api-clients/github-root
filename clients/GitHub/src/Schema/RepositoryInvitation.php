...
final readonly class RepositoryInvitation implements \ApiClients\Client\GitHub\Contract\RepositoryInvitation
{
    const SCHEMA_JSON = '{
     ...
     */
    public function __construct(public int $id, public \ApiClients\Client\GitHub\Schema\MinimalRepository $repository, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $invitee, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $inviter, public string $permissions, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public string $createdAt, public ?bool $expired, public string $url, #[\EventSauce\ObjectHydrator\MapFrom('html_url')] public string $htmlUrl, #[\EventSauce\ObjectHydrator\MapFrom('node_id')] public string $nodeId)
    {
    }
}
