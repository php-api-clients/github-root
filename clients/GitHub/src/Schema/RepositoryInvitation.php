...
final readonly class RepositoryInvitation implements \ApiClients\Client\GitHub\Contract\RepositoryInvitation
{
     ...
     */
    public function __construct(public int $id, public MinimalRepository $repository, public SimpleUser|null $invitee, public SimpleUser|null $inviter, public string $permissions, #[MapFrom('created_at')]
