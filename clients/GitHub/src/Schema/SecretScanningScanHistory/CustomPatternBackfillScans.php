...
final readonly class CustomPatternBackfillScans implements \ApiClients\Client\GitHub\Contract\SecretScanningScan, \ApiClients\Client\GitHub\Contract\SecretScanningScanHistory\CustomPatternBackfillScans
{
    const SCHEMA_JSON = '{
    "allOf": [
        {
     ...
     */
    public function __construct(public ?string $type, public ?string $status, #[\EventSauce\ObjectHydrator\MapFrom('completed_at')] public ?string $completedAt, #[\EventSauce\ObjectHydrator\MapFrom('started_at')] public ?string $startedAt, #[\EventSauce\ObjectHydrator\MapFrom('pattern_name')] public ?string $patternName, #[\EventSauce\ObjectHydrator\MapFrom('pattern_scope')] public ?string $patternScope)
    {
    }
}
