...
final readonly class WebhookWorkflowJobWaiting implements \ApiClients\Client\GitHub\Contract\WebhookWorkflowJobWaiting
{
    const SCHEMA_JSON = '{
    ...
    public const SCHEMA_TITLE = 'workflow_job waiting event';
    ...
    */
    public function __construct(public string $action, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public \ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender, #[\EventSauce\ObjectHydrator\MapFrom('workflow_job')] public \ApiClients\Client\GitHub\Schema\WebhookWorkflowJobWaiting\WorkflowJob $workflowJob, public ?\ApiClients\Client\GitHub\Schema\Deployment $deployment)
    {
    }
}
