...
use ApiClients\Client\GitHub\Schema\WebhookWorkflowJobWaiting\WorkflowJob;
...
final readonly class WebhookWorkflowJobWaiting implements \ApiClients\Client\GitHub\Contract\WebhookWorkflowJobWaiting
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser $sender, #[MapFrom('workflow_job')]
    public WorkflowJob $workflowJob, public Deployment|null $deployment,)
    {
    }
}
