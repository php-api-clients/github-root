...
final readonly class MovedColumnInProjectIssueEvent implements \ApiClients\Client\GitHub\Contract\MovedColumnInProjectIssueEvent
{
    const SCHEMA_JSON = '{
