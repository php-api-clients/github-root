...
final readonly class WebhookCheckRunRerequested implements \ApiClients\Client\GitHub\Contract\WebhookCheckRunRerequested
{
    ...
    public CheckRunWithSimpleCheckSuite $checkRun, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser $sender,)
    {
    }
}
