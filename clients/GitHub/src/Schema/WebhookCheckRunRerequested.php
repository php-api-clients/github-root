...
final readonly class WebhookCheckRunRerequested implements \ApiClients\Client\GitHub\Contract\WebhookCheckRunRerequested
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public ?string $action, #[\EventSauce\ObjectHydrator\MapFrom('check_run')] public \ApiClients\Client\GitHub\Schema\CheckRunWithSimpleCheckSuite $checkRun, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public \ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
