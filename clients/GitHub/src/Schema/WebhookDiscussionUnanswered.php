...
final readonly class WebhookDiscussionUnanswered implements \ApiClients\Client\GitHub\Contract\WebhookDiscussionUnanswered
{
     ...
     */
    public function __construct(public string $action, public Discussion $discussion, #[MapFrom('old_answer')]
    public WebhooksAnswer $oldAnswer, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser|null $sender,)
    {
    }
}
