...
final readonly class WebhookDiscussionUnanswered implements \ApiClients\Client\GitHub\Contract\WebhookDiscussionUnanswered
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public string $action, public \ApiClients\Client\GitHub\Schema\Discussion $discussion, #[\EventSauce\ObjectHydrator\MapFrom('old_answer')] public \ApiClients\Client\GitHub\Schema\WebhooksAnswer $oldAnswer, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public \ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
