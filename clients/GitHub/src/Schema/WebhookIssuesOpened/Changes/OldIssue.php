...
use ApiClients\Client\GitHub\Schema\WebhookIssuesOpened\Changes\OldIssue\Assignee;
use ApiClients\Client\GitHub\Schema\WebhookIssuesOpened\Changes\OldIssue\Milestone;
use ApiClients\Client\GitHub\Schema\WebhookIssuesOpened\Changes\OldIssue\PerformedViaGithubApp;
use ApiClients\Client\GitHub\Schema\WebhookIssuesOpened\Changes\OldIssue\PullRequest;
use ApiClients\Client\GitHub\Schema\WebhookIssuesOpened\Changes\OldIssue\Reactions;
use ApiClients\Client\GitHub\Schema\WebhookIssuesOpened\Changes\OldIssue\SubIssuesSummary;
use ApiClients\Client\GitHub\Schema\WebhookIssuesOpened\Changes\OldIssue\User;
...
final readonly class OldIssue implements \ApiClients\Client\GitHub\Contract\WebhookIssuesOpened\Changes\OldIssue
{
    ...
    public string $labelsUrl, public bool|null $locked, public Milestone|null $milestone, #[MapFrom('node_id')]
    ...
    public PullRequest|null $pullRequest, public Reactions $reactions, #[MapFrom('repository_url')]
    public string $repositoryUrl, #[MapFrom('sub_issues_summary')]
    public SubIssuesSummary|null $subIssuesSummary, public string|null $state, #[MapFrom('state_reason')]
