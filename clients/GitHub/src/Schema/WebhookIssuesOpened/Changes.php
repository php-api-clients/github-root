...
final readonly class Changes implements \ApiClients\Client\GitHub\Contract\WebhookIssuesOpened\Changes
{
    const SCHEMA_JSON = '{
    "required": [
        "old_issue",
     ...
     */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('old_issue')] public ?\ApiClients\Client\GitHub\Schema\WebhookIssuesOpened\Changes\OldIssue $oldIssue, #[\EventSauce\ObjectHydrator\MapFrom('old_repository')] public \ApiClients\Client\GitHub\Schema\WebhookIssuesOpened\Changes\OldRepository $oldRepository)
    {
    }
}
