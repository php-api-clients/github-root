...
final readonly class Two implements \ApiClients\Client\GitHub\Contract\RepositoryRulesetConditions, \ApiClients\Client\GitHub\Contract\RepositoryRulesetConditionsRepositoryPropertyTarget
{
    const SCHEMA_JSON = '{
    ...
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('ref_name')] public ?\ApiClients\Client\GitHub\Schema\RepositoryRulesetConditions\RefName $refName, #[\EventSauce\ObjectHydrator\MapFrom('repository_property')] public \ApiClients\Client\GitHub\Schema\RepositoryRulesetConditionsRepositoryPropertyTarget\RepositoryProperty $repositoryProperty)
    {
    }
}
