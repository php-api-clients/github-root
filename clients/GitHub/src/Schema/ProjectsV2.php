...
final readonly class ProjectsV2 implements \ApiClients\Client\GitHub\Contract\ProjectsV2
{
    ...
    public string $nodeId, public SimpleUser $owner, public SimpleUser $creator, public string $title, public string|null $description, public bool $public, #[MapFrom('closed_at')]
    ...
    public SimpleUser|null $deletedBy,)
    {
    }
}
