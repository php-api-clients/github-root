...
use ApiClients\Client\GitHub\Schema\WebhookMembershipAdded\Sender;
...
final readonly class WebhookMembershipAdded implements \ApiClients\Client\GitHub\Contract\WebhookMembershipAdded
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public WebhooksUser|null $member, public OrganizationSimpleWebhooks $organization, public RepositoryWebhooks|null $repository, public string $scope, public Sender|null $sender, public WebhooksTeam $team)
    {
    }
}
