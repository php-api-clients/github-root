...
final readonly class WebhookMembershipAdded implements \ApiClients\Client\GitHub\Contract\WebhookMembershipAdded
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public string $action, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\WebhooksUser $member, public \ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public ?\ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public string $scope, public ?\ApiClients\Client\GitHub\Schema\WebhookMembershipAdded\Sender $sender, public \ApiClients\Client\GitHub\Schema\WebhooksTeam $team)
    {
    }
}
