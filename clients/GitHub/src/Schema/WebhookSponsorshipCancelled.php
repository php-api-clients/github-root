...
final readonly class WebhookSponsorshipCancelled implements \ApiClients\Client\GitHub\Contract\WebhookSponsorshipCancelled
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks|null $repository, public SimpleUser $sender, public WebhooksSponsorship $sponsorship)
    {
    }
}
