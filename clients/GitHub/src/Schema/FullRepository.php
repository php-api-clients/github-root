...
final readonly class FullRepository implements \ApiClients\Client\GitHub\Contract\FullRepository
{
    ...
    public string $updatedAt, public Permissions|null $permissions, #[MapFrom('allow_rebase_merge')]
    public bool|null $allowRebaseMerge, #[MapFrom('template_repository')]
    public Repository|null $templateRepository, #[MapFrom('temp_clone_token')]
    ...
    public int $networkCount, public LicenseSimple|null $license, public SimpleUser|null $organization, public Repository|null $parent, public Repository|null $source, public int $forks, #[MapFrom('master_branch')]
    ...
    public CodeOfConductSimple|null $codeOfConduct, #[MapFrom('security_and_analysis')]
    public SecurityAndAnalysis|null $securityAndAnalysis, #[MapFrom('custom_properties')]
