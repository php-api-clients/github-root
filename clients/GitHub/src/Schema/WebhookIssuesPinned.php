...
final readonly class WebhookIssuesPinned implements \ApiClients\Client\GitHub\Contract\WebhookIssuesPinned
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public WebhooksIssue2 $issue, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser $sender)
    {
    }
}
