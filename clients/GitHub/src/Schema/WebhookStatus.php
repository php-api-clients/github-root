...
final readonly class WebhookStatus implements \ApiClients\Client\GitHub\Contract\WebhookStatus
{
    ...
    public string|null $avatarUrl, public array $branches, public Commit $commit, public string $context, #[MapFrom('created_at')]
    public string $createdAt, public string|null $description, public EnterpriseWebhooks|null $enterprise, public int $id, public SimpleInstallation|null $installation, public string $name, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser $sender, public string $sha, public string $state, #[MapFrom('target_url')]
