...
final readonly class WebhookStatus implements \ApiClients\Client\GitHub\Contract\WebhookStatus
{
    const SCHEMA_JSON = '{
    "title": "status event",
    "required": [
    ...
    */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('avatar_url')] public ?string $avatarUrl, public array $branches, public \ApiClients\Client\GitHub\Schema\WebhookStatus\Commit $commit, public string $context, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public string $createdAt, public ?string $description, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public int $id, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public string $name, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public \ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender, public string $sha, public string $state, #[\EventSauce\ObjectHydrator\MapFrom('target_url')] public ?string $targetUrl, #[\EventSauce\ObjectHydrator\MapFrom('updated_at')] public string $updatedAt)
    {
    }
}
