...
use ApiClients\Client\GitHub\Schema\WebhookBranchProtectionRuleEdited\Changes;
...
final readonly class WebhookBranchProtectionRuleEdited implements \ApiClients\Client\GitHub\Contract\WebhookBranchProtectionRuleEdited
{
     ...
     */
    public function __construct(public string $action, public Changes|null $changes, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public WebhooksRule $rule, public SimpleUser $sender)
    {
    }
}
