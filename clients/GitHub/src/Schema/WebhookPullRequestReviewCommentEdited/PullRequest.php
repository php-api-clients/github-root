...
use ApiClients\Client\GitHub\Internal\Attribute\CastUnionToType\Multiple\Schema\WebhookPullRequestReviewCommentEdited\PullRequest\RequestedReviewers;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewCommentEdited\PullRequest\Assignee;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewCommentEdited\PullRequest\AutoMerge;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewCommentEdited\PullRequest\Base;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewCommentEdited\PullRequest\Head;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewCommentEdited\PullRequest\Links;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewCommentEdited\PullRequest\Milestone;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewCommentEdited\PullRequest\RequestedReviewers\One;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewCommentEdited\PullRequest\RequestedReviewers\Zero;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewCommentEdited\PullRequest\User;
