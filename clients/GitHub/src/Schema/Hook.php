...
final readonly class Hook implements \ApiClients\Client\GitHub\Contract\Hook
{
     ...
     */
    public function __construct(public string $type, public int $id, public string $name, public bool $active, public array $events, public \ApiClients\Client\GitHub\Schema\WebhookConfig $config, #[\EventSauce\ObjectHydrator\MapFrom('updated_at')] public string $updatedAt, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public string $createdAt, public string $url, #[\EventSauce\ObjectHydrator\MapFrom('test_url')] public string $testUrl, #[\EventSauce\ObjectHydrator\MapFrom('ping_url')] public string $pingUrl, #[\EventSauce\ObjectHydrator\MapFrom('deliveries_url')] public ?string $deliveriesUrl, #[\EventSauce\ObjectHydrator\MapFrom('last_response')] public \ApiClients\Client\GitHub\Schema\HookResponse $lastResponse)
    {
    }
}
