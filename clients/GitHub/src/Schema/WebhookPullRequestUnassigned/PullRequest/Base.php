...
final readonly class Base implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestUnassigned\PullRequest\Base
{
    const SCHEMA_JSON = '{
    "required": [
        "label",
     ...
     */
    public function __construct(public ?string $label, public string $ref, public \ApiClients\Client\GitHub\Schema\WebhookPullRequestUnassigned\PullRequest\Base\Repo $repo, public string $sha, public ?\ApiClients\Client\GitHub\Schema\WebhookPullRequestUnassigned\PullRequest\Base\User $user)
    {
    }
}
