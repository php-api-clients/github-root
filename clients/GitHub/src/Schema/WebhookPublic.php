...
final readonly class WebhookPublic implements \ApiClients\Client\GitHub\Contract\WebhookPublic
{
     ...
     */
    public function __construct(public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser $sender)
    {
    }
}
