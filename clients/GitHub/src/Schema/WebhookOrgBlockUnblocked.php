...
final readonly class WebhookOrgBlockUnblocked implements \ApiClients\Client\GitHub\Contract\WebhookOrgBlockUnblocked
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public string $action, #[\EventSauce\ObjectHydrator\MapFrom('blocked_user')] public ?\ApiClients\Client\GitHub\Schema\WebhooksUser $blockedUser, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public \ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public ?\ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
