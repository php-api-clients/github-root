...
final readonly class WebhookOrgBlockUnblocked implements \ApiClients\Client\GitHub\Contract\WebhookOrgBlockUnblocked
{
    ...
    public WebhooksUser|null $blockedUser, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks $organization, public RepositoryWebhooks|null $repository, public SimpleUser $sender,)
    {
    }
}
