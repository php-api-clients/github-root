...
final readonly class WebhookRepositoryAdvisoryReported implements \ApiClients\Client\GitHub\Contract\WebhookRepositoryAdvisoryReported
{
    ...
    public const SCHEMA_TITLE        = 'Repository advisory reported event';
