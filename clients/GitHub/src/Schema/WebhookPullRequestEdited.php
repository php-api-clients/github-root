...
final readonly class WebhookPullRequestEdited implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestEdited
{
     ...
     */
    public function __construct(public string $action, public Changes $changes, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public int $number, public OrganizationSimpleWebhooks|null $organization, #[MapFrom('pull_request')]
    public PullRequestWebhook $pullRequest, public RepositoryWebhooks $repository, public SimpleUser|null $sender,)
    {
    }
}
