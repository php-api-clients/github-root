...
final readonly class WebhookSubIssuesParentIssueRemoved implements \ApiClients\Client\GitHub\Contract\WebhookSubIssuesParentIssueRemoved
{
     ...
     */
    public function __construct(public string $action, #[MapFrom('parent_issue_id')]
    public int|float $parentIssueId, #[MapFrom('parent_issue')]
    public Issue $parentIssue, #[MapFrom('parent_issue_repo')]
    public Repository $parentIssueRepo, #[MapFrom('sub_issue_id')]
    public int|float $subIssueId, #[MapFrom('sub_issue')]
    public Issue $subIssue, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks|null $repository, public SimpleUser|null $sender,)
    {
    }
}
