...
final readonly class WebhookSubIssuesParentIssueRemoved implements \ApiClients\Client\GitHub\Contract\WebhookSubIssuesParentIssueRemoved
{
    const SCHEMA_JSON = '{
    ...
    public const SCHEMA_TITLE = 'parent issue removed event';
    ...
    /**
    * parentIssueId: The ID of the parent issue.
    * parentIssue: Issues are a great way to keep track of tasks, enhancements, and bugs for your projects.
    * parentIssueRepo: A repository on GitHub.
    * subIssueId: The ID of the sub-issue.
    * subIssue: Issues are a great way to keep track of tasks, enhancements, and bugs for your projects.
    ...
    */
    public function __construct(public string $action, #[\EventSauce\ObjectHydrator\MapFrom('parent_issue_id')] public int|float $parentIssueId, #[\EventSauce\ObjectHydrator\MapFrom('parent_issue')] public \ApiClients\Client\GitHub\Schema\Issue $parentIssue, #[\EventSauce\ObjectHydrator\MapFrom('parent_issue_repo')] public \ApiClients\Client\GitHub\Schema\Repository $parentIssueRepo, #[\EventSauce\ObjectHydrator\MapFrom('sub_issue_id')] public int|float $subIssueId, #[\EventSauce\ObjectHydrator\MapFrom('sub_issue')] public \ApiClients\Client\GitHub\Schema\Issue $subIssue, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public ?\ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
