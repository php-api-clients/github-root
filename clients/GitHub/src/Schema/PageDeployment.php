...
final readonly class PageDeployment implements \ApiClients\Client\GitHub\Contract\PageDeployment
{
    const SCHEMA_JSON = '{
    "title": "GitHub Pages",
    "required": [
     ...
     */
    public function __construct(public int|string $id, #[\EventSauce\ObjectHydrator\MapFrom('status_url')] public string $statusUrl, #[\EventSauce\ObjectHydrator\MapFrom('page_url')] public string $pageUrl, #[\EventSauce\ObjectHydrator\MapFrom('preview_url')] public ?string $previewUrl)
    {
    }
}
