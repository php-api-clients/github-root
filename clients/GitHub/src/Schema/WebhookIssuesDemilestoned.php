...
use ApiClients\Client\GitHub\Schema\WebhookIssuesDemilestoned\Issue;
...
final readonly class WebhookIssuesDemilestoned implements \ApiClients\Client\GitHub\Contract\WebhookIssuesDemilestoned
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public Issue $issue, public WebhooksMilestone|null $milestone, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser $sender)
    {
    }
}
