...
use ApiClients\Client\GitHub\Schema\UnlabeledIssueEvent\Label;
use EventSauce\ObjectHydrator\MapFrom;

final readonly class UnlabeledIssueEvent implements \ApiClients\Client\GitHub\Contract\UnlabeledIssueEvent
{
    ...
    public Integration|null $performedViaGithubApp, public Label $label,)
    {
    }
}
