...
use ApiClients\Client\GitHub\Schema\WebhookIssuesClosed\Issue;
...
final readonly class WebhookIssuesClosed implements \ApiClients\Client\GitHub\Contract\WebhookIssuesClosed
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public Issue $issue, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser $sender)
    {
    }
}
