...
final readonly class WebhookPullRequestReviewCommentCreated implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestReviewCommentCreated
{
     ...
     */
    public function __construct(public string $action, public Comment $comment, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, #[MapFrom('pull_request')]
