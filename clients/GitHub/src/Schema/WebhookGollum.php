...
final readonly class WebhookGollum implements \ApiClients\Client\GitHub\Contract\WebhookGollum
{
     ...
     */
    public function __construct(public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public array $pages, public RepositoryWebhooks $repository, public SimpleUser $sender)
    {
    }
}
