...
final readonly class WebhookGollum implements \ApiClients\Client\GitHub\Contract\WebhookGollum
{
    const SCHEMA_JSON = '{
    "title": "gollum event",
    "required": [
    ...
    */
    public function __construct(public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public array $pages, public \ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
