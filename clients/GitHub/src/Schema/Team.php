...
final readonly class Team
{
    ...
    public mixed $parent;
    public function __construct(int $id, string $node_id, string $name, string $slug, string $description, string $privacy, string $permission, Schema\Team\Permissions $permissions, string $url, string $html_url, string $members_url, string $repositories_url, mixed $parent)
    {
        $this->id = $id;
