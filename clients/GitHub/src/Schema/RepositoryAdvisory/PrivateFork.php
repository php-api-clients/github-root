...
use ApiClients\Client\GitHub\Contract\SimpleRepository;
use ApiClients\Client\GitHub\Schema\SimpleUser;
use EventSauce\ObjectHydrator\MapFrom;

final readonly class PrivateFork implements SimpleRepository
{
    ...
    public const SCHEMA_DESCRIPTION  = 'A temporary private fork of the advisory\'s repository for collaborating on a fix.';
    ...
    public string $fullName, public SimpleUser $owner, public bool $private, #[MapFrom('html_url')]
