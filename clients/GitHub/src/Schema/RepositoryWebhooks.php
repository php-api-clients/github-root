...
when the event occurs from activity in a repository.';
    ...
    public string $fullName, public LicenseSimple|null $license, public SimpleUser|null $organization, public int $forks, public Permissions|null $permissions, public SimpleUser $owner, public bool $private, #[MapFrom('html_url')]
    ...
    public CustomProperties|null $customProperties, #[MapFrom('has_issues')]
    ...
    public TemplateRepository|null $templateRepository, #[MapFrom('temp_clone_token')]
