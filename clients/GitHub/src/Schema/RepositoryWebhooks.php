...
final readonly class RepositoryWebhooks implements \ApiClients\Client\GitHub\Contract\RepositoryWebhooks
{
    const SCHEMA_JSON = '{
    "title": "Repository",
    "required": [
