...
use ApiClients\Client\GitHub\Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\DismissedBy;
use ApiClients\Client\GitHub\Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\MostRecentInstance;
