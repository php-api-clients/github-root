...
use ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewCommentEdited\PullRequest;
...
final readonly class WebhookPullRequestReviewCommentEdited implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestReviewCommentEdited
{
     ...
     */
    public function __construct(public string $action, public WebhooksChanges $changes, public WebhooksReviewComment $comment, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, #[MapFrom('pull_request')]
    public PullRequest $pullRequest, public RepositoryWebhooks $repository, public SimpleUser $sender,)
    {
    }
}
