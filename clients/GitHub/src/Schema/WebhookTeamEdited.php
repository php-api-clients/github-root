...
final readonly class WebhookTeamEdited implements \ApiClients\Client\GitHub\Contract\WebhookTeamEdited
{
     ...
     */
    public function __construct(public string $action, public Changes $changes, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks $organization, public Repository|null $repository, public SimpleUser $sender, public WebhooksTeam1 $team)
    {
    }
}
