...
final readonly class WebhookTeamEdited implements \ApiClients\Client\GitHub\Contract\WebhookTeamEdited
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public string $action, public \ApiClients\Client\GitHub\Schema\WebhookTeamEdited\Changes $changes, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public \ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public ?\ApiClients\Client\GitHub\Schema\WebhookTeamEdited\Repository $repository, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender, public \ApiClients\Client\GitHub\Schema\WebhooksTeam1 $team)
    {
    }
}
