...
final readonly class WebhookProjectsV2ItemConverted implements \ApiClients\Client\GitHub\Contract\WebhookProjectsV2ItemConverted
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public string $action, public \ApiClients\Client\GitHub\Schema\WebhookProjectsV2ItemConverted\Changes $changes, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public \ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, #[\EventSauce\ObjectHydrator\MapFrom('projects_v2_item')] public \ApiClients\Client\GitHub\Schema\ProjectsV2Item $projectsVTwoItem, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
