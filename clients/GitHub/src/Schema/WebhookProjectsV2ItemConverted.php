...
final readonly class WebhookProjectsV2ItemConverted implements \ApiClients\Client\GitHub\Contract\WebhookProjectsV2ItemConverted
{
     ...
     */
    public function __construct(public string $action, public Changes $changes, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks $organization, #[MapFrom('projects_v2_item')]
