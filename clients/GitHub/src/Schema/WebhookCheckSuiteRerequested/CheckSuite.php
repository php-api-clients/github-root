...
final readonly class CheckSuite implements \ApiClients\Client\GitHub\Contract\WebhookCheckSuiteRerequested\CheckSuite
{
    const SCHEMA_JSON = '{
    "required": [
        "id",
