...
final readonly class WebhookDeployKeyDeleted implements \ApiClients\Client\GitHub\Contract\WebhookDeployKeyDeleted
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public WebhooksDeployKey $key, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser $sender)
    {
    }
}
