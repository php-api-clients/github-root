...
final readonly class WebhookDeployKeyDeleted implements \ApiClients\Client\GitHub\Contract\WebhookDeployKeyDeleted
{
    const SCHEMA_JSON = '{
    ...
    * installation: The GitHub App installation. Webhook payloads contain the `installation` property when the event is configured
    for and sent to a GitHub App. For more information,
    see "[Using webhooks with GitHub Apps](https://docs.github.com/apps/creating-github-apps/registering-a-github-app/using-webhooks-with-github-apps)."
    * key: The [`deploy key`](https://docs.github.com/rest/deploy-keys/deploy-keys#get-a-deploy-key) resource.
    ...
    */
    public function __construct(public string $action, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public \ApiClients\Client\GitHub\Schema\WebhooksDeployKey $key, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public \ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
