...
final readonly class PullRequestSimple implements \ApiClients\Client\GitHub\Contract\PullRequestSimple
{
    ...
    public string $statusesUrl, public int $number, public string $state, public bool $locked, public string $title, public SimpleUser|null $user, public string|null $body, public array $labels, public Milestone|null $milestone, #[MapFrom('active_lock_reason')]
    ...
    public AutoMerge|null $autoMerge, public bool|null $draft,)
    {
    }
}
