...
final readonly class Parameters implements \ApiClients\Client\GitHub\Contract\RepositoryRuleMergeQueue\Parameters
{
     ...
     */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('check_response_timeout_minutes')] public int $checkResponseTimeoutMinutes, #[\EventSauce\ObjectHydrator\MapFrom('grouping_strategy')] public string $groupingStrategy, #[\EventSauce\ObjectHydrator\MapFrom('max_entries_to_build')] public int $maxEntriesToBuild, #[\EventSauce\ObjectHydrator\MapFrom('max_entries_to_merge')] public int $maxEntriesToMerge, #[\EventSauce\ObjectHydrator\MapFrom('merge_method')] public string $mergeMethod, #[\EventSauce\ObjectHydrator\MapFrom('min_entries_to_merge')] public int $minEntriesToMerge, #[\EventSauce\ObjectHydrator\MapFrom('min_entries_to_merge_wait_minutes')] public int $minEntriesToMergeWaitMinutes)
    {
    }
}
