...
final readonly class WebhookDeploymentReviewRequested implements \ApiClients\Client\GitHub\Contract\WebhookDeploymentReviewRequested
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public string $environment, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks $organization, public RepositoryWebhooks $repository, public WebhooksUser|null $requestor, public array $reviewers, public SimpleUser $sender, public string $since, #[MapFrom('workflow_job_run')]
    public WorkflowJobRun $workflowJobRun, #[MapFrom('workflow_run')]
