...
final readonly class WebhookDeploymentReviewRequested implements \ApiClients\Client\GitHub\Contract\WebhookDeploymentReviewRequested
{
    const SCHEMA_JSON = '{
    "required": [
        "action",
    ...
    */
    public function __construct(public string $action, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public string $environment, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public \ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public \ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public ?\ApiClients\Client\GitHub\Schema\WebhooksUser $requestor, public array $reviewers, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender, public string $since, #[\EventSauce\ObjectHydrator\MapFrom('workflow_job_run')] public \ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowJobRun $workflowJobRun, #[\EventSauce\ObjectHydrator\MapFrom('workflow_run')] public ?\ApiClients\Client\GitHub\Schema\WebhookDeploymentReviewRequested\WorkflowRun $workflowRun)
    {
    }
}
