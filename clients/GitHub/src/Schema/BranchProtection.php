...
final readonly class BranchProtection implements \ApiClients\Client\GitHub\Contract\BranchProtection
{
    ...
    public ProtectedBranchRequiredStatusCheck|null $requiredStatusChecks, #[MapFrom('enforce_admins')]
    public ProtectedBranchAdminEnforced|null $enforceAdmins, #[MapFrom('required_pull_request_reviews')]
    public ProtectedBranchPullRequestReview|null $requiredPullRequestReviews, public BranchRestrictionPolicy|null $restrictions, #[MapFrom('required_linear_history')]
    ...
    public AllowDeletions|null $allowDeletions, #[MapFrom('block_creations')]
    public BlockCreations|null $blockCreations, #[MapFrom('required_conversation_resolution')]
    public RequiredConversationResolution|null $requiredConversationResolution, public string|null $name, #[MapFrom('protection_url')]
    public string|null $protectionUrl, #[MapFrom('required_signatures')]
    public RequiredSignatures|null $requiredSignatures, #[MapFrom('lock_branch')]
