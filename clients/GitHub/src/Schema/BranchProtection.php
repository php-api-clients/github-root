...
final readonly class BranchProtection implements \ApiClients\Client\GitHub\Contract\BranchProtection
{
    const SCHEMA_JSON = '{
     ...
     */
    public function __construct(public ?string $url, public ?bool $enabled, #[\EventSauce\ObjectHydrator\MapFrom('required_status_checks')] public ?\ApiClients\Client\GitHub\Schema\ProtectedBranchRequiredStatusCheck $requiredStatusChecks, #[\EventSauce\ObjectHydrator\MapFrom('enforce_admins')] public ?\ApiClients\Client\GitHub\Schema\ProtectedBranchAdminEnforced $enforceAdmins, #[\EventSauce\ObjectHydrator\MapFrom('required_pull_request_reviews')] public ?\ApiClients\Client\GitHub\Schema\ProtectedBranchPullRequestReview $requiredPullRequestReviews, public ?\ApiClients\Client\GitHub\Schema\BranchRestrictionPolicy $restrictions, #[\EventSauce\ObjectHydrator\MapFrom('required_linear_history')] public ?\ApiClients\Client\GitHub\Schema\BranchProtection\RequiredLinearHistory $requiredLinearHistory, #[\EventSauce\ObjectHydrator\MapFrom('allow_force_pushes')] public ?\ApiClients\Client\GitHub\Schema\BranchProtection\AllowForcePushes $allowForcePushes, #[\EventSauce\ObjectHydrator\MapFrom('allow_deletions')] public ?\ApiClients\Client\GitHub\Schema\BranchProtection\AllowDeletions $allowDeletions, #[\EventSauce\ObjectHydrator\MapFrom('block_creations')] public ?\ApiClients\Client\GitHub\Schema\BranchProtection\BlockCreations $blockCreations, #[\EventSauce\ObjectHydrator\MapFrom('required_conversation_resolution')] public ?\ApiClients\Client\GitHub\Schema\BranchProtection\RequiredConversationResolution $requiredConversationResolution, public ?string $name, #[\EventSauce\ObjectHydrator\MapFrom('protection_url')] public ?string $protectionUrl, #[\EventSauce\ObjectHydrator\MapFrom('required_signatures')] public ?\ApiClients\Client\GitHub\Schema\BranchProtection\RequiredSignatures $requiredSignatures, #[\EventSauce\ObjectHydrator\MapFrom('lock_branch')] public ?\ApiClients\Client\GitHub\Schema\BranchProtection\LockBranch $lockBranch, #[\EventSauce\ObjectHydrator\MapFrom('allow_fork_syncing')] public ?\ApiClients\Client\GitHub\Schema\BranchProtection\AllowForkSyncing $allowForkSyncing)
    {
    }
}
