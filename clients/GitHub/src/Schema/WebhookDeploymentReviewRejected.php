...
final readonly class WebhookDeploymentReviewRejected implements \ApiClients\Client\GitHub\Contract\WebhookDeploymentReviewRejected
{
    const SCHEMA_JSON = '{
    "required": [
        "action",
