...
use ApiClients\Client\GitHub\Schema\WebhookIssuesOpened\Changes;
use ApiClients\Client\GitHub\Schema\WebhookIssuesOpened\Issue;
...
final readonly class WebhookIssuesOpened implements \ApiClients\Client\GitHub\Contract\WebhookIssuesOpened
{
     ...
     */
    public function __construct(public string $action, public Changes|null $changes, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public Issue $issue, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser $sender)
    {
    }
}
