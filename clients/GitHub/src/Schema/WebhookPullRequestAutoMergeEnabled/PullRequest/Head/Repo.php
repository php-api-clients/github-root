...
namespace ApiClients\Client\GitHub\Schema\WebhookPullRequestAutoMergeEnabled\PullRequest\Head;

final readonly class Repo implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestAutoMergeEnabled\PullRequest\Head\Repo
{
    const SCHEMA_JSON = '{
    "title": "Repository",
    "required": [
