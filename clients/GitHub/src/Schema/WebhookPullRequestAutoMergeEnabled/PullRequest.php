...
use ApiClients\Client\GitHub\Internal\Attribute\CastUnionToType\Multiple\Schema\WebhookPullRequestAutoMergeEnabled\PullRequest\RequestedReviewers;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestAutoMergeEnabled\PullRequest\Assignee;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestAutoMergeEnabled\PullRequest\AutoMerge;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestAutoMergeEnabled\PullRequest\Base;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestAutoMergeEnabled\PullRequest\Head;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestAutoMergeEnabled\PullRequest\Links;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestAutoMergeEnabled\PullRequest\MergedBy;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestAutoMergeEnabled\PullRequest\Milestone;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestAutoMergeEnabled\PullRequest\RequestedReviewers\One;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestAutoMergeEnabled\PullRequest\RequestedReviewers\Zero;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestAutoMergeEnabled\PullRequest\User;
...
final readonly class PullRequest implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestAutoMergeEnabled\PullRequest
{
    ...
    public string|null $activeLockReason, public int|null $additions, public Assignee|null $assignee, public array $assignees, #[MapFrom('author_association')]
    public string $authorAssociation, #[MapFrom('auto_merge')]
    public AutoMerge|null $autoMerge, public Base $base, public string|null $body, #[MapFrom('changed_files')]
    ...
    public MergedBy|null $mergedBy, public Milestone|null $milestone, #[MapFrom('node_id')]
