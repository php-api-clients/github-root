...
final readonly class WebhookInstallationRepositoriesRemoved implements \ApiClients\Client\GitHub\Contract\WebhookInstallationRepositoriesRemoved
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public Installation $installation, public OrganizationSimpleWebhooks|null $organization, #[MapFrom('repositories_added')]
    public array $repositoriesAdded, #[MapFrom('repositories_removed')]
    public array $repositoriesRemoved, public RepositoryWebhooks|null $repository, #[MapFrom('repository_selection')]
    public string $repositorySelection, public WebhooksUser|null $requester, public SimpleUser $sender,)
    {
    }
}
