...
final readonly class WebhookInstallationRepositoriesRemoved implements \ApiClients\Client\GitHub\Contract\WebhookInstallationRepositoriesRemoved
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public string $action, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public \ApiClients\Client\GitHub\Schema\Installation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, #[\EventSauce\ObjectHydrator\MapFrom('repositories_added')] public array $repositoriesAdded, #[\EventSauce\ObjectHydrator\MapFrom('repositories_removed')] public array $repositoriesRemoved, public ?\ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, #[\EventSauce\ObjectHydrator\MapFrom('repository_selection')] public string $repositorySelection, public ?\ApiClients\Client\GitHub\Schema\WebhooksUser $requester, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
