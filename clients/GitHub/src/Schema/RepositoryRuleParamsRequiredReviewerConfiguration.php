...
final readonly class RepositoryRuleParamsRequiredReviewerConfiguration implements \ApiClients\Client\GitHub\Contract\RepositoryRuleParamsRequiredReviewerConfiguration
{
    const SCHEMA_JSON = '{
     ...
     */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('file_patterns')] public array $filePatterns, #[\EventSauce\ObjectHydrator\MapFrom('minimum_approvals')] public int $minimumApprovals, #[\EventSauce\ObjectHydrator\MapFrom('reviewer_id')] public string $reviewerId)
    {
    }
}
