...
final readonly class WebhookPullRequestAssigned implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestAssigned
{
     ...
     */
    public function __construct(public string $action, public WebhooksUser|null $assignee, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public int $number, public OrganizationSimpleWebhooks|null $organization, #[MapFrom('pull_request')]
