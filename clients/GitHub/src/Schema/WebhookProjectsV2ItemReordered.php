...
final readonly class WebhookProjectsV2ItemReordered implements \ApiClients\Client\GitHub\Contract\WebhookProjectsV2ItemReordered
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public string $action, public \ApiClients\Client\GitHub\Schema\WebhookProjectsV2ItemReordered\Changes $changes, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public \ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, #[\EventSauce\ObjectHydrator\MapFrom('projects_v2_item')] public \ApiClients\Client\GitHub\Schema\ProjectsV2Item $projectsVTwoItem, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
