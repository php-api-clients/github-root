...
final readonly class Changes
{
    ...
    public ?Schema\WebhookSponsorshipPendingTierChange\Changes\Tier $tier;
    public function __construct(Schema\WebhookSponsorshipPendingTierChange\Changes\Tier $tier)
    {
        $this->tier = $tier;
    }
}
