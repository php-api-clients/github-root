...
final readonly class SecretScanningScan implements \ApiClients\Client\GitHub\Contract\SecretScanningScan
{
     ...
     */
    public function __construct(public ?string $type, public ?string $status, #[\EventSauce\ObjectHydrator\MapFrom('completed_at')] public ?string $completedAt, #[\EventSauce\ObjectHydrator\MapFrom('started_at')] public ?string $startedAt)
    {
    }
}
