...
final readonly class WebhookDependabotAlertAutoReopened implements \ApiClients\Client\GitHub\Contract\WebhookDependabotAlertAutoReopened
{
     ...
     */
    public function __construct(public string $action, public DependabotAlert $alert, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public EnterpriseWebhooks|null $enterprise, public RepositoryWebhooks $repository, public SimpleUser $sender)
    {
    }
}
