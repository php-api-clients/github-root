...
final readonly class Repository implements \ApiClients\Client\GitHub\Contract\Repository
{
    const SCHEMA_JSON = '{
    "title": "Repository",
    "required": [
