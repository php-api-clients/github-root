...
final readonly class Repository implements \ApiClients\Client\GitHub\Contract\Repository
{
    ...
    public string $fullName, public LicenseSimple|null $license, public int $forks, public Permissions|null $permissions, public SimpleUser $owner, public bool $private, #[MapFrom('html_url')]
