...
use ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewDismissed\PullRequest;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewDismissed\Review;
...
final readonly class WebhookPullRequestReviewDismissed implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestReviewDismissed
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, #[MapFrom('pull_request')]
    public PullRequest $pullRequest, public RepositoryWebhooks $repository, public Review $review, public SimpleUser $sender,)
    {
    }
}
