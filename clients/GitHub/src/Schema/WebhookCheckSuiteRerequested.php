...
final readonly class WebhookCheckSuiteRerequested implements \ApiClients\Client\GitHub\Contract\WebhookCheckSuiteRerequested
{
    const SCHEMA_JSON = '{
    ...
    /**
    * checkSuite: The [check_suite](https://docs.github.com/rest/checks/suites#get-a-check-suite).
    ...
    */
    public function __construct(public string $action, #[\EventSauce\ObjectHydrator\MapFrom('check_suite')] public \ApiClients\Client\GitHub\Schema\WebhookCheckSuiteRerequested\CheckSuite $checkSuite, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public \ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
