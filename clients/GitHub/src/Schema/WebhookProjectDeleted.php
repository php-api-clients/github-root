...
final readonly class WebhookProjectDeleted implements \ApiClients\Client\GitHub\Contract\WebhookProjectDeleted
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public WebhooksProject $project, public RepositoryWebhooks|null $repository, public SimpleUser|null $sender)
    {
    }
}
