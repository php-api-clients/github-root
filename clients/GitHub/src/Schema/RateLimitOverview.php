...
final readonly class RateLimitOverview
{
    ...
    public ?Schema\RateLimitOverview\Resources $resources;
    public ?Schema\RateLimit $rate;
    public function __construct(Schema\RateLimitOverview\Resources $resources, Schema\RateLimit $rate)
    {
