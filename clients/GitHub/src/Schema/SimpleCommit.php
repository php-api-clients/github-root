...
final readonly class SimpleCommit implements \ApiClients\Client\GitHub\Contract\SimpleCommit
{
     ...
     */
    public function __construct(public string $id, #[\EventSauce\ObjectHydrator\MapFrom('tree_id')] public string $treeId, public string $message, public string $timestamp, public ?\ApiClients\Client\GitHub\Schema\SimpleCommit\Author $author, public ?\ApiClients\Client\GitHub\Schema\SimpleCommit\Committer $committer)
    {
    }
}
