...
final readonly class TimelineCrossReferencedEvent implements \ApiClients\Client\GitHub\Contract\TimelineCrossReferencedEvent
{
    const SCHEMA_JSON = '{
     ...
     * actor: A GitHub user.
     */
    public function __construct(public string $event, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $actor, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public string $createdAt, #[\EventSauce\ObjectHydrator\MapFrom('updated_at')] public string $updatedAt, public \ApiClients\Client\GitHub\Schema\TimelineCrossReferencedEvent\Source $source)
    {
    }
}
