...
final readonly class RepositoryAdvisory implements \ApiClients\Client\GitHub\Contract\RepositoryAdvisory
{
    const SCHEMA_JSON = '{
    "required": [
        "ghsa_id",
     ...
     */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('ghsa_id')] public string $ghsaId, #[\EventSauce\ObjectHydrator\MapFrom('cve_id')] public ?string $cveId, public string $url, #[\EventSauce\ObjectHydrator\MapFrom('html_url')] public string $htmlUrl, public string $summary, public ?string $description, public ?string $severity, public \ApiClients\Client\GitHub\Schema\RepositoryAdvisory\Author $author, public \ApiClients\Client\GitHub\Schema\RepositoryAdvisory\Publisher $publisher, public array $identifiers, public string $state, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public ?string $createdAt, #[\EventSauce\ObjectHydrator\MapFrom('updated_at')] public ?string $updatedAt, #[\EventSauce\ObjectHydrator\MapFrom('published_at')] public ?string $publishedAt, #[\EventSauce\ObjectHydrator\MapFrom('closed_at')] public ?string $closedAt, #[\EventSauce\ObjectHydrator\MapFrom('withdrawn_at')] public ?string $withdrawnAt, public ?\ApiClients\Client\GitHub\Schema\RepositoryAdvisory\Submission $submission, public ?array $vulnerabilities, public ?\ApiClients\Client\GitHub\Schema\RepositoryAdvisory\Cvss $cvss, #[\EventSauce\ObjectHydrator\MapFrom('cvss_severities')] public ?\ApiClients\Client\GitHub\Schema\CvssSeverities $cvssSeverities, public ?array $cwes, #[\EventSauce\ObjectHydrator\MapFrom('cwe_ids')] public ?array $cweIds, public ?array $credits, #[\EventSauce\ObjectHydrator\MapFrom('credits_detailed')] public ?array $creditsDetailed, #[\EventSauce\ObjectHydrator\MapFrom('collaborating_users')] public ?array $collaboratingUsers, #[\EventSauce\ObjectHydrator\MapFrom('collaborating_teams')] public ?array $collaboratingTeams, #[\EventSauce\ObjectHydrator\MapFrom('private_fork')] public \ApiClients\Client\GitHub\Schema\RepositoryAdvisory\PrivateFork $privateFork)
    {
    }
}
