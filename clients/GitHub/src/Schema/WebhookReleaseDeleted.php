...
final readonly class WebhookReleaseDeleted implements \ApiClients\Client\GitHub\Contract\WebhookReleaseDeleted
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public WebhooksRelease $release, public RepositoryWebhooks $repository, public SimpleUser $sender)
    {
    }
}
