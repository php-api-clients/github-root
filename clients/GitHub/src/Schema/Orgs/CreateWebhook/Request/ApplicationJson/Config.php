...
final readonly class Config implements \ApiClients\Client\GitHub\Contract\Orgs\CreateWebhook\Request\ApplicationJson\Config
{
    const SCHEMA_JSON = '{
    "required": [
        "url"
     ...
     */
    public function __construct(public string $url, #[\EventSauce\ObjectHydrator\MapFrom('content_type')] public ?string $contentType, public ?string $secret, #[\EventSauce\ObjectHydrator\MapFrom('insecure_ssl')] public null|string|int|float $insecureSsl, public ?string $username, public ?string $password)
    {
    }
}
