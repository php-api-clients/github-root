...
final readonly class WebhookPullRequestReviewThreadUnresolved implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestReviewThreadUnresolved
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public string $action, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, #[\EventSauce\ObjectHydrator\MapFrom('pull_request')] public \ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewThreadUnresolved\PullRequest $pullRequest, public \ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $sender, public \ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewThreadUnresolved\Thread $thread)
    {
    }
}
