...
final readonly class WebhookProjectsV2StatusUpdateCreated implements \ApiClients\Client\GitHub\Contract\WebhookProjectsV2StatusUpdateCreated
{
    const SCHEMA_JSON = '{
    ...
    public const SCHEMA_TITLE = 'Projects v2 Status Update Created Event';
    ...
    */
    public function __construct(public string $action, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public \ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, #[\EventSauce\ObjectHydrator\MapFrom('projects_v2_status_update')] public \ApiClients\Client\GitHub\Schema\ProjectsV2StatusUpdate $projectsVTwoStatusUpdate, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
