...
final readonly class WebhookMergeGroupDestroyed implements \ApiClients\Client\GitHub\Contract\WebhookMergeGroupDestroyed
{
     ...
     */
    public function __construct(public string $action, public string|null $reason, public SimpleInstallation|null $installation, #[MapFrom('merge_group')]
    public MergeGroup $mergeGroup, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks|null $repository, public SimpleUser|null $sender,)
    {
    }
}
