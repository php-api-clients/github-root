...
final readonly class WebhookMergeGroupDestroyed implements \ApiClients\Client\GitHub\Contract\WebhookMergeGroupDestroyed
{
    const SCHEMA_JSON = '{
    "required": [
        "action",
    ...
    */
    public function __construct(public string $action, public ?string $reason, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, #[\EventSauce\ObjectHydrator\MapFrom('merge_group')] public \ApiClients\Client\GitHub\Schema\MergeGroup $mergeGroup, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public ?\ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
