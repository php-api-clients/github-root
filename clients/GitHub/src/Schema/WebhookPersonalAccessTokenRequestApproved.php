...
final readonly class WebhookPersonalAccessTokenRequestApproved implements \ApiClients\Client\GitHub\Contract\WebhookPersonalAccessTokenRequestApproved
{
    ...
    public PersonalAccessTokenRequest $personalAccessTokenRequest, public EnterpriseWebhooks|null $enterprise, public OrganizationSimpleWebhooks $organization, public SimpleUser $sender, public SimpleInstallation $installation,)
    {
    }
}
