...
namespace ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewEdited\PullRequest\Base;

final readonly class Repo implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestReviewEdited\PullRequest\Base\Repo
{
    const SCHEMA_JSON = '{
    "title": "Repository",
    "required": [
