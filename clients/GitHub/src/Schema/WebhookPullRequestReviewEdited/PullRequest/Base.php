...
final readonly class Base implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestReviewEdited\PullRequest\Base
{
     ...
     */
    public function __construct(public string $label, public string $ref, public \ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewEdited\PullRequest\Base\Repo $repo, public string $sha, public ?\ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewEdited\PullRequest\Base\User $user)
    {
    }
}
