...
use ApiClients\Client\GitHub\Internal\Attribute\CastUnionToType\Multiple\Schema\WebhookPullRequestReviewEdited\PullRequest\RequestedReviewers;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewEdited\PullRequest\Assignee;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewEdited\PullRequest\AutoMerge;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewEdited\PullRequest\Base;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewEdited\PullRequest\Head;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewEdited\PullRequest\Links;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewEdited\PullRequest\Milestone;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewEdited\PullRequest\RequestedReviewers\One;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewEdited\PullRequest\RequestedReviewers\Zero;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestReviewEdited\PullRequest\User;
