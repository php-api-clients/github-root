...
final readonly class WebhookWorkflowRunRequested implements \ApiClients\Client\GitHub\Contract\WebhookWorkflowRunRequested
{
    const SCHEMA_JSON = '{
