...
final readonly class Changes implements \ApiClients\Client\GitHub\Contract\WebhookIssuesTransferred\Changes
{
    ...
    /**
     * newIssue: The [issue](https://docs.github.com/rest/issues/issues#get-an-issue) itself.
     * newRepository: A git repository
     */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('new_issue')] public \ApiClients\Client\GitHub\Schema\WebhookIssuesTransferred\Changes\NewIssue $newIssue, #[\EventSauce\ObjectHydrator\MapFrom('new_repository')] public \ApiClients\Client\GitHub\Schema\WebhookIssuesTransferred\Changes\NewRepository $newRepository)
    {
    }
}
