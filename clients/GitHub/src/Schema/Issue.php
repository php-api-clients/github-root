...
final readonly class Issue implements \ApiClients\Client\GitHub\Contract\Issue
{
    const SCHEMA_JSON = '{
    "title": "Issue",
    "required": [
     ...
     * @param array<\ApiClients\Client\GitHub\Schema\Issue\Labels\One> $labels
     * repository: A repository on GitHub.
     * authorAssociation: How the author is associated with the repository.
     */
    public function __construct(public int $id, #[\EventSauce\ObjectHydrator\MapFrom('node_id')] public string $nodeId, public string $url, #[\EventSauce\ObjectHydrator\MapFrom('repository_url')] public string $repositoryUrl, #[\EventSauce\ObjectHydrator\MapFrom('labels_url')] public string $labelsUrl, #[\EventSauce\ObjectHydrator\MapFrom('comments_url')] public string $commentsUrl, #[\EventSauce\ObjectHydrator\MapFrom('events_url')] public string $eventsUrl, #[\EventSauce\ObjectHydrator\MapFrom('html_url')] public string $htmlUrl, public int $number, public string $state, #[\EventSauce\ObjectHydrator\MapFrom('state_reason')] public ?string $stateReason, public string $title, public ?string $body, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $user, #[\ApiClients\Client\GitHub\Internal\Attribute\CastUnionToType\Multiple\Schema\Issue\Labels] public array $labels, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $assignee, public ?array $assignees, public ?\ApiClients\Client\GitHub\Schema\Milestone $milestone, public bool $locked, #[\EventSauce\ObjectHydrator\MapFrom('active_lock_reason')] public ?string $activeLockReason, public int $comments, #[\EventSauce\ObjectHydrator\MapFrom('pull_request')] public ?\ApiClients\Client\GitHub\Schema\Issue\PullRequest $pullRequest, #[\EventSauce\ObjectHydrator\MapFrom('closed_at')] public ?string $closedAt, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public string $createdAt, #[\EventSauce\ObjectHydrator\MapFrom('updated_at')] public string $updatedAt, public ?bool $draft, #[\EventSauce\ObjectHydrator\MapFrom('closed_by')] public ?\ApiClients\Client\GitHub\Schema\SimpleUser $closedBy, #[\EventSauce\ObjectHydrator\MapFrom('body_html')] public ?string $bodyHtml, #[\EventSauce\ObjectHydrator\MapFrom('body_text')] public ?string $bodyText, #[\EventSauce\ObjectHydrator\MapFrom('timeline_url')] public ?string $timelineUrl, public ?\ApiClients\Client\GitHub\Schema\Repository $repository, #[\EventSauce\ObjectHydrator\MapFrom('performed_via_github_app')] public ?\ApiClients\Client\GitHub\Schema\Integration $performedViaGithubApp, #[\EventSauce\ObjectHydrator\MapFrom('author_association')] public string $authorAssociation, public ?\ApiClients\Client\GitHub\Schema\ReactionRollup $reactions, #[\EventSauce\ObjectHydrator\MapFrom('sub_issues_summary')] public ?\ApiClients\Client\GitHub\Schema\SubIssuesSummary $subIssuesSummary)
    {
    }
}
