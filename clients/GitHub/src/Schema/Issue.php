...
final readonly class Issue implements \ApiClients\Client\GitHub\Contract\Issue
{
    ...
    public string|null $stateReason, public string $title, public string|null $body, public SimpleUser|null $user, #[Labels]
    public array $labels, public SimpleUser|null $assignee, public array|null $assignees, public Milestone|null $milestone, public bool $locked, #[MapFrom('active_lock_reason')]
    public string|null $activeLockReason, public int $comments, #[MapFrom('pull_request')]
    public PullRequest|null $pullRequest, #[MapFrom('closed_at')]
    public string|null $closedAt, #[MapFrom('created_at')]
    public string $createdAt, #[MapFrom('updated_at')]
    public string $updatedAt, public bool|null $draft, #[MapFrom('closed_by')]
    public SimpleUser|null $closedBy, #[MapFrom('body_html')]
    public string|null $bodyHtml, #[MapFrom('body_text')]
    public string|null $bodyText, #[MapFrom('timeline_url')]
    public string|null $timelineUrl, public Repository|null $repository, #[MapFrom('performed_via_github_app')]
    public Integration|null $performedViaGithubApp, #[MapFrom('author_association')]
    public string $authorAssociation, public ReactionRollup|null $reactions, #[MapFrom('sub_issues_summary')]
    public SubIssuesSummary|null $subIssuesSummary,)
    {
    }
}
