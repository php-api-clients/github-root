...
final readonly class WebhookReleaseReleased implements \ApiClients\Client\GitHub\Contract\WebhookReleaseReleased
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public WebhooksRelease $release, public RepositoryWebhooks $repository, public SimpleUser|null $sender)
    {
    }
}
