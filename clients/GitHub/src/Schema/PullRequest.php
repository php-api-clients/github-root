...
final readonly class PullRequest implements \ApiClients\Client\GitHub\Contract\PullRequest
{
    const SCHEMA_JSON = '{
    "title": "Pull Request",
    "required": [
