...
final readonly class WebhookIssuesUnlabeled implements \ApiClients\Client\GitHub\Contract\WebhookIssuesUnlabeled
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public WebhooksIssue $issue, public WebhooksLabel|null $label, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser $sender)
    {
    }
}
