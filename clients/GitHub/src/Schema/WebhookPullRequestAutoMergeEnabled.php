...
use ApiClients\Client\GitHub\Schema\WebhookPullRequestAutoMergeEnabled\PullRequest;
...
final readonly class WebhookPullRequestAutoMergeEnabled implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestAutoMergeEnabled
{
    ...
    public PullRequest $pullRequest, public string|null $reason, public RepositoryWebhooks $repository, public SimpleUser $sender,)
    {
    }
}
