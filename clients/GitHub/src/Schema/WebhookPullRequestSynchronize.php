...
use ApiClients\Client\GitHub\Schema\WebhookPullRequestSynchronize\PullRequest;
...
final readonly class WebhookPullRequestSynchronize implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestSynchronize
{
     ...
     */
    public function __construct(public string $action, public string $after, public string $before, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public int $number, public OrganizationSimpleWebhooks|null $organization, #[MapFrom('pull_request')]
