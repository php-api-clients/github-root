...
final readonly class WebhookTeamAdd implements \ApiClients\Client\GitHub\Contract\WebhookTeamAdd
{
     ...
     */
    public function __construct(public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser $sender, public WebhooksTeam1 $team)
    {
    }
}
