...
final readonly class WebhookLabelCreated implements \ApiClients\Client\GitHub\Contract\WebhookLabelCreated
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public WebhooksLabel $label, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser|null $sender)
    {
    }
}
