...
final readonly class WebhookOrganizationDeleted implements \ApiClients\Client\GitHub\Contract\WebhookOrganizationDeleted
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public WebhooksMembership|null $membership, public OrganizationSimpleWebhooks $organization, public RepositoryWebhooks|null $repository, public SimpleUser $sender)
    {
    }
}
