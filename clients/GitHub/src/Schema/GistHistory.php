...
final readonly class GistHistory implements \ApiClients\Client\GitHub\Contract\GistHistory
{
    ...
    public function __construct(public SimpleUser|null $user, public string|null $version, #[MapFrom('committed_at')]
    public string|null $committedAt, #[MapFrom('change_status')]
    public ChangeStatus|null $changeStatus, public string|null $url,)
    {
    }
}
