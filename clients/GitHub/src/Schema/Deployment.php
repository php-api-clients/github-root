...
final readonly class Deployment implements \ApiClients\Client\GitHub\Contract\Deployment
{
    ...
    public Zero|string $payload, #[MapFrom('original_environment')]
    public string|null $originalEnvironment, public string $environment, public string|null $description, public SimpleUser|null $creator, #[MapFrom('created_at')]
