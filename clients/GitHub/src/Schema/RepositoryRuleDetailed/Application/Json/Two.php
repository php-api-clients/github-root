...
final readonly class Two implements \ApiClients\Client\GitHub\Contract\RepositoryRuleDeletion, \ApiClients\Client\GitHub\Contract\RepositoryRuleRulesetInfo
{
    const SCHEMA_JSON = '{
    "allOf": [
        {
