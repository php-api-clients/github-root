...
final readonly class Eleven implements \ApiClients\Client\GitHub\Contract\RepositoryRuleCommitAuthorEmailPattern, \ApiClients\Client\GitHub\Contract\RepositoryRuleRulesetInfo
{
    const SCHEMA_JSON = '{
    "allOf": [
        {
     ...
     */
    public function __construct(public string $type, public ?\ApiClients\Client\GitHub\Schema\RepositoryRuleDetailed\Application\Json\Eleven\Parameters $parameters, #[\EventSauce\ObjectHydrator\MapFrom('ruleset_source_type')] public ?string $rulesetSourceType, #[\EventSauce\ObjectHydrator\MapFrom('ruleset_source')] public ?string $rulesetSource, #[\EventSauce\ObjectHydrator\MapFrom('ruleset_id')] public ?int $rulesetId)
    {
    }
}
