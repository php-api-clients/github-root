...
final readonly class Five implements \ApiClients\Client\GitHub\Contract\RepositoryRuleRequiredDeployments, \ApiClients\Client\GitHub\Contract\RepositoryRuleRulesetInfo
{
    const SCHEMA_JSON = '{
    "allOf": [
        {
