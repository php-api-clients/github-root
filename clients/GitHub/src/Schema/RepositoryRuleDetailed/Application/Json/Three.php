...
final readonly class Three implements \ApiClients\Client\GitHub\Contract\RepositoryRuleRequiredLinearHistory, \ApiClients\Client\GitHub\Contract\RepositoryRuleRulesetInfo
{
    const SCHEMA_JSON = '{
    "allOf": [
        {
