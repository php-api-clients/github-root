...
final readonly class Fifteen implements \ApiClients\Client\GitHub\Contract\RepositoryRuleWorkflows, \ApiClients\Client\GitHub\Contract\RepositoryRuleRulesetInfo
{
    const SCHEMA_JSON = '{
    "allOf": [
        {
