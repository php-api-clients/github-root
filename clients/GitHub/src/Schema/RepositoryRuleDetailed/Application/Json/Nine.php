...
final readonly class Nine implements \ApiClients\Client\GitHub\Contract\RepositoryRuleNonFastForward, \ApiClients\Client\GitHub\Contract\RepositoryRuleRulesetInfo
{
    const SCHEMA_JSON = '{
    "allOf": [
        {
