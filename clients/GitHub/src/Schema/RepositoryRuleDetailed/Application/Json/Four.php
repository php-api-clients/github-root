...
final readonly class Four implements \ApiClients\Client\GitHub\Contract\RepositoryRuleMergeQueue, \ApiClients\Client\GitHub\Contract\RepositoryRuleRulesetInfo
{
    const SCHEMA_JSON = '{
    "allOf": [
        {
