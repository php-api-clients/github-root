...
final readonly class CodeSearchResultItem implements \ApiClients\Client\GitHub\Contract\CodeSearchResultItem
{
    const SCHEMA_JSON = '{
     ...
     */
    public function __construct(public string $name, public string $path, public string $sha, public string $url, #[\EventSauce\ObjectHydrator\MapFrom('git_url')] public string $gitUrl, #[\EventSauce\ObjectHydrator\MapFrom('html_url')] public string $htmlUrl, public \ApiClients\Client\GitHub\Schema\MinimalRepository $repository, public int|float $score, #[\EventSauce\ObjectHydrator\MapFrom('file_size')] public ?int $fileSize, public ?string $language, #[\EventSauce\ObjectHydrator\MapFrom('last_modified_at')] public ?string $lastModifiedAt, #[\EventSauce\ObjectHydrator\MapFrom('line_numbers')] public ?array $lineNumbers, #[\EventSauce\ObjectHydrator\MapFrom('text_matches')] public ?array $textMatches)
    {
    }
}
