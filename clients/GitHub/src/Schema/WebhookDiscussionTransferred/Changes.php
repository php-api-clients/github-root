...
namespace ApiClients\Client\GitHub\Schema\WebhookDiscussionTransferred;

final readonly class Changes implements \ApiClients\Client\GitHub\Contract\WebhookDiscussionTransferred\Changes
{
    const SCHEMA_JSON = '{
    "required": [
        "new_discussion",
    ...
    * newRepository: The repository on GitHub where the event occurred. Webhook payloads contain the `repository` property
    when the event occurs from activity in a repository.
    */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('new_discussion')] public \ApiClients\Client\GitHub\Schema\Discussion $newDiscussion, #[\EventSauce\ObjectHydrator\MapFrom('new_repository')] public \ApiClients\Client\GitHub\Schema\RepositoryWebhooks $newRepository)
    {
    }
}
