...
final readonly class Reaction implements \ApiClients\Client\GitHub\Contract\Reaction
{
     ...
     */
    public function __construct(public int $id, #[\EventSauce\ObjectHydrator\MapFrom('node_id')] public string $nodeId, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $user, public string $content, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public string $createdAt)
    {
    }
}
