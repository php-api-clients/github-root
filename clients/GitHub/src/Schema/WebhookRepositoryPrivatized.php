...
final readonly class WebhookRepositoryPrivatized implements \ApiClients\Client\GitHub\Contract\WebhookRepositoryPrivatized
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser $sender)
    {
    }
}
