...
final readonly class WebhookProjectColumnEdited implements \ApiClients\Client\GitHub\Contract\WebhookProjectColumnEdited
{
     ...
     */
    public function __construct(public string $action, public Changes $changes, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, #[MapFrom('project_column')]
    public WebhooksProjectColumn $projectColumn, public RepositoryWebhooks|null $repository, public SimpleUser|null $sender,)
    {
    }
}
