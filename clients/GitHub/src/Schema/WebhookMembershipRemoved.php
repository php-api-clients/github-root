...
final readonly class WebhookMembershipRemoved implements \ApiClients\Client\GitHub\Contract\WebhookMembershipRemoved
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public string $action, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\WebhooksUser $member, public \ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public ?\ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public string $scope, public ?\ApiClients\Client\GitHub\Schema\WebhookMembershipRemoved\Sender $sender, public \ApiClients\Client\GitHub\Schema\WebhooksTeam $team)
    {
    }
}
