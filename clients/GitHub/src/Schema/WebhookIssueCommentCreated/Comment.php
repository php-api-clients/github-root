...
namespace ApiClients\Client\GitHub\Schema\WebhookIssueCommentCreated;

final readonly class Comment implements \ApiClients\Client\GitHub\Contract\WebhookIssueCommentCreated\Comment
{
    const SCHEMA_JSON = '{
    "title": "issue comment",
    "required": [
    ...
    public const SCHEMA_DESCRIPTION = 'The [comment](https://docs.github.com/rest/issues/comments#get-an-issue-comment) itself.';
