...
final readonly class WebhookIssuesLabeled implements \ApiClients\Client\GitHub\Contract\WebhookIssuesLabeled
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public Issue $issue, public WebhooksLabel|null $label, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser $sender)
    {
    }
}
