...
You can check which security and analysis features are currently enabled by using a `GET /repos/{owner}/{repo}` request.';
     ...
     */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('advanced_security')] public ?\ApiClients\Client\GitHub\Schema\Repos\Update\Request\ApplicationJson\SecurityAndAnalysis\AdvancedSecurity $advancedSecurity, #[\EventSauce\ObjectHydrator\MapFrom('secret_scanning')] public ?\ApiClients\Client\GitHub\Schema\Repos\Update\Request\ApplicationJson\SecurityAndAnalysis\SecretScanning $secretScanning, #[\EventSauce\ObjectHydrator\MapFrom('secret_scanning_push_protection')] public ?\ApiClients\Client\GitHub\Schema\Repos\Update\Request\ApplicationJson\SecurityAndAnalysis\SecretScanningPushProtection $secretScanningPushProtection, #[\EventSauce\ObjectHydrator\MapFrom('secret_scanning_ai_detection')] public ?\ApiClients\Client\GitHub\Schema\Repos\Update\Request\ApplicationJson\SecurityAndAnalysis\SecretScanningAiDetection $secretScanningAiDetection, #[\EventSauce\ObjectHydrator\MapFrom('secret_scanning_non_provider_patterns')] public ?\ApiClients\Client\GitHub\Schema\Repos\Update\Request\ApplicationJson\SecurityAndAnalysis\SecretScanningNonProviderPatterns $secretScanningNonProviderPatterns)
    {
    }
}
