...
final readonly class ApplicationJson implements \ApiClients\Client\GitHub\Contract\Repos\CreatePagesDeployment\Request\ApplicationJson
{
     ...
     */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('artifact_id')] public null|int|float $artifactId, #[\EventSauce\ObjectHydrator\MapFrom('artifact_url')] public ?string $artifactUrl, public ?string $environment, #[\EventSauce\ObjectHydrator\MapFrom('pages_build_version')] public string $pagesBuildVersion, #[\EventSauce\ObjectHydrator\MapFrom('oidc_token')] public string $oidcToken)
    {
    }
}
