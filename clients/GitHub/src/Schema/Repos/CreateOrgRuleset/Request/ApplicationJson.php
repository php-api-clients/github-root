...
final readonly class ApplicationJson implements \ApiClients\Client\GitHub\Contract\Repos\CreateOrgRuleset\Request\ApplicationJson
{
    const SCHEMA_JSON = '{
    "required": [
        "name",
    ...
    */
    public function __construct(public string $name, public ?string $target, public string $enforcement, #[\EventSauce\ObjectHydrator\MapFrom('bypass_actors')] public ?array $bypassActors, #[\ApiClients\Client\GitHub\Internal\Attribute\CastUnionToType\Single\Schema\Repos\CreateOrgRuleset\Request\ApplicationJson\Conditions] public null|\ApiClients\Client\GitHub\Schema\RepositoryRuleset\Conditions\One\Zero|\ApiClients\Client\GitHub\Schema\RepositoryRuleset\Conditions\One\One|\ApiClients\Client\GitHub\Schema\RepositoryRuleset\Conditions\One\Two $conditions, #[\ApiClients\Client\GitHub\Internal\Attribute\CastUnionToType\Multiple\Schema\Repos\CreateOrgRuleset\Request\ApplicationJson\Rules] public ?array $rules)
    {
    }
}
