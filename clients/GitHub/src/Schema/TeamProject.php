...
final readonly class TeamProject implements \ApiClients\Client\GitHub\Contract\TeamProject
{
    ...
    public string $nodeId, public string $name, public string|null $body, public int $number, public string $state, public SimpleUser $creator, #[MapFrom('created_at')]
    public string $createdAt, #[MapFrom('updated_at')]
    public string $updatedAt, #[MapFrom('organization_permission')]
    public string|null $organizationPermission, public bool|null $private, public Permissions $permissions,)
    {
    }
}
