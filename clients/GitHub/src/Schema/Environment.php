...
final readonly class Environment implements \ApiClients\Client\GitHub\Contract\Environment
{
     ...
     * @param ?array<\ApiClients\Client\GitHub\Schema\Environment\ProtectionRules\Zero|\ApiClients\Client\GitHub\Schema\Environment\ProtectionRules\One|\ApiClients\Client\GitHub\Schema\Environment\ProtectionRules\Two> $protectionRules
     ...
     */
    public function __construct(public int $id, #[\EventSauce\ObjectHydrator\MapFrom('node_id')] public string $nodeId, public string $name, public string $url, #[\EventSauce\ObjectHydrator\MapFrom('html_url')] public string $htmlUrl, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public string $createdAt, #[\EventSauce\ObjectHydrator\MapFrom('updated_at')] public string $updatedAt, #[\EventSauce\ObjectHydrator\MapFrom('protection_rules')] #[\ApiClients\Client\GitHub\Internal\Attribute\CastUnionToType\Multiple\Schema\Environment\ProtectionRules] public ?array $protectionRules, #[\EventSauce\ObjectHydrator\MapFrom('deployment_branch_policy')] public ?\ApiClients\Client\GitHub\Schema\DeploymentBranchPolicySettings $deploymentBranchPolicy)
    {
    }
}
