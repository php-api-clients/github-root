...
final readonly class UnassignedIssueEvent implements \ApiClients\Client\GitHub\Contract\UnassignedIssueEvent
{
    ...
    public Integration|null $performedViaGithubApp, public SimpleUser $assignee, public SimpleUser $assigner,)
    {
    }
}
