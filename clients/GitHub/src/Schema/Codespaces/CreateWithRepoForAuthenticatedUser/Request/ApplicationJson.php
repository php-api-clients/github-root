...
final readonly class ApplicationJson implements \ApiClients\Client\GitHub\Contract\Codespaces\CreateWithRepoForAuthenticatedUser\Request\ApplicationJson
{
    const SCHEMA_JSON = '{
    "type": [
        "object",
