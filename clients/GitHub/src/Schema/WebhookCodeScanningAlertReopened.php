...
final readonly class WebhookCodeScanningAlertReopened implements \ApiClients\Client\GitHub\Contract\WebhookCodeScanningAlertReopened
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public string $action, public ?\ApiClients\Client\GitHub\Schema\WebhookCodeScanningAlertReopened\Alert $alert, #[\EventSauce\ObjectHydrator\MapFrom('commit_oid')] public ?string $commitOid, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public ?string $ref, public \ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
