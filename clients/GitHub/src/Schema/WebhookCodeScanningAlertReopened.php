...
final readonly class WebhookCodeScanningAlertReopened implements \ApiClients\Client\GitHub\Contract\WebhookCodeScanningAlertReopened
{
     ...
     */
    public function __construct(public string $action, public Alert|null $alert, #[MapFrom('commit_oid')]
    public string|null $commitOid, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public string|null $ref, public RepositoryWebhooks $repository, public SimpleUser $sender,)
    {
    }
}
