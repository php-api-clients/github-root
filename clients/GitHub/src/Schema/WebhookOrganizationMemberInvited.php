...
use ApiClients\Client\GitHub\Schema\WebhookOrganizationMemberInvited\Invitation;
...
final readonly class WebhookOrganizationMemberInvited implements \ApiClients\Client\GitHub\Contract\WebhookOrganizationMemberInvited
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public Invitation $invitation, public OrganizationSimpleWebhooks $organization, public RepositoryWebhooks|null $repository, public SimpleUser $sender, public WebhooksUser|null $user)
    {
    }
}
