...
final readonly class WebhookSecretScanningAlertLocationCreated implements \ApiClients\Client\GitHub\Contract\WebhookSecretScanningAlertLocationCreated
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public ?string $action, public \ApiClients\Client\GitHub\Schema\SecretScanningAlertWebhook $alert, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public \ApiClients\Client\GitHub\Schema\SecretScanningLocation $location, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public \ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
