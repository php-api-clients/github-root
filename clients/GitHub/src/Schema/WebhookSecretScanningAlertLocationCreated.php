...
final readonly class WebhookSecretScanningAlertLocationCreated implements \ApiClients\Client\GitHub\Contract\WebhookSecretScanningAlertLocationCreated
{
     ...
     */
    public function __construct(public string|null $action, public SecretScanningAlertWebhook $alert, public SimpleInstallation|null $installation, public SecretScanningLocation $location, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser $sender)
    {
    }
}
