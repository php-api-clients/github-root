...
final readonly class WebhookInstallationCreated implements \ApiClients\Client\GitHub\Contract\WebhookInstallationCreated
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public Installation $installation, public OrganizationSimpleWebhooks|null $organization, public array|null $repositories, public RepositoryWebhooks|null $repository, public WebhooksUser|null $requester, public SimpleUser $sender)
    {
    }
}
