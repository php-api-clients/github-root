...
final readonly class WebhookInstallationCreated implements \ApiClients\Client\GitHub\Contract\WebhookInstallationCreated
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public string $action, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public \ApiClients\Client\GitHub\Schema\Installation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public ?array $repositories, public ?\ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public ?\ApiClients\Client\GitHub\Schema\WebhooksUser $requester, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
