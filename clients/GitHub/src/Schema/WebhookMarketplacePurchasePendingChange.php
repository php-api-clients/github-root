...
use ApiClients\Client\GitHub\Schema\WebhookMarketplacePurchasePendingChange\PreviousMarketplacePurchase;
...
final readonly class WebhookMarketplacePurchasePendingChange implements \ApiClients\Client\GitHub\Contract\WebhookMarketplacePurchasePendingChange
{
    ...
    public string $effectiveDate, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, #[MapFrom('marketplace_purchase')]
    public WebhooksMarketplacePurchase $marketplacePurchase, public OrganizationSimpleWebhooks|null $organization, #[MapFrom('previous_marketplace_purchase')]
    public PreviousMarketplacePurchase|null $previousMarketplacePurchase, public RepositoryWebhooks|null $repository, public SimpleUser $sender,)
    {
    }
}
