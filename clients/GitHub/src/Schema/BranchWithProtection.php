...
final readonly class BranchWithProtection implements \ApiClients\Client\GitHub\Contract\BranchWithProtection
{
     ...
     */
    public function __construct(public string $name, public \ApiClients\Client\GitHub\Schema\Commit $commit, #[\EventSauce\ObjectHydrator\MapFrom('_links')] public \ApiClients\Client\GitHub\Schema\BranchWithProtection\Links $links, public bool $protected, public \ApiClients\Client\GitHub\Schema\BranchProtection $protection, #[\EventSauce\ObjectHydrator\MapFrom('protection_url')] public string $protectionUrl, public ?string $pattern, #[\EventSauce\ObjectHydrator\MapFrom('required_approving_review_count')] public ?int $requiredApprovingReviewCount)
    {
    }
}
