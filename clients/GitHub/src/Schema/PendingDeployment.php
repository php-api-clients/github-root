...
final readonly class PendingDeployment implements \ApiClients\Client\GitHub\Contract\PendingDeployment
{
     ...
     */
    public function __construct(public \ApiClients\Client\GitHub\Schema\PendingDeployment\Environment $environment, #[\EventSauce\ObjectHydrator\MapFrom('wait_timer')] public int $waitTimer, #[\EventSauce\ObjectHydrator\MapFrom('wait_timer_started_at')] public ?string $waitTimerStartedAt, #[\EventSauce\ObjectHydrator\MapFrom('current_user_can_approve')] public bool $currentUserCanApprove, public array $reviewers)
    {
    }
}
