...
final readonly class MarketplacePurchase implements \ApiClients\Client\GitHub\Contract\MarketplacePurchase
{
    ...
    public function __construct(public string $url, public string $type, public int $id, public string $login, #[\EventSauce\ObjectHydrator\MapFrom('organization_billing_email')] public ?string $organizationBillingEmail, public ?string $email, #[\EventSauce\ObjectHydrator\MapFrom('marketplace_pending_change')] public ?\ApiClients\Client\GitHub\Schema\MarketplacePurchase\MarketplacePendingChange $marketplacePendingChange, #[\EventSauce\ObjectHydrator\MapFrom('marketplace_purchase')] public \ApiClients\Client\GitHub\Schema\MarketplacePurchase\MarketplacePurchase $marketplacePurchase)
    {
    }
}
