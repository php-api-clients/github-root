...
final readonly class WebhookDeploymentStatusCreated implements \ApiClients\Client\GitHub\Contract\WebhookDeploymentStatusCreated
{
    ...
    public CheckRun|null $checkRun, public Deployment $deployment, #[MapFrom('deployment_status')]
    public DeploymentStatus $deploymentStatus, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser $sender, public WebhooksWorkflow|null $workflow, #[MapFrom('workflow_run')]
