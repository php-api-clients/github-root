...
final readonly class WebhookDeploymentStatusCreated implements \ApiClients\Client\GitHub\Contract\WebhookDeploymentStatusCreated
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public string $action, #[\EventSauce\ObjectHydrator\MapFrom('check_run')] public ?\ApiClients\Client\GitHub\Schema\WebhookDeploymentStatusCreated\CheckRun $checkRun, public \ApiClients\Client\GitHub\Schema\WebhookDeploymentStatusCreated\Deployment $deployment, #[\EventSauce\ObjectHydrator\MapFrom('deployment_status')] public \ApiClients\Client\GitHub\Schema\WebhookDeploymentStatusCreated\DeploymentStatus $deploymentStatus, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public \ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender, public ?\ApiClients\Client\GitHub\Schema\WebhooksWorkflow $workflow, #[\EventSauce\ObjectHydrator\MapFrom('workflow_run')] public ?\ApiClients\Client\GitHub\Schema\WebhookDeploymentStatusCreated\WorkflowRun $workflowRun)
    {
    }
}
