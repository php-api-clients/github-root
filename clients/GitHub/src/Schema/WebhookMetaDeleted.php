...
final readonly class WebhookMetaDeleted implements \ApiClients\Client\GitHub\Contract\WebhookMetaDeleted
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public string $action, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public \ApiClients\Client\GitHub\Schema\WebhookMetaDeleted\Hook $hook, #[\EventSauce\ObjectHydrator\MapFrom('hook_id')] public int $hookId, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public ?\ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
