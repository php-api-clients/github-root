...
use ApiClients\Client\GitHub\Schema\WebhookMetaDeleted\Hook;
...
final readonly class WebhookMetaDeleted implements \ApiClients\Client\GitHub\Contract\WebhookMetaDeleted
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public Hook $hook, #[MapFrom('hook_id')]
    public int $hookId, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks|null $repository, public SimpleUser|null $sender,)
    {
    }
}
