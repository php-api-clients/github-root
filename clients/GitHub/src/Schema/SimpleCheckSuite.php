...
final readonly class SimpleCheckSuite implements \ApiClients\Client\GitHub\Contract\SimpleCheckSuite
{
    const SCHEMA_JSON = '{
    "type": "object",
    "properties": {
     ...
     */
    public function __construct(public ?string $after, public ?\ApiClients\Client\GitHub\Schema\Integration $app, public ?string $before, public ?string $conclusion, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public ?string $createdAt, #[\EventSauce\ObjectHydrator\MapFrom('head_branch')] public ?string $headBranch, #[\EventSauce\ObjectHydrator\MapFrom('head_sha')] public ?string $headSha, public ?int $id, #[\EventSauce\ObjectHydrator\MapFrom('node_id')] public ?string $nodeId, #[\EventSauce\ObjectHydrator\MapFrom('pull_requests')] public ?array $pullRequests, public ?\ApiClients\Client\GitHub\Schema\MinimalRepository $repository, public ?string $status, #[\EventSauce\ObjectHydrator\MapFrom('updated_at')] public ?string $updatedAt, public ?string $url)
    {
    }
}
