...
final readonly class SimpleCheckSuite implements \ApiClients\Client\GitHub\Contract\SimpleCheckSuite
{
     ...
     */
    public function __construct(public string|null $after, public Integration|null $app, public string|null $before, public string|null $conclusion, #[MapFrom('created_at')]
    ...
    public array|null $pullRequests, public MinimalRepository|null $repository, public string|null $status, #[MapFrom('updated_at')]
