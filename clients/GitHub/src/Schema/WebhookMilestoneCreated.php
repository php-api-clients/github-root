...
final readonly class WebhookMilestoneCreated implements \ApiClients\Client\GitHub\Contract\WebhookMilestoneCreated
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public WebhooksMilestone3 $milestone, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser $sender)
    {
    }
}
