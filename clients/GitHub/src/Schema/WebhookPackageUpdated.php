...
final readonly class WebhookPackageUpdated implements \ApiClients\Client\GitHub\Contract\WebhookPackageUpdated
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public Package $package, public RepositoryWebhooks $repository, public SimpleUser $sender)
    {
    }
}
