...
final readonly class Forkee implements \ApiClients\Client\GitHub\Contract\WebhookFork\Forkee\Repository, \ApiClients\Client\GitHub\Contract\WebhookFork\Forkee
{
    const SCHEMA_JSON = '{
    "allOf": [
        {
