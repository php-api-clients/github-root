...
final readonly class WebhookProjectColumnMoved implements \ApiClients\Client\GitHub\Contract\WebhookProjectColumnMoved
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, #[MapFrom('project_column')]
    public WebhooksProjectColumn $projectColumn, public RepositoryWebhooks|null $repository, public SimpleUser $sender,)
    {
    }
}
