...
final readonly class WebhookCustomPropertyDeleted implements \ApiClients\Client\GitHub\Contract\WebhookCustomPropertyDeleted
{
     ...
     */
    public function __construct(public string $action, public Definition $definition, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public SimpleUser|null $sender)
    {
    }
}
