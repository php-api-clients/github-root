...
final readonly class WebhookCustomPropertyDeleted implements \ApiClients\Client\GitHub\Contract\WebhookCustomPropertyDeleted
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public string $action, public \ApiClients\Client\GitHub\Schema\WebhookCustomPropertyDeleted\Definition $definition, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
