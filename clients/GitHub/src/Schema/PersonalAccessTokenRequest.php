...
final readonly class PersonalAccessTokenRequest implements \ApiClients\Client\GitHub\Contract\PersonalAccessTokenRequest
{
    const SCHEMA_JSON = '{
     ...
     */
    public function __construct(public int $id, public \ApiClients\Client\GitHub\Schema\SimpleUser $owner, #[\EventSauce\ObjectHydrator\MapFrom('permissions_added')] public \ApiClients\Client\GitHub\Schema\PersonalAccessTokenRequest\PermissionsAdded $permissionsAdded, #[\EventSauce\ObjectHydrator\MapFrom('permissions_upgraded')] public \ApiClients\Client\GitHub\Schema\PersonalAccessTokenRequest\PermissionsUpgraded $permissionsUpgraded, #[\EventSauce\ObjectHydrator\MapFrom('permissions_result')] public \ApiClients\Client\GitHub\Schema\PersonalAccessTokenRequest\PermissionsResult $permissionsResult, #[\EventSauce\ObjectHydrator\MapFrom('repository_selection')] public string $repositorySelection, #[\EventSauce\ObjectHydrator\MapFrom('repository_count')] public ?int $repositoryCount, public ?array $repositories, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public string $createdAt, #[\EventSauce\ObjectHydrator\MapFrom('token_id')] public int $tokenId, #[\EventSauce\ObjectHydrator\MapFrom('token_name')] public string $tokenName, #[\EventSauce\ObjectHydrator\MapFrom('token_expired')] public bool $tokenExpired, #[\EventSauce\ObjectHydrator\MapFrom('token_expires_at')] public ?string $tokenExpiresAt, #[\EventSauce\ObjectHydrator\MapFrom('token_last_used_at')] public ?string $tokenLastUsedAt)
    {
    }
}
