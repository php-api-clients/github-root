...
namespace ApiClients\Client\GitHub\Schema\WebhookPullRequestUnlabeled\PullRequest;

final readonly class Head implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestUnlabeled\PullRequest\Head
{
    const SCHEMA_JSON = '{
    "required": [
        "label",
     ...
     */
    public function __construct(public ?string $label, public string $ref, public ?\ApiClients\Client\GitHub\Schema\WebhookPullRequestUnlabeled\PullRequest\Head\Repo $repo, public string $sha, public ?\ApiClients\Client\GitHub\Schema\WebhookPullRequestUnlabeled\PullRequest\Head\User $user)
    {
    }
}
