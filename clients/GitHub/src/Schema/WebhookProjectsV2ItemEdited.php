...
final readonly class WebhookProjectsV2ItemEdited implements \ApiClients\Client\GitHub\Contract\WebhookProjectsV2ItemEdited
{
    const SCHEMA_JSON = '{
    ...
    public const SCHEMA_TITLE = 'Projects v2 Item Edited Event';
    ...
    */
    public function __construct(public string $action, #[\ApiClients\Client\GitHub\Internal\Attribute\CastUnionToType\Single\Schema\WebhookProjectsV2ItemEdited\Changes] public null|\ApiClients\Client\GitHub\Schema\WebhookProjectsV2ItemEdited\Changes\Zero|\ApiClients\Client\GitHub\Schema\WebhookProjectsV2ItemEdited\Changes\One $changes, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public \ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, #[\EventSauce\ObjectHydrator\MapFrom('projects_v2_item')] public \ApiClients\Client\GitHub\Schema\ProjectsV2Item $projectsVTwoItem, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
