...
final readonly class WebhookIssuesUnassigned implements \ApiClients\Client\GitHub\Contract\WebhookIssuesUnassigned
{
     ...
     */
    public function __construct(public string $action, public WebhooksUserMannequin|null $assignee, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public WebhooksIssue $issue, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser $sender)
    {
    }
}
