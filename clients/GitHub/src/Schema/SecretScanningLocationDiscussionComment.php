...
final readonly class SecretScanningLocationDiscussionComment implements \ApiClients\Client\GitHub\Contract\SecretScanningLocationDiscussionComment
{
    const SCHEMA_JSON = '{
    "required": [
    ...
    "discussion_comment_url": "https:\\/\\/example.com\\/"
}';
    /**
     * discussionCommentUrl: The API URL to get the discussion comment where the secret was detected.
     */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('discussion_comment_url')] public string $discussionCommentUrl)
    {
    }
}
