...
namespace ApiClients\Client\GitHub\Schema\WebhookIssuesDeleted;

final readonly class Issue implements \ApiClients\Client\GitHub\Contract\WebhookIssuesDeleted\Issue
{
    const SCHEMA_JSON = '{
    "title": "Issue",
    "required": [
     ...
     */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('active_lock_reason')] public ?string $activeLockReason, public ?\ApiClients\Client\GitHub\Schema\WebhookIssuesDeleted\Issue\Assignee $assignee, public array $assignees, #[\EventSauce\ObjectHydrator\MapFrom('author_association')] public string $authorAssociation, public ?string $body, #[\EventSauce\ObjectHydrator\MapFrom('closed_at')] public ?string $closedAt, public int $comments, #[\EventSauce\ObjectHydrator\MapFrom('comments_url')] public string $commentsUrl, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public string $createdAt, public ?bool $draft, #[\EventSauce\ObjectHydrator\MapFrom('events_url')] public string $eventsUrl, #[\EventSauce\ObjectHydrator\MapFrom('html_url')] public string $htmlUrl, public int $id, public ?array $labels, #[\EventSauce\ObjectHydrator\MapFrom('labels_url')] public string $labelsUrl, public ?bool $locked, public ?\ApiClients\Client\GitHub\Schema\WebhookIssuesDeleted\Issue\Milestone $milestone, #[\EventSauce\ObjectHydrator\MapFrom('node_id')] public string $nodeId, public int $number, #[\EventSauce\ObjectHydrator\MapFrom('performed_via_github_app')] public ?\ApiClients\Client\GitHub\Schema\WebhookIssuesDeleted\Issue\PerformedViaGithubApp $performedViaGithubApp, #[\EventSauce\ObjectHydrator\MapFrom('pull_request')] public ?\ApiClients\Client\GitHub\Schema\WebhookIssuesDeleted\Issue\PullRequest $pullRequest, public \ApiClients\Client\GitHub\Schema\WebhookIssuesDeleted\Issue\Reactions $reactions, #[\EventSauce\ObjectHydrator\MapFrom('repository_url')] public string $repositoryUrl, #[\EventSauce\ObjectHydrator\MapFrom('sub_issues_summary')] public ?\ApiClients\Client\GitHub\Schema\WebhookIssuesDeleted\Issue\SubIssuesSummary $subIssuesSummary, public ?string $state, #[\EventSauce\ObjectHydrator\MapFrom('state_reason')] public ?string $stateReason, #[\EventSauce\ObjectHydrator\MapFrom('timeline_url')] public ?string $timelineUrl, public string $title, #[\EventSauce\ObjectHydrator\MapFrom('updated_at')] public string $updatedAt, public string $url, public ?\ApiClients\Client\GitHub\Schema\WebhookIssuesDeleted\Issue\User $user)
    {
    }
}
