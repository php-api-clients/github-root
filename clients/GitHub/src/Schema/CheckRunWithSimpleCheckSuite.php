...
final readonly class CheckRunWithSimpleCheckSuite implements \ApiClients\Client\GitHub\Contract\CheckRunWithSimpleCheckSuite
{
     ...
     */
    public function __construct(public Integration|null $app, #[MapFrom('check_suite')]
    public SimpleCheckSuite $checkSuite, #[MapFrom('completed_at')]
    public string|null $completedAt, public string|null $conclusion, public DeploymentSimple|null $deployment, #[MapFrom('details_url')]
    ...
    public string $nodeId, public Output $output, #[MapFrom('pull_requests')]
