...
final readonly class CheckRunWithSimpleCheckSuite implements \ApiClients\Client\GitHub\Contract\CheckRunWithSimpleCheckSuite
{
    const SCHEMA_JSON = '{
    "title": "CheckRun",
    "required": [
     ...
     */
    public function __construct(public ?\ApiClients\Client\GitHub\Schema\Integration $app, #[\EventSauce\ObjectHydrator\MapFrom('check_suite')] public \ApiClients\Client\GitHub\Schema\SimpleCheckSuite $checkSuite, #[\EventSauce\ObjectHydrator\MapFrom('completed_at')] public ?string $completedAt, public ?string $conclusion, public ?\ApiClients\Client\GitHub\Schema\DeploymentSimple $deployment, #[\EventSauce\ObjectHydrator\MapFrom('details_url')] public string $detailsUrl, #[\EventSauce\ObjectHydrator\MapFrom('external_id')] public string $externalId, #[\EventSauce\ObjectHydrator\MapFrom('head_sha')] public string $headSha, #[\EventSauce\ObjectHydrator\MapFrom('html_url')] public string $htmlUrl, public int $id, public string $name, #[\EventSauce\ObjectHydrator\MapFrom('node_id')] public string $nodeId, public \ApiClients\Client\GitHub\Schema\CheckRunWithSimpleCheckSuite\Output $output, #[\EventSauce\ObjectHydrator\MapFrom('pull_requests')] public array $pullRequests, #[\EventSauce\ObjectHydrator\MapFrom('started_at')] public string $startedAt, public string $status, public string $url)
    {
    }
}
