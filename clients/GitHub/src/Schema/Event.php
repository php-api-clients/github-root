...
final readonly class Event implements \ApiClients\Client\GitHub\Contract\Event
{
    const SCHEMA_JSON = '{
    "title": "Event",
    "required": [
     ...
     * org: Actor
     */
    public function __construct(public string $id, public ?string $type, public \ApiClients\Client\GitHub\Schema\Actor $actor, public \ApiClients\Client\GitHub\Schema\Event\Repo $repo, public ?\ApiClients\Client\GitHub\Schema\Actor $org, public \ApiClients\Client\GitHub\Schema\Event\Payload $payload, public bool $public, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public ?string $createdAt)
    {
    }
}
