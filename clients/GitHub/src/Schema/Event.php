...
final readonly class Event implements \ApiClients\Client\GitHub\Contract\Event
{
     ...
     * org: Actor
     */
    public function __construct(public string $id, public string|null $type, public Actor $actor, public Repo $repo, public Actor|null $org, public Payload $payload, public bool $public, #[MapFrom('created_at')]
