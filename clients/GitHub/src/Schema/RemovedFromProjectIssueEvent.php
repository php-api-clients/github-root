...
final readonly class RemovedFromProjectIssueEvent implements \ApiClients\Client\GitHub\Contract\RemovedFromProjectIssueEvent
{
    const SCHEMA_JSON = '{
