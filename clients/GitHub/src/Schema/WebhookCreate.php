...
final readonly class WebhookCreate implements \ApiClients\Client\GitHub\Contract\WebhookCreate
{
    const SCHEMA_JSON = '{
    "title": "create event",
    "required": [
    ...
    */
    public function __construct(public ?string $description, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, #[\EventSauce\ObjectHydrator\MapFrom('master_branch')] public string $masterBranch, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, #[\EventSauce\ObjectHydrator\MapFrom('pusher_type')] public string $pusherType, public string $ref, #[\EventSauce\ObjectHydrator\MapFrom('ref_type')] public string $refType, public \ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
