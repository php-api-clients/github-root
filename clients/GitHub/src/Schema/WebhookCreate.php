...
final readonly class WebhookCreate implements \ApiClients\Client\GitHub\Contract\WebhookCreate
{
     ...
     */
    public function __construct(public string|null $description, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, #[MapFrom('master_branch')]
    public string $masterBranch, public OrganizationSimpleWebhooks|null $organization, #[MapFrom('pusher_type')]
    public string $pusherType, public string $ref, #[MapFrom('ref_type')]
    public string $refType, public RepositoryWebhooks $repository, public SimpleUser $sender,)
    {
    }
}
