...
final readonly class NpmMetadata
{
    ...
    public ?Schema\WebhookDeploymentStatusCreated\Deployment\Payload $author;
    public ?Schema\WebhookDeploymentStatusCreated\Deployment\Payload $bugs;
    ...
    public ?Schema\WebhookDeploymentStatusCreated\Deployment\Payload $dist;
    public ?string $git_head;
    public ?string $homepage;
    public ?string $license;
    public ?string $main;
    public ?Schema\WebhookDeploymentStatusCreated\Deployment\Payload $repository;
    ...
    public ?Schema\WebhookDeploymentStatusCreated\Deployment\Payload $directories;
    /**
     * @var array<string>
     */
    public ?array $os;
