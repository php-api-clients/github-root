...
final readonly class PackageVersion implements \ApiClients\Client\GitHub\Contract\WebhookRegistryPackagePublished\RegistryPackage\PackageVersion
{
    ...
    public function __construct(public ?\ApiClients\Client\GitHub\Schema\WebhookRegistryPackagePublished\RegistryPackage\PackageVersion\Author $author, #[\ApiClients\Client\GitHub\Internal\Attribute\CastUnionToType\Single\Schema\WebhookRegistryPackagePublished\RegistryPackage\PackageVersion\Body] public null|string|\ApiClients\Client\GitHub\Schema\WebhookRegistryPackagePublished\RegistryPackage\PackageVersion\Body\One $body, #[\EventSauce\ObjectHydrator\MapFrom('body_html')] public ?string $bodyHtml, #[\EventSauce\ObjectHydrator\MapFrom('container_metadata')] public ?\ApiClients\Client\GitHub\Schema\WebhookRegistryPackagePublished\RegistryPackage\PackageVersion\ContainerMetadata $containerMetadata, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public ?string $createdAt, public string $description, #[\EventSauce\ObjectHydrator\MapFrom('docker_metadata')] public ?array $dockerMetadata, public ?bool $draft, #[\EventSauce\ObjectHydrator\MapFrom('html_url')] public string $htmlUrl, public int $id, #[\EventSauce\ObjectHydrator\MapFrom('installation_command')] public string $installationCommand, public ?string $manifest, public array $metadata, public string $name, #[\EventSauce\ObjectHydrator\MapFrom('npm_metadata')] public ?\ApiClients\Client\GitHub\Schema\WebhookRegistryPackagePublished\RegistryPackage\PackageVersion\NpmMetadata $npmMetadata, #[\EventSauce\ObjectHydrator\MapFrom('nuget_metadata')] public ?array $nugetMetadata, #[\EventSauce\ObjectHydrator\MapFrom('package_files')] public array $packageFiles, #[\EventSauce\ObjectHydrator\MapFrom('package_url')] public string $packageUrl, public ?bool $prerelease, public ?\ApiClients\Client\GitHub\Schema\WebhookRegistryPackagePublished\RegistryPackage\PackageVersion\Release $release, #[\EventSauce\ObjectHydrator\MapFrom('rubygems_metadata')] public ?array $rubygemsMetadata, public string $summary, #[\EventSauce\ObjectHydrator\MapFrom('tag_name')] public ?string $tagName, #[\EventSauce\ObjectHydrator\MapFrom('target_commitish')] public ?string $targetCommitish, #[\EventSauce\ObjectHydrator\MapFrom('target_oid')] public ?string $targetOid, #[\EventSauce\ObjectHydrator\MapFrom('updated_at')] public ?string $updatedAt, public string $version)
    {
    }
}
