...
final readonly class WebhookIssuesTransferred implements \ApiClients\Client\GitHub\Contract\WebhookIssuesTransferred
{
     ...
     */
    public function __construct(public string $action, public Changes $changes, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public WebhooksIssue2 $issue, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser $sender)
    {
    }
}
