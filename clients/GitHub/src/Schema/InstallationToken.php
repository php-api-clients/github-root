...
final readonly class InstallationToken implements \ApiClients\Client\GitHub\Contract\InstallationToken
{
    const SCHEMA_JSON = '{
     ...
     */
    public function __construct(public string $token, #[\EventSauce\ObjectHydrator\MapFrom('expires_at')] public string $expiresAt, public ?\ApiClients\Client\GitHub\Schema\AppPermissions $permissions, #[\EventSauce\ObjectHydrator\MapFrom('repository_selection')] public ?string $repositorySelection, public ?array $repositories, #[\EventSauce\ObjectHydrator\MapFrom('single_file')] public ?string $singleFile, #[\EventSauce\ObjectHydrator\MapFrom('has_multiple_single_files')] public ?bool $hasMultipleSingleFiles, #[\EventSauce\ObjectHydrator\MapFrom('single_file_paths')] public ?array $singleFilePaths)
    {
    }
}
