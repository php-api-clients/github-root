...
final readonly class WebhookInstallationNewPermissionsAccepted implements \ApiClients\Client\GitHub\Contract\WebhookInstallationNewPermissionsAccepted
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public Installation $installation, public OrganizationSimpleWebhooks|null $organization, public array|null $repositories, public RepositoryWebhooks|null $repository, public string $requester, public SimpleUser $sender)
    {
    }
}
