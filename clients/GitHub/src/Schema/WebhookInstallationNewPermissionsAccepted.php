...
final readonly class WebhookInstallationNewPermissionsAccepted implements \ApiClients\Client\GitHub\Contract\WebhookInstallationNewPermissionsAccepted
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public string $action, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public \ApiClients\Client\GitHub\Schema\Installation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public ?array $repositories, public ?\ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public string $requester, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
