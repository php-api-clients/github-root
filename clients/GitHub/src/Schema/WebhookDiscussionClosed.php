...
final readonly class WebhookDiscussionClosed implements \ApiClients\Client\GitHub\Contract\WebhookDiscussionClosed
{
    const SCHEMA_JSON = '{
    ...
    public const SCHEMA_TITLE = 'discussion closed event';
