...
final readonly class WebhookProjectCreated implements \ApiClients\Client\GitHub\Contract\WebhookProjectCreated
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public WebhooksProject $project, public RepositoryWebhooks|null $repository, public SimpleUser $sender)
    {
    }
}
