...
final readonly class WebhooksIssueComment implements \ApiClients\Client\GitHub\Contract\WebhooksIssueComment
{
    const SCHEMA_JSON = '{
    "title": "issue comment",
    "required": [
