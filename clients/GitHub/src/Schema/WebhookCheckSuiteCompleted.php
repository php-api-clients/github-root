...
final readonly class WebhookCheckSuiteCompleted implements \ApiClients\Client\GitHub\Contract\WebhookCheckSuiteCompleted
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public string $action, #[\EventSauce\ObjectHydrator\MapFrom('check_suite')] public \ApiClients\Client\GitHub\Schema\WebhookCheckSuiteCompleted\CheckSuite $checkSuite, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public \ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
