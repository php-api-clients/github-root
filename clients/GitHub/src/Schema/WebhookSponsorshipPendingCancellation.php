...
final readonly class WebhookSponsorshipPendingCancellation implements \ApiClients\Client\GitHub\Contract\WebhookSponsorshipPendingCancellation
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public string $action, #[\EventSauce\ObjectHydrator\MapFrom('effective_date')] public ?string $effectiveDate, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public ?\ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender, public \ApiClients\Client\GitHub\Schema\WebhooksSponsorship $sponsorship)
    {
    }
}
