...
final readonly class WebhookMilestoneDeleted implements \ApiClients\Client\GitHub\Contract\WebhookMilestoneDeleted
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public WebhooksMilestone $milestone, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser $sender)
    {
    }
}
