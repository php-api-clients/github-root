...
final readonly class WorkflowJob implements \ApiClients\Client\GitHub\Contract\WebhookWorkflowJobInProgress\WorkflowJob\WorkflowJob, \ApiClients\Client\GitHub\Contract\WebhookWorkflowJobInProgress\WorkflowJob
{
     ...
     */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('check_run_url')] public ?string $checkRunUrl, #[\EventSauce\ObjectHydrator\MapFrom('completed_at')] public ?string $completedAt, public ?string $conclusion, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public ?string $createdAt, #[\EventSauce\ObjectHydrator\MapFrom('head_sha')] public ?string $headSha, #[\EventSauce\ObjectHydrator\MapFrom('html_url')] public ?string $htmlUrl, public ?int $id, public ?array $labels, public ?string $name, #[\EventSauce\ObjectHydrator\MapFrom('node_id')] public ?string $nodeId, #[\EventSauce\ObjectHydrator\MapFrom('run_attempt')] public ?int $runAttempt, #[\EventSauce\ObjectHydrator\MapFrom('run_id')] public ?int $runId, #[\EventSauce\ObjectHydrator\MapFrom('run_url')] public ?string $runUrl, #[\EventSauce\ObjectHydrator\MapFrom('runner_group_id')] public null|int|float $runnerGroupId, #[\EventSauce\ObjectHydrator\MapFrom('runner_group_name')] public ?string $runnerGroupName, #[\EventSauce\ObjectHydrator\MapFrom('runner_id')] public null|int|float $runnerId, #[\EventSauce\ObjectHydrator\MapFrom('runner_name')] public ?string $runnerName, #[\EventSauce\ObjectHydrator\MapFrom('started_at')] public ?string $startedAt, public string $status, #[\EventSauce\ObjectHydrator\MapFrom('head_branch')] public ?string $headBranch, #[\EventSauce\ObjectHydrator\MapFrom('workflow_name')] public ?string $workflowName, public array $steps, public ?string $url)
    {
    }
}
