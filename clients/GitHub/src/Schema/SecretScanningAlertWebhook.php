...
final readonly class SecretScanningAlertWebhook implements \ApiClients\Client\GitHub\Contract\SecretScanningAlertWebhook
{
    const SCHEMA_JSON = '{
    "type": "object",
    "properties": {
