...
final readonly class ApplicationJson implements \ApiClients\Client\GitHub\Contract\Apps\ScopeToken\Request\ApplicationJson
{
     ...
     */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('access_token')] public string $accessToken, public ?string $target, #[\EventSauce\ObjectHydrator\MapFrom('target_id')] public ?int $targetId, public ?array $repositories, #[\EventSauce\ObjectHydrator\MapFrom('repository_ids')] public ?array $repositoryIds, public ?\ApiClients\Client\GitHub\Schema\AppPermissions $permissions)
    {
    }
}
