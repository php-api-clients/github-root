...
use ApiClients\Client\GitHub\Schema\WebhookRegistryPackageUpdated\RegistryPackage;
...
final readonly class WebhookRegistryPackageUpdated implements \ApiClients\Client\GitHub\Contract\WebhookRegistryPackageUpdated
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, #[MapFrom('registry_package')]
    public RegistryPackage $registryPackage, public RepositoryWebhooks|null $repository, public SimpleUser $sender,)
    {
    }
}
