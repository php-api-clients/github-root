...
final readonly class ReviewComment implements \ApiClients\Client\GitHub\Contract\ReviewComment
{
     ...
     */
    public function __construct(public string $url, #[\EventSauce\ObjectHydrator\MapFrom('pull_request_review_id')] public ?int $pullRequestReviewId, public int $id, #[\EventSauce\ObjectHydrator\MapFrom('node_id')] public string $nodeId, #[\EventSauce\ObjectHydrator\MapFrom('diff_hunk')] public string $diffHunk, public string $path, public ?int $position, #[\EventSauce\ObjectHydrator\MapFrom('original_position')] public int $originalPosition, #[\EventSauce\ObjectHydrator\MapFrom('commit_id')] public string $commitId, #[\EventSauce\ObjectHydrator\MapFrom('original_commit_id')] public string $originalCommitId, #[\EventSauce\ObjectHydrator\MapFrom('in_reply_to_id')] public ?int $inReplyToId, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $user, public string $body, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public string $createdAt, #[\EventSauce\ObjectHydrator\MapFrom('updated_at')] public string $updatedAt, #[\EventSauce\ObjectHydrator\MapFrom('html_url')] public string $htmlUrl, #[\EventSauce\ObjectHydrator\MapFrom('pull_request_url')] public string $pullRequestUrl, #[\EventSauce\ObjectHydrator\MapFrom('author_association')] public string $authorAssociation, #[\EventSauce\ObjectHydrator\MapFrom('_links')] public \ApiClients\Client\GitHub\Schema\ReviewComment\Links $links, #[\EventSauce\ObjectHydrator\MapFrom('body_text')] public ?string $bodyText, #[\EventSauce\ObjectHydrator\MapFrom('body_html')] public ?string $bodyHtml, public ?\ApiClients\Client\GitHub\Schema\ReactionRollup $reactions, public ?string $side, #[\EventSauce\ObjectHydrator\MapFrom('start_side')] public ?string $startSide, public ?int $line, #[\EventSauce\ObjectHydrator\MapFrom('original_line')] public ?int $originalLine, #[\EventSauce\ObjectHydrator\MapFrom('start_line')] public ?int $startLine, #[\EventSauce\ObjectHydrator\MapFrom('original_start_line')] public ?int $originalStartLine)
    {
    }
}
