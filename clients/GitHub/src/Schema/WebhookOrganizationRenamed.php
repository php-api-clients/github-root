...
final readonly class WebhookOrganizationRenamed implements \ApiClients\Client\GitHub\Contract\WebhookOrganizationRenamed
{
     ...
     */
    public function __construct(public string $action, public Changes|null $changes, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public WebhooksMembership|null $membership, public OrganizationSimpleWebhooks $organization, public RepositoryWebhooks|null $repository, public SimpleUser $sender)
    {
    }
}
