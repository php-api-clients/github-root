...
final readonly class WebhookPush implements \ApiClients\Client\GitHub\Contract\WebhookPush
{
    const SCHEMA_JSON = '{
    "title": "push event",
    "required": [
    ...
    */
    public function __construct(public string $after, #[\EventSauce\ObjectHydrator\MapFrom('base_ref')] public ?string $baseRef, public string $before, public array $commits, public string $compare, public bool $created, public bool $deleted, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public bool $forced, #[\EventSauce\ObjectHydrator\MapFrom('head_commit')] public ?\ApiClients\Client\GitHub\Schema\WebhookPush\HeadCommit $headCommit, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public \ApiClients\Client\GitHub\Schema\WebhookPush\Pusher $pusher, public string $ref, public \ApiClients\Client\GitHub\Schema\WebhookPush\Repository $repository, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
