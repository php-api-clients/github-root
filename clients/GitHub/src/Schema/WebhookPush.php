...
final readonly class WebhookPush implements \ApiClients\Client\GitHub\Contract\WebhookPush
{
    ...
    public string|null $baseRef, public string $before, public array $commits, public string $compare, public bool $created, public bool $deleted, public EnterpriseWebhooks|null $enterprise, public bool $forced, #[MapFrom('head_commit')]
    public HeadCommit|null $headCommit, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public Pusher $pusher, public string $ref, public Repository $repository, public SimpleUser|null $sender,)
    {
    }
}
