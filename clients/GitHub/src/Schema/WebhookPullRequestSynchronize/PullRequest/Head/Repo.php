...
namespace ApiClients\Client\GitHub\Schema\WebhookPullRequestSynchronize\PullRequest\Head;

final readonly class Repo implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestSynchronize\PullRequest\Head\Repo
{
    const SCHEMA_JSON = '{
    "title": "Repository",
    "required": [
