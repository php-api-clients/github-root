...
final readonly class ReviewRequestedIssueEvent implements \ApiClients\Client\GitHub\Contract\ReviewRequestedIssueEvent
{
    ...
    public string $nodeId, public string $url, public SimpleUser $actor, public string $event, #[MapFrom('commit_id')]
    ...
    public Integration|null $performedViaGithubApp, #[MapFrom('review_requester')]
    public SimpleUser $reviewRequester, #[MapFrom('requested_team')]
    public Team|null $requestedTeam, #[MapFrom('requested_reviewer')]
    public SimpleUser|null $requestedReviewer,)
    {
    }
}
