...
final readonly class TeamDiscussion implements \ApiClients\Client\GitHub\Contract\TeamDiscussion
{
    const SCHEMA_JSON = '{
     ...
     */
    public function __construct(public ?\ApiClients\Client\GitHub\Schema\SimpleUser $author, public string $body, #[\EventSauce\ObjectHydrator\MapFrom('body_html')] public string $bodyHtml, #[\EventSauce\ObjectHydrator\MapFrom('body_version')] public string $bodyVersion, #[\EventSauce\ObjectHydrator\MapFrom('comments_count')] public int $commentsCount, #[\EventSauce\ObjectHydrator\MapFrom('comments_url')] public string $commentsUrl, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public string $createdAt, #[\EventSauce\ObjectHydrator\MapFrom('last_edited_at')] public ?string $lastEditedAt, #[\EventSauce\ObjectHydrator\MapFrom('html_url')] public string $htmlUrl, #[\EventSauce\ObjectHydrator\MapFrom('node_id')] public string $nodeId, public int $number, public bool $pinned, public bool $private, #[\EventSauce\ObjectHydrator\MapFrom('team_url')] public string $teamUrl, public string $title, #[\EventSauce\ObjectHydrator\MapFrom('updated_at')] public string $updatedAt, public string $url, public ?\ApiClients\Client\GitHub\Schema\ReactionRollup $reactions)
    {
    }
}
