...
namespace ApiClients\Client\GitHub\Schema\Operations\Apps\ListInstallationReposForAuthenticatedUser\Response\ApplicationJson;

final readonly class Ok implements \ApiClients\Client\GitHub\Contract\Operations\Apps\ListInstallationReposForAuthenticatedUser\Response\ApplicationJson\Ok
{
    const SCHEMA_JSON = '{
    "required": [
        "total_count",
    ...
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('total_count')] public int $totalCount, #[\EventSauce\ObjectHydrator\MapFrom('repository_selection')] public ?string $repositorySelection, public array $repositories)
    {
    }
}
