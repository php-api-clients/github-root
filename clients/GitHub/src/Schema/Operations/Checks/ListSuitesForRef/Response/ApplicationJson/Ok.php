...
final readonly class Ok implements \ApiClients\Client\GitHub\Contract\Operations\Checks\ListSuitesForRef\Response\ApplicationJson\Ok
{
    const SCHEMA_JSON = '{
    "required": [
        "total_count",
    ...
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('total_count')] public int $totalCount, #[\EventSauce\ObjectHydrator\MapFrom('check_suites')] public array $checkSuites)
    {
    }
}
