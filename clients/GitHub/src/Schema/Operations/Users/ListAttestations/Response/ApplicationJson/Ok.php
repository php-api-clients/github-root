...
final readonly class Ok implements \ApiClients\Client\GitHub\Contract\Operations\Users\ListAttestations\Response\ApplicationJson\Ok
{
    const SCHEMA_JSON = '{
    "type": "object",
    "properties": {
    ...
    public function __construct(public ?array $attestations)
    {
    }
}
