...
final readonly class Ok implements \ApiClients\Client\GitHub\Contract\Operations\Copilot\ListCopilotSeats\Response\ApplicationJson\Ok
{
    const SCHEMA_JSON = '{
    "type": "object",
    "properties": {
     ...
     */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('total_seats')] public ?int $totalSeats, public ?array $seats)
    {
    }
}
