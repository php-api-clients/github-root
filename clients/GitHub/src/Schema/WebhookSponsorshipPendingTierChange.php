...
final readonly class WebhookSponsorshipPendingTierChange implements \ApiClients\Client\GitHub\Contract\WebhookSponsorshipPendingTierChange
{
     ...
     */
    public function __construct(public string $action, public WebhooksChanges8 $changes, #[MapFrom('effective_date')]
    public string|null $effectiveDate, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks|null $repository, public SimpleUser $sender, public WebhooksSponsorship $sponsorship,)
    {
    }
}
