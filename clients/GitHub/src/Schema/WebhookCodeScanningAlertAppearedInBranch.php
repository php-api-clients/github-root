...
use ApiClients\Client\GitHub\Schema\WebhookCodeScanningAlertAppearedInBranch\Alert;
...
final readonly class WebhookCodeScanningAlertAppearedInBranch implements \ApiClients\Client\GitHub\Contract\WebhookCodeScanningAlertAppearedInBranch
{
     ...
     */
    public function __construct(public string $action, public Alert $alert, #[MapFrom('commit_oid')]
    public string $commitOid, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public string $ref, public RepositoryWebhooks $repository, public SimpleUser $sender,)
    {
    }
}
