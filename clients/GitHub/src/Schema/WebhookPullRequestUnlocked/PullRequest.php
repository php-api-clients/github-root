...
use ApiClients\Client\GitHub\Internal\Attribute\CastUnionToType\Multiple\Schema\WebhookPullRequestUnlocked\PullRequest\RequestedReviewers;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestUnlocked\PullRequest\Assignee;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestUnlocked\PullRequest\AutoMerge;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestUnlocked\PullRequest\Base;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestUnlocked\PullRequest\Head;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestUnlocked\PullRequest\Links;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestUnlocked\PullRequest\MergedBy;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestUnlocked\PullRequest\Milestone;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestUnlocked\PullRequest\RequestedReviewers\One;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestUnlocked\PullRequest\RequestedReviewers\Zero;
use ApiClients\Client\GitHub\Schema\WebhookPullRequestUnlocked\PullRequest\User;
