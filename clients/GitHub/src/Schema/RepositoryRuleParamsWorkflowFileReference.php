...
final readonly class RepositoryRuleParamsWorkflowFileReference implements \ApiClients\Client\GitHub\Contract\RepositoryRuleParamsWorkflowFileReference
{
     ...
     */
    public function __construct(public string $path, public ?string $ref, #[\EventSauce\ObjectHydrator\MapFrom('repository_id')] public int $repositoryId, public ?string $sha)
    {
    }
}
