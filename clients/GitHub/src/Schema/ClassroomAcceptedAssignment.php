...
final readonly class ClassroomAcceptedAssignment implements \ApiClients\Client\GitHub\Contract\ClassroomAcceptedAssignment
{
     ...
     */
    public function __construct(public int $id, public bool $submitted, public bool $passing, #[\EventSauce\ObjectHydrator\MapFrom('commit_count')] public int $commitCount, public string $grade, public array $students, public \ApiClients\Client\GitHub\Schema\SimpleClassroomRepository $repository, public \ApiClients\Client\GitHub\Schema\SimpleClassroomAssignment $assignment)
    {
    }
}
