...
final readonly class WebhookDiscussionCategoryChanged implements \ApiClients\Client\GitHub\Contract\WebhookDiscussionCategoryChanged
{
     ...
     */
    public function __construct(public string $action, public Changes $changes, public Discussion $discussion, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser $sender)
    {
    }
}
