...
final readonly class TeamFull implements \ApiClients\Client\GitHub\Contract\TeamFull
{
     ...
     */
    public function __construct(public int $id, #[\EventSauce\ObjectHydrator\MapFrom('node_id')] public string $nodeId, public string $url, #[\EventSauce\ObjectHydrator\MapFrom('html_url')] public string $htmlUrl, public string $name, public string $slug, public ?string $description, public ?string $privacy, #[\EventSauce\ObjectHydrator\MapFrom('notification_setting')] public ?string $notificationSetting, public string $permission, #[\EventSauce\ObjectHydrator\MapFrom('members_url')] public string $membersUrl, #[\EventSauce\ObjectHydrator\MapFrom('repositories_url')] public string $repositoriesUrl, public ?\ApiClients\Client\GitHub\Schema\TeamSimple $parent, #[\EventSauce\ObjectHydrator\MapFrom('members_count')] public int $membersCount, #[\EventSauce\ObjectHydrator\MapFrom('repos_count')] public int $reposCount, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public string $createdAt, #[\EventSauce\ObjectHydrator\MapFrom('updated_at')] public string $updatedAt, public \ApiClients\Client\GitHub\Schema\TeamOrganization $organization, #[\EventSauce\ObjectHydrator\MapFrom('ldap_dn')] public ?string $ldapDn)
    {
    }
}
