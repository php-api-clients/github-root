...
final readonly class WebhookRepositoryImport implements \ApiClients\Client\GitHub\Contract\WebhookRepositoryImport
{
     ...
     */
    public function __construct(public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser $sender, public string $status)
    {
    }
}
