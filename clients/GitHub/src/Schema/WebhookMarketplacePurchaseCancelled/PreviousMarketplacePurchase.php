...
final readonly class PreviousMarketplacePurchase
{
    ...
    public mixed $free_trial_ends_on;
    ...
    public function __construct(Schema\WebhookMarketplacePurchaseCancelled\PreviousMarketplacePurchase\Account $account, string $billing_cycle, mixed $free_trial_ends_on, string $next_billing_date, bool $on_free_trial, Schema\WebhookMarketplacePurchaseCancelled\PreviousMarketplacePurchase\Plan $plan, int $unit_count)
    {
