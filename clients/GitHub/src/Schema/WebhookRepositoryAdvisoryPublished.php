...
final readonly class WebhookRepositoryAdvisoryPublished implements \ApiClients\Client\GitHub\Contract\WebhookRepositoryAdvisoryPublished
{
    const SCHEMA_JSON = '{
    ...
    public const SCHEMA_TITLE = 'Repository advisory published event';
    ...
    */
    public function __construct(public string $action, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public \ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, #[\EventSauce\ObjectHydrator\MapFrom('repository_advisory')] public \ApiClients\Client\GitHub\Schema\RepositoryAdvisory $repositoryAdvisory, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
