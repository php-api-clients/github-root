...
final readonly class WebhookRepositoryAdvisoryPublished implements \ApiClients\Client\GitHub\Contract\WebhookRepositoryAdvisoryPublished
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, #[MapFrom('repository_advisory')]
    public RepositoryAdvisory $repositoryAdvisory, public SimpleUser|null $sender,)
    {
    }
}
