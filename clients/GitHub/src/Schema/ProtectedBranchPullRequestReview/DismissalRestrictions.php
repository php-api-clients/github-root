...
namespace ApiClients\Client\GitHub\Schema\ProtectedBranchPullRequestReview;

final readonly class DismissalRestrictions implements \ApiClients\Client\GitHub\Contract\ProtectedBranchPullRequestReview\DismissalRestrictions
{
    const SCHEMA_JSON = '{
    "type": "object",
    "properties": {
     ...
     */
    public function __construct(public ?array $users, public ?array $teams, public ?array $apps, public ?string $url, #[\EventSauce\ObjectHydrator\MapFrom('users_url')] public ?string $usersUrl, #[\EventSauce\ObjectHydrator\MapFrom('teams_url')] public ?string $teamsUrl)
    {
    }
}
