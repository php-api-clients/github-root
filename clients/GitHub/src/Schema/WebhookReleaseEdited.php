...
final readonly class WebhookReleaseEdited implements \ApiClients\Client\GitHub\Contract\WebhookReleaseEdited
{
     ...
     */
    public function __construct(public string $action, public Changes $changes, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public WebhooksRelease $release, public RepositoryWebhooks $repository, public SimpleUser|null $sender)
    {
    }
}
