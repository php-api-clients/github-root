...
final readonly class WebhookCustomPropertyValuesUpdated implements \ApiClients\Client\GitHub\Contract\WebhookCustomPropertyValuesUpdated
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public RepositoryWebhooks $repository, public OrganizationSimpleWebhooks $organization, public SimpleUser|null $sender, #[MapFrom('new_property_values')]
