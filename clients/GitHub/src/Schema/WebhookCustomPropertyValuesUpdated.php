...
final readonly class WebhookCustomPropertyValuesUpdated implements \ApiClients\Client\GitHub\Contract\WebhookCustomPropertyValuesUpdated
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public string $action, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public \ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public \ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $sender, #[\EventSauce\ObjectHydrator\MapFrom('new_property_values')] public array $newPropertyValues, #[\EventSauce\ObjectHydrator\MapFrom('old_property_values')] public array $oldPropertyValues)
    {
    }
}
