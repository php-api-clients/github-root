...
final readonly class WebhookProjectsV2ProjectReopened implements \ApiClients\Client\GitHub\Contract\WebhookProjectsV2ProjectReopened
{
     ...
     */
    public function __construct(public string $action, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks $organization, #[MapFrom('projects_v2')]
    public ProjectsV2 $projectsVTwo, public SimpleUser $sender,)
    {
    }
}
