...
final readonly class WebhookProjectsV2ProjectReopened implements \ApiClients\Client\GitHub\Contract\WebhookProjectsV2ProjectReopened
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public string $action, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public \ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, #[\EventSauce\ObjectHydrator\MapFrom('projects_v2')] public \ApiClients\Client\GitHub\Schema\ProjectsV2 $projectsVTwo, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
