...
final readonly class WebhookDiscussionReopened implements \ApiClients\Client\GitHub\Contract\WebhookDiscussionReopened
{
     ...
     */
    public function __construct(public string $action, public Discussion $discussion, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser $sender)
    {
    }
}
