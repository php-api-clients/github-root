...
final readonly class WebhookDiscussionReopened implements \ApiClients\Client\GitHub\Contract\WebhookDiscussionReopened
{
    const SCHEMA_JSON = '{
    ...
    public const SCHEMA_TITLE = 'discussion reopened event';
    ...
    */
    public function __construct(public string $action, public \ApiClients\Client\GitHub\Schema\Discussion $discussion, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public \ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
