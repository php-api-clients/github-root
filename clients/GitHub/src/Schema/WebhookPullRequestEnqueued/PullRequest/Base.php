...
final readonly class Base implements \ApiClients\Client\GitHub\Contract\WebhookPullRequestEnqueued\PullRequest\Base
{
    const SCHEMA_JSON = '{
    "required": [
        "label",
     ...
     */
    public function __construct(public string $label, public string $ref, public \ApiClients\Client\GitHub\Schema\WebhookPullRequestEnqueued\PullRequest\Base\Repo $repo, public string $sha, public ?\ApiClients\Client\GitHub\Schema\WebhookPullRequestEnqueued\PullRequest\Base\User $user)
    {
    }
}
