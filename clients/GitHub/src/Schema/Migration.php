...
final readonly class Migration implements \ApiClients\Client\GitHub\Contract\Migration
{
    const SCHEMA_JSON = '{
    "title": "Migration",
    "required": [
     ...
     */
    public function __construct(public int $id, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $owner, public string $guid, public string $state, #[\EventSauce\ObjectHydrator\MapFrom('lock_repositories')] public bool $lockRepositories, #[\EventSauce\ObjectHydrator\MapFrom('exclude_metadata')] public bool $excludeMetadata, #[\EventSauce\ObjectHydrator\MapFrom('exclude_git_data')] public bool $excludeGitData, #[\EventSauce\ObjectHydrator\MapFrom('exclude_attachments')] public bool $excludeAttachments, #[\EventSauce\ObjectHydrator\MapFrom('exclude_releases')] public bool $excludeReleases, #[\EventSauce\ObjectHydrator\MapFrom('exclude_owner_projects')] public bool $excludeOwnerProjects, #[\EventSauce\ObjectHydrator\MapFrom('org_metadata_only')] public bool $orgMetadataOnly, public array $repositories, public string $url, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public string $createdAt, #[\EventSauce\ObjectHydrator\MapFrom('updated_at')] public string $updatedAt, #[\EventSauce\ObjectHydrator\MapFrom('node_id')] public string $nodeId, #[\EventSauce\ObjectHydrator\MapFrom('archive_url')] public ?string $archiveUrl, public ?array $exclude)
    {
    }
}
