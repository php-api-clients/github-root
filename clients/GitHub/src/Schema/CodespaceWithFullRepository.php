...
final readonly class CodespaceWithFullRepository implements \ApiClients\Client\GitHub\Contract\CodespaceWithFullRepository
{
    const SCHEMA_JSON = '{
    "title": "Codespace",
    "required": [
     ...
     */
    public function __construct(public int $id, public string $name, #[\EventSauce\ObjectHydrator\MapFrom('display_name')] public ?string $displayName, #[\EventSauce\ObjectHydrator\MapFrom('environment_id')] public ?string $environmentId, public \ApiClients\Client\GitHub\Schema\SimpleUser $owner, #[\EventSauce\ObjectHydrator\MapFrom('billable_owner')] public \ApiClients\Client\GitHub\Schema\SimpleUser $billableOwner, public \ApiClients\Client\GitHub\Schema\FullRepository $repository, public ?\ApiClients\Client\GitHub\Schema\CodespaceMachine $machine, #[\EventSauce\ObjectHydrator\MapFrom('devcontainer_path')] public ?string $devcontainerPath, public ?bool $prebuild, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public string $createdAt, #[\EventSauce\ObjectHydrator\MapFrom('updated_at')] public string $updatedAt, #[\EventSauce\ObjectHydrator\MapFrom('last_used_at')] public string $lastUsedAt, public string $state, public string $url, #[\EventSauce\ObjectHydrator\MapFrom('git_status')] public \ApiClients\Client\GitHub\Schema\CodespaceWithFullRepository\GitStatus $gitStatus, public string $location, #[\EventSauce\ObjectHydrator\MapFrom('idle_timeout_minutes')] public ?int $idleTimeoutMinutes, #[\EventSauce\ObjectHydrator\MapFrom('web_url')] public string $webUrl, #[\EventSauce\ObjectHydrator\MapFrom('machines_url')] public string $machinesUrl, #[\EventSauce\ObjectHydrator\MapFrom('start_url')] public string $startUrl, #[\EventSauce\ObjectHydrator\MapFrom('stop_url')] public string $stopUrl, #[\EventSauce\ObjectHydrator\MapFrom('publish_url')] public ?string $publishUrl, #[\EventSauce\ObjectHydrator\MapFrom('pulls_url')] public ?string $pullsUrl, #[\EventSauce\ObjectHydrator\MapFrom('recent_folders')] public array $recentFolders, #[\EventSauce\ObjectHydrator\MapFrom('runtime_constraints')] public ?\ApiClients\Client\GitHub\Schema\CodespaceWithFullRepository\RuntimeConstraints $runtimeConstraints, #[\EventSauce\ObjectHydrator\MapFrom('pending_operation')] public ?bool $pendingOperation, #[\EventSauce\ObjectHydrator\MapFrom('pending_operation_disabled_reason')] public ?string $pendingOperationDisabledReason, #[\EventSauce\ObjectHydrator\MapFrom('idle_timeout_notice')] public ?string $idleTimeoutNotice, #[\EventSauce\ObjectHydrator\MapFrom('retention_period_minutes')] public ?int $retentionPeriodMinutes, #[\EventSauce\ObjectHydrator\MapFrom('retention_expires_at')] public ?string $retentionExpiresAt)
    {
    }
}
