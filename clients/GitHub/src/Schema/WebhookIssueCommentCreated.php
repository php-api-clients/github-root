...
final readonly class WebhookIssueCommentCreated implements \ApiClients\Client\GitHub\Contract\WebhookIssueCommentCreated
{
     ...
     */
    public function __construct(public string $action, public Comment $comment, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public Issue $issue, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser $sender)
    {
    }
}
