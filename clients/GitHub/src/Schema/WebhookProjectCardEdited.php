...
use ApiClients\Client\GitHub\Schema\WebhookProjectCardEdited\Changes;
...
final readonly class WebhookProjectCardEdited implements \ApiClients\Client\GitHub\Contract\WebhookProjectCardEdited
{
     ...
     */
    public function __construct(public string $action, public Changes $changes, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public OrganizationSimpleWebhooks|null $organization, #[MapFrom('project_card')]
    public WebhooksProjectCard $projectCard, public RepositoryWebhooks|null $repository, public SimpleUser $sender,)
    {
    }
}
