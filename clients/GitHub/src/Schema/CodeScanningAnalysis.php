...
final readonly class CodeScanningAnalysis implements \ApiClients\Client\GitHub\Contract\CodeScanningAnalysis
{
    ...
    */
    public function __construct(public string $ref, #[\EventSauce\ObjectHydrator\MapFrom('commit_sha')] public string $commitSha, #[\EventSauce\ObjectHydrator\MapFrom('analysis_key')] public string $analysisKey, public string $environment, public ?string $category, public string $error, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public string $createdAt, #[\EventSauce\ObjectHydrator\MapFrom('results_count')] public int $resultsCount, #[\EventSauce\ObjectHydrator\MapFrom('rules_count')] public int $rulesCount, public int $id, public string $url, #[\EventSauce\ObjectHydrator\MapFrom('sarif_id')] public string $sarifId, public \ApiClients\Client\GitHub\Schema\CodeScanningAnalysisTool $tool, public bool $deletable, public string $warning)
    {
    }
}
