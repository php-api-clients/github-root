...
final readonly class WebhookOrganizationMemberRemoved implements \ApiClients\Client\GitHub\Contract\WebhookOrganizationMemberRemoved
{
     ...
     */
    public function __construct(public string $action, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation|null $installation, public WebhooksMembership $membership, public OrganizationSimpleWebhooks $organization, public RepositoryWebhooks|null $repository, public SimpleUser $sender)
    {
    }
}
