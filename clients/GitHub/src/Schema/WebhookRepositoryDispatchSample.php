...
final readonly class WebhookRepositoryDispatchSample implements \ApiClients\Client\GitHub\Contract\WebhookRepositoryDispatchSample
{
    ...
    public ClientPayload|null $clientPayload, public EnterpriseWebhooks|null $enterprise, public SimpleInstallation $installation, public OrganizationSimpleWebhooks|null $organization, public RepositoryWebhooks $repository, public SimpleUser $sender,)
    {
    }
}
