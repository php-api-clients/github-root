...
final readonly class WebhookRepositoryDispatchSample implements \ApiClients\Client\GitHub\Contract\WebhookRepositoryDispatchSample
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public string $action, public string $branch, #[\EventSauce\ObjectHydrator\MapFrom('client_payload')] public ?\ApiClients\Client\GitHub\Schema\WebhookRepositoryDispatchSample\ClientPayload $clientPayload, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public \ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public \ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, public \ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
