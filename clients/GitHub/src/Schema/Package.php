...
final readonly class Package implements \ApiClients\Client\GitHub\Contract\Package
{
    const SCHEMA_JSON = '{
    "title": "Package",
    "required": [
     ...
     */
    public function __construct(public int $id, public string $name, #[\EventSauce\ObjectHydrator\MapFrom('package_type')] public string $packageType, public string $url, #[\EventSauce\ObjectHydrator\MapFrom('html_url')] public string $htmlUrl, #[\EventSauce\ObjectHydrator\MapFrom('version_count')] public int $versionCount, public string $visibility, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $owner, public ?\ApiClients\Client\GitHub\Schema\MinimalRepository $repository, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public string $createdAt, #[\EventSauce\ObjectHydrator\MapFrom('updated_at')] public string $updatedAt)
    {
    }
}
