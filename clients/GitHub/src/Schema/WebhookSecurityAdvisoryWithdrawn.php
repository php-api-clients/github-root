...
final readonly class WebhookSecurityAdvisoryWithdrawn implements \ApiClients\Client\GitHub\Contract\WebhookSecurityAdvisoryWithdrawn
{
    const SCHEMA_JSON = '{
    ...
    */
    public function __construct(public string $action, public ?\ApiClients\Client\GitHub\Schema\EnterpriseWebhooks $enterprise, public ?\ApiClients\Client\GitHub\Schema\SimpleInstallation $installation, public ?\ApiClients\Client\GitHub\Schema\OrganizationSimpleWebhooks $organization, public ?\ApiClients\Client\GitHub\Schema\RepositoryWebhooks $repository, #[\EventSauce\ObjectHydrator\MapFrom('security_advisory')] public \ApiClients\Client\GitHub\Schema\WebhookSecurityAdvisoryWithdrawn\SecurityAdvisory $securityAdvisory, public ?\ApiClients\Client\GitHub\Schema\SimpleUser $sender)
    {
    }
}
