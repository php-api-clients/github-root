...
class Sponsorship implements ObjectMapper
{
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSponsorshipCancelled⚡️Sponsorship(mixed $object): mixed
    {
        ...
        $maintainer = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentCreated⚡️WorkflowRun⚡️HeadRepository⚡️Owner($maintainer);
        ...
        $sponsor = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️Discussion⚡️AnswerChosenBy($sponsor);
        ...
        $sponsorable = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️Discussion⚡️AnswerChosenBy($sponsorable);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSponsorshipEdited⚡️Changes(mixed $object): mixed
    {
        ...
        $privacy_level = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSponsorshipEdited⚡️Changes⚡️PrivacyLevel($privacy_level);
        after_privacy_level:        $result['privacy_level'] = $privacy_level;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSponsorshipPendingTierChange⚡️Changes⚡️Tier(mixed $object): mixed
    {
        ...
        $from = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookSponsorshipCancelled⚡️Sponsorship⚡️Tier($from);
        after_from:        $result['from'] = $from;
