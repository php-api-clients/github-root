...
class ProjectCard implements ObjectMapper
{
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookProjectCardConverted(mixed $object): mixed
    {
        ...
        $project_card = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookProjectCardConverted⚡️ProjectCard($project_card);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookProjectCardConverted⚡️Changes(mixed $object): mixed
    {
        ...
        $note = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionCommentEdited⚡️Changes⚡️Body($note);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookProjectCardDeleted(mixed $object): mixed
    {
        ...
        $project_card = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookProjectCardDeleted⚡️ProjectCard($project_card);
        after_project_card:        $result['project_card'] = $project_card;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookProjectCardMoved(mixed $object): mixed
    {
        ...
        $project_card = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookProjectCardMoved⚡️ProjectCard($project_card);
        after_project_card:        $result['project_card'] = $project_card;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookProjectCardMoved⚡️Changes(mixed $object): mixed
    {
        ...
        $column_id = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookProjectCardMoved⚡️Changes⚡️ColumnId($column_id);
        after_column_id:        $result['column_id'] = $column_id;
