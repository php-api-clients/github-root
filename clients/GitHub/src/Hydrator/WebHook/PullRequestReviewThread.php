...
class PullRequestReviewThread implements ObjectMapper
{
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPullRequestReviewThreadResolved(mixed $object): mixed
    {
        ...
        $pull_request = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPullRequestReviewThreadResolved⚡️PullRequest($pull_request);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPullRequestReviewThreadResolved⚡️PullRequest⚡️Base(mixed $object): mixed
    {
        ...
        $repo = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionTransferred⚡️Changes⚡️NewRepository($repo);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPullRequestReviewThreadUnresolved⚡️PullRequest(mixed $object): mixed
    {
        ...
        $auto_merge = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPullRequestReviewThreadUnresolved⚡️PullRequest⚡️AutoMerge($auto_merge);
        after_auto_merge:        $result['auto_merge'] = $auto_merge;
        ...
        $head = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPullRequestReviewThreadResolved⚡️PullRequest⚡️Base($head);
        after_head:        $result['head'] = $head;
