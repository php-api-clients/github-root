...
class Discussion implements ObjectMapper
{
    ...
    public function serializeObject(object $object): mixed
    {
        try {
            ...
            return match($className) {
                ...
                'ApiClients\Client\GitHub\Schema\WebhookDiscussionLabeled\Discussion' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionLabeled⚡️Discussion($object),
                ...
                'ApiClients\Client\GitHub\Schema\WebhookDiscussionTransferred\Changes\NewDiscussion' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionTransferred⚡️Changes⚡️NewDiscussion($object),
                'ApiClients\Client\GitHub\Schema\WebhookDiscussionTransferred\Changes\NewRepository' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionTransferred⚡️Changes⚡️NewRepository($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️Discussion(mixed $object): mixed
    {
        ...
        $answer_chosen_by = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️Discussion⚡️AnswerChosenBy($answer_chosen_by);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionCategoryChanged⚡️Changes⚡️Category(mixed $object): mixed
    {
        ...
        $from = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️Discussion⚡️Category($from);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionCreated⚡️Discussion(mixed $object): mixed
    {
        ...
        $user = $object->user;
        $user = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentCreated⚡️WorkflowRun⚡️HeadRepository⚡️Owner($user);
        after_user:        $result['user'] = $user;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionEdited⚡️Changes(mixed $object): mixed
    {
        ...
        $title = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionCommentEdited⚡️Changes⚡️Body($title);
        after_title:        $result['title'] = $title;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionLabeled⚡️Discussion(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHub\Schema\WebhookDiscussionLabeled\Discussion);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionTransferred⚡️Changes(mixed $object): mixed
    {
        ...
        $new_discussion = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionTransferred⚡️Changes⚡️NewDiscussion($new_discussion);
        ...
        $new_repository = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionTransferred⚡️Changes⚡️NewRepository($new_repository);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionTransferred⚡️Changes⚡️NewDiscussion(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHub\Schema\WebhookDiscussionTransferred\Changes\NewDiscussion);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDiscussionTransferred⚡️Changes⚡️NewRepository(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHub\Schema\WebhookDiscussionTransferred\Changes\NewRepository);
        $result = [];
