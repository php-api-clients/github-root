...
class RepositoryDispatch implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHub\Schema\WebhookRepositoryDispatchSample' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryDispatchSample($payload),
                ...
                'ApiClients\Client\GitHub\Schema\WebhookRepositoryDispatchSample\ClientPayload' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryDispatchSample⚡️ClientPayload($payload),
            ...
            try {
                ...
                if (is_array($value)) {
                    try {
                        ...
                        $value = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryDispatchSample⚡️ClientPayload($value);
                    } finally {
        ...
        private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryDispatchSample⚡️ClientPayload(array $payload): \ApiClients\Client\GitHub\Schema\WebhookRepositoryDispatchSample\ClientPayload
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookRepositoryDispatchSample\ClientPayload', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\WebhookRepositoryDispatchSample\ClientPayload::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHub\Schema\WebhookRepositoryDispatchSample\ClientPayload(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookRepositoryDispatchSample\ClientPayload', $exception, stack: $this->hydrationStack);
            }
        }
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryDispatchSample(mixed $object): mixed
    {
        ...
        $client_payload = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRepositoryDispatchSample⚡️ClientPayload($client_payload);
