...
class WorkflowJob implements ObjectMapper
{
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowJobCompleted(mixed $object): mixed
    {
        ...
        $workflow_job = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowJobCompleted⚡️WorkflowJob($workflow_job);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowJobInProgress(mixed $object): mixed
    {
        ...
        $workflow_job = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowJobInProgress⚡️WorkflowJob($workflow_job);
        after_workflow_job:        $result['workflow_job'] = $workflow_job;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowJobQueued(mixed $object): mixed
    {
        ...
        $workflow_job = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowJobQueued⚡️WorkflowJob($workflow_job);
        after_workflow_job:        $result['workflow_job'] = $workflow_job;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowJobWaiting(mixed $object): mixed
    {
        ...
        $workflow_job = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookWorkflowJobWaiting⚡️WorkflowJob($workflow_job);
        after_workflow_job:        $result['workflow_job'] = $workflow_job;
