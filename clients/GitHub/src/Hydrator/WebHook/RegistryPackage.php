...
class RegistryPackage implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHub\Schema\WebhookRegistryPackagePublished' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished($payload),
                ...
                'ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NugetMetadata\Value' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NugetMetadata⚡️Value($payload),
            ...
            try {
                ...
                if (is_array($value)) {
                    try {
                        ...
                        $value = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NugetMetadata⚡️Value($value);
                    } finally {
                        array_pop($this->hydrationStack);
                    }
                }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NugetMetadata⚡️Value(array $payload): \ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NugetMetadata\Value
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NugetMetadata\Value', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NugetMetadata\Value::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NugetMetadata\Value(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NugetMetadata\Value', $exception, stack: $this->hydrationStack);
            }
        }
    ...
    public function serializeObject(object $object): mixed
    {
        try {
            ...
            return match($className) {
                ...
                'ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NugetMetadata\Value' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NugetMetadata⚡️Value($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished(mixed $object): mixed
    {
        ...
        $registry_package = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage($registry_package);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage(mixed $object): mixed
    {
        ...
        $package_version = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion($package_version);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion(mixed $object): mixed
    {
        ...
        $body = $object->body;
        $body = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️Payload($body);
        ...
        $container_metadata = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️ContainerMetadata($container_metadata);
        ...
        $npm_metadata = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata($npm_metadata);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️ContainerMetadata(mixed $object): mixed
    {
        ...
        $labels = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookCheckSuiteCompleted⚡️ActionsMeta($labels);
        ...
        $manifest = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookCheckSuiteCompleted⚡️ActionsMeta($manifest);
        after_manifest:        $result['manifest'] = $manifest;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata(mixed $object): mixed
    {
        ...
        $author = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️Payload($author);
        after_author:        $result['author'] = $author;
        ...
        $bugs = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️Payload($bugs);
        ...
        $dependencies = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️Payload($dependencies);
        ...
        $dev_dependencies = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️Payload($dev_dependencies);
        ...
        $peer_dependencies = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️Payload($peer_dependencies);
        ...
        $optional_dependencies = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️Payload($optional_dependencies);
        ...
        $dist = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️Payload($dist);
        ...
        $repository = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️Payload($repository);
        after_repository:        $result['repository'] = $repository;
        ...
        $scripts = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️Payload($scripts);
        ...
        $engines = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️Payload($engines);
        ...
        $bin = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️Payload($bin);
        ...
        $man = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️Payload($man);
        ...
        $directories = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️Payload($directories);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NugetMetadata(mixed $object): mixed
    {
        ...
        $value = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NugetMetadata⚡️Value($value);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NugetMetadata⚡️Value(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHub\Schema\WebhookPackagePublished\Package\PackageVersion\NugetMetadata\Value);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackageUpdated(mixed $object): mixed
    {
        ...
        $registry_package = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackageUpdated⚡️RegistryPackage($registry_package);
        after_registry_package:        $result['registry_package'] = $registry_package;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackageUpdated⚡️RegistryPackage(mixed $object): mixed
    {
        ...
        $package_version = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookRegistryPackageUpdated⚡️RegistryPackage⚡️PackageVersion($package_version);
        after_package_version:        $result['package_version'] = $package_version;
        ...
        $registry = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️WebhookCheckSuiteCompleted⚡️ActionsMeta($registry);
        after_registry:        $result['registry'] = $registry;
