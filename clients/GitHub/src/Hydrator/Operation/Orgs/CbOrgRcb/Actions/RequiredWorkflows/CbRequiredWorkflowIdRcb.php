...
namespace ApiClients\Client\GitHub\Hydrator\Operation\Orgs\CbOrgRcb\Actions\RequiredWorkflows;
...
class CbRequiredWorkflowIdRcb implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHub\Schema\RequiredWorkflow' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️RequiredWorkflow($payload),
        ...
        private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️RequiredWorkflow(array $payload): \ApiClients\Client\GitHub\Schema\RequiredWorkflow
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\RequiredWorkflow', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\RequiredWorkflow::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHub\Schema\RequiredWorkflow(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\RequiredWorkflow', $exception, stack: $this->hydrationStack);
            }
        }
    ...
    public function serializeObject(object $object): mixed
    {
        try {
            ...
            return match($className) {
                ...
                'ApiClients\Client\GitHub\Schema\RequiredWorkflow' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️RequiredWorkflow($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️RequiredWorkflow(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHub\Schema\RequiredWorkflow);
        $result = [];
