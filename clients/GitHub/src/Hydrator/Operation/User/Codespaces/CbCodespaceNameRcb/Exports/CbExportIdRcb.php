...
namespace ApiClients\Client\GitHub\Hydrator\Operation\User\Codespaces\CbCodespaceNameRcb\Exports;
...
class CbExportIdRcb implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHub\Schema\CodespaceExportDetails' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️CodespaceExportDetails($payload),
