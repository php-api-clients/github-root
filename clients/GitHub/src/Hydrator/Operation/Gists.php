...
class Gists implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHub\Schema\BaseGist' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️BaseGist($payload),
                ...
                'ApiClients\Client\GitHub\Schema\BaseGist\Files' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️BaseGist⚡️Files($payload),
                ...
                'ApiClients\Client\GitHub\Schema\GistSimple\Files' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️GistSimple⚡️Files($payload),
            ...
            try {
                ...
                if (is_array($value)) {
                    try {
                        ...
                        $value = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️BaseGist⚡️Files($value);
                    } finally {
        ...
        private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️GistSimple(array $payload): \ApiClients\Client\GitHub\Schema\GistSimple
        {
            ...
            try {
                ...
                if (is_array($value)) {
                    try {
                        $this->hydrationStack[] = 'files';
                        $value = $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️GistSimple⚡️Files($value);
                    } finally {
                        array_pop($this->hydrationStack);
                    }
                }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️BaseGist⚡️Files(array $payload): \ApiClients\Client\GitHub\Schema\BaseGist\Files
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\BaseGist\Files', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\BaseGist\Files::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHub\Schema\BaseGist\Files(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\BaseGist\Files', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️GistSimple⚡️Files(array $payload): \ApiClients\Client\GitHub\Schema\GistSimple\Files
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\GistSimple\Files', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\GistSimple\Files::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHub\Schema\GistSimple\Files(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\GistSimple\Files', $exception, stack: $this->hydrationStack);
            }
        }
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️BaseGist(mixed $object): mixed
    {
        ...
        $files = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️BaseGist⚡️Files($files);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️GistSimple(mixed $object): mixed
    {
        ...
        $files = $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️GistSimple⚡️Files($files);
        after_files:        $result['files'] = $files;
