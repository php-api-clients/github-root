...
namespace ApiClients\Client\GitHub\Hydrator\Operation\Repos\CbOrgRcb\CbRepoRcb\Actions\RequiredWorkflows;
...
class CbRequiredWorkflowIdForRepoRcb implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHub\Schema\RepoRequiredWorkflow' => $this->hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️RepoRequiredWorkflow($payload),
        ...
        private function hydrateApiClients⚡️Client⚡️GitHub⚡️Schema⚡️RepoRequiredWorkflow(array $payload): \ApiClients\Client\GitHub\Schema\RepoRequiredWorkflow
        {
            $properties = []; 
            $missingFields = [];
            try {
            ...
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHub\Schema\RepoRequiredWorkflow::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHub\Schema\RepoRequiredWorkflow(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHub\Schema\RepoRequiredWorkflow', $exception, stack: $this->hydrationStack);
            }
        }
    ...
    public function serializeObject(object $object): mixed
    {
        try {
            ...
            return match($className) {
                ...
                'ApiClients\Client\GitHub\Schema\RepoRequiredWorkflow' => $this->serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️RepoRequiredWorkflow($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHub⚡️Schema⚡️RepoRequiredWorkflow(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHub\Schema\RepoRequiredWorkflow);
        $result = [];
