...
use ApiClients\Client\GitHub\Internal\Operation\Pulls\ListFiles;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Pulls\ListFiles */
final class ListFilesTest extends AsyncTestCase
{
    ...
    public function call_httpCode_422_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repos/generated/generated/pulls/11/files?page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ListFiles::OPERATION_MATCH, (static function (array $data): array {
