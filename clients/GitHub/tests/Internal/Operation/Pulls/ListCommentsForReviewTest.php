...
use ApiClients\Client\GitHub\Internal\Operation\Pulls\ListCommentsForReview;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Pulls\ListCommentsForReview */
final class ListCommentsForReviewTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repos/generated/generated/pulls/11/reviews/9/comments?page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ListCommentsForReview::OPERATION_MATCH, (static function (array $data): array {
