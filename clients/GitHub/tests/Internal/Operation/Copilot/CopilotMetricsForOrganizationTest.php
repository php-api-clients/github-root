...
use ApiClients\Client\GitHub\Internal\Operation\Copilot\CopilotMetricsForOrganization;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Copilot\CopilotMetricsForOrganization */
final class CopilotMetricsForOrganizationTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_500_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/orgs/generated/copilot/metrics?page=1&per_page=8&since=generated&until=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(CopilotMetricsForOrganization::OPERATION_MATCH, (static function (array $data): array {
            $data['org']      = 'generated';
    ...
    public function operations_httpCode_500_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/orgs/generated/copilot/metrics?page=1&per_page=8&since=generated&until=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->copilot()->copilotMetricsForOrganization('generated', 'generated', 'generated', 1, 8);
    }
