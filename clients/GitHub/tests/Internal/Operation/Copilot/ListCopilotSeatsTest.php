...
use ApiClients\Client\GitHub\Internal\Operation\Copilot\ListCopilotSeats;
...
final class ListCopilotSeatsTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(ListCopilotSeats::OPERATION_MATCH, (static function (array $data): array {
            $data['org']      = 'generated';
            $data['page']     = 1;
            $data['per_page'] = 8;
