...
use ApiClients\Client\GitHub\Internal\Operation\Copilot\CancelCopilotSeatAssignmentForUsers;
use ApiClients\Client\GitHub\Schema\Copilot\CancelCopilotSeatAssignmentForUsers\Request\ApplicationJson;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Copilot\CancelCopilotSeatAssignmentForUsers */
final class CancelCopilotSeatAssignmentForUsersTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/orgs/generated/copilot/billing/selected_users', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(CancelCopilotSeatAssignmentForUsers::OPERATION_MATCH, (static function (array $data): array {
            $data['org'] = 'generated';
    ...
    public function operations_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/orgs/generated/copilot/billing/selected_users', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->copilot()->cancelCopilotSeatAssignmentForUsers('generated', json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
