...
use ApiClients\Client\GitHub\Internal\Operation\Copilot\AddCopilotSeatsForTeams;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Copilot\AddCopilotSeatsForTeams */
final class AddCopilotSeatsForTeamsTest extends AsyncTestCase
{
    ...
    public function call_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/orgs/generated/copilot/billing/selected_teams', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(AddCopilotSeatsForTeams::OPERATION_MATCH, (static function (array $data): array {
            $data['org'] = 'generated';
    ...
    public function operations_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/orgs/generated/copilot/billing/selected_teams', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->copilot()->addCopilotSeatsForTeams('generated', json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
