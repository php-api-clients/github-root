...
use ApiClients\Client\GitHub\Internal\Operation\Copilot\CopilotMetricsForEnterprise;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Copilot\CopilotMetricsForEnterprise */
final class CopilotMetricsForEnterpriseTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_500_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/enterprises/generated/copilot/metrics?page=1&per_page=8&since=generated&until=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(CopilotMetricsForEnterprise::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_500_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/enterprises/generated/copilot/metrics?page=1&per_page=8&since=generated&until=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->copilot()->copilotMetricsForEnterprise('generated', 'generated', 'generated', 1, 8);
    }
