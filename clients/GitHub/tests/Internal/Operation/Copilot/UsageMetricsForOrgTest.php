...
use ApiClients\Client\GitHub\Internal\Operation\Copilot\UsageMetricsForOrg;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Copilot\UsageMetricsForOrg */
final class UsageMetricsForOrgTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_500_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/orgs/generated/copilot/usage?page=1&per_page=8&since=generated&until=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(UsageMetricsForOrg::OPERATION_MATCH, (static function (array $data): array {
            $data['org']      = 'generated';
    ...
    public function operations_httpCode_500_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/orgs/generated/copilot/usage?page=1&per_page=8&since=generated&until=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->copilot()->usageMetricsForOrg('generated', 'generated', 'generated', 1, 8);
    }
