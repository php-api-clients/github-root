...
use ApiClients\Client\GitHub\Internal\Operation\Copilot\AddCopilotSeatsForUsers;
use ApiClients\Client\GitHub\Schema\Copilot\AddCopilotSeatsForUsers\Request\ApplicationJson;
...
final class AddCopilotSeatsForUsersTest extends AsyncTestCase
{
    ...
    public function call_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/orgs/generated/copilot/billing/selected_users', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(AddCopilotSeatsForUsers::OPERATION_MATCH, (static function (array $data): array {
            $data['org'] = 'generated';
    ...
    public function operations_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/orgs/generated/copilot/billing/selected_users', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->copilot()->addCopilotSeatsForUsers('generated', json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
