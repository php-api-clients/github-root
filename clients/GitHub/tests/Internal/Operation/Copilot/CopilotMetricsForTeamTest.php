...
use ApiClients\Client\GitHub\Internal\Operation\Copilot\CopilotMetricsForTeam;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Copilot\CopilotMetricsForTeam */
final class CopilotMetricsForTeamTest extends AsyncTestCase
{
    ...
    public function call_httpCode_500_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/orgs/generated/team/generated/copilot/metrics?page=1&per_page=8&since=generated&until=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(CopilotMetricsForTeam::OPERATION_MATCH, (static function (array $data): array {
            $data['org']       = 'generated';
