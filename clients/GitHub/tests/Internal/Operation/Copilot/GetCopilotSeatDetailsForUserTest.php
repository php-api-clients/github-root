...
use ApiClients\Client\GitHub\Internal\Operation\Copilot\GetCopilotSeatDetailsForUser;
...
final class GetCopilotSeatDetailsForUserTest extends AsyncTestCase
{
    ...
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(CopilotSeatDetails::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(GetCopilotSeatDetailsForUser::OPERATION_MATCH, (static function (array $data): array {
            $data['org']      = 'generated';
