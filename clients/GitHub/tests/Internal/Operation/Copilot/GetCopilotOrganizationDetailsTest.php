...
use ApiClients\Client\GitHub\Internal\Operation\Copilot\GetCopilotOrganizationDetails;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Copilot\GetCopilotOrganizationDetails */
final class GetCopilotOrganizationDetailsTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(CopilotOrganizationDetails::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(GetCopilotOrganizationDetails::OPERATION_MATCH, (static function (array $data): array {
            $data['org'] = 'generated';
