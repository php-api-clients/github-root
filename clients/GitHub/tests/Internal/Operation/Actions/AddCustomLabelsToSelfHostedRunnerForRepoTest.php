...
use ApiClients\Client\GitHub\Internal\Operation\Actions\AddCustomLabelsToSelfHostedRunnerForRepo;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Actions\AddCustomLabelsToSelfHostedRunnerForRepo */
final class AddCustomLabelsToSelfHostedRunnerForRepoTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/repos/generated/generated/actions/runners/9/labels', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(AddCustomLabelsToSelfHostedRunnerForRepo::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/repos/generated/generated/actions/runners/9/labels', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->actions()->addCustomLabelsToSelfHostedRunnerForRepo('generated', 'generated', 9, json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
