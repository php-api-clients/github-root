...
use ApiClients\Client\GitHub\Internal\Operation\Actions\CreateRegistrationTokenForRepo;
...
final class CreateRegistrationTokenForRepoTest extends AsyncTestCase
{
    ...
    public function call_httpCode_201_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(CreateRegistrationTokenForRepo::OPERATION_MATCH, (static function (array $data): array {
