...
use ApiClients\Client\GitHub\Internal\Operation\Actions\CreateRemoveTokenForOrg;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Actions\CreateRemoveTokenForOrg */
final class CreateRemoveTokenForOrgTest extends AsyncTestCase
{
    ...
    public function call_httpCode_201_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(CreateRemoveTokenForOrg::OPERATION_MATCH, (static function (array $data): array {
            $data['org'] = 'generated';
