...
use ApiClients\Client\GitHub\Internal\Operation\Actions\RemoveCustomLabelFromSelfHostedRunnerForOrg;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Actions\RemoveCustomLabelFromSelfHostedRunnerForOrg */
final class RemoveCustomLabelFromSelfHostedRunnerForOrgTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(RemoveCustomLabelFromSelfHostedRunnerForOrg::OPERATION_MATCH, (static function (array $data): array {
            $data['org']       = 'generated';
            $data['runner_id'] = 9;
            $data['name']      = 'generated';
