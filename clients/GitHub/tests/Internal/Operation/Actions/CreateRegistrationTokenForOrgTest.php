...
use ApiClients\Client\GitHub\Internal\Operation\Actions\CreateRegistrationTokenForOrg;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Actions\CreateRegistrationTokenForOrg */
final class CreateRegistrationTokenForOrgTest extends AsyncTestCase
{
    ...
    {
        $response = new Response(201, ['Content-Type' => 'application/json'], json_encode(json_decode(AuthenticationToken::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(CreateRegistrationTokenForOrg::OPERATION_MATCH, (static function (array $data): array {
            $data['org'] = 'generated';
