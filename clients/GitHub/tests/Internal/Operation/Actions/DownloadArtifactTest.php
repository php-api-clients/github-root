...
use ApiClients\Client\GitHub\Internal\Operation\Actions\DownloadArtifact;
...
final class DownloadArtifactTest extends AsyncTestCase
{
    ...
    public function call_httpCode_410_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(DownloadArtifact::OPERATION_MATCH, (static function (array $data): array {
