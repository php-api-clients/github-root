...
use ApiClients\Client\GitHub\Internal\Operation\Actions\CancelWorkflowRun;
...
final class CancelWorkflowRunTest extends AsyncTestCase
{
    ...
    {
        $response = new Response(202, ['Content-Type' => 'application/json'], json_encode(json_decode(EmptyObject::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(CancelWorkflowRun::OPERATION_MATCH, (static function (array $data): array {
