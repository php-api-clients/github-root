...
use ApiClients\Client\GitHub\Internal\Operation\Actions\ListSelectedReposForOrgVariable;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Actions\ListSelectedReposForOrgVariable */
final class ListSelectedReposForOrgVariableTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(ListSelectedReposForOrgVariable::OPERATION_MATCH, (static function (array $data): array {
            $data['org']      = 'generated';
            $data['name']     = 'generated';
            $data['page']     = 1;
            $data['per_page'] = 8;
