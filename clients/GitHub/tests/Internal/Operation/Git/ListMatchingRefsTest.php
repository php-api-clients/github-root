...
use ApiClients\Client\GitHub\Internal\Operation\Git\ListMatchingRefs;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Git\ListMatchingRefs */
final class ListMatchingRefsTest extends AsyncTestCase
{
    ...
    public function call_httpCode_409_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(ListMatchingRefs::OPERATION_MATCH, (static function (array $data): array {
