...
use ApiClients\Client\GitHub\Internal\Operation\Git\GetTree;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Git\GetTree */
final class GetTreeTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(GitTree::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(GetTree::OPERATION_MATCH, (static function (array $data): array {
