...
use ApiClients\Client\GitHub\Internal\Operation\Git\GetBlob;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Git\GetBlob */
final class GetBlobTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(Blob::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(GetBlob::OPERATION_MATCH, (static function (array $data): array {
