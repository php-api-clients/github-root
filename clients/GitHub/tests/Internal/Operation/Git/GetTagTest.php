...
use ApiClients\Client\GitHub\Internal\Operation\Git\GetTag;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Git\GetTag */
final class GetTagTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(GitTag::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(GetTag::OPERATION_MATCH, (static function (array $data): array {
