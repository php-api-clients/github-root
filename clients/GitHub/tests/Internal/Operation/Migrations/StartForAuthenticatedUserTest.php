...
use ApiClients\Client\GitHub\Internal\Operation\Migrations\StartForAuthenticatedUser;
use ApiClients\Client\GitHub\Schema\Migration;
use ApiClients\Client\GitHub\Schema\Migrations\StartForAuthenticatedUser\Request\ApplicationJson;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Migrations\StartForAuthenticatedUser */
final class StartForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/user/migrations', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
    ...
    public function operations_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/user/migrations', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->migrations()->startForAuthenticatedUser(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
