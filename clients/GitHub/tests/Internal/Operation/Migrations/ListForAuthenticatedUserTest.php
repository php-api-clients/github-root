...
use ApiClients\Client\GitHub\Internal\Operation\Migrations\ListForAuthenticatedUser;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Migrations\ListForAuthenticatedUser */
final class ListForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/user/migrations?page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
