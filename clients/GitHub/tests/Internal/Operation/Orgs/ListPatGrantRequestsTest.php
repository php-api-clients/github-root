...
use ApiClients\Client\GitHub\Internal\Operation\Orgs\ListPatGrantRequests;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Orgs\ListPatGrantRequests */
final class ListPatGrantRequestsTest extends AsyncTestCase
{
    ...
    public function call_httpCode_500_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/orgs/generated/personal-access-token-requests?direction=generated&last_used_after=1970-01-01T00%3A00%3A00%2B00%3A00&last_used_before=1970-01-01T00%3A00%3A00%2B00%3A00&owner=generated&page=1&per_page=8&permission=generated&repository=generated&sort=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ListPatGrantRequests::OPERATION_MATCH, (static function (array $data): array {
            $data['org']              = 'generated';
    ...
    public function operations_httpCode_500_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/orgs/generated/personal-access-token-requests?direction=generated&last_used_after=1970-01-01T00%3A00%3A00%2B00%3A00&last_used_before=1970-01-01T00%3A00%3A00%2B00%3A00&owner=generated&page=1&per_page=8&permission=generated&repository=generated&sort=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->orgs()->listPatGrantRequests('generated', ['generated'], 'generated', 'generated', '1970-01-01T00:00:00+00:00', '1970-01-01T00:00:00+00:00', 8, 1, 'generated', 'generated');
    }
