...
use ApiClients\Client\GitHub\Internal\Operation\Orgs\CreateOrUpdateCustomPropertiesValuesForRepos;
use ApiClients\Client\GitHub\Schema\Orgs\CreateOrUpdateCustomPropertiesValuesForRepos\Request\ApplicationJson;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Orgs\CreateOrUpdateCustomPropertiesValuesForRepos */
final class CreateOrUpdateCustomPropertiesValuesForReposTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_403_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PATCH', '/orgs/generated/properties/values', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(CreateOrUpdateCustomPropertiesValuesForRepos::OPERATION_MATCH, (static function (array $data): array {
            $data['org'] = 'generated';
    ...
    public function operations_httpCode_403_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PATCH', '/orgs/generated/properties/values', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->orgs()->createOrUpdateCustomPropertiesValuesForRepos('generated', json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
