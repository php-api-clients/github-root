...
use ApiClients\Client\GitHub\Internal\Operation\Orgs\ListPendingInvitations;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Orgs\ListPendingInvitations */
final class ListPendingInvitationsTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/orgs/generated/invitations?invitation_source=generated&page=1&per_page=8&role=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ListPendingInvitations::OPERATION_MATCH, (static function (array $data): array {
            $data['org']               = 'generated';
            $data['per_page']          = 8;
            $data['page']              = 1;
            $data['role']              = 'generated';
