...
use ApiClients\Client\GitHub\Internal\Operation\Orgs\ListMembershipsForAuthenticatedUser;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Orgs\ListMembershipsForAuthenticatedUser */
final class ListMembershipsForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/user/memberships/orgs?page=1&per_page=8&state=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ListMembershipsForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
