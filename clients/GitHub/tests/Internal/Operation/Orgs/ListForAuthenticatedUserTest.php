...
use ApiClients\Client\GitHub\Internal\Operation\Orgs\ListForAuthenticatedUser;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Orgs\ListForAuthenticatedUser */
final class ListForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/user/orgs?page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
