...
use ApiClients\Client\GitHub\Internal\Operation\Orgs\CancelInvitation;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Orgs\CancelInvitation */
final class CancelInvitationTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_422_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/orgs/generated/invitations/13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(CancelInvitation::OPERATION_MATCH, (static function (array $data): array {
            $data['org']           = 'generated';
    ...
    public function operations_httpCode_422_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/orgs/generated/invitations/13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->orgs()->cancelInvitation('generated', 13);
    }
