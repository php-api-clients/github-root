...
use ApiClients\Client\GitHub\Internal\Operation\Interactions\SetRestrictionsForAuthenticatedUser;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Interactions\SetRestrictionsForAuthenticatedUser */
final class SetRestrictionsForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/user/interaction-limits', Argument::type('array'), json_encode(json_decode(InteractionLimit::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(SetRestrictionsForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
            return $data;
    ...
    public function operations_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/user/interaction-limits', Argument::type('array'), json_encode(json_decode(InteractionLimit::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->interactions()->setRestrictionsForAuthenticatedUser(json_decode(InteractionLimit::SCHEMA_EXAMPLE_DATA, true));
    }
