...
use ApiClients\Client\GitHub\Internal\Operation\Activity\ListWatchedReposForAuthenticatedUser;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Activity\ListWatchedReposForAuthenticatedUser */
final class ListWatchedReposForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/user/subscriptions?page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ListWatchedReposForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
            $data['per_page'] = 8;
            $data['page']     = 1;
