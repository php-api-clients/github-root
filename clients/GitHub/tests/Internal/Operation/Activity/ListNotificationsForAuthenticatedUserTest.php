...
use ApiClients\Client\GitHub\Internal\Operation\Activity\ListNotificationsForAuthenticatedUser;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Activity\ListNotificationsForAuthenticatedUser */
final class ListNotificationsForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/notifications?all=0&before=1970-01-01T00%3A00%3A00%2B00%3A00&page=1&participating=0&per_page=8&since=1970-01-01T00%3A00%3A00%2B00%3A00', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ListNotificationsForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
