...
use ApiClients\Client\GitHub\Internal\Operation\Activity\ListReposStarredByAuthenticatedUser;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Activity\ListReposStarredByAuthenticatedUser */
final class ListReposStarredByAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/user/starred?direction=generated&page=1&per_page=8&sort=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ListReposStarredByAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
            $data['sort']      = 'generated';
