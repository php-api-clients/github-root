...
use ApiClients\Client\GitHub\Internal\Operation\Activity\GetThread;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Activity\GetThread */
final class GetThreadTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(Thread::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(GetThread::OPERATION_MATCH, (static function (array $data): array {
            $data['thread_id'] = 9;
