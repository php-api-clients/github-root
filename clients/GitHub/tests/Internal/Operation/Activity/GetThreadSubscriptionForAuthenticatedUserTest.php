...
use ApiClients\Client\GitHub\Internal\Operation\Activity\GetThreadSubscriptionForAuthenticatedUser;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Activity\GetThreadSubscriptionForAuthenticatedUser */
final class GetThreadSubscriptionForAuthenticatedUserTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(ThreadSubscription::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(GetThreadSubscriptionForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
            $data['thread_id'] = 9;
