...
use ApiClients\Client\GitHub\Internal\Operation\Activity\SetThreadSubscription;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Activity\SetThreadSubscription */
final class SetThreadSubscriptionTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/notifications/threads/9/subscription', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(SetThreadSubscription::OPERATION_MATCH, (static function (array $data): array {
            $data['thread_id'] = 9;
    ...
    public function operations_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/notifications/threads/9/subscription', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->activity()->setThreadSubscription(9, json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
