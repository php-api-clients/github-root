...
use ApiClients\Client\GitHub\Internal\Operation\Activity\DeleteThreadSubscription;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Activity\DeleteThreadSubscription */
final class DeleteThreadSubscriptionTest extends AsyncTestCase
{
    ...
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(DeleteThreadSubscription::OPERATION_MATCH, (static function (array $data): array {
            $data['thread_id'] = 9;
