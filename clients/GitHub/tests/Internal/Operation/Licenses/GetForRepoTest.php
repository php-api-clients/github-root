...
namespace ApiClients\Tests\Client\GitHub\Internal\Operation\Licenses;

use ApiClients\Client\GitHub\Client;
use ApiClients\Client\GitHub\Error\BasicError;
use ApiClients\Client\GitHub\Internal\Operation\Licenses\GetForRepo;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Licenses\GetForRepo */
final class GetForRepoTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(LicenseContent::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(GetForRepo::OPERATION_MATCH, (static function (array $data): array {
