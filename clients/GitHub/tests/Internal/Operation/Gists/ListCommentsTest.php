...
use ApiClients\Client\GitHub\Internal\Operation\Gists\ListComments;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Gists\ListComments */
final class ListCommentsTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/gists/generated/comments?page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
