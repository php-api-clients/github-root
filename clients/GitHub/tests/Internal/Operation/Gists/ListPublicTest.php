...
use ApiClients\Client\GitHub\Internal\Operation\Gists\ListPublic;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Gists\ListPublic */
final class ListPublicTest extends AsyncTestCase
{
    ...
    public function call_httpCode_422_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/gists/public?page=1&per_page=8&since=1970-01-01T00%3A00%3A00%2B00%3A00', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ListPublic::OPERATION_MATCH, (static function (array $data): array {
