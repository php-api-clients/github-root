...
use ApiClients\Client\GitHub\Internal\Operation\Gists\ListCommits;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Gists\ListCommits */
final class ListCommitsTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/gists/generated/commits?page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
