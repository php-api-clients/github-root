...
use ApiClients\Client\GitHub\Internal\Operation\Gists\Fork;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Gists\Fork */
final class ForkTest extends AsyncTestCase
{
    ...
    {
        $response = new Response(201, ['Content-Type' => 'application/json'], json_encode(json_decode(BaseGist::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(Fork::OPERATION_MATCH, (static function (array $data): array {
