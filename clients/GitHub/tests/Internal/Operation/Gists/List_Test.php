...
use ApiClients\Client\GitHub\Internal\Operation\Gists\List_;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Gists\List_ */
final class List_Test extends AsyncTestCase
{
    ...
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/gists?page=1&per_page=8&since=1970-01-01T00%3A00%3A00%2B00%3A00', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
