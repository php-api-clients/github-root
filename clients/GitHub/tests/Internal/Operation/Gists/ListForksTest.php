...
use ApiClients\Client\GitHub\Internal\Operation\Gists\ListForks;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Gists\ListForks */
final class ListForksTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/gists/generated/forks?page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
