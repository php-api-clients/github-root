...
use ApiClients\Client\GitHub\Internal\Operation\SecurityAdvisories\ListRepositoryAdvisories;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\SecurityAdvisories\ListRepositoryAdvisories */
final class ListRepositoryAdvisoriesTest extends AsyncTestCase
{
    ...
    public function call_httpCode_400_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repos/generated/generated/security-advisories?after=generated&before=generated&direction=generated&per_page=8&sort=generated&state=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ListRepositoryAdvisories::OPERATION_MATCH, (static function (array $data): array {
