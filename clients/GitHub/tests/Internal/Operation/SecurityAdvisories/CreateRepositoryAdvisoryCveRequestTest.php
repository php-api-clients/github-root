...
use ApiClients\Client\GitHub\Internal\Operation\SecurityAdvisories\CreateRepositoryAdvisoryCveRequest;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\SecurityAdvisories\CreateRepositoryAdvisoryCveRequest */
final class CreateRepositoryAdvisoryCveRequestTest extends AsyncTestCase
{
    ...
    public function call_httpCode_202_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(CreateRepositoryAdvisoryCveRequest::OPERATION_MATCH, (static function (array $data): array {
