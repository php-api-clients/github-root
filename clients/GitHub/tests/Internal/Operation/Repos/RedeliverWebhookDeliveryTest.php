...
use ApiClients\Client\GitHub\Internal\Operation\Repos\RedeliverWebhookDelivery;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Repos\RedeliverWebhookDelivery */
final class RedeliverWebhookDeliveryTest extends AsyncTestCase
{
    ...
    public function call_httpCode_202_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(RedeliverWebhookDelivery::OPERATION_MATCH, (static function (array $data): array {
