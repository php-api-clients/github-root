...
use ApiClients\Client\GitHub\Internal\Operation\Repos\DeclineInvitationForAuthenticatedUser;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Repos\DeclineInvitationForAuthenticatedUser */
final class DeclineInvitationForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_409_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(DeclineInvitationForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
