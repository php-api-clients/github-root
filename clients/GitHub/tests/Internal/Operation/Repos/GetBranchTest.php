...
use ApiClients\Client\GitHub\Internal\Operation\Repos\GetBranch;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Repos\GetBranch */
final class GetBranchTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(BranchWithProtection::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(GetBranch::OPERATION_MATCH, (static function (array $data): array {
