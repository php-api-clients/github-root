...
use ApiClients\Client\GitHub\Internal\Operation\Repos\ListPublic;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Repos\ListPublic */
final class ListPublicTest extends AsyncTestCase
{
    ...
    public function call_httpCode_422_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repositories?since=5', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
    ...
    public function operations_httpCode_422_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repositories?since=5', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->repos()->listPublic(5);
    }
