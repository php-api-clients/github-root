...
use ApiClients\Client\GitHub\Internal\Operation\Repos\GetCommit;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Repos\GetCommit */
final class GetCommitTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(Commit::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(GetCommit::OPERATION_MATCH, (static function (array $data): array {
