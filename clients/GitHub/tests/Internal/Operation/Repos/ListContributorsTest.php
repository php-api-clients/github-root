...
use ApiClients\Client\GitHub\Internal\Operation\Repos\ListContributors;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Repos\ListContributors */
final class ListContributorsTest extends AsyncTestCase
{
    ...
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repos/generated/generated/contributors?anon=generated&page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ListContributors::OPERATION_MATCH, (static function (array $data): array {
