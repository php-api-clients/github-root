...
use ApiClients\Client\GitHub\Internal\Operation\Repos\ListForks;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Repos\ListForks */
final class ListForksTest extends AsyncTestCase
{
    ...
    public function call_httpCode_400_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repos/generated/generated/forks?page=1&per_page=8&sort=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ListForks::OPERATION_MATCH, (static function (array $data): array {
