...
use ApiClients\Client\GitHub\Internal\Operation\Repos\CreateOrUpdateCustomPropertiesValues;
use ApiClients\Client\GitHub\Schema\Repos\CreateOrUpdateCustomPropertiesValues\Request\ApplicationJson;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Repos\CreateOrUpdateCustomPropertiesValues */
final class CreateOrUpdateCustomPropertiesValuesTest extends AsyncTestCase
{
    ...
    public function call_httpCode_403_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PATCH', '/repos/generated/generated/properties/values', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(CreateOrUpdateCustomPropertiesValues::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_403_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PATCH', '/repos/generated/generated/properties/values', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->repos()->createOrUpdateCustomPropertiesValues('generated', 'generated', json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
