...
use ApiClients\Client\GitHub\Internal\Operation\Repos\AddStatusCheckContexts;
use ApiClients\Client\GitHub\Schema\Repos\AddStatusCheckContexts\Request\ApplicationJson;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Repos\AddStatusCheckContexts */
final class AddStatusCheckContextsTest extends AsyncTestCase
{
    ...
    public function call_httpCode_422_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/repos/generated/generated/branches/generated/protection/required_status_checks/contexts', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(AddStatusCheckContexts::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_422_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/repos/generated/generated/branches/generated/protection/required_status_checks/contexts', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->repos()->addStatusCheckContexts('generated', 'generated', 'generated', json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
