...
use ApiClients\Client\GitHub\Internal\Operation\Repos\GetStatusChecksProtection;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Repos\GetStatusChecksProtection */
final class GetStatusChecksProtectionTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(StatusCheckPolicy::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(GetStatusChecksProtection::OPERATION_MATCH, (static function (array $data): array {
