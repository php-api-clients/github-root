...
use ApiClients\Client\GitHub\Internal\Operation\Repos\GetRepoRuleSuites;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Repos\GetRepoRuleSuites */
final class GetRepoRuleSuitesTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repos/generated/generated/rulesets/rule-suites?actor_name=generated&page=1&per_page=8&ref=generated&rule_suite_result=generated&time_period=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(GetRepoRuleSuites::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repos/generated/generated/rulesets/rule-suites?actor_name=generated&page=1&per_page=8&ref=generated&rule_suite_result=generated&time_period=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->repos()->getRepoRuleSuites('generated', 'generated', 'generated', 'generated', 'generated', 'generated', 8, 1);
    }
