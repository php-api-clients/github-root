...
use ApiClients\Client\GitHub\Internal\Operation\Repos\DeleteOrgRuleset;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Repos\DeleteOrgRuleset */
final class DeleteOrgRulesetTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/orgs/generated/rulesets/10', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(DeleteOrgRuleset::OPERATION_MATCH, (static function (array $data): array {
            $data['org']        = 'generated';
            $data['ruleset_id'] = 10;
    ...
    public function operations_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/orgs/generated/rulesets/10', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->repos()->deleteOrgRuleset('generated', 10);
    }
