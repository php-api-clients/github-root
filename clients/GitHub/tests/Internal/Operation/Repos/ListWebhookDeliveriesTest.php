...
use ApiClients\Client\GitHub\Internal\Operation\Repos\ListWebhookDeliveries;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Repos\ListWebhookDeliveries */
final class ListWebhookDeliveriesTest extends AsyncTestCase
{
    ...
    public function call_httpCode_400_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(ListWebhookDeliveries::OPERATION_MATCH, (static function (array $data): array {
