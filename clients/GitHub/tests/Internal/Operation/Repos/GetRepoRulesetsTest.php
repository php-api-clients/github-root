...
use ApiClients\Client\GitHub\Internal\Operation\Repos\GetRepoRulesets;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Repos\GetRepoRulesets */
final class GetRepoRulesetsTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repos/generated/generated/rulesets?includes_parents=0&page=1&per_page=8&targets=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(GetRepoRulesets::OPERATION_MATCH, (static function (array $data): array {
