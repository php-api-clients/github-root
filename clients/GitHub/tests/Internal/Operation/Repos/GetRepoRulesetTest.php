...
use ApiClients\Client\GitHub\Internal\Operation\Repos\GetRepoRuleset;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Repos\GetRepoRuleset */
final class GetRepoRulesetTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repos/generated/generated/rulesets/10?includes_parents=0', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(GetRepoRuleset::OPERATION_MATCH, (static function (array $data): array {
