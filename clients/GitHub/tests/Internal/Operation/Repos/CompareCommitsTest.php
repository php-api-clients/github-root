...
use ApiClients\Client\GitHub\Internal\Operation\Repos\CompareCommits;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Repos\CompareCommits */
final class CompareCommitsTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(CommitComparison::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(CompareCommits::OPERATION_MATCH, (static function (array $data): array {
