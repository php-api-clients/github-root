...
use ApiClients\Client\GitHub\Internal\Operation\Repos\ListPullRequestsAssociatedWithCommit;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Repos\ListPullRequestsAssociatedWithCommit */
final class ListPullRequestsAssociatedWithCommitTest extends AsyncTestCase
{
    ...
    public function call_httpCode_409_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repos/generated/generated/commits/generated/pulls?page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ListPullRequestsAssociatedWithCommit::OPERATION_MATCH, (static function (array $data): array {
