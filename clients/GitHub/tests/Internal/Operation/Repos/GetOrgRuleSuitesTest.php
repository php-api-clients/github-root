...
use ApiClients\Client\GitHub\Internal\Operation\Repos\GetOrgRuleSuites;
...
final class GetOrgRuleSuitesTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/orgs/generated/rulesets/rule-suites?actor_name=generated&page=1&per_page=8&ref=generated&repository_name=generated&rule_suite_result=generated&time_period=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(GetOrgRuleSuites::OPERATION_MATCH, (static function (array $data): array {
            $data['org']               = 'generated';
            $data['ref']               = 'generated';
