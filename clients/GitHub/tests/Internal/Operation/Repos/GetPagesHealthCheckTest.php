...
use ApiClients\Client\GitHub\Internal\Operation\Repos\GetPagesHealthCheck;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Repos\GetPagesHealthCheck */
final class GetPagesHealthCheckTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(PagesHealthCheck::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(GetPagesHealthCheck::OPERATION_MATCH, (static function (array $data): array {
