...
use ApiClients\Client\GitHub\Internal\Operation\Repos\GetOrgRulesets;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Repos\GetOrgRulesets */
final class GetOrgRulesetsTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/orgs/generated/rulesets?page=1&per_page=8&targets=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(GetOrgRulesets::OPERATION_MATCH, (static function (array $data): array {
            $data['org']      = 'generated';
