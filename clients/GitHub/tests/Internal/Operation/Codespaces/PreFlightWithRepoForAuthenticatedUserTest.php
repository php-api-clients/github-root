...
use ApiClients\Client\GitHub\Internal\Operation\Codespaces\PreFlightWithRepoForAuthenticatedUser;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Codespaces\PreFlightWithRepoForAuthenticatedUser */
final class PreFlightWithRepoForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repos/generated/generated/codespaces/new?client_ip=generated&ref=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(PreFlightWithRepoForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
