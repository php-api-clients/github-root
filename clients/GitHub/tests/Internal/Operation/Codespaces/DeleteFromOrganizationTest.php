...
use ApiClients\Client\GitHub\Internal\Operation\Codespaces\DeleteFromOrganization;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Codespaces\DeleteFromOrganization */
final class DeleteFromOrganizationTest extends AsyncTestCase
{
    ...
    public function call_httpCode_202_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(DeleteFromOrganization::OPERATION_MATCH, (static function (array $data): array {
            $data['org']            = 'generated';
