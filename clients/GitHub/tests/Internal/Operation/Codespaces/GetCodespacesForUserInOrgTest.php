...
use ApiClients\Client\GitHub\Internal\Operation\Codespaces\GetCodespacesForUserInOrg;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Codespaces\GetCodespacesForUserInOrg */
final class GetCodespacesForUserInOrgTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/orgs/generated/members/generated/codespaces?page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(GetCodespacesForUserInOrg::OPERATION_MATCH, (static function (array $data): array {
            $data['org']      = 'generated';
