...
use ApiClients\Client\GitHub\Internal\Operation\Codespaces\RepoMachinesForAuthenticatedUser;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Codespaces\RepoMachinesForAuthenticatedUser */
final class RepoMachinesForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repos/generated/generated/codespaces/machines?client_ip=generated&location=generated&ref=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(RepoMachinesForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
