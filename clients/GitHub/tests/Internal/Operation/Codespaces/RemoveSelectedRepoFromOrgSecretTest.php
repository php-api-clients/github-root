...
use ApiClients\Client\GitHub\Internal\Operation\Codespaces\RemoveSelectedRepoFromOrgSecret;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Codespaces\RemoveSelectedRepoFromOrgSecret */
final class RemoveSelectedRepoFromOrgSecretTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/orgs/generated/codespaces/secrets/generated/repositories/13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(RemoveSelectedRepoFromOrgSecret::OPERATION_MATCH, (static function (array $data): array {
            $data['org']           = 'generated';
    ...
    public function operations_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/orgs/generated/codespaces/secrets/generated/repositories/13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->codespaces()->removeSelectedRepoFromOrgSecret('generated', 'generated', 13);
    }
