...
use ApiClients\Client\GitHub\Internal\Operation\Codespaces\ListInRepositoryForAuthenticatedUser;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Codespaces\ListInRepositoryForAuthenticatedUser */
final class ListInRepositoryForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repos/generated/generated/codespaces?page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ListInRepositoryForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
