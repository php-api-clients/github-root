...
use ApiClients\Client\GitHub\Internal\Operation\Codespaces\CheckPermissionsForDevcontainer;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Codespaces\CheckPermissionsForDevcontainer */
final class CheckPermissionsForDevcontainerTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(CodespacesPermissionsCheckForDevcontainer::SCHEMA_EXAMPLE_DATA, true)));
        $auth     = $this->prophesize(AuthenticationInterface::class);
        $auth->authHeader(Argument::any())->willReturn('Bearer beer')->shouldBeCalled();
        $browser = $this->prophesize(Browser::class);
        $browser->withBase(Argument::any())->willReturn($browser->reveal());
        $browser->withFollowRedirects(Argument::any())->willReturn($browser->reveal());
        $browser->request('GET', '/repos/generated/generated/codespaces/permissions_check?devcontainer_path=generated&ref=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(CheckPermissionsForDevcontainer::OPERATION_MATCH, (static function (array $data): array {
            $data['owner']             = 'generated';
            $data['repo']              = 'generated';
            $data['ref']               = 'generated';
            $data['devcontainer_path'] = 'generated';
    ...
    public function operations_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repos/generated/generated/codespaces/permissions_check?devcontainer_path=generated&ref=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->codespaces()->checkPermissionsForDevcontainer('generated', 'generated', 'generated', 'generated');
    }
