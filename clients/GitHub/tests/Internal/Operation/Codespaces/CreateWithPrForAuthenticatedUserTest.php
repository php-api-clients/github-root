...
use ApiClients\Client\GitHub\Internal\Operation\Codespaces\CreateWithPrForAuthenticatedUser;
use ApiClients\Client\GitHub\Schema\Codespace;
use ApiClients\Client\GitHub\Schema\Codespaces\CreateWithPrForAuthenticatedUser\Request\ApplicationJson;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Codespaces\CreateWithPrForAuthenticatedUser */
final class CreateWithPrForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/repos/generated/generated/pulls/11/codespaces', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(CreateWithPrForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/repos/generated/generated/pulls/11/codespaces', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->codespaces()->createWithPrForAuthenticatedUser('generated', 'generated', 11, json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
