...
use ApiClients\Client\GitHub\Internal\Operation\Codespaces\ExportForAuthenticatedUser;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Codespaces\ExportForAuthenticatedUser */
final class ExportForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    {
        $response = new Response(202, ['Content-Type' => 'application/json'], json_encode(json_decode(CodespaceExportDetails::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(ExportForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
