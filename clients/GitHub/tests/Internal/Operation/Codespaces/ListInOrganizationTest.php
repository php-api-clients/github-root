...
use ApiClients\Client\GitHub\Internal\Operation\Codespaces\ListInOrganization;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Codespaces\ListInOrganization */
final class ListInOrganizationTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/orgs/generated/codespaces?page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ListInOrganization::OPERATION_MATCH, (static function (array $data): array {
            $data['org']      = 'generated';
            $data['per_page'] = 8;
            $data['page']     = 1;
