...
use ApiClients\Client\GitHub\Internal\Operation\Codespaces\RemoveRepositoryForSecretForAuthenticatedUser;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Codespaces\RemoveRepositoryForSecretForAuthenticatedUser */
final class RemoveRepositoryForSecretForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_401_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(RemoveRepositoryForSecretForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
