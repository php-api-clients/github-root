...
use ApiClients\Client\GitHub\Internal\Operation\Codespaces\DeleteForAuthenticatedUser;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Codespaces\DeleteForAuthenticatedUser */
final class DeleteForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_202_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(DeleteForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
