...
use ApiClients\Client\GitHub\Internal\Operation\Codespaces\SetCodespacesAccess;
use ApiClients\Client\GitHub\Schema\Codespaces\SetCodespacesAccess\Request\ApplicationJson;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Codespaces\SetCodespacesAccess */
final class SetCodespacesAccessTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/orgs/generated/codespaces/access', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(SetCodespacesAccess::OPERATION_MATCH, (static function (array $data): array {
            $data['org'] = 'generated';
    ...
    public function operations_httpCode_404_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/orgs/generated/codespaces/access', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->codespaces()->setCodespacesAccess('generated', json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
