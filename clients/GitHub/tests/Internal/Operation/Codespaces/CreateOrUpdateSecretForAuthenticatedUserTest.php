...
use ApiClients\Client\GitHub\Internal\Operation\Codespaces\CreateOrUpdateSecretForAuthenticatedUser;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Codespaces\CreateOrUpdateSecretForAuthenticatedUser */
final class CreateOrUpdateSecretForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/user/codespaces/secrets/generated', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(CreateOrUpdateSecretForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/user/codespaces/secrets/generated', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->codespaces()->createOrUpdateSecretForAuthenticatedUser('generated', json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
