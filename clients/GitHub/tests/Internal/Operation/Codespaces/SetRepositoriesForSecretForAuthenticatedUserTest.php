...
use ApiClients\Client\GitHub\Internal\Operation\Codespaces\SetRepositoriesForSecretForAuthenticatedUser;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Codespaces\SetRepositoriesForSecretForAuthenticatedUser */
final class SetRepositoriesForSecretForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_401_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/user/codespaces/secrets/generated/repositories', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(SetRepositoriesForSecretForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_401_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/user/codespaces/secrets/generated/repositories', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->codespaces()->setRepositoriesForSecretForAuthenticatedUser('generated', json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
