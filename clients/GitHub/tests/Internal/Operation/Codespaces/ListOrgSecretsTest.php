...
use ApiClients\Client\GitHub\Internal\Operation\Codespaces\ListOrgSecrets;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Codespaces\ListOrgSecrets */
final class ListOrgSecretsTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/orgs/generated/codespaces/secrets?page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
