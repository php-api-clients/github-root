...
use ApiClients\Client\GitHub\Internal\Operation\Codespaces\DeleteCodespacesAccessUsers;
use ApiClients\Client\GitHub\Schema\Codespaces\DeleteCodespacesAccessUsers\Request\ApplicationJson;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Codespaces\DeleteCodespacesAccessUsers */
final class DeleteCodespacesAccessUsersTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_404_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/orgs/generated/codespaces/access/selected_users', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(DeleteCodespacesAccessUsers::OPERATION_MATCH, (static function (array $data): array {
            $data['org'] = 'generated';
    ...
    public function operations_httpCode_404_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/orgs/generated/codespaces/access/selected_users', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->codespaces()->deleteCodespacesAccessUsers('generated', json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
