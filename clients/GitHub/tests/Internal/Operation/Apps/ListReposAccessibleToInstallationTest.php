...
use ApiClients\Client\GitHub\Internal\Operation\Apps\ListReposAccessibleToInstallation;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Apps\ListReposAccessibleToInstallation */
final class ListReposAccessibleToInstallationTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/installation/repositories?page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ListReposAccessibleToInstallation::OPERATION_MATCH, (static function (array $data): array {
            $data['per_page'] = 8;
            $data['page']     = 1;
