...
use ApiClients\Client\GitHub\Internal\Operation\Apps\ListAccountsForPlanStubbed;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Apps\ListAccountsForPlanStubbed */
final class ListAccountsForPlanStubbedTest extends AsyncTestCase
{
    ...
    public function call_httpCode_401_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/marketplace_listing/stubbed/plans/7/accounts?direction=generated&page=1&per_page=8&sort=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ListAccountsForPlanStubbed::OPERATION_MATCH, (static function (array $data): array {
            $data['plan_id']   = 7;
