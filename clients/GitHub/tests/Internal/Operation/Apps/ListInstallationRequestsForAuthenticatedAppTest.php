...
use ApiClients\Client\GitHub\Internal\Operation\Apps\ListInstallationRequestsForAuthenticatedApp;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Apps\ListInstallationRequestsForAuthenticatedApp */
final class ListInstallationRequestsForAuthenticatedAppTest extends AsyncTestCase
{
    ...
    public function call_httpCode_401_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/app/installation-requests?page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ListInstallationRequestsForAuthenticatedApp::OPERATION_MATCH, (static function (array $data): array {
            $data['per_page'] = 8;
            $data['page']     = 1;
