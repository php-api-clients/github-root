...
use ApiClients\Client\GitHub\Internal\Operation\Apps\ListInstallationsForAuthenticatedUser;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Apps\ListInstallationsForAuthenticatedUser */
final class ListInstallationsForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/user/installations?page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ListInstallationsForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
            $data['per_page'] = 8;
            $data['page']     = 1;
