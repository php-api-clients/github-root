...
use ApiClients\Client\GitHub\Internal\Operation\Apps\GetSubscriptionPlanForAccount;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Apps\GetSubscriptionPlanForAccount */
final class GetSubscriptionPlanForAccountTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/marketplace_listing/accounts/10', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(GetSubscriptionPlanForAccount::OPERATION_MATCH, (static function (array $data): array {
            $data['account_id'] = 10;
    ...
    public function operations_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/marketplace_listing/accounts/10', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->apps()->getSubscriptionPlanForAccount(10);
    }
