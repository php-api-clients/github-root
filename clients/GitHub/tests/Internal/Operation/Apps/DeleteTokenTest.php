...
use ApiClients\Client\GitHub\Internal\Operation\Apps\DeleteToken;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Apps\DeleteToken */
final class DeleteTokenTest extends AsyncTestCase
{
    ...
    public function call_httpCode_422_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/applications/generated/token', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(DeleteToken::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_422_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/applications/generated/token', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->apps()->deleteToken('generated', json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
