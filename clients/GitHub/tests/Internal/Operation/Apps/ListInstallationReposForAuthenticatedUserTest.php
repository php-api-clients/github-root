...
use ApiClients\Client\GitHub\Internal\Operation\Apps\ListInstallationReposForAuthenticatedUser;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Apps\ListInstallationReposForAuthenticatedUser */
final class ListInstallationReposForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/user/installations/15/repositories?page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ListInstallationReposForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
