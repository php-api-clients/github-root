...
use ApiClients\Client\GitHub\Internal\Operation\Apps\DeleteAuthorization;
use ApiClients\Client\GitHub\Schema\Apps\DeleteAuthorization\Request\ApplicationJson;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Apps\DeleteAuthorization */
final class DeleteAuthorizationTest extends AsyncTestCase
{
    ...
    public function call_httpCode_422_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/applications/generated/grant', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(DeleteAuthorization::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_422_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/applications/generated/grant', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->apps()->deleteAuthorization('generated', json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
