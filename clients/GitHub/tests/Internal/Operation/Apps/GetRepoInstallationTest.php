...
use ApiClients\Client\GitHub\Internal\Operation\Apps\GetRepoInstallation;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Apps\GetRepoInstallation */
final class GetRepoInstallationTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(Installation::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(GetRepoInstallation::OPERATION_MATCH, (static function (array $data): array {
