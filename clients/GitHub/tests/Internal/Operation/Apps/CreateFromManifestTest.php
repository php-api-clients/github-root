...
use ApiClients\Client\GitHub\Internal\Operation\Apps\CreateFromManifest;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Apps\CreateFromManifest */
final class CreateFromManifestTest extends AsyncTestCase
{
    ...
    public function call_httpCode_201_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(CreateFromManifest::OPERATION_MATCH, (static function (array $data): array {
            $data['code'] = 'generated';
