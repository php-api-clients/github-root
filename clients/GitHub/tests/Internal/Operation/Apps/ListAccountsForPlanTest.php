...
use ApiClients\Client\GitHub\Internal\Operation\Apps\ListAccountsForPlan;
...
final class ListAccountsForPlanTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/marketplace_listing/plans/7/accounts?direction=generated&page=1&per_page=8&sort=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ListAccountsForPlan::OPERATION_MATCH, (static function (array $data): array {
            $data['plan_id']   = 7;
