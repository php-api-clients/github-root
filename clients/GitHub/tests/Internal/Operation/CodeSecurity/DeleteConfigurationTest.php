...
use ApiClients\Client\GitHub\Internal\Operation\CodeSecurity\DeleteConfiguration;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\CodeSecurity\DeleteConfiguration */
final class DeleteConfigurationTest extends AsyncTestCase
{
    ...
    public function call_httpCode_400_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(DeleteConfiguration::OPERATION_MATCH, (static function (array $data): array {
            $data['org']              = 'generated';
