...
use ApiClients\Client\GitHub\Internal\Operation\CodeSecurity\SetConfigurationAsDefault;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\CodeSecurity\SetConfigurationAsDefault */
final class SetConfigurationAsDefaultTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/orgs/generated/code-security/configurations/16/defaults', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(SetConfigurationAsDefault::OPERATION_MATCH, (static function (array $data): array {
            $data['org']              = 'generated';
    ...
    public function operations_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/orgs/generated/code-security/configurations/16/defaults', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->codeSecurity()->setConfigurationAsDefault('generated', 16, json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
