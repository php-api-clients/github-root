...
use ApiClients\Client\GitHub\Internal\Operation\CodeSecurity\DetachConfiguration;
use ApiClients\Client\GitHub\Schema\CodeSecurity\DetachConfiguration\Request\ApplicationJson;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\CodeSecurity\DetachConfiguration */
final class DetachConfigurationTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_400_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/orgs/generated/code-security/configurations/detach', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(DetachConfiguration::OPERATION_MATCH, (static function (array $data): array {
            $data['org'] = 'generated';
    ...
    public function operations_httpCode_400_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/orgs/generated/code-security/configurations/detach', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->codeSecurity()->detachConfiguration('generated', json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
