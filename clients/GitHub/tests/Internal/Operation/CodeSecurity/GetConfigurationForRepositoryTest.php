...
use ApiClients\Client\GitHub\Internal\Operation\CodeSecurity\GetConfigurationForRepository;
...
final class GetConfigurationForRepositoryTest extends AsyncTestCase
{
    ...
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(CodeSecurityConfigurationForRepository::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(GetConfigurationForRepository::OPERATION_MATCH, (static function (array $data): array {
