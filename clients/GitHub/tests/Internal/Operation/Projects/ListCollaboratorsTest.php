...
use ApiClients\Client\GitHub\Internal\Operation\Projects\ListCollaborators;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Projects\ListCollaborators */
final class ListCollaboratorsTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/projects/10/collaborators?affiliation=generated&page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
