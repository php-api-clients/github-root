...
use ApiClients\Client\GitHub\Error\Operations\Projects\Delete\Response\ApplicationJson\Forbidden\Application\Json;
use ApiClients\Client\GitHub\Internal\Operation\Projects\Delete;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Projects\Delete */
final class DeleteTest extends AsyncTestCase
{
    ...
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $response = new Response(403, ['Content-Type' => 'application/json'], json_encode(json_decode(\ApiClients\Client\GitHub\Schema\Operations\Projects\Delete\Response\ApplicationJson\Forbidden\Application\Json::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(Delete::OPERATION_MATCH, (static function (array $data): array {
            $data['project_id'] = 10;
