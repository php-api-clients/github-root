...
use ApiClients\Client\GitHub\Error\Operations\Projects\DeleteCard\Response\ApplicationJson\Forbidden;
use ApiClients\Client\GitHub\Internal\Operation\Projects\DeleteCard;
...
final class DeleteCardTest extends AsyncTestCase
{
    ...
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $response = new Response(403, ['Content-Type' => 'application/json'], json_encode(json_decode(\ApiClients\Client\GitHub\Schema\Operations\Projects\DeleteCard\Response\ApplicationJson\Forbidden::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(DeleteCard::OPERATION_MATCH, (static function (array $data): array {
            $data['card_id'] = 7;
