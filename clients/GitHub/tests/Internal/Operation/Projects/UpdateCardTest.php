...
use ApiClients\Client\GitHub\Internal\Operation\Projects\UpdateCard;
use ApiClients\Client\GitHub\Schema\ProjectCard;
use ApiClients\Client\GitHub\Schema\Projects\UpdateCard\Request\ApplicationJson;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Projects\UpdateCard */
final class UpdateCardTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PATCH', '/projects/columns/cards/7', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(UpdateCard::OPERATION_MATCH, (static function (array $data): array {
            $data['card_id'] = 7;
    ...
    public function operations_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PATCH', '/projects/columns/cards/7', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->projects()->updateCard(7, json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
