...
use ApiClients\Client\GitHub\Internal\Operation\Projects\ListCards;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Projects\ListCards */
final class ListCardsTest extends AsyncTestCase
{
    ...
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/projects/columns/9/cards?archived_state=generated&page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ListCards::OPERATION_MATCH, (static function (array $data): array {
            $data['column_id']      = 9;
