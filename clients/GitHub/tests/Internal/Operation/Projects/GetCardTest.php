...
use ApiClients\Client\GitHub\Internal\Operation\Projects\GetCard;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Projects\GetCard */
final class GetCardTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(ProjectCard::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(GetCard::OPERATION_MATCH, (static function (array $data): array {
            $data['card_id'] = 7;
