...
use ApiClients\Client\GitHub\Internal\Operation\Projects\MoveColumn;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Projects\MoveColumn */
final class MoveColumnTest extends AsyncTestCase
{
    ...
    public function call_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/projects/columns/9/moves', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(MoveColumn::OPERATION_MATCH, (static function (array $data): array {
            $data['column_id'] = 9;
    ...
    public function operations_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/projects/columns/9/moves', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->projects()->moveColumn(9, json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
