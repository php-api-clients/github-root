...
use ApiClients\Client\GitHub\Internal\Operation\Projects\ListForOrg;
...
final class ListForOrgTest extends AsyncTestCase
{
    ...
    public function call_httpCode_422_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/orgs/generated/projects?page=1&per_page=8&state=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
