...
use ApiClients\Client\GitHub\Internal\Operation\Projects\ListColumns;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Projects\ListColumns */
final class ListColumnsTest extends AsyncTestCase
{
    ...
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/projects/10/columns?page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ListColumns::OPERATION_MATCH, (static function (array $data): array {
            $data['project_id'] = 10;
            $data['per_page']   = 8;
            $data['page']       = 1;
