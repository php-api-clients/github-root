...
use ApiClients\Client\GitHub\Internal\Operation\Projects\Get;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Projects\Get */
final class GetTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(Project::SCHEMA_EXAMPLE_DATA, true)));
