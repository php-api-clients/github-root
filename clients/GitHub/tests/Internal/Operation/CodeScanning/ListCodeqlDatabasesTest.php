...
use ApiClients\Client\GitHub\Internal\Operation\CodeScanning\ListCodeqlDatabases;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\CodeScanning\ListCodeqlDatabases */
final class ListCodeqlDatabasesTest extends AsyncTestCase
{
    ...
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(ListCodeqlDatabases::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repos/generated/generated/code-scanning/codeql/databases', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->codeScanning()->listCodeqlDatabases('generated', 'generated');
    }
