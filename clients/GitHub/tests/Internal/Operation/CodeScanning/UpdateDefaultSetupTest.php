...
use ApiClients\Client\GitHub\Internal\Operation\CodeScanning\UpdateDefaultSetup;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\CodeScanning\UpdateDefaultSetup */
final class UpdateDefaultSetupTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(EmptyObject::SCHEMA_EXAMPLE_DATA, true)));
        $auth     = $this->prophesize(AuthenticationInterface::class);
        $auth->authHeader(Argument::any())->willReturn('Bearer beer')->shouldBeCalled();
        $browser = $this->prophesize(Browser::class);
        $browser->withBase(Argument::any())->willReturn($browser->reveal());
        $browser->withFollowRedirects(Argument::any())->willReturn($browser->reveal());
        $browser->request('PATCH', '/repos/generated/generated/code-scanning/default-setup', Argument::type('array'), json_encode(json_decode(CodeScanningDefaultSetupUpdate::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(UpdateDefaultSetup::OPERATION_MATCH, (static function (array $data): array {
            $data['owner'] = 'generated';
            $data['repo']  = 'generated';

            return $data;
        })(json_decode(CodeScanningDefaultSetupUpdate::SCHEMA_EXAMPLE_DATA, true)));
    }
    ...
    public function operations_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PATCH', '/repos/generated/generated/code-scanning/default-setup', Argument::type('array'), json_encode(json_decode(CodeScanningDefaultSetupUpdate::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->codeScanning()->updateDefaultSetup('generated', 'generated', json_decode(CodeScanningDefaultSetupUpdate::SCHEMA_EXAMPLE_DATA, true));
    }

    /** @test */
    public function call_httpCode_202_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        $response = new Response(202, ['Content-Type' => 'application/json'], json_encode(json_decode(CodeScanningDefaultSetupUpdateResponse::SCHEMA_EXAMPLE_DATA, true)));
        $auth     = $this->prophesize(AuthenticationInterface::class);
        $auth->authHeader(Argument::any())->willReturn('Bearer beer')->shouldBeCalled();
        $browser = $this->prophesize(Browser::class);
        $browser->withBase(Argument::any())->willReturn($browser->reveal());
