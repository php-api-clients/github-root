...
use ApiClients\Client\GitHub\Internal\Operation\CodeScanning\GetDefaultSetup;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\CodeScanning\GetDefaultSetup */
final class GetDefaultSetupTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(CodeScanningDefaultSetup::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(GetDefaultSetup::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repos/generated/generated/code-scanning/default-setup', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->codeScanning()->getDefaultSetup('generated', 'generated');
    }
