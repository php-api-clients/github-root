...
use ApiClients\Client\GitHub\Internal\Operation\CodeScanning\GetSarif;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\CodeScanning\GetSarif */
final class GetSarifTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(CodeScanningSarifsStatus::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(GetSarif::OPERATION_MATCH, (static function (array $data): array {
