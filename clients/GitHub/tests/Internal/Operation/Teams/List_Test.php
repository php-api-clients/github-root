...
use ApiClients\Client\GitHub\Internal\Operation\Teams\List_;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Teams\List_ */
final class List_Test extends AsyncTestCase
{
    ...
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/orgs/generated/teams?page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
