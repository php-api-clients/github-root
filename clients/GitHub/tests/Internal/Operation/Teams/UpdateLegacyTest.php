...
use ApiClients\Client\GitHub\Internal\Operation\Teams\UpdateLegacy;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Teams\UpdateLegacy */
final class UpdateLegacyTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PATCH', '/teams/7', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(UpdateLegacy::OPERATION_MATCH, (static function (array $data): array {
            $data['team_id'] = 7;
    ...
    public function operations_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PATCH', '/teams/7', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->teams()->updateLegacy(7, json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
