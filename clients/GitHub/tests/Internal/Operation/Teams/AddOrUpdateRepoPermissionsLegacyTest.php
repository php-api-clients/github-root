...
use ApiClients\Client\GitHub\Internal\Operation\Teams\AddOrUpdateRepoPermissionsLegacy;
use ApiClients\Client\GitHub\Schema\Teams\AddOrUpdateRepoPermissionsLegacy\Request\ApplicationJson;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Teams\AddOrUpdateRepoPermissionsLegacy */
final class AddOrUpdateRepoPermissionsLegacyTest extends AsyncTestCase
{
    ...
    public function call_httpCode_403_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/teams/7/repos/generated/generated', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(AddOrUpdateRepoPermissionsLegacy::OPERATION_MATCH, (static function (array $data): array {
            $data['team_id'] = 7;
    ...
    public function operations_httpCode_403_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/teams/7/repos/generated/generated', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->teams()->addOrUpdateRepoPermissionsLegacy(7, 'generated', 'generated', json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
