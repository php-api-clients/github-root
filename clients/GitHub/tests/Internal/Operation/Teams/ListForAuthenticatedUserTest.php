...
use ApiClients\Client\GitHub\Internal\Operation\Teams\ListForAuthenticatedUser;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Teams\ListForAuthenticatedUser */
final class ListForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/user/teams?page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
