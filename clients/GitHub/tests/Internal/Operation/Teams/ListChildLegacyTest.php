...
use ApiClients\Client\GitHub\Internal\Operation\Teams\ListChildLegacy;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Teams\ListChildLegacy */
final class ListChildLegacyTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/teams/7/teams?page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ListChildLegacy::OPERATION_MATCH, (static function (array $data): array {
            $data['team_id']  = 7;
            $data['per_page'] = 8;
            $data['page']     = 1;
