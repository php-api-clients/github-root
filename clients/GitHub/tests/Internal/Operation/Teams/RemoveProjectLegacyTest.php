...
use ApiClients\Client\GitHub\Internal\Operation\Teams\RemoveProjectLegacy;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Teams\RemoveProjectLegacy */
final class RemoveProjectLegacyTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(RemoveProjectLegacy::OPERATION_MATCH, (static function (array $data): array {
            $data['team_id']    = 7;
            $data['project_id'] = 10;
