...
use ApiClients\Client\GitHub\Internal\Operation\Users\GetGpgKeyForAuthenticatedUser;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Users\GetGpgKeyForAuthenticatedUser */
final class GetGpgKeyForAuthenticatedUserTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(GpgKey::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(GetGpgKeyForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
            $data['gpg_key_id'] = 10;
