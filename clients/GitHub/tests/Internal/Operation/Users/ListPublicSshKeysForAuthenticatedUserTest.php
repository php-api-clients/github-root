...
use ApiClients\Client\GitHub\Internal\Operation\Users\ListPublicSshKeysForAuthenticatedUser;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Users\ListPublicSshKeysForAuthenticatedUser */
final class ListPublicSshKeysForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/user/keys?page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ListPublicSshKeysForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
            $data['per_page'] = 8;
            $data['page']     = 1;
