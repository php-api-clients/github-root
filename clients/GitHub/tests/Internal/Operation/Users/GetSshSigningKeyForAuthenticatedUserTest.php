...
use ApiClients\Client\GitHub\Internal\Operation\Users\GetSshSigningKeyForAuthenticatedUser;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Users\GetSshSigningKeyForAuthenticatedUser */
final class GetSshSigningKeyForAuthenticatedUserTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(SshSigningKey::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(GetSshSigningKeyForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
