...
use ApiClients\Client\GitHub\Internal\Operation\Users\ListAttestations;
...
final class ListAttestationsTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/users/generated/attestations/generated?after=generated&before=generated&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ListAttestations::OPERATION_MATCH, (static function (array $data): array {
