...
use ApiClients\Client\GitHub\Internal\Operation\Users\DeleteSocialAccountForAuthenticatedUser;
use ApiClients\Client\GitHub\Schema\Users\DeleteSocialAccountForAuthenticatedUser\Request\ApplicationJson;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Users\DeleteSocialAccountForAuthenticatedUser */
final class DeleteSocialAccountForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_422_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/user/social_accounts', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(DeleteSocialAccountForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
            return $data;
    ...
    public function operations_httpCode_422_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/user/social_accounts', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->users()->deleteSocialAccountForAuthenticatedUser(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
