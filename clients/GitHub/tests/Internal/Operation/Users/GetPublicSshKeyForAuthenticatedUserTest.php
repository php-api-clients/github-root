...
use ApiClients\Client\GitHub\Internal\Operation\Users\GetPublicSshKeyForAuthenticatedUser;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Users\GetPublicSshKeyForAuthenticatedUser */
final class GetPublicSshKeyForAuthenticatedUserTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(Key::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(GetPublicSshKeyForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
            $data['key_id'] = 6;
