...
use ApiClients\Client\GitHub\Internal\Operation\Users\ListFollowersForAuthenticatedUser;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Users\ListFollowersForAuthenticatedUser */
final class ListFollowersForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/user/followers?page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ListFollowersForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
            $data['per_page'] = 8;
            $data['page']     = 1;
