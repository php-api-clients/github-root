...
use ApiClients\Client\GitHub\Internal\Operation\Reactions\ListForIssue;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Reactions\ListForIssue */
final class ListForIssueTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repos/generated/generated/issues/12/reactions?content=generated&page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ListForIssue::OPERATION_MATCH, (static function (array $data): array {
