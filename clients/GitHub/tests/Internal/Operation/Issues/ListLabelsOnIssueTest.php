...
use ApiClients\Client\GitHub\Internal\Operation\Issues\ListLabelsOnIssue;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Issues\ListLabelsOnIssue */
final class ListLabelsOnIssueTest extends AsyncTestCase
{
    ...
    public function call_httpCode_301_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repos/generated/generated/issues/12/labels?page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ListLabelsOnIssue::OPERATION_MATCH, (static function (array $data): array {
