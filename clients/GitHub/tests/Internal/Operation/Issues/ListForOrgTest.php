...
use ApiClients\Client\GitHub\Internal\Operation\Issues\ListForOrg;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Issues\ListForOrg */
final class ListForOrgTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/orgs/generated/issues?direction=generated&filter=generated&labels=generated&page=1&per_page=8&since=1970-01-01T00%3A00%3A00%2B00%3A00&sort=generated&state=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ListForOrg::OPERATION_MATCH, (static function (array $data): array {
            $data['org']       = 'generated';
