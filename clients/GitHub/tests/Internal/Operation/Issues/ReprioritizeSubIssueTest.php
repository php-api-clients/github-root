...
use ApiClients\Client\GitHub\Internal\Operation\Issues\ReprioritizeSubIssue;
use ApiClients\Client\GitHub\Schema\Issue;
use ApiClients\Client\GitHub\Schema\Issues\ReprioritizeSubIssue\Request\ApplicationJson;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Issues\ReprioritizeSubIssue */
final class ReprioritizeSubIssueTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PATCH', '/repos/generated/generated/issues/12/sub_issues/priority', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ReprioritizeSubIssue::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PATCH', '/repos/generated/generated/issues/12/sub_issues/priority', Argument::type('array'), json_encode(json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->issues()->reprioritizeSubIssue('generated', 'generated', 12, json_decode(ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
