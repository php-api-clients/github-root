...
use ApiClients\Client\GitHub\Internal\Operation\Issues\ListComments;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Issues\ListComments */
final class ListCommentsTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repos/generated/generated/issues/12/comments?page=1&per_page=8&since=1970-01-01T00%3A00%3A00%2B00%3A00', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ListComments::OPERATION_MATCH, (static function (array $data): array {
