...
use ApiClients\Client\GitHub\Internal\Operation\Checks\RerequestSuite;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Checks\RerequestSuite */
final class RerequestSuiteTest extends AsyncTestCase
{
    ...
    public function call_httpCode_201_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(RerequestSuite::OPERATION_MATCH, (static function (array $data): array {
