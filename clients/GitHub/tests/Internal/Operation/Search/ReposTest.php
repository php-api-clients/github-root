...
use ApiClients\Client\GitHub\Internal\Operation\Search\Repos;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Search\Repos */
final class ReposTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/search/repositories?order=generated&page=1&per_page=8&q=generated&sort=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Repos::OPERATION_MATCH, (static function (array $data): array {
            $data['q']        = 'generated';
            $data['sort']     = 'generated';
