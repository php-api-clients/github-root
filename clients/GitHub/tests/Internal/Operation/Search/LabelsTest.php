...
use ApiClients\Client\GitHub\Internal\Operation\Search\Labels;
...
final class LabelsTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/search/labels?order=generated&page=1&per_page=8&q=generated&repository_id=13&sort=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Labels::OPERATION_MATCH, (static function (array $data): array {
