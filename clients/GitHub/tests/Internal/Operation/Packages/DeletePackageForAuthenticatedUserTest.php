...
use ApiClients\Client\GitHub\Internal\Operation\Packages\DeletePackageForAuthenticatedUser;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Packages\DeletePackageForAuthenticatedUser */
final class DeletePackageForAuthenticatedUserTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/user/packages/generated/generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(DeletePackageForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/user/packages/generated/generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->packages()->deletePackageForAuthenticatedUser('generated', 'generated');
    }
