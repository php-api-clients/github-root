...
use ApiClients\Client\GitHub\Internal\Operation\Packages\ListPackagesForUser;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Packages\ListPackagesForUser */
final class ListPackagesForUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/users/generated/packages?package_type=generated&page=1&per_page=8&visibility=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(ListPackagesForUser::OPERATION_MATCH, (static function (array $data): array {
