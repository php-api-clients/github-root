...
use ApiClients\Client\GitHub\Internal\Operation\Packages\RestorePackageForOrg;
...
/** @covers \ApiClients\Client\GitHub\Internal\Operation\Packages\RestorePackageForOrg */
final class RestorePackageForOrgTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/orgs/generated/packages/generated/generated/restore?token=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(RestorePackageForOrg::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/orgs/generated/packages/generated/generated/restore?token=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->packages()->restorePackageForOrg('generated', 'generated', 'generated', 'generated');
    }
