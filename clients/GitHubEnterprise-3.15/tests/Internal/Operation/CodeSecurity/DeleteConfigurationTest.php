...
/** @covers \ApiClients\Client\GitHubEnterprise\Internal\Operation\CodeSecurity\DeleteConfiguration */
final class DeleteConfigurationTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_400_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/orgs/generated/code-security/configurations/16', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\CodeSecurity\DeleteConfiguration::OPERATION_MATCH, (static function (array $data): array {
            $data['org']              = 'generated';
    ...
    public function operations_httpCode_400_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/orgs/generated/code-security/configurations/16', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->codeSecurity()->deleteConfiguration('generated', 16);
    }
