...
/** @covers \ApiClients\Client\GitHubEnterprise\Internal\Operation\EnterpriseAdmin\GetVersion */
final class GetVersionTest extends AsyncTestCase
{
    ...
    public function call_httpCode_401_empty(): void
    {
        ...
        $result = $client->call(Internal\Operation\EnterpriseAdmin\GetVersion::OPERATION_MATCH, (static function (array $data): array {
            $data['uuid']          = 'generated';
