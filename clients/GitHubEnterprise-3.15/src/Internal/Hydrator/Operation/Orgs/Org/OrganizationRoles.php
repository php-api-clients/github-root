...
use ApiClients\Client\GitHubEnterprise\Schema\Operations\Orgs\ListOrgRoles\Response\ApplicationJson\Ok;
...
class OrganizationRoles implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubEnterprise\Schema\Operations\Orgs\ListOrgRoles\Response\ApplicationJson\Ok' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Operations⚡️Orgs⚡️ListOrgRoles⚡️Response⚡️ApplicationJson⚡️Ok($payload),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\OrganizationRole' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️OrganizationRole($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Operations⚡️Orgs⚡️ListOrgRoles⚡️Response⚡️ApplicationJson⚡️Ok(array $payload): Ok
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\Operations\Orgs\ListOrgRoles\Response\ApplicationJson\Ok', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️OrganizationRole(array $payload): OrganizationRole
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\OrganizationRole', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(OrganizationRole::class, $missingFields, stack: $this->hydrationStack);
        }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\Operations\Orgs\ListOrgRoles\Response\ApplicationJson\Ok' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Operations⚡️Orgs⚡️ListOrgRoles⚡️Response⚡️ApplicationJson⚡️Ok($object),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\OrganizationRole' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️OrganizationRole($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Operations⚡️Orgs⚡️ListOrgRoles⚡️Response⚡️ApplicationJson⚡️Ok(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️OrganizationRole(mixed $object): mixed
    {
        assert($object instanceof OrganizationRole);
        $result = [];
