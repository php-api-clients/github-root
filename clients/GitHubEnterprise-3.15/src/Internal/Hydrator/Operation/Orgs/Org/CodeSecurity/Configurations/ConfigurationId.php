...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Orgs\Org\CodeSecurity\Configurations;
...
class ConfigurationId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️CodeSecurityConfiguration(array $payload): CodeSecurityConfiguration
    {
        $properties    = [];
        $missingFields = [];
        try {
