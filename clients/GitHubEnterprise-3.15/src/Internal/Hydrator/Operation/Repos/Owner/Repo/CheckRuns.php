...
use ApiClients\Client\GitHubEnterprise\Schema\CheckRun\CheckSuite;
use ApiClients\Client\GitHubEnterprise\Schema\CheckRun\Output;
...
class CheckRuns implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️CheckRun(array $payload): CheckRun
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️CheckRun⚡️Output(array $payload): Output
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️CheckRun⚡️CheckSuite(array $payload): CheckSuite
    {
        $properties    = [];
        $missingFields = [];
        try {
