...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Repos\Owner\Repo\Deployments\DeploymentId\Statuses;
...
class StatusId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️DeploymentStatus(array $payload): DeploymentStatus
    {
        $properties    = [];
        $missingFields = [];
        try {
