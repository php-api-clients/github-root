...
use ApiClients\Client\GitHubEnterprise\Schema\WebhookWorkflowJobWaiting;
...
class WorkflowJob implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Integration(array $payload): Integration
    {
        ...
        try {
            ...
            if ($ownerCaster1 === null) {
                $ownerCaster1 = new \ApiClients\Client\GitHubEnterprise\Internal\Attribute\CastUnionToType\Schema\Integration\Owner(...[]);
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookWorkflowJobWaiting(array $payload): WebhookWorkflowJobWaiting
    {
        $properties    = [];
        $missingFields = [];
        try {
