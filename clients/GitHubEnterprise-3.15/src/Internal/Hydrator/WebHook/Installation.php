...
use ApiClients\Client\GitHubEnterprise\Internal\Attribute\CastUnionToType\Schema\Installation\Account;
...
use ApiClients\Client\GitHubEnterprise\Schema\WebhookInstallationCreated;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookInstallationDeleted;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookInstallationNewPermissionsAccepted;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookInstallationSuspend;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookInstallationUnsuspend;
...
class Installation implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookInstallationCreated(array $payload): WebhookInstallationCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️AppPermissions(array $payload): AppPermissions
    {
        ...
        try {
            ...
            $value = $payload['enterprise_administration'] ?? null;

            if ($value === null) {
                $properties['enterpriseAdministration'] = null;
                goto after_enterpriseAdministration;
            }

            $properties['enterpriseAdministration'] = $value;

            after_enterpriseAdministration:
        } catch (Throwable $exception) {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookInstallationDeleted(array $payload): WebhookInstallationDeleted
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookInstallationNewPermissionsAccepted(array $payload): WebhookInstallationNewPermissionsAccepted
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookInstallationSuspend(array $payload): WebhookInstallationSuspend
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookInstallationUnsuspend(array $payload): WebhookInstallationUnsuspend
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookInstallationCreated(mixed $object): mixed
    {
        ...
        $requester                                   = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhooksUser($requester);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Installation(mixed $object): mixed
    {
        ...
        $account = match ($account::class) {
                        'ApiClients\Client\GitHubEnterprise\Schema\SimpleUser' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️SimpleUser($account),
            'ApiClients\Client\GitHubEnterprise\Schema\Enterprise' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Enterprise($account),
        };
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️AppPermissions(mixed $object): mixed
    {
        ...
        $enterpriseAdministration = $object->enterpriseAdministration;

        if ($enterpriseAdministration === null) {
            goto after_enterpriseAdministration;
        }

        after_enterpriseAdministration:        $result['enterprise_administration'] = $enterpriseAdministration;
