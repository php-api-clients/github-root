...
use ApiClients\Client\GitHubEnterprise\Schema\WebhookBranchProtectionRuleEdited\Changes\LockAllowsForkSync;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookBranchProtectionRuleEdited\Changes\LockBranchEnforcementLevel;
...
class BranchProtectionRule implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookBranchProtectionRuleCreated' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookBranchProtectionRuleCreated($payload),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookBranchProtectionRuleEdited\Changes\LockBranchEnforcementLevel' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️LockBranchEnforcementLevel($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookBranchProtectionRuleEdited\Changes\LockAllowsForkSync' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️LockAllowsForkSync($payload),
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️LockBranchEnforcementLevel($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️LockAllowsForkSync($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️LockBranchEnforcementLevel(array $payload): LockBranchEnforcementLevel
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookBranchProtectionRuleEdited\Changes\LockBranchEnforcementLevel', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️LockAllowsForkSync(array $payload): LockAllowsForkSync
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookBranchProtectionRuleEdited\Changes\LockAllowsForkSync', $exception, stack: $this->hydrationStack);
        }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookBranchProtectionRuleEdited\Changes\LockBranchEnforcementLevel' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️LockBranchEnforcementLevel($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookBranchProtectionRuleEdited\Changes\LockAllowsForkSync' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️LockAllowsForkSync($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes(mixed $object): mixed
    {
        ...
        $lockBranchEnforcementLevel                                                       = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️LockBranchEnforcementLevel($lockBranchEnforcementLevel);
        after_lockBranchEnforcementLevel:        $result['lock_branch_enforcement_level'] = $lockBranchEnforcementLevel;
        ...
        $lockAllowsForkSync                                               = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️LockAllowsForkSync($lockAllowsForkSync);
        after_lockAllowsForkSync:        $result['lock_allows_fork_sync'] = $lockAllowsForkSync;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️LockBranchEnforcementLevel(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️LockAllowsForkSync(mixed $object): mixed
    {
