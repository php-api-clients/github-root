...
final class Four
{
    ...
    /** @return Schema\Integration|Schema\Authorization|Schema\GistComment|WithoutBody|Schema\BaseGist|iterable<int,Schema\GhesSetMaintenanceResponse>|Schema\OrganizationCustomRepositoryRole|Schema\OrgHook|Schema\Migration|Schema\OrganizationRole|Schema\Operations\Orgs\ReviewPatGrantRequestsInBulk\Response\ApplicationJson\Accepted\Application\Json|Schema\Operations\Orgs\UpdatePatAccesses\Response\ApplicationJson\Accepted\Application\Json|Schema\Project|Schema\FullRepository|Schema\RepositoryRuleset|Schema\TeamFull|Schema\ProjectColumn|Schema\TeamDiscussion */
    public function call(string $call, array $params, array $pathChunks): Integration|Authorization|GistComment|WithoutBody|BaseGist|iterable|OrganizationCustomRepositoryRole|OrgHook|Migration|OrganizationRole|Json|\ApiClients\Client\GitHubEnterprise\Schema\Operations\Orgs\UpdatePatAccesses\Response\ApplicationJson\Accepted\Application\Json|Project|FullRepository|RepositoryRuleset|TeamFull|ProjectColumn|TeamDiscussion
    {
        if ($pathChunks[0] === '') {
