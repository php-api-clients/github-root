...
final class OauthAuthorizations
{
    ...
    public function updateAuthorization(array $params): Authorization
    {
        ...
        $operator = new Internal\Operator\OauthAuthorizations\UpdateAuthorization($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Authorizations🌀AuthorizationId());
