...
final class Five
{
    ...
    public function call(string $call, array $params, array $pathChunks): GistComment|OrganizationCustomRepositoryRole|OrgHook|OrganizationRole|OrgPreReceiveHook|iterable|WithoutBody|TeamFull|ProjectCard|TeamDiscussion|OrgMembership
    {
        if ($pathChunks[0] === '') {
