...
final class Teams
{
    ...
    public function listLinkedExternalIdpGroupsToTeamForOrg(array $params): ExternalGroups
    {
        ...
        $arguments['team_slug'] = $params['team_slug'];
        unset($params['team_slug']);
        $operator = new Internal\Operator\Teams\ListLinkedExternalIdpGroupsToTeamForOrg($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Teams🌀TeamSlug🌀ExternalGroups());
