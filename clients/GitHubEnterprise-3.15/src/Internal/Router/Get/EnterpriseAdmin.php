...
final class EnterpriseAdmin
{
    ...
    {
        $arguments = [];
        if (array_key_exists('last_request_id', $params) === false) {
            throw new InvalidArgumentException('Missing mandatory field: last_request_id');
        }

        $arguments['last_request_id'] = $params['last_request_id'];
        unset($params['last_request_id']);
        $operator = new Internal\Operator\EnterpriseAdmin\GetManageConfigApplyEvents($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Manage🌀V1🌀Config🌀Apply🌀Events());
    ...
    public function getManageConfigApplyStatus(array $params): \ApiClients\Client\GitHubEnterprise\Schema\Operations\EnterpriseAdmin\GetManageConfigApplyStatus\Response\ApplicationJson\Ok|WithoutBody
    {
        ...
        unset($params['run_id']);
        $operator = new Internal\Operator\EnterpriseAdmin\GetManageConfigApplyStatus($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Manage🌀V1🌀Config🌀Apply());
