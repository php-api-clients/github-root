...
final class CreateOrUpdateCustomPropertiesValuesForRepos
{
    ...
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Orgs\Org\Properties\Values $hydrator, string $org)
    {
        $this->org = $org;
    }
