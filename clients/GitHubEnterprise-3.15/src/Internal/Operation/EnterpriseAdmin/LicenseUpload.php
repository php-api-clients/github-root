...
final class LicenseUpload
{
    ...
    /**Whether to instantly apply changes from the license. Otherwise the new license can be applied using the [`/manage/v1/config/apply`](https://docs.github.com/enterprise-server@3.15/rest/enterprise-admin/manage-ghes#start-configuration-apply-process) endpoint. **/
    private bool $apply;
