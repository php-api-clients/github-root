...
final class GetDefaultConfigurations
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Orgs\Org\CodeSecurity\Configurations\Defaults $hydrator, string $org)
    {
        $this->org = $org;
    }
    ...
    {
        return new Request('GET', str_replace(['{org}'], [$this->org], '/orgs/{org}/code-security/configurations/defaults'));
    }
