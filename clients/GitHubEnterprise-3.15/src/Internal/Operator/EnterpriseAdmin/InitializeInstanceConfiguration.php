...
final readonly class InitializeInstanceConfiguration
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\EnterpriseAdmin\InitializeInstanceConfiguration($this->requestSchemaValidator);
