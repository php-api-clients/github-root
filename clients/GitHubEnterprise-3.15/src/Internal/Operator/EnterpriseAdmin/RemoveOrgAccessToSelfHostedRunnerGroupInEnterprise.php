...
final readonly class RemoveOrgAccessToSelfHostedRunnerGroupInEnterprise
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\EnterpriseAdmin\RemoveOrgAccessToSelfHostedRunnerGroupInEnterprise($enterprise, $runnerGroupId, $orgId);
