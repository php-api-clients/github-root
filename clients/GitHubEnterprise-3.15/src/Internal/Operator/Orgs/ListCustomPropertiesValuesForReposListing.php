...
final readonly class ListCustomPropertiesValuesForReposListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Orgs\ListCustomPropertiesValuesForReposListing($this->responseSchemaValidator, $this->hydrator, $org, $repositoryQuery, $perPage, $page);
