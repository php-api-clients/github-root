...
final readonly class ListOrgRoleUsersListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Orgs\ListOrgRoleUsersListing($this->responseSchemaValidator, $this->hydrator, $org, $roleId, $perPage, $page);
