...
final readonly class UpdateRepoRuleset
{
    ...
    public function call(string $owner, string $repo, int $rulesetId, array $params): RepositoryRuleset
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Repos\UpdateRepoRuleset($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $rulesetId);
