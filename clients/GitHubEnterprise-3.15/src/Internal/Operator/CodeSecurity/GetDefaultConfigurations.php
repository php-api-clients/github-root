...
final readonly class GetDefaultConfigurations
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\CodeSecurity\GetDefaultConfigurations($this->responseSchemaValidator, $this->hydrator, $org);
