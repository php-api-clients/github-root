...
final readonly class GetConfigurationForRepository
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\CodeSecurity\GetConfigurationForRepository($this->responseSchemaValidator, $this->hydrator, $owner, $repo);
