...
final readonly class UpdateConfiguration
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\CodeSecurity\UpdateConfiguration($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $org, $configurationId);
