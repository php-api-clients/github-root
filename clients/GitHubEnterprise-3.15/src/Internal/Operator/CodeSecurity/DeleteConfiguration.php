...
final readonly class DeleteConfiguration
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\CodeSecurity\DeleteConfiguration($this->responseSchemaValidator, $this->hydrator, $org, $configurationId);
