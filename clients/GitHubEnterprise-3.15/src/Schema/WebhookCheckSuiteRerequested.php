...
final readonly class WebhookCheckSuiteRerequested
{
    ...
    /**
     * checkSuite: The [check_suite](https://docs.github.com/enterprise-server@3.15/rest/checks/suites#get-a-check-suite).
    ...
    public Schema\WebhookCheckSuiteRerequested\CheckSuite $checkSuite, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUser $sender,)
    {
    }
}
