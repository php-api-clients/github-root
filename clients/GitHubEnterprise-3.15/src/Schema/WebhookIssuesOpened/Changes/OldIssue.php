...
namespace ApiClients\Client\GitHubEnterprise\Schema\WebhookIssuesOpened\Changes;
...
final readonly class OldIssue
{
    ...
    public const SCHEMA_DESCRIPTION  = 'The [issue](https://docs.github.com/enterprise-server@3.15/rest/issues/issues#get-an-issue) itself.';
