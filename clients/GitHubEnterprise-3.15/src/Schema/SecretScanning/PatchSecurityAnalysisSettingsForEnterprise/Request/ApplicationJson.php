...
final readonly class ApplicationJson
{
    ...
    "properties": {
        ...
        "secret_scanning_push_protection_custom_link": {
            ...
            "description": "The URL that will be displayed to contributors who are blocked from pushing a secret. For more information, see \\"[Protecting pushes with secret scanning](https:\\/\\/docs.github.com\\/enterprise-server@3.15\\/code-security\\/secret-scanning\\/protecting-pushes-with-secret-scanning).\\"\\nTo disable this functionality, set this field to `null`."
        },
    ...
    /**
     * advancedSecurityEnabledForNewRepositories: Whether GitHub Advanced Security is automatically enabled for new repositories. For more information, see "[About GitHub Advanced Security](https://docs.github.com/enterprise-server@3.15/get-started/learning-about-github/about-github-advanced-security)."
     * advancedSecurityEnabledNewUserNamespaceRepos: Whether GitHub Advanced Security is automatically enabled for new user namespace repositories. For more information, see "[About GitHub Advanced Security](https://docs.github.com/enterprise-server@3.15/get-started/learning-about-github/about-github-advanced-security)."
     * dependabotAlertsEnabledForNewRepositories: Whether Dependabot alerts are automatically enabled for new repositories. For more information, see "[About Dependabot alerts](https://docs.github.com/enterprise-server@3.15/code-security/dependabot/dependabot-alerts/about-dependabot-alerts)."
     * secretScanningEnabledForNewRepositories: Whether secret scanning is automatically enabled for new repositories. For more information, see "[About secret scanning](https://docs.github.com/enterprise-server@3.15/code-security/secret-scanning/about-secret-scanning)."
