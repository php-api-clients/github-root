...
final readonly class Integration
{
    ...
    public string $nodeId, #[MapFrom('client_id')]
    public string|null $clientId, public Schema\SimpleUser|null $owner, public string $name, public string|null $description, #[MapFrom('external_url')]
    ...
    public int|null $installationsCount, #[MapFrom('client_secret')]
