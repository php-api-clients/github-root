...
namespace ApiClients\Client\GitHubEnterprise\Schema\AliasAbstract\TietF6D0FE1B\TietB05FD652\Tiet9605F53A;

use EventSauce\ObjectHydrator\MapFrom;

abstract readonly class TietFE5342BA
{
     ...
     * secret: If provided, the `secret` will be used as the `key` to generate the HMAC hex digest value in the [`X-Hub-Signature`](https://docs.github.com/enterprise-server@3.15/webhooks/event-payloads/#delivery-headers) header.
