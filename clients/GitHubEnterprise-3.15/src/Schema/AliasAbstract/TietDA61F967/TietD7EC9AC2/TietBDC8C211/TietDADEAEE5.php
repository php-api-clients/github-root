...
namespace ApiClients\Client\GitHubEnterprise\Schema\AliasAbstract\TietDA61F967\TietD7EC9AC2\TietBDC8C211;

use EventSauce\ObjectHydrator\MapFrom;

abstract readonly class TietDADEAEE5
{
     ...
     * secret: If provided, the `secret` will be used as the `key` to generate the HMAC hex digest value for [delivery signature headers](https://docs.github.com/enterprise-server@3.15/webhooks/event-payloads/#delivery-headers).
     */
