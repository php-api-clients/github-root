...
final readonly class WebhookRegistryPackageUpdated
{
    ...
    public Schema\WebhookRegistryPackageUpdated\RegistryPackage $registryPackage, public Schema\RepositoryWebhooks|null $repository, public Schema\SimpleUser $sender,)
    {
    }
}
