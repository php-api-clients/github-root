...
final readonly class WebhookReleasePrereleased
{
    ...
    organization, or when the event occurs from activity in a repository owned by an organization.
     * release: The [release](https://docs.github.com/enterprise-server@3.15/rest/releases/releases/#get-a-release) object.
     * repository: The repository on GitHub where the event occurred. Webhook payloads contain the `repository` property
    when the event occurs from activity in a repository.
     * sender: A GitHub user.
     */
    public function __construct(public string $action, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\WebhookReleasePrereleased\Release $release, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUser|null $sender)
    {
    }
}
