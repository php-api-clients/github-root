...
final readonly class WebhookIssueCommentEdited
{
     ...
     * comment: The [comment](https://docs.github.com/enterprise-server@3.15/rest/issues/comments#get-an-issue-comment) itself.
    ...
    for and sent to a GitHub App. For more information,
    see "[Using webhooks with GitHub Apps](https://docs.github.com/enterprise-server@3.15/apps/creating-github-apps/registering-a-github-app/using-webhooks-with-github-apps)."
     * issue: The [issue](https://docs.github.com/enterprise-server@3.15/rest/issues/issues#get-an-issue) the comment belongs to.
