...
final readonly class WebhookDeploymentStatusCreated
{
    ...
    /**
     * deployment: The [deployment](https://docs.github.com/enterprise-server@3.15/rest/deployments/deployments#list-deployments).
     * deploymentStatus: The [deployment status](https://docs.github.com/enterprise-server@3.15/rest/deployments/statuses#list-deployment-statuses).
    ...
    public Schema\WebhookDeploymentStatusCreated\DeploymentStatus $deploymentStatus, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUser $sender, public Schema\WebhooksWorkflow|null $workflow, #[MapFrom('workflow_run')]
