...
final readonly class WebhookPullRequestAssigned
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhooksUser|null $assignee, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public int $number, public Schema\OrganizationSimpleWebhooks|null $organization, #[MapFrom('pull_request')]
    public Schema\WebhookPullRequestAssigned\PullRequest $pullRequest, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUser $sender,)
    {
    }
}
