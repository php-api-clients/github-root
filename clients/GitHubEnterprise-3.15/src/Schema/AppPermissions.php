...
final readonly class AppPermissions
{
     ...
     * enterpriseAdministration: The level of permission to grant the access token to list and manage repositories a user is starring.
     */
    ...
    public string|null $interactionLimits, public string|null $profile, public string|null $starring, #[MapFrom('enterprise_administration')]
    public string|null $enterpriseAdministration,)
    {
    }
}
