...
final readonly class WebhookPullRequestReviewCommentDeleted
{
    ...
    /**
     * comment: The [comment](https://docs.github.com/enterprise-server@3.15/rest/pulls/comments#get-a-review-comment-for-a-pull-request) itself.
    ...
    public Schema\WebhookPullRequestReviewCommentDeleted\PullRequest $pullRequest, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUser $sender,)
    {
    }
}
