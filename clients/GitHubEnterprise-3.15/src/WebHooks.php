...
final class WebHooks implements WebHooksInterface
{
    ...
    private Internal\WebHook\CacheSync|null $cacheSync                                           = null;
    ...
    private Internal\WebHook\Enterprise|null $enterprise                                         = null;
    ...
    public function resolve(array $headers, array $data): object
    {
        ...
        webhooks_aaaab:
        try {
            if ($this->exemptionRequestSecretScanning instanceof Internal\WebHook\ExemptionRequestSecretScanning === false) {
                $this->exemptionRequestSecretScanning = new Internal\WebHook\ExemptionRequestSecretScanning($this->requestSchemaValidator, $this->hydrator->getObjectMapperWebHook🪝ExemptionRequestSecretScanning());
            }

            return $this->exemptionRequestSecretScanning->resolve($headers, $data);
        } catch (Throwable $error) {
            goto webhooks_aaaac;
        }
        ...
        webhooks_aaaac:
        try {
            if ($this->cacheSync instanceof Internal\WebHook\CacheSync === false) {
                $this->cacheSync = new Internal\WebHook\CacheSync($this->requestSchemaValidator, $this->hydrator->getObjectMapperWebHook🪝CacheSync());
            }

            return $this->cacheSync->resolve($headers, $data);
        } catch (Throwable $error) {
            goto webhooks_aaaad;
        }
        ...
        webhooks_aaaar:
        try {
            if ($this->enterprise instanceof Internal\WebHook\Enterprise === false) {
                $this->enterprise = new Internal\WebHook\Enterprise($this->requestSchemaValidator, $this->hydrator->getObjectMapperWebHook🪝Enterprise());
            }

            return $this->enterprise->resolve($headers, $data);
        } catch (Throwable $error) {
            goto webhooks_aaaas;
        }
