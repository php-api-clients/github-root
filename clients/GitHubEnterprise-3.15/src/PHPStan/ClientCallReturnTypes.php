...
final readonly class ClientCallReturnTypes implements DynamicMethodReturnTypeExtension
{
    ...
    public function getTypeFromMethodCall(MethodReflection $methodReflection, MethodCall $methodCall, Scope $scope): Type|null
    {
        ...
        if ($call === 'GET /manage/v1/access/ssh') {
            return $this->typeResolver->resolve('iterable<int,Schema\\GhesGetSsh>|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }

        if ($call === 'POST /manage/v1/access/ssh') {
            return $this->typeResolver->resolve('iterable<int,Schema\\GhesSetSshResponse>|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }

        if ($call === 'DELETE /manage/v1/access/ssh') {
            return $this->typeResolver->resolve('iterable<int,Schema\\GhesDeleteSshResponse>|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }

        if ($call === 'GET /manage/v1/checks/system-requirements') {
            return $this->typeResolver->resolve('Schema\\GhesChecksSystemRequirements|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }

        if ($call === 'GET /manage/v1/cluster/status') {
            return $this->typeResolver->resolve('Schema\\GhesClusterStatus|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }

        if ($call === 'GET /manage/v1/config/apply') {
            return $this->typeResolver->resolve('Schema\\Operations\\EnterpriseAdmin\\GetManageConfigApplyStatus\\Response\\ApplicationJson\\Ok|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }

        if ($call === 'POST /manage/v1/config/apply') {
            return $this->typeResolver->resolve('Schema\\Operations\\EnterpriseAdmin\\PostManageRunConfigApply\\Response\\ApplicationJson\\Ok|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }

        if ($call === 'GET /manage/v1/config/apply/events') {
            return $this->typeResolver->resolve('Schema\\Operations\\EnterpriseAdmin\\GetManageConfigApplyEvents\\Response\\ApplicationJson\\Ok|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
        ...
        if ($call === 'GET /manage/v1/config/license') {
            return $this->typeResolver->resolve('Schema\\GhesLicenseInfo|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
        ...
        if ($call === 'GET /manage/v1/config/license/check') {
            return $this->typeResolver->resolve('Schema\\GhesLicenseCheck|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
        ...
        if ($call === 'GET /manage/v1/config/settings') {
            return $this->typeResolver->resolve('Schema\\GhesGetSettings|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
