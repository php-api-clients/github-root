...
final class Six
{
    ...
    /** @return |Observable<Schema\RunnerApplication>|Observable<Schema\HookDeliveryItem>|array{code: int}|Observable<Schema\MinimalRepository>|Observable<Schema\TeamDiscussion>|Observable<Schema\SimpleUser>|Observable<Schema\TeamProject>|Observable<Schema\Team>|(Schema\ProjectCollaboratorPermission|array{code: int})|Schema\Operations\Actions\ListArtifactsForRepo\Response\ApplicationJson\Ok|(Observable<Schema\CodeScanningAlertItems>|Observable<Schema\CodeScanningAnalysis>|(Schema\CodeownersErrors|(Schema\ContentDirectory|Schema\ContentFile|Schema\ContentSymlink|Schema\ContentSubmodule|(Observable<Schema\DependabotAlert>|Observable<Schema\IssueComment>|Observable<Schema\IssueEvent>|(Schema\Issue|Schema\BasicError|Observable<Schema\PageBuild>|Observable<Schema\PullRequestReviewComment>|(Schema\PullRequest|(Schema\Release|Observable<Schema\Operations\Repos\ListCacheInfo\Response\ApplicationJson\Ok>|(Observable<Schema\SecretScanningAlert>|(Observable<int>|Schema\Operations\Repos\GetCodeFrequencyStats\Response\ApplicationJson\Accepted\Application\Json|(Observable<Schema\CommitActivity>|Schema\Operations\Repos\GetCommitActivityStats\Response\ApplicationJson\Accepted\Application\Json|(Observable<Schema\ContributorActivity>|Schema\Operations\Repos\GetContributorsStats\Response\ApplicationJson\Accepted\Application\Json|Observable<Schema\TagProtection>|array{code: int, location: string}|Observable<Schema\TeamDiscussionComment>|Observable<Schema\Reaction>|(Schema\TeamRepository|Observable<Schema\Event> */
