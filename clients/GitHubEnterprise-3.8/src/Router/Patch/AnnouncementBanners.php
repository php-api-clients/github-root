...
final class AnnouncementBanners
{
    ...
    public function setAnnouncementBannerForOrg(array $params): AnnouncementBanner|array
    {
        ...
        unset($params['org']);
        $operator = new Operator\AnnouncementBanners\SetAnnouncementBannerForOrg($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Announcement());
