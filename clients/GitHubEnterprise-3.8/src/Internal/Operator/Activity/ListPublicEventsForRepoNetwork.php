...
final readonly class ListPublicEventsForRepoNetwork
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Activity\ListPublicEventsForRepoNetwork($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
