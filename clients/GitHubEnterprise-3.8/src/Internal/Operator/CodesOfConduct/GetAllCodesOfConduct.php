...
namespace ApiClients\Client\GitHubEnterprise\Internal\Operator\CodesOfConduct;
...
final readonly class GetAllCodesOfConduct
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\CodesOfConduct\GetAllCodesOfConduct($this->responseSchemaValidator, $this->hydrator);
