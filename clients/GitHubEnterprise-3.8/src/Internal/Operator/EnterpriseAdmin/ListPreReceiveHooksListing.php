...
final readonly class ListPreReceiveHooksListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\EnterpriseAdmin\ListPreReceiveHooksListing($this->responseSchemaValidator, $this->hydrator, $perPage, $page, $direction, $sort);
