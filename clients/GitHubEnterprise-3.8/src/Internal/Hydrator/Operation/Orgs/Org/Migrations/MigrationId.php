...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Orgs\Org\Migrations;
...
class MigrationId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Migration(array $payload): Migration
    {
        $properties    = [];
        $missingFields = [];
        try {
