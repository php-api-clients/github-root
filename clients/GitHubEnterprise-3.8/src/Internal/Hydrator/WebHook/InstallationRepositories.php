...
use ApiClients\Client\GitHubEnterprise\Schema\WebhookInstallationRepositoriesAdded;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookInstallationRepositoriesAdded\Requester;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookInstallationRepositoriesRemoved;
...
class InstallationRepositories implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookInstallationRepositoriesAdded(array $payload): WebhookInstallationRepositoriesAdded
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Installation(array $payload): Installation
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookInstallationRepositoriesAdded⚡️Requester(array $payload): Requester
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookInstallationRepositoriesRemoved(array $payload): WebhookInstallationRepositoriesRemoved
    {
        $properties    = [];
        $missingFields = [];
        try {
