...
use ApiClients\Client\GitHubEnterprise\Internal\Attribute\CastUnionToType\Schema\WebhookDeploymentCreated\Deployment\Payload;
...
use ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentCreated;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentCreated\Deployment\Creator;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentCreated\Deployment\PerformedViaGithubApp;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentCreated\Deployment\PerformedViaGithubApp\Owner;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentCreated\Deployment\PerformedViaGithubApp\Permissions;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentCreated\Workflow;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentCreated\WorkflowRun;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentCreated\WorkflowRun\Actor;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentCreated\WorkflowRun\HeadRepository;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentCreated\WorkflowRun\Repository;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentCreated\WorkflowRun\TriggeringActor;
...
class Deployment implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentCreated(array $payload): WebhookDeploymentCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentCreated⚡️Deployment⚡️Creator(array $payload): Creator
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentCreated⚡️Deployment⚡️PerformedViaGithubApp(array $payload): PerformedViaGithubApp
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentCreated⚡️Deployment⚡️PerformedViaGithubApp⚡️Owner(array $payload): Owner
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentCreated⚡️Deployment⚡️PerformedViaGithubApp⚡️Permissions(array $payload): Permissions
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentCreated⚡️Workflow(array $payload): Workflow
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentCreated⚡️WorkflowRun(array $payload): WorkflowRun
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentCreated⚡️WorkflowRun⚡️Actor(array $payload): Actor
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentCreated⚡️WorkflowRun⚡️HeadRepository(array $payload): HeadRepository
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentCreated⚡️WorkflowRun⚡️Repository(array $payload): Repository
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentCreated⚡️WorkflowRun⚡️TriggeringActor(array $payload): TriggeringActor
    {
        $properties    = [];
        $missingFields = [];
        try {
