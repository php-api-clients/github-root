...
use ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipAdded;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipAdded\Member;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipAdded\Sender;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipAdded\Team;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipAdded\Team\Parent_;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved;
...
class Membership implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipAdded' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipAdded($payload),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipAdded\Member' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipAdded⚡️Member($payload),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipAdded\Sender' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipAdded⚡️Sender($payload),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipRemoved($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved\Member' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipRemoved⚡️Member($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved\Sender' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipRemoved⚡️Sender($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved\Team' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipRemoved⚡️Team($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved\Team\Parent_' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipRemoved⚡️Team⚡️Parent_($payload),
            default => throw UnableToHydrateObject::noHydrationDefined($className, $this->hydrationStack),
        };
    }

    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipAdded(array $payload): WebhookMembershipAdded
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipAdded⚡️Member($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipAdded⚡️Sender($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipAdded⚡️Team($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipAdded', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipAdded⚡️Member(array $payload): Member
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipAdded\Member', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipAdded⚡️Sender(array $payload): Sender
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipAdded\Sender', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipAdded⚡️Team(array $payload): Team
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipAdded⚡️Team⚡️Parent_(array $payload): Parent_
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipRemoved(array $payload): WebhookMembershipRemoved
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'member';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipRemoved⚡️Member($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'sender';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipRemoved⚡️Sender($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'team';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipRemoved⚡️Team($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipRemoved⚡️Member(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved\Member
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved\Member', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved\Member::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved\Member(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved\Member', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipRemoved⚡️Sender(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved\Sender
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved\Sender', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved\Sender::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved\Sender(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved\Sender', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipRemoved⚡️Team(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved\Team
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved\Team', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved\Team::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved\Team(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved\Team', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipRemoved⚡️Team⚡️Parent_(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved\Team\Parent_
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved\Team\Parent_', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved\Team\Parent_::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved\Team\Parent_(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved\Team\Parent_', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipAdded' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipAdded($object),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipAdded\Member' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipAdded⚡️Member($object),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipAdded\Sender' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipAdded⚡️Sender($object),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipRemoved($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved\Member' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipRemoved⚡️Member($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved\Sender' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipRemoved⚡️Sender($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved\Team' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipRemoved⚡️Team($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved\Team\Parent_' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipRemoved⚡️Team⚡️Parent_($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipAdded(mixed $object): mixed
    {
        ...
        $member                                = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipAdded⚡️Member($member);
        ...
        $sender                                = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipAdded⚡️Sender($sender);
        after_sender:        $result['sender'] = $sender;

        $team                              = $object->team;
        $team                              = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipAdded⚡️Team($team);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipAdded⚡️Member(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipAdded⚡️Sender(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipRemoved(mixed $object): mixed
    {
        ...
        $member                                = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipRemoved⚡️Member($member);
        after_member:        $result['member'] = $member;
        ...
        $sender                                = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipRemoved⚡️Sender($sender);
        after_sender:        $result['sender'] = $sender;

        $team                              = $object->team;
        $team                              = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipRemoved⚡️Team($team);
        after_team:        $result['team'] = $team;

        return $result;
    }

    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipRemoved⚡️Member(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved\Member);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipRemoved⚡️Sender(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved\Sender);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipRemoved⚡️Team(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved\Team);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookMembershipRemoved⚡️Team⚡️Parent_(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookMembershipRemoved\Team\Parent_);
        $result = [];
