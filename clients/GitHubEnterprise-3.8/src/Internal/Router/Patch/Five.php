...
final class Five
{
    ...
    /** @return Schema\GistComment|Schema\OrgHook|Schema\OrgPreReceiveHook|Schema\TeamFull|Schema\ProjectCard|array{code:int}|Schema\GroupResponse|Schema\UserResponse|Schema\TeamDiscussion|Schema\OrgMembership */
