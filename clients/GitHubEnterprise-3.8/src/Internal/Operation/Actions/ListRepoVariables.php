...
final class ListRepoVariables
{
    ...
    {
        return new Request('GET', str_replace(['{owner}', '{repo}', '{per_page}', '{page}'], [$this->owner, $this->repo, $this->perPage, $this->page], '/repos/{owner}/{repo}/actions/variables' . '?per_page={per_page}&page={page}'));
    }
