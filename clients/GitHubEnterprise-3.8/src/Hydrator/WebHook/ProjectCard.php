...
class ProjectCard implements ObjectMapper
{
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectCardConverted(mixed $object): mixed
    {
        ...
        $project_card = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectCardConverted⚡️ProjectCard($project_card);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectCardConverted⚡️Changes(mixed $object): mixed
    {
        ...
        $note = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDiscussionCommentEdited⚡️Changes⚡️Body($note);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectCardDeleted(mixed $object): mixed
    {
        ...
        $project_card = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectCardDeleted⚡️ProjectCard($project_card);
        after_project_card:        $result['project_card'] = $project_card;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectCardMoved(mixed $object): mixed
    {
        ...
        $project_card = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectCardMoved⚡️ProjectCard($project_card);
        after_project_card:        $result['project_card'] = $project_card;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectCardMoved⚡️Changes(mixed $object): mixed
    {
        ...
        $column_id = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectCardMoved⚡️Changes⚡️ColumnId($column_id);
        after_column_id:        $result['column_id'] = $column_id;
