...
class ProjectCard implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectCardConverted(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardConverted
    {
        $properties = []; 
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardConverted::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardConverted(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardConverted', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectCardConverted⚡️Changes(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardConverted\Changes
    {
        $properties = []; 
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardConverted\Changes::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardConverted\Changes(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardConverted\Changes', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectCardConverted⚡️Changes⚡️Note(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardConverted\Changes\Note
    {
        $properties = []; 
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardConverted\Changes\Note::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardConverted\Changes\Note(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardConverted\Changes\Note', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectCardConverted⚡️ProjectCard⚡️Creator(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardConverted\ProjectCard\Creator
    {
        $properties = []; 
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardConverted\ProjectCard\Creator::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardConverted\ProjectCard\Creator(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardConverted\ProjectCard\Creator', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectCardCreated(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardCreated
    {
        $properties = []; 
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardCreated::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardCreated(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardCreated', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectCardCreated⚡️ProjectCard(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardCreated\ProjectCard
    {
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'creator';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectCardCreated⚡️ProjectCard⚡️Creator($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectCardDeleted(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardDeleted
    {
        $properties = []; 
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardDeleted::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardDeleted(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardDeleted', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectCardEdited(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardEdited
    {
        $properties = []; 
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardEdited::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardEdited(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardEdited', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectCardEdited⚡️ProjectCard(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardEdited\ProjectCard
    {
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'creator';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectCardEdited⚡️ProjectCard⚡️Creator($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectCardMoved(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardMoved
    {
        $properties = []; 
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardMoved::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardMoved(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardMoved', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectCardMoved⚡️Changes⚡️ColumnId(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardMoved\Changes\ColumnId
    {
        $properties = []; 
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardMoved\Changes\ColumnId::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardMoved\Changes\ColumnId(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardMoved\Changes\ColumnId', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardConverted);
        $result = [];
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardConverted\Changes);
        $result = [];
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardConverted\Changes\Note);
        $result = [];
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardConverted\ProjectCard\Creator);
        $result = [];
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardCreated);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectCardCreated⚡️ProjectCard(mixed $object): mixed
    {
        ...
        $creator = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectCardCreated⚡️ProjectCard⚡️Creator($creator);
        after_creator:        $result['creator'] = $creator;
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardDeleted);
        $result = [];
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardEdited);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectCardEdited⚡️ProjectCard(mixed $object): mixed
    {
        ...
        $creator = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectCardEdited⚡️ProjectCard⚡️Creator($creator);
        after_creator:        $result['creator'] = $creator;
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardMoved);
        $result = [];
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookProjectCardMoved\Changes\ColumnId);
        $result = [];
