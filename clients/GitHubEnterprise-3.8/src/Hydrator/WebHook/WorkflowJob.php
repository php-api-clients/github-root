...
class WorkflowJob implements ObjectMapper
{
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookWorkflowJobWaiting\\WorkflowJob\\Steps',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookWorkflowJobCompleted(mixed $object): mixed
    {
        ...
        $workflow_job = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookWorkflowJobCompleted⚡️WorkflowJob($workflow_job);
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookWorkflowJobCompleted\\WorkflowJob\\Steps',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookWorkflowJobInProgress(mixed $object): mixed
    {
        ...
        $workflow_job = $object->workflow_job;
        $workflow_job = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookWorkflowJobInProgress⚡️WorkflowJob($workflow_job);
        after_workflow_job:        $result['workflow_job'] = $workflow_job;
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookWorkflowJobInProgress\\WorkflowJob\\Steps',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookWorkflowJobQueued(mixed $object): mixed
    {
        ...
        $workflow_job = $object->workflow_job;
        $workflow_job = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookWorkflowJobQueued⚡️WorkflowJob($workflow_job);
        after_workflow_job:        $result['workflow_job'] = $workflow_job;
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookWorkflowJobQueued\\WorkflowJob\\Steps',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookWorkflowJobWaiting(mixed $object): mixed
    {
        ...
        $workflow_job = $object->workflow_job;
        $workflow_job = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookWorkflowJobWaiting⚡️WorkflowJob($workflow_job);
        after_workflow_job:        $result['workflow_job'] = $workflow_job;
