...
class PullRequestReviewThread implements ObjectMapper
{
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookPullRequestReviewCommentDeleted\\Comment',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewThreadResolved(mixed $object): mixed
    {
        ...
        $pull_request = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewThreadResolved⚡️PullRequest($pull_request);
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookPullRequestReviewThreadResolved\\Thread\\Comments',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewThreadUnresolved(mixed $object): mixed
    {
        ...
        $pull_request = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewThreadUnresolved⚡️PullRequest($pull_request);
        after_pull_request:        $result['pull_request'] = $pull_request;
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\Discussion\\AnswerChosenBy',
        ...
        $auto_merge = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewThreadUnresolved⚡️PullRequest⚡️AutoMerge($auto_merge);
        after_auto_merge:        $result['auto_merge'] = $auto_merge;
        ...
        $head = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPullRequestReviewThreadResolved⚡️PullRequest⚡️Base($head);
        after_head:        $result['head'] = $head;
