...
class SecurityAdvisory implements ObjectMapper
{
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookSecurityAdvisoryPublished\\SecurityAdvisory\\Vulnerabilities',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookSecurityAdvisoryPublished(mixed $object): mixed
    {
        ...
        $security_advisory = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookSecurityAdvisoryPublished⚡️SecurityAdvisory($security_advisory);
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookSecurityAdvisoryPublished\\SecurityAdvisory\\Vulnerabilities',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookSecurityAdvisoryPublished⚡️SecurityAdvisory⚡️Vulnerabilities(mixed $object): mixed
    {
        ...
        $first_patched_version = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookSecurityAdvisoryPublished⚡️SecurityAdvisory⚡️Vulnerabilities⚡️FirstPatchedVersion($first_patched_version);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookSecurityAdvisoryWithdrawn(mixed $object): mixed
    {
        ...
        $security_advisory = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookSecurityAdvisoryWithdrawn⚡️SecurityAdvisory($security_advisory);
        after_security_advisory:        $result['security_advisory'] = $security_advisory;
