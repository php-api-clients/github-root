...
class BranchProtectionRule implements ObjectMapper
{
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes(mixed $object): mixed
    {
        ...
        $admin_enforced = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️AdminEnforced($admin_enforced);
        after_admin_enforced:        $result['admin_enforced'] = $admin_enforced;
        ...
        $authorized_actor_names = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️AuthorizedActorNames($authorized_actor_names);
        after_authorized_actor_names:        $result['authorized_actor_names'] = $authorized_actor_names;
        ...
        $authorized_actors_only = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️AdminEnforced($authorized_actors_only);
        after_authorized_actors_only:        $result['authorized_actors_only'] = $authorized_actors_only;
        ...
        $authorized_dismissal_actors_only = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️AdminEnforced($authorized_dismissal_actors_only);
        after_authorized_dismissal_actors_only:        $result['authorized_dismissal_actors_only'] = $authorized_dismissal_actors_only;
        ...
        $linear_history_requirement_enforcement_level = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️LinearHistoryRequirementEnforcementLevel($linear_history_requirement_enforcement_level);
        after_linear_history_requirement_enforcement_level:        $result['linear_history_requirement_enforcement_level'] = $linear_history_requirement_enforcement_level;
        ...
        $required_status_checks = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️AuthorizedActorNames($required_status_checks);
        after_required_status_checks:        $result['required_status_checks'] = $required_status_checks;
        ...
        $required_status_checks_enforcement_level = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookBranchProtectionRuleEdited⚡️Changes⚡️LinearHistoryRequirementEnforcementLevel($required_status_checks_enforcement_level);
        after_required_status_checks_enforcement_level:        $result['required_status_checks_enforcement_level'] = $required_status_checks_enforcement_level;
