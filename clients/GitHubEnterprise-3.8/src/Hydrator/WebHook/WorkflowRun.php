...
class WorkflowRun implements ObjectMapper
{
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookWorkflowRunCompleted(mixed $object): mixed
    {
        ...
        $workflow_run = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookWorkflowRunCompleted⚡️WorkflowRun($workflow_run);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookWorkflowRunCompleted⚡️WorkflowRun(mixed $object): mixed
    {
        ...
        $actor = $object->actor;
        $actor = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentCreated⚡️WorkflowRun⚡️HeadRepository⚡️Owner($actor);
        ...
        $head_commit = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookWorkflowRunCompleted⚡️WorkflowRun⚡️HeadCommit($head_commit);
        after_head_commit:        $result['head_commit'] = $head_commit;

        
        $head_repository = $object->head_repository;
        $head_repository = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookWorkflowRunCompleted⚡️WorkflowRun⚡️HeadRepository($head_repository);
        ...
        $repository = $object->repository;
        $repository = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookWorkflowRunCompleted⚡️WorkflowRun⚡️HeadRepository($repository);
        after_repository:        $result['repository'] = $repository;
        ...
        $triggering_actor = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectCardMoved⚡️ProjectCard⚡️Creator($triggering_actor);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookWorkflowRunCompleted⚡️WorkflowRun⚡️HeadCommit(mixed $object): mixed
    {
        ...
        $committer = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookWorkflowRunCompleted⚡️WorkflowRun⚡️HeadCommit⚡️Author($committer);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookWorkflowRunInProgress(mixed $object): mixed
    {
        ...
        $workflow_run = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookWorkflowRunInProgress⚡️WorkflowRun($workflow_run);
        after_workflow_run:        $result['workflow_run'] = $workflow_run;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookWorkflowRunInProgress⚡️WorkflowRun(mixed $object): mixed
    {
        ...
        $head_repository = $object->head_repository;
        $head_repository = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookWorkflowRunInProgress⚡️WorkflowRun⚡️HeadRepository($head_repository);
        after_head_repository:        $result['head_repository'] = $head_repository;
        ...
        $triggering_actor = $object->triggering_actor;
        $triggering_actor = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentCreated⚡️WorkflowRun⚡️HeadRepository⚡️Owner($triggering_actor);
        after_triggering_actor:        $result['triggering_actor'] = $triggering_actor;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookWorkflowRunRequested(mixed $object): mixed
    {
        ...
        $workflow_run = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun($workflow_run);
        after_workflow_run:        $result['workflow_run'] = $workflow_run;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun(mixed $object): mixed
    {
        ...
        $actor = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Discussion⚡️AnswerChosenBy($actor);
        after_actor:        $result['actor'] = $actor;
        ...
        $head_repository = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun⚡️HeadRepository($head_repository);
        after_head_repository:        $result['head_repository'] = $head_repository;
        ...
        $repository = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun⚡️HeadRepository($repository);
        after_repository:        $result['repository'] = $repository;
        ...
        $triggering_actor = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Discussion⚡️AnswerChosenBy($triggering_actor);
        after_triggering_actor:        $result['triggering_actor'] = $triggering_actor;
