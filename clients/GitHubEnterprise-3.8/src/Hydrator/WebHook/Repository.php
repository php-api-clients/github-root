...
class Repository implements ObjectMapper
{
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRepositoryEdited⚡️Changes(mixed $object): mixed
    {
        ...
        $default_branch = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDiscussionCommentEdited⚡️Changes⚡️Body($default_branch);
        after_default_branch:        $result['default_branch'] = $default_branch;
        ...
        $description = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectCardEdited⚡️Changes⚡️Note($description);
        after_description:        $result['description'] = $description;
        ...
        $homepage = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookProjectCardEdited⚡️Changes⚡️Note($homepage);
        after_homepage:        $result['homepage'] = $homepage;
