...
class CodeScanningAlert implements ObjectMapper
{
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookCodeScanningAlertAppearedInBranch⚡️Alert(mixed $object): mixed
    {
        ...
        $dismissed_by = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Discussion⚡️AnswerChosenBy($dismissed_by);
        ...
        $most_recent_instance = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookCodeScanningAlertAppearedInBranch⚡️Alert⚡️MostRecentInstance($most_recent_instance);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookCodeScanningAlertReopened⚡️Alert(mixed $object): mixed
    {
        ...
        $dismissed_by = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookCheckSuiteCompleted⚡️ActionsMeta($dismissed_by);
        after_dismissed_by:        $result['dismissed_by'] = $dismissed_by;
