...
class RegistryPackage implements ObjectMapper
{
            ...
            try {
                ...
                if (is_array($value)) {
                    try {
                        ...
                        $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️AuditLogEvent⚡️Config($value);
                    } finally {
                        array_pop($this->hydrationStack);
                    }
                }
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\AuditLogEvent\\Data',
));
                }
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookRegistryPackagePublished\\RegistryPackage\\PackageVersion\\PackageFiles',
            ...
            try {
                ...
                if (is_array($value)) {
                    try {
                        ...
                        $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookCheckSuiteCompleted⚡️ActionsMeta($value);
                    } finally {
                        array_pop($this->hydrationStack);
                    }
                }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️ContainerMetadata⚡️Tag(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished\Package\PackageVersion\ContainerMetadata\Tag
        {
            $properties = []; 
            $missingFields = [];
            try {
            ...
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished\Package\PackageVersion\ContainerMetadata\Tag::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished\Package\PackageVersion\ContainerMetadata\Tag(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished\Package\PackageVersion\ContainerMetadata\Tag', $exception, stack: $this->hydrationStack);
            }
        }
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookRegistryPackageUpdated\\RegistryPackage\\PackageVersion\\PackageFiles',
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️AuditLogEvent⚡️Config(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\AuditLogEvent\Config
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\AuditLogEvent\Config', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\AuditLogEvent\Config::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubEnterprise\Schema\AuditLogEvent\Config(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\AuditLogEvent\Config', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookCheckSuiteCompleted⚡️ActionsMeta(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookCheckSuiteCompleted\ActionsMeta
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookCheckSuiteCompleted\ActionsMeta', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookCheckSuiteCompleted\ActionsMeta::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookCheckSuiteCompleted\ActionsMeta(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookCheckSuiteCompleted\ActionsMeta', $exception, stack: $this->hydrationStack);
            }
        }
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRegistryPackagePublished(mixed $object): mixed
    {
        ...
        $registry_package = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage($registry_package);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage(mixed $object): mixed
    {
        ...
        $package_version = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion($package_version);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion(mixed $object): mixed
    {
        ...
        $author = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️Owner($author);
        after_author:        $result['author'] = $author;

        
        $body = $object->body;
        $body = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️AuditLogEvent⚡️Config($body);
        ...
        $container_metadata = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️ContainerMetadata($container_metadata);
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\AuditLogEvent\\Data',
        ...
        $npm_metadata = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata($npm_metadata);
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookRegistryPackagePublished\\RegistryPackage\\PackageVersion\\PackageFiles',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️ContainerMetadata(mixed $object): mixed
    {
        ...
        $labels = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookCheckSuiteCompleted⚡️ActionsMeta($labels);
        ...
        $manifest = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookCheckSuiteCompleted⚡️ActionsMeta($manifest);
        after_manifest:        $result['manifest'] = $manifest;
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished\Package\PackageVersion\ContainerMetadata\Tag);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️NpmMetadata(mixed $object): mixed
    {
        ...
        $author = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️AuditLogEvent⚡️Config($author);
        after_author:        $result['author'] = $author;
        ...
        $bugs = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️AuditLogEvent⚡️Config($bugs);
        ...
        $dependencies = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️AuditLogEvent⚡️Config($dependencies);
        ...
        $dev_dependencies = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️AuditLogEvent⚡️Config($dev_dependencies);
        ...
        $peer_dependencies = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️AuditLogEvent⚡️Config($peer_dependencies);
        ...
        $optional_dependencies = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️AuditLogEvent⚡️Config($optional_dependencies);
        ...
        $dist = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️AuditLogEvent⚡️Config($dist);
        ...
        $repository = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️AuditLogEvent⚡️Config($repository);
        after_repository:        $result['repository'] = $repository;
        ...
        $scripts = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️AuditLogEvent⚡️Config($scripts);
        ...
        $engines = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️AuditLogEvent⚡️Config($engines);
        ...
        $bin = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️AuditLogEvent⚡️Config($bin);
        ...
        $man = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️AuditLogEvent⚡️Config($man);
        ...
        $directories = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️AuditLogEvent⚡️Config($directories);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRegistryPackagePublished⚡️RegistryPackage⚡️PackageVersion⚡️Release(mixed $object): mixed
    {
        ...
        $author = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentCreated⚡️WorkflowRun⚡️HeadRepository⚡️Owner($author);
        after_author:        $result['author'] = $author;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRegistryPackageUpdated(mixed $object): mixed
    {
        ...
        $registry_package = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRegistryPackageUpdated⚡️RegistryPackage($registry_package);
        after_registry_package:        $result['registry_package'] = $registry_package;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRegistryPackageUpdated⚡️RegistryPackage(mixed $object): mixed
    {
        ...
        $package_version = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookRegistryPackageUpdated⚡️RegistryPackage⚡️PackageVersion($package_version);
        after_package_version:        $result['package_version'] = $package_version;
        ...
        $registry = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookCheckSuiteCompleted⚡️ActionsMeta($registry);
        after_registry:        $result['registry'] = $registry;
