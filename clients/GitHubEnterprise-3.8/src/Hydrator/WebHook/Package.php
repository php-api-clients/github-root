...
class Package implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPackagePublished(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished
        {
            $properties = []; 
            $missingFields = [];
            try {
            ...
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished\Package\PackageVersion
        {
            $properties = []; 
            $missingFields = [];
            try {
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookPackagePublished\\Package\\PackageVersion\\NugetMetadata',
));
                }
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookPackagePublished\\Package\\PackageVersion\\PackageFiles',
));
                }
            ...
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished\Package\PackageVersion::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished\Package\PackageVersion(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished\Package\PackageVersion', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️ContainerMetadata(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished\Package\PackageVersion\ContainerMetadata
        {
            $properties = []; 
            $missingFields = [];
            try {
            ...
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished\Package\PackageVersion\ContainerMetadata::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished\Package\PackageVersion\ContainerMetadata(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished\Package\PackageVersion\ContainerMetadata', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata
        {
            $properties = []; 
            $missingFields = [];
            try {
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\AuditLogEvent\\Config',
));
                }
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\AuditLogEvent\\Config',
            ...
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata::class, $missingFields, stack: $this->hydrationStack);
            }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️Release(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished\Package\PackageVersion\Release
        {
            $properties = []; 
            $missingFields = [];
            try {
            ...
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished\Package\PackageVersion\Release::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished\Package\PackageVersion\Release(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished\Package\PackageVersion\Release', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️Registry(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished\Package\Registry
        {
            $properties = []; 
            $missingFields = [];
            try {
            ...
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished\Package\Registry::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished\Package\Registry(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished\Package\Registry', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPackageUpdated(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookPackageUpdated
        {
            $properties = []; 
            $missingFields = [];
            try {
            ...
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookPackageUpdated::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookPackageUpdated(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookPackageUpdated', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPackageUpdated⚡️Package⚡️PackageVersion(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookPackageUpdated\Package\PackageVersion
        {
            ...
            try {
                ...
                if ($package_filesCaster1 === null) {
                    $package_filesCaster1 = new \EventSauce\ObjectHydrator\PropertyCasters\CastListToType(...array (
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookPackageUpdated\\Package\\PackageVersion\\PackageFiles',
));
                }
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPackagePublished⚡️Package(mixed $object): mixed
    {
        ...
        $package_version = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion($package_version);
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished\Package\PackageVersion);
        $result = [];
        ...
        $author = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Discussion⚡️AnswerChosenBy($author);
        ...
        $container_metadata = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️ContainerMetadata($container_metadata);
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\AuditLogEvent\\Data',
        ...
        $npm_metadata = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPackagePublished⚡️Package⚡️PackageVersion⚡️NpmMetadata($npm_metadata);
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\WebhookPackagePublished\\Package\\PackageVersion\\PackageFiles',
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished\Package\PackageVersion\ContainerMetadata);
        $result = [];
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata);
        $result = [];
        ...
        $author = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookCheckSuiteCompleted⚡️ActionsMeta($author);
        after_author:        $result['author'] = $author;
        ...
        $bugs = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookCheckSuiteCompleted⚡️ActionsMeta($bugs);
        ...
        $dist = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookCheckSuiteCompleted⚡️ActionsMeta($dist);
        ...
        $repository = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookCheckSuiteCompleted⚡️ActionsMeta($repository);
        after_repository:        $result['repository'] = $repository;
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\AuditLogEvent\\Config',
        ...
        $directories = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookCheckSuiteCompleted⚡️ActionsMeta($directories);
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished\Package\PackageVersion\Release);
        $result = [];
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookPackagePublished\Package\Registry);
        $result = [];
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookPackageUpdated);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPackageUpdated⚡️Package(mixed $object): mixed
    {
        ...
        $package_version = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPackageUpdated⚡️Package⚡️PackageVersion($package_version);
        after_package_version:        $result['package_version'] = $package_version;
