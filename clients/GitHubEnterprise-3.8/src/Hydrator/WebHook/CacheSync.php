...
class CacheSync implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookCacheSync(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookCacheSync
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                if ($value === null) {
                    $properties['cache_location'] = null;
                    goto after_cache_location;
                }

                $properties['cache_location'] = $value;
    
                after_cache_location:
            ...
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookCacheSync::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookCacheSync(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookCacheSync', $exception, stack: $this->hydrationStack);
            }
        }
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookCacheSync);
        $result = [];
        ...
        $cache_location = $object->cache_location;

        if ($cache_location === null) {
            goto after_cache_location;
        }
        after_cache_location:        $result['cache_location'] = $cache_location;
