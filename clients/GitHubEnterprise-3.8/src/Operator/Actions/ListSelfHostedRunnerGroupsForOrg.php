...
final readonly class ListSelfHostedRunnerGroupsForOrg
{
    ...
    /** @return */
    public function call(string $org, string $visibleToRepository, int $perPage = 30, int $page = 1): Ok|array
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Actions\ListSelfHostedRunnerGroupsForOrg($this->responseSchemaValidator, $this->hydrator, $org, $visibleToRepository, $perPage, $page);
