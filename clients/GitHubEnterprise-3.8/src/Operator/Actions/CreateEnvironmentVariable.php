...
final readonly class CreateEnvironmentVariable
{
    ...
    /** @return */
    public function call(int $repositoryId, string $environmentName, array $params): EmptyObject|array
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Actions\CreateEnvironmentVariable($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $repositoryId, $environmentName);
