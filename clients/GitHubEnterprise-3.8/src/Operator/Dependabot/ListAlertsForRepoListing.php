...
final readonly class ListAlertsForRepoListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Dependabot\ListAlertsForRepoListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $state, $severity, $ecosystem, $package, $manifest, $scope, $before, $after, $last, $sort, $direction, $page, $perPage, $first);
