...
final readonly class UpdateAlert
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Dependabot\UpdateAlert($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $alertNumber);
