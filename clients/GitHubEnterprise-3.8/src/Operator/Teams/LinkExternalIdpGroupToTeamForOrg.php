...
final readonly class LinkExternalIdpGroupToTeamForOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Teams\LinkExternalIdpGroupToTeamForOrg($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $org, $teamSlug);
