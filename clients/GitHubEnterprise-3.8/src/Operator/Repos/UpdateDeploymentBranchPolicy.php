...
final readonly class UpdateDeploymentBranchPolicy
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Repos\UpdateDeploymentBranchPolicy($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $environmentName, $branchPolicyId);
