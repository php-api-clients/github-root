...
final readonly class ListCommitCommentsForRepo
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Repos\ListCommitCommentsForRepo($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
