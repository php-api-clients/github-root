...
final readonly class ListColumnsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Projects\ListColumnsListing($this->responseSchemaValidator, $this->hydrator, $projectId, $perPage, $page);
