...
final class ListSshSigningKeysForAuthenticatedUserListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\User\SshSigningKeys $hydrator, int $perPage = 30, int $page = 1)
    {
