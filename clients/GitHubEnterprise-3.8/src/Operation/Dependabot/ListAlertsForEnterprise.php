...
final class ListAlertsForEnterprise
{
    ...
    /**
     * @return Observable<Schema\DependabotAlertWithRepository>
     */
                    ...
                    **/
                    case 200:
                        foreach ($body as $bodyItem) {
                            $this->responseSchemaValidator->validate($bodyItem, Reader::readFromJson(Schema\DependabotAlertWithRepository::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                        }
