...
final class ListForTeamDiscussionLegacyListing
{
    ...
    /**Returns a single [reaction type](https://docs.github.com/enterprise-server@3.8/rest/reactions/reactions#about-reactions). Omit this parameter to list all reactions to a team discussion. **/
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Teams\TeamId\Discussions\DiscussionNumber\Reactions $hydrator, int $teamId, int $discussionNumber, string $content, int $perPage = 30, int $page = 1)
    {
        $this->teamId           = $teamId;
