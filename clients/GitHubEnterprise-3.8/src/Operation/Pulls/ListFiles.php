...
final class ListFiles
{
    ...
    /**
     * @return \Rx\Observable<Schema\DiffEntry>|Schema\ValidationError|Schema\BasicError|Schema\Operation\CodeScanning\ListAlertsForEnterprise\Response\Applicationjson\H503
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : \Rx\Observable|Schema\ValidationError|Schema\BasicError|Schema\Operation\CodeScanning\ListAlertsForEnterprise\Response\Applicationjson\H503
    {
                ...
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return \Rx\Observable::fromArray($body, new \Rx\Scheduler\ImmediateScheduler())->map(function (array $body) : Schema\DiffEntry {
                            return $this->hydrator->hydrateObject('Schema\\DiffEntry', $body);
                        });
                }
                break;
            /**Service unavailable**/
