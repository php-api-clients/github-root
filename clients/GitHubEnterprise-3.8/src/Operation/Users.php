...
final class Users
{
    ...
    public function listEmailsForAuthenticatedUser(int $perPage, int $page): PromiseInterface
    {
    ...
    public function addEmailForAuthenticatedUser(array $params): PromiseInterface
    {
    ...
    public function deleteEmailForAuthenticatedUser(array $params): PromiseInterface
    {
    ...
    public function listPublicEmailsForAuthenticatedUser(int $perPage, int $page): PromiseInterface
    {
    ...
    public function listSshSigningKeysForAuthenticatedUser(int $perPage, int $page): PromiseInterface
    {
    ...
    public function createSshSigningKeyForAuthenticatedUser(array $params): PromiseInterface
    {
    ...
    public function getSshSigningKeyForAuthenticatedUser(int $sshSigningKeyId): PromiseInterface
    {
    ...
    public function deleteSshSigningKeyForAuthenticatedUser(int $sshSigningKeyId): PromiseInterface
    {
    ...
    public function listSshSigningKeysForUser(string $username, int $perPage, int $page): PromiseInterface
    {
