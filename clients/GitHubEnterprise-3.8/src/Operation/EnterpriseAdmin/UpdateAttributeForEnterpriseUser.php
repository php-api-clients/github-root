...
final class UpdateAttributeForEnterpriseUser
{
    ...
    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Hydrator\Operation\Scim\V2\Users\CbScimUserIdRcb $hydrator, string $scimUserId)
    {
