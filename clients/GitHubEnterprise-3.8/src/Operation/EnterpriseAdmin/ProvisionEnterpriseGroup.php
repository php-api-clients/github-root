...
final class ProvisionEnterpriseGroup
{
    ...
    /**
     * @return Schema\ScimEnterpriseGroupResponse|Schema\ScimError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\ScimEnterpriseGroupResponse|Schema\ScimError
    {
