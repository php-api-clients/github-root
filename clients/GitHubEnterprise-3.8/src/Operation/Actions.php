...
final class Actions
{
    ...
    /** @return Schema\Operations\Actions\ListRepoVariables\Response\ApplicationJson\Ok */
    public function listRepoVariables(string $owner, string $repo, int $perPage, int $page): \ApiClients\Client\GitHubEnterprise\Schema\Operations\Actions\ListRepoVariables\Response\ApplicationJson\Ok|array
    {
