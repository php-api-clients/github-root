...
final class ListRepoVariables
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Actions\Variables $hydrator, string $owner, string $repo, int $perPage = 10, int $page = 1)
    {
        $this->owner = $owner;
        $this->repo = $repo;
     ...
     */
    public function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\Operation\Actions\ListRepoVariables\Response\Applicationjson\H200
    {
