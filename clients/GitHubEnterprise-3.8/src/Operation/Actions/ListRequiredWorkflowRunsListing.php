...
final class ListRequiredWorkflowRunsListing
{
    public const OPERATION_ID = 'actions/list-required-workflow-runs';
    public const OPERATION_MATCH = 'LIST /repos/{owner}/{repo}/actions/required_workflows/{required_workflow_id_for_repo}/runs';
