...
final class GetActionsCacheUsageForEnterprise
{
    ...
    private readonly Hydrator\Operation\Enterprises\Enterprise\Actions\Cache\Usage $hydrator;

    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Enterprises\Enterprise\Actions\Cache\Usage $hydrator, string $enterprise)
    {
