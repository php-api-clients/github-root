...
final class ListArtifactsForRepo
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{owner}', '{repo}', '{name}', '{per_page}', '{page}'), array($this->owner, $this->repo, $this->name, $this->perPage, $this->page), self::PATH . '?name={name}&per_page={per_page}&page={page}'));
    }
    /**
