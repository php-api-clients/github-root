...
namespace ApiClients\Client\GitHubEnterprise\Schema\WebhookRepositoryTransferred\Changes;
...
final readonly class Owner
{
    ...
    public ?Schema\WebhookRepositoryTransferred\Changes\Owner\From $from;
    public function __construct(Schema\WebhookRepositoryTransferred\Changes\Owner\From $from)
    {
        $this->from = $from;
    }
}
