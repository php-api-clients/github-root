...
final readonly class Alert
{
    ...
    public ?Schema\WebhookCheckSuiteCompleted\ActionsMeta $dismissed_by;
    /**
    ...
    public ?string $url;
    public function __construct(string $created_at, string $dismissed_at, Schema\WebhookCheckSuiteCompleted\ActionsMeta $dismissed_by, string $dismissed_reason, string $html_url, Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\MostRecentInstance $most_recent_instance, int $number, Schema\WebhookCodeScanningAlertClosedByUser\Alert\Rule $rule, string $state, Schema\WebhookCodeScanningAlertClosedByUser\Alert\Tool $tool, string $url)
    {
