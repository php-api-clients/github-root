...
final readonly class Dependency
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"package_url":"pkg:\\/npm\\/%40actions\\/http-client@1.0.11","metadata":[],"relationship":"direct","scope":"runtime","dependencies":["@actions\\/http-client","@actions\\/http-client"]}';
