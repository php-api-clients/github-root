...
final readonly class ApiOverview
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"verifiable_password_authentication":true,"packages":["2a01:111:f403:f90c::\\/62"],"dependabot":["192.168.7.16\\/32"],"installed_version":"3.8.0"}';
    /**
