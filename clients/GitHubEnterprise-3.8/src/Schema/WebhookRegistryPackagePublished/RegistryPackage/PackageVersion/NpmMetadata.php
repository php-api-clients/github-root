...
final readonly class NpmMetadata
{
     ...
     */
    public function __construct(public ?string $name, public ?string $version, public ?string $npm_user, public ?Schema\AuditLogEvent\Config $author, public ?Schema\AuditLogEvent\Config $bugs, public ?Schema\AuditLogEvent\Config $dependencies, public ?Schema\AuditLogEvent\Config $dev_dependencies, public ?Schema\AuditLogEvent\Config $peer_dependencies, public ?Schema\AuditLogEvent\Config $optional_dependencies, public ?string $description, public ?Schema\AuditLogEvent\Config $dist, public ?string $git_head, public ?string $homepage, public ?string $license, public ?string $main, public ?Schema\AuditLogEvent\Config $repository, public ?Schema\AuditLogEvent\Config $scripts, public ?string $id, public ?string $node_version, public ?string $npm_version, public ?bool $has_shrinkwrap, public ?array $maintainers, public ?array $contributors, public ?Schema\AuditLogEvent\Config $engines, public ?array $keywords, public ?array $files, public ?Schema\AuditLogEvent\Config $bin, public ?Schema\AuditLogEvent\Config $man, public ?Schema\AuditLogEvent\Config $directories, public ?array $os, public ?array $cpu, public ?string $readme, public ?string $installation_command, public ?int $release_id, public ?string $commit_oid, public ?bool $published_via_actions, public ?int $deleted_by_id)
    {
    }
}
