...
final readonly class WebhookCheckSuiteRequested
{
    ...
    "properties": {
        ...
        "check_suite": {
            ...
            "description": "The [check_suite](https:\\/\\/docs.github.com\\/enterprise-server@3.8\\/rest\\/checks\\/suites#get-a-check-suite)."
        },
        "enterprise": {
            "title": "Enterprise",
            "required": [
    ...
    /**
     * checkSuite: The [check_suite](https://docs.github.com/enterprise-server@3.8/rest/checks/suites#get-a-check-suite).
