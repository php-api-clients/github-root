...
use ApiClients\Client\GitHubEnterprise\Schema\Group\Members;
...
final readonly class Group
{
     ...
     */
    public function __construct(public array $schemas, public string $externalId, public string $displayName, #[CastListToType(Schema\Group\Members::class)] public array $members)
    {
    }
}
