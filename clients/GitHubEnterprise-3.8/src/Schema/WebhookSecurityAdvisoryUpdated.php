...
final readonly class WebhookSecurityAdvisoryUpdated
{
    ...
    public Schema\WebhookSecurityAdvisoryUpdated\SecurityAdvisory $securityAdvisory, public Schema\SimpleUserWebhooks|null $sender,)
    {
    }
}
