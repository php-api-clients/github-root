...
final readonly class UserResponse
{
     ...
     * @param array<UserEmailsResponse> $emails  roles: The roles assigned to the user.
     * @param ?array<UserRole>          $roles
     */
    public function __construct(public array $schemas, public ?string $externalId, public bool $active, public ?string $userName, public ?Schema\UserNameResponse $name, public ?string $displayName, #[CastListToType(Schema\UserEmailsResponse::class)] public array $emails, #[CastListToType(Schema\UserRole::class)] public ?array $roles)
    {
    }
}
