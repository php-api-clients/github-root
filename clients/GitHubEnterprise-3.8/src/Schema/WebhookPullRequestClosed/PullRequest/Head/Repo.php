...
namespace ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestClosed\PullRequest\Head;
...
final readonly class Repo
{
    ...
    public ?Schema\WebhookProjectCardMoved\ProjectCard\Creator $owner;
    public ?bool $private;
