...
namespace ApiClients\Client\GitHubEnterprise\Schema\Git\CreateTree\Request;
...
final readonly class Applicationjson
{
     ...
     * @param array<\ApiClients\Client\GitHubEnterprise\Schema\Git\CreateTree\Request\Applicationjson\Tree> $tree
