...
namespace ApiClients\Client\GitHubEnterprise\Schema\WebhookDiscussionCommentEdited;
...
final readonly class Changes
{
    ...
    public function __construct(Schema\WebhookDiscussionCommentEdited\Changes\Body $body)
    {
        $this->body = $body;
    }
}
