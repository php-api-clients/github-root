...
namespace ApiClients\Client\GitHubEnterprise\Schema\CommitSearchResultItem;
...
final readonly class Commit
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"author":{"name":"generated_name","email":"generated_email","date":"generated_date"},"committer":"generated_committer","comment_count":13,"message":"generated_message","tree":{"sha":"generated_sha","url":"generated_url"},"url":"generated_url","verification":{"verified":false,"reason":"generated_reason","payload":"generated_payload","signature":"generated_signature"}}';
    public ?Schema\CommitSearchResultItem\Commit\Author $author;
    ...
    public function __construct(Schema\CommitSearchResultItem\Commit\Author $author, mixed $committer, int $comment_count, string $message, Schema\ShortBranch\Commit $tree, string $url, Schema\Verification $verification)
    {
        $this->author = $author;
