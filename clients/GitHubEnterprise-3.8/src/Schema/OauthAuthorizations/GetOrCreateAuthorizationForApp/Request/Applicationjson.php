...
final readonly class Applicationjson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"client_secret":"generated_client_secret","scopes":"user","note":"Update all gems","note_url":"generated_note_url","fingerprint":"generated_fingerprint"}';
    /**
    ...
    public function __construct(string $client_secret, array $scopes, string $note, string $note_url, string $fingerprint)
    {
