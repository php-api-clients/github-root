...
final readonly class Applicationjson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"scopes":["public_repo"],"addScopes":["generated_add_scopes_null"],"removeScopes":["generated_remove_scopes_null"],"note":"Update all gems","noteUrl":"generated_note_url_null","fingerprint":"generated_fingerprint_null"}';
    /**
