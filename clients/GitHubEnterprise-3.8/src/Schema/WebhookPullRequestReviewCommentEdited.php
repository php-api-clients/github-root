...
final readonly class WebhookPullRequestReviewCommentEdited
{
    ...
    "properties": {
        ...
        "comment": {
            ...
            "description": "The [comment](https:\\/\\/docs.github.com\\/enterprise-server@3.8\\/rest\\/pulls\\/comments#get-a-review-comment-for-a-pull-request) itself."
        },
        "enterprise": {
            "title": "Enterprise",
            "required": [
     ...
     * comment: The [comment](https://docs.github.com/enterprise-server@3.8/rest/pulls/comments#get-a-review-comment-for-a-pull-request) itself.
