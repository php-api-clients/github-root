...
final readonly class Applicationjson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"state":"generated_state_null","dismissed_reason":"generated_dismissed_reason_null","dismissed_comment":"generated_dismissed_comment_null"}';
    /**
