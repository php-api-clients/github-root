...
final readonly class WebhookSecurityAdvisoryWithdrawn
{
     ...
     */
    public function __construct(public string $action, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks|null $repository, #[MapFrom('security_advisory')]
    public Schema\WebhookSecurityAdvisoryWithdrawn\SecurityAdvisory $securityAdvisory, public Schema\SimpleUserWebhooks|null $sender,)
    {
    }
}
