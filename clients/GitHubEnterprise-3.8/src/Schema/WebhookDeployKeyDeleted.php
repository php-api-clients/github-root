...
final readonly class WebhookDeployKeyDeleted
{
    ...
    "properties": {
        ...
        "key": {
            ...
            "description": "The [`deploy key`](https:\\/\\/docs.github.com\\/enterprise-server@3.8\\/rest\\/deploy-keys\\/deploy-keys#get-a-deploy-key) resource."
        },
        "organization": {
    ...
    for and sent to a GitHub App. For more information,
    see "[Using webhooks with GitHub Apps](https://docs.github.com/enterprise-server@3.8/apps/creating-github-apps/registering-a-github-app/using-webhooks-with-github-apps)."
     * key: The [`deploy key`](https://docs.github.com/enterprise-server@3.8/rest/deploy-keys/deploy-keys#get-a-deploy-key) resource.
