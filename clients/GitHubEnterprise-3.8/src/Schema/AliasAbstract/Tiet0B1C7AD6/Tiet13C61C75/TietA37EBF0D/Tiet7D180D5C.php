...
namespace ApiClients\Client\GitHubEnterprise\Schema\AliasAbstract\Tiet0B1C7AD6\Tiet13C61C75\TietA37EBF0D;

use EventSauce\ObjectHydrator\MapFrom;

abstract readonly class Tiet7D180D5C
{
    ...
    public const SCHEMA_DESCRIPTION  = 'The [`deploy key`](https://docs.github.com/enterprise-server@3.8/rest/deploy-keys/deploy-keys#get-a-deploy-key) resource.';
