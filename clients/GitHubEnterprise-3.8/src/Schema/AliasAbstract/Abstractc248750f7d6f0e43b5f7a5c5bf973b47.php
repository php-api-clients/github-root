...
abstract readonly class Abstractc248750f7d6f0e43b5f7a5c5bf973b47
{
    ...
    /**
     * @param array<ActionsVariable> $variables
     */
    public function __construct(#[MapFrom('total_count')] public int $totalCount, #[CastListToType(Schema\ActionsVariable::class)] public array $variables)
    {
    }
}
