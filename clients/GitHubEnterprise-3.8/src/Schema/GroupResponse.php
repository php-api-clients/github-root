...
use ApiClients\Client\GitHubEnterprise\Schema\GroupResponse\Members;
...
final readonly class GroupResponse
{
     ...
     */
    public function __construct(public array $schemas, public ?string $externalId, public ?string $displayName, #[CastListToType(Schema\GroupResponse\Members::class)] public ?array $members)
    {
    }
}
