...
final readonly class ScimEnterpriseUserList
{
     ...
     * @param array<UserResponse> $resources startIndex: A starting index for the returned page
     * itemsPerPage: Number of objects per page
     */
    public function __construct(public array $schemas, public int $totalResults, #[MapFrom('Resources')] #[CastListToType(Schema\UserResponse::class)] public array $resources, public int $startIndex, public int $itemsPerPage)
    {
    }
}
