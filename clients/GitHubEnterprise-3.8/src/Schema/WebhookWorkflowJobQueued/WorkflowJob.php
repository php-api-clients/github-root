...
namespace ApiClients\Client\GitHubEnterprise\Schema\WebhookWorkflowJobQueued;
...
final readonly class WorkflowJob
{
     ...
     * @param array<\ApiClients\Client\GitHubEnterprise\Schema\WebhookWorkflowJobQueued\WorkflowJob\Steps> $steps
     */
