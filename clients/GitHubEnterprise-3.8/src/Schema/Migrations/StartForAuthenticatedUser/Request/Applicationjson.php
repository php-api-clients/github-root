...
namespace ApiClients\Client\GitHubEnterprise\Schema\Migrations\StartForAuthenticatedUser\Request;
...
final readonly class Applicationjson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"lock_repositories":true,"exclude_metadata":true,"exclude_git_data":true,"exclude_attachments":true,"exclude_releases":true,"exclude_owner_projects":true,"org_metadata_only":true,"exclude":["repositories"],"repositories":[null]}';
    /**
