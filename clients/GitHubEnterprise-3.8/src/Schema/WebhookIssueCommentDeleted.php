...
final readonly class WebhookIssueCommentDeleted
{
    ...
    "properties": {
        ...
        "issue": {
            "allOf": [
                {
                    ...
                    "description": "The [issue](https:\\/\\/docs.github.com\\/enterprise-server@3.8\\/rest\\/issues\\/issues#get-an-issue) itself."
                },
                {
                    "required": [
                        "labels",
            ...
            "description": "The [issue](https:\\/\\/docs.github.com\\/enterprise-server@3.8\\/rest\\/issues\\/issues#get-an-issue) the comment belongs to."
        },
        "organization": {
    ...
    /**
     * comment: The [comment](https://docs.github.com/enterprise-server@3.8/rest/issues/comments#get-an-issue-comment) itself.
    ...
    for and sent to a GitHub App. For more information,
    see "[Using webhooks with GitHub Apps](https://docs.github.com/enterprise-server@3.8/apps/creating-github-apps/registering-a-github-app/using-webhooks-with-github-apps)."
     * issue: The [issue](https://docs.github.com/enterprise-server@3.8/rest/issues/issues#get-an-issue) the comment belongs to.
