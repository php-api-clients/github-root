...
final readonly class Applicationjson
{
    ...
    public function __construct(string $tag_name, string $target_commitish, string $name, string $body, bool $draft, bool $prerelease, bool $generate_release_notes, string $make_latest)
    {
