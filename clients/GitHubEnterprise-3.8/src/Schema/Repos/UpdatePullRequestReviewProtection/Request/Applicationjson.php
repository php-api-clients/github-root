...
final readonly class Applicationjson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"dismissal_restrictions":{"users":[null],"teams":[null],"apps":[null]},"dismiss_stale_reviews":false,"require_code_owner_reviews":false,"required_approving_review_count":13,"require_last_push_approval":false,"bypass_pull_request_allowances":{"users":[null],"teams":[null],"apps":[null]}}';
    /**
    ...
    /**
     * Blocks merging pull requests until [code owners](https://docs.github.com/enterprise-server@3.8/articles/about-code-owners/) have reviewed.
     */
     ...
     */
    public ?Schema\Repos\UpdateBranchProtection\Request\Applicationjson\RequiredPullRequestReviews\BypassPullRequestAllowances $bypass_pull_request_allowances;
    public function __construct(Schema\Repos\UpdateBranchProtection\Request\Applicationjson\RequiredPullRequestReviews\DismissalRestrictions $dismissal_restrictions, bool $dismiss_stale_reviews, bool $require_code_owner_reviews, int $required_approving_review_count, bool $require_last_push_approval, Schema\Repos\UpdateBranchProtection\Request\Applicationjson\RequiredPullRequestReviews\BypassPullRequestAllowances $bypass_pull_request_allowances)
    {
