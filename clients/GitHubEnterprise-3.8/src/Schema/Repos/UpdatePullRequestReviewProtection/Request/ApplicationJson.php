...
final readonly class ApplicationJson
{
     ...
     * requireCodeOwnerReviews: Blocks merging pull requests until [code owners](https://docs.github.com/enterprise-server@3.8/articles/about-code-owners/) have reviewed.
     ...
     */
    public function __construct(#[MapFrom('dismissal_restrictions')] public ?Schema\Repos\UpdateBranchProtection\Request\ApplicationJson\RequiredPullRequestReviews\DismissalRestrictions $dismissalRestrictions, #[MapFrom('dismiss_stale_reviews')] public ?bool $dismissStaleReviews, #[MapFrom('require_code_owner_reviews')] public ?bool $requireCodeOwnerReviews, #[MapFrom('required_approving_review_count')] public ?int $requiredApprovingReviewCount, #[MapFrom('require_last_push_approval')] public ?bool $requireLastPushApproval, #[MapFrom('bypass_pull_request_allowances')] public ?Schema\Repos\UpdateBranchProtection\Request\ApplicationJson\RequiredPullRequestReviews\BypassPullRequestAllowances $bypassPullRequestAllowances)
    {
    }
}
