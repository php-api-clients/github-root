...
namespace ApiClients\Client\GitHubEnterprise\Schema\WebhookWorkflowJobWaiting;
...
final readonly class WorkflowJob
{
     ...
     * @param array<\ApiClients\Client\GitHubEnterprise\Schema\WebhookWorkflowJobWaiting\WorkflowJob\Steps> $steps
     */
