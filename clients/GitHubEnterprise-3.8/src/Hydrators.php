...
final class Hydrators implements \EventSauce\ObjectHydrator\ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload) : object
    {
        return match ($className) {
            ...
            'ApiClients\\Client\\Github\\Schema\\EnterpriseSecurityAnalysisSettings' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀CodeSecurityAndAnalysis()->hydrateObject($className, $payload),
            'ApiClients\\Client\\Github\\Schema\\DependabotAlertWithRepository', 'ApiClients\\Client\\Github\\Schema\\DependabotAlertWithRepository\\Dependency', 'ApiClients\\Client\\Github\\Schema\\DependabotAlertPackage', 'ApiClients\\Client\\Github\\Schema\\DependabotAlertSecurityAdvisory', 'ApiClients\\Client\\Github\\Schema\\DependabotAlertSecurityVulnerability', 'ApiClients\\Client\\Github\\Schema\\DependabotAlertSecurityVulnerability\\FirstPatchedVersion', 'ApiClients\\Client\\Github\\Schema\\DependabotAlertSecurityAdvisory\\Cvss', 'ApiClients\\Client\\Github\\Schema\\DependabotAlertSecurityAdvisory\\Cwes', 'ApiClients\\Client\\Github\\Schema\\DependabotAlertSecurityAdvisory\\Identifiers', 'ApiClients\\Client\\Github\\Schema\\DependabotAlertSecurityAdvisory\\References' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀Dependabot🌀Alerts()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\AnnouncementBanner' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀Announcement()->hydrateObject($className, $payload),
    ...
    public function serializeObjectOfType(object $object, string $className) : mixed
    {
        return match ($className) {
            ...
            'ApiClients\\Client\\Github\\Schema\\EnterpriseSecurityAnalysisSettings' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀CodeSecurityAndAnalysis()->serializeObject($object),
            'ApiClients\\Client\\Github\\Schema\\DependabotAlertWithRepository', 'ApiClients\\Client\\Github\\Schema\\DependabotAlertWithRepository\\Dependency', 'ApiClients\\Client\\Github\\Schema\\DependabotAlertPackage', 'ApiClients\\Client\\Github\\Schema\\DependabotAlertSecurityAdvisory', 'ApiClients\\Client\\Github\\Schema\\DependabotAlertSecurityVulnerability', 'ApiClients\\Client\\Github\\Schema\\DependabotAlertSecurityVulnerability\\FirstPatchedVersion', 'ApiClients\\Client\\Github\\Schema\\DependabotAlertSecurityAdvisory\\Cvss', 'ApiClients\\Client\\Github\\Schema\\DependabotAlertSecurityAdvisory\\Cwes', 'ApiClients\\Client\\Github\\Schema\\DependabotAlertSecurityAdvisory\\Identifiers', 'ApiClients\\Client\\Github\\Schema\\DependabotAlertSecurityAdvisory\\References' => $this->getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀Dependabot🌀Alerts()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\AnnouncementBanner' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀Announcement()->serializeObject($object),
