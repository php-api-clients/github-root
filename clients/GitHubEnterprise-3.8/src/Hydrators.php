...
final class Hydrators implements \EventSauce\ObjectHydrator\ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload) : object
    {
        return match ($className) {
            ...
            'ApiClients\\Client\\GitHubEnterprise\\Schema\\SecretScanningLocation', 'ApiClients\\Client\\GitHubEnterprise\\Schema\\SecretScanningLocationIssueComment' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀SecretDashScanning🌀Alerts🌀CbAlertNumberRcb🌀Locations()->hydrateObject($className, $payload),
    ...
    public function serializeObject(object $object) : mixed
    {
        return match ($object::class) {
            ...
            'ApiClients\\Client\\GitHubEnterprise\\Schema\\SecretScanningLocation', 'ApiClients\\Client\\GitHubEnterprise\\Schema\\SecretScanningLocationIssueComment' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀SecretDashScanning🌀Alerts🌀CbAlertNumberRcb🌀Locations()->serializeObject($object),
