...
final class GetGrantTest extends AsyncTestCase
{
    ...
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], Schema\ApplicationGrant::SCHEMA_EXAMPLE_DATA);
        ...
        $result = $client->call(Operation\OauthAuthorizations\GetGrant::OPERATION_MATCH, (static function (array $data): array {
            $data['grant_id'] = 8;
    ...
    public function operations_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/applications/grants/8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = await($client->operations()->oauthAuthorizations()->getGrant(8));
    }
