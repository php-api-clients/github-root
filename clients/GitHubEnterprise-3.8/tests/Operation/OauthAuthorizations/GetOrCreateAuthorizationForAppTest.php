...
final class GetOrCreateAuthorizationForAppTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/authorizations/clients/generated', Argument::type('array'), Schema\OauthAuthorizations\GetOrCreateAuthorizationForApp\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
