...
use ApiClients\Client\GitHubEnterprise\Operation\OauthAuthorizations\UpdateAuthorization;
...
final class UpdateAuthorizationTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PATCH', '/authorizations/13', Argument::type('array'), Schema\OauthAuthorizations\UpdateAuthorization\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(UpdateAuthorization::OPERATION_MATCH, (static function (array $data): array {
