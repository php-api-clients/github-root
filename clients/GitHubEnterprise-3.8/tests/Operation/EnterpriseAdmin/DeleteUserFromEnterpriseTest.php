...
final class DeleteUserFromEnterpriseTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function httpCode_400_responseContentType_application_json()
    {
        ...
        $browser->request('DELETE', '/scim/v2/Users/generated_null', \Prophecy\Argument::type('array'), \Prophecy\Argument::any())->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterprise\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterprise\Operation\EnterpriseAdmin\DeleteUserFromEnterprise::OPERATION_MATCH, (static function (array $data) : array {
