...
final class DeleteUserFromEnterpriseTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function t400td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('DELETE', '/scim/v2/Users/generated_null', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\Github\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\Github\Operation\EnterpriseAdmin\DeleteUserFromEnterprise::OPERATION_MATCH, array('scim_user_id' => 'generated_null'));
    }
    /**
     * @test
     */
