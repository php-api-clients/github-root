...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Users\DeleteSocialAccountForAuthenticatedUser;
...
final class DeleteSocialAccountForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function httpCode_422_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $client->call(DeleteSocialAccountForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
            return $data;
