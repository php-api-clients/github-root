...
final class DeleteSocialAccountForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_422_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/user/social_accounts', Argument::type('array'), Schema\Users\DeleteSocialAccountForAuthenticatedUser\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Operation\Users\DeleteSocialAccountForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
            return $data;
    ...
    public function operations_httpCode_422_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/user/social_accounts', Argument::type('array'), Schema\Users\DeleteSocialAccountForAuthenticatedUser\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = await($client->operations()->users()->deleteSocialAccountForAuthenticatedUser(json_decode(Schema\Users\DeleteSocialAccountForAuthenticatedUser\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)));
    }
