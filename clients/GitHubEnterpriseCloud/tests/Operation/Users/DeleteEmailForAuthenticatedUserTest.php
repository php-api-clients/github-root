...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Users\DeleteEmailForAuthenticatedUser;
...
final class DeleteEmailForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function httpCode_404_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('DELETE', '/user/emails', Argument::type('array'), Schema\Users\DeleteEmailForAuthenticatedUser\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(DeleteEmailForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
            return $data;
