...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Users\Block;
...
final class BlockTest extends AsyncTestCase
{
    ...
    public function httpCode_404_responseContentType_application_json(): void
    {
        ...
        $browser->request('PUT', '/user/blocks/generated_null', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(Block::OPERATION_MATCH, (static function (array $data): array {
