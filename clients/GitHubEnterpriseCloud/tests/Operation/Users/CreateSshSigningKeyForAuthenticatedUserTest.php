...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Users\CreateSshSigningKeyForAuthenticatedUser;
...
final class CreateSshSigningKeyForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function httpCode_201_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $client->call(CreateSshSigningKeyForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
            return $data;
