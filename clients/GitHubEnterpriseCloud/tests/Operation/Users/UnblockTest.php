...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Users\Unblock;
...
final class UnblockTest extends AsyncTestCase
{
    ...
    public function httpCode_403_responseContentType_application_json(): void
    {
        ...
        $browser->request('DELETE', '/user/blocks/generated_null', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(Unblock::OPERATION_MATCH, (static function (array $data): array {
