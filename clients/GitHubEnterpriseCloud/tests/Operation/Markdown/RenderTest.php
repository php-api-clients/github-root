...
namespace ApiClients\Tests\Client\GitHubEnterpriseCloud\Operation\Markdown;
...
final class RenderTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_text_html()
    {
        ...
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\Markdown\Render::OPERATION_MATCH, (static function (array $data) : array {
            return $data;
