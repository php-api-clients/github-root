...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Operation\Copilot\AddCopilotForBusinessSeatsForUsers */
final class AddCopilotForBusinessSeatsForUsersTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        $response = new Response(201, ['Content-Type' => 'application/json'], json_encode(json_decode(Schema\Operations\Copilot\AddCopilotForBusinessSeatsForUsers\Response\ApplicationJson\Created\Application\Json::SCHEMA_EXAMPLE_DATA, true)));
        $auth     = $this->prophesize(AuthenticationInterface::class);
        $auth->authHeader(Argument::any())->willReturn('Bearer beer')->shouldBeCalled();
        $browser = $this->prophesize(Browser::class);
        $browser->withBase(Argument::any())->willReturn($browser->reveal());
        $browser->withFollowRedirects(Argument::any())->willReturn($browser->reveal());
        $browser->request('POST', '/orgs/generated/copilot/billing/selected_users', Argument::type('array'), json_encode(json_decode(Schema\Copilot\AddCopilotForBusinessSeatsForUsers\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
    ...
    public function operations_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/orgs/generated/copilot/billing/selected_users', Argument::type('array'), json_encode(json_decode(Schema\Copilot\AddCopilotForBusinessSeatsForUsers\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->copilot()->addCopilotForBusinessSeatsForUsers('generated', json_decode(Schema\Copilot\AddCopilotForBusinessSeatsForUsers\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
