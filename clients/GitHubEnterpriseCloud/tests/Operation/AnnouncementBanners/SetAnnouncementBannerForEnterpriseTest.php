...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\AnnouncementBanners\SetAnnouncementBannerForEnterprise;
...
final class SetAnnouncementBannerForEnterpriseTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PATCH', '/enterprises/generated_null/announcement', Argument::type('array'), Schema\Announcement::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(SetAnnouncementBannerForEnterprise::OPERATION_MATCH, (static function (array $data): array {
