...
final class RemoveRepoFromInstallationForAuthenticatedUserTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function httpCode_403_responseContentType_application_json()
    {
        ...
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\Apps\RemoveRepoFromInstallationForAuthenticatedUser::OPERATION_MATCH, (static function (array $data) : array {
