...
final class GetSubscriptionPlanForAccountStubbedTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function httpCode_200_responseContentType_application_json()
    {
        ...
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\Apps\GetSubscriptionPlanForAccountStubbed::OPERATION_MATCH, (static function (array $data) : array {
            $data['account_id'] = 13;
            return $data;
        })(array()));
    }
