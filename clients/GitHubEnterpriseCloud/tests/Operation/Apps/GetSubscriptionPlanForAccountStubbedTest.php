...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Apps\GetSubscriptionPlanForAccountStubbed;
...
final class GetSubscriptionPlanForAccountStubbedTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/marketplace_listing/stubbed/accounts/13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(GetSubscriptionPlanForAccountStubbed::OPERATION_MATCH, (static function (array $data): array {
            $data['account_id'] = 13;
