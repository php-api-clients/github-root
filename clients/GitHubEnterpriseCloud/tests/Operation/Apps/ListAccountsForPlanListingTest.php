...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Operation\Apps\ListAccountsForPlanListing */
final class ListAccountsForPlanListingTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Operation\Apps\ListAccountsForPlanListing::OPERATION_MATCH, (static function (array $data): array {
            $data['plan_id']   = 7;
