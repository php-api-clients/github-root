...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Apps\ScopeToken;
...
final class ScopeTokenTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/applications/generated_null/token/scoped', Argument::type('array'), Schema\Apps\ScopeToken\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(ScopeToken::OPERATION_MATCH, (static function (array $data): array {
