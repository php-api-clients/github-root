...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Operation\Apps\ScopeToken */
final class ScopeTokenTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/applications/generated/token/scoped', Argument::type('array'), json_encode(json_decode(Schema\Apps\ScopeToken\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Operation\Apps\ScopeToken::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/applications/generated/token/scoped', Argument::type('array'), json_encode(json_decode(Schema\Apps\ScopeToken\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->apps()->scopeToken('generated', json_decode(Schema\Apps\ScopeToken\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
