...
final class ScopeTokenTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/applications/generated/token/scoped', Argument::type('array'), Schema\Apps\ScopeToken\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
    ...
    public function operations_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/applications/generated/token/scoped', Argument::type('array'), Schema\Apps\ScopeToken\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = await($client->operations()->apps()->scopeToken('generated', json_decode(Schema\Apps\ScopeToken\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)));
    }
