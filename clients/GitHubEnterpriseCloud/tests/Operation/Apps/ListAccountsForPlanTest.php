...
final class ListAccountsForPlanTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function t200td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('GET', '/marketplace_listing/plans/13/accounts?direction=generated_null&sort=generated_null&per_page=13&page=13', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterpriseCloud\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\Apps\ListAccountsForPlan::OPERATION_MATCH, array('plan_id' => 13, 'direction' => 'generated_null', 'sort' => 'generated_null', 'per_page' => 13, 'page' => 13));
    }
    /**
     * @test
     */
