...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Apps\ListAccountsForPlan;
...
final class ListAccountsForPlanTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/marketplace_listing/plans/13/accounts?direction=generated_null&sort=generated_null&per_page=13&page=13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(ListAccountsForPlan::OPERATION_MATCH, (static function (array $data): array {
            $data['plan_id']   = 13;
