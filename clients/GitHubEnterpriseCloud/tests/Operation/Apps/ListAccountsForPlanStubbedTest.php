...
final class ListAccountsForPlanStubbedTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json()
    {
        ...
        $browser->request('GET', '/marketplace_listing/stubbed/plans/13/accounts?direction=generated_null&sort=generated_null&per_page=13&page=13', \Prophecy\Argument::type('array'), \Prophecy\Argument::any())->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterpriseCloud\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\Apps\ListAccountsForPlanStubbed::OPERATION_MATCH, (static function (array $data) : array {
            $data['plan_id'] = 13;
