...
final class GetSubscriptionPlanForAccountTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function httpCode_200_responseContentType_application_json()
    {
        ...
        $browser->request('GET', '/marketplace_listing/accounts/13', \Prophecy\Argument::type('array'), \Prophecy\Argument::any())->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterpriseCloud\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\Apps\GetSubscriptionPlanForAccount::OPERATION_MATCH, (static function (array $data) : array {
            $data['account_id'] = 13;
            return $data;
        })(array()));
    }
