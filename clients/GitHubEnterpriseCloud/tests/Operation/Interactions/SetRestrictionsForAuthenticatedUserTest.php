...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Interactions\SetRestrictionsForAuthenticatedUser;
...
final class SetRestrictionsForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PUT', '/user/interaction-limits', Argument::type('array'), Schema\InteractionLimit::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(SetRestrictionsForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
            return $data;
