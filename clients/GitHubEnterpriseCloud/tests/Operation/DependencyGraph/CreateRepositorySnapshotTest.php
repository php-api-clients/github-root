...
final class CreateRepositorySnapshotTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function httpCode_201_requestContentType_application_json_responseContentType_application_json()
    {
        ...
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\DependencyGraph\CreateRepositorySnapshot::OPERATION_MATCH, (static function (array $data) : array {
