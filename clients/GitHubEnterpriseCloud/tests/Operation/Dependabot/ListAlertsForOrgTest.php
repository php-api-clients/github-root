...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Operation\Dependabot\ListAlertsForOrg */
final class ListAlertsForOrgTest extends AsyncTestCase
{
    ...
    public function call_httpCode_400_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Operation\Dependabot\ListAlertsForOrg::OPERATION_MATCH, (static function (array $data): array {
            $data['org']       = 'generated';
