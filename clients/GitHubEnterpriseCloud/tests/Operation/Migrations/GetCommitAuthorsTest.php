...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Migrations\GetCommitAuthors;
...
final class GetCommitAuthorsTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/repos/generated_null/generated_null/import/authors?since=13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(GetCommitAuthors::OPERATION_MATCH, (static function (array $data): array {
