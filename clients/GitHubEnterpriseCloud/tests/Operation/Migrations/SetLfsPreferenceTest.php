...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Migrations\SetLfsPreference;
...
final class SetLfsPreferenceTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PATCH', '/repos/generated_null/generated_null/import/lfs', Argument::type('array'), Schema\Migrations\SetLfsPreference\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(SetLfsPreference::OPERATION_MATCH, (static function (array $data): array {
