...
final class CancelImportTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function httpCode_503_responseContentType_application_json()
    {
        ...
        $browser->request('DELETE', '/repos/generated_null/generated_null/import', \Prophecy\Argument::type('array'), \Prophecy\Argument::any())->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterpriseCloud\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\Migrations\CancelImport::OPERATION_MATCH, (static function (array $data) : array {
