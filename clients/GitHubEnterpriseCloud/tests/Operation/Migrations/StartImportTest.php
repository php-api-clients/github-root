...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Migrations\StartImport;
...
final class StartImportTest extends AsyncTestCase
{
    ...
    public function httpCode_201_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PUT', '/repos/generated_null/generated_null/import', Argument::type('array'), Schema\Migrations\StartImport\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(StartImport::OPERATION_MATCH, (static function (array $data): array {
