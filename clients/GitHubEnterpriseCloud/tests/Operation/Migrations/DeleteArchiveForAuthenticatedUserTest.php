...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Migrations\DeleteArchiveForAuthenticatedUser;
...
final class DeleteArchiveForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function httpCode_404_responseContentType_application_json(): void
    {
        ...
        $browser->request('DELETE', '/user/migrations/13/archive', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(DeleteArchiveForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
