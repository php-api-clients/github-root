...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Migrations\UnlockRepoForAuthenticatedUser;
...
final class UnlockRepoForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function httpCode_404_responseContentType_application_json(): void
    {
        ...
        $browser->request('DELETE', '/user/migrations/13/repos/generated_null/lock', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(UnlockRepoForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
