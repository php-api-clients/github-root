...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Migrations\GetImportStatus;
...
final class GetImportStatusTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/repos/generated_null/generated_null/import', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(GetImportStatus::OPERATION_MATCH, (static function (array $data): array {
