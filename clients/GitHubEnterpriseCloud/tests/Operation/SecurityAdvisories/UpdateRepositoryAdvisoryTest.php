...
final class UpdateRepositoryAdvisoryTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PATCH', '/repos/generated/generated/security-advisories/generated', Argument::type('array'), Schema\RepositoryAdvisoryUpdate::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
