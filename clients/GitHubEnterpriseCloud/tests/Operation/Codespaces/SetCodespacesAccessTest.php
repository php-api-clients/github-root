...
final class SetCodespacesAccessTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/orgs/generated/codespaces/access', Argument::type('array'), Schema\Codespaces\SetCodespacesAccess\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
    ...
    public function operations_httpCode_404_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/orgs/generated/codespaces/access', Argument::type('array'), Schema\Codespaces\SetCodespacesAccess\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = await($client->operations()->codespaces()->setCodespacesAccess('generated', json_decode(Schema\Codespaces\SetCodespacesAccess\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)));
    }
