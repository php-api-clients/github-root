...
final class SetCodespacesAccessUsersTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/orgs/generated/codespaces/access/selected_users', Argument::type('array'), Schema\Codespaces\SetCodespacesAccessUsers\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Operation\Codespaces\SetCodespacesAccessUsers::OPERATION_MATCH, (static function (array $data): array {
            $data['org'] = 'generated';
    ...
    public function operations_httpCode_404_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/orgs/generated/codespaces/access/selected_users', Argument::type('array'), Schema\Codespaces\SetCodespacesAccessUsers\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = await($client->operations()->codespaces()->setCodespacesAccessUsers('generated', json_decode(Schema\Codespaces\SetCodespacesAccessUsers\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)));
    }
