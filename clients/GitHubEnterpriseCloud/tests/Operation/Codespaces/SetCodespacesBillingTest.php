...
final class SetCodespacesBillingTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function t404td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('PUT', '/orgs/generated_null/codespaces/billing', \Prophecy\Argument::type('array'), Schema\Codespaces\SetCodespacesBilling\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterpriseCloud\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\Codespaces\SetCodespacesBilling::OPERATION_MATCH, (static function (array $data) : array {
