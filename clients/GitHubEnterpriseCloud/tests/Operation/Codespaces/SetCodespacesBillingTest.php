...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Codespaces\SetCodespacesBilling;
...
final class SetCodespacesBillingTest extends AsyncTestCase
{
    ...
    public function httpCode_404_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PUT', '/orgs/generated_null/codespaces/billing', Argument::type('array'), Schema\Codespaces\SetCodespacesBilling\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(SetCodespacesBilling::OPERATION_MATCH, (static function (array $data): array {
