...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Codespaces\StopForAuthenticatedUser;
...
final class StopForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/user/codespaces/generated_null/stop', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(StopForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
