...
final class SetSelectedReposForOrgSecretTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/orgs/generated/codespaces/secrets/generated/repositories', Argument::type('array'), Schema\Codespaces\SetSelectedReposForOrgSecret\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Operation\Codespaces\SetSelectedReposForOrgSecret::OPERATION_MATCH, (static function (array $data): array {
            $data['org']         = 'generated';
