...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Codespaces\SetSelectedReposForOrgSecret;
...
final class SetSelectedReposForOrgSecretTest extends AsyncTestCase
{
    ...
    public function httpCode_404_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PUT', '/orgs/generated_null/codespaces/secrets/generated_null/repositories', Argument::type('array'), Schema\Codespaces\SetSelectedReposForOrgSecret\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(SetSelectedReposForOrgSecret::OPERATION_MATCH, (static function (array $data): array {
