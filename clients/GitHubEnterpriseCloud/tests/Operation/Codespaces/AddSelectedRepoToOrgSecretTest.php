...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Codespaces\AddSelectedRepoToOrgSecret;
...
final class AddSelectedRepoToOrgSecretTest extends AsyncTestCase
{
    ...
    public function httpCode_404_responseContentType_application_json(): void
    {
        ...
        $browser->request('PUT', '/orgs/generated_null/codespaces/secrets/generated_null/repositories/13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(AddSelectedRepoToOrgSecret::OPERATION_MATCH, (static function (array $data): array {
