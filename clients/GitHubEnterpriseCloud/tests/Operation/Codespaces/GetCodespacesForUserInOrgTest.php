...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Operation\Codespaces\GetCodespacesForUserInOrg */
final class GetCodespacesForUserInOrgTest extends AsyncTestCase
{
    ...
    public function operations_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/orgs/generated/members/generated/codespaces?per_page=8&page=4', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->codespaces()->getCodespacesForUserInOrg('generated', 'generated', 8, 4);
    }
