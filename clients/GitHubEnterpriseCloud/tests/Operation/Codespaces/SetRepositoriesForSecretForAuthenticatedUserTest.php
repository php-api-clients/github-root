...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Operation\Codespaces\SetRepositoriesForSecretForAuthenticatedUser */
final class SetRepositoriesForSecretForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_401_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/user/codespaces/secrets/generated/repositories', Argument::type('array'), json_encode(json_decode(Schema\Codespaces\SetRepositoriesForSecretForAuthenticatedUser\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Operation\Codespaces\SetRepositoriesForSecretForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_401_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/user/codespaces/secrets/generated/repositories', Argument::type('array'), json_encode(json_decode(Schema\Codespaces\SetRepositoriesForSecretForAuthenticatedUser\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->codespaces()->setRepositoriesForSecretForAuthenticatedUser('generated', json_decode(Schema\Codespaces\SetRepositoriesForSecretForAuthenticatedUser\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
