...
final class SetRepositoriesForSecretForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_401_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/user/codespaces/secrets/generated/repositories', Argument::type('array'), Schema\Codespaces\SetRepositoriesForSecretForAuthenticatedUser\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
    ...
    public function operations_httpCode_401_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/user/codespaces/secrets/generated/repositories', Argument::type('array'), Schema\Codespaces\SetRepositoriesForSecretForAuthenticatedUser\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = await($client->operations()->codespaces()->setRepositoriesForSecretForAuthenticatedUser('generated', json_decode(Schema\Codespaces\SetRepositoriesForSecretForAuthenticatedUser\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)));
    }
