...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Operation\Codespaces\StartForAuthenticatedUser */
final class StartForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Operation\Codespaces\StartForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
    ...
    {
        self::expectException(ErrorSchemas\BasicError::class);
        $response = new Response(402, ['Content-Type' => 'application/json'], json_encode(json_decode(Schema\BasicError::SCHEMA_EXAMPLE_DATA, true)));
        $auth     = $this->prophesize(AuthenticationInterface::class);
        $auth->authHeader(Argument::any())->willReturn('Bearer beer')->shouldBeCalled();
        $browser = $this->prophesize(Browser::class);
        $browser->withBase(Argument::any())->willReturn($browser->reveal());
