...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Operation\Codespaces\RepoMachinesForAuthenticatedUser */
final class RepoMachinesForAuthenticatedUserTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(Schema\Operations\Codespaces\RepoMachinesForAuthenticatedUser\Response\ApplicationJson\Ok::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(Operation\Codespaces\RepoMachinesForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
