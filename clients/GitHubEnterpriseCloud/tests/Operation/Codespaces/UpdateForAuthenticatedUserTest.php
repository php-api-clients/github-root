...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Codespaces\UpdateForAuthenticatedUser;
...
final class UpdateForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PATCH', '/user/codespaces/generated_null', Argument::type('array'), Schema\Codespaces\UpdateForAuthenticatedUser\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(UpdateForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
