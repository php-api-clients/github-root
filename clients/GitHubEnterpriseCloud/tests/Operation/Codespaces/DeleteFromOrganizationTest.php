...
final class DeleteFromOrganizationTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function httpCode_202_responseContentType_application_json()
    {
        ...
        $browser->request('DELETE', '/orgs/generated_null/members/generated_null/codespaces/generated_null', \Prophecy\Argument::type('array'), \Prophecy\Argument::any())->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterpriseCloud\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\Codespaces\DeleteFromOrganization::OPERATION_MATCH, (static function (array $data) : array {
