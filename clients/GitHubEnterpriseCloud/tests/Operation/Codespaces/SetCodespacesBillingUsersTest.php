...
final class SetCodespacesBillingUsersTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/orgs/generated/codespaces/billing/selected_users', Argument::type('array'), Schema\Codespaces\SetCodespacesBillingUsers\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Operation\Codespaces\SetCodespacesBillingUsers::OPERATION_MATCH, (static function (array $data): array {
            $data['org'] = 'generated';
