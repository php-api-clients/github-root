...
final class CreateOrUpdateOrgSecretTest extends AsyncTestCase
{
    ...
    public function call_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/orgs/generated/codespaces/secrets/generated', Argument::type('array'), Schema\Codespaces\CreateOrUpdateOrgSecret\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Operation\Codespaces\CreateOrUpdateOrgSecret::OPERATION_MATCH, (static function (array $data): array {
            $data['org']         = 'generated';
