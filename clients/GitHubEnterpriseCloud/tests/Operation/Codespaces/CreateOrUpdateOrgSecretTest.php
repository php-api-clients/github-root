...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Codespaces\CreateOrUpdateOrgSecret;
...
final class CreateOrUpdateOrgSecretTest extends AsyncTestCase
{
    ...
    public function httpCode_201_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PUT', '/orgs/generated_null/codespaces/secrets/generated_null', Argument::type('array'), Schema\Codespaces\CreateOrUpdateOrgSecret\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
