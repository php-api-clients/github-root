...
final class DeleteCodespacesAccessUsersTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/orgs/generated/codespaces/access/selected_users', Argument::type('array'), Schema\Codespaces\DeleteCodespacesAccessUsers\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
    ...
    public function operations_httpCode_404_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/orgs/generated/codespaces/access/selected_users', Argument::type('array'), Schema\Codespaces\DeleteCodespacesAccessUsers\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = await($client->operations()->codespaces()->deleteCodespacesAccessUsers('generated', json_decode(Schema\Codespaces\DeleteCodespacesAccessUsers\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)));
    }
