...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Codespaces\RemoveRepositoryForSecretForAuthenticatedUser;
...
final class RemoveRepositoryForSecretForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function httpCode_401_responseContentType_application_json(): void
    {
        ...
        $browser->request('DELETE', '/user/codespaces/secrets/generated_null/repositories/13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(RemoveRepositoryForSecretForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
