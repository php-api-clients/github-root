...
final class RemoveRepositoryForSecretForAuthenticatedUserTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function t401td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('DELETE', '/user/codespaces/secrets/generated_null/repositories/13', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterpriseCloud\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\Codespaces\RemoveRepositoryForSecretForAuthenticatedUser::OPERATION_MATCH, array('secret_name' => 'generated_null', 'repository_id' => 13));
    }
    /**
     * @test
     */
