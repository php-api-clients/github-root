...
final class RemoveSelectedRepoFromOrgSecretTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function httpCode_404_responseContentType_application_json()
    {
        ...
        $browser->request('DELETE', '/orgs/generated_null/codespaces/secrets/generated_null/repositories/13', \Prophecy\Argument::type('array'), \Prophecy\Argument::any())->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterpriseCloud\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\Codespaces\RemoveSelectedRepoFromOrgSecret::OPERATION_MATCH, (static function (array $data) : array {
