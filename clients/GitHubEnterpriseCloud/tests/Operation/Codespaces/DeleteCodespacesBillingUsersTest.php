...
final class DeleteCodespacesBillingUsersTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/orgs/generated/codespaces/billing/selected_users', Argument::type('array'), Schema\Codespaces\DeleteCodespacesBillingUsers\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Operation\Codespaces\DeleteCodespacesBillingUsers::OPERATION_MATCH, (static function (array $data): array {
            $data['org'] = 'generated';
    ...
    public function operations_httpCode_404_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/orgs/generated/codespaces/billing/selected_users', Argument::type('array'), Schema\Codespaces\DeleteCodespacesBillingUsers\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = await($client->operations()->codespaces()->deleteCodespacesBillingUsers('generated', json_decode(Schema\Codespaces\DeleteCodespacesBillingUsers\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)));
    }
