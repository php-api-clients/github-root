...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Codespaces\StopInOrganization;
...
final class StopInOrganizationTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/orgs/generated_null/members/generated_null/codespaces/generated_null/stop', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(StopInOrganization::OPERATION_MATCH, (static function (array $data): array {
