...
final class StopInOrganizationTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function t200td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('POST', '/orgs/generated_null/members/generated_null/codespaces/generated_null/stop', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterpriseCloud\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\Codespaces\StopInOrganization::OPERATION_MATCH, array('org' => 'generated_null', 'username' => 'generated_null', 'codespace_name' => 'generated_null'));
    }
    /**
     * @test
     */
