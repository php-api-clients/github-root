...
final class ListForTeamDiscussionCommentInOrgTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json()
    {
        ...
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\Reactions\ListForTeamDiscussionCommentInOrg::OPERATION_MATCH, (static function (array $data) : array {
