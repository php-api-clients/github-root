...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Orgs\ListPatGrantRepositories;
...
final class ListPatGrantRepositoriesTest extends AsyncTestCase
{
    ...
    public function httpCode_500_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/organizations/generated_null/personal-access-tokens/13/repositories?per_page=13&page=13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(ListPatGrantRepositories::OPERATION_MATCH, (static function (array $data): array {
