...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Operation\Orgs\ListPatGrantRepositories */
final class ListPatGrantRepositoriesTest extends AsyncTestCase
{
    ...
    public function call_httpCode_500_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/orgs/generated/personal-access-tokens/6/repositories?per_page=8&page=4', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Operation\Orgs\ListPatGrantRepositories::OPERATION_MATCH, (static function (array $data): array {
            $data['org']      = 'generated';
            $data['pat_id']   = 6;
            $data['per_page'] = 8;
            $data['page']     = 4;
    ...
    public function operations_httpCode_500_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/orgs/generated/personal-access-tokens/6/repositories?per_page=8&page=4', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->orgs()->listPatGrantRepositories('generated', 6, 8, 4);
    }
