...
final class ListPatGrantRepositoriesTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function t500td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('GET', '/organizations/generated_null/personal-access-tokens/13/repositories?per_page=13&page=13', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterpriseCloud\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\Orgs\ListPatGrantRepositories::OPERATION_MATCH, array('org' => 'generated_null', 'pat_id' => 13, 'per_page' => 13, 'page' => 13));
    }
    /**
     * @test
     */
