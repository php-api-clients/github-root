...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Orgs\CreateCustomRepoRole;
...
final class CreateCustomRepoRoleTest extends AsyncTestCase
{
    ...
    public function httpCode_201_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/orgs/generated_null/custom-repository-roles', Argument::type('array'), Schema\OrganizationCustomRepositoryRoleCreateSchema::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(CreateCustomRepoRole::OPERATION_MATCH, (static function (array $data): array {
