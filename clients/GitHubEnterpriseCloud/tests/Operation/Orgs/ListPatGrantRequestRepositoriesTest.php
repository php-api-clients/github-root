...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Orgs\ListPatGrantRequestRepositories;
...
final class ListPatGrantRequestRepositoriesTest extends AsyncTestCase
{
    ...
    public function httpCode_500_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/organizations/generated_null/personal-access-token-requests/13/repositories?per_page=13&page=13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(ListPatGrantRequestRepositories::OPERATION_MATCH, (static function (array $data): array {
