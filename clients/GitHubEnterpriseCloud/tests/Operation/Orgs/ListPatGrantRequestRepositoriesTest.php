...
final class ListPatGrantRequestRepositoriesTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function httpCode_500_responseContentType_application_json()
    {
        ...
        $browser->request('GET', '/organizations/generated_null/personal-access-token-requests/13/repositories?per_page=13&page=13', \Prophecy\Argument::type('array'), \Prophecy\Argument::any())->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterpriseCloud\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\Orgs\ListPatGrantRequestRepositories::OPERATION_MATCH, (static function (array $data) : array {
