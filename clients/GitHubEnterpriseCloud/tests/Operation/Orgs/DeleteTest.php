...
final class DeleteTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function t202td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('DELETE', '/orgs/generated_null', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterpriseCloud\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\Orgs\Delete::OPERATION_MATCH, array('org' => 'generated_null'));
    }
    /**
     * @test
     */
