...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Operation\Orgs\UpdatePatAccess */
final class UpdatePatAccessTest extends AsyncTestCase
{
    ...
    public function call_httpCode_500_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Operation\Orgs\UpdatePatAccess::OPERATION_MATCH, (static function (array $data): array {
            $data['org']    = 'generated';
            $data['pat_id'] = 6;
