...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Orgs\UpdatePatAccess;
...
final class UpdatePatAccessTest extends AsyncTestCase
{
    ...
    public function httpCode_500_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/organizations/generated_null/personal-access-tokens/13', Argument::type('array'), Schema\Orgs\UpdatePatAccess\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(UpdatePatAccess::OPERATION_MATCH, (static function (array $data): array {
