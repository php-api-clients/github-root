...
final class UpdateCustomRoleTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json()
    {
        ...
        $browser->request('PATCH', '/orgs/generated_null/custom_roles/13', \Prophecy\Argument::type('array'), Schema\OrganizationCustomRepositoryRoleUpdateSchema::SCHEMA_EXAMPLE_DATA)->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterpriseCloud\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\Orgs\UpdateCustomRole::OPERATION_MATCH, (static function (array $data) : array {
