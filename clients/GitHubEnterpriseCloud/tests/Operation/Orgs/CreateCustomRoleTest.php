...
final class CreateCustomRoleTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function httpCode_201_requestContentType_application_json_responseContentType_application_json()
    {
        ...
        $browser->request('POST', '/orgs/generated_null/custom_roles', \Prophecy\Argument::type('array'), Schema\OrganizationCustomRepositoryRoleCreateSchema::SCHEMA_EXAMPLE_DATA)->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterpriseCloud\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\Orgs\CreateCustomRole::OPERATION_MATCH, (static function (array $data) : array {
