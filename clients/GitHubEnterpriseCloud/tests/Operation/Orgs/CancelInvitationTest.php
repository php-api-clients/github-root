...
final class CancelInvitationTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function t422td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('DELETE', '/orgs/generated_null/invitations/13', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterpriseCloud\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\Orgs\CancelInvitation::OPERATION_MATCH, array('org' => 'generated_null', 'invitation_id' => 13));
    }
    /**
     * @test
     */
