...
final class ReviewPatGrantRequestsInBulkTest extends AsyncTestCase
{
    ...
    public function call_httpCode_500_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/orgs/generated/personal-access-token-requests', Argument::type('array'), Schema\Orgs\ReviewPatGrantRequestsInBulk\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
