...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Orgs\CreateInvitation;
...
final class CreateInvitationTest extends AsyncTestCase
{
    ...
    public function httpCode_201_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/orgs/generated_null/invitations', Argument::type('array'), Schema\Orgs\CreateInvitation\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(CreateInvitation::OPERATION_MATCH, (static function (array $data): array {
