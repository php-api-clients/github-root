...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Operation\Activity\ListPublicEventsListing */
final class ListPublicEventsListingTest extends AsyncTestCase
{
    ...
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Operation\Activity\ListPublicEventsListing::OPERATION_MATCH, (static function (array $data): array {
            $data['per_page'] = 8;
            $data['page']     = 1;
