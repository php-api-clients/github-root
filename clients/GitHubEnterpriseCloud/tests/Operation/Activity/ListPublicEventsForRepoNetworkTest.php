...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Activity\ListPublicEventsForRepoNetwork;
...
final class ListPublicEventsForRepoNetworkTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/networks/generated_null/generated_null/events?per_page=13&page=13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(ListPublicEventsForRepoNetwork::OPERATION_MATCH, (static function (array $data): array {
