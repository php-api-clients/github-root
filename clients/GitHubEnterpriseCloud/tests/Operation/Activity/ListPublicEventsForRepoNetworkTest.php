...
final class ListPublicEventsForRepoNetworkTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function t200td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('GET', '/networks/generated_null/generated_null/events?per_page=13&page=13', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterpriseCloud\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\Activity\ListPublicEventsForRepoNetwork::OPERATION_MATCH, array('owner' => 'generated_null', 'repo' => 'generated_null', 'per_page' => 13, 'page' => 13));
    }
    /**
     * @test
     */
