...
final class ListProvisionedIdentitiesTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_scim_json()
    {
        ...
        $browser->request('GET', '/scim/v2/organizations/generated_null/Users?startIndex=13&count=13&filter=generated_null', \Prophecy\Argument::type('array'), \Prophecy\Argument::any())->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterpriseCloud\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\Scim\ListProvisionedIdentities::OPERATION_MATCH, (static function (array $data) : array {
