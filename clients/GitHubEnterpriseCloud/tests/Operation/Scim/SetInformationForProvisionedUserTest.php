...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Operation\Scim\SetInformationForProvisionedUser */
final class SetInformationForProvisionedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_scim_json_zero(): void
    {
        ...
        $browser->request('PUT', '/scim/v2/organizations/generated/Users/generated', Argument::type('array'), json_encode(json_decode(Schema\Scim\SetInformationForProvisionedUser\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
    ...
    public function operations_httpCode_200_requestContentType_application_json_responseContentType_application_scim_json_zero(): void
    {
        ...
        $browser->request('PUT', '/scim/v2/organizations/generated/Users/generated', Argument::type('array'), json_encode(json_decode(Schema\Scim\SetInformationForProvisionedUser\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->scim()->setInformationForProvisionedUser('generated', 'generated', json_decode(Schema\Scim\SetInformationForProvisionedUser\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
