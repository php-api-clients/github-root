...
final class UpdateAttributeForUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_scim_json_zero(): void
    {
        ...
        $browser->request('PATCH', '/scim/v2/organizations/generated/Users/generated', Argument::type('array'), Schema\Scim\UpdateAttributeForUser\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
    ...
    public function operations_httpCode_200_requestContentType_application_json_responseContentType_application_scim_json_zero(): void
    {
        ...
        $browser->request('PATCH', '/scim/v2/organizations/generated/Users/generated', Argument::type('array'), Schema\Scim\UpdateAttributeForUser\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = await($client->operations()->scim()->updateAttributeForUser('generated', 'generated', json_decode(Schema\Scim\UpdateAttributeForUser\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)));
    }
