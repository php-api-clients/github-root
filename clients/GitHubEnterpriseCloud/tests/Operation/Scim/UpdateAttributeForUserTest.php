...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Operation\Scim\UpdateAttributeForUser */
final class UpdateAttributeForUserTest extends AsyncTestCase
{
    ...
    {
        $response = new Response(200, ['Content-Type' => 'application/scim+json'], json_encode(json_decode(Schema\ScimUser::SCHEMA_EXAMPLE_DATA, true)));
        $auth     = $this->prophesize(AuthenticationInterface::class);
        $auth->authHeader(Argument::any())->willReturn('Bearer beer')->shouldBeCalled();
        $browser = $this->prophesize(Browser::class);
        $browser->withBase(Argument::any())->willReturn($browser->reveal());
        $browser->withFollowRedirects(Argument::any())->willReturn($browser->reveal());
        $browser->request('PATCH', '/scim/v2/organizations/generated/Users/generated', Argument::type('array'), json_encode(json_decode(Schema\Scim\UpdateAttributeForUser\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Operation\Scim\UpdateAttributeForUser::OPERATION_MATCH, (static function (array $data): array {
            $data['org']          = 'generated';
    ...
    public function operations_httpCode_200_requestContentType_application_json_responseContentType_application_scim_json_zero(): void
    {
        ...
        $browser->request('PATCH', '/scim/v2/organizations/generated/Users/generated', Argument::type('array'), json_encode(json_decode(Schema\Scim\UpdateAttributeForUser\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->scim()->updateAttributeForUser('generated', 'generated', json_decode(Schema\Scim\UpdateAttributeForUser\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
