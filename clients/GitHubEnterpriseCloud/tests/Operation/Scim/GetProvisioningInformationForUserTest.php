...
final class GetProvisioningInformationForUserTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function t200te721a100ec95fd3067a83a0920ca7a5e()
    {
        ...
        $browser->request('GET', '/scim/v2/organizations/generated_null/Users/generated_null', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\Github\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\Github\Operation\Scim\GetProvisioningInformationForUser::OPERATION_MATCH, array('org' => 'generated_null', 'scim_user_id' => 'generated_null'));
    }
    /**
     * @test
     */
