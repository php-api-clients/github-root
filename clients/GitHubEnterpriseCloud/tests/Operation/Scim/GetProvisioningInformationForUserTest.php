...
final class GetProvisioningInformationForUserTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function httpCode_200_responseContentType_application_scim_json()
    {
        ...
        $browser->request('GET', '/scim/v2/organizations/generated_null/Users/generated_null', \Prophecy\Argument::type('array'), \Prophecy\Argument::any())->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterpriseCloud\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\Scim\GetProvisioningInformationForUser::OPERATION_MATCH, (static function (array $data) : array {
