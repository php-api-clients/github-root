...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Operation\Scim\ProvisionAndInviteUser */
final class ProvisionAndInviteUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_201_requestContentType_application_json_responseContentType_application_scim_json_zero(): void
    {
        ...
        $result = $client->call(Operation\Scim\ProvisionAndInviteUser::OPERATION_MATCH, (static function (array $data): array {
            $data['org'] = 'generated';
