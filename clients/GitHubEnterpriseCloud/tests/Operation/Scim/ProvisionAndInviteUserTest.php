...
final class ProvisionAndInviteUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_201_requestContentType_application_json_responseContentType_application_scim_json_zero(): void
    {
        ...
        $browser->request('POST', '/scim/v2/organizations/generated/Users', Argument::type('array'), Schema\Scim\ProvisionAndInviteUser\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
