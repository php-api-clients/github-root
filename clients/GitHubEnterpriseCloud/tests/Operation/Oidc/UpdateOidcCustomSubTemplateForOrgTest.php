...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Operation\Oidc\UpdateOidcCustomSubTemplateForOrg */
final class UpdateOidcCustomSubTemplateForOrgTest extends AsyncTestCase
{
    ...
    public function call_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/orgs/generated/actions/oidc/customization/sub', Argument::type('array'), json_encode(json_decode(Schema\OidcCustomSub::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
    ...
    public function operations_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/orgs/generated/actions/oidc/customization/sub', Argument::type('array'), json_encode(json_decode(Schema\OidcCustomSub::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->oidc()->updateOidcCustomSubTemplateForOrg('generated', json_decode(Schema\OidcCustomSub::SCHEMA_EXAMPLE_DATA, true));
    }
