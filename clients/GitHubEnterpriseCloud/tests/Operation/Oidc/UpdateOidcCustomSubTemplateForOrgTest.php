...
namespace ApiClients\Tests\Client\GitHubEnterpriseCloud\Operation\Oidc;
...
final class UpdateOidcCustomSubTemplateForOrgTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function t201td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('PUT', '/orgs/generated_null/actions/oidc/customization/sub', \Prophecy\Argument::type('array'), Schema\OidcCustomSub::SCHEMA_EXAMPLE_DATA)->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterpriseCloud\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\Oidc\UpdateOidcCustomSubTemplateForOrg::OPERATION_MATCH, (static function (array $data) : array {
