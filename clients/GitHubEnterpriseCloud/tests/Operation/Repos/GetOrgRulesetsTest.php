...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Repos\GetOrgRulesets;
...
final class GetOrgRulesetsTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/orgs/generated_null/rulesets', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(GetOrgRulesets::OPERATION_MATCH, (static function (array $data): array {
