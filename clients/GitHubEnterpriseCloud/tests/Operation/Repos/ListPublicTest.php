...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Repos\ListPublic;
...
final class ListPublicTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/repositories?since=13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
