...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Repos\UpdateRepoRuleset;
...
final class UpdateRepoRulesetTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PUT', '/repos/generated_null/generated_null/rulesets/13', Argument::type('array'), Schema\Repos\UpdateRepoRuleset\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(UpdateRepoRuleset::OPERATION_MATCH, (static function (array $data): array {
