...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Operation\Repos\UpdateRepoRuleset */
final class UpdateRepoRulesetTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/repos/generated/generated/rulesets/10', Argument::type('array'), json_encode(json_decode(Schema\Repos\UpdateRepoRuleset\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
    ...
    public function operations_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/repos/generated/generated/rulesets/10', Argument::type('array'), json_encode(json_decode(Schema\Repos\UpdateRepoRuleset\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->repos()->updateRepoRuleset('generated', 'generated', 10, json_decode(Schema\Repos\UpdateRepoRuleset\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
