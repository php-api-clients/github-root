...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Repos\GetPagesHealthCheck;
...
final class GetPagesHealthCheckTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/repos/generated_null/generated_null/pages/health', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(GetPagesHealthCheck::OPERATION_MATCH, (static function (array $data): array {
