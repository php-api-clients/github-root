...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Repos\GetRepoRuleset;
...
final class GetRepoRulesetTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/repos/generated_null/generated_null/rulesets/13?includes_parents=', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(GetRepoRuleset::OPERATION_MATCH, (static function (array $data): array {
