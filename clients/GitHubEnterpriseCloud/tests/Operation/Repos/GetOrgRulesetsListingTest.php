...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Operation\Repos\GetOrgRulesetsListing */
final class GetOrgRulesetsListingTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Operation\Repos\GetOrgRulesetsListing::OPERATION_MATCH, (static function (array $data): array {
            $data['org']      = 'generated';
            $data['per_page'] = 8;
            $data['page']     = 1;
