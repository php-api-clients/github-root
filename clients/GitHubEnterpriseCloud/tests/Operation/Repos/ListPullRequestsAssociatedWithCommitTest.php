...
final class ListPullRequestsAssociatedWithCommitTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json()
    {
        ...
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\Repos\ListPullRequestsAssociatedWithCommit::OPERATION_MATCH, (static function (array $data) : array {
