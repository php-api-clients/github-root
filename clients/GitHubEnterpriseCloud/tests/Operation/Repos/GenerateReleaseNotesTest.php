...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Repos\GenerateReleaseNotes;
...
final class GenerateReleaseNotesTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/repos/generated_null/generated_null/releases/generate-notes', Argument::type('array'), Schema\Repos\GenerateReleaseNotes\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(GenerateReleaseNotes::OPERATION_MATCH, (static function (array $data): array {
