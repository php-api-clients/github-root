...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Repos\CreatePagesDeployment;
...
final class CreatePagesDeploymentTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/repos/generated_null/generated_null/pages/deployment', Argument::type('array'), Schema\Repos\CreatePagesDeployment\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(CreatePagesDeployment::OPERATION_MATCH, (static function (array $data): array {
