...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Operation\Repos\CreatePagesDeployment */
final class CreatePagesDeploymentTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(Schema\PageDeployment::SCHEMA_EXAMPLE_DATA, true)));
