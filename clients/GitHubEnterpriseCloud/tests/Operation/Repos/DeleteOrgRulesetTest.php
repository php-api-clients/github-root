...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Repos\DeleteOrgRuleset;
...
final class DeleteOrgRulesetTest extends AsyncTestCase
{
    ...
    public function httpCode_404_responseContentType_application_json(): void
    {
        ...
        $browser->request('DELETE', '/orgs/generated_null/rulesets/13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(DeleteOrgRuleset::OPERATION_MATCH, (static function (array $data): array {
