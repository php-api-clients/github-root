...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Repos\RenameBranch;
...
final class RenameBranchTest extends AsyncTestCase
{
    ...
    public function httpCode_201_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/repos/generated_null/generated_null/branches/generated_null/rename', Argument::type('array'), Schema\Repos\RenameBranch\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(RenameBranch::OPERATION_MATCH, (static function (array $data): array {
