...
final class RemoveCustomLabelFromSelfHostedRunnerForEnterpriseTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json()
    {
        ...
        $browser->request('DELETE', '/enterprises/generated_null/actions/runners/13/labels/generated_null', \Prophecy\Argument::type('array'), \Prophecy\Argument::any())->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterpriseCloud\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\EnterpriseAdmin\RemoveCustomLabelFromSelfHostedRunnerForEnterprise::OPERATION_MATCH, (static function (array $data) : array {
