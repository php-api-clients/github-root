...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Packages\ListDockerMigrationConflictingPackagesForUser;
...
final class ListDockerMigrationConflictingPackagesForUserTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/users/generated_null/docker/conflicts', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(ListDockerMigrationConflictingPackagesForUser::OPERATION_MATCH, (static function (array $data): array {
