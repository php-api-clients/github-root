...
final class ListDockerMigrationConflictingPackagesForUserTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function t200td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('GET', '/users/generated_null/docker/conflicts', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterpriseCloud\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\Packages\ListDockerMigrationConflictingPackagesForUser::OPERATION_MATCH, array('username' => 'generated_null'));
    }
    /**
     * @test
     */
