...
final class RestorePackageVersionForUserTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function httpCode_404_responseContentType_application_json()
    {
        ...
        $browser->request('POST', '/users/generated_null/packages/generated_null/generated_null/versions/13/restore', \Prophecy\Argument::type('array'), \Prophecy\Argument::any())->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterpriseCloud\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\Packages\RestorePackageVersionForUser::OPERATION_MATCH, (static function (array $data) : array {
