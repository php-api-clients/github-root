...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Packages\RestorePackageForAuthenticatedUser;
...
final class RestorePackageForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function httpCode_404_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/user/packages/generated_null/generated_null/restore?token=generated_null', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(RestorePackageForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
