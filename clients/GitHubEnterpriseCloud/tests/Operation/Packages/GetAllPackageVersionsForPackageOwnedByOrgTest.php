...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Packages\GetAllPackageVersionsForPackageOwnedByOrg;
...
final class GetAllPackageVersionsForPackageOwnedByOrgTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/orgs/generated_null/packages/generated_null/generated_null/versions?page=13&per_page=13&state=generated_null', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(GetAllPackageVersionsForPackageOwnedByOrg::OPERATION_MATCH, (static function (array $data): array {
