...
final class ListPackagesForUserTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function t200td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('GET', '/users/generated_null/packages?package_type=generated_null&visibility=generated_null&page=13&per_page=13', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterpriseCloud\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\Packages\ListPackagesForUser::OPERATION_MATCH, array('package_type' => 'generated_null', 'visibility' => 'generated_null', 'username' => 'generated_null', 'page' => 13, 'per_page' => 13));
    }
    /**
     * @test
     */
