...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Packages\ListPackagesForUser;
...
final class ListPackagesForUserTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/users/generated_null/packages?package_type=generated_null&visibility=generated_null&page=13&per_page=13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(ListPackagesForUser::OPERATION_MATCH, (static function (array $data): array {
