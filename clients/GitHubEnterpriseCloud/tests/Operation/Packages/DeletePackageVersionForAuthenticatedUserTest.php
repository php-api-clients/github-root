...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Operation\Packages\DeletePackageVersionForAuthenticatedUser */
final class DeletePackageVersionForAuthenticatedUserTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/user/packages/generated/generated/versions/18', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Operation\Packages\DeletePackageVersionForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/user/packages/generated/generated/versions/18', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->packages()->deletePackageVersionForAuthenticatedUser('generated', 'generated', 18);
    }
