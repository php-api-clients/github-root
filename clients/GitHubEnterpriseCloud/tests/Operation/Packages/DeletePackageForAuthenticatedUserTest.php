...
final class DeletePackageForAuthenticatedUserTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function httpCode_404_responseContentType_application_json()
    {
        ...
        $browser->request('DELETE', '/user/packages/generated_null/generated_null', \Prophecy\Argument::type('array'), \Prophecy\Argument::any())->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterpriseCloud\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\Packages\DeletePackageForAuthenticatedUser::OPERATION_MATCH, (static function (array $data) : array {
