...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Operation\Packages\ListPackagesForOrganizationListing */
final class ListPackagesForOrganizationListingTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Operation\Packages\ListPackagesForOrganizationListing::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/orgs/generated/packages?package_type=generated&visibility=generated&page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->packages()->listPackagesForOrganizationListing('generated', 'generated', 'generated', 1, 8);
        foreach ($result as $item) {
        }
    }
