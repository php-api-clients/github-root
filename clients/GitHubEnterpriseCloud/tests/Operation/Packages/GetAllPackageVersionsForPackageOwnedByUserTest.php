...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Packages\GetAllPackageVersionsForPackageOwnedByUser;
...
final class GetAllPackageVersionsForPackageOwnedByUserTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/users/generated_null/packages/generated_null/generated_null/versions', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(GetAllPackageVersionsForPackageOwnedByUser::OPERATION_MATCH, (static function (array $data): array {
