...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Packages\ListDockerMigrationConflictingPackagesForOrganization;
...
final class ListDockerMigrationConflictingPackagesForOrganizationTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/orgs/generated_null/docker/conflicts', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(ListDockerMigrationConflictingPackagesForOrganization::OPERATION_MATCH, (static function (array $data): array {
