...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Packages\RestorePackageForUser;
...
final class RestorePackageForUserTest extends AsyncTestCase
{
    ...
    public function httpCode_404_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/users/generated_null/packages/generated_null/generated_null/restore?token=generated_null', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(RestorePackageForUser::OPERATION_MATCH, (static function (array $data): array {
