...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Teams\CreateOrUpdateIdpGroupConnectionsLegacy;
...
final class CreateOrUpdateIdpGroupConnectionsLegacyTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PATCH', '/teams/13/team-sync/group-mappings', Argument::type('array'), Schema\Teams\CreateOrUpdateIdpGroupConnectionsLegacy\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(CreateOrUpdateIdpGroupConnectionsLegacy::OPERATION_MATCH, (static function (array $data): array {
            $data['team_id'] = 13;
