...
final class CreateOrUpdateIdpGroupConnectionsLegacyTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PATCH', '/teams/7/team-sync/group-mappings', Argument::type('array'), Schema\Teams\CreateOrUpdateIdpGroupConnectionsLegacy\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
