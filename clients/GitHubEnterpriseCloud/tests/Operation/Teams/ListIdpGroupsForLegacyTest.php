...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Teams\ListIdpGroupsForLegacy;
...
final class ListIdpGroupsForLegacyTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/teams/13/team-sync/group-mappings', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(ListIdpGroupsForLegacy::OPERATION_MATCH, (static function (array $data): array {
            $data['team_id'] = 13;
