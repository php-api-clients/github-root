...
final class ListIdpGroupsForLegacyTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function httpCode_200_responseContentType_application_json()
    {
        ...
        $browser->request('GET', '/teams/13/team-sync/group-mappings', \Prophecy\Argument::type('array'), \Prophecy\Argument::any())->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterpriseCloud\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\Teams\ListIdpGroupsForLegacy::OPERATION_MATCH, (static function (array $data) : array {
            $data['team_id'] = 13;
            return $data;
        })(array()));
    }
