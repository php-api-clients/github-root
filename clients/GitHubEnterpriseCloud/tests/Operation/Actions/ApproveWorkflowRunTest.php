...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Actions\ApproveWorkflowRun;
...
final class ApproveWorkflowRunTest extends AsyncTestCase
{
    ...
    public function httpCode_201_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/repos/generated_null/generated_null/actions/runs/13/approve', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(ApproveWorkflowRun::OPERATION_MATCH, (static function (array $data): array {
