...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Actions\RemoveCustomLabelFromSelfHostedRunnerForOrg;
...
final class RemoveCustomLabelFromSelfHostedRunnerForOrgTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('DELETE', '/orgs/generated_null/actions/runners/13/labels/generated_null', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(RemoveCustomLabelFromSelfHostedRunnerForOrg::OPERATION_MATCH, (static function (array $data): array {
