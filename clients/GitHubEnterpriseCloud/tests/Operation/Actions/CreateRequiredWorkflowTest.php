...
final class CreateRequiredWorkflowTest extends AsyncTestCase
{
    ...
    public function call_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/orgs/generated/actions/required_workflows', Argument::type('array'), Schema\Actions\CreateRequiredWorkflow\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Operation\Actions\CreateRequiredWorkflow::OPERATION_MATCH, (static function (array $data): array {
            $data['org'] = 'generated';
