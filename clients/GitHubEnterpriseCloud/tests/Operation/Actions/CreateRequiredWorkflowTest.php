...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Actions\CreateRequiredWorkflow;
...
final class CreateRequiredWorkflowTest extends AsyncTestCase
{
    ...
    public function httpCode_201_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/orgs/generated_null/actions/required_workflows', Argument::type('array'), Schema\Actions\CreateRequiredWorkflow\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(CreateRequiredWorkflow::OPERATION_MATCH, (static function (array $data): array {
