...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Actions\CreateOrUpdateEnvironmentSecret;
...
final class CreateOrUpdateEnvironmentSecretTest extends AsyncTestCase
{
    ...
    public function httpCode_201_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PUT', '/repositories/13/environments/generated_null/secrets/generated_null', Argument::type('array'), Schema\Actions\CreateOrUpdateEnvironmentSecret\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(CreateOrUpdateEnvironmentSecret::OPERATION_MATCH, (static function (array $data): array {
