...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Actions\AddCustomLabelsToSelfHostedRunnerForOrg;
...
final class AddCustomLabelsToSelfHostedRunnerForOrgTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/orgs/generated_null/actions/runners/13/labels', Argument::type('array'), Schema\Actions\AddCustomLabelsToSelfHostedRunnerForOrg\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(AddCustomLabelsToSelfHostedRunnerForOrg::OPERATION_MATCH, (static function (array $data): array {
