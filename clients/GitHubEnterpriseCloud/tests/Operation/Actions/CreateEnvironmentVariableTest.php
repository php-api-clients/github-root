...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Actions\CreateEnvironmentVariable;
...
final class CreateEnvironmentVariableTest extends AsyncTestCase
{
    ...
    public function httpCode_201_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/repositories/13/environments/generated_null/variables', Argument::type('array'), Schema\Actions\CreateEnvironmentVariable\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(CreateEnvironmentVariable::OPERATION_MATCH, (static function (array $data): array {
