...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Actions\GetRepoRequiredWorkflow;
...
final class GetRepoRequiredWorkflowTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/repos/generated_null/generated_null/actions/required_workflows/13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(GetRepoRequiredWorkflow::OPERATION_MATCH, (static function (array $data): array {
