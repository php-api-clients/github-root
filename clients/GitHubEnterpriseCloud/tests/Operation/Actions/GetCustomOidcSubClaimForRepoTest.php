...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Actions\GetCustomOidcSubClaimForRepo;
...
final class GetCustomOidcSubClaimForRepoTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/repos/generated_null/generated_null/actions/oidc/customization/sub', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(GetCustomOidcSubClaimForRepo::OPERATION_MATCH, (static function (array $data): array {
