...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Operation\Actions\SetCustomOidcSubClaimForRepo */
final class SetCustomOidcSubClaimForRepoTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/repos/generated/generated/actions/oidc/customization/sub', Argument::type('array'), json_encode(json_decode(Schema\Actions\SetCustomOidcSubClaimForRepo\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
    ...
    public function operations_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('PUT', '/repos/generated/generated/actions/oidc/customization/sub', Argument::type('array'), json_encode(json_decode(Schema\Actions\SetCustomOidcSubClaimForRepo\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->actions()->setCustomOidcSubClaimForRepo('generated', 'generated', json_decode(Schema\Actions\SetCustomOidcSubClaimForRepo\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
