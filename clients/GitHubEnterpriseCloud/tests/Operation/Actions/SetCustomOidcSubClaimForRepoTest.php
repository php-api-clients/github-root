...
use ApiClients\Client\GitHubEnterpriseCloud\Operation\Actions\SetCustomOidcSubClaimForRepo;
...
final class SetCustomOidcSubClaimForRepoTest extends AsyncTestCase
{
    ...
    public function httpCode_201_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $browser->request('PUT', '/repos/generated_null/generated_null/actions/oidc/customization/sub', Argument::type('array'), Schema\Actions\SetCustomOidcSubClaimForRepo\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(SetCustomOidcSubClaimForRepo::OPERATION_MATCH, (static function (array $data): array {
