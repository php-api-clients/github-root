...
final class SetCustomOidcSubClaimForRepoTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function httpCode_201_requestContentType_application_json_responseContentType_application_json()
    {
        ...
        $browser->request('PUT', '/repos/generated_null/generated_null/actions/oidc/customization/sub', \Prophecy\Argument::type('array'), Schema\Actions\SetCustomOidcSubClaimForRepo\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterpriseCloud\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\Actions\SetCustomOidcSubClaimForRepo::OPERATION_MATCH, (static function (array $data) : array {
