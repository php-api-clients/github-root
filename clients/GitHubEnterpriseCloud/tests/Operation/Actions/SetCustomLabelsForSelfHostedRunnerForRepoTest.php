...
final class SetCustomLabelsForSelfHostedRunnerForRepoTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    /**
     * @test
     */
    public function httpCode_200_requestContentType_application_json_responseContentType_application_json()
    {
        ...
        $browser->request('PUT', '/repos/generated_null/generated_null/actions/runners/13/labels', \Prophecy\Argument::type('array'), Schema\Actions\SetCustomLabelsForSelfHostedRunnerForRepo\Request\Applicationjson::SCHEMA_EXAMPLE_DATA)->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterpriseCloud\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterpriseCloud\Operation\Actions\SetCustomLabelsForSelfHostedRunnerForRepo::OPERATION_MATCH, (static function (array $data) : array {
