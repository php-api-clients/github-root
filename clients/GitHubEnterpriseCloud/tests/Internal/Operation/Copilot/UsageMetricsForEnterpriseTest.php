...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Copilot\UsageMetricsForEnterprise */
final class UsageMetricsForEnterpriseTest extends AsyncTestCase
{
    ...
    public function call_httpCode_500_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Internal\Operation\Copilot\UsageMetricsForEnterprise::OPERATION_MATCH, (static function (array $data): array {
