...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Copilot\UsageMetricsForEnterpriseTeamListing */
final class UsageMetricsForEnterpriseTeamListingTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_500_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Internal\Operation\Copilot\UsageMetricsForEnterpriseTeamListing::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_500_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/enterprises/generated/team/generated/copilot/usage?since=generated&until=generated&page=1&per_page=8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->copilot()->usageMetricsForEnterpriseTeamListing('generated', 'generated', 'generated', 'generated', 1, 8);
        foreach ($result as $item) {
        }
    }
