...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\EnterpriseAdmin\ProvisionEnterpriseGroup */
final class ProvisionEnterpriseGroupTest extends AsyncTestCase
{
    ...
    {
        $response = new Response(201, ['Content-Type' => 'application/scim+json'], json_encode(json_decode(Schema\GroupResponse::SCHEMA_EXAMPLE_DATA, true)));
