...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Issues\AddSubIssue */
final class AddSubIssueTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/repos/generated/generated/issues/12/sub_issues', Argument::type('array'), json_encode(json_decode(Schema\Issues\AddSubIssue\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\Issues\AddSubIssue::OPERATION_MATCH, (static function (array $data): array {
            $data['owner']        = 'generated';
            $data['repo']         = 'generated';
            $data['issue_number'] = 12;

            return $data;
        })(json_decode(Schema\Issues\AddSubIssue\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)));
    }
    ...
    public function operations_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/repos/generated/generated/issues/12/sub_issues', Argument::type('array'), json_encode(json_decode(Schema\Issues\AddSubIssue\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->issues()->addSubIssue('generated', 'generated', 12, json_decode(Schema\Issues\AddSubIssue\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
