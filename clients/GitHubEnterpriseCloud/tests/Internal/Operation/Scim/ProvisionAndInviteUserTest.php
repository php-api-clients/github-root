...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Scim\ProvisionAndInviteUser */
final class ProvisionAndInviteUserTest extends AsyncTestCase
{
    ...
    {
        $response = new Response(201, ['Content-Type' => 'application/scim+json'], json_encode(json_decode(Schema\ScimUser::SCHEMA_EXAMPLE_DATA, true)));
        $auth     = $this->prophesize(AuthenticationInterface::class);
        $auth->authHeader(Argument::any())->willReturn('Bearer beer')->shouldBeCalled();
        $browser = $this->prophesize(Browser::class);
        $browser->withBase(Argument::any())->willReturn($browser->reveal());
        $browser->withFollowRedirects(Argument::any())->willReturn($browser->reveal());
        $browser->request('POST', '/scim/v2/organizations/generated/Users', Argument::type('array'), json_encode(json_decode(Schema\Scim\ProvisionAndInviteUser\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\Scim\ProvisionAndInviteUser::OPERATION_MATCH, (static function (array $data): array {
            $data['org'] = 'generated';
    ...
    public function operations_httpCode_201_requestContentType_application_json_responseContentType_application_scim_json_zero(): void
    {
        ...
        $browser->request('POST', '/scim/v2/organizations/generated/Users', Argument::type('array'), json_encode(json_decode(Schema\Scim\ProvisionAndInviteUser\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->scim()->provisionAndInviteUser('generated', json_decode(Schema\Scim\ProvisionAndInviteUser\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
    ...
    {
        self::expectException(ErrorSchemas\ScimError::class);
        $response = new Response(409, ['Content-Type' => 'application/json'], json_encode(json_decode(Schema\ScimError::SCHEMA_EXAMPLE_DATA, true)));
        $auth     = $this->prophesize(AuthenticationInterface::class);
        $auth->authHeader(Argument::any())->willReturn('Bearer beer')->shouldBeCalled();
        $browser = $this->prophesize(Browser::class);
        $browser->withBase(Argument::any())->willReturn($browser->reveal());
    ...
    {
        self::expectException(ErrorSchemas\ScimError::class);
        $response = new Response(409, ['Content-Type' => 'application/scim+json'], json_encode(json_decode(Schema\ScimError::SCHEMA_EXAMPLE_DATA, true)));
        $auth     = $this->prophesize(AuthenticationInterface::class);
        $auth->authHeader(Argument::any())->willReturn('Bearer beer')->shouldBeCalled();
        $browser = $this->prophesize(Browser::class);
        $browser->withBase(Argument::any())->willReturn($browser->reveal());
