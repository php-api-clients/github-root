...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Scim\UpdateAttributeForUser */
final class UpdateAttributeForUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_scim_json_zero(): void
    {
        ...
        $result = $client->call(Internal\Operation\Scim\UpdateAttributeForUser::OPERATION_MATCH, (static function (array $data): array {
            $data['org']          = 'generated';
