...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Scim\ListProvisionedIdentities */
final class ListProvisionedIdentitiesTest extends AsyncTestCase
{
    ...
    {
        $response = new Response(200, ['Content-Type' => 'application/scim+json'], json_encode(json_decode(Schema\ScimUserList::SCHEMA_EXAMPLE_DATA, true)));
        $auth     = $this->prophesize(AuthenticationInterface::class);
        $auth->authHeader(Argument::any())->willReturn('Bearer beer')->shouldBeCalled();
        $browser = $this->prophesize(Browser::class);
        $browser->withBase(Argument::any())->willReturn($browser->reveal());
        $browser->withFollowRedirects(Argument::any())->willReturn($browser->reveal());
        $browser->request('GET', '/scim/v2/organizations/generated/Users?startIndex=10&count=5&filter=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\Scim\ListProvisionedIdentities::OPERATION_MATCH, (static function (array $data): array {
            $data['org']        = 'generated';
            $data['startIndex'] = 10;
            $data['count']      = 5;
    ...
    public function operations_httpCode_200_responseContentType_application_scim_json_zero(): void
    {
        ...
        $browser->request('GET', '/scim/v2/organizations/generated/Users?startIndex=10&count=5&filter=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->scim()->listProvisionedIdentities('generated', 10, 5, 'generated');
    }
