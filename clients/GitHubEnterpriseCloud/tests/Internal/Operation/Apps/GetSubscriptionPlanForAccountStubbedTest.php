...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Apps\GetSubscriptionPlanForAccountStubbed */
final class GetSubscriptionPlanForAccountStubbedTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(Schema\MarketplacePurchase::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(Internal\Operation\Apps\GetSubscriptionPlanForAccountStubbed::OPERATION_MATCH, (static function (array $data): array {
            $data['account_id'] = 10;
