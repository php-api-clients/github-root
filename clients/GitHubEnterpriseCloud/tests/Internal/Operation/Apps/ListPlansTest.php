...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Apps\ListPlans */
final class ListPlansTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Internal\Operation\Apps\ListPlans::OPERATION_MATCH, (static function (array $data): array {
            $data['per_page'] = 8;
            $data['page']     = 1;
