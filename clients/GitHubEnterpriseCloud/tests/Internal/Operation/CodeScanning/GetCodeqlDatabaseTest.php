...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\CodeScanning\GetCodeqlDatabase */
final class GetCodeqlDatabaseTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(Schema\CodeScanningCodeqlDatabase::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(Internal\Operation\CodeScanning\GetCodeqlDatabase::OPERATION_MATCH, (static function (array $data): array {
