...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\CodeScanning\DeleteCodeqlDatabase */
final class DeleteCodeqlDatabaseTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/repos/generated/generated/code-scanning/codeql/databases/generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\CodeScanning\DeleteCodeqlDatabase::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/repos/generated/generated/code-scanning/codeql/databases/generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->codeScanning()->deleteCodeqlDatabase('generated', 'generated', 'generated');
    }
