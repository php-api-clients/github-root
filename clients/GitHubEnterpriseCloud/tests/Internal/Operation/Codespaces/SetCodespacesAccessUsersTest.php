...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Codespaces\SetCodespacesAccessUsers */
final class SetCodespacesAccessUsersTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_404_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/orgs/generated/codespaces/access/selected_users', Argument::type('array'), json_encode(json_decode(Schema\Codespaces\SetCodespacesAccessUsers\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\Codespaces\SetCodespacesAccessUsers::OPERATION_MATCH, (static function (array $data): array {
            $data['org'] = 'generated';

            return $data;
        })(json_decode(Schema\Codespaces\SetCodespacesAccessUsers\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)));
    }
    ...
    public function operations_httpCode_404_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/orgs/generated/codespaces/access/selected_users', Argument::type('array'), json_encode(json_decode(Schema\Codespaces\SetCodespacesAccessUsers\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->codespaces()->setCodespacesAccessUsers('generated', json_decode(Schema\Codespaces\SetCodespacesAccessUsers\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
