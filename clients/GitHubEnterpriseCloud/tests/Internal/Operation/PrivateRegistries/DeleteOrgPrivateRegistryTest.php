...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\PrivateRegistries\DeleteOrgPrivateRegistry */
final class DeleteOrgPrivateRegistryTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_400_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/orgs/generated/private-registries/generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\PrivateRegistries\DeleteOrgPrivateRegistry::OPERATION_MATCH, (static function (array $data): array {
            $data['org']         = 'generated';
    ...
    public function operations_httpCode_400_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/orgs/generated/private-registries/generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->privateRegistries()->deleteOrgPrivateRegistry('generated', 'generated');
    }
