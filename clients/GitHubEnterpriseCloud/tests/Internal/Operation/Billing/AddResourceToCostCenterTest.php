...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Billing\AddResourceToCostCenter */
final class AddResourceToCostCenterTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(Schema\Operations\Billing\AddResourceToCostCenter\Response\ApplicationJson\Ok::SCHEMA_EXAMPLE_DATA, true)));
