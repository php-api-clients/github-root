...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Packages\RestorePackageVersionForAuthenticatedUser */
final class RestorePackageVersionForAuthenticatedUserTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/user/packages/generated/generated/versions/18/restore', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\Packages\RestorePackageVersionForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/user/packages/generated/generated/versions/18/restore', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->packages()->restorePackageVersionForAuthenticatedUser('generated', 'generated', 18);
    }
