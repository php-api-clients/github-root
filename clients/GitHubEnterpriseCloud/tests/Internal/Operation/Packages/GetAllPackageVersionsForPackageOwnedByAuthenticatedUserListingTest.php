...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Packages\GetAllPackageVersionsForPackageOwnedByAuthenticatedUserListing */
final class GetAllPackageVersionsForPackageOwnedByAuthenticatedUserListingTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Internal\Operation\Packages\GetAllPackageVersionsForPackageOwnedByAuthenticatedUserListing::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/user/packages/generated/generated/versions?page=1&per_page=8&state=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->packages()->getAllPackageVersionsForPackageOwnedByAuthenticatedUserListing('generated', 'generated', 1, 8, 'generated');
        foreach ($result as $item) {
        }
    }
