...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Packages\GetAllPackageVersionsForPackageOwnedByOrgListing */
final class GetAllPackageVersionsForPackageOwnedByOrgListingTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Internal\Operation\Packages\GetAllPackageVersionsForPackageOwnedByOrgListing::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/orgs/generated/packages/generated/generated/versions?page=1&per_page=8&state=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->packages()->getAllPackageVersionsForPackageOwnedByOrgListing('generated', 'generated', 'generated', 1, 8, 'generated');
        foreach ($result as $item) {
        }
    }
