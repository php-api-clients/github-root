...
namespace ApiClients\Tests\Client\GitHubEnterpriseCloud\Internal\Operation\Activity;
...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Activity\ListPublicEventsListing */
final class ListPublicEventsListingTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/events?per_page=8&page=1', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\Activity\ListPublicEventsListing::OPERATION_MATCH, (static function (array $data): array {
            $data['per_page'] = 8;
            $data['page']     = 1;
    ...
    public function operations_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/events?per_page=8&page=1', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->activity()->listPublicEventsListing(8, 1);
        foreach ($result as $item) {
        }
    }
