...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Repos\ListAttestations */
final class ListAttestationsTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(Schema\Operations\Repos\ListAttestations\Response\ApplicationJson\Ok\Application\Json::SCHEMA_EXAMPLE_DATA, true)));
