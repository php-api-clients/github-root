...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Actions\GenerateRunnerJitconfigForOrg */
final class GenerateRunnerJitconfigForOrgTest extends AsyncTestCase
{
    ...
    public function call_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Internal\Operation\Actions\GenerateRunnerJitconfigForOrg::OPERATION_MATCH, (static function (array $data): array {
            $data['org'] = 'generated';

            return $data;
        })(json_decode(Schema\Actions\GenerateRunnerJitconfigForOrg\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)));
    }
