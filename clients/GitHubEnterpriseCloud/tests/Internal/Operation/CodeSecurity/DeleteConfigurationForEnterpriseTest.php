...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\CodeSecurity\DeleteConfigurationForEnterprise */
final class DeleteConfigurationForEnterpriseTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_400_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/enterprises/generated/code-security/configurations/16', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\CodeSecurity\DeleteConfigurationForEnterprise::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_400_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/enterprises/generated/code-security/configurations/16', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->codeSecurity()->deleteConfigurationForEnterprise('generated', 16);
    }
