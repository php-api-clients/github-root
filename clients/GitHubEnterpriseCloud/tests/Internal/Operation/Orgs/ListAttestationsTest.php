...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Orgs\ListAttestations */
final class ListAttestationsTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(Schema\Operations\Orgs\ListAttestations\Response\ApplicationJson\Ok::SCHEMA_EXAMPLE_DATA, true)));
