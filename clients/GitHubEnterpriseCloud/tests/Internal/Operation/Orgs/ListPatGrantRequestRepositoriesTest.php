...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Orgs\ListPatGrantRequestRepositories */
final class ListPatGrantRequestRepositoriesTest extends AsyncTestCase
{
    ...
    public function call_httpCode_500_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Internal\Operation\Orgs\ListPatGrantRequestRepositories::OPERATION_MATCH, (static function (array $data): array {
            $data['org']            = 'generated';
