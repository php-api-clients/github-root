...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Orgs\ListOrgRoleUsersListing */
final class ListOrgRoleUsersListingTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_404_empty(): void
    {
        ...
        $result = $client->call(Internal\Operation\Orgs\ListOrgRoleUsersListing::OPERATION_MATCH, (static function (array $data): array {
            $data['org']      = 'generated';
            $data['role_id']  = 7;
            $data['per_page'] = 8;
            $data['page']     = 1;
    ...
    public function operations_httpCode_404_empty(): void
    {
        ...
        $browser->request('GET', '/orgs/generated/organization-roles/7/users?per_page=8&page=1', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->orgs()->listOrgRoleUsersListing('generated', 7, 8, 1);
