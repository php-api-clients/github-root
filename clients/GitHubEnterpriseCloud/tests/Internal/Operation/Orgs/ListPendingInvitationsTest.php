...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Orgs\ListPendingInvitations */
final class ListPendingInvitationsTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Internal\Operation\Orgs\ListPendingInvitations::OPERATION_MATCH, (static function (array $data): array {
            $data['org']               = 'generated';
            $data['per_page']          = 8;
            $data['page']              = 1;
            $data['role']              = 'generated';
