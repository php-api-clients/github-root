...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Orgs\ReviewPatGrantRequestsInBulk */
final class ReviewPatGrantRequestsInBulkTest extends AsyncTestCase
{
    ...
    public function call_httpCode_500_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/orgs/generated/personal-access-token-requests', Argument::type('array'), json_encode(json_decode(Schema\Orgs\ReviewPatGrantRequestsInBulk\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\Orgs\ReviewPatGrantRequestsInBulk::OPERATION_MATCH, (static function (array $data): array {
            $data['org'] = 'generated';
    ...
    public function operations_httpCode_500_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/orgs/generated/personal-access-token-requests', Argument::type('array'), json_encode(json_decode(Schema\Orgs\ReviewPatGrantRequestsInBulk\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->orgs()->reviewPatGrantRequestsInBulk('generated', json_decode(Schema\Orgs\ReviewPatGrantRequestsInBulk\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
    ...
    {
        $response = new Response(202, ['Content-Type' => 'application/json'], json_encode(json_decode(Schema\Operations\Orgs\ReviewPatGrantRequestsInBulk\Response\ApplicationJson\Accepted\Application\Json::SCHEMA_EXAMPLE_DATA, true)));
        $auth     = $this->prophesize(AuthenticationInterface::class);
        $auth->authHeader(Argument::any())->willReturn('Bearer beer')->shouldBeCalled();
        $browser = $this->prophesize(Browser::class);
        $browser->withBase(Argument::any())->willReturn($browser->reveal());
