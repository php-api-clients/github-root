...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Orgs\ListPatGrantRepositories */
final class ListPatGrantRepositoriesTest extends AsyncTestCase
{
    ...
    public function call_httpCode_500_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Internal\Operation\Orgs\ListPatGrantRepositories::OPERATION_MATCH, (static function (array $data): array {
            $data['org']      = 'generated';
            $data['pat_id']   = 6;
            $data['per_page'] = 8;
            $data['page']     = 1;
