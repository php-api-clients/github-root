...
/** @covers \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Orgs\ReviewPatGrantRequest */
final class ReviewPatGrantRequestTest extends AsyncTestCase
{
    ...
    public function call_httpCode_500_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/orgs/generated/personal-access-token-requests/14', Argument::type('array'), json_encode(json_decode(Schema\Orgs\ReviewPatGrantRequest\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\Orgs\ReviewPatGrantRequest::OPERATION_MATCH, (static function (array $data): array {
            $data['org']            = 'generated';
    ...
    public function operations_httpCode_500_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/orgs/generated/personal-access-token-requests/14', Argument::type('array'), json_encode(json_decode(Schema\Orgs\ReviewPatGrantRequest\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->orgs()->reviewPatGrantRequest('generated', 14, json_decode(Schema\Orgs\ReviewPatGrantRequest\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
