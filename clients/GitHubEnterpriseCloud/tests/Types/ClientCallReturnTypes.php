...
assertType('Schema\\Operations\\Actions\\ListHostedRunnersForEnterprise\\Response\\ApplicationJson\\Ok', $client->call('GET /enterprises/{enterprise}/actions/hosted-runners'));
assertType('Schema\\ActionsHostedRunner', $client->call('POST /enterprises/{enterprise}/actions/hosted-runners'));
assertType('Schema\\Operations\\Actions\\GetHostedRunnersGithubOwnedImagesForEnterprise\\Response\\ApplicationJson\\Ok', $client->call('GET /enterprises/{enterprise}/actions/hosted-runners/images/github-owned'));
assertType('Schema\\Operations\\Actions\\GetHostedRunnersPartnerImagesForEnterprise\\Response\\ApplicationJson\\Ok\\Application\\Json', $client->call('GET /enterprises/{enterprise}/actions/hosted-runners/images/partner'));
assertType('Schema\\ActionsHostedRunnerLimits', $client->call('GET /enterprises/{enterprise}/actions/hosted-runners/limits'));
assertType('Schema\\Operations\\Actions\\GetHostedRunnersMachineSpecsForEnterprise\\Response\\ApplicationJson\\Ok', $client->call('GET /enterprises/{enterprise}/actions/hosted-runners/machine-sizes'));
assertType('Schema\\Operations\\Actions\\GetHostedRunnersPlatformsForEnterprise\\Response\\ApplicationJson\\Ok', $client->call('GET /enterprises/{enterprise}/actions/hosted-runners/platforms'));
assertType('Schema\\ActionsHostedRunner', $client->call('GET /enterprises/{enterprise}/actions/hosted-runners/{hosted_runner_id}'));
assertType('Schema\\ActionsHostedRunner', $client->call('DELETE /enterprises/{enterprise}/actions/hosted-runners/{hosted_runner_id}'));
assertType('Schema\\ActionsHostedRunner', $client->call('PATCH /enterprises/{enterprise}/actions/hosted-runners/{hosted_runner_id}'));
...
assertType('Schema\\Operations\\Actions\\ListHostedRunnersForOrg\\Response\\ApplicationJson\\Ok\\Application\\Json', $client->call('GET /orgs/{org}/actions/hosted-runners'));
assertType('Schema\\ActionsHostedRunner', $client->call('POST /orgs/{org}/actions/hosted-runners'));
assertType('Schema\\Operations\\Actions\\GetHostedRunnersGithubOwnedImagesForOrg\\Response\\ApplicationJson\\Ok\\Application\\Json', $client->call('GET /orgs/{org}/actions/hosted-runners/images/github-owned'));
assertType('Schema\\Operations\\Actions\\GetHostedRunnersPartnerImagesForOrg\\Response\\ApplicationJson\\Ok\\Application\\Json', $client->call('GET /orgs/{org}/actions/hosted-runners/images/partner'));
assertType('Schema\\ActionsHostedRunnerLimits', $client->call('GET /orgs/{org}/actions/hosted-runners/limits'));
assertType('Schema\\Operations\\Actions\\GetHostedRunnersMachineSpecsForOrg\\Response\\ApplicationJson\\Ok\\Application\\Json', $client->call('GET /orgs/{org}/actions/hosted-runners/machine-sizes'));
assertType('Schema\\Operations\\Actions\\GetHostedRunnersPlatformsForOrg\\Response\\ApplicationJson\\Ok\\Application\\Json', $client->call('GET /orgs/{org}/actions/hosted-runners/platforms'));
assertType('Schema\\ActionsHostedRunner', $client->call('GET /orgs/{org}/actions/hosted-runners/{hosted_runner_id}'));
assertType('Schema\\ActionsHostedRunner', $client->call('DELETE /orgs/{org}/actions/hosted-runners/{hosted_runner_id}'));
assertType('Schema\\ActionsHostedRunner', $client->call('PATCH /orgs/{org}/actions/hosted-runners/{hosted_runner_id}'));
...
assertType('Schema\\Operations\\Actions\\ListGithubHostedRunnersInGroupForOrg\\Response\\ApplicationJson\\Ok', $client->call('GET /orgs/{org}/actions/runner-groups/{runner_group_id}/hosted-runners'));
