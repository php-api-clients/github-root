...
assertType('Schema\\CodeSecurityConfiguration', $client->call('POST /orgs/{org}/code-security/configurations'));
assertType('iterable<int,Schema\\CodeSecurityDefaultConfigurations>|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody', $client->call('GET /orgs/{org}/code-security/configurations/defaults'));
assertType('Schema\\CodeSecurityConfiguration|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody', $client->call('GET /orgs/{org}/code-security/configurations/{configuration_id}'));
assertType('\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody', $client->call('DELETE /orgs/{org}/code-security/configurations/{configuration_id}'));
assertType('Schema\\CodeSecurityConfiguration|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody', $client->call('PATCH /orgs/{org}/code-security/configurations/{configuration_id}'));
assertType('Schema\\Operations\\CodeSecurity\\AttachConfiguration\\Response\\ApplicationJson\\Accepted\\Application\\Json', $client->call('POST /orgs/{org}/code-security/configurations/{configuration_id}/attach'));
assertType('Schema\\Operations\\CodeSecurity\\SetConfigurationAsDefault\\Response\\ApplicationJson\\Ok', $client->call('PUT /orgs/{org}/code-security/configurations/{configuration_id}/defaults'));
assertType('iterable<int,Schema\\CodeSecurityConfigurationRepositories>', $client->call('GET /orgs/{org}/code-security/configurations/{configuration_id}/repositories'));
