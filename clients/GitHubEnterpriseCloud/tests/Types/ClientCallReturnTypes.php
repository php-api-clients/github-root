...
assertType('Schema\\ApiInsightsSummaryStats', $client->call('GET /orgs/{org}/insights/api/summary-stats'));
assertType('Schema\\ApiInsightsSummaryStats', $client->call('GET /orgs/{org}/insights/api/summary-stats/users/{user_id}'));
assertType('Schema\\ApiInsightsSummaryStats', $client->call('GET /orgs/{org}/insights/api/summary-stats/{actor_type}/{actor_id}'));
assertType('iterable<int,Schema\\ApiInsightsTimeStats>', $client->call('GET /orgs/{org}/insights/api/time-stats'));
assertType('iterable<int,Schema\\ApiInsightsTimeStats>', $client->call('GET /orgs/{org}/insights/api/time-stats/users/{user_id}'));
assertType('iterable<int,Schema\\ApiInsightsTimeStats>', $client->call('GET /orgs/{org}/insights/api/time-stats/{actor_type}/{actor_id}'));
