...
assertType('Schema\\RepositoryRuleset', $client->call('POST /enterprises/{enterprise}/rulesets'));
assertType('Schema\\RepositoryRuleset', $client->call('GET /enterprises/{enterprise}/rulesets/{ruleset_id}'));
assertType('Schema\\RepositoryRuleset', $client->call('PUT /enterprises/{enterprise}/rulesets/{ruleset_id}'));
assertType('\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody', $client->call('DELETE /enterprises/{enterprise}/rulesets/{ruleset_id}'));
