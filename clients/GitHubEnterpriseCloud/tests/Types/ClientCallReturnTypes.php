...
assertType('Schema\\Operations\\Repos\\CheckPrivateVulnerabilityReporting\\Response\\ApplicationJson\\Ok', $client->call('GET /repos/{owner}/{repo}/private-vulnerability-reporting'));
