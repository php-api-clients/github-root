...
assertType('iterable<int,Schema\\CustomProperty>', $client->call('GET /enterprises/{enterprise}/properties/schema'));
assertType('iterable<int,Schema\\CustomProperty>', $client->call('PATCH /enterprises/{enterprise}/properties/schema'));
assertType('Schema\\CustomProperty', $client->call('GET /enterprises/{enterprise}/properties/schema/{custom_property_name}'));
assertType('Schema\\CustomProperty', $client->call('PUT /enterprises/{enterprise}/properties/schema/{custom_property_name}'));
assertType('\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody', $client->call('DELETE /enterprises/{enterprise}/properties/schema/{custom_property_name}'));
...
assertType('iterable<int,Schema\\ApiInsightsRouteStats>', $client->call('GET /orgs/{org}/insights/api/route-stats/{actor_type}/{actor_id}'));
assertType('iterable<int,Schema\\ApiInsightsRouteStats>', $client->call('LIST /orgs/{org}/insights/api/route-stats/{actor_type}/{actor_id}'));
assertType('iterable<int,Schema\\ApiInsightsSubjectStats>', $client->call('GET /orgs/{org}/insights/api/subject-stats'));
assertType('iterable<int,Schema\\ApiInsightsSubjectStats>', $client->call('LIST /orgs/{org}/insights/api/subject-stats'));
...
assertType('iterable<int,Schema\\ApiInsightsUserStats>', $client->call('GET /orgs/{org}/insights/api/user-stats/{user_id}'));
assertType('iterable<int,Schema\\ApiInsightsUserStats>', $client->call('LIST /orgs/{org}/insights/api/user-stats/{user_id}'));
