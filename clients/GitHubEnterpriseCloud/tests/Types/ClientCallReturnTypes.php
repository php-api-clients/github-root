...
assertType('Schema\\AuditLogStreamKey', $client->call('GET /enterprises/{enterprise}/audit-log/stream-key'));
assertType('iterable<int,Schema\\GetAuditLogStreamConfigs>', $client->call('GET /enterprises/{enterprise}/audit-log/streams'));
assertType('Schema\\GetAuditLogStreamConfig', $client->call('POST /enterprises/{enterprise}/audit-log/streams'));
assertType('Schema\\GetAuditLogStreamConfig', $client->call('GET /enterprises/{enterprise}/audit-log/streams/{stream_id}'));
assertType('Schema\\GetAuditLogStreamConfig', $client->call('PUT /enterprises/{enterprise}/audit-log/streams/{stream_id}'));
assertType('\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody', $client->call('DELETE /enterprises/{enterprise}/audit-log/streams/{stream_id}'));
