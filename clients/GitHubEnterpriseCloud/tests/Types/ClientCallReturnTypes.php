...
assertType('Observable<Schema\\IssueType>', $client->call('GET /orgs/{org}/issue-types'));
assertType('', $client->call('POST /orgs/{org}/issue-types'));
assertType('', $client->call('PUT /orgs/{org}/issue-types/{issue_type_id}'));
assertType('', $client->call('DELETE /orgs/{org}/issue-types/{issue_type_id}'));
