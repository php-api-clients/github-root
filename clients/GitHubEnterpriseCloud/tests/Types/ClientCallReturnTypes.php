...
assertType('Schema\\Operations\\HostedCompute\\ListNetworkConfigurationsForEnterprise\\Response\\ApplicationJson\\Ok', $client->call('GET /enterprises/{enterprise}/network-configurations'));
assertType('Schema\\NetworkConfiguration', $client->call('POST /enterprises/{enterprise}/network-configurations'));
assertType('Schema\\NetworkConfiguration', $client->call('GET /enterprises/{enterprise}/network-configurations/{network_configuration_id}'));
assertType('\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody', $client->call('DELETE /enterprises/{enterprise}/network-configurations/{network_configuration_id}'));
assertType('Schema\\NetworkConfiguration', $client->call('PATCH /enterprises/{enterprise}/network-configurations/{network_configuration_id}'));
assertType('Schema\\NetworkSettings', $client->call('GET /enterprises/{enterprise}/network-settings/{network_settings_id}'));
...
assertType('Schema\\Operations\\HostedCompute\\ListNetworkConfigurationsForOrg\\Response\\ApplicationJson\\Ok\\Application\\Json', $client->call('GET /orgs/{org}/settings/network-configurations'));
assertType('Schema\\NetworkConfiguration', $client->call('POST /orgs/{org}/settings/network-configurations'));
assertType('Schema\\NetworkConfiguration', $client->call('GET /orgs/{org}/settings/network-configurations/{network_configuration_id}'));
assertType('\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody', $client->call('DELETE /orgs/{org}/settings/network-configurations/{network_configuration_id}'));
assertType('Schema\\NetworkConfiguration', $client->call('PATCH /orgs/{org}/settings/network-configurations/{network_configuration_id}'));
assertType('Schema\\NetworkSettings', $client->call('GET /orgs/{org}/settings/network-settings/{network_settings_id}'));
