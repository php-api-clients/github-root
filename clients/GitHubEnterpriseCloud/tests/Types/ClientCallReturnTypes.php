...
assertType('iterable<int,Schema\\RulesetVersion>', $client->call('GET /enterprises/{enterprise}/rulesets/{ruleset_id}/history'));
assertType('iterable<int,Schema\\RulesetVersion>', $client->call('LIST /enterprises/{enterprise}/rulesets/{ruleset_id}/history'));
assertType('Schema\\RulesetVersion', $client->call('GET /enterprises/{enterprise}/rulesets/{ruleset_id}/history/{version_id}'));
