...
final class WebHooks implements \ApiClients\Contracts\OpenAPI\WebHooksInterface
{
    ...
    private ?WebHook\PersonalAccessTokenRequest $personalAccessTokenRequest = null;
    ...
    public function resolve(array $headers, array $data) : object
    {
        ...
        webhooks_aaabf:
        try {
            if ($this->personalAccessTokenRequest instanceof WebHook\PersonalAccessTokenRequest === false) {
                $this->personalAccessTokenRequest = new WebHook\PersonalAccessTokenRequest($this->requestSchemaValidator, $this->hydrator->getObjectMapperWebHook🪝PersonalAccessTokenRequest());
            }
