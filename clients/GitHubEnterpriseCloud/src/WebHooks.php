...
final class WebHooks implements WebHooksInterface
{
    ...
    private Internal\WebHook\DismissalRequestCodeScanning|null $dismissalRequestCodeScanning     = null;
    ...
    public function resolve(array $headers, array $data): object
    {
        ...
        webhooks_aaaab:
        try {
            if ($this->exemptionRequestPushRuleset instanceof Internal\WebHook\ExemptionRequestPushRuleset === false) {
                $this->exemptionRequestPushRuleset = new Internal\WebHook\ExemptionRequestPushRuleset($this->requestSchemaValidator, $this->hydrator->getObjectMapperWebHook🪝ExemptionRequestPushRuleset());
            }

            return $this->exemptionRequestPushRuleset->resolve($headers, $data);
        } catch (Throwable $error) {
            goto webhooks_aaaac;
        }
        ...
        webhooks_aaaat:
        try {
            if ($this->dismissalRequestCodeScanning instanceof Internal\WebHook\DismissalRequestCodeScanning === false) {
                $this->dismissalRequestCodeScanning = new Internal\WebHook\DismissalRequestCodeScanning($this->requestSchemaValidator, $this->hydrator->getObjectMapperWebHook🪝DismissalRequestCodeScanning());
            }

            return $this->dismissalRequestCodeScanning->resolve($headers, $data);
        } catch (Throwable $error) {
            goto webhooks_aaaau;
        }
