...
class InstallationRepositories implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesAdded($payload),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded\RepositoriesAdded' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesAdded⚡️RepositoriesAdded($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded\RepositoriesRemoved' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesAdded⚡️RepositoriesRemoved($payload),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded\Requester' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesAdded⚡️Requester($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesRemoved($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved\RepositoriesAdded' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesRemoved⚡️RepositoriesAdded($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved\RepositoriesRemoved' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesRemoved⚡️RepositoriesRemoved($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved\Requester' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesRemoved⚡️Requester($payload),
            default => throw UnableToHydrateObject::noHydrationDefined($className, $this->hydrationStack),
        };
    }
    
            
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesAdded(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded
    {
        $properties = []; 
        $missingFields = [];
        try {
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookInstallationRepositoriesAdded\\RepositoriesAdded',
));
            }
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookInstallationRepositoriesAdded\\RepositoriesRemoved',
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesAdded⚡️Requester($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesAdded⚡️RepositoriesAdded(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded\RepositoriesAdded
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded\RepositoriesAdded', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded\RepositoriesAdded::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded\RepositoriesAdded(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded\RepositoriesAdded', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesAdded⚡️RepositoriesRemoved(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded\RepositoriesRemoved
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded\RepositoriesRemoved', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded\RepositoriesRemoved::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded\RepositoriesRemoved(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded\RepositoriesRemoved', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesAdded⚡️Requester(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded\Requester
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded\Requester', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded\Requester::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded\Requester(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded\Requester', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesRemoved(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if ($repositoriesAddedCaster1 === null) {
                $repositoriesAddedCaster1 = new \EventSauce\ObjectHydrator\PropertyCasters\CastListToType(...array (
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookInstallationRepositoriesRemoved\\RepositoriesAdded',
));
            }
            ...
            if ($repositoriesRemovedCaster1 === null) {
                $repositoriesRemovedCaster1 = new \EventSauce\ObjectHydrator\PropertyCasters\CastListToType(...array (
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookInstallationRepositoriesRemoved\\RepositoriesRemoved',
));
            }
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'requester';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesRemoved⚡️Requester($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesRemoved⚡️RepositoriesAdded(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved\RepositoriesAdded
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved\RepositoriesAdded', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved\RepositoriesAdded::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved\RepositoriesAdded(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved\RepositoriesAdded', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesRemoved⚡️RepositoriesRemoved(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved\RepositoriesRemoved
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved\RepositoriesRemoved', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved\RepositoriesRemoved::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved\RepositoriesRemoved(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved\RepositoriesRemoved', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesRemoved⚡️Requester(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved\Requester
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved\Requester', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved\Requester::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved\Requester(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved\Requester', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            ...
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesAdded($object),
            ...
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded\RepositoriesAdded' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesAdded⚡️RepositoriesAdded($object),
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded\RepositoriesRemoved' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesAdded⚡️RepositoriesRemoved($object),
            ...
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded\Requester' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesAdded⚡️Requester($object),
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesRemoved($object),
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved\RepositoriesAdded' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesRemoved⚡️RepositoriesAdded($object),
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved\RepositoriesRemoved' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesRemoved⚡️RepositoriesRemoved($object),
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved\Requester' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesRemoved⚡️Requester($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesAdded(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded);
        $result = [];
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookInstallationRepositoriesAdded\\RepositoriesRemoved',
        ...
        $requester = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesAdded⚡️Requester($requester);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesAdded⚡️RepositoriesAdded(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded\RepositoriesAdded);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesAdded⚡️RepositoriesRemoved(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded\RepositoriesRemoved);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesAdded⚡️Requester(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded\Requester);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesRemoved(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved);
        $result = [];
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookInstallationRepositoriesRemoved\\RepositoriesRemoved',
        ...
        $requester = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesRemoved⚡️Requester($requester);
        after_requester:        $result['requester'] = $requester;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesRemoved⚡️RepositoriesAdded(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved\RepositoriesAdded);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesRemoved⚡️RepositoriesRemoved(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved\RepositoriesRemoved);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesRemoved⚡️Requester(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved\Requester);
        $result = [];
