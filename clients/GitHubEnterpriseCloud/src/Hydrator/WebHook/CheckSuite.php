...
class CheckSuite implements ObjectMapper
{
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookCheckSuiteCompleted\\CheckSuite\\PullRequests',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookCheckSuiteCompleted(mixed $object): mixed
    {
        ...
        $actions_meta = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookCheckSuiteCompleted⚡️ActionsMeta($actions_meta);
        ...
        $check_suite = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookCheckSuiteCompleted⚡️CheckSuite($check_suite);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookCheckSuiteCompleted⚡️CheckSuite(mixed $object): mixed
    {
        ...
        $head_commit = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookCheckSuiteCompleted⚡️CheckSuite⚡️HeadCommit($head_commit);
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookCheckSuiteCompleted\\CheckSuite\\PullRequests',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookCheckSuiteCompleted⚡️CheckSuite⚡️HeadCommit(mixed $object): mixed
    {
        ...
        $committer = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookCheckSuiteCompleted⚡️CheckSuite⚡️HeadCommit⚡️Author($committer);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookCheckSuiteCompleted⚡️CheckSuite⚡️PullRequests(mixed $object): mixed
    {
        ...
        $head = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookCheckSuiteCompleted⚡️CheckSuite⚡️PullRequests⚡️Base($head);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookCheckSuiteRequested(mixed $object): mixed
    {
        ...
        $check_suite = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookCheckSuiteRequested⚡️CheckSuite($check_suite);
        after_check_suite:        $result['check_suite'] = $check_suite;
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookCheckSuiteCompleted\\CheckSuite\\PullRequests',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookCheckSuiteRerequested(mixed $object): mixed
    {
        ...
        $actions_meta = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookCheckSuiteRerequested⚡️ActionsMeta($actions_meta);
        after_actions_meta:        $result['actions_meta'] = $actions_meta;
        ...
        $check_suite = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookCheckSuiteRerequested⚡️CheckSuite($check_suite);
        after_check_suite:        $result['check_suite'] = $check_suite;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookCheckSuiteRerequested⚡️ActionsMeta(mixed $object): mixed
    {
        ...
        $rerun_info = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookCheckSuiteRerequested⚡️ActionsMeta⚡️RerunInfo($rerun_info);
