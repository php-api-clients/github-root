...
class MarketplacePurchase implements ObjectMapper
{
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookMarketplacePurchasePendingChange(mixed $object): mixed
    {
        ...
        $previousMarketplacePurchase = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookMarketplacePurchaseCancelled⚡️MarketplacePurchase($previousMarketplacePurchase);
        after_previousMarketplacePurchase:        $result['previous_marketplace_purchase'] = $previousMarketplacePurchase;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookMarketplacePurchasePendingChangeCancelled(mixed $object): mixed
    {
        ...
        $marketplacePurchase = $object->marketplacePurchase;
        $marketplacePurchase = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookMarketplacePurchaseCancelled⚡️PreviousMarketplacePurchase($marketplacePurchase);
        after_marketplacePurchase:        $result['marketplace_purchase'] = $marketplacePurchase;
