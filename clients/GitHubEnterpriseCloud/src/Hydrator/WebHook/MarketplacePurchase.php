...
class MarketplacePurchase implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookMarketplacePurchaseCancelled(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookMarketplacePurchaseCancelled
        {
            ...
            try {
                ...
                if ($value === null) {
                    $missingFields[] = 'previous_marketplace_purchase';
                    goto after_previous_marketplace_purchase;
                }

                if (is_array($value)) {
                    try {
                        $this->hydrationStack[] = 'previous_marketplace_purchase';
                ...
                $properties['previous_marketplace_purchase'] = $value;
    
                after_previous_marketplace_purchase:
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookMarketplacePurchaseCancelled(mixed $object): mixed
    {
        ...
        $marketplace_purchase = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookMarketplacePurchaseCancelled⚡️MarketplacePurchase($marketplace_purchase);
        ...
        $previous_marketplace_purchase = $object->previous_marketplace_purchase;
        $previous_marketplace_purchase = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookMarketplacePurchaseCancelled⚡️PreviousMarketplacePurchase($previous_marketplace_purchase);
        after_previous_marketplace_purchase:        $result['previous_marketplace_purchase'] = $previous_marketplace_purchase;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookMarketplacePurchaseChanged(mixed $object): mixed
    {
        ...
        $previous_marketplace_purchase = $object->previous_marketplace_purchase;
        $previous_marketplace_purchase = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookMarketplacePurchaseChanged⚡️PreviousMarketplacePurchase($previous_marketplace_purchase);
        after_previous_marketplace_purchase:        $result['previous_marketplace_purchase'] = $previous_marketplace_purchase;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookMarketplacePurchasePendingChange(mixed $object): mixed
    {
        ...
        $previous_marketplace_purchase = $object->previous_marketplace_purchase;
        $previous_marketplace_purchase = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookMarketplacePurchasePendingChange⚡️PreviousMarketplacePurchase($previous_marketplace_purchase);
        after_previous_marketplace_purchase:        $result['previous_marketplace_purchase'] = $previous_marketplace_purchase;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookMarketplacePurchasePendingChangeCancelled(mixed $object): mixed
    {
        ...
        $marketplace_purchase = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookMarketplacePurchasePendingChangeCancelled⚡️MarketplacePurchase($marketplace_purchase);
        after_marketplace_purchase:        $result['marketplace_purchase'] = $marketplace_purchase;
