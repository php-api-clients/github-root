...
class WorkflowRun implements ObjectMapper
{
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookDeploymentCreated\\WorkflowRun\\ReferencedWorkflows',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowRunCompleted(mixed $object): mixed
    {
        ...
        $workflow_run = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowRunCompleted⚡️WorkflowRun($workflow_run);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowRunCompleted⚡️WorkflowRun(mixed $object): mixed
    {
        ...
        $actor = $object->actor;
        $actor = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeploymentCreated⚡️WorkflowRun⚡️HeadRepository⚡️Owner($actor);
        ...
        $head_commit = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowRunCompleted⚡️WorkflowRun⚡️HeadCommit($head_commit);
        after_head_commit:        $result['head_commit'] = $head_commit;

        
        $head_repository = $object->head_repository;
        $head_repository = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowRunCompleted⚡️WorkflowRun⚡️HeadRepository($head_repository);
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookDeploymentCreated\\WorkflowRun\\ReferencedWorkflows',
        ...
        $repository = $object->repository;
        $repository = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowRunCompleted⚡️WorkflowRun⚡️HeadRepository($repository);
        after_repository:        $result['repository'] = $repository;
        ...
        $triggering_actor = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookProjectCardMoved⚡️ProjectCard⚡️Creator($triggering_actor);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowRunCompleted⚡️WorkflowRun⚡️HeadCommit(mixed $object): mixed
    {
        ...
        $committer = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowRunCompleted⚡️WorkflowRun⚡️HeadCommit⚡️Author($committer);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowRunInProgress(mixed $object): mixed
    {
        ...
        $workflow_run = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowRunInProgress⚡️WorkflowRun($workflow_run);
        after_workflow_run:        $result['workflow_run'] = $workflow_run;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowRunInProgress⚡️WorkflowRun(mixed $object): mixed
    {
        ...
        $head_repository = $object->head_repository;
        $head_repository = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowRunInProgress⚡️WorkflowRun⚡️HeadRepository($head_repository);
        after_head_repository:        $result['head_repository'] = $head_repository;
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookDeploymentCreated\\WorkflowRun\\ReferencedWorkflows',
        ...
        $triggering_actor = $object->triggering_actor;
        $triggering_actor = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeploymentCreated⚡️WorkflowRun⚡️HeadRepository⚡️Owner($triggering_actor);
        after_triggering_actor:        $result['triggering_actor'] = $triggering_actor;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowRunRequested(mixed $object): mixed
    {
        ...
        $workflow_run = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun($workflow_run);
        after_workflow_run:        $result['workflow_run'] = $workflow_run;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun(mixed $object): mixed
    {
        ...
        $head_repository = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun⚡️HeadRepository($head_repository);
        after_head_repository:        $result['head_repository'] = $head_repository;
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookDeploymentCreated\\WorkflowRun\\ReferencedWorkflows',
        ...
        $repository = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowRunRequested⚡️WorkflowRun⚡️HeadRepository($repository);
        after_repository:        $result['repository'] = $repository;
