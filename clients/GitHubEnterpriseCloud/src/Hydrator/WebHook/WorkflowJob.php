...
class WorkflowJob implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobCompleted' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobCompleted($payload),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobCompleted\WorkflowJob' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobCompleted⚡️WorkflowJob($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobCompleted\WorkflowJob\Steps' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobCompleted⚡️WorkflowJob⚡️Steps($payload),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobInProgress' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobInProgress($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobInProgress\WorkflowJob' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobInProgress⚡️WorkflowJob($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobInProgress\WorkflowJob\Steps' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobInProgress⚡️WorkflowJob⚡️Steps($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobQueued' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobQueued($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobQueued\WorkflowJob' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobQueued⚡️WorkflowJob($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobQueued\WorkflowJob\Steps' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobQueued⚡️WorkflowJob⚡️Steps($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobWaiting' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobWaiting($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobWaiting\WorkflowJob' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobWaiting⚡️WorkflowJob($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobWaiting\WorkflowJob\Steps' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobWaiting⚡️WorkflowJob⚡️Steps($payload),
            default => throw UnableToHydrateObject::noHydrationDefined($className, $this->hydrationStack),
        };
    }
    
            
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobCompleted(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobCompleted
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobCompleted⚡️WorkflowJob($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Deployment($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobCompleted', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobCompleted::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobCompleted(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobCompleted', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobCompleted⚡️WorkflowJob(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobCompleted\WorkflowJob
    {
        $properties = []; 
        $missingFields = [];
        try {
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookWorkflowJobCompleted\\WorkflowJob\\Steps',
));
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobCompleted\WorkflowJob', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobCompleted\WorkflowJob::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobCompleted\WorkflowJob(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobCompleted\WorkflowJob', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobCompleted⚡️WorkflowJob⚡️Steps(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobCompleted\WorkflowJob\Steps
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobCompleted\WorkflowJob\Steps', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobCompleted\WorkflowJob\Steps::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobCompleted\WorkflowJob\Steps(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobCompleted\WorkflowJob\Steps', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobInProgress(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobInProgress
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'workflowJob';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobInProgress⚡️WorkflowJob($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobInProgress', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobInProgress::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobInProgress(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobInProgress', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobInProgress⚡️WorkflowJob(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobInProgress\WorkflowJob
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if ($stepsCaster1 === null) {
                $stepsCaster1 = new \EventSauce\ObjectHydrator\PropertyCasters\CastListToType(...array (
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookWorkflowJobInProgress\\WorkflowJob\\Steps',
));
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobInProgress\WorkflowJob', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobInProgress\WorkflowJob::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobInProgress\WorkflowJob(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobInProgress\WorkflowJob', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobInProgress⚡️WorkflowJob⚡️Steps(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobInProgress\WorkflowJob\Steps
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobInProgress\WorkflowJob\Steps', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobInProgress\WorkflowJob\Steps::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobInProgress\WorkflowJob\Steps(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobInProgress\WorkflowJob\Steps', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobQueued(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobQueued
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'workflowJob';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobQueued⚡️WorkflowJob($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobQueued', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobQueued::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobQueued(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobQueued', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobQueued⚡️WorkflowJob(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobQueued\WorkflowJob
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if ($stepsCaster1 === null) {
                $stepsCaster1 = new \EventSauce\ObjectHydrator\PropertyCasters\CastListToType(...array (
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookWorkflowJobQueued\\WorkflowJob\\Steps',
));
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobQueued\WorkflowJob', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobQueued\WorkflowJob::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobQueued\WorkflowJob(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobQueued\WorkflowJob', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobQueued⚡️WorkflowJob⚡️Steps(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobQueued\WorkflowJob\Steps
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobQueued\WorkflowJob\Steps', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobQueued\WorkflowJob\Steps::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobQueued\WorkflowJob\Steps(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobQueued\WorkflowJob\Steps', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobWaiting(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobWaiting
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'workflowJob';
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobWaiting⚡️WorkflowJob($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobWaiting', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobWaiting::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobWaiting(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobWaiting', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobWaiting⚡️WorkflowJob(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobWaiting\WorkflowJob
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if ($stepsCaster1 === null) {
                $stepsCaster1 = new \EventSauce\ObjectHydrator\PropertyCasters\CastListToType(...array (
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookWorkflowJobWaiting\\WorkflowJob\\Steps',
));
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobWaiting\WorkflowJob', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobWaiting\WorkflowJob::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobWaiting\WorkflowJob(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobWaiting\WorkflowJob', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobWaiting⚡️WorkflowJob⚡️Steps(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobWaiting\WorkflowJob\Steps
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobWaiting\WorkflowJob\Steps', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobWaiting\WorkflowJob\Steps::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobWaiting\WorkflowJob\Steps(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobWaiting\WorkflowJob\Steps', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            ...
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobCompleted' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobCompleted($object),
            ...
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobCompleted\WorkflowJob' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobCompleted⚡️WorkflowJob($object),
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobCompleted\WorkflowJob\Steps' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobCompleted⚡️WorkflowJob⚡️Steps($object),
            ...
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobInProgress' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobInProgress($object),
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobInProgress\WorkflowJob' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobInProgress⚡️WorkflowJob($object),
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobInProgress\WorkflowJob\Steps' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobInProgress⚡️WorkflowJob⚡️Steps($object),
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobQueued' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobQueued($object),
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobQueued\WorkflowJob' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobQueued⚡️WorkflowJob($object),
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobQueued\WorkflowJob\Steps' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobQueued⚡️WorkflowJob⚡️Steps($object),
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobWaiting' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobWaiting($object),
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobWaiting\WorkflowJob' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobWaiting⚡️WorkflowJob($object),
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobWaiting\WorkflowJob\Steps' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobWaiting⚡️WorkflowJob⚡️Steps($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobCompleted(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobCompleted);
        $result = [];
        ...
        $workflowJob = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobCompleted⚡️WorkflowJob($workflowJob);
        ...
        $deployment = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Deployment($deployment);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobCompleted⚡️WorkflowJob(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobCompleted\WorkflowJob);
        $result = [];
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookWorkflowJobCompleted\\WorkflowJob\\Steps',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobCompleted⚡️WorkflowJob⚡️Steps(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobCompleted\WorkflowJob\Steps);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobInProgress(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobInProgress);
        $result = [];
        ...
        $workflowJob = $object->workflowJob;
        $workflowJob = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobInProgress⚡️WorkflowJob($workflowJob);
        after_workflowJob:        $result['workflow_job'] = $workflowJob;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobInProgress⚡️WorkflowJob(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobInProgress\WorkflowJob);
        $result = [];
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookWorkflowJobInProgress\\WorkflowJob\\Steps',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobInProgress⚡️WorkflowJob⚡️Steps(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobInProgress\WorkflowJob\Steps);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobQueued(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobQueued);
        $result = [];
        ...
        $workflowJob = $object->workflowJob;
        $workflowJob = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobQueued⚡️WorkflowJob($workflowJob);
        after_workflowJob:        $result['workflow_job'] = $workflowJob;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobQueued⚡️WorkflowJob(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobQueued\WorkflowJob);
        $result = [];
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookWorkflowJobQueued\\WorkflowJob\\Steps',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobQueued⚡️WorkflowJob⚡️Steps(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobQueued\WorkflowJob\Steps);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobWaiting(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobWaiting);
        $result = [];
        ...
        $workflowJob = $object->workflowJob;
        $workflowJob = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobWaiting⚡️WorkflowJob($workflowJob);
        after_workflowJob:        $result['workflow_job'] = $workflowJob;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobWaiting⚡️WorkflowJob(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobWaiting\WorkflowJob);
        $result = [];
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookWorkflowJobWaiting\\WorkflowJob\\Steps',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobWaiting⚡️WorkflowJob⚡️Steps(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobWaiting\WorkflowJob\Steps);
        $result = [];
