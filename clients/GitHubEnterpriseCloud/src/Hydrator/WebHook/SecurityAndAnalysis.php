...
class SecurityAndAnalysis implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecurityAndAnalysis(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAndAnalysis
        {
            $properties = []; 
            $missingFields = [];
            try {
            ...
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAndAnalysis::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAndAnalysis(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAndAnalysis', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAndAnalysis\Changes
        {
            $properties = []; 
            $missingFields = [];
            try {
            ...
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAndAnalysis\Changes::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAndAnalysis\Changes(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAndAnalysis\Changes', $exception, stack: $this->hydrationStack);
            }
        }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes⚡️From(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAndAnalysis\Changes\From
        {
            $properties = []; 
            $missingFields = [];
            try {
            ...
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAndAnalysis\Changes\From::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAndAnalysis\Changes\From(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAndAnalysis\Changes\From', $exception, stack: $this->hydrationStack);
            }
        }
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAndAnalysis);
        $result = [];
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAndAnalysis\Changes);
        $result = [];
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAndAnalysis\Changes\From);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️FullRepository(mixed $object): mixed
    {
        ...
        $code_of_conduct = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodeOfConductSimple($code_of_conduct);
