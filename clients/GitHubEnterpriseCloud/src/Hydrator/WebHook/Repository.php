...
class Repository implements ObjectMapper
{
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryEdited⚡️Changes(mixed $object): mixed
    {
        ...
        $default_branch = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDiscussionCommentEdited⚡️Changes⚡️Body($default_branch);
        after_default_branch:        $result['default_branch'] = $default_branch;
        ...
        $description = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookProjectCardEdited⚡️Changes⚡️Note($description);
        after_description:        $result['description'] = $description;
        ...
        $homepage = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookProjectCardEdited⚡️Changes⚡️Note($homepage);
        after_homepage:        $result['homepage'] = $homepage;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRenamed⚡️Changes⚡️Repository(mixed $object): mixed
    {
        ...
        $name = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDiscussionCommentEdited⚡️Changes⚡️Body($name);
        after_name:        $result['name'] = $name;
