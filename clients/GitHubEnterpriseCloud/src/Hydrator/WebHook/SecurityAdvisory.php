...
class SecurityAdvisory implements ObjectMapper
{
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookSecurityAdvisoryPublished\\SecurityAdvisory\\Vulnerabilities',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecurityAdvisoryPublished(mixed $object): mixed
    {
        ...
        $security_advisory = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecurityAdvisoryPublished⚡️SecurityAdvisory($security_advisory);
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookSecurityAdvisoryPublished\\SecurityAdvisory\\Vulnerabilities',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecurityAdvisoryPublished⚡️SecurityAdvisory⚡️Vulnerabilities(mixed $object): mixed
    {
        ...
        $first_patched_version = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecurityAdvisoryPublished⚡️SecurityAdvisory⚡️Vulnerabilities⚡️FirstPatchedVersion($first_patched_version);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecurityAdvisoryWithdrawn(mixed $object): mixed
    {
        ...
        $security_advisory = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecurityAdvisoryWithdrawn⚡️SecurityAdvisory($security_advisory);
        after_security_advisory:        $result['security_advisory'] = $security_advisory;
