...
class DeploymentStatus implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookDeploymentStatusCreated' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeploymentStatusCreated($payload),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\AuditLogEvent\Config' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️AuditLogEvent⚡️Config($payload),
            ...
            try {
                ...
                if (is_array($value)) {
                    try {
                        ...
                        $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️AuditLogEvent⚡️Config($value);
                    } finally {
                        array_pop($this->hydrationStack);
                    }
                }
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookDeploymentCreated\\WorkflowRun\\ReferencedWorkflows',
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️AuditLogEvent⚡️Config(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\AuditLogEvent\Config
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\AuditLogEvent\Config', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\AuditLogEvent\Config::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\AuditLogEvent\Config(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\AuditLogEvent\Config', $exception, stack: $this->hydrationStack);
            }
        }
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeploymentStatusCreated(mixed $object): mixed
    {
        ...
        $check_run = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️CheckRun($check_run);
        ...
        $deployment_status = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus($deployment_status);
        ...
        $workflow_run = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun($workflow_run);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment(mixed $object): mixed
    {
        ...
        $payload = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️AuditLogEvent⚡️Config($payload);
        ...
        $performed_via_github_app = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️PerformedViaGithubApp($performed_via_github_app);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus(mixed $object): mixed
    {
        ...
        $performed_via_github_app = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus⚡️PerformedViaGithubApp($performed_via_github_app);
        after_performed_via_github_app:        $result['performed_via_github_app'] = $performed_via_github_app;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun(mixed $object): mixed
    {
        ...
        $actor = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Discussion⚡️AnswerChosenBy($actor);
        ...
        $head_repository = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeploymentCreated⚡️WorkflowRun⚡️HeadRepository($head_repository);
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookDeploymentCreated\\WorkflowRun\\ReferencedWorkflows',
        ...
        $repository = $object->repository;
        $repository = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeploymentCreated⚡️WorkflowRun⚡️HeadRepository($repository);
        after_repository:        $result['repository'] = $repository;
        ...
        $triggering_actor = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Discussion⚡️AnswerChosenBy($triggering_actor);
