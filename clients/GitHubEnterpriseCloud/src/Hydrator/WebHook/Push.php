...
class Push implements ObjectMapper
{
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPush(mixed $object): mixed
    {
        ...
        $head_commit = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPush⚡️HeadCommit($head_commit);
        ...
        $repository = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDiscussionTransferred⚡️Changes⚡️NewRepository($repository);
