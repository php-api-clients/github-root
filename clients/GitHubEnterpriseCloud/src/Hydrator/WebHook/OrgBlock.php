...
class OrgBlock implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookOrgBlockBlocked(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookOrgBlockBlocked
        {
            ...
            try {
                ...
                if (is_array($value)) {
                    try {
                        $this->hydrationStack[] = 'blocked_user';
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookOrgBlockBlocked(mixed $object): mixed
    {
        ...
        $blocked_user = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Discussion⚡️AnswerChosenBy($blocked_user);
