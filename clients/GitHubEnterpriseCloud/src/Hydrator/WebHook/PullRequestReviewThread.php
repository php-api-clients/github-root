...
class PullRequestReviewThread implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPullRequestReviewThreadResolved' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPullRequestReviewThreadResolved($payload),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPullRequestReviewCommentCreated\Comment\Links' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️Comment⚡️Links($payload),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPullRequestReviewCommentDeleted\Comment' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPullRequestReviewCommentDeleted⚡️Comment($payload),
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookPullRequestReviewThreadResolved\\Thread\\Comments',
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPullRequestReviewThreadResolved⚡️Thread⚡️Comments(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPullRequestReviewThreadResolved\Thread\Comments
        {
            ...
            try {
                ...
                if (is_array($value)) {
                    try {
                        $this->hydrationStack[] = '_links';
                        $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️Comment⚡️Links($value);
                    } finally {
                        array_pop($this->hydrationStack);
                    }
                }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️Comment⚡️Links(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPullRequestReviewCommentCreated\Comment\Links
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPullRequestReviewCommentCreated\Comment\Links', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPullRequestReviewCommentCreated\Comment\Links::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPullRequestReviewCommentCreated\Comment\Links(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPullRequestReviewCommentCreated\Comment\Links', $exception, stack: $this->hydrationStack);
            }
        }
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookMembershipAdded\\Team',
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPullRequestReviewThreadUnresolved⚡️Thread(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPullRequestReviewThreadUnresolved\Thread
        {
            ...
            try {
                ...
                if ($commentsCaster1 === null) {
                    $commentsCaster1 = new \EventSauce\ObjectHydrator\PropertyCasters\CastListToType(...array (
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookPullRequestReviewCommentDeleted\\Comment',
));
                }
        ...
        private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPullRequestReviewCommentDeleted⚡️Comment(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPullRequestReviewCommentDeleted\Comment
        {
            $properties = []; 
            $missingFields = [];
            try {
                ...
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPullRequestReviewCommentDeleted\Comment', $exception, stack: $this->hydrationStack);
            }
            
            if (count($missingFields) > 0) {
                throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPullRequestReviewCommentDeleted\Comment::class, $missingFields, stack: $this->hydrationStack);
            }
            
            try {
                return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPullRequestReviewCommentDeleted\Comment(...$properties);
            } catch (\Throwable $exception) {
                throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPullRequestReviewCommentDeleted\Comment', $exception, stack: $this->hydrationStack);
            }
        }
    ...
    public function serializeObject(object $object): mixed
    {
        try {
            ...
            return match($className) {
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPullRequestReviewCommentCreated\Comment\Links' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️Comment⚡️Links($object),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPullRequestReviewCommentDeleted\Comment' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPullRequestReviewCommentDeleted⚡️Comment($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPullRequestReviewThreadResolved(mixed $object): mixed
    {
        ...
        $pull_request = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPullRequestReviewThreadResolved⚡️PullRequest($pull_request);
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookMembershipAdded\\Team',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPullRequestReviewThreadResolved⚡️PullRequest⚡️Base(mixed $object): mixed
    {
        ...
        $repo = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookIssuesTransferred⚡️Changes⚡️NewRepository($repo);
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookPullRequestReviewThreadResolved\\Thread\\Comments',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPullRequestReviewThreadResolved⚡️Thread⚡️Comments(mixed $object): mixed
    {
        ...
        $_links = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️Comment⚡️Links($_links);
        after__links:        $result['_links'] = $_links;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPullRequestReviewCommentCreated⚡️Comment⚡️Links(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPullRequestReviewCommentCreated\Comment\Links);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPullRequestReviewThreadUnresolved(mixed $object): mixed
    {
        ...
        $pull_request = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPullRequestReviewThreadUnresolved⚡️PullRequest($pull_request);
        after_pull_request:        $result['pull_request'] = $pull_request;
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\Discussion\\AnswerChosenBy',
        ...
        $auto_merge = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPullRequestReviewThreadUnresolved⚡️PullRequest⚡️AutoMerge($auto_merge);
        after_auto_merge:        $result['auto_merge'] = $auto_merge;
        ...
        $head = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPullRequestReviewThreadResolved⚡️PullRequest⚡️Base($head);
        after_head:        $result['head'] = $head;
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookPullRequestReviewCommentDeleted\\Comment',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPullRequestReviewCommentDeleted⚡️Comment(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPullRequestReviewCommentDeleted\Comment);
        $result = [];
