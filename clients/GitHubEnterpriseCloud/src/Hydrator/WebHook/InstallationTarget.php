...
class InstallationTarget implements ObjectMapper
{
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationTargetRenamed⚡️Changes(mixed $object): mixed
    {
        ...
        $login = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDiscussionCommentEdited⚡️Changes⚡️Body($login);
        after_login:        $result['login'] = $login;
        ...
        $slug = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDiscussionCommentEdited⚡️Changes⚡️Body($slug);
        after_slug:        $result['slug'] = $slug;
