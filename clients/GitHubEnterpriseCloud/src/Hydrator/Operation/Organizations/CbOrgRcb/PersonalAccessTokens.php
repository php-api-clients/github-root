...
namespace ApiClients\Client\GitHubEnterpriseCloud\Hydrator\Operation\Organizations\CbOrgRcb;
...
class PersonalAccessTokens implements ObjectMapper
{
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\ValidationError\\Errors',
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️OrganizationProgrammaticAccessGrant(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\OrganizationProgrammaticAccessGrant
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            $value = $payload['access_granted_at'] ?? null;

            if ($value === null) {
                $missingFields[] = 'access_granted_at';
                goto after_accessGrantedAt;
            }

            $properties['accessGrantedAt'] = $value;

            after_accessGrantedAt:
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\OrganizationProgrammaticAccessGrant', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\OrganizationProgrammaticAccessGrant::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\OrganizationProgrammaticAccessGrant(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\OrganizationProgrammaticAccessGrant', $exception, stack: $this->hydrationStack);
        }
    }
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\ValidationError\\Errors',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️OrganizationProgrammaticAccessGrant(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\OrganizationProgrammaticAccessGrant);
        $result = [];
        ...
        $accessGrantedAt = $object->accessGrantedAt;
        after_accessGrantedAt:        $result['access_granted_at'] = $accessGrantedAt;
