...
namespace ApiClients\Client\GitHubEnterpriseCloud\Hydrator\Operation\Projects\CbProjectIdRcb\Collaborators\CbUsernameRcb;
...
class Permission implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️ProjectCollaboratorPermission(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\ProjectCollaboratorPermission
    {
        $properties = []; 
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\ProjectCollaboratorPermission::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\ProjectCollaboratorPermission(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\ProjectCollaboratorPermission', $exception, stack: $this->hydrationStack);
        }
    }
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\ValidationError\\Errors',
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\ProjectCollaboratorPermission);
        $result = [];
