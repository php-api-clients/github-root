...
class Events implements ObjectMapper
{
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\ValidationError\\Errors',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️IssueEvent(mixed $object): mixed
    {
        ...
        $reviewRequester = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️SimpleUser($reviewRequester);
        ...
        $requestedReviewer = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️SimpleUser($requestedReviewer);
        ...
        $requestedTeam = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Team($requestedTeam);
        ...
        $dismissedReview = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️IssueEventDismissedReview($dismissedReview);
        ...
        $projectCard = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️IssueEventProjectCard($projectCard);
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\SimpleUser',
        ...
        $pullRequest = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Issue⚡️PullRequest($pullRequest);
        ...
        $closedBy = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️SimpleUser($closedBy);
