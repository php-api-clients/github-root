...
class Profile implements ObjectMapper
{
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CommunityProfile⚡️Files(mixed $object): mixed
    {
        ...
        $code_of_conduct_file = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CommunityHealthFile($code_of_conduct_file);
        ...
        $issue_template = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CommunityHealthFile($issue_template);
        ...
        $pull_request_template = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CommunityHealthFile($pull_request_template);
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\CommunityHealthFile);
        $result = [];
