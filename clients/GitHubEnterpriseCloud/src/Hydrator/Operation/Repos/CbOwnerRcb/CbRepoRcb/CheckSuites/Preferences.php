...
namespace ApiClients\Client\GitHubEnterpriseCloud\Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\CheckSuites;
...
class Preferences implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match($className) {
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\CheckSuitePreference' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CheckSuitePreference($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\CheckSuitePreference\Preferences' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CheckSuitePreference⚡️Preferences($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\CheckSuitePreference\Preferences\AutoTriggerChecks' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CheckSuitePreference⚡️Preferences⚡️AutoTriggerChecks($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CheckSuitePreference(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\CheckSuitePreference
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CheckSuitePreference⚡️Preferences($value);
                } finally {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\CheckSuitePreference', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\CheckSuitePreference::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\CheckSuitePreference(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\CheckSuitePreference', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CheckSuitePreference⚡️Preferences(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\CheckSuitePreference\Preferences
    {
        $properties = []; 
        $missingFields = [];
        try {
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\CheckSuitePreference\\Preferences\\AutoTriggerChecks',
));
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\CheckSuitePreference\Preferences', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\CheckSuitePreference\Preferences::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\CheckSuitePreference\Preferences(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\CheckSuitePreference\Preferences', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CheckSuitePreference⚡️Preferences⚡️AutoTriggerChecks(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\CheckSuitePreference\Preferences\AutoTriggerChecks
    {
        $properties = []; 
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\CheckSuitePreference\Preferences\AutoTriggerChecks', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\CheckSuitePreference\Preferences\AutoTriggerChecks::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\CheckSuitePreference\Preferences\AutoTriggerChecks(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\CheckSuitePreference\Preferences\AutoTriggerChecks', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            ...
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\CheckSuitePreference' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CheckSuitePreference($object),
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\CheckSuitePreference\Preferences' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CheckSuitePreference⚡️Preferences($object),
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\CheckSuitePreference\Preferences\AutoTriggerChecks' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CheckSuitePreference⚡️Preferences⚡️AutoTriggerChecks($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CheckSuitePreference(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\CheckSuitePreference);
        $result = [];

        $preferences = $object->preferences;
        $preferences = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CheckSuitePreference⚡️Preferences($preferences);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CheckSuitePreference⚡️Preferences(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\CheckSuitePreference\Preferences);
        $result = [];
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\CheckSuitePreference\\Preferences\\AutoTriggerChecks',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CheckSuitePreference⚡️Preferences⚡️AutoTriggerChecks(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\CheckSuitePreference\Preferences\AutoTriggerChecks);
        $result = [];
