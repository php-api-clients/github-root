...
class New_ implements ObjectMapper
{
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            ...
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\Operation\Codespaces\PreFlightWithRepoForAuthenticatedUser\Response\Applicationjson\H200\Defaults' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Operation⚡️Codespaces⚡️PreFlightWithRepoForAuthenticatedUser⚡️Response⚡️Applicationjson⚡️H200⚡️Defaults($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Operation⚡️Codespaces⚡️PreFlightWithRepoForAuthenticatedUser⚡️Response⚡️Applicationjson⚡️H200⚡️Defaults(mixed $object): mixed
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\Operation\Codespaces\PreFlightWithRepoForAuthenticatedUser\Response\Applicationjson\H200\Defaults);
        $result = [];
