...
namespace ApiClients\Client\GitHubEnterpriseCloud\Hydrator\Operation\MarketplaceListing\Accounts;
...
class CbAccountIdRcb implements ObjectMapper
{
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️MarketplacePurchase(mixed $object): mixed
    {
        ...
        $marketplace_pending_change = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️MarketplacePurchase⚡️MarketplacePendingChange($marketplace_pending_change);
        ...
        $marketplace_purchase = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️MarketplacePurchase⚡️MarketplacePurchase($marketplace_purchase);
