...
namespace ApiClients\Client\GitHubEnterpriseCloud\Hydrator\Operation\Users\Username;
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Installation(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\Installation
    {
        ...
        try {
            ...
            if ($accountCaster1 === null) {
                $accountCaster1 = new \ApiClients\Client\GitHubEnterpriseCloud\Attribute\CastUnionToType\Schema\Installation\Account(...array (
));
            }
