...
class Feeds implements ObjectMapper
{
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\LinkWithType',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Feed(mixed $object): mixed
    {
        ...
        $links = $object->links;
        $links = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Feed⚡️Links($links);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Feed⚡️Links(mixed $object): mixed
    {
        ...
        $securityAdvisories = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️LinkWithType($securityAdvisories);
        ...
        $currentUser = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️LinkWithType($currentUser);
        ...
        $currentUserPublic = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️LinkWithType($currentUserPublic);
        ...
        $currentUserActor = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️LinkWithType($currentUserActor);
        ...
        $currentUserOrganization = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️LinkWithType($currentUserOrganization);
  ...
  0 => 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\LinkWithType',
        ...
        $repositoryDiscussions = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️LinkWithType($repositoryDiscussions);
        ...
        $repositoryDiscussionsCategory = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️LinkWithType($repositoryDiscussionsCategory);
