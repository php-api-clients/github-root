...
namespace ApiClients\Client\GitHubEnterpriseCloud\Router\List;
...
final class CodeScanning
{
    ...
    public function listAlertsForEnterpriseListing(array $params): iterable
    {
        ...
        unset($params['sort']);
        if (array_key_exists(Hydrator\Operation\Enterprises\Enterprise\CodeScanning\Alerts::class, $this->hydrator) === false) {
            $this->hydrator[Hydrator\Operation\Enterprises\Enterprise\CodeScanning\Alerts::class] = $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀CodeScanning🌀Alerts();
        }

        $arguments['page'] = 1;
        do {
            $operator = new Operator\CodeScanning\ListAlertsForEnterpriseListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrator[Hydrator\Operation\Enterprises\Enterprise\CodeScanning\Alerts::class]);
