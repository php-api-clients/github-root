                    ...
                    if ($pathChunks[3] === 'code-scanning') {
                        if ($pathChunks[4] === 'alerts') {
                            if ($call === 'LIST /enterprises/{enterprise}/code-scanning/alerts') {
                                ...
                                return $this->router[Router\List\CodeScanning::class]->ListAlertsForEnterpriseListing($params);
                            }
                        }
                    }
                }
