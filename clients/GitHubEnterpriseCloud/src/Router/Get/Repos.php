...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Operation\Repos\GetAllEnvironments\Response\Applicationjson\H200;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Operation\Repos\GetCodeFrequencyStats\Response\Applicationjson\H202;
...
final class Repos
{
    ...
    public function getPagesHealthCheck(array $params)
    {
        ...
        return $this->browser->request($request->getMethod(), (string) $request->getUri(), $request->withHeader('Authorization', $this->authentication->authHeader())->getHeaders(), (string) $request->getBody())->then(static function (ResponseInterface $response) use ($operation): PagesHealthCheck|EmptyObject {
            return $operation->createResponse($response);
        });
    }
    ...
    public function getCommitActivityStats(array $params)
    {
        ...
        return $this->browser->request($request->getMethod(), (string) $request->getUri(), $request->withHeader('Authorization', $this->authentication->authHeader())->getHeaders(), (string) $request->getBody())->then(static function (ResponseInterface $response) use ($operation): Observable|\ApiClients\Client\GitHubEnterpriseCloud\Schema\Operation\Repos\GetCommitActivityStats\Response\Applicationjson\H202 {
            return $operation->createResponse($response);
        });
    }
