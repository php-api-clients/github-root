...
final class AnnouncementBanners
{
    ...
    public function getAnnouncementBannerForEnterprise(array $params)
    {
        $arguments = [];
        ...
        $operation = new Operation\AnnouncementBanners\GetAnnouncementBannerForEnterprise($this->responseSchemaValidator, $this->hydrator[Hydrator\Operation\Enterprises\CbEnterpriseRcb\Announcement::class], $arguments['enterprise']);
