...
final class Scim
{
    ...
    public function deleteUserFromOrg(array $params)
    {
        ...
        $operation = new Operation\Scim\DeleteUserFromOrg($this->responseSchemaValidator, $this->hydrator[Hydrator\Operation\Scim\V2\Organizations\CbOrgRcb\Users\CbScimUserIdRcb::class], $arguments['org'], $arguments['scim_user_id']);
