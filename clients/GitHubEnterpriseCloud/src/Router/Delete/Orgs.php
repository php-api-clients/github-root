...
final class Orgs
{
    ...
    public function removeSamlSsoAuthorization(array $params)
    {
        $arguments = [];
        if (array_key_exists('org', $params) === false) {
            throw new InvalidArgumentException('Missing mandatory field: org');
        ...
        if (array_key_exists(Hydrator\Operation\Orgs\Org\CredentialAuthorizations\CredentialId::class, $this->hydrator) === false) {
            $this->hydrator[Hydrator\Operation\Orgs\Org\CredentialAuthorizations\CredentialId::class] = $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀CredentialAuthorizations🌀CredentialId();
        }

        $operator = new Operator\Orgs\RemoveSamlSsoAuthorization($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrator[Hydrator\Operation\Orgs\Org\CredentialAuthorizations\CredentialId::class]);

        return $operator->call($arguments['org'], $arguments['credential_id']);
    }

    public function deleteCustomRepoRole(array $params)
    {
        $arguments = [];
        if (array_key_exists('org', $params) === false) {
            throw new InvalidArgumentException('Missing mandatory field: org');
    ...
    public function deleteCustomRole(array $params)
    {
        $arguments = [];
        if (array_key_exists('org', $params) === false) {
            throw new InvalidArgumentException('Missing mandatory field: org');
        ...
        $arguments['role_id'] = $params['role_id'];
        unset($params['role_id']);
        $operator = new Operator\Orgs\DeleteCustomRole($this->browser, $this->authentication);
