...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Operation\Orgs\Delete\Response\Applicationjson\H202;
...
final class Orgs
{
    ...
    public function removeSamlSsoAuthorization(array $params)
    {
        ...
        $operation = new Operation\Orgs\RemoveSamlSsoAuthorization($this->responseSchemaValidator, $this->hydrator[Hydrator\Operation\Orgs\CbOrgRcb\CredentialDashAuthorizations\CbCredentialIdRcb::class], $arguments['org'], $arguments['credential_id']);
        $request   = $operation->createRequest($params);
    ...
    public function deleteCustomRepoRole(array $params)
    {
        ...
        $operation = new Operation\Orgs\DeleteCustomRepoRole($arguments['org'], $arguments['role_id']);
        $request   = $operation->createRequest($params);
    ...
    public function deleteCustomRole(array $params)
    {
        ...
        $arguments['role_id'] = $params['role_id'];
        unset($params['role_id']);
        $operation = new Operation\Orgs\DeleteCustomRole($arguments['org'], $arguments['role_id']);
        $request   = $operation->createRequest($params);
