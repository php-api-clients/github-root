...
final class Projects
{
    ...
    public function moveColumn(array $params): \ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Projects\MoveColumn\Response\ApplicationJson\Created\Application\Json|array
    {
        $matched   = true;
        $arguments = [];
        if (array_key_exists('column_id', $params) === false) {
