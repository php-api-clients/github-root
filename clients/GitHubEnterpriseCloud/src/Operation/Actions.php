...
final class Actions
{
    ...
    public function getActionsCacheUsageForEnterprise(string $enterprise): PromiseInterface
    {
    ...
    public function setActionsOidcCustomIssuerPolicyForEnterprise(string $enterprise, array $params): PromiseInterface
    {
    ...
    public function getGithubActionsDefaultWorkflowPermissionsEnterprise(string $enterprise): PromiseInterface
    {
    ...
    public function setGithubActionsDefaultWorkflowPermissionsEnterprise(string $enterprise, array $params): PromiseInterface
    {
    ...
    public function generateRunnerJitconfigForEnterprise(string $enterprise, array $params): PromiseInterface
    {
    ...
    public function listSelfHostedRunnerGroupsForOrg(string $org, string $visibleToRepository, int $perPage, int $page): PromiseInterface
    {
    ...
    public function listRepoAccessToSelfHostedRunnerGroupInOrg(string $org, int $runnerGroupId, int $page, int $perPage): PromiseInterface
    {
    ...
    public function setRepoAccessToSelfHostedRunnerGroupInOrg(string $org, int $runnerGroupId, array $params): PromiseInterface
    {
    ...
    public function addRepoAccessToSelfHostedRunnerGroupInOrg(string $org, int $runnerGroupId, int $repositoryId): PromiseInterface
    {
    ...
    public function removeRepoAccessToSelfHostedRunnerGroupInOrg(string $org, int $runnerGroupId, int $repositoryId): PromiseInterface
    {
    ...
    public function listSelfHostedRunnersInGroupForOrg(string $org, int $runnerGroupId, int $perPage, int $page): PromiseInterface
    {
    ...
    public function setSelfHostedRunnersInGroupForOrg(string $org, int $runnerGroupId, array $params): PromiseInterface
    {
    ...
    public function removeSelfHostedRunnerFromGroupForOrg(string $org, int $runnerGroupId, int $runnerId): PromiseInterface
    {
