...
final class Actions
{
    ...
    public function setActionsOidcCustomIssuerPolicyForEnterprise(string $enterprise, array $params): ResponseInterface
    {
        if (array_key_exists(Operator\Actions\SetActionsOidcCustomIssuerPolicyForEnterprise::class, $this->operator) === false) {
            $this->operator[Operator\Actions\SetActionsOidcCustomIssuerPolicyForEnterprise::class] = new Operator\Actions\SetActionsOidcCustomIssuerPolicyForEnterprise($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀Actions🌀Oidc🌀Customization🌀Issuer());
        }

        return $this->operator[Operator\Actions\SetActionsOidcCustomIssuerPolicyForEnterprise::class]->call($enterprise, $params);
    }

    public function getGithubActionsDefaultWorkflowPermissionsEnterprise(string $enterprise): Schema\ActionsGetDefaultWorkflowPermissions
    {
        if (array_key_exists(Operator\Actions\GetGithubActionsDefaultWorkflowPermissionsEnterprise::class, $this->operator) === false) {
            $this->operator[Operator\Actions\GetGithubActionsDefaultWorkflowPermissionsEnterprise::class] = new Operator\Actions\GetGithubActionsDefaultWorkflowPermissionsEnterprise($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀Actions🌀Permissions🌀Workflow());
        }

        return $this->operator[Operator\Actions\GetGithubActionsDefaultWorkflowPermissionsEnterprise::class]->call($enterprise);
    }

    public function setGithubActionsDefaultWorkflowPermissionsEnterprise(string $enterprise, array $params): ResponseInterface
    {
        if (array_key_exists(Operator\Actions\SetGithubActionsDefaultWorkflowPermissionsEnterprise::class, $this->operator) === false) {
            $this->operator[Operator\Actions\SetGithubActionsDefaultWorkflowPermissionsEnterprise::class] = new Operator\Actions\SetGithubActionsDefaultWorkflowPermissionsEnterprise($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀Actions🌀Permissions🌀Workflow());
        }

        return $this->operator[Operator\Actions\SetGithubActionsDefaultWorkflowPermissionsEnterprise::class]->call($enterprise, $params);
    }

    public function generateRunnerJitconfigForEnterprise(string $enterprise, array $params): Schema\Operations\Actions\GenerateRunnerJitconfigForEnterprise\Response\ApplicationJson\Created
    {
        if (array_key_exists(Operator\Actions\GenerateRunnerJitconfigForEnterprise::class, $this->operator) === false) {
            $this->operator[Operator\Actions\GenerateRunnerJitconfigForEnterprise::class] = new Operator\Actions\GenerateRunnerJitconfigForEnterprise($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀Actions🌀Runners🌀GenerateJitconfig());
        }

        return $this->operator[Operator\Actions\GenerateRunnerJitconfigForEnterprise::class]->call($enterprise, $params);
    }
    ...
    public function listSelfHostedRunnerGroupsForOrg(string $org, string $visibleToRepository, int $perPage, int $page): Schema\Operations\Actions\ListSelfHostedRunnerGroupsForOrg\Response\ApplicationJson\Ok
    {
        ...
        return $this->operator[Operator\Actions\ListSelfHostedRunnerGroupsForOrg::class]->call($org, $visibleToRepository, $perPage, $page);
    }
    ...
    public function generateRunnerJitconfigForOrg(string $org, array $params): Schema\Operations\Actions\GenerateRunnerJitconfigForEnterprise\Response\ApplicationJson\Created
    {
    ...
    public function listOrgVariables(string $org, int $perPage, int $page): Schema\Operations\Actions\ListOrgVariables\Response\ApplicationJson\Ok
    {
    ...
    public function createOrgVariable(string $org, array $params): Schema\EmptyObject
    {
    ...
    public function getOrgVariable(string $org, string $name): Schema\OrganizationActionsVariable
    {
    ...
    public function deleteOrgVariable(string $org, string $name): ResponseInterface
    {
    ...
    public function updateOrgVariable(string $org, string $name, array $params): ResponseInterface
    {
    ...
    public function listSelectedReposForOrgVariable(string $org, string $name, int $page, int $perPage): Schema\Operations\Actions\ListSelectedReposForOrgVariable\Response\ApplicationJson\Ok
    {
    ...
    public function setSelectedReposForOrgVariable(string $org, string $name, array $params): ResponseInterface
    {
    ...
    public function addSelectedRepoToOrgVariable(string $org, string $name, int $repositoryId): ResponseInterface
    {
    ...
    public function removeSelectedRepoFromOrgVariable(string $org, string $name, int $repositoryId): ResponseInterface
    {
    ...
    public function listArtifactsForRepo(string $owner, string $repo, string $name, int $perPage, int $page): Schema\Operations\Actions\ListArtifactsForRepo\Response\ApplicationJson\Ok
    {
    ...
    public function getActionsCacheList(string $owner, string $repo, string $ref, string $key, int $perPage, int $page, string $sort, string $direction): Schema\ActionsCacheList
    {
    ...
    public function deleteActionsCacheByKey(string $owner, string $repo, string $key, string $ref): Schema\ActionsCacheList
    {
    ...
    public function deleteActionsCacheById(string $owner, string $repo, int $cacheId): ResponseInterface
    {
    ...
    public function getCustomOidcSubClaimForRepo(string $owner, string $repo): Schema\OidcCustomSubRepo
    {
    ...
    public function setCustomOidcSubClaimForRepo(string $owner, string $repo, array $params): Schema\EmptyObject
    {
    ...
    public function listRepoOrganizationVariables(string $owner, string $repo, int $perPage, int $page): Schema\Operations\Actions\ListRepoOrganizationVariables\Response\ApplicationJson\Ok
    {
    ...
    public function getGithubActionsDefaultWorkflowPermissionsRepository(string $owner, string $repo): Schema\ActionsGetDefaultWorkflowPermissions
    {
    ...
    public function setGithubActionsDefaultWorkflowPermissionsRepository(string $owner, string $repo, array $params): ResponseInterface
    {
    ...
    public function generateRunnerJitconfigForRepo(string $owner, string $repo, array $params): Schema\Operations\Actions\GenerateRunnerJitconfigForEnterprise\Response\ApplicationJson\Created
    {
    ...
    public function approveWorkflowRun(string $owner, string $repo, int $runId): Schema\EmptyObject
    {
    ...
    public function reviewCustomGatesForRun(string $owner, string $repo, int $runId, array $params): ResponseInterface
    {
    ...
    public function listRepoVariables(string $owner, string $repo, int $perPage, int $page): Schema\Operations\Actions\ListRepoVariables\Response\ApplicationJson\Ok
    {
    ...
    public function createRepoVariable(string $owner, string $repo, array $params): Schema\EmptyObject
    {
    ...
    public function getRepoVariable(string $owner, string $repo, string $name): Schema\ActionsVariable
    {
    ...
    public function deleteRepoVariable(string $owner, string $repo, string $name): ResponseInterface
    {
    ...
    public function updateRepoVariable(string $owner, string $repo, string $name, array $params): ResponseInterface
    {
    ...
    public function listEnvironmentVariables(int $repositoryId, string $environmentName, int $perPage, int $page): Schema\Operations\Actions\ListEnvironmentVariables\Response\ApplicationJson\Ok
    {
    ...
    public function createEnvironmentVariable(int $repositoryId, string $environmentName, array $params): Schema\EmptyObject
    {
    ...
    public function getEnvironmentVariable(int $repositoryId, string $environmentName, string $name): Schema\ActionsVariable
    {
    ...
    public function deleteEnvironmentVariable(int $repositoryId, string $name, string $environmentName): ResponseInterface
    {
    ...
    public function updateEnvironmentVariable(int $repositoryId, string $name, string $environmentName, array $params): ResponseInterface
    {
