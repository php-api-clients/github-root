...
namespace ApiClients\Client\GitHubEnterpriseCloud\Operation\Emojis;
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return $this->hydrator->hydrateObject('Schema\\Operation\\Emojis\\Get\\Response\\Applicationjson\\H200', $body);
                }
                break;
        }
