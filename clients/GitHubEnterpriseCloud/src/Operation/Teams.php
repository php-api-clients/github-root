...
final class Teams
{
    ...
    public function listIdpGroupsForOrg(string $org, string $page, string $q, int $perPage): PromiseInterface
    {
        if (array_key_exists(Operator\Teams\ListIdpGroupsForOrg::class, $this->operator) === false) {
            $this->operator[Operator\Teams\ListIdpGroupsForOrg::class] = new Operator\Teams\ListIdpGroupsForOrg($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀TeamSync🌀Groups());
        }

        return $this->operator[Operator\Teams\ListIdpGroupsForOrg::class]->call($org, $page, $q, $perPage);
    }
    ...
    public function listLinkedExternalIdpGroupsToTeamForOrg(string $org, string $teamSlug): PromiseInterface
    {
        if (array_key_exists(Operator\Teams\ListLinkedExternalIdpGroupsToTeamForOrg::class, $this->operator) === false) {
            $this->operator[Operator\Teams\ListLinkedExternalIdpGroupsToTeamForOrg::class] = new Operator\Teams\ListLinkedExternalIdpGroupsToTeamForOrg($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Teams🌀TeamSlug🌀ExternalGroups());
        }

        return $this->operator[Operator\Teams\ListLinkedExternalIdpGroupsToTeamForOrg::class]->call($org, $teamSlug);
    }
    ...
    public function listPendingInvitationsInOrg(string $org, string $teamSlug, int $perPage, int $page): PromiseInterface
    {
    ...
    public function listIdpGroupsInOrg(string $org, string $teamSlug): PromiseInterface
    {
        if (array_key_exists(Operator\Teams\ListIdpGroupsInOrg::class, $this->operator) === false) {
            $this->operator[Operator\Teams\ListIdpGroupsInOrg::class] = new Operator\Teams\ListIdpGroupsInOrg($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Teams🌀TeamSlug🌀TeamSync🌀GroupMappings());
        }

        return $this->operator[Operator\Teams\ListIdpGroupsInOrg::class]->call($org, $teamSlug);
    }

    public function createOrUpdateIdpGroupConnectionsInOrg(string $org, string $teamSlug, array $params): PromiseInterface
    {
        if (array_key_exists(Operator\Teams\CreateOrUpdateIdpGroupConnectionsInOrg::class, $this->operator) === false) {
            $this->operator[Operator\Teams\CreateOrUpdateIdpGroupConnectionsInOrg::class] = new Operator\Teams\CreateOrUpdateIdpGroupConnectionsInOrg($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Teams🌀TeamSlug🌀TeamSync🌀GroupMappings());
        }

        return $this->operator[Operator\Teams\CreateOrUpdateIdpGroupConnectionsInOrg::class]->call($org, $teamSlug, $params);
    }
    ...
    public function listPendingInvitationsLegacy(int $teamId, int $perPage, int $page): PromiseInterface
    {
    ...
    public function listIdpGroupsForLegacy(int $teamId): PromiseInterface
    {
        if (array_key_exists(Operator\Teams\ListIdpGroupsForLegacy::class, $this->operator) === false) {
            $this->operator[Operator\Teams\ListIdpGroupsForLegacy::class] = new Operator\Teams\ListIdpGroupsForLegacy($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Teams🌀TeamId🌀TeamSync🌀GroupMappings());
        }

        return $this->operator[Operator\Teams\ListIdpGroupsForLegacy::class]->call($teamId);
    }

    public function createOrUpdateIdpGroupConnectionsLegacy(int $teamId, array $params): PromiseInterface
    {
        if (array_key_exists(Operator\Teams\CreateOrUpdateIdpGroupConnectionsLegacy::class, $this->operator) === false) {
            $this->operator[Operator\Teams\CreateOrUpdateIdpGroupConnectionsLegacy::class] = new Operator\Teams\CreateOrUpdateIdpGroupConnectionsLegacy($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Teams🌀TeamId🌀TeamSync🌀GroupMappings());
        }

        return $this->operator[Operator\Teams\CreateOrUpdateIdpGroupConnectionsLegacy::class]->call($teamId, $params);
    }
