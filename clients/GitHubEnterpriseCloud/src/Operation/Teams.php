...
final class Teams
{
    ...
    public function listIdpGroupsForOrg(string $org, string $page, string $q, int $perPage): GroupMapping
    {
    ...
    /** @return */
    public function listLinkedExternalIdpGroupsToTeamForOrg(string $org, string $teamSlug): ExternalGroups
    {
    ...
    /** @return */
    public function listIdpGroupsInOrg(string $org, string $teamSlug): GroupMapping
    {
        return $this->operators->teams👷ListIdpGroupsInOrg()->call($org, $teamSlug);
    }

    /** @return */
    public function createOrUpdateIdpGroupConnectionsInOrg(string $org, string $teamSlug, array $params): GroupMapping
    {
    ...
    /** @return */
    public function listIdpGroupsForLegacy(int $teamId): GroupMapping
    {
        return $this->operators->teams👷ListIdpGroupsForLegacy()->call($teamId);
    }

    /** @return */
    public function createOrUpdateIdpGroupConnectionsLegacy(int $teamId, array $params): GroupMapping
    {
