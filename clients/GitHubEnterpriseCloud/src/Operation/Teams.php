...
final class Teams
{
    ...
    public function listIdpGroupsForOrg(string $org, string $page, string $q, int $perPage): Schema\GroupMapping
    {
    ...
    public function listLinkedExternalIdpGroupsToTeamForOrg(string $org, string $teamSlug): Schema\ExternalGroups
    {
    ...
    public function listIdpGroupsInOrg(string $org, string $teamSlug): Schema\GroupMapping
    {
    ...
    public function createOrUpdateIdpGroupConnectionsInOrg(string $org, string $teamSlug, array $params): Schema\GroupMapping
    {
    ...
    public function listIdpGroupsForLegacy(int $teamId): Schema\GroupMapping
    {
    ...
    public function createOrUpdateIdpGroupConnectionsLegacy(int $teamId, array $params): Schema\GroupMapping
    {
