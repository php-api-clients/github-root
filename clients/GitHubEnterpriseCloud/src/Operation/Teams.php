...
final class Teams
{
    ...
    /** @return */
    public function listIdpGroupsForOrg(string $org, string $page, string $q, int $perPage): GroupMapping|array
    {
        return $this->operators->teams👷ListIdpGroupsForOrg()->call($org, $page, $q, $perPage);
    }
    ...
    /** @return */
    public function listLinkedExternalIdpGroupsToTeamForOrg(string $org, string $teamSlug): ExternalGroups|array
    {
        return $this->operators->teams👷ListLinkedExternalIdpGroupsToTeamForOrg()->call($org, $teamSlug);
    }
    ...
    /** @return */
    public function listIdpGroupsInOrg(string $org, string $teamSlug): GroupMapping|array
    {
        return $this->operators->teams👷ListIdpGroupsInOrg()->call($org, $teamSlug);
    }

    /** @return */
    public function createOrUpdateIdpGroupConnectionsInOrg(string $org, string $teamSlug, array $params): GroupMapping|array
    {
        return $this->operators->teams👷CreateOrUpdateIdpGroupConnectionsInOrg()->call($org, $teamSlug, $params);
    }
    ...
    /** @return */
    public function listIdpGroupsForLegacy(int $teamId): GroupMapping|array
    {
        return $this->operators->teams👷ListIdpGroupsForLegacy()->call($teamId);
    }

    /** @return */
    public function createOrUpdateIdpGroupConnectionsLegacy(int $teamId, array $params): GroupMapping|array
    {
        return $this->operators->teams👷CreateOrUpdateIdpGroupConnectionsLegacy()->call($teamId, $params);
    }
