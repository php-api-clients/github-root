...
final class Orgs
{
    ...
    /** @return array{code:int} */
    public function removeSamlSsoAuthorization(string $org, int $credentialId): array
    {
        return $this->operators->orgs👷RemoveSamlSsoAuthorization()->call($org, $credentialId);
    }

    /** @return */
    public function listCustomRepoRoles(string $org): \ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Orgs\ListCustomRepoRoles\Response\ApplicationJson\Ok\Application\Json|array
    {
    ...
    /** @return array{code:int} */
    public function deleteCustomRepoRole(string $org, int $roleId): array
    {
    ...
    /** @return */
    public function createCustomRole(string $org, array $params): OrganizationCustomRepositoryRole|array
    {
        return $this->operators->orgs👷CreateCustomRole()->call($org, $params);
    }

    /** @return */
    public function getCustomRole(string $org, int $roleId): OrganizationCustomRepositoryRole|array
    {
        return $this->operators->orgs👷GetCustomRole()->call($org, $roleId);
    }

    /** @return array{code:int} */
    public function deleteCustomRole(string $org, int $roleId): array
    {
        return $this->operators->orgs👷DeleteCustomRole()->call($org, $roleId);
    }

    /** @return */
    public function updateCustomRole(string $org, int $roleId, array $params): OrganizationCustomRepositoryRole|array
    {
    ...
    public function redeliverWebhookDelivery(string $org, int $hookId, int $deliveryId): \ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Orgs\RedeliverWebhookDelivery\Response\ApplicationJson\Accepted\Application\Json|array
    {
    ...
    /** @return */
    public function listAppInstallations(string $org, int $perPage, int $page): \ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Orgs\ListAppInstallations\Response\ApplicationJson\Ok|array
    {
    ...
    public function convertMemberToOutsideCollaborator(string $org, string $username, array $params): \ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Orgs\ConvertMemberToOutsideCollaborator\Response\ApplicationJson\Accepted\Application\Json|array
    {
    ...
    /** @return */
    public function reviewPatGrantRequestsInBulk(string $org, array $params): \ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Orgs\ReviewPatGrantRequestsInBulk\Response\ApplicationJson\Accepted\Application\Json|array
    {
    ...
    /** @return */
    public function updatePatAccesses(string $org, array $params): \ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Orgs\UpdatePatAccesses\Response\ApplicationJson\Accepted\Application\Json|array
    {
