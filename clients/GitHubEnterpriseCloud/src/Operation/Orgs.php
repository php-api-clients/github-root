...
final class Orgs
{
    ...
    public function listCustomRoles(string $organizationId): Schema\Operations\Orgs\ListCustomRoles\Response\ApplicationJson\Ok
    {
    ...
    public function delete(string $org): Schema\Operations\Orgs\Delete\Response\ApplicationJson\Accepted
    {
    ...
    public function getAuditLog(string $org, string $phrase, string $include, string $after, string $before, string $order, int $perPage): Schema\AuditLogEvent
    {
        ...
        return $this->operator[Operator\Orgs\GetAuditLog::class]->call($org, $phrase, $include, $after, $before, $order, $perPage);
    }

    public function listBlockedUsers(string $org, int $perPage, int $page): Schema\SimpleUser
    {
    ...
    public function blockUser(string $org, string $username): ResponseInterface
    {
    ...
    public function unblockUser(string $org, string $username): ResponseInterface
    {
    ...
    public function listSamlSsoAuthorizations(string $org, int $page, string $login, int $perPage): Schema\CredentialAuthorization
    {
        if (array_key_exists(Operator\Orgs\ListSamlSsoAuthorizations::class, $this->operator) === false) {
            $this->operator[Operator\Orgs\ListSamlSsoAuthorizations::class] = new Operator\Orgs\ListSamlSsoAuthorizations($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀CredentialAuthorizations());
        }

        return $this->operator[Operator\Orgs\ListSamlSsoAuthorizations::class]->call($org, $page, $login, $perPage);
    }

    public function listSamlSsoAuthorizationsListing(string $org, int $page, string $login, int $perPage): Schema\CredentialAuthorization
    {
        if (array_key_exists(Operator\Orgs\ListSamlSsoAuthorizationsListing::class, $this->operator) === false) {
            $this->operator[Operator\Orgs\ListSamlSsoAuthorizationsListing::class] = new Operator\Orgs\ListSamlSsoAuthorizationsListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀CredentialAuthorizations());
        }

        return $this->operator[Operator\Orgs\ListSamlSsoAuthorizationsListing::class]->call($org, $page, $login, $perPage);
    }

    public function removeSamlSsoAuthorization(string $org, int $credentialId): ResponseInterface
    {
        if (array_key_exists(Operator\Orgs\RemoveSamlSsoAuthorization::class, $this->operator) === false) {
            $this->operator[Operator\Orgs\RemoveSamlSsoAuthorization::class] = new Operator\Orgs\RemoveSamlSsoAuthorization($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀CredentialAuthorizations🌀CredentialId());
        }

        return $this->operator[Operator\Orgs\RemoveSamlSsoAuthorization::class]->call($org, $credentialId);
    }

    public function listCustomRepoRoles(string $org): Schema\Operations\Orgs\ListCustomRepoRoles\Response\ApplicationJson\Ok
    {
    ...
    public function createCustomRepoRole(string $org, array $params): Schema\OrganizationCustomRepositoryRole
    {
    ...
    public function getCustomRepoRole(string $org, int $roleId): Schema\OrganizationCustomRepositoryRole
    {
    ...
    public function deleteCustomRepoRole(string $org, int $roleId): ResponseInterface
    {
    ...
    public function updateCustomRepoRole(string $org, int $roleId, array $params): Schema\OrganizationCustomRepositoryRole
    {
    ...
    public function createCustomRole(string $org, array $params): Schema\OrganizationCustomRepositoryRole
    {
        if (array_key_exists(Operator\Orgs\CreateCustomRole::class, $this->operator) === false) {
            $this->operator[Operator\Orgs\CreateCustomRole::class] = new Operator\Orgs\CreateCustomRole($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀CustomRoles());
        }

        return $this->operator[Operator\Orgs\CreateCustomRole::class]->call($org, $params);
    }

    public function getCustomRole(string $org, int $roleId): Schema\OrganizationCustomRepositoryRole
    {
        if (array_key_exists(Operator\Orgs\GetCustomRole::class, $this->operator) === false) {
            $this->operator[Operator\Orgs\GetCustomRole::class] = new Operator\Orgs\GetCustomRole($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀CustomRoles🌀RoleId());
        }

        return $this->operator[Operator\Orgs\GetCustomRole::class]->call($org, $roleId);
    }

    public function deleteCustomRole(string $org, int $roleId): ResponseInterface
    {
        if (array_key_exists(Operator\Orgs\DeleteCustomRole::class, $this->operator) === false) {
            $this->operator[Operator\Orgs\DeleteCustomRole::class] = new Operator\Orgs\DeleteCustomRole($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀CustomRoles🌀RoleId());
        }

        return $this->operator[Operator\Orgs\DeleteCustomRole::class]->call($org, $roleId);
    }

    public function updateCustomRole(string $org, int $roleId, array $params): Schema\OrganizationCustomRepositoryRole
    {
        if (array_key_exists(Operator\Orgs\UpdateCustomRole::class, $this->operator) === false) {
            $this->operator[Operator\Orgs\UpdateCustomRole::class] = new Operator\Orgs\UpdateCustomRole($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀CustomRoles🌀RoleId());
        }

        return $this->operator[Operator\Orgs\UpdateCustomRole::class]->call($org, $roleId, $params);
    }

    public function listFailedInvitations(string $org, int $perPage, int $page): Schema\OrganizationInvitation
    {
    ...
    public function listFineGrainedPermissions(string $org): Schema\RepositoryFineGrainedPermission
    {
        if (array_key_exists(Operator\Orgs\ListFineGrainedPermissions::class, $this->operator) === false) {
            $this->operator[Operator\Orgs\ListFineGrainedPermissions::class] = new Operator\Orgs\ListFineGrainedPermissions($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀FineGrainedPermissions());
        }

        return $this->operator[Operator\Orgs\ListFineGrainedPermissions::class]->call($org);
    }
    ...
    public function listPendingInvitations(string $org, int $perPage, int $page, string $role, string $invitationSource): Schema\OrganizationInvitation
    {
    ...
    public function cancelInvitation(string $org, int $invitationId): ResponseInterface
    {
    ...
    public function listInvitationTeams(string $org, int $invitationId, int $perPage, int $page): Schema\Team
    {
    ...
    public function listPatGrantRequests(string $org, array $owner, string $repository, string $permission, string $lastUsedBefore, string $lastUsedAfter, int $perPage, int $page, string $sort, string $direction): Schema\OrganizationProgrammaticAccessGrantRequest
    {
    ...
    public function reviewPatGrantRequest(string $org, int $patRequestId, array $params): ResponseInterface
    {
    ...
    public function listPatGrantRequestRepositories(string $org, int $patRequestId, int $perPage, int $page): Schema\MinimalRepository
    {
    ...
    public function updatePatAccess(string $org, int $patId, array $params): ResponseInterface
    {
    ...
    public function listPatGrantRepositories(string $org, int $patId, int $perPage, int $page): Schema\MinimalRepository
    {
    ...
    public function setPublicMembershipForAuthenticatedUser(string $org, string $username): ResponseInterface
    {
    ...
    public function removePublicMembershipForAuthenticatedUser(string $org, string $username): ResponseInterface
    {
    ...
    public function listRepoFineGrainedPermissions(string $org): Schema\RepositoryFineGrainedPermission
    {
    ...
    public function listSecurityManagerTeams(string $org): Schema\TeamSimple
    {
    ...
    public function addSecurityManagerTeam(string $org, string $teamSlug): ResponseInterface
    {
    ...
    public function removeSecurityManagerTeam(string $org, string $teamSlug): ResponseInterface
    {
    ...
    public function enableOrDisableSecurityProductOnAllOrgRepos(string $org, string $securityProduct, string $enablement, array $params): ResponseInterface
    {
