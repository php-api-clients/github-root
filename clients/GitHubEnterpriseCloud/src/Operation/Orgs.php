...
final class Orgs
{
    ...
    public function getAuditLog(string $org, string $phrase, string $include, string $after, string $before, string $order, int $perPage): PromiseInterface
    {
    ...
    public function listSamlSsoAuthorizations(string $org, int $page, string $login, int $perPage): PromiseInterface
    {
    ...
    public function removeSamlSsoAuthorization(string $org, int $credentialId): PromiseInterface
    {
    ...
    public function createCustomRole(string $org, array $params): PromiseInterface
    {
    ...
    public function getCustomRole(string $org, int $roleId): PromiseInterface
    {
    ...
    public function deleteCustomRole(string $org, int $roleId): PromiseInterface
    {
    ...
    public function updateCustomRole(string $org, int $roleId, array $params): PromiseInterface
    {
    ...
    public function listFineGrainedPermissions(string $org): PromiseInterface
    {
