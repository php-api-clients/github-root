...
final class Migrations
{
    ...
    public function getImportStatus(string $owner, string $repo): PromiseInterface
    {
    ...
    public function startImport(string $owner, string $repo, array $params): PromiseInterface
    {
    ...
    public function cancelImport(string $owner, string $repo): PromiseInterface
    {
    ...
    public function updateImport(string $owner, string $repo, array $params): PromiseInterface
    {
    ...
    public function getCommitAuthors(string $owner, string $repo, int $since): PromiseInterface
    {
    ...
    public function mapCommitAuthor(string $owner, string $repo, int $authorId, array $params): PromiseInterface
    {
    ...
    public function getLargeFiles(string $owner, string $repo): PromiseInterface
    {
    ...
    public function setLfsPreference(string $owner, string $repo, array $params): PromiseInterface
    {
    ...
    public function getStatusForAuthenticatedUser(int $migrationId, array $exclude): PromiseInterface
    {
    ...
    public function deleteArchiveForAuthenticatedUser(int $migrationId): PromiseInterface
    {
    ...
    public function unlockRepoForAuthenticatedUser(int $migrationId, string $repoName): PromiseInterface
    {
