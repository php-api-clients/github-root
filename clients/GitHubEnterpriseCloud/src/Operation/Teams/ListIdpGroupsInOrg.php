...
final class ListIdpGroupsInOrg
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Orgs\Org\Teams\TeamSlug\TeamSync\GroupMappings $hydrator, string $org, string $teamSlug)
    {
        $this->org                     = $org;
