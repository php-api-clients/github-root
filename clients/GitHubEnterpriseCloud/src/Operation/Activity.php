...
final class Activity
{
    ...
    public function markRepoNotificationsAsRead(string $owner, string $repo, array $params): \ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Activity\MarkRepoNotificationsAsRead\Response\ApplicationJson\Accepted|array
    {
