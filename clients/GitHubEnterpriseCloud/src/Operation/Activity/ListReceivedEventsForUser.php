...
final class ListReceivedEventsForUser
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Users\CbUsernameRcb\ReceivedEvents $hydrator, string $username, int $perPage = 30, int $page = 1)
    {
