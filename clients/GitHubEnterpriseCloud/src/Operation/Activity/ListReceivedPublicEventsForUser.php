...
final class ListReceivedPublicEventsForUser
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Users\CbUsernameRcb\ReceivedEvents\Public_ $hydrator, string $username, int $perPage = 30, int $page = 1)
    {
