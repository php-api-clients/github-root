...
final class SetCustomLabelsForSelfHostedRunnerForEnterprise
{
    ...
    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Hydrator\Operation\Enterprises\CbEnterpriseRcb\Actions\Runners\CbRunnerIdRcb\Labels $hydrator, string $enterprise, int $runnerId)
    {
