...
final class GetConsumedLicenses
{
    ...
    private readonly Hydrator\Operation\Enterprises\Enterprise\ConsumedLicenses $hydrator;

    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Enterprises\Enterprise\ConsumedLicenses $hydrator, string $enterprise, int $perPage = 30, int $page = 1)
    {
