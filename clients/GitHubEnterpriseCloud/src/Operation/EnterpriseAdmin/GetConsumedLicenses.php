...
final class GetConsumedLicenses
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Enterprises\CbEnterpriseRcb\ConsumedLicenses $hydrator, string $enterprise, int $per_page = 30, int $page = 1)
    {
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return $this->hydrator->hydrateObject('Schema\\GetConsumedLicenses', $body);
                }
                break;
        }
