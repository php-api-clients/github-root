...
final class ListOrgAccessToSelfHostedRunnerGroupInEnterpriseListing
{
    public const OPERATION_ID = 'enterprise-admin/list-org-access-to-self-hosted-runner-group-in-enterprise';
    public const OPERATION_MATCH = 'LIST /enterprises/{enterprise}/actions/runner-groups/{runner_group_id}/organizations';
