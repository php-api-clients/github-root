...
final class GetGlobalAdvisory
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Advisories\GhsaId $hydrator, string $ghsaId)
    {
        $this->ghsaId = $ghsaId;
    }
