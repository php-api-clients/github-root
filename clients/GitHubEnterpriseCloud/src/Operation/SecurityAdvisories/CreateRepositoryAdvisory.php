...
final class CreateRepositoryAdvisory
{
    ...
    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\SecurityAdvisories $hydrator, string $owner, string $repo)
    {
