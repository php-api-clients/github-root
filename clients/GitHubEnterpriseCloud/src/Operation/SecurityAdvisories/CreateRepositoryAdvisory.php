...
final class CreateRepositoryAdvisory
{
    ...
    private readonly Hydrator\Operation\Repos\Owner\Repo\SecurityAdvisories $hydrator;

    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\Owner\Repo\SecurityAdvisories $hydrator, string $owner, string $repo)
    {
    ...
    {
        $this->requestSchemaValidator->validate($data, Reader::readFromJson(Schema\RepositoryAdvisoryCreate::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));
