...
final class UpdateRepositoryAdvisory
{
    ...
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Repos\Owner\Repo\SecurityAdvisories\GhsaId $hydrator, string $owner, string $repo, string $ghsaId)
    {
        $this->owner  = $owner;
        $this->repo   = $repo;
        $this->ghsaId = $ghsaId;
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request(self::METHOD, str_replace(['{owner}', '{repo}', '{ghsa_id}'], [$this->owner, $this->repo, $this->ghsaId], self::PATH), ['Content-Type' => 'application/json'], json_encode($data));
    }
