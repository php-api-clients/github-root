...
final class Codespaces
{
    ...
    public function repoMachinesForAuthenticatedUser(string $owner, string $repo, string $location, string $clientIp): \ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Codespaces\RepoMachinesForAuthenticatedUser\Response\ApplicationJson\Ok|array
    {
