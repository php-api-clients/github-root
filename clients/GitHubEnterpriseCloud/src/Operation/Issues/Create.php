...
final class Create
{
    ...
    /**
     * @return Schema\Issue|Schema\BasicError|Schema\ValidationError|Schema\Operation\CodeScanning\ListAlertsForEnterprise\Response\Applicationjson\H503
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\Issue|Schema\BasicError|Schema\ValidationError|Schema\Operation\CodeScanning\ListAlertsForEnterprise\Response\Applicationjson\H503
    {
