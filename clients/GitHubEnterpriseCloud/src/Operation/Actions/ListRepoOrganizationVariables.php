...
final class ListRepoOrganizationVariables
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Actions\OrganizationVariables $hydrator, string $owner, string $repo, int $perPage = 10, int $page = 1)
    {
        $this->owner = $owner;
        $this->repo = $repo;
     ...
     */
    public function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\Operation\Actions\ListRepoOrganizationVariables\Response\Applicationjson\H200
    {
