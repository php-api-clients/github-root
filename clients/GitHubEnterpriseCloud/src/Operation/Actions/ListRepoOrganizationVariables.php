...
final class ListRepoOrganizationVariables
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Actions\OrganizationVariables $hydrator, string $owner, string $repo, int $per_page = 10, int $page = 1)
    {
        $this->owner = $owner;
        $this->repo = $repo;
