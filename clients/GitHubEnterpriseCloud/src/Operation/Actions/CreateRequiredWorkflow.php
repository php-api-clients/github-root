...
final class CreateRequiredWorkflow
{
    ...
    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Hydrator\Operation\Orgs\Org\Actions\RequiredWorkflows $hydrator, string $org)
    {
    ...
    {
        $this->requestSchemaValidator->validate($data, Reader::readFromJson(Schema\Actions\CreateRequiredWorkflow\Request\ApplicationJson::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));
