...
final class GetWorkflowAccessToRepository
{
    ...
    private readonly Hydrator\Operation\Repos\Owner\Repo\Actions\Permissions\Access $hydrator;

    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\Owner\Repo\Actions\Permissions\Access $hydrator, string $owner, string $repo)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
