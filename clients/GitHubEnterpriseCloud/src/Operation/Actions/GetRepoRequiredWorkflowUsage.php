...
final class GetRepoRequiredWorkflowUsage
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\CbOrgRcb\CbRepoRcb\Actions\RequiredWorkflows\CbRequiredWorkflowIdForRepoRcb\Timing $hydrator, string $org, string $repo, int $requiredWorkflowIdForRepo)
    {
        $this->org = $org;
        $this->repo = $repo;
