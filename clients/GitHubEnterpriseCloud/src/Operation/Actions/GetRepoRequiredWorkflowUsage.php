...
final class GetRepoRequiredWorkflowUsage
{
    ...
    /**
     * @return Schema\WorkflowUsage|Schema\BasicError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\WorkflowUsage|Schema\BasicError
    {
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return $this->hydrator->hydrateObject('Schema\\WorkflowUsage', $body);
                }
                break;
            /**Resource not found**/
            case 404:
