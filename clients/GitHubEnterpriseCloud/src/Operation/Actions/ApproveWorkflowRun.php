...
final class ApproveWorkflowRun
{
    ...
    private readonly Hydrator\Operation\Repos\Owner\Repo\Actions\Runs\RunId\Approve $hydrator;

    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\Owner\Repo\Actions\Runs\RunId\Approve $hydrator, string $owner, string $repo, int $runId)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
        $this->runId                   = $runId;
