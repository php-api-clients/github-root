...
final class ListRepoAccessToSelfHostedRunnerGroupInOrgListing
{
    public const OPERATION_ID = 'actions/list-repo-access-to-self-hosted-runner-group-in-org';
    public const OPERATION_MATCH = 'LIST /orgs/{org}/actions/runner-groups/{runner_group_id}/repositories';
