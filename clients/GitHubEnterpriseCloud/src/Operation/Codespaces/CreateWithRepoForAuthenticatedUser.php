...
final class CreateWithRepoForAuthenticatedUser
{
    ...
    /**
     * @return Schema\Codespace|Schema\BasicError|Schema\ScimError|Schema\Operation\CodeScanning\ListAlertsForEnterprise\Response\Applicationjson\H503
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\Codespace|Schema\BasicError|Schema\ScimError|Schema\Operation\CodeScanning\ListAlertsForEnterprise\Response\Applicationjson\H503
    {
