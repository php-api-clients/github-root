            ...
            case 503:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        throw $this->hydrator->hydrateObject(ErrorSchemas\Operation\CodeScanning\ListAlertsForEnterprise\Response\Applicationjson\H503::class, array('status' => 503, 'error' => $body));
                }
                break;
        }
