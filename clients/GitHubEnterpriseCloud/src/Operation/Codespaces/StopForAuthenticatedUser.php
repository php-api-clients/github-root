...
final class StopForAuthenticatedUser
{
    ...
    private readonly Hydrator\Operation\User\Codespaces\CodespaceName\Stop $hydrator;

    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\User\Codespaces\CodespaceName\Stop $hydrator, string $codespaceName)
    {
