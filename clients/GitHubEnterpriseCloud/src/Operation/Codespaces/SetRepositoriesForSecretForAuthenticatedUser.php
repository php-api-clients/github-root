...
final class SetRepositoriesForSecretForAuthenticatedUser
{
    ...
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\User\Codespaces\Secrets\SecretName\Repositories $hydrator, string $secretName)
    {
