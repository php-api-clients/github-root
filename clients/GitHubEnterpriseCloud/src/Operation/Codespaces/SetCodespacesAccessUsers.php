...
final class SetCodespacesAccessUsers
{
    ...
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Orgs\Org\Codespaces\Access\SelectedUsers $hydrator, string $org)
    {
        $this->org = $org;
    }
