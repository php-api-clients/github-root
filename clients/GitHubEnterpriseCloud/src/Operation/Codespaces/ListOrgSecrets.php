...
final class ListOrgSecrets
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Orgs\CbOrgRcb\Codespaces\Secrets $hydrator, string $org, int $per_page = 30, int $page = 1)
    {
        $this->org = $org;
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return $this->hydrator->hydrateObject('Schema\\Operation\\Codespaces\\ListOrgSecrets\\Response\\Applicationjson\\H200', $body);
                }
                break;
        }
