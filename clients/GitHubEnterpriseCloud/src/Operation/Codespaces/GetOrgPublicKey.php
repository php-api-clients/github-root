...
final class GetOrgPublicKey
{
    ...
    private readonly Hydrator\Operation\Orgs\Org\Codespaces\Secrets\PublicKey $hydrator;

    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Orgs\Org\Codespaces\Secrets\PublicKey $hydrator, string $org)
    {
        $this->org                     = $org;
