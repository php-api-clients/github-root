...
final class ListInRepositoryForAuthenticatedUserListing
{
    public const OPERATION_ID = 'codespaces/list-in-repository-for-authenticated-user';
    public const OPERATION_MATCH = 'LIST /repos/{owner}/{repo}/codespaces';
    ...
    private readonly Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Codespaces $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Codespaces $hydrator, string $owner, string $repo, int $per_page = 30, int $page = 1)
    {
        $this->owner = $owner;
        $this->repo = $repo;
