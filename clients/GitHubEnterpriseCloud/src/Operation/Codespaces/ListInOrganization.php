...
final class ListInOrganization
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Orgs\CbOrgRcb\Codespaces $hydrator, string $org, int $per_page = 30, int $page = 1)
    {
        $this->org = $org;
    ...
    /**
     * @return Schema\Operation\Codespaces\ListInOrganization\Response\Applicationjson\H200|Schema\BasicError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\Operation\Codespaces\ListInOrganization\Response\Applicationjson\H200|Schema\BasicError
    {
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return $this->hydrator->hydrateObject('Schema\\Operation\\Codespaces\\ListInOrganization\\Response\\Applicationjson\\H200', $body);
                }
                break;
            /**Resource not found**/
            case 500:
