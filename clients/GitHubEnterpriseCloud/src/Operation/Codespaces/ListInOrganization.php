...
final class ListInOrganization
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Orgs\CbOrgRcb\Codespaces $hydrator, string $org, int $perPage = 30, int $page = 1)
    {
        $this->org = $org;
     ...
     */
    public function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\Operation\Codespaces\ListInOrganization\Response\Applicationjson\H200
    {
