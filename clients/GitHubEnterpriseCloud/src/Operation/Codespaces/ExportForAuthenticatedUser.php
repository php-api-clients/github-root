...
final class ExportForAuthenticatedUser
{
    ...
    /**
     * @return Schema\CodespaceExportDetails|Schema\BasicError|Schema\ValidationError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\CodespaceExportDetails|Schema\BasicError|Schema\ValidationError
    {
            ...
            case 202:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return $this->hydrator->hydrateObject('Schema\\CodespaceExportDetails', $body);
                }
                break;
            /**Validation failed, or the endpoint has been spammed.**/
            case 500:
