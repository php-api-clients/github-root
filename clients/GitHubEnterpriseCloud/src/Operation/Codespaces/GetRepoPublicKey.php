...
final class GetRepoPublicKey
{
    ...
    private readonly Hydrator\Operation\Repos\Owner\Repo\Codespaces\Secrets\PublicKey $hydrator;

    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\Owner\Repo\Codespaces\Secrets\PublicKey $hydrator, string $owner, string $repo)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
