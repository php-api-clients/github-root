...
final class PreFlightWithRepoForAuthenticatedUser
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{owner}', '{repo}', '{ref}', '{client_ip}'), array($this->owner, $this->repo, $this->ref, $this->clientIp), self::PATH . '?ref={ref}&clientIp={client_ip}'));
    }
    /**
