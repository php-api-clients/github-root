...
final class SetCodespacesBillingUsers
{
    ...
    {
        $this->requestSchemaValidator->validate($data, Reader::readFromJson(Schema\Codespaces\SetCodespacesBillingUsers\Request\ApplicationJson::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));
