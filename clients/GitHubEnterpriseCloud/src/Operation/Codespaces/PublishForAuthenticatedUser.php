...
final class PublishForAuthenticatedUser
{
    ...
    private readonly Hydrator\Operation\User\Codespaces\CbCodespaceNameRcb\Publish $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $requestSchemaValidator, \League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\User\Codespaces\CbCodespaceNameRcb\Publish $hydrator, string $codespace_name)
    {
    ...
    /**
     * @return Schema\CodespaceWithFullRepository|Schema\BasicError|Schema\ValidationError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\CodespaceWithFullRepository|Schema\BasicError|Schema\ValidationError
    {
            ...
            case 201:
                switch ($contentType) {
                    case 'application/json':
                        $this->responseSchemaValidator->validate($body, \cebe\openapi\Reader::readFromJson(Schema\CodespaceWithFullRepository::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                        return $this->hydrator->hydrateObject('Schema\\CodespaceWithFullRepository', $body);
                }
                break;
            /**Validation failed, or the endpoint has been spammed.**/
            case 401:
