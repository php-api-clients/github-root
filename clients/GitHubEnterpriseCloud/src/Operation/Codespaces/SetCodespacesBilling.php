...
final class SetCodespacesBilling
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $requestSchemaValidator, \League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Orgs\CbOrgRcb\Codespaces\Billing $hydrator, string $org)
    {
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(Schema\Codespaces\SetCodespacesBilling\Request\Applicationjson::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));
