...
final class DeleteForAuthenticatedUser
{
    ...
    /**
     * @return Schema\AuditLogEvent\Config|Schema\BasicError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\AuditLogEvent\Config|Schema\BasicError
    {
