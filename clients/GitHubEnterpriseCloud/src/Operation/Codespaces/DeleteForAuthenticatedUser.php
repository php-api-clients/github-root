...
final class DeleteForAuthenticatedUser
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\User\Codespaces\CbCodespaceNameRcb $hydrator, string $codespaceName)
    {
    ...
    public function createResponse(ResponseInterface $response): Schema\Operation\Codespaces\DeleteForAuthenticatedUser\Response\Applicationjson\H202
    {
        ...
        switch ($contentType) {
            case 'application/json':
                ...
                switch ($code) {
                    ...
                    **/
                    case 202:
                        $this->responseSchemaValidator->validate($body, Reader::readFromJson(Schema\Operation\Codespaces\DeleteForAuthenticatedUser\Response\Applicationjson\H202::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
