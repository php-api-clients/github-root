...
final class ListRepoFineGrainedPermissions
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Orgs\CbOrgRcb\RepositoryFineGrainedPermissions $hydrator, string $org)
    {
        $this->org                     = $org;
