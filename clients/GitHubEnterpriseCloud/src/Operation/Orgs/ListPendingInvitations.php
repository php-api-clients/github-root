...
final class ListPendingInvitations
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{org}', '{per_page}', '{page}', '{role}', '{invitation_source}'), array($this->org, $this->perPage, $this->page, $this->role, $this->invitationSource), self::PATH . '?perPage={per_page}&page={page}&role={role}&invitationSource={invitation_source}'));
    }
    /**
