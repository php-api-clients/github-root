...
final class UpdateCustomRole
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $requestSchemaValidator, \League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Orgs\CbOrgRcb\CustomRoles\CbRoleIdRcb $hydrator, string $org, int $role_id)
    {
    ...
    /**
     * @return Schema\OrganizationCustomRepositoryRole|Schema\ValidationError|Schema\BasicError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\OrganizationCustomRepositoryRole|Schema\ValidationError|Schema\BasicError
    {
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return $this->hydrator->hydrateObject('Schema\\OrganizationCustomRepositoryRole', $body);
                }
                break;
            /**Resource not found**/
            case 422:
