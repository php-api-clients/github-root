...
final class ListInvitationTeams
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{org}', '{invitation_id}', '{per_page}', '{page}'), array($this->org, $this->invitationId, $this->perPage, $this->page), self::PATH . '?per_page={per_page}&page={page}'));
    }
    /**
