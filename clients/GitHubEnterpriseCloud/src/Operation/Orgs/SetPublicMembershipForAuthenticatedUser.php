...
final class SetPublicMembershipForAuthenticatedUser
{
    ...
    private readonly Hydrator\Operation\Orgs\Org\PublicMembers\Username $hydrator;

    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Orgs\Org\PublicMembers\Username $hydrator, string $org, string $username)
    {
        $this->org                     = $org;
