...
final class ListPatGrantRepositories
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{org}', '{pat_id}', '{per_page}', '{page}'), array($this->org, $this->patId, $this->perPage, $this->page), self::PATH . '?perPage={per_page}&page={page}'));
    }
    /**
