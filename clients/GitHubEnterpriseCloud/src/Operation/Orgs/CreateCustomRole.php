...
final class CreateCustomRole
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(Schema\OrganizationCustomRepositoryRoleCreateSchema::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));
