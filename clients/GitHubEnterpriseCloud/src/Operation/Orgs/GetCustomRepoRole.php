...
final class GetCustomRepoRole
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Orgs\CbOrgRcb\CustomDashRepositoryDashRoles\CbRoleIdRcb $hydrator, string $org, int $role_id)
    {
        $this->org = $org;
    ...
    /**
     * @return Schema\OrganizationCustomRepositoryRole|Schema\BasicError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\OrganizationCustomRepositoryRole|Schema\BasicError
    {
