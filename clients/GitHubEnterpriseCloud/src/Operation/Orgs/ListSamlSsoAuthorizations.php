...
final class ListSamlSsoAuthorizations
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{org}', '{page}', '{login}', '{per_page}'), array($this->org, $this->page, $this->login, $this->perPage), self::PATH . '?page={page}&login={login}&per_page={per_page}'));
    }
    /**
