...
final class ListSamlSsoAuthorizations
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Orgs\Org\CredentialAuthorizations $hydrator, string $org, int $page, string $login, int $perPage = 30)
    {
        $this->org     = $org;
        $this->page    = $page;
        $this->login   = $login;
