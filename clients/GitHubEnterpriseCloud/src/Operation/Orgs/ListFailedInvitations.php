...
final class ListFailedInvitations
{
    ...
    private readonly Hydrator\Operation\Orgs\Org\FailedInvitations $hydrator;

    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Orgs\Org\FailedInvitations $hydrator, string $org, int $perPage = 30, int $page = 1)
    {
        $this->org                     = $org;
