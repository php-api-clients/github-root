...
final class ListBlockedUsersListing
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Orgs\CbOrgRcb\Blocks $hydrator, string $org, int $per_page = 30, int $page = 1)
    {
        $this->org = $org;
