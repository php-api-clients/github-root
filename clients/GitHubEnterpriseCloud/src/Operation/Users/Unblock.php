...
final class Unblock
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\User\Blocks\Username $hydrator, string $username)
    {
