...
final class Unblock
{
    ...
    private readonly Hydrator\Operation\User\Blocks\Username $hydrator;

    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\User\Blocks\Username $hydrator, string $username)
    {
