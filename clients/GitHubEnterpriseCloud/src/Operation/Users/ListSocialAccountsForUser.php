...
final class ListSocialAccountsForUser
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Users\CbUsernameRcb\SocialAccounts $hydrator, string $username, int $perPage = 30, int $page = 1)
    {
