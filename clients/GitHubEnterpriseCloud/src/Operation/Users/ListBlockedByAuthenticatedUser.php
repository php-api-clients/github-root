...
final class ListBlockedByAuthenticatedUser
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\User\Blocks $hydrator, int $perPage = 30, int $page = 1)
    {
