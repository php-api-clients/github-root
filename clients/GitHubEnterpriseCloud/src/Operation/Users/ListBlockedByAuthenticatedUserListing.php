...
final class ListBlockedByAuthenticatedUserListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\User\Blocks $hydrator, int $perPage = 30, int $page = 1)
    {
