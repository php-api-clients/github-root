...
final class ListBlockedByAuthenticatedUserListing
{
    ...
    private readonly Hydrator\Operation\User\Blocks $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\User\Blocks $hydrator, int $per_page = 30, int $page = 1)
    {
