...
final class SetRestrictionsForRepo
{
    ...
    private readonly Hydrator\Operation\Repos\Owner\Repo\InteractionLimits $hydrator;

    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\Owner\Repo\InteractionLimits $hydrator, string $owner, string $repo)
    {
