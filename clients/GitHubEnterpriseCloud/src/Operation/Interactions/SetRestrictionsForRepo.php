...
final class SetRestrictionsForRepo
{
    ...
    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\InteractionLimits $hydrator, string $owner, string $repo)
    {
