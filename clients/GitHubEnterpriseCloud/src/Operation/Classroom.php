...
final class Classroom
{
    ...
    public function getAnAssignment(int $assignmentId): ClassroomAssignment|array
    {
    ...
    /** @return iterable<Schema\ClassroomAssignmentGrade> */
    ...
    /** @return Schema\Classroom */
    public function getAClassroom(int $classroomId): \ApiClients\Client\GitHubEnterpriseCloud\Schema\Classroom|array
    {
