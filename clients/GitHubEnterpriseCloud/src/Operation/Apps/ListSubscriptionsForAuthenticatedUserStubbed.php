...
final class ListSubscriptionsForAuthenticatedUserStubbed
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\User\MarketplacePurchases\Stubbed $hydrator, int $perPage = 30, int $page = 1)
    {
    ...
    /**
     * @return Observable<Schema\UserMarketplacePurchase>
     */
                    ...
                    **/
                    case 200:
                        foreach ($body as $bodyItem) {
                            $this->responseSchemaValidator->validate($bodyItem, Reader::readFromJson(Schema\UserMarketplacePurchase::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                        }
