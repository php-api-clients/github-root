...
final class ListPlansStubbed
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\MarketplaceListing\Stubbed\Plans $hydrator, int $perPage = 30, int $page = 1)
    {
                    ...
                    **/
                    case 200:
                        foreach ($body as $bodyItem) {
                            $this->responseSchemaValidator->validate($bodyItem, Reader::readFromJson(Schema\MarketplaceListingPlan::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                        }
