...
final class ListPlansListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\MarketplaceListing\Plans $hydrator, int $perPage = 30, int $page = 1)
    {
