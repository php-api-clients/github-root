...
final class SetLfsPreference
{
    ...
    private readonly Hydrator\Operation\Repos\Owner\Repo\Import\Lfs $hydrator;

    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\Owner\Repo\Import\Lfs $hydrator, string $owner, string $repo)
    {
