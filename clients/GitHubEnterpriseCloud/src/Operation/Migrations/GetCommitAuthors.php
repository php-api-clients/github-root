...
final class GetCommitAuthors
{
    ...
    /**
     * @return \Rx\Observable<Schema\PorterAuthor>
     */
                ...
                switch ($contentType) {
                    case 'application/json':
                        foreach ($body as $bodyItem) {
                            $this->responseSchemaValidator->validate($bodyItem, \cebe\openapi\Reader::readFromJson(Schema\PorterAuthor::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                        }
