...
final class GetLargeFiles
{
    ...
    private readonly Hydrator\Operation\Repos\Owner\Repo\Import\LargeFiles $hydrator;

    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\Owner\Repo\Import\LargeFiles $hydrator, string $owner, string $repo)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
