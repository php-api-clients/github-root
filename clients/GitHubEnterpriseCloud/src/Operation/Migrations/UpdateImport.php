...
final class UpdateImport
{
    ...
    private readonly Hydrator\Operation\Repos\Owner\Repo\Import $hydrator;

    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\Owner\Repo\Import $hydrator, string $owner, string $repo)
    {
