...
final class UpdateImport
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(Schema\Migrations\UpdateImport\Request\Applicationjson::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));
