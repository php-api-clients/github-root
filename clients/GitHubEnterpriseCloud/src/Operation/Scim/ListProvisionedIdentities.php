...
final class ListProvisionedIdentities
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Scim\V2\Organizations\CbOrgRcb\Users $hydrator, string $org, int $startIndex, int $count, string $filter)
    {
        $this->org                     = $org;
