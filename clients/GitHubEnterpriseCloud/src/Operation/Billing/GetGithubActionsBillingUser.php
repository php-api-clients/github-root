...
final class GetGithubActionsBillingUser
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Users\CbUsernameRcb\Settings\Billing\Actions $hydrator, string $username)
    {
