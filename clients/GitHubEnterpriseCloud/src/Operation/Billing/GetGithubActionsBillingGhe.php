...
final class GetGithubActionsBillingGhe
{
    ...
    private readonly Hydrator\Operation\Enterprises\Enterprise\Settings\Billing\Actions $hydrator;

    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Enterprises\Enterprise\Settings\Billing\Actions $hydrator, string $enterprise)
    {
