...
final class GetGithubPackagesBillingUser
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Users\CbUsernameRcb\Settings\Billing\Packages $hydrator, string $username)
    {
