...
final class GetGithubActionsBillingOrg
{
    ...
    private readonly Hydrator\Operation\Orgs\CbOrgRcb\Settings\Billing\Actions $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Orgs\CbOrgRcb\Settings\Billing\Actions $hydrator, string $org)
    {
        $this->org = $org;
