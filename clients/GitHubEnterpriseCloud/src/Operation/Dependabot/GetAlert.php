...
final class GetAlert
{
    ...
    /**
     * @return Schema\DependabotAlert|Schema\BasicError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\DependabotAlert|Schema\BasicError
    {
