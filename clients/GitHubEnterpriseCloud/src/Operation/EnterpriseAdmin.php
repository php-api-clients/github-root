...
final class EnterpriseAdmin
{
    ...
    public function getServerStatistics(string $enterpriseOrOrg, string $dateStart, string $dateEnd): PromiseInterface
    {
    ...
    public function getConsumedLicenses(string $enterprise, int $perPage, int $page): PromiseInterface
    {
    ...
    public function getLicenseSyncStatus(string $enterprise): PromiseInterface
    {
