...
final class Users
{
    ...
    public function listBlockedByAuthenticatedUser(int $perPage, int $page): PromiseInterface
    {
    ...
    public function checkBlocked(string $username): PromiseInterface
    {
    ...
    public function block(string $username): PromiseInterface
    {
    ...
    public function unblock(string $username): PromiseInterface
    {
    ...
    public function setPrimaryEmailVisibilityForAuthenticatedUser(array $params): PromiseInterface
    {
    ...
    public function listSocialAccountsForAuthenticatedUser(int $perPage, int $page): PromiseInterface
    {
    ...
    public function addSocialAccountForAuthenticatedUser(array $params): PromiseInterface
    {
    ...
    public function deleteSocialAccountForAuthenticatedUser(array $params): PromiseInterface
    {
    ...
    public function listSocialAccountsForUser(string $username, int $perPage, int $page): PromiseInterface
    {
