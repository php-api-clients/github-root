...
final class GetTopReferrers
{
    ...
    private readonly Hydrator\Operation\Repos\Owner\Repo\Traffic\Popular\Referrers $hydrator;

    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\Owner\Repo\Traffic\Popular\Referrers $hydrator, string $owner, string $repo)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
