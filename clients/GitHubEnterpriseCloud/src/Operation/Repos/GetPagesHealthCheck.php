...
final class GetPagesHealthCheck
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Pages\Health $hydrator, string $owner, string $repo)
    {
        $this->owner = $owner;
        $this->repo = $repo;
    ...
    /**
     * @return Schema\PagesHealthCheck|Schema\EmptyObject|Schema\BasicError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\PagesHealthCheck|Schema\EmptyObject|Schema\BasicError
    {
