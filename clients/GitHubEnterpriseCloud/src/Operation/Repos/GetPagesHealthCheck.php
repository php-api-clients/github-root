...
final class GetPagesHealthCheck
{
    ...
    /**
     * @return Schema\PagesHealthCheck|Schema\EmptyObject
     */
    public function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\PagesHealthCheck|Schema\EmptyObject
    {
