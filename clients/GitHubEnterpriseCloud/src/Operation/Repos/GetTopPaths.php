...
final class GetTopPaths
{
    ...
    private readonly Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Traffic\Popular\Paths $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Traffic\Popular\Paths $hydrator, string $owner, string $repo)
    {
        $this->owner = $owner;
        $this->repo = $repo;
    ...
    /**
     * @return \Rx\Observable<Schema\ContentTraffic>
     */
                ...
                switch ($contentType) {
                    case 'application/json':
                        foreach ($body as $bodyItem) {
                            $this->responseSchemaValidator->validate($bodyItem, \cebe\openapi\Reader::readFromJson(Schema\ContentTraffic::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                        }
