...
final class CheckAutomatedSecurityFixes
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Repos\Owner\Repo\AutomatedSecurityFixes $hydrator, string $owner, string $repo)
    {
        $this->owner = $owner;
        $this->repo  = $repo;
    }
    ...
    public function createResponse(ResponseInterface $response): Schema\CheckAutomatedSecurityFixes|array
    {
