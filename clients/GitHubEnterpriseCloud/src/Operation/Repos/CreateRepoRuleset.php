...
final class CreateRepoRuleset
{
    ...
    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\Owner\Repo\Rulesets $hydrator, string $owner, string $repo)
    {
