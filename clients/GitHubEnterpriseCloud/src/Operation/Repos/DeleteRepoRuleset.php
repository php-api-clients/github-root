...
final class DeleteRepoRuleset
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Rulesets\CbRulesetIdRcb $hydrator, string $owner, string $repo, int $rulesetId)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
