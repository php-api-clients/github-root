...
final class GetCommunityProfileMetrics
{
    ...
    private readonly Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Community\Profile $hydrator;
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Community\Profile $hydrator, string $owner, string $repo)
    {
        $this->owner = $owner;
        $this->repo = $repo;
     ...
     */
    public function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\CommunityProfile
    {
