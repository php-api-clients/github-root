...
final class ListCodeqlDatabases
{
    ...
    private readonly Hydrator\Operation\Repos\Owner\Repo\CodeScanning\Codeql\Databases $hydrator;

    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\Owner\Repo\CodeScanning\Codeql\Databases $hydrator, string $owner, string $repo)
    {
        $this->owner                   = $owner;
        $this->repo                    = $repo;
