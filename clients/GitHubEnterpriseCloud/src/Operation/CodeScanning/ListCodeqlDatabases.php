...
final class ListCodeqlDatabases
{
    ...
    /**
     * @return \Rx\Observable<Schema\CodeScanningCodeqlDatabase>|Schema\BasicError|Schema\Operation\CodeScanning\ListAlertsForEnterprise\Response\Applicationjson\H503
     */
