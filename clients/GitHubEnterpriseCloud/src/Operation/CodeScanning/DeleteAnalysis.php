...
final class DeleteAnalysis
{
    ...
    /**
     * @return Schema\CodeScanningAnalysisDeletion|Schema\BasicError|Schema\ScimError|Schema\Operation\CodeScanning\ListAlertsForEnterprise\Response\Applicationjson\H503
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\CodeScanningAnalysisDeletion|Schema\BasicError|Schema\ScimError|Schema\Operation\CodeScanning\ListAlertsForEnterprise\Response\Applicationjson\H503
    {
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return $this->hydrator->hydrateObject('Schema\\CodeScanningAnalysisDeletion', $body);
                }
                break;
            /**Service unavailable**/
            case 400:
