...
final class UpdateDefaultSetup
{
    ...
    public function __construct(SchemaValidator $requestSchemaValidator, SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\CodeScanning\DefaultSetup $hydrator, string $owner, string $repo)
    {
            ...
            case 'application/json':
                ...
                switch ($code) {
                    ...
                    **/
                    ...
                    case 202:
                        $this->responseSchemaValidator->validate($body, Reader::readFromJson(Schema\CodeScanningDefaultSetupUpdateResponse::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
