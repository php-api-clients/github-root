...
final class ListPackagesForAuthenticatedUser
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{package_type}', '{visibility}', '{page}', '{per_page}'), array($this->packageType, $this->visibility, $this->page, $this->perPage), self::PATH . '?packageType={package_type}&visibility={visibility}&page={page}&perPage={per_page}'));
    }
    /**
