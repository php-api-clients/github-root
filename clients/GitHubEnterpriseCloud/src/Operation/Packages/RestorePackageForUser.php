...
final class RestorePackageForUser
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Users\CbUsernameRcb\Packages\CbPackageTypeRcb\CbPackageNameRcb\Restore $hydrator, string $packageType, string $packageName, string $username, string $token)
    {
