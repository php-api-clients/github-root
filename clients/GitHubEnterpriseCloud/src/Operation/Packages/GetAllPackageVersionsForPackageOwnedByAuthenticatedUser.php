...
final class GetAllPackageVersionsForPackageOwnedByAuthenticatedUser
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{package_type}', '{package_name}', '{page}', '{per_page}', '{state}'), array($this->packageType, $this->packageName, $this->page, $this->perPage, $this->state), self::PATH . '?page={page}&per_page={per_page}&state={state}'));
    }
    /**
