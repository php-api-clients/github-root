...
final class RestorePackageForOrg
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Orgs\CbOrgRcb\Packages\CbPackageTypeRcb\CbPackageNameRcb\Restore $hydrator, string $packageType, string $packageName, string $org, string $token)
    {
