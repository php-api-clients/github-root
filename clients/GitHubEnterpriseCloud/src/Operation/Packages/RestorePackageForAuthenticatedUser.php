...
final class RestorePackageForAuthenticatedUser
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\User\Packages\CbPackageTypeRcb\CbPackageNameRcb\Restore $hydrator, string $packageType, string $packageName, string $token)
    {
