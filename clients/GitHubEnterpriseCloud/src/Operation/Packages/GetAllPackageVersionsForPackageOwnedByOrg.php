...
final class GetAllPackageVersionsForPackageOwnedByOrg
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{package_type}', '{package_name}', '{org}', '{page}', '{per_page}', '{state}'), array($this->packageType, $this->packageName, $this->org, $this->page, $this->perPage, $this->state), self::PATH . '?page={page}&perPage={per_page}&state={state}'));
    }
    /**
