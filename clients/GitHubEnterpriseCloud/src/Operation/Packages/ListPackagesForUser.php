...
final class ListPackagesForUser
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{package_type}', '{visibility}', '{username}', '{page}', '{per_page}'), array($this->packageType, $this->visibility, $this->username, $this->page, $this->perPage), self::PATH . '?package_type={package_type}&visibility={visibility}&page={page}&per_page={per_page}'));
    }
    /**
