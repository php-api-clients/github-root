...
final class GetAllPackageVersionsForPackageOwnedByUser
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Users\CbUsernameRcb\Packages\CbPackageTypeRcb\CbPackageNameRcb\Versions $hydrator, string $package_type, string $package_name, string $username)
    {
    ...
    /**
     * @return \Rx\Observable<Schema\PackageVersion>|Schema\BasicError
     */
