...
final class RestorePackageVersionForAuthenticatedUser
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\User\Packages\CbPackageTypeRcb\CbPackageNameRcb\Versions\CbPackageVersionIdRcb\Restore $hydrator, string $packageType, string $packageName, int $packageVersionId)
    {
