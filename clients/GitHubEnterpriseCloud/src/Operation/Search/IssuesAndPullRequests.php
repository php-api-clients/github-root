...
namespace ApiClients\Client\GitHubEnterpriseCloud\Operation\Search;
...
final class IssuesAndPullRequests
{
    ...
    /**
     * @return Schema\Operation\Search\IssuesAndPullRequests\Response\Applicationjson\H200|Schema\Operation\CodeScanning\ListAlertsForEnterprise\Response\Applicationjson\H503|Schema\ValidationError|Schema\BasicError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\Operation\Search\IssuesAndPullRequests\Response\Applicationjson\H200|Schema\Operation\CodeScanning\ListAlertsForEnterprise\Response\Applicationjson\H503|Schema\ValidationError|Schema\BasicError
    {
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return $this->hydrator->hydrateObject('Schema\\Operation\\Search\\IssuesAndPullRequests\\Response\\Applicationjson\\H200', $body);
                }
                break;
            /**Forbidden**/
            case 503:
