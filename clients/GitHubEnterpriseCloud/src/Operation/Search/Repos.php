...
final class Repos
{
    ...
    /**
     * @return Schema\Operation\Search\Repos\Response\Applicationjson\H200|Schema\Operation\CodeScanning\ListAlertsForEnterprise\Response\Applicationjson\H503|Schema\ValidationError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\Operation\Search\Repos\Response\Applicationjson\H200|Schema\Operation\CodeScanning\ListAlertsForEnterprise\Response\Applicationjson\H503|Schema\ValidationError
    {
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return $this->hydrator->hydrateObject('Schema\\Operation\\Search\\Repos\\Response\\Applicationjson\\H200', $body);
                }
                break;
            /**Validation failed, or the endpoint has been spammed.**/
            case 503:
