...
final class GetSecurityAnalysisSettingsForEnterprise
{
    ...
    /**
     * @return Schema\EnterpriseSecurityAnalysisSettings|Schema\BasicError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\EnterpriseSecurityAnalysisSettings|Schema\BasicError
    {
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return $this->hydrator->hydrateObject('Schema\\EnterpriseSecurityAnalysisSettings', $body);
                }
                break;
            /**Resource not found**/
            case 404:
