...
final class ListLocationsForAlert
{
    ...
    /**
     * @return \Rx\Observable<Schema\SecretScanningLocation>|Schema\Operation\CodeScanning\ListAlertsForEnterprise\Response\Applicationjson\H503
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : \Rx\Observable|Schema\Operation\CodeScanning\ListAlertsForEnterprise\Response\Applicationjson\H503
    {
                ...
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return \Rx\Observable::fromArray($body, new \Rx\Scheduler\ImmediateScheduler())->map(function (array $body) : Schema\SecretScanningLocation {
                            return $this->hydrator->hydrateObject('Schema\\SecretScanningLocation', $body);
                        });
                }
                break;
            /**Service unavailable**/
