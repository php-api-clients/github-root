...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Feed\Links;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\LinkWithType;
...
class Feeds implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Feed(array $payload): Feed
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Feed⚡️Links(array $payload): Links
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️LinkWithType(array $payload): LinkWithType
    {
        $properties    = [];
        $missingFields = [];
        try {
