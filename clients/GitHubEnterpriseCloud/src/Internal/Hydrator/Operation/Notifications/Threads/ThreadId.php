...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Notifications\Threads;
...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Thread\Subject;
...
class ThreadId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Thread(array $payload): Thread
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Thread⚡️Subject(array $payload): Subject
    {
        $properties    = [];
        $missingFields = [];
        try {
