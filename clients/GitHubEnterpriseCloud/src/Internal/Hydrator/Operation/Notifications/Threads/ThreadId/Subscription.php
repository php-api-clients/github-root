...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Notifications\Threads\ThreadId;
...
class Subscription implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️ThreadSubscription(array $payload): ThreadSubscription
    {
        $properties    = [];
        $missingFields = [];
        try {
