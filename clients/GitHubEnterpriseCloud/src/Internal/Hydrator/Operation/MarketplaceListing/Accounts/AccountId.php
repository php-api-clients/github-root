...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\MarketplaceListing\Accounts;

use ApiClients\Client\GitHubEnterpriseCloud\Schema\BasicError;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\MarketplaceListingPlan;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\MarketplacePurchase;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\MarketplacePurchase\MarketplacePendingChange;
...
class AccountId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️MarketplacePurchase(array $payload): MarketplacePurchase
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️MarketplacePurchase⚡️MarketplacePendingChange(array $payload): MarketplacePendingChange
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️MarketplaceListingPlan(array $payload): MarketplaceListingPlan
    {
        $properties    = [];
        $missingFields = [];
        try {
