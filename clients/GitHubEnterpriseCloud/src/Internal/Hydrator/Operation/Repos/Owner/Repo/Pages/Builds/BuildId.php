...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Repos\Owner\Repo\Pages\Builds;

use ApiClients\Client\GitHubEnterpriseCloud\Schema\PageBuild;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\PageBuild\Error;
...
class BuildId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️PageBuild(array $payload): PageBuild
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️PageBuild⚡️Error(array $payload): Error
    {
        $properties    = [];
        $missingFields = [];
        try {
