...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Repos\Owner\Repo\CodeScanning\Sarifs;
...
class SarifId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodeScanningSarifsStatus(array $payload): CodeScanningSarifsStatus
    {
        $properties    = [];
        $missingFields = [];
        try {
