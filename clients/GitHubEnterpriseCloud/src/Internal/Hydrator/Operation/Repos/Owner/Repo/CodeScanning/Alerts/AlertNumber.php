...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Repos\Owner\Repo\CodeScanning\Alerts;
...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\CodeScanningAlertInstance;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\CodeScanningAlertInstance\Message;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\CodeScanningAlertLocation;
...
class AlertNumber implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodeScanningAlert(array $payload): CodeScanningAlert
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodeScanningAlertRule(array $payload): CodeScanningAlertRule
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodeScanningAnalysisTool(array $payload): CodeScanningAnalysisTool
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodeScanningAlertInstance(array $payload): CodeScanningAlertInstance
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodeScanningAlertInstance⚡️Message(array $payload): Message
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodeScanningAlertLocation(array $payload): CodeScanningAlertLocation
    {
        $properties    = [];
        $missingFields = [];
        try {
