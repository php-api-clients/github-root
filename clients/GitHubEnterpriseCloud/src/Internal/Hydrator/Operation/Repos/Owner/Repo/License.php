...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\LicenseContent\Links;
...
class License implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️LicenseContent(array $payload): LicenseContent
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️LicenseContent⚡️Links(array $payload): Links
    {
        $properties    = [];
        $missingFields = [];
        try {
