...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Repos\Owner\Repo\Community;

use ApiClients\Client\GitHubEnterpriseCloud\Schema\CodeOfConductSimple;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\CommunityHealthFile;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\CommunityProfile;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\CommunityProfile\Files;
...
class Profile implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CommunityProfile(array $payload): CommunityProfile
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CommunityProfile⚡️Files(array $payload): Files
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CommunityHealthFile(array $payload): CommunityHealthFile
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\CommunityHealthFile' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CommunityHealthFile($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CommunityProfile⚡️Files(mixed $object): mixed
    {
        ...
        $codeOfConductFile                                              = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CommunityHealthFile($codeOfConductFile);
        ...
        $contributing                                      = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CommunityHealthFile($contributing);
        ...
        $readme                                = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CommunityHealthFile($readme);
        ...
        $issueTemplate                                        = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CommunityHealthFile($issueTemplate);
        ...
        $pullRequestTemplate                                               = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CommunityHealthFile($pullRequestTemplate);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CommunityHealthFile(mixed $object): mixed
    {
