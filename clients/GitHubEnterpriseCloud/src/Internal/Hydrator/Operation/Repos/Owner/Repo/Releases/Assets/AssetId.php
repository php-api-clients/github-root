...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Repos\Owner\Repo\Releases\Assets;
...
class AssetId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️ReleaseAsset(array $payload): ReleaseAsset
    {
        $properties    = [];
        $missingFields = [];
        try {
