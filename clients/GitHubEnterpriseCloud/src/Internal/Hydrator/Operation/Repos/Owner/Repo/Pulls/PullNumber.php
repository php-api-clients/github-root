...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Repos\Owner\Repo\Pulls;

use ApiClients\Client\GitHubEnterpriseCloud\Schema\AutoMerge;
...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Link;
...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\PullRequest\Base;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\PullRequest\Head;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\PullRequest\Head\Repo;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\PullRequest\Head\Repo\License;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\PullRequest\Head\Repo\Owner;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\PullRequest\Head\Repo\Permissions;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\PullRequest\Head\User;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\PullRequest\Links;
...
class PullNumber implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️PullRequest(array $payload): PullRequest
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Milestone(array $payload): Milestone
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️PullRequest⚡️Head(array $payload): Head
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️PullRequest⚡️Head⚡️Repo(array $payload): Repo
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️PullRequest⚡️Head⚡️Repo⚡️Owner(array $payload): Owner
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️PullRequest⚡️Head⚡️Repo⚡️Permissions(array $payload): Permissions
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️PullRequest⚡️Head⚡️Repo⚡️License(array $payload): License
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️PullRequest⚡️Head⚡️User(array $payload): User
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️PullRequest⚡️Base(array $payload): Base
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️PullRequest⚡️Links(array $payload): Links
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Link(array $payload): Link
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️AutoMerge(array $payload): AutoMerge
    {
        $properties    = [];
        $missingFields = [];
        try {
