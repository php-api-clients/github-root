...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Repos\Owner\Repo\Import\Authors;
...
class AuthorId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️PorterAuthor(array $payload): PorterAuthor
    {
        $properties    = [];
        $missingFields = [];
        try {
