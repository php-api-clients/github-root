...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Repos\Owner\Repo\CodeScanning\Codeql\Databases;
...
class Language implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodeScanningCodeqlDatabase(array $payload): CodeScanningCodeqlDatabase
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(CodeScanningCodeqlDatabase::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new CodeScanningCodeqlDatabase(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\CodeScanningCodeqlDatabase', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    {
        assert($object instanceof CodeScanningCodeqlDatabase);
        $result = [];
