...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\PagesHttpsCertificate;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\PagesSourceHash;
...
class Pages implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Page(array $payload): Page
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️PagesSourceHash(array $payload): PagesSourceHash
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️PagesHttpsCertificate(array $payload): PagesHttpsCertificate
    {
        $properties    = [];
        $missingFields = [];
        try {
