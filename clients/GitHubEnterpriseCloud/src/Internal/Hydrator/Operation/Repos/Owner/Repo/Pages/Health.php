...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\PagesHealthCheck\AltDomain;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\PagesHealthCheck\Domain;
...
class Health implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️PagesHealthCheck(array $payload): PagesHealthCheck
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(PagesHealthCheck::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new PagesHealthCheck(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\PagesHealthCheck', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️PagesHealthCheck⚡️Domain(array $payload): Domain
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(Domain::class, $missingFields, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️PagesHealthCheck⚡️AltDomain(array $payload): AltDomain
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(AltDomain::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new AltDomain(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\PagesHealthCheck\AltDomain', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    {
        assert($object instanceof PagesHealthCheck);
        $result = [];
    ...
    {
        assert($object instanceof Domain);
        $result = [];
    ...
    {
        assert($object instanceof AltDomain);
        $result = [];
