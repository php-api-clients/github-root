...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Repos\Owner\Repo\Collaborators;
...
class Username implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️RepositoryInvitation(array $payload): RepositoryInvitation
    {
        $properties    = [];
        $missingFields = [];
        try {
