...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Repos\Owner\Repo\Commits\CommitSha;
...
class Comments implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CommitComment(array $payload): CommitComment
    {
        $properties    = [];
        $missingFields = [];
        try {
