...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Repos\Owner\Repo\Actions\Artifacts;

use ApiClients\Client\GitHubEnterpriseCloud\Schema\Artifact;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Artifact\WorkflowRun;
...
class ArtifactId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Artifact(array $payload): Artifact
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Artifact⚡️WorkflowRun(array $payload): WorkflowRun
    {
        $properties    = [];
        $missingFields = [];
        try {
