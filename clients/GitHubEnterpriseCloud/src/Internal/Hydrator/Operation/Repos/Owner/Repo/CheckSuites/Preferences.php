...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Repos\Owner\Repo\CheckSuites;
...
class Preferences implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CheckSuitePreference(array $payload): CheckSuitePreference
    {
        $properties    = [];
        $missingFields = [];
        try {
