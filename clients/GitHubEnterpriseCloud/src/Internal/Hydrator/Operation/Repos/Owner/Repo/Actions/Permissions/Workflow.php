...
class Workflow implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️ActionsGetDefaultWorkflowPermissions(array $payload): ActionsGetDefaultWorkflowPermissions
    {
        $properties    = [];
        $missingFields = [];
        try {
