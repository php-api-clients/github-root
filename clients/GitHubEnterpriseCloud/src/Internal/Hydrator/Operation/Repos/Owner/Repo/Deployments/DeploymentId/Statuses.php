...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Repos\Owner\Repo\Deployments\DeploymentId;
...
class Statuses implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️DeploymentStatus(array $payload): DeploymentStatus
    {
        $properties    = [];
        $missingFields = [];
        try {
