...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Repos\Owner\Repo\Actions\Cache;
...
class Usage implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️ActionsCacheUsageByRepository(array $payload): ActionsCacheUsageByRepository
    {
        $properties    = [];
        $missingFields = [];
        try {
