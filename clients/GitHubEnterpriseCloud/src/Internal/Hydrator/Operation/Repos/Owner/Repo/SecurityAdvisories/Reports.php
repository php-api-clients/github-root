...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Repos\Owner\Repo\SecurityAdvisories;
...
class Reports implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️RepositoryAdvisory(array $payload): RepositoryAdvisory
    {
        $properties    = [];
        $missingFields = [];
        try {
