...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Repos\Owner\Repo\CodeScanning;
...
class DefaultSetup implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodeScanningDefaultSetup(array $payload): CodeScanningDefaultSetup
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodeScanningDefaultSetupUpdateResponse(array $payload): CodeScanningDefaultSetupUpdateResponse
    {
        $properties    = [];
        $missingFields = [];
        try {
