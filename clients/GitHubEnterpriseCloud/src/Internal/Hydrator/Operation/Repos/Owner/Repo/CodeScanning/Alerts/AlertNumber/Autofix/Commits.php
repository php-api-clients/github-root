...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Repos\Owner\Repo\CodeScanning\Alerts\AlertNumber\Autofix;
...
class Commits implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\CodeScanningAutofixCommitsResponse' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodeScanningAutofixCommitsResponse($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodeScanningAutofixCommitsResponse(array $payload): CodeScanningAutofixCommitsResponse
    {
        $properties    = [];
        $missingFields = [];
        try {
            $value = $payload['target_ref'] ?? null;

            if ($value === null) {
                $properties['targetRef'] = null;
                goto after_targetRef;
            }

            $properties['targetRef'] = $value;
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\CodeScanningAutofixCommitsResponse', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(CodeScanningAutofixCommitsResponse::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new CodeScanningAutofixCommitsResponse(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\CodeScanningAutofixCommitsResponse', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\CodeScanningAutofixCommitsResponse' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodeScanningAutofixCommitsResponse($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodeScanningAutofixCommitsResponse(mixed $object): mixed
    {
        assert($object instanceof CodeScanningAutofixCommitsResponse);
        $result = [];
        ...
        after_targetRef:        $result['target_ref'] = $targetRef;
