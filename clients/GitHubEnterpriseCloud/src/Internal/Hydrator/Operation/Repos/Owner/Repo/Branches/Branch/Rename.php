...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\BranchWithProtection\Links;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Commit;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Commit\Commit\Tree;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Commit\Stats;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\GitUser;
...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Verification;
...
class Rename implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️BranchWithProtection(array $payload): BranchWithProtection
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Commit(array $payload): Commit
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️GitUser(array $payload): GitUser
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Commit⚡️Commit⚡️Tree(array $payload): Tree
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Verification(array $payload): Verification
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Commit⚡️Stats(array $payload): Stats
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️BranchWithProtection⚡️Links(array $payload): Links
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Commit(mixed $object): mixed
    {
        ...
        $author = match ($author::class) {
                        'ApiClients\Client\GitHubEnterpriseCloud\Schema\SimpleUser' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️SimpleUser($author),
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\EmptyObject' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️EmptyObject($author),
        };
        after_author:        $result['author'] = $author;

        $committer = $object->committer;
        $committer = match ($committer::class) {
                        'ApiClients\Client\GitHubEnterpriseCloud\Schema\SimpleUser' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️SimpleUser($committer),
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\EmptyObject' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️EmptyObject($committer),
        };
