...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\CustomDeploymentRuleApp;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\DeploymentProtectionRule;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Repos\GetAllDeploymentProtectionRules\Response\ApplicationJson\Ok;
...
class DeploymentProtectionRules implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Operations⚡️Repos⚡️GetAllDeploymentProtectionRules⚡️Response⚡️ApplicationJson⚡️Ok(array $payload): Ok
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️DeploymentProtectionRule(array $payload): DeploymentProtectionRule
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CustomDeploymentRuleApp(array $payload): CustomDeploymentRuleApp
    {
        $properties    = [];
        $missingFields = [];
        try {
