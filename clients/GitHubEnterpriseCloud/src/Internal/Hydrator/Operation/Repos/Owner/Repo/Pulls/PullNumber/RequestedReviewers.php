...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\PullRequestSimple\Base;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\PullRequestSimple\Head;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\PullRequestSimple\Links;
...
class RequestedReviewers implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️PullRequestReviewRequest(array $payload): PullRequestReviewRequest
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️PullRequestSimple(array $payload): PullRequestSimple
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️PullRequestSimple⚡️Head(array $payload): Head
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️PullRequestSimple⚡️Base(array $payload): Base
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️PullRequestSimple⚡️Links(array $payload): Links
    {
        $properties    = [];
        $missingFields = [];
        try {
