...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Repos\Owner\Repo\Git\Refs;

use ApiClients\Client\GitHubEnterpriseCloud\Schema\BasicError;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\GitRef;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\GitRef\Object_;
...
class Ref implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️GitRef(array $payload): GitRef
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️GitRef⚡️Object_(array $payload): Object_
    {
        $properties    = [];
        $missingFields = [];
        try {
