...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Repos\Owner\Repo\Git\Trees;
...
class TreeSha implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️GitTree(array $payload): GitTree
    {
        $properties    = [];
        $missingFields = [];
        try {
