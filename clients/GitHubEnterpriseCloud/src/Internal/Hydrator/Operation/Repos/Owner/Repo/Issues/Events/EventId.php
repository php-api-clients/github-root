...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Repos\Owner\Repo\Issues\Events;
...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\IssueEvent;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\IssueEventDismissedReview;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\IssueEventLabel;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\IssueEventMilestone;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\IssueEventProjectCard;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\IssueEventRename;
...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Repository\TemplateRepository;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Repository\TemplateRepository\Owner;
...
class EventId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️IssueEvent(array $payload): IssueEvent
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Issue(array $payload): Issue
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Issue⚡️PullRequest(array $payload): PullRequest
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Repository(array $payload): Repository
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Repository⚡️Permissions(array $payload): Permissions
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Repository⚡️TemplateRepository(array $payload): TemplateRepository
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Repository⚡️TemplateRepository⚡️Owner(array $payload): Owner
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️TeamSimple(array $payload): TeamSimple
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️IssueEventDismissedReview(array $payload): IssueEventDismissedReview
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️IssueEventMilestone(array $payload): IssueEventMilestone
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️IssueEventProjectCard(array $payload): IssueEventProjectCard
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️IssueEventRename(array $payload): IssueEventRename
    {
        $properties    = [];
        $missingFields = [];
        try {
