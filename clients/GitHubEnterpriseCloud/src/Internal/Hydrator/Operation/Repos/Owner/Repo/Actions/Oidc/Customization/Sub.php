...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Repos\Owner\Repo\Actions\Oidc\Customization;
...
class Sub implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️OidcCustomSubRepo(array $payload): OidcCustomSubRepo
    {
        $properties    = [];
        $missingFields = [];
        try {
