...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Orgs\Org\Actions\Oidc\Customization;
...
class Sub implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️OidcCustomSub(array $payload): OidcCustomSub
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(OidcCustomSub::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new OidcCustomSub(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\OidcCustomSub', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    {
        assert($object instanceof OidcCustomSub);
        $result = [];
