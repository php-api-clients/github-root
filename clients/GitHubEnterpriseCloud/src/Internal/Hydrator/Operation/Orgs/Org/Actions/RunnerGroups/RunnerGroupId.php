...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Orgs\Org\Actions\RunnerGroups;
...
class RunnerGroupId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️RunnerGroupsOrg(array $payload): RunnerGroupsOrg
    {
        $properties    = [];
        $missingFields = [];
        try {
