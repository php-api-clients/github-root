...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Orgs\Org\Teams\TeamSlug\Discussions;
...
class DiscussionNumber implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️TeamDiscussion(array $payload): TeamDiscussion
    {
        $properties    = [];
        $missingFields = [];
        try {
