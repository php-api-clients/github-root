...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Orgs\Org\Copilot;
...
class Billing implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CopilotOrganizationDetails(array $payload): CopilotOrganizationDetails
    {
        $properties    = [];
        $missingFields = [];
        try {
