...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Orgs\Org\Hooks\HookId\Deliveries;
...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\HookDelivery\Request;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\HookDelivery\Request\Headers;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\HookDelivery\Request\Payload;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\HookDelivery\Response;
...
class DeliveryId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️HookDelivery(array $payload): HookDelivery
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️HookDelivery⚡️Request(array $payload): Request
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️HookDelivery⚡️Response(array $payload): Response
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️HookDelivery⚡️Request⚡️Headers(array $payload): Headers
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️HookDelivery⚡️Request⚡️Payload(array $payload): Payload
    {
        $properties    = [];
        $missingFields = [];
        try {
