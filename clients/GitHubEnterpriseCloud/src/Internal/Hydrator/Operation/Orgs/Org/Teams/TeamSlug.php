...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Orgs\Org\Teams;

use ApiClients\Client\GitHubEnterpriseCloud\Schema\BasicError;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\TeamFull;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\TeamOrganization;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\TeamOrganization\Plan;
...
class TeamSlug implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️TeamFull(array $payload): TeamFull
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️TeamOrganization(array $payload): TeamOrganization
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️TeamOrganization⚡️Plan(array $payload): Plan
    {
        $properties    = [];
        $missingFields = [];
        try {
