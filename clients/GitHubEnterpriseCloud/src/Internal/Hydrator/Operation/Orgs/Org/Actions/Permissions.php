...
class Permissions implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️ActionsOrganizationPermissions(array $payload): ActionsOrganizationPermissions
    {
        $properties    = [];
        $missingFields = [];
        try {
