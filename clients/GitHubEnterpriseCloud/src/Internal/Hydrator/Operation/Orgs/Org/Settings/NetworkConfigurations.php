...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Orgs\Org\Settings;
...
class NetworkConfigurations implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Operations⚡️HostedCompute⚡️ListNetworkConfigurationsForOrg⚡️Response⚡️ApplicationJson⚡️Ok⚡️Application⚡️Json(array $payload): Json
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            $value = $payload['network_configurations'] ?? null;

            if ($value === null) {
                $missingFields[] = 'network_configurations';
                goto after_networkConfigurations;
            }

            $properties['networkConfigurations'] = $value;

            after_networkConfigurations:
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\HostedCompute\ListNetworkConfigurationsForOrg\Response\ApplicationJson\Ok\Application\Json', $exception, stack: $this->hydrationStack);
        }
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Operations⚡️HostedCompute⚡️ListNetworkConfigurationsForOrg⚡️Response⚡️ApplicationJson⚡️Ok⚡️Application⚡️Json(mixed $object): mixed
    {
        ...
        $networkConfigurations = $object->networkConfigurations;
        static $networkConfigurationsSerializer0;

        if ($networkConfigurationsSerializer0 === null) {
            $networkConfigurationsSerializer0 = new SerializeArrayItems(...[]);
        }

        $networkConfigurations                                                = $networkConfigurationsSerializer0->serialize($networkConfigurations, $this);
        after_networkConfigurations:        $result['network_configurations'] = $networkConfigurations;
