...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\ActionsBillingUsage\MinutesUsedBreakdown;
...
class Actions implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️ActionsBillingUsage(array $payload): ActionsBillingUsage
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️ActionsBillingUsage⚡️MinutesUsedBreakdown(array $payload): MinutesUsedBreakdown
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️ActionsBillingUsage(mixed $object): mixed
    {
        ...
        $minutesUsedBreakdown                                                = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️ActionsBillingUsage⚡️MinutesUsedBreakdown($minutesUsedBreakdown);
