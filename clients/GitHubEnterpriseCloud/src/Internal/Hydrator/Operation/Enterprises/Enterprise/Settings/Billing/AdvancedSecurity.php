...
class AdvancedSecurity implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️AdvancedSecurityActiveCommitters(array $payload): AdvancedSecurityActiveCommitters
    {
        $properties    = [];
        $missingFields = [];
        try {
