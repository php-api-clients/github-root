...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Enterprises\Enterprise\Actions\Cache;
...
class Usage implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️ActionsCacheUsageOrgEnterprise(array $payload): ActionsCacheUsageOrgEnterprise
    {
        $properties    = [];
        $missingFields = [];
        try {
