...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Enterprises\Enterprise\Actions\Runners;
...
class GenerateJitconfig implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Operations⚡️Actions⚡️GenerateRunnerJitconfigForEnterprise⚡️Response⚡️ApplicationJson⚡️Created(array $payload): Created
    {
        $properties    = [];
        $missingFields = [];
        try {
