...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\User\Migrations;
...
class MigrationId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Migration(array $payload): Migration
    {
        $properties    = [];
        $missingFields = [];
        try {
