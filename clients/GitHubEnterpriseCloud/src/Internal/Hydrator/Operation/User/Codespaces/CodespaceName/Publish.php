...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\User\Codespaces\CodespaceName;
...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\CodespaceMachine;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\CodespaceWithFullRepository;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\CodespaceWithFullRepository\GitStatus;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\CodespaceWithFullRepository\RuntimeConstraints;
...
class Publish implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\CodespaceWithFullRepository' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodespaceWithFullRepository($payload),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\CodespaceWithFullRepository\GitStatus' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodespaceWithFullRepository⚡️GitStatus($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\CodespaceWithFullRepository\RuntimeConstraints' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodespaceWithFullRepository⚡️RuntimeConstraints($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodespaceWithFullRepository(array $payload): CodespaceWithFullRepository
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodespaceWithFullRepository⚡️GitStatus($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodespaceWithFullRepository⚡️RuntimeConstraints($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(CodespaceWithFullRepository::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new CodespaceWithFullRepository(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\CodespaceWithFullRepository', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️FullRepository(array $payload): FullRepository
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️FullRepository⚡️Permissions(array $payload): Permissions
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodeOfConductSimple(array $payload): CodeOfConductSimple
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodespaceMachine(array $payload): CodespaceMachine
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(CodespaceMachine::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new CodespaceMachine(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\CodespaceMachine', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodespaceWithFullRepository⚡️GitStatus(array $payload): GitStatus
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\CodespaceWithFullRepository\GitStatus', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(GitStatus::class, $missingFields, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodespaceWithFullRepository⚡️RuntimeConstraints(array $payload): RuntimeConstraints
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\CodespaceWithFullRepository\RuntimeConstraints', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(RuntimeConstraints::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new RuntimeConstraints(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\CodespaceWithFullRepository\RuntimeConstraints', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\FullRepository' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️FullRepository($object),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\CodeOfConductSimple' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodeOfConductSimple($object),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\CodespaceWithFullRepository\GitStatus' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodespaceWithFullRepository⚡️GitStatus($object),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\CodespaceWithFullRepository\RuntimeConstraints' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodespaceWithFullRepository⚡️RuntimeConstraints($object),
    ...
    {
        assert($object instanceof CodespaceWithFullRepository);
        $result = [];
        ...
        $billableOwner                                        = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️SimpleUser($billableOwner);
        ...
        $gitStatus                                    = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodespaceWithFullRepository⚡️GitStatus($gitStatus);
        ...
        if ($recentFoldersSerializer0 === null) {
            $recentFoldersSerializer0 = new SerializeArrayItems(...[]);
        }
        ...
        $runtimeConstraints                                             = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodespaceWithFullRepository⚡️RuntimeConstraints($runtimeConstraints);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️FullRepository(mixed $object): mixed
    {
        ...
        $templateRepository                                             = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Repository($templateRepository);
        ...
        $parent                                = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Repository($parent);
        ...
        $source                                = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Repository($source);
        ...
        $codeOfConduct                                         = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodeOfConductSimple($codeOfConduct);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodeOfConductSimple(mixed $object): mixed
    {
    ...
    {
        assert($object instanceof CodespaceMachine);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodespaceWithFullRepository⚡️GitStatus(mixed $object): mixed
    {
        assert($object instanceof GitStatus);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CodespaceWithFullRepository⚡️RuntimeConstraints(mixed $object): mixed
    {
        assert($object instanceof RuntimeConstraints);
        $result = [];
        ...
        if ($allowedPortPrivacySettingsSerializer0 === null) {
            $allowedPortPrivacySettingsSerializer0 = new SerializeArrayItems(...[]);
        }
