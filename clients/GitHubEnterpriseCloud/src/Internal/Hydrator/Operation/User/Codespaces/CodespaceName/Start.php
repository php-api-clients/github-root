...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Codespace\GitStatus;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Codespace\RuntimeConstraints;
...
class Start implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Codespace(array $payload): Codespace
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(Codespace::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new Codespace(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\Codespace', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Codespace⚡️GitStatus(array $payload): GitStatus
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Codespace⚡️RuntimeConstraints(array $payload): RuntimeConstraints
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    {
        assert($object instanceof Codespace);
        $result = [];
