...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\BaseGist\Files;
...
class Forks implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️BaseGist(array $payload): BaseGist
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️BaseGist⚡️Files(array $payload): Files
    {
        $properties    = [];
        $missingFields = [];
        try {
