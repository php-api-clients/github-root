...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Gists;
...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Gists\Get\Response\ApplicationJson\Forbidden;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Gists\Get\Response\ApplicationJson\Forbidden\Block;
...
class GistId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Operations⚡️Gists⚡️Get⚡️Response⚡️ApplicationJson⚡️Forbidden(array $payload): Forbidden
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Operations⚡️Gists⚡️Get⚡️Response⚡️ApplicationJson⚡️Forbidden⚡️Block(array $payload): Block
    {
        $properties    = [];
        $missingFields = [];
        try {
