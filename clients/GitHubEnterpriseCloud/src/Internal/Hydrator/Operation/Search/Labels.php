...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Search\Labels\Response\ApplicationJson\Ok;
...
class Labels implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Operations⚡️Search⚡️Labels⚡️Response⚡️ApplicationJson⚡️Ok(array $payload): Ok
    {
        $properties    = [];
        $missingFields = [];
        try {
