...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Projects\ProjectId;
...
class Columns implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️ProjectColumn(array $payload): ProjectColumn
    {
        $properties    = [];
        $missingFields = [];
        try {
