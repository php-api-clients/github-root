...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Advisories;
...
class GhsaId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️GlobalAdvisory(array $payload): GlobalAdvisory
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️GlobalAdvisory⚡️Cvss(array $payload): Cvss
    {
        $properties    = [];
        $missingFields = [];
        try {
