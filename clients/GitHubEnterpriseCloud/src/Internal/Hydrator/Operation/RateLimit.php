...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\RateLimitOverview\Resources;
...
class RateLimit implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️RateLimitOverview(array $payload): RateLimitOverview
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️RateLimitOverview⚡️Resources(array $payload): Resources
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️RateLimitOverview⚡️Resources(mixed $object): mixed
    {
        ...
        $codeScanningAutofix                                               = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️RateLimit($codeScanningAutofix);
