...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Hydrator\Operation\Applications\ClientId\Token;
...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Authorization\App;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\BasicError;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\ScopedInstallation;
...
class Scoped implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Authorization(array $payload): Authorization
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Authorization⚡️App(array $payload): App
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️ScopedInstallation(array $payload): ScopedInstallation
    {
        $properties    = [];
        $missingFields = [];
        try {
