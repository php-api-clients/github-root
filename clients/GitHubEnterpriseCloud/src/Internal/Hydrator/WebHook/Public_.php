...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPublic;
...
class Public_ implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPublic(array $payload): WebhookPublic
    {
        $properties    = [];
        $missingFields = [];
        try {
