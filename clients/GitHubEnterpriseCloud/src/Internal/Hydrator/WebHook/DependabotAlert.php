...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\DependabotAlert\Dependency;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\DependabotAlertPackage;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\DependabotAlertSecurityAdvisory;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\DependabotAlertSecurityAdvisory\Cvss;
...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookDependabotAlertAutoDismissed;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookDependabotAlertAutoReopened;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookDependabotAlertCreated;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookDependabotAlertDismissed;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookDependabotAlertFixed;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookDependabotAlertReintroduced;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookDependabotAlertReopened;
...
class DependabotAlert implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDependabotAlertAutoDismissed(array $payload): WebhookDependabotAlertAutoDismissed
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️DependabotAlert⚡️Dependency(array $payload): Dependency
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️DependabotAlertPackage(array $payload): DependabotAlertPackage
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️DependabotAlertSecurityAdvisory(array $payload): DependabotAlertSecurityAdvisory
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️DependabotAlertSecurityAdvisory⚡️Cvss(array $payload): Cvss
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️DependabotAlertSecurityVulnerability(array $payload): DependabotAlertSecurityVulnerability
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️DependabotAlertSecurityVulnerability⚡️FirstPatchedVersion(array $payload): FirstPatchedVersion
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDependabotAlertAutoReopened(array $payload): WebhookDependabotAlertAutoReopened
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDependabotAlertCreated(array $payload): WebhookDependabotAlertCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDependabotAlertDismissed(array $payload): WebhookDependabotAlertDismissed
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDependabotAlertFixed(array $payload): WebhookDependabotAlertFixed
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDependabotAlertReintroduced(array $payload): WebhookDependabotAlertReintroduced
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDependabotAlertReopened(array $payload): WebhookDependabotAlertReopened
    {
        $properties    = [];
        $missingFields = [];
        try {
