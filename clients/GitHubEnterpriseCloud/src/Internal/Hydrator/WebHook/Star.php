...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookStarCreated;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookStarDeleted;
...
class Star implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookStarCreated(array $payload): WebhookStarCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookStarDeleted(array $payload): WebhookStarDeleted
    {
        $properties    = [];
        $missingFields = [];
        try {
