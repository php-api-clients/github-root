...
use ApiClients\Client\GitHubEnterpriseCloud\Internal\Attribute\CastUnionToType\Schema\Deployment\Payload;
...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobCompleted;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobInProgress;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobQueued;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobWaiting;
...
class WorkflowJob implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobCompleted(array $payload): WebhookWorkflowJobCompleted
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Deployment(array $payload): Deployment
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobInProgress(array $payload): WebhookWorkflowJobInProgress
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobQueued(array $payload): WebhookWorkflowJobQueued
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowJobWaiting(array $payload): WebhookWorkflowJobWaiting
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookWorkflowJobWaiting::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookWorkflowJobWaiting(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobWaiting', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    {
        assert($object instanceof WebhookWorkflowJobWaiting);
        $result = [];
