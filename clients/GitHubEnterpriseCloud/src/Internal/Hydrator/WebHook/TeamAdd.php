...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookTeamAdd;
...
class TeamAdd implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookTeamAdd(array $payload): WebhookTeamAdd
    {
        $properties    = [];
        $missingFields = [];
        try {
