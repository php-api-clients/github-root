...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWatchStarted;
...
class Watch implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWatchStarted(array $payload): WebhookWatchStarted
    {
        $properties    = [];
        $missingFields = [];
        try {
