...
use ApiClients\Client\GitHubEnterpriseCloud\Internal\Attribute\CastUnionToType\Schema\Installation\Account;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\AppPermissions;
...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationCreated;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationCreated\Requester;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationDeleted;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationNewPermissionsAccepted;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationSuspend;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationUnsuspend;
...
class Installation implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationCreated(array $payload): WebhookInstallationCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️AppPermissions(array $payload): AppPermissions
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationCreated⚡️Requester(array $payload): Requester
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationDeleted(array $payload): WebhookInstallationDeleted
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationNewPermissionsAccepted(array $payload): WebhookInstallationNewPermissionsAccepted
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationSuspend(array $payload): WebhookInstallationSuspend
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationUnsuspend(array $payload): WebhookInstallationUnsuspend
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Installation(mixed $object): mixed
    {
        ...
        $account = match ($account::class) {
                        'ApiClients\Client\GitHubEnterpriseCloud\Schema\SimpleUser' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️SimpleUser($account),
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\Enterprise' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Enterprise($account),
        };
