...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetCreated;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetDeleted;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetEdited;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetEdited\Changes;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetEdited\Changes\Enforcement;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetEdited\Changes\Name;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetEdited\Changes\Rules;
...
class RepositoryRuleset implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetCreated' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetCreated($payload),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetDeleted' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetDeleted($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetEdited' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetEdited\Changes' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetEdited\Changes\Name' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Name($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetEdited\Changes\Enforcement' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Enforcement($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetEdited\Changes\Conditions' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Conditions($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetEdited\Changes\Rules' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Rules($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetCreated(array $payload): WebhookRepositoryRulesetCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️RepositoryRuleset($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetCreated', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetDeleted(array $payload): WebhookRepositoryRulesetDeleted
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetDeleted', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited(array $payload): WebhookRepositoryRulesetEdited
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetEdited', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes(array $payload): Changes
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Name($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Enforcement($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Conditions($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Rules($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetEdited\Changes', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Name(array $payload): Name
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetEdited\Changes\Name', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Enforcement(array $payload): Enforcement
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetEdited\Changes\Enforcement', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Conditions(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetEdited\Changes\Conditions
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetEdited\Changes\Conditions', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetEdited\Changes\Conditions::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetEdited\Changes\Conditions(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetEdited\Changes\Conditions', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Rules(array $payload): Rules
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetEdited\Changes\Rules', $exception, stack: $this->hydrationStack);
        }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetCreated' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetCreated($object),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetDeleted' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetDeleted($object),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetEdited' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited($object),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetEdited\Changes' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes($object),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetEdited\Changes\Name' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Name($object),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetEdited\Changes\Enforcement' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Enforcement($object),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetEdited\Changes\Conditions' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Conditions($object),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetEdited\Changes\Rules' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Rules($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetCreated(mixed $object): mixed
    {
        ...
        $repositoryRuleset                                            = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️RepositoryRuleset($repositoryRuleset);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetDeleted(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited(mixed $object): mixed
    {
        ...
        $changes                                 = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes($changes);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes(mixed $object): mixed
    {
        ...
        $name                              = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Name($name);
        after_name:        $result['name'] = $name;
        ...
        $enforcement                                     = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Enforcement($enforcement);
        after_enforcement:        $result['enforcement'] = $enforcement;
        ...
        $conditions                                    = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Conditions($conditions);
        after_conditions:        $result['conditions'] = $conditions;
        ...
        $rules                               = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Rules($rules);
        after_rules:        $result['rules'] = $rules;

        return $result;
    }

    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Name(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Enforcement(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Conditions(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryRulesetEdited\Changes\Conditions);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryRulesetEdited⚡️Changes⚡️Rules(mixed $object): mixed
    {
