...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesAdded\Requester;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookInstallationRepositoriesRemoved;
...
class InstallationRepositories implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesAdded(array $payload): WebhookInstallationRepositoriesAdded
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Installation(array $payload): Installation
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesAdded⚡️Requester(array $payload): Requester
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookInstallationRepositoriesRemoved(array $payload): WebhookInstallationRepositoriesRemoved
    {
        $properties    = [];
        $missingFields = [];
        try {
