...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookCreate;
...
class Create implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookCreate(array $payload): WebhookCreate
    {
        $properties    = [];
        $missingFields = [];
        try {
