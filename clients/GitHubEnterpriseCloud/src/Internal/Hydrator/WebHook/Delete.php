...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookDelete;
...
class Delete implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDelete(array $payload): WebhookDelete
    {
        $properties    = [];
        $missingFields = [];
        try {
