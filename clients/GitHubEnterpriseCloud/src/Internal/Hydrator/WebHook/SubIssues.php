...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSubIssuesParentIssueAdded;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSubIssuesParentIssueRemoved;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSubIssuesSubIssueAdded;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSubIssuesSubIssueRemoved;
...
class SubIssues implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSubIssuesParentIssueAdded' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSubIssuesParentIssueAdded($payload),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSubIssuesParentIssueRemoved' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSubIssuesParentIssueRemoved($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSubIssuesSubIssueAdded' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSubIssuesSubIssueAdded($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSubIssuesSubIssueRemoved' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSubIssuesSubIssueRemoved($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSubIssuesParentIssueAdded(array $payload): WebhookSubIssuesParentIssueAdded
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSubIssuesParentIssueAdded', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSubIssuesParentIssueRemoved(array $payload): WebhookSubIssuesParentIssueRemoved
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSubIssuesParentIssueRemoved', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSubIssuesSubIssueAdded(array $payload): WebhookSubIssuesSubIssueAdded
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSubIssuesSubIssueAdded', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSubIssuesSubIssueRemoved(array $payload): WebhookSubIssuesSubIssueRemoved
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSubIssuesSubIssueRemoved', $exception, stack: $this->hydrationStack);
        }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSubIssuesParentIssueAdded' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSubIssuesParentIssueAdded($object),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSubIssuesParentIssueRemoved' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSubIssuesParentIssueRemoved($object),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSubIssuesSubIssueAdded' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSubIssuesSubIssueAdded($object),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSubIssuesSubIssueRemoved' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSubIssuesSubIssueRemoved($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSubIssuesParentIssueAdded(mixed $object): mixed
    {
        ...
        $parentIssue                                      = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Issue($parentIssue);
        after_parentIssue:        $result['parent_issue'] = $parentIssue;

        $parentIssueRepo                                           = $object->parentIssueRepo;
        $parentIssueRepo                                           = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Repository($parentIssueRepo);
        ...
        $subIssue                                   = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Issue($subIssue);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSubIssuesParentIssueRemoved(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSubIssuesSubIssueAdded(mixed $object): mixed
    {
        ...
        $subIssueRepo                                        = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️Repository($subIssueRepo);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSubIssuesSubIssueRemoved(mixed $object): mixed
    {
