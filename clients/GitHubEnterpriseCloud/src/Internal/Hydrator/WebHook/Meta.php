...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookMetaDeleted;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookMetaDeleted\Hook;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookMetaDeleted\Hook\Config;
...
class Meta implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookMetaDeleted(array $payload): WebhookMetaDeleted
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookMetaDeleted⚡️Hook(array $payload): Hook
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookMetaDeleted⚡️Hook⚡️Config(array $payload): Config
    {
        $properties    = [];
        $missingFields = [];
        try {
