...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookMergeGroupChecksRequested;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookMergeGroupDestroyed;
...
class MergeGroup implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookMergeGroupChecksRequested' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookMergeGroupChecksRequested($payload),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\MergeGroup' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️MergeGroup($payload),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookMergeGroupDestroyed' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookMergeGroupDestroyed($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookMergeGroupChecksRequested(array $payload): WebhookMergeGroupChecksRequested
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️MergeGroup($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookMergeGroupChecksRequested::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookMergeGroupChecksRequested(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookMergeGroupChecksRequested', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️MergeGroup(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\MergeGroup
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\MergeGroup', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\MergeGroup::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\MergeGroup(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\MergeGroup', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookMergeGroupDestroyed(array $payload): WebhookMergeGroupDestroyed
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookMergeGroupDestroyed', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookMergeGroupDestroyed::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookMergeGroupDestroyed(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookMergeGroupDestroyed', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\MergeGroup' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️MergeGroup($object),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookMergeGroupDestroyed' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookMergeGroupDestroyed($object),
    ...
    {
        assert($object instanceof WebhookMergeGroupChecksRequested);
        $result = [];
        ...
        $mergeGroup                                     = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️MergeGroup($mergeGroup);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️MergeGroup(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\MergeGroup);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookMergeGroupDestroyed(mixed $object): mixed
    {
        assert($object instanceof WebhookMergeGroupDestroyed);
        $result = [];
