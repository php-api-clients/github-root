...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookMembershipAdded;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookMembershipAdded\Sender;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookMembershipRemoved;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksTeam;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksTeam\Parent_;
...
class Membership implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookMembershipAdded' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookMembershipAdded($payload),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksTeam' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksTeam($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksTeam\Parent_' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksTeam⚡️Parent_($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookMembershipAdded(array $payload): WebhookMembershipAdded
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksTeam($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookMembershipAdded⚡️Sender(array $payload): Sender
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksTeam(array $payload): WebhooksTeam
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksTeam⚡️Parent_($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksTeam', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhooksTeam::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhooksTeam(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksTeam', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksTeam⚡️Parent_(array $payload): Parent_
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksTeam\Parent_', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookMembershipRemoved(array $payload): WebhookMembershipRemoved
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksTeam' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksTeam($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookMembershipAdded(mixed $object): mixed
    {
        ...
        $member                                = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksUser($member);
        ...
        $team                              = $object->team;
        $team                              = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksTeam($team);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksTeam(mixed $object): mixed
    {
        assert($object instanceof WebhooksTeam);
        $result = [];
        ...
        $parent                                = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksTeam⚡️Parent_($parent);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksTeam⚡️Parent_(mixed $object): mixed
    {
