...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookMembershipAdded\Member;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookMembershipAdded\Sender;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookMembershipAdded\Team;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookMembershipAdded\Team\Parent_;
...
class Membership implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookMembershipAdded⚡️Member(array $payload): Member
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookMembershipAdded⚡️Team(array $payload): Team
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookMembershipAdded⚡️Team⚡️Parent_(array $payload): Parent_
    {
        $properties    = [];
        $missingFields = [];
        try {
