...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPageBuild;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPageBuild\Build;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPageBuild\Build\Error;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPageBuild\Build\Pusher;
...
class PageBuild implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPageBuild(array $payload): WebhookPageBuild
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPageBuild⚡️Build(array $payload): Build
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPageBuild⚡️Build⚡️Error(array $payload): Error
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPageBuild⚡️Build⚡️Pusher(array $payload): Pusher
    {
        $properties    = [];
        $missingFields = [];
        try {
