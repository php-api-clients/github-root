...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\HookResponse;
...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPing;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPing\Hook;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPing\Hook\Config;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPingFormEncoded;
...
class Ping implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPing(array $payload): WebhookPing
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPing⚡️Hook(array $payload): Hook
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPing⚡️Hook⚡️Config(array $payload): Config
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️HookResponse(array $payload): HookResponse
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPingFormEncoded(array $payload): WebhookPingFormEncoded
    {
        $properties    = [];
        $missingFields = [];
        try {
