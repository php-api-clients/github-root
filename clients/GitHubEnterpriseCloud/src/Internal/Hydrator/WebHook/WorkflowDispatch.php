...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowDispatch;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowDispatch\Inputs;
...
class WorkflowDispatch implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowDispatch' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowDispatch($payload),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowDispatch\Inputs' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowDispatch⚡️Inputs($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowDispatch(array $payload): WebhookWorkflowDispatch
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowDispatch⚡️Inputs($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowDispatch⚡️Inputs(array $payload): Inputs
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowDispatch\Inputs', $exception, stack: $this->hydrationStack);
        }
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowDispatch(mixed $object): mixed
    {
        ...
        $inputs                                = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookWorkflowDispatch⚡️Inputs($inputs);
