...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksChanges8;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksChanges8\Tier\From;
...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksSponsorship;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksSponsorship\Maintainer;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksSponsorship\Sponsor;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksSponsorship\Sponsorable;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksSponsorship\Tier;
...
class Sponsorship implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSponsorshipCancelled' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSponsorshipCancelled($payload),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksSponsorship' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSponsorship($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksSponsorship\Maintainer' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSponsorship⚡️Maintainer($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksSponsorship\Sponsor' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSponsorship⚡️Sponsor($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksSponsorship\Sponsorable' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSponsorship⚡️Sponsorable($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksSponsorship\Tier' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSponsorship⚡️Tier($payload),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksChanges8' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksChanges8($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksChanges8\Tier' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksChanges8⚡️Tier($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksChanges8\Tier\From' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksChanges8⚡️Tier⚡️From($payload),
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSponsorship($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSponsorship(array $payload): WebhooksSponsorship
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSponsorship⚡️Maintainer($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSponsorship⚡️Sponsor($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSponsorship⚡️Sponsorable($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSponsorship⚡️Tier($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksSponsorship', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSponsorship⚡️Maintainer(array $payload): Maintainer
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksSponsorship\Maintainer', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSponsorship⚡️Sponsor(array $payload): Sponsor
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksSponsorship\Sponsor', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSponsorship⚡️Sponsorable(array $payload): Sponsorable
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksSponsorship\Sponsorable', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSponsorship⚡️Tier(array $payload): Tier
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksSponsorship\Tier', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSponsorshipPendingTierChange(array $payload): WebhookSponsorshipPendingTierChange
    {
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'changes';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksChanges8($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksChanges8(array $payload): WebhooksChanges8
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'tier';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksChanges8⚡️Tier($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksChanges8', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksChanges8⚡️Tier(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksChanges8\Tier
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksChanges8⚡️Tier⚡️From($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksChanges8\Tier', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksChanges8\Tier::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksChanges8\Tier(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksChanges8\Tier', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksChanges8⚡️Tier⚡️From(array $payload): From
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksChanges8\Tier\From', $exception, stack: $this->hydrationStack);
        }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksSponsorship' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSponsorship($object),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksSponsorship\Maintainer' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSponsorship⚡️Maintainer($object),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksSponsorship\Sponsor' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSponsorship⚡️Sponsor($object),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksSponsorship\Sponsorable' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSponsorship⚡️Sponsorable($object),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksSponsorship\Tier' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSponsorship⚡️Tier($object),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksChanges8' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksChanges8($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSponsorshipCancelled(mixed $object): mixed
    {
        ...
        $sponsorship                                     = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSponsorship($sponsorship);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSponsorship(mixed $object): mixed
    {
        ...
        $maintainer                                    = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSponsorship⚡️Maintainer($maintainer);
        ...
        $sponsor                                 = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSponsorship⚡️Sponsor($sponsor);
        ...
        $sponsorable                                     = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSponsorship⚡️Sponsorable($sponsorable);
        after_sponsorable:        $result['sponsorable'] = $sponsorable;

        $tier                              = $object->tier;
        $tier                              = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSponsorship⚡️Tier($tier);
        after_tier:        $result['tier'] = $tier;

        return $result;
    }

    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSponsorship⚡️Maintainer(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSponsorship⚡️Sponsor(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSponsorship⚡️Sponsorable(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSponsorship⚡️Tier(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSponsorshipPendingTierChange(mixed $object): mixed
    {
        ...
        $changes                                 = $object->changes;
        $changes                                 = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksChanges8($changes);
        after_changes:        $result['changes'] = $changes;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksChanges8(mixed $object): mixed
    {
        assert($object instanceof WebhooksChanges8);
        $result = [];

        $tier                              = $object->tier;
        $tier                              = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksChanges8⚡️Tier($tier);
        after_tier:        $result['tier'] = $tier;

        return $result;
    }

    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksChanges8⚡️Tier(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksChanges8\Tier);
        $result = [];

        $from                              = $object->from;
        $from                              = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksChanges8⚡️Tier⚡️From($from);
        after_from:        $result['from'] = $from;

        return $result;
    }

    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksChanges8⚡️Tier⚡️From(mixed $object): mixed
    {
