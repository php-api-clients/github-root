...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\CvssSeverities;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\CvssSeverities\CvssVFour;
...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\RepositoryAdvisory\Cvss;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\RepositoryAdvisory\Submission;
...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryAdvisoryPublished;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryAdvisoryReported;
...
class RepositoryAdvisory implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryAdvisoryPublished' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryAdvisoryPublished($payload),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryAdvisoryReported' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryAdvisoryReported($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryAdvisoryPublished(array $payload): WebhookRepositoryAdvisoryPublished
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            $value = $payload['repository_advisory'] ?? null;

            if ($value === null) {
                $missingFields[] = 'repository_advisory';
                goto after_repositoryAdvisory;
            }

            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'repositoryAdvisory';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️RepositoryAdvisory($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }

            $properties['repositoryAdvisory'] = $value;

            after_repositoryAdvisory:
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryAdvisoryPublished', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookRepositoryAdvisoryPublished::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookRepositoryAdvisoryPublished(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryAdvisoryPublished', $exception, stack: $this->hydrationStack);
        }
    }
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CvssSeverities($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️RepositoryAdvisory⚡️Submission(array $payload): Submission
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️RepositoryAdvisory⚡️Cvss(array $payload): Cvss
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CvssSeverities(array $payload): CvssSeverities
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CvssSeverities⚡️CvssVThree($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CvssSeverities⚡️CvssVFour($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\CvssSeverities', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CvssSeverities⚡️CvssVThree(array $payload): CvssVThree
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\CvssSeverities\CvssVThree', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CvssSeverities⚡️CvssVFour(array $payload): CvssVFour
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryAdvisoryReported(array $payload): WebhookRepositoryAdvisoryReported
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryAdvisoryReported', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookRepositoryAdvisoryReported::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookRepositoryAdvisoryReported(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryAdvisoryReported', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryAdvisoryPublished' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryAdvisoryPublished($object),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryAdvisoryReported' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryAdvisoryReported($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryAdvisoryPublished(mixed $object): mixed
    {
        assert($object instanceof WebhookRepositoryAdvisoryPublished);
        $result = [];
        ...
        $repositoryAdvisory                                             = $object->repositoryAdvisory;
        $repositoryAdvisory                                             = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️RepositoryAdvisory($repositoryAdvisory);
        after_repositoryAdvisory:        $result['repository_advisory'] = $repositoryAdvisory;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️RepositoryAdvisory(mixed $object): mixed
    {
        ...
        $privateFork                                      = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️SimpleRepository($privateFork);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CvssSeverities(mixed $object): mixed
    {
        ...
        $cvssVThree                                 = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CvssSeverities⚡️CvssVThree($cvssVThree);
        ...
        $cvssVFour                                 = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CvssSeverities⚡️CvssVFour($cvssVFour);
        after_cvssVFour:        $result['cvss_v4'] = $cvssVFour;

        return $result;
    }

    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CvssSeverities⚡️CvssVThree(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️CvssSeverities⚡️CvssVFour(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryAdvisoryReported(mixed $object): mixed
    {
        assert($object instanceof WebhookRepositoryAdvisoryReported);
        $result = [];
