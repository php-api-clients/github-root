...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecretScanningScanCompleted;
...
class SecretScanningScan implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecretScanningScanCompleted' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecretScanningScanCompleted($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecretScanningScanCompleted(array $payload): WebhookSecretScanningScanCompleted
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            $value = $payload['secret_types'] ?? null;

            if ($value === null) {
                $properties['secretTypes'] = null;
                goto after_secretTypes;
            }

            $properties['secretTypes'] = $value;

            after_secretTypes:

            $value = $payload['custom_pattern_name'] ?? null;

            if ($value === null) {
                $properties['customPatternName'] = null;
                goto after_customPatternName;
            }

            $properties['customPatternName'] = $value;

            after_customPatternName:

            $value = $payload['custom_pattern_scope'] ?? null;

            if ($value === null) {
                $properties['customPatternScope'] = null;
                goto after_customPatternScope;
            }

            $properties['customPatternScope'] = $value;

            after_customPatternScope:
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecretScanningScanCompleted', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookSecretScanningScanCompleted::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookSecretScanningScanCompleted(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecretScanningScanCompleted', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecretScanningScanCompleted' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecretScanningScanCompleted($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecretScanningScanCompleted(mixed $object): mixed
    {
        ...
        $secretTypes = $object->secretTypes;

        if ($secretTypes === null) {
            goto after_secretTypes;
        }

        static $secretTypesSerializer0;

        if ($secretTypesSerializer0 === null) {
            $secretTypesSerializer0 = new SerializeArrayItems(...[]);
        }

        $secretTypes                                      = $secretTypesSerializer0->serialize($secretTypes, $this);
        after_secretTypes:        $result['secret_types'] = $secretTypes;

        $customPatternName = $object->customPatternName;

        if ($customPatternName === null) {
            goto after_customPatternName;
        }

        after_customPatternName:        $result['custom_pattern_name'] = $customPatternName;

        $customPatternScope = $object->customPatternScope;

        if ($customPatternScope === null) {
            goto after_customPatternScope;
        }

        after_customPatternScope:        $result['custom_pattern_scope'] = $customPatternScope;
