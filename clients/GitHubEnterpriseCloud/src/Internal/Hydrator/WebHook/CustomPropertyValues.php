...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookCustomPropertyValuesUpdated;
...
class CustomPropertyValues implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookCustomPropertyValuesUpdated' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookCustomPropertyValuesUpdated($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookCustomPropertyValuesUpdated(array $payload): WebhookCustomPropertyValuesUpdated
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            $value = $payload['new_property_values'] ?? null;

            if ($value === null) {
                $missingFields[] = 'new_property_values';
                goto after_newPropertyValues;
            }

            $properties['newPropertyValues'] = $value;

            after_newPropertyValues:

            $value = $payload['old_property_values'] ?? null;

            if ($value === null) {
                $missingFields[] = 'old_property_values';
                goto after_oldPropertyValues;
            }

            $properties['oldPropertyValues'] = $value;

            after_oldPropertyValues:
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookCustomPropertyValuesUpdated', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookCustomPropertyValuesUpdated::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookCustomPropertyValuesUpdated(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookCustomPropertyValuesUpdated', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookCustomPropertyValuesUpdated' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookCustomPropertyValuesUpdated($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookCustomPropertyValuesUpdated(mixed $object): mixed
    {
        assert($object instanceof WebhookCustomPropertyValuesUpdated);
        $result = [];
        ...
        static $newPropertyValuesSerializer0;

        if ($newPropertyValuesSerializer0 === null) {
            $newPropertyValuesSerializer0 = new SerializeArrayItems(...[]);
        }

        $newPropertyValues                                             = $newPropertyValuesSerializer0->serialize($newPropertyValues, $this);
        after_newPropertyValues:        $result['new_property_values'] = $newPropertyValues;

        $oldPropertyValues = $object->oldPropertyValues;
        static $oldPropertyValuesSerializer0;

        if ($oldPropertyValuesSerializer0 === null) {
            $oldPropertyValuesSerializer0 = new SerializeArrayItems(...[]);
        }

        $oldPropertyValues                                             = $oldPropertyValuesSerializer0->serialize($oldPropertyValues, $this);
        after_oldPropertyValues:        $result['old_property_values'] = $oldPropertyValues;
