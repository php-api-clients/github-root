...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookGithubAppAuthorizationRevoked;
...
class GithubAppAuthorization implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookGithubAppAuthorizationRevoked(array $payload): WebhookGithubAppAuthorizationRevoked
    {
        $properties    = [];
        $missingFields = [];
        try {
