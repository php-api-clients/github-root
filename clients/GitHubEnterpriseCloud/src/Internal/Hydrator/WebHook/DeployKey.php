...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookDeployKeyCreated;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookDeployKeyCreated\Key;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookDeployKeyDeleted;
...
class DeployKey implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookDeployKeyCreated' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeployKeyCreated($payload),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookDeployKeyCreated\Key' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeployKeyCreated⚡️Key($payload),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookDeployKeyDeleted' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeployKeyDeleted($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookDeployKeyDeleted\Key' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeployKeyDeleted⚡️Key($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeployKeyCreated(array $payload): WebhookDeployKeyCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeployKeyCreated⚡️Key($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookDeployKeyCreated', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeployKeyCreated⚡️Key(array $payload): Key
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookDeployKeyCreated\Key', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeployKeyDeleted(array $payload): WebhookDeployKeyDeleted
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'key';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeployKeyDeleted⚡️Key($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookDeployKeyDeleted', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeployKeyDeleted⚡️Key(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookDeployKeyDeleted\Key
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookDeployKeyDeleted\Key', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookDeployKeyDeleted\Key::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookDeployKeyDeleted\Key(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookDeployKeyDeleted\Key', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookDeployKeyCreated' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeployKeyCreated($object),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookDeployKeyCreated\Key' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeployKeyCreated⚡️Key($object),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookDeployKeyDeleted' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeployKeyDeleted($object),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookDeployKeyDeleted\Key' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeployKeyDeleted⚡️Key($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeployKeyCreated(mixed $object): mixed
    {
        ...
        $key                             = $object->key;
        $key                             = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeployKeyCreated⚡️Key($key);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeployKeyCreated⚡️Key(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeployKeyDeleted(mixed $object): mixed
    {
        ...
        $key                             = $object->key;
        $key                             = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeployKeyDeleted⚡️Key($key);
        after_key:        $result['key'] = $key;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookDeployKeyDeleted⚡️Key(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookDeployKeyDeleted\Key);
        $result = [];
