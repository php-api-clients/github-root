...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookGollum;
...
class Gollum implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookGollum(array $payload): WebhookGollum
    {
        $properties    = [];
        $missingFields = [];
        try {
