...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookOrgBlockBlocked;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookOrgBlockBlocked\BlockedUser;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookOrgBlockUnblocked;
...
class OrgBlock implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookOrgBlockBlocked(array $payload): WebhookOrgBlockBlocked
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookOrgBlockBlocked::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookOrgBlockBlocked(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookOrgBlockBlocked', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookOrgBlockBlocked⚡️BlockedUser(array $payload): BlockedUser
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(BlockedUser::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new BlockedUser(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookOrgBlockBlocked\BlockedUser', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookOrgBlockUnblocked(array $payload): WebhookOrgBlockUnblocked
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookOrgBlockUnblocked::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookOrgBlockUnblocked(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookOrgBlockUnblocked', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    {
        assert($object instanceof WebhookOrgBlockBlocked);
        $result = [];
    ...
    {
        assert($object instanceof BlockedUser);
        $result = [];
    ...
    {
        assert($object instanceof WebhookOrgBlockUnblocked);
        $result = [];
