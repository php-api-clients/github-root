...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAndAnalysis;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAndAnalysis\Changes;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAndAnalysis\Changes\From;
...
class SecurityAndAnalysis implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAndAnalysis' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecurityAndAnalysis($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAndAnalysis\Changes' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAndAnalysis\Changes\From' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes⚡️From($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecurityAndAnalysis(array $payload): WebhookSecurityAndAnalysis
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes($value);
                } finally {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAndAnalysis', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes(array $payload): Changes
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes⚡️From($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAndAnalysis\Changes', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes⚡️From(array $payload): From
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAndAnalysis\Changes\From', $exception, stack: $this->hydrationStack);
        }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAndAnalysis' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecurityAndAnalysis($object),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAndAnalysis\Changes' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes($object),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAndAnalysis\Changes\From' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes⚡️From($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecurityAndAnalysis(mixed $object): mixed
    {
        assert($object instanceof WebhookSecurityAndAnalysis);
        $result = [];

        $changes                                 = $object->changes;
        $changes                                 = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes($changes);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes(mixed $object): mixed
    {
        ...
        $from                              = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes⚡️From($from);
        after_from:        $result['from'] = $from;

        return $result;
    }

    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecurityAndAnalysis⚡️Changes⚡️From(mixed $object): mixed
    {
