...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookReleaseCreated;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookReleaseDeleted;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookReleaseEdited;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookReleaseEdited\Changes;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookReleaseEdited\Changes\Body;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookReleaseEdited\Changes\MakeLatest;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookReleaseEdited\Changes\Name;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookReleaseEdited\Changes\TagName;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookReleasePrereleased;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookReleasePublished;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookReleaseReleased;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookReleaseUnpublished;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksRelease;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksRelease\Author;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksRelease\Reactions;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksRelease1;
...
class Release implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookReleaseCreated' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookReleaseCreated($payload),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksRelease' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksRelease\Author' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease⚡️Author($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksRelease\Reactions' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease⚡️Reactions($payload),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookReleaseEdited\Changes\TagName' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookReleaseEdited⚡️Changes⚡️TagName($payload),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksRelease1' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease1($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksRelease1\Author' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease1⚡️Author($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksRelease1\Reactions' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease1⚡️Reactions($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookReleaseCreated(array $payload): WebhookReleaseCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease(array $payload): WebhooksRelease
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease⚡️Author($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease⚡️Reactions($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksRelease', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease⚡️Author(array $payload): Author
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksRelease\Author', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease⚡️Reactions(array $payload): Reactions
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksRelease\Reactions', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookReleaseDeleted(array $payload): WebhookReleaseDeleted
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookReleaseEdited(array $payload): WebhookReleaseEdited
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookReleaseEdited⚡️Changes(array $payload): Changes
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookReleaseEdited⚡️Changes⚡️TagName($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookReleaseEdited⚡️Changes⚡️Body(array $payload): Body
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookReleaseEdited⚡️Changes⚡️Name(array $payload): Name
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookReleaseEdited⚡️Changes⚡️TagName(array $payload): TagName
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookReleaseEdited\Changes\TagName', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookReleaseEdited⚡️Changes⚡️MakeLatest(array $payload): MakeLatest
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookReleasePrereleased(array $payload): WebhookReleasePrereleased
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookReleasePublished(array $payload): WebhookReleasePublished
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'release';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease1($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease1(array $payload): WebhooksRelease1
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'author';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease1⚡️Author($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'reactions';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease1⚡️Reactions($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksRelease1', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease1⚡️Author(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksRelease1\Author
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksRelease1\Author', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksRelease1\Author::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksRelease1\Author(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksRelease1\Author', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease1⚡️Reactions(array $payload): \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksRelease1\Reactions
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksRelease1\Reactions', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksRelease1\Reactions::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksRelease1\Reactions(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksRelease1\Reactions', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookReleaseReleased(array $payload): WebhookReleaseReleased
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookReleaseUnpublished(array $payload): WebhookReleaseUnpublished
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksRelease' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease($object),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksRelease\Author' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease⚡️Author($object),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksRelease\Reactions' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease⚡️Reactions($object),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookReleaseEdited\Changes\TagName' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookReleaseEdited⚡️Changes⚡️TagName($object),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksRelease1' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease1($object),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksRelease1\Author' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease1⚡️Author($object),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksRelease1\Reactions' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease1⚡️Reactions($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookReleaseCreated(mixed $object): mixed
    {
        ...
        $release                                 = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease($release);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease(mixed $object): mixed
    {
        ...
        $author                                = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease⚡️Author($author);
        ...
        $reactions                                   = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease⚡️Reactions($reactions);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease⚡️Author(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease⚡️Reactions(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookReleaseEdited⚡️Changes(mixed $object): mixed
    {
        ...
        $tagName                                  = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookReleaseEdited⚡️Changes⚡️TagName($tagName);
        after_tagName:        $result['tag_name'] = $tagName;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookReleaseEdited⚡️Changes⚡️TagName(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookReleasePublished(mixed $object): mixed
    {
        ...
        $release                                 = $object->release;
        $release                                 = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease1($release);
        after_release:        $result['release'] = $release;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease1(mixed $object): mixed
    {
        ...
        $author                                = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease1⚡️Author($author);
        after_author:        $result['author'] = $author;
        ...
        $reactions                                   = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease1⚡️Reactions($reactions);
        after_reactions:        $result['reactions'] = $reactions;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease1⚡️Author(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksRelease1\Author);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksRelease1⚡️Reactions(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksRelease1\Reactions);
        $result = [];
