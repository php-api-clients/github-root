...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookReleaseCreated\Release\Author;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookReleaseCreated\Release\Reactions;
...
class Release implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookReleaseCreated⚡️Release⚡️Author(array $payload): Author
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookReleaseCreated⚡️Release⚡️Reactions(array $payload): Reactions
    {
        $properties    = [];
        $missingFields = [];
        try {
