...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAdvisoryPublished;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAdvisoryUpdated;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAdvisoryWithdrawn;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksSecurityAdvisory;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksSecurityAdvisory\Cvss;
...
class SecurityAdvisory implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAdvisoryPublished' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecurityAdvisoryPublished($payload),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksSecurityAdvisory' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSecurityAdvisory($payload),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksSecurityAdvisory\Cvss' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSecurityAdvisory⚡️Cvss($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecurityAdvisoryPublished(array $payload): WebhookSecurityAdvisoryPublished
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSecurityAdvisory($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSecurityAdvisory(array $payload): WebhooksSecurityAdvisory
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSecurityAdvisory⚡️Cvss($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksSecurityAdvisory', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSecurityAdvisory⚡️Cvss(array $payload): Cvss
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksSecurityAdvisory\Cvss', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecurityAdvisoryUpdated(array $payload): WebhookSecurityAdvisoryUpdated
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecurityAdvisoryWithdrawn(array $payload): WebhookSecurityAdvisoryWithdrawn
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksSecurityAdvisory' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSecurityAdvisory($object),
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhooksSecurityAdvisory\Cvss' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSecurityAdvisory⚡️Cvss($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecurityAdvisoryPublished(mixed $object): mixed
    {
        ...
        $securityAdvisory                                           = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSecurityAdvisory($securityAdvisory);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSecurityAdvisory(mixed $object): mixed
    {
        assert($object instanceof WebhooksSecurityAdvisory);
        $result = [];

        $cvss                              = $object->cvss;
        $cvss                              = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSecurityAdvisory⚡️Cvss($cvss);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhooksSecurityAdvisory⚡️Cvss(mixed $object): mixed
    {
