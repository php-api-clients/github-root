...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookBranchProtectionConfigurationDisabled;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookBranchProtectionConfigurationEnabled;
...
class BranchProtectionConfiguration implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookBranchProtectionConfigurationDisabled' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookBranchProtectionConfigurationDisabled($payload),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookBranchProtectionConfigurationEnabled' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookBranchProtectionConfigurationEnabled($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookBranchProtectionConfigurationDisabled(array $payload): WebhookBranchProtectionConfigurationDisabled
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookBranchProtectionConfigurationDisabled', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookBranchProtectionConfigurationDisabled::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookBranchProtectionConfigurationDisabled(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookBranchProtectionConfigurationDisabled', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookBranchProtectionConfigurationEnabled(array $payload): WebhookBranchProtectionConfigurationEnabled
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookBranchProtectionConfigurationEnabled', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookBranchProtectionConfigurationEnabled::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookBranchProtectionConfigurationEnabled(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookBranchProtectionConfigurationEnabled', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookBranchProtectionConfigurationDisabled' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookBranchProtectionConfigurationDisabled($object),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookBranchProtectionConfigurationEnabled' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookBranchProtectionConfigurationEnabled($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookBranchProtectionConfigurationDisabled(mixed $object): mixed
    {
        assert($object instanceof WebhookBranchProtectionConfigurationDisabled);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookBranchProtectionConfigurationEnabled(mixed $object): mixed
    {
        assert($object instanceof WebhookBranchProtectionConfigurationEnabled);
        $result = [];
