...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecretScanningAlertCreated;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecretScanningAlertPubliclyLeaked;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecretScanningAlertReopened;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecretScanningAlertResolved;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecretScanningAlertValidated;
...
class SecretScanningAlert implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecretScanningAlertCreated' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecretScanningAlertCreated($payload),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecretScanningAlertPubliclyLeaked' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecretScanningAlertPubliclyLeaked($payload),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecretScanningAlertValidated' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecretScanningAlertValidated($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecretScanningAlertCreated(array $payload): WebhookSecretScanningAlertCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecretScanningAlertPubliclyLeaked(array $payload): WebhookSecretScanningAlertPubliclyLeaked
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecretScanningAlertPubliclyLeaked', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookSecretScanningAlertPubliclyLeaked::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookSecretScanningAlertPubliclyLeaked(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecretScanningAlertPubliclyLeaked', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecretScanningAlertReopened(array $payload): WebhookSecretScanningAlertReopened
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecretScanningAlertResolved(array $payload): WebhookSecretScanningAlertResolved
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecretScanningAlertValidated(array $payload): WebhookSecretScanningAlertValidated
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecretScanningAlertValidated', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookSecretScanningAlertValidated::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookSecretScanningAlertValidated(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecretScanningAlertValidated', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecretScanningAlertPubliclyLeaked' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecretScanningAlertPubliclyLeaked($object),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecretScanningAlertValidated' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecretScanningAlertValidated($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️SecretScanningAlertWebhook(mixed $object): mixed
    {
        ...
        $pushProtectionBypassRequestReviewer                                                                 = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️SimpleUser($pushProtectionBypassRequestReviewer);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecretScanningAlertPubliclyLeaked(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecretScanningAlertValidated(mixed $object): mixed
    {
