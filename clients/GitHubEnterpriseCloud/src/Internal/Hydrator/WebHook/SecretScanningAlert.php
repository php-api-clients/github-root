...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecretScanningAlertRevoked;
...
class SecretScanningAlert implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookSecretScanningAlertRevoked(array $payload): WebhookSecretScanningAlertRevoked
    {
        $properties    = [];
        $missingFields = [];
        try {
