...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPush\HeadCommit\Author;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPush\HeadCommit\Committer;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPush\Pusher;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPush\Repository;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPush\Repository\License;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPush\Repository\Owner;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPush\Repository\Permissions;
...
class Push implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPush(array $payload): WebhookPush
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPush⚡️HeadCommit(array $payload): HeadCommit
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPush⚡️HeadCommit⚡️Author(array $payload): Author
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPush⚡️HeadCommit⚡️Committer(array $payload): Committer
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPush⚡️Pusher(array $payload): Pusher
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPush⚡️Repository(array $payload): Repository
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookIssuesTransferred⚡️Changes⚡️NewRepository⚡️CustomProperties($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPush⚡️Repository⚡️License(array $payload): License
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPush⚡️Repository⚡️Owner(array $payload): Owner
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPush⚡️Repository⚡️Permissions(array $payload): Permissions
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookIssuesTransferred⚡️Changes⚡️NewRepository⚡️CustomProperties(array $payload): CustomProperties
    {
        $properties    = [];
        $missingFields = [];
        try {
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookIssuesTransferred\Changes\NewRepository\CustomProperties', $exception, stack: $this->hydrationStack);
        }
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookPush⚡️Repository(mixed $object): mixed
    {
        ...
        $customProperties                                           = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookIssuesTransferred⚡️Changes⚡️NewRepository⚡️CustomProperties($customProperties);
