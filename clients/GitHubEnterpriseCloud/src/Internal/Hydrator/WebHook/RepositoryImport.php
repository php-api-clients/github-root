...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryImport;
...
class RepositoryImport implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookRepositoryImport(array $payload): WebhookRepositoryImport
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(WebhookRepositoryImport::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new WebhookRepositoryImport(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryImport', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    {
        assert($object instanceof WebhookRepositoryImport);
        $result = [];
