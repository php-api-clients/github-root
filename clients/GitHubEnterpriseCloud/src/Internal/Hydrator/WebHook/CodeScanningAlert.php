...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookCodeScanningAlertClosedByUser\Alert\DismissalApprovedBy;
...
class CodeScanningAlert implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookCodeScanningAlertAppearedInBranch' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookCodeScanningAlertAppearedInBranch($payload),
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookCodeScanningAlertClosedByUser\Alert\DismissalApprovedBy' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookCodeScanningAlertClosedByUser⚡️Alert⚡️DismissalApprovedBy($payload),
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookCodeScanningAlertClosedByUser⚡️Alert⚡️DismissalApprovedBy($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookCodeScanningAlertClosedByUser⚡️Alert⚡️DismissalApprovedBy(array $payload): DismissalApprovedBy
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookCodeScanningAlertClosedByUser\Alert\DismissalApprovedBy', $exception, stack: $this->hydrationStack);
        }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookCodeScanningAlertClosedByUser\Alert\DismissalApprovedBy' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookCodeScanningAlertClosedByUser⚡️Alert⚡️DismissalApprovedBy($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookCodeScanningAlertClosedByUser⚡️Alert(mixed $object): mixed
    {
        ...
        $dismissalApprovedBy                                               = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookCodeScanningAlertClosedByUser⚡️Alert⚡️DismissalApprovedBy($dismissalApprovedBy);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterpriseCloud⚡️Schema⚡️WebhookCodeScanningAlertClosedByUser⚡️Alert⚡️DismissalApprovedBy(mixed $object): mixed
    {
