...
final class ListDockerMigrationConflictingPackagesForUser
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Users\Username\Docker\Conflicts $hydrator, string $username)
    {
    ...
    {
        return new Request('GET', str_replace(['{username}'], [$this->username], '/users/{username}/docker/conflicts'));
    }
