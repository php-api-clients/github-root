...
final class DeletePackageForUser
{
    ...
    {
        return new Request('DELETE', str_replace(['{package_type}', '{package_name}', '{username}'], [$this->packageType, $this->packageName, $this->username], '/users/{username}/packages/{package_type}/{package_name}'));
    }
