...
final class GetPackageForOrganization
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Orgs\Org\Packages\PackageType\PackageName $hydrator, string $packageType, string $packageName, string $org)
    {
    ...
    {
        return new Request('GET', str_replace(['{package_type}', '{package_name}', '{org}'], [$this->packageType, $this->packageName, $this->org], '/orgs/{org}/packages/{package_type}/{package_name}'));
    }
