...
final class GetAllCostCenters
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Enterprises\Enterprise\Settings\Billing\CostCenters $hydrator, string $enterprise)
    {
    ...
    {
        return new Request('GET', str_replace(['{enterprise}'], [$this->enterprise], '/enterprises/{enterprise}/settings/billing/cost-centers'));
    }

    public function createResponse(ResponseInterface $response): Schema\GetAllCostCenters
    {
        ...
        switch ($contentType) {
            case 'application/json':
                ...
                switch ($code) {
                     ...
                     **/
                    case 200:
                        $this->responseSchemaValidator->validate($body, Reader::readFromJson(Schema\GetAllCostCenters::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));

                        return $this->hydrator->hydrateObject(Schema\GetAllCostCenters::class, $body);
                    /**
                     * Bad Request
                     **/
