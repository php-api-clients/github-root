...
final class GetServerStatistics
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\EnterpriseInstallation\EnterpriseOrOrg\ServerStatistics $hydrator, string $enterpriseOrOrg, string $dateStart, string $dateEnd)
    {
