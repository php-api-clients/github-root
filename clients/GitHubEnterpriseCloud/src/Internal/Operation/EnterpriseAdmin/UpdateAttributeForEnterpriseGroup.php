...
final class UpdateAttributeForEnterpriseGroup
{
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('PATCH', str_replace(['{scim_group_id}', '{enterprise}'], [$this->scimGroupId, $this->enterprise], '/scim/v2/enterprises/{enterprise}/Groups/{scim_group_id}'), ['Content-Type' => 'application/json'], json_encode($data));
    }
