...
final class GetEnterpriseCustomProperties
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Enterprises\Enterprise\Properties\Schema $hydrator, string $enterprise)
    {
    ...
    {
        return new Request('GET', str_replace(['{enterprise}'], [$this->enterprise], '/enterprises/{enterprise}/properties/schema'));
    }
