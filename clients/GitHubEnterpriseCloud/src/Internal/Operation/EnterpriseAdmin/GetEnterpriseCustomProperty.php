...
final class GetEnterpriseCustomProperty
{
    ...
    {
        return new Request('GET', str_replace(['{enterprise}', '{custom_property_name}'], [$this->enterprise, $this->customPropertyName], '/enterprises/{enterprise}/properties/schema/{custom_property_name}'));
    }
