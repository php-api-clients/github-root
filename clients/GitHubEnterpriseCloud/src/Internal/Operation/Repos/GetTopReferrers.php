...
final class GetTopReferrers
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Traffic\Popular\Referrers $hydrator, string $owner, string $repo)
    {
        $this->owner = $owner;
        $this->repo  = $repo;
    }
    ...
    {
        return new Request('GET', str_replace(['{owner}', '{repo}'], [$this->owner, $this->repo], '/repos/{owner}/{repo}/traffic/popular/referrers'));
    }
                    ...
                    case 200:
                        return Observable::fromArray($body, new ImmediateScheduler())->map(function (array $body): Schema\ReferrerTraffic {
                            ...
                            try {
                                ...
                                return $this->hydrator->hydrateObject(Schema\ReferrerTraffic::class, $body);
