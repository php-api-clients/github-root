...
final class DeleteHostedRunnerForEnterprise
{
    ...
    {
        return new Request('DELETE', str_replace(['{enterprise}', '{hosted_runner_id}'], [$this->enterprise, $this->hostedRunnerId], '/enterprises/{enterprise}/actions/hosted-runners/{hosted_runner_id}'));
    }
