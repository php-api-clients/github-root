...
final class SetWorkflowAccessToRepository
{
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('PUT', str_replace(['{owner}', '{repo}'], [$this->owner, $this->repo], '/repos/{owner}/{repo}/actions/permissions/access'), ['Content-Type' => 'application/json'], json_encode($data));
    }
