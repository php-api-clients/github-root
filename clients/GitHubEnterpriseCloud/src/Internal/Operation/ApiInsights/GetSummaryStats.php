...
final class GetSummaryStats
{
    ...
    {
        return new Request('GET', str_replace(['{org}', '{min_timestamp}', '{max_timestamp}'], [$this->org, $this->minTimestamp, $this->maxTimestamp], '/orgs/{org}/insights/api/summary-stats' . '?min_timestamp={min_timestamp}&max_timestamp={max_timestamp}'));
    }
