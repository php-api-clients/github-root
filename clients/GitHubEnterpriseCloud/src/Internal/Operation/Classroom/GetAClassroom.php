...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Classroom;
...
final class GetAClassroom
{
    ...
    {
        return new Request('GET', str_replace(['{classroom_id}'], [$this->classroomId], '/classrooms/{classroom_id}'));
    }
