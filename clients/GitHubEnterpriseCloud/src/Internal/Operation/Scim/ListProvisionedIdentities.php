...
final class ListProvisionedIdentities
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Scim\V2\Organizations\Org\Users $hydrator, string $org, int $startIndex, int $count, string $filter)
    {
        $this->org        = $org;
