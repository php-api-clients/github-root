...
final class GetOrgSecret
{
    ...
    {
        return new Request('GET', str_replace(['{org}', '{secret_name}'], [$this->org, $this->secretName], '/orgs/{org}/codespaces/secrets/{secret_name}'));
    }

    public function createResponse(ResponseInterface $response): Schema\CodespacesOrgSecret
    {
