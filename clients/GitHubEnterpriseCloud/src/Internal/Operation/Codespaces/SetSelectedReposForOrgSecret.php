...
final class SetSelectedReposForOrgSecret
{
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('PUT', str_replace(['{org}', '{secret_name}'], [$this->org, $this->secretName], '/orgs/{org}/codespaces/secrets/{secret_name}/repositories'), ['Content-Type' => 'application/json'], json_encode($data));
    }
