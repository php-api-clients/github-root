...
final class ListInOrganization
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Orgs\Org\Codespaces $hydrator, string $org, int $perPage = 30, int $page = 1)
    {
        $this->org     = $org;
