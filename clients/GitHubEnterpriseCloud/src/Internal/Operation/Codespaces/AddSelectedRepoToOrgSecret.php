...
final class AddSelectedRepoToOrgSecret
{
    ...
    {
        return new Request('PUT', str_replace(['{org}', '{secret_name}', '{repository_id}'], [$this->org, $this->secretName, $this->repositoryId], '/orgs/{org}/codespaces/secrets/{secret_name}/repositories/{repository_id}'));
    }
