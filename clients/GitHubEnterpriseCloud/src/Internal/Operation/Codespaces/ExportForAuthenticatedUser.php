...
final class ExportForAuthenticatedUser
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\User\Codespaces\CodespaceName\Exports $hydrator, string $codespaceName)
    {
    ...
    {
        return new Request('POST', str_replace(['{codespace_name}'], [$this->codespaceName], '/user/codespaces/{codespace_name}/exports'));
    }
