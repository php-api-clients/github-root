...
final class GetCustomRole
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Orgs\Org\CustomRoles\RoleId $hydrator, string $org, int $roleId)
    {
        $this->org    = $org;
        $this->roleId = $roleId;
    }
    ...
    {
        return new Request('GET', str_replace(['{org}', '{role_id}'], [$this->org, $this->roleId], '/orgs/{org}/custom_roles/{role_id}'));
    }
