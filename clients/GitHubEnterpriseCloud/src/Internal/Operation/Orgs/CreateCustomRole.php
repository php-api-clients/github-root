...
final class CreateCustomRole
{
    ...
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Orgs\Org\CustomRoles $hydrator, string $org)
    {
        $this->org = $org;
    }
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('POST', str_replace(['{org}'], [$this->org], '/orgs/{org}/custom_roles'), ['Content-Type' => 'application/json'], json_encode($data));
    }
