...
final class GetConfigurationsForEnterprise
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Enterprises\Enterprise\CodeSecurity\Configurations $hydrator, string $enterprise, string $before, string $after, int $perPage = 30)
    {
    ...
    {
        return new Request('GET', str_replace(['{enterprise}', '{before}', '{after}', '{per_page}'], [$this->enterprise, $this->before, $this->after, $this->perPage], '/enterprises/{enterprise}/code-security/configurations' . '?before={before}&after={after}&per_page={per_page}'));
    }
