...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Dependabot;
...
final class ListAlertsForEnterprise
{
    ...
    {
        return new Request('GET', str_replace(['{enterprise}', '{state}', '{severity}', '{ecosystem}', '{package}', '{epss_percentage}', '{scope}', '{before}', '{after}', '{last}', '{sort}', '{direction}', '{first}', '{per_page}'], [$this->enterprise, $this->state, $this->severity, $this->ecosystem, $this->package, $this->epssPercentage, $this->scope, $this->before, $this->after, $this->last, $this->sort, $this->direction, $this->first, $this->perPage], '/enterprises/{enterprise}/dependabot/alerts' . '?state={state}&severity={severity}&ecosystem={ecosystem}&package={package}&epss_percentage={epss_percentage}&scope={scope}&before={before}&after={after}&last={last}&sort={sort}&direction={direction}&first={first}&per_page={per_page}'));
    }
