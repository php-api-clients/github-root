...
/** @internal */
final class SecretScanningScan implements WebHookInterface
{
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly Internal\Hydrator\WebHook\SecretScanningScan $hydrator)
    {
    }

    public function resolve(array $headers, array $data): Schema\WebhookSecretScanningScanCompleted
    {
        ...
        if ($headers['content-type'] === 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($data, Reader::readFromJson(Schema\WebhookSecretScanningScanCompleted::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));

                return $this->hydrator->hydrateObject(Schema\WebhookSecretScanningScanCompleted::class, $data);
            } catch (Throwable) {
                goto actions_aaaaa;
            }
        }
