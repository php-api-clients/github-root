...
/** @internal */
final class ExemptionRequestPushRuleset implements WebHookInterface
{
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly Internal\Hydrator\WebHook\ExemptionRequestPushRuleset $hydrator)
    {
    }
