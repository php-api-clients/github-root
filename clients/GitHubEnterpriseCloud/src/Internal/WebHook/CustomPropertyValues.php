...
/** @internal */
final class CustomPropertyValues implements WebHookInterface
{
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly Internal\Hydrator\WebHook\CustomPropertyValues $hydrator)
    {
    }

    public function resolve(array $headers, array $data): Schema\WebhookCustomPropertyValuesUpdated
    {
        ...
        if ($headers['content-type'] === 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($data, Reader::readFromJson(Schema\WebhookCustomPropertyValuesUpdated::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));

                return $this->hydrator->hydrateObject(Schema\WebhookCustomPropertyValuesUpdated::class, $data);
            } catch (Throwable) {
                goto actions_aaaaa;
            }
        }
