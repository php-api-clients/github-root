...
/** @internal */
final class ExemptionRequestSecretScanning implements WebHookInterface
{
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly Internal\Hydrator\WebHook\ExemptionRequestSecretScanning $hydrator)
    {
    }
