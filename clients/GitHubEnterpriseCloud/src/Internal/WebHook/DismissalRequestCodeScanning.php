...
/** @internal */
final class DismissalRequestCodeScanning implements WebHookInterface
{
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly Internal\Hydrator\WebHook\DismissalRequestCodeScanning $hydrator)
    {
    }

    public function resolve(array $headers, array $data): Schema\WebhookExemptionRequestCreated|Schema\WebhookExemptionRequestResponseSubmitted
    {
