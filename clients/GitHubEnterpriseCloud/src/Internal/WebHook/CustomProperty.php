...
final class CustomProperty implements WebHookInterface
{
    ...
    public function resolve(array $headers, array $data): Schema\WebhookCustomPropertyCreated|Schema\WebhookCustomPropertyDeleted|Schema\WebhookCustomPropertyUpdated
    {
