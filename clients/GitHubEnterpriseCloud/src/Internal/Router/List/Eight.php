...
final class Eight
{
    ...
    /** @return Observable<Schema\TeamDiscussionComment>|Observable<Schema\Reaction>|iterable<int,Schema\CodeScanningAlertInstance>|Observable<Schema\SecretScanningLocation>|WithoutBody */
