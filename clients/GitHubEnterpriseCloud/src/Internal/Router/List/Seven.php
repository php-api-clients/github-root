            ...
            if ($pathChunks[1] === 'enterprises') {
                ...
                if ($pathChunks[2] === '{org}') {
                    if ($pathChunks[3] === 'insights') {
                        if ($pathChunks[4] === 'api') {
                            if ($pathChunks[5] === 'user-stats') {
                                if ($pathChunks[6] === '{user_id}') {
                                    if ($call === 'LIST /orgs/{org}/insights/api/user-stats/{user_id}') {
                                        return $this->routers->internal🔀Router🔀List🔀ApiInsights()->getUserStatsListing($params);
                                    }
                                }
                            }
                        }
                            ...
                            if ($pathChunks[5] === 'copilot') {
                                if ($pathChunks[6] === 'metrics') {
                                    if ($call === 'LIST /orgs/{org}/team/{team_slug}/copilot/metrics') {
                                        return $this->routers->internal🔀Router🔀List🔀Copilot()->copilotMetricsForTeamListing($params);
                                    }
                                } elseif ($pathChunks[6] === 'usage') {
                                    if ($call === 'LIST /orgs/{org}/team/{team_slug}/copilot/usage') {
                                        return $this->routers->internal🔀Router🔀List🔀Copilot()->usageMetricsForTeamListing($params);
                                    }
                                }
                            }
                        }
                            ...
                            if ($pathChunks[5] === '{issue_number}') {
                                if ($pathChunks[6] === 'comments') {
                                    ...
                                    if ($call === 'LIST /repos/{owner}/{repo}/issues/{issue_number}/sub_issues') {
                                        return $this->routers->internal🔀Router🔀List🔀Issues()->listSubIssuesListing($params);
                                    }
                            ...
                            if ($pathChunks[5] === '{ruleset_id}') {
                                if ($pathChunks[6] === 'history') {
                                    if ($call === 'LIST /repos/{owner}/{repo}/rulesets/{ruleset_id}/history') {
                                        return $this->routers->internal🔀Router🔀List🔀Repos()->getRepoRulesetHistoryListing($params);
                                    }
                                }
                            }
                        }
