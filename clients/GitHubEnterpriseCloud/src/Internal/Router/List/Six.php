...
final class Six
{
    ...
    /** @return Observable<Schema\RulesetVersion>|Observable<Schema\MarketplacePurchase>|Observable<Schema\ApiInsightsSubjectStats>|Observable<Schema\Team>|Observable<Schema\MinimalRepository>|Observable<Schema\TeamRoleAssignment>|WithoutBody|Observable<Schema\UserRoleAssignment>|Observable<Schema\TeamDiscussion>|Observable<Schema\OrganizationInvitation>|Observable<Schema\SimpleUser>|Observable<Schema\TeamProject>|Observable<Schema\PushRuleBypassRequest>|Observable<Schema\SecretScanningBypassRequest>|Observable<Schema\CodeScanningAlertItems>|Observable<Schema\CodeScanningAnalysis>|Observable<Schema\DependabotAlert>|Observable<Schema\IssueComment>|Observable<Schema\IssueEvent>|Observable<Schema\PageBuild>|Observable<Schema\PullRequestReviewComment>|Observable<Schema\RuleSuites>|iterable<int,Schema\SecretScanningAlert>|WithoutBody|Observable<Schema\TeamDiscussionComment>|Observable<Schema\Reaction>|Observable<Schema\PackageVersion>|Observable<Schema\Event> */
                    ...
                    if ($pathChunks[3] === 'rulesets') {
                        if ($pathChunks[4] === '{ruleset_id}') {
                            if ($pathChunks[5] === 'history') {
                                if ($call === 'LIST /enterprises/{enterprise}/rulesets/{ruleset_id}/history') {
                                    return $this->routers->internal🔀Router🔀List🔀EnterpriseAdmin()->getEnterpriseRulesetHistoryListing($params);
                                }
                            }
                        }
                    }
                        ...
                        if ($pathChunks[4] === '{ruleset_id}') {
                            if ($pathChunks[5] === 'history') {
                                if ($call === 'LIST /orgs/{org}/rulesets/{ruleset_id}/history') {
                                    return $this->routers->internal🔀Router🔀List🔀Orgs()->getOrgRulesetHistoryListing($params);
                                }
                            }
                        }
