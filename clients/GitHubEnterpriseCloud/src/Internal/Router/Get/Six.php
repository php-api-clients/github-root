...
final class Six
{
    ...
    /** @return Schema\ActionsCacheUsageOrgEnterprise|Schema\Operations\EnterpriseAdmin\ListSelectedOrganizationsEnabledGithubActionsEnterprise\Response\ApplicationJson\Ok|Schema\SelectedActions|Schema\ActionsGetDefaultWorkflowPermissions|Schema\RunnerGroupsEnterprise|iterable<int,Schema\RunnerApplication>|Schema\Runner|Schema\ActionsBillingUsage|Schema\AdvancedSecurityActiveCommitters|Schema\PackagesBillingUsage|Schema\CombinedBillingUsage|iterable<int,Schema\MarketplacePurchase>|Schema\Operations\Actions\GetActionsCacheUsageByRepoForOrg\Response\ApplicationJson\Ok|Schema\Operations\Actions\ListSelectedRepositoriesEnabledGithubActionsOrganization\Response\ApplicationJson\Ok|Schema\RunnerGroupsOrg|Schema\ActionsPublicKey|Schema\OrganizationActionsSecret|Schema\OrganizationActionsVariable|Schema\CodespacesPublicKey|Schema\CodespacesOrgSecret|Schema\Operations\Copilot\ListCopilotSeats\Response\ApplicationJson\Ok|Schema\DependabotPublicKey|Schema\OrganizationDependabotSecret|Schema\WebhookConfig|iterable<int,Schema\HookDeliveryItem>|iterable<int,Schema\Team>|Schema\Operations\Codespaces\GetCodespacesForUserInOrg\Response\ApplicationJson\Ok\Application\Json|WithoutBody|Schema\CopilotSeatDetails|iterable<int,Schema\MinimalRepository>|Schema\Package|Schema\OrgCustomProperty|Schema\RuleSuite|iterable<int,Schema\TeamDiscussion>|Schema\ExternalGroups|iterable<int,Schema\OrganizationInvitation>|iterable<int,Schema\SimpleUser>|iterable<int,Schema\TeamProject>|Schema\ProjectCollaboratorPermission|Schema\Operations\Actions\ListArtifactsForRepo\Response\ApplicationJson\Ok|Schema\ActionsCacheList|Schema\Operations\Actions\ListRepoOrganizationSecrets\Response\ApplicationJson\Ok|Schema\Operations\Actions\ListRepoOrganizationVariables\Response\ApplicationJson\Ok|Schema\ActionsRepositoryPermissions|Schema\Operations\Actions\ListSelfHostedRunnersForRepo\Response\ApplicationJson\Ok\Application\Json|Schema\Operations\Actions\ListWorkflowRunsForRepo\Response\ApplicationJson\Ok|Schema\Operations\Actions\ListRepoSecrets\Response\ApplicationJson\Ok\Application\Json|Schema\Operations\Actions\ListRepoVariables\Response\ApplicationJson\Ok\Application\Json|Schema\Operations\Actions\ListRepoWorkflows\Response\ApplicationJson\Ok|Schema\Autolink|Schema\BranchWithProtection|Schema\BasicError|Schema\CheckRun|Schema\CheckSuite|iterable<int,Schema\CodeScanningAlertItems>|iterable<int,Schema\CodeScanningAnalysis>|Schema\CodeScanningDefaultSetup|Schema\CodeownersErrors|Schema\Operations\Codespaces\ListDevcontainersInRepositoryForAuthenticatedUser\Response\ApplicationJson\Ok|Schema\Operations\Codespaces\RepoMachinesForAuthenticatedUser\Response\ApplicationJson\Ok|Schema\Operations\Codespaces\PreFlightWithRepoForAuthenticatedUser\Response\ApplicationJson\Ok|Schema\CodespacesPermissionsCheckForDevcontainer|Schema\Operations\Codespaces\ListRepoSecrets\Response\ApplicationJson\Ok|Schema\CommitComment|Schema\Commit|Schema\CommunityProfile|Schema\CommitComparison|Schema\ContentDirectory|Schema\ContentFile|Schema\ContentSymlink|Schema\ContentSubmodule|iterable<int,Schema\DependabotAlert>|Schema\Operations\Dependabot\ListRepoSecrets\Response\ApplicationJson\Ok|Schema\DependencyGraphSpdxSbom|Schema\Deployment|Schema\Environment|Schema\Hook|iterable<int,Schema\PorterAuthor>|iterable<int,Schema\PorterLargeFile>|iterable<int,Schema\IssueComment>|iterable<int,Schema\IssueEvent>|Schema\Issue|Schema\DeployKey|Schema\Label|Schema\Milestone|iterable<int,Schema\PageBuild>|Schema\PagesHealthCheck|Schema\EmptyObject|iterable<int,Schema\CustomPropertyValue>|iterable<int,Schema\PullRequestReviewComment>|Schema\PullRequest|Schema\Release|iterable<int,Schema\RuleSuites>|Schema\RepositoryRuleset|iterable<int,Schema\SecretScanningAlert>|Schema\RepositoryAdvisory|iterable<int,int>|Schema\Operations\Repos\GetCodeFrequencyStats\Response\ApplicationJson\Accepted\Application\Json|iterable<int,Schema\CommitActivity>|Schema\Operations\Repos\GetCommitActivityStats\Response\ApplicationJson\Accepted\Application\Json|iterable<int,Schema\ContributorActivity>|Schema\Operations\Repos\GetContributorsStats\Response\ApplicationJson\Accepted\Application\Json|Schema\ParticipationStats|iterable<int,Schema\TagProtection>|Schema\CloneTraffic|Schema\ViewTraffic|Schema\Operations\Actions\ListEnvironmentSecrets\Response\ApplicationJson\Ok\Application\Json|Schema\Operations\Actions\ListEnvironmentVariables\Response\ApplicationJson\Ok\Application\Json|Schema\ScimUserList|iterable<int,Schema\TeamDiscussionComment>|iterable<int,Schema\Reaction>|Schema\TeamRepository|Schema\Operations\Codespaces\ListRepositoriesForSecretForAuthenticatedUser\Response\ApplicationJson\Ok\Application\Json|Schema\CodespaceExportDetails|iterable<int,Schema\PackageVersion>|iterable<int,Schema\Event> */
