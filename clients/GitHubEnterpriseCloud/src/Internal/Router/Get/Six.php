...
final class Six
{
    ...
    /** @return Schema\ActionsCacheUsageOrgEnterprise|Schema\Operations\EnterpriseAdmin\ListSelectedOrganizationsEnabledGithubActionsEnterprise\Response\ApplicationJson\Ok|Schema\SelectedActions|Schema\ActionsGetDefaultWorkflowPermissions|Schema\RunnerGroupsEnterprise|iterable<Schema\RunnerApplication>|Schema\Runner|Schema\ActionsBillingUsage|Schema\AdvancedSecurityActiveCommitters|Schema\PackagesBillingUsage|Schema\CombinedBillingUsage|iterable<Schema\MarketplacePurchase>|Schema\Operations\Actions\GetActionsCacheUsageByRepoForOrg\Response\ApplicationJson\Ok|Schema\Operations\Actions\ListSelectedRepositoriesEnabledGithubActionsOrganization\Response\ApplicationJson\Ok|Schema\RunnerGroupsOrg|Schema\ActionsPublicKey|Schema\OrganizationActionsSecret|Schema\OrganizationActionsVariable|Schema\CodespacesPublicKey|Schema\CodespacesOrgSecret|Schema\Operations\Copilot\ListCopilotSeats\Response\ApplicationJson\Ok|Schema\DependabotPublicKey|Schema\OrganizationDependabotSecret|Schema\WebhookConfig|iterable<Schema\HookDeliveryItem>|iterable<Schema\Team>|Schema\Operations\Codespaces\GetCodespacesForUserInOrg\Response\ApplicationJson\Ok\Application\Json|array{code:int}|Schema\CopilotSeatDetails|iterable<Schema\MinimalRepository>|Schema\Package|iterable<Schema\TeamDiscussion>|Schema\ExternalGroups|iterable<Schema\OrganizationInvitation>|iterable<Schema\SimpleUser>|iterable<Schema\TeamProject>|Schema\ProjectCollaboratorPermission|Schema\Operations\Actions\ListArtifactsForRepo\Response\ApplicationJson\Ok|Schema\ActionsCacheList|Schema\Operations\Actions\ListRepoOrganizationSecrets\Response\ApplicationJson\Ok|Schema\Operations\Actions\ListRepoOrganizationVariables\Response\ApplicationJson\Ok|Schema\ActionsRepositoryPermissions|Schema\Operations\Actions\ListSelfHostedRunnersForRepo\Response\ApplicationJson\Ok\Application\Json|Schema\Operations\Actions\ListWorkflowRunsForRepo\Response\ApplicationJson\Ok|Schema\Operations\Actions\ListRepoSecrets\Response\ApplicationJson\Ok\Application\Json|Schema\Operations\Actions\ListRepoVariables\Response\ApplicationJson\Ok\Application\Json|Schema\Operations\Actions\ListRepoWorkflows\Response\ApplicationJson\Ok|Schema\Autolink|Schema\BranchWithProtection|Schema\BasicError|Schema\CheckRun|Schema\CheckSuite|iterable<Schema\CodeScanningAlertItems>|iterable<Schema\CodeScanningAnalysis>|Schema\CodeScanningDefaultSetup|Schema\CodeownersErrors|Schema\Operations\Codespaces\ListDevcontainersInRepositoryForAuthenticatedUser\Response\ApplicationJson\Ok|Schema\Operations\Codespaces\RepoMachinesForAuthenticatedUser\Response\ApplicationJson\Ok|Schema\Operations\Codespaces\PreFlightWithRepoForAuthenticatedUser\Response\ApplicationJson\Ok|Schema\Operations\Codespaces\ListRepoSecrets\Response\ApplicationJson\Ok|Schema\CommitComment|Schema\Commit|Schema\CommunityProfile|Schema\CommitComparison|Schema\ContentDirectory|Schema\ContentFile|Schema\ContentSymlink|Schema\ContentSubmodule|iterable<Schema\DependabotAlert>|Schema\Operations\Dependabot\ListRepoSecrets\Response\ApplicationJson\Ok|Schema\DependencyGraphSpdxSbom|Schema\Deployment|Schema\Environment|Schema\Hook|iterable<Schema\PorterAuthor>|iterable<Schema\PorterLargeFile>|iterable<Schema\IssueComment>|iterable<Schema\IssueEvent>|Schema\Issue|Schema\DeployKey|Schema\Label|Schema\Milestone|iterable<Schema\PageBuild>|Schema\PagesHealthCheck|Schema\EmptyObject|iterable<Schema\PullRequestReviewComment>|Schema\PullRequest|Schema\Release|Schema\RepositoryRuleset|iterable<Schema\SecretScanningAlert>|Schema\RepositoryAdvisory|iterable<int>|Schema\Operations\Repos\GetCodeFrequencyStats\Response\ApplicationJson\Accepted\Application\Json|iterable<Schema\CommitActivity>|Schema\Operations\Repos\GetCommitActivityStats\Response\ApplicationJson\Accepted\Application\Json|iterable<Schema\ContributorActivity>|Schema\Operations\Repos\GetContributorsStats\Response\ApplicationJson\Accepted\Application\Json|Schema\ParticipationStats|iterable<Schema\TagProtection>|array{code:int,location:string}|Schema\CloneTraffic|Schema\ViewTraffic|Schema\Operations\Actions\ListEnvironmentSecrets\Response\ApplicationJson\Ok\Application\Json|Schema\Operations\Actions\ListEnvironmentVariables\Response\ApplicationJson\Ok\Application\Json|Schema\ScimUserList|iterable<Schema\TeamDiscussionComment>|iterable<Schema\Reaction>|Schema\TeamRepository|Schema\Operations\Codespaces\ListRepositoriesForSecretForAuthenticatedUser\Response\ApplicationJson\Ok\Application\Json|Schema\CodespaceExportDetails|iterable<Schema\PackageVersion>|iterable<Schema\Event> */
