                ...
                if ($pathChunks[2] === '{enterprise}') {
                    if ($pathChunks[3] === 'actions') {
                        if ($pathChunks[4] === 'hosted-runners') {
                            if ($pathChunks[5] === 'images') {
                                if ($pathChunks[6] === 'github-owned') {
                                    if ($call === 'GET /enterprises/{enterprise}/actions/hosted-runners/images/github-owned') {
                                        return $this->routers->internal🔀Router🔀Get🔀Actions()->getHostedRunnersGithubOwnedImagesForEnterprise($params);
                                    }
                                } elseif ($pathChunks[6] === 'partner') {
                                    if ($call === 'GET /enterprises/{enterprise}/actions/hosted-runners/images/partner') {
                                        return $this->routers->internal🔀Router🔀Get🔀Actions()->getHostedRunnersPartnerImagesForEnterprise($params);
                                    }
                                }
                            }
                            ...
                            if ($pathChunks[5] === '{configuration_id}') {
                                if ($pathChunks[6] === 'repositories') {
                                    if ($call === 'GET /enterprises/{enterprise}/code-security/configurations/{configuration_id}/repositories') {
                                        return $this->routers->internal🔀Router🔀Get🔀CodeSecurity()->getRepositoriesForEnterpriseConfiguration($params);
                                    }
                                }
                            }
                        }
                        ...
                        if ($pathChunks[4] === '{ruleset_id}') {
                            if ($pathChunks[5] === 'history') {
                                if ($pathChunks[6] === '{version_id}') {
                                    if ($call === 'GET /enterprises/{enterprise}/rulesets/{ruleset_id}/history/{version_id}') {
                                        return $this->routers->internal🔀Router🔀Get🔀EnterpriseAdmin()->getEnterpriseRulesetVersion($params);
                                    }
                                }
                            }
                        }
                            ...
                            if ($pathChunks[5] === 'copilot') {
                                if ($pathChunks[6] === 'metrics') {
                                    if ($call === 'GET /enterprises/{enterprise}/team/{team_slug}/copilot/metrics') {
                                        return $this->routers->internal🔀Router🔀Get🔀Copilot()->copilotMetricsForEnterpriseTeam($params);
                                    }
                                } elseif ($pathChunks[6] === 'usage') {
                                    if ($call === 'GET /enterprises/{enterprise}/team/{team_slug}/copilot/usage') {
                                        return $this->routers->internal🔀Router🔀Get🔀Copilot()->usageMetricsForEnterpriseTeam($params);
                                    }
                                }
                            }
                        }
                ...
                if ($pathChunks[2] === '{org}') {
                    if ($pathChunks[3] === 'actions') {
                        if ($pathChunks[4] === 'hosted-runners') {
                            if ($pathChunks[5] === 'images') {
                                if ($pathChunks[6] === 'github-owned') {
                                    if ($call === 'GET /orgs/{org}/actions/hosted-runners/images/github-owned') {
                                        return $this->routers->internal🔀Router🔀Get🔀Actions()->getHostedRunnersGithubOwnedImagesForOrg($params);
                                    }
                                } elseif ($pathChunks[6] === 'partner') {
                                    if ($call === 'GET /orgs/{org}/actions/hosted-runners/images/partner') {
                                        return $this->routers->internal🔀Router🔀Get🔀Actions()->getHostedRunnersPartnerImagesForOrg($params);
                                    }
                                }
                            }
                        } elseif ($pathChunks[4] === 'oidc') {
                            ...
                            if ($pathChunks[5] === '{runner_group_id}') {
                                if ($pathChunks[6] === 'hosted-runners') {
                                    if ($call === 'GET /orgs/{org}/actions/runner-groups/{runner_group_id}/hosted-runners') {
                                        return $this->routers->internal🔀Router🔀Get🔀Actions()->listGithubHostedRunnersInGroupForOrg($params);
                                    }
                                } elseif ($pathChunks[6] === 'repositories') {
                            ...
                            if ($pathChunks[5] === 'user-stats') {
                                if ($pathChunks[6] === '{user_id}') {
                                    if ($call === 'GET /orgs/{org}/insights/api/user-stats/{user_id}') {
                                        return $this->routers->internal🔀Router🔀Get🔀ApiInsights()->getUserStats($params);
                                    }
                                }
                            }
                        }
                            ...
                            if ($pathChunks[5] === 'history') {
                                if ($pathChunks[6] === '{version_id}') {
                                    if ($call === 'GET /orgs/{org}/rulesets/{ruleset_id}/history/{version_id}') {
                                        return $this->routers->internal🔀Router🔀Get🔀Orgs()->getOrgRulesetVersion($params);
                                    }
                                }
                            }
                        }
                            ...
                            if ($pathChunks[5] === 'copilot') {
                                if ($pathChunks[6] === 'metrics') {
                                    if ($call === 'GET /orgs/{org}/team/{team_slug}/copilot/metrics') {
                                        return $this->routers->internal🔀Router🔀Get🔀Copilot()->copilotMetricsForTeam($params);
                                    }
                                } elseif ($pathChunks[6] === 'usage') {
                            ...
                            if ($pathChunks[5] === 'push-rules') {
                                if ($pathChunks[6] === '{bypass_request_number}') {
                                    if ($call === 'GET /repos/{owner}/{repo}/bypass-requests/push-rules/{bypass_request_number}') {
                                        return $this->routers->internal🔀Router🔀Get🔀Repos()->getRepoPushBypassRequest($params);
                                    }
                                }
                            } elseif ($pathChunks[5] === 'secret-scanning') {
                                if ($pathChunks[6] === '{bypass_request_number}') {
                                    if ($call === 'GET /repos/{owner}/{repo}/bypass-requests/secret-scanning/{bypass_request_number}') {
                                        return $this->routers->internal🔀Router🔀Get🔀SecretScanning()->getBypassRequest($params);
                                    }
                                }
                            }
                            ...
                            if ($pathChunks[5] === 'comments') {
                                ...
                                if ($pathChunks[6] === 'comments') {
                                    ...
                                    if ($call === 'GET /repos/{owner}/{repo}/issues/{issue_number}/sub_issues') {
                                        return $this->routers->internal🔀Router🔀Get🔀Issues()->listSubIssues($params);
                                    }
                            ...
                            if ($pathChunks[5] === 'rule-suites') {
                                ...
                                if ($pathChunks[6] === 'history') {
                                    if ($call === 'GET /repos/{owner}/{repo}/rulesets/{ruleset_id}/history') {
                                        return $this->routers->internal🔀Router🔀Get🔀Repos()->getRepoRulesetHistory($params);
                                    }
                                }
                            }
