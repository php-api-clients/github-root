...
final class Five
{
    ...
    /** @return |Observable<Schema\GetAuditLogStreamConfigs>|Observable<Schema\CodeScanningOrganizationAlertItems>|Observable<Schema\CodeSecurityConfiguration>|Observable<Schema\CopilotUsageMetricsDay>|Observable<Schema\CopilotUsageMetrics>|iterable<int,Schema\DependabotAlertWithRepository>|\ApiClients\Tools\OpenApiClient\Utils\Response\WithoutBody|Schema\NetworkConfiguration|Schema\NetworkSettings|Observable<Schema\CustomProperty>|Observable<Schema\OrganizationSecretScanningAlert>|Observable<Schema\MarketplacePurchase>|Observable<Schema\Event>|Schema\BasicError|WithoutBody|Observable<Schema\PushRuleBypassRequest>|Observable<Schema\Package>|Observable<Schema\OrgRepoCustomPropertyValues>|Observable<Schema\RuleSuites>|Schema\Operations\HostedCompute\ListNetworkConfigurationsForOrg\Response\ApplicationJson\Ok\Application\Json|Observable<Schema\ProjectCard>|Observable<Schema\Activity>|Observable<Schema\SimpleUser>|Observable<Schema\Autolink>|Observable<Schema\ShortBranch>|Observable<Schema\Collaborator>|Observable<Schema\CommitComment>|Observable<Schema\Commit>|Observable<Schema\Contributor>|Observable<Schema\Deployment>|Observable<Schema\MinimalRepository>|Observable<Schema\Hook>|Observable<Schema\RepositoryInvitation>|Observable<Schema\Issue>|Observable<Schema\DeployKey>|Observable<Schema\Label>|Observable<Schema\Milestone>|Observable<Schema\Thread>|Observable<Schema\Project>|Observable<Schema\PullRequestSimple>|Observable<Schema\Release>|Observable<Schema\RepositoryRuleset>|Observable<Schema\RepositoryAdvisory>|Observable<Schema\Tag>|Observable<Schema\Team> */
