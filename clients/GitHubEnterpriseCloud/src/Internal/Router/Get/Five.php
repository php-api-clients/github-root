...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Codespaces\ListInRepositoryForAuthenticatedUser\Response\ApplicationJson\Ok\Application\Json;
...
final class Five
{
    ...
    /** @return Schema\HookDelivery|Schema\ActionsEnterprisePermissions|Schema\Operations\EnterpriseAdmin\ListSelfHostedRunnerGroupsForEnterprise\Response\ApplicationJson\Ok|Schema\Operations\EnterpriseAdmin\ListSelfHostedRunnersForEnterprise\Response\ApplicationJson\Ok|iterable<int,Schema\CodeScanningOrganizationAlertItems>|iterable<int,Schema\DependabotAlertWithRepository>|WithoutBody|iterable<int,Schema\OrganizationSecretScanningAlert>|Schema\GistComment|iterable<int,Schema\MarketplacePurchase>|Schema\MarketplacePurchase|iterable<int,Schema\Event>|Schema\BasicError|Schema\ThreadSubscription|Schema\ActionsOrganizationPermissions|Schema\Operations\Actions\ListSelfHostedRunnerGroupsForOrg\Response\ApplicationJson\Ok|Schema\Operations\Actions\ListSelfHostedRunnersForOrg\Response\ApplicationJson\Ok|Schema\Operations\Actions\ListOrgSecrets\Response\ApplicationJson\Ok|Schema\Operations\Actions\ListOrgVariables\Response\ApplicationJson\Ok|Schema\Operations\Codespaces\ListOrgSecrets\Response\ApplicationJson\Ok|Schema\CopilotOrganizationDetails|Schema\OrganizationCustomRepositoryRole|Schema\Operations\Dependabot\ListOrgSecrets\Response\ApplicationJson\Ok|iterable<int,Schema\Package>|Schema\ExternalGroup|Schema\OrgHook|Schema\OrgMembership|Schema\Migration|iterable<int,Schema\OrgCustomProperty>|iterable<int,Schema\OrgRepoCustomPropertyValues>|iterable<int,Schema\RuleSuites>|Schema\RepositoryRuleset|Schema\GroupMapping|Schema\TeamFull|Schema\ProjectCard|iterable<int,Schema\ProjectCard>|iterable<int,Schema\Activity>|iterable<int,Schema\SimpleUser>|iterable<int,Schema\Autolink>|Schema\CheckAutomatedSecurityFixes|iterable<int,Schema\ShortBranch>|Schema\Operations\Codespaces\ListInRepositoryForAuthenticatedUser\Response\ApplicationJson\Ok\Application\Json|iterable<int,Schema\Collaborator>|iterable<int,Schema\CommitComment>|iterable<int,Schema\Commit>|iterable<int,Schema\Contributor>|iterable<int,Schema\Deployment>|Schema\Operations\Repos\GetAllEnvironments\Response\ApplicationJson\Ok|iterable<int,Schema\MinimalRepository>|iterable<int,Schema\Hook>|Schema\Import|Schema\Installation|Schema\InteractionLimitResponse|Schema\Operations\Interactions\GetRestrictionsForRepo\Response\ApplicationJson\Ok\Application\Json\One|iterable<int,Schema\RepositoryInvitation>|iterable<int,Schema\Issue>|iterable<int,Schema\DeployKey>|iterable<int,Schema\Label>|Schema\Language|Schema\LicenseContent|iterable<int,Schema\Milestone>|iterable<int,Schema\Thread>|Schema\Page|iterable<int,Schema\Project>|iterable<int,Schema\PullRequestSimple>|Schema\ContentFile|iterable<int,Schema\Release>|iterable<int,Schema\RepositoryRuleset>|iterable<int,Schema\RepositoryAdvisory>|Schema\SimpleUser|Schema\Stargazer|Schema\RepositorySubscription|iterable<int,Schema\Tag>|iterable<int,Schema\Team>|Schema\Topic|Schema\GroupResponse|Schema\UserResponse|Schema\TeamDiscussion|Schema\TeamMembership|Schema\TeamProject|Schema\CodespacesUserPublicKey|Schema\CodespacesSecret|Schema\Operations\Codespaces\CodespaceMachinesForAuthenticatedUser\Response\ApplicationJson\Ok\Application\Json|Schema\Operations\Apps\ListInstallationReposForAuthenticatedUser\Response\ApplicationJson\Ok|Schema\Package */
    public function call(string $call, array $params, array $pathChunks): HookDelivery|ActionsEnterprisePermissions|Ok|\ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\EnterpriseAdmin\ListSelfHostedRunnersForEnterprise\Response\ApplicationJson\Ok|iterable|WithoutBody|GistComment|MarketplacePurchase|BasicError|ThreadSubscription|ActionsOrganizationPermissions|\ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Actions\ListSelfHostedRunnerGroupsForOrg\Response\ApplicationJson\Ok|\ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Actions\ListSelfHostedRunnersForOrg\Response\ApplicationJson\Ok|\ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Actions\ListOrgSecrets\Response\ApplicationJson\Ok|\ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Actions\ListOrgVariables\Response\ApplicationJson\Ok|\ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Codespaces\ListOrgSecrets\Response\ApplicationJson\Ok|CopilotOrganizationDetails|OrganizationCustomRepositoryRole|\ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Dependabot\ListOrgSecrets\Response\ApplicationJson\Ok|ExternalGroup|OrgHook|OrgMembership|Migration|RepositoryRuleset|GroupMapping|TeamFull|ProjectCard|CheckAutomatedSecurityFixes|Json|\ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Repos\GetAllEnvironments\Response\ApplicationJson\Ok|Import|Installation|InteractionLimitResponse|One|Language|LicenseContent|Page|ContentFile|SimpleUser|Stargazer|RepositorySubscription|Topic|GroupResponse|UserResponse|TeamDiscussion|TeamMembership|TeamProject|CodespacesUserPublicKey|CodespacesSecret|\ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Codespaces\CodespaceMachinesForAuthenticatedUser\Response\ApplicationJson\Ok\Application\Json|\ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Apps\ListInstallationReposForAuthenticatedUser\Response\ApplicationJson\Ok|Package
    {
        if ($pathChunks[0] === '') {
            if ($pathChunks[1] === 'app') {
