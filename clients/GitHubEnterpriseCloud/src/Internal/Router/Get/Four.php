                ...
                if ($pathChunks[2] === '{org}') {
                    if ($pathChunks[3] === 'announcement') {
                        ...
                        if ($call === 'GET /orgs/{org}/issue-types') {
                            return $this->routers->internal🔀Router🔀Get🔀Orgs()->listIssueTypes($params);
                        }
