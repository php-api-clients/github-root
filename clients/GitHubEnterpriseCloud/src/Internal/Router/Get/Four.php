                ...
                if ($pathChunks[2] === '{enterprise}') {
                    if ($pathChunks[3] === 'announcement') {
                        ...
                        if ($call === 'GET /enterprises/{enterprise}/network-configurations') {
                            return $this->routers->internal🔀Router🔀Get🔀HostedCompute()->listNetworkConfigurationsForEnterprise($params);
                        }
                    }
                }
                ...
                if ($pathChunks[2] === '{org}') {
                    if ($pathChunks[3] === 'announcement') {
                        ...
                        if ($call === 'GET /orgs/{org}/private-registries') {
                            return $this->routers->internal🔀Router🔀Get🔀PrivateRegistries()->listOrgPrivateRegistries($params);
                        }
