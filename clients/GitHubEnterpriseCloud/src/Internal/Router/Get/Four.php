...
final class Four
{
    ...
    /** @return Schema\WebhookConfig|iterable<int,Schema\HookDeliveryItem>|Schema\Installation|iterable<int,Schema\ClassroomAcceptedAssignment>|iterable<int,Schema\ClassroomAssignmentGrade>|iterable<int,Schema\SimpleClassroomAssignment>|iterable<int,Schema\ServerStatistics>|Schema\AnnouncementBanner|iterable<int,Schema\AuditLogEvent>|Schema\EnterpriseSecurityAnalysisSettings|string|iterable<int,Schema\GistComment>|WithoutBody|iterable<int,Schema\GistCommit>|iterable<int,Schema\GistSimple>|Schema\GistSimple|Schema\GitignoreTemplate|Schema\MarketplacePurchase|iterable<int,Schema\MarketplaceListingPlan>|Schema\Thread|Schema\Operations\Orgs\ListCustomRoles\Response\ApplicationJson\Ok|iterable<int,Schema\SimpleUser>|Schema\Operations\Codespaces\ListInOrganization\Response\ApplicationJson\Ok|iterable<int,Schema\CredentialAuthorization>|Schema\Operations\Orgs\ListCustomRepoRoles\Response\ApplicationJson\Ok\Application\Json|iterable<int,Schema\Event>|Schema\ExternalGroups|iterable<int,Schema\OrganizationInvitation>|iterable<int,Schema\RepositoryFineGrainedPermission>|iterable<int,Schema\OrgHook>|Schema\Operations\Orgs\ListAppInstallations\Response\ApplicationJson\Ok|Schema\InteractionLimitResponse|Schema\Operations\Interactions\GetRestrictionsForOrg\Response\ApplicationJson\Ok\Application\Json\One|iterable<int,Schema\Issue>|iterable<int,Schema\Migration>|iterable<int,Schema\Package>|iterable<int,Schema\OrganizationProgrammaticAccessGrantRequest>|iterable<int,Schema\OrganizationProgrammaticAccessGrant>|iterable<int,Schema\Project>|iterable<int,Schema\MinimalRepository>|iterable<int,Schema\RepositoryRuleset>|iterable<int,Schema\RepositoryAdvisory>|iterable<int,Schema\TeamSimple>|iterable<int,Schema\Team>|Schema\ProjectColumn|iterable<int,Schema\ProjectColumn>|Schema\FullRepository|Schema\BasicError|Schema\ScimEnterpriseGroupList|Schema\ScimEnterpriseUserList|iterable<int,Schema\TeamDiscussion>|iterable<int,Schema\TeamProject>|Schema\Operations\Codespaces\ListSecretsForAuthenticatedUser\Response\ApplicationJson\Ok|Schema\Codespace|Schema\GpgKey|Schema\Key|iterable<int,Schema\UserMarketplacePurchase>|iterable<int,Schema\OrgMembership>|Schema\Migration|Schema\SshSigningKey|iterable<int,Schema\BaseGist>|iterable<int,Schema\GpgKey>|Schema\Hovercard|iterable<int,Schema\KeySimple>|iterable<int,Schema\OrganizationSimple>|iterable<int,Schema\SocialAccount>|iterable<int,Schema\SshSigningKey>|Schema\StarredRepository|Schema\Repository */
