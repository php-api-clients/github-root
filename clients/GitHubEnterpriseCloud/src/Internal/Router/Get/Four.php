...
final class Four
{
    ...
    /** @return |iterable<int,Schema\HookDeliveryItem>|iterable<int,Schema\ClassroomAcceptedAssignment>|Observable<Schema\ClassroomAssignmentGrade>|iterable<int,Schema\SimpleClassroomAssignment>|Observable<Schema\ServerStatistics>|iterable<int,Schema\AuditLogEvent>|string|iterable<int,Schema\GistComment>|\ApiClients\Tools\OpenApiClient\Utils\Response\WithoutBody|iterable<int,Schema\GistCommit>|iterable<int,Schema\GistSimple>|iterable<int,Schema\MarketplaceListingPlan>|iterable<int,Schema\SimpleUser>|Schema\Operations\Codespaces\ListInOrganization\Response\ApplicationJson\Ok|iterable<int,Schema\CredentialAuthorization>|iterable<int,Schema\Event>|Schema\ExternalGroups|iterable<int,Schema\OrganizationInvitation>|Observable<Schema\RepositoryFineGrainedPermission>|iterable<int,Schema\OrgHook>|Schema\Operations\Orgs\ListAppInstallations\Response\ApplicationJson\Ok|iterable<int,Schema\Issue>|iterable<int,Schema\Migration>|Observable<Schema\OrganizationFineGrainedPermission>|iterable<int,Schema\Package>|iterable<int,Schema\OrganizationProgrammaticAccessGrantRequest>|iterable<int,Schema\OrganizationProgrammaticAccessGrant>|iterable<int,Schema\Project>|iterable<int,Schema\MinimalRepository>|iterable<int,Schema\RepositoryRuleset>|iterable<int,Schema\RepositoryAdvisory>|Observable<Schema\TeamSimple>|iterable<int,Schema\Team>|iterable<int,Schema\ProjectColumn>|iterable<int,Schema\TeamDiscussion>|iterable<int,Schema\TeamProject>|Schema\Operations\Codespaces\ListSecretsForAuthenticatedUser\Response\ApplicationJson\Ok|Observable<Schema\Package>|iterable<int,Schema\UserMarketplacePurchase>|iterable<int,Schema\OrgMembership>|iterable<int,Schema\BaseGist>|iterable<int,Schema\GpgKey>|iterable<int,Schema\KeySimple>|iterable<int,Schema\OrganizationSimple>|iterable<int,Schema\SocialAccount>|iterable<int,Schema\SshSigningKey>|Schema\StarredRepository|Schema\Repository */
