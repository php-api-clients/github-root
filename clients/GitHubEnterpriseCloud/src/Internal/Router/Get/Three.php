...
final class Three
{
    ...
    /** @return |iterable<int,Schema\IntegrationInstallationRequest>|\ApiClients\Tools\OpenApiClient\Utils\Response\WithoutBody|iterable<int,Schema\Installation>|iterable<int,Schema\BaseGist>|Observable<string>|WithoutBody|Schema\Operations\Apps\ListReposAccessibleToInstallation\Response\ApplicationJson\Ok|iterable<int,Schema\MarketplaceListingPlan>|Schema\Operations\Search\Code\Response\ApplicationJson\Ok|Schema\Operations\Search\Commits\Response\ApplicationJson\Ok|Schema\Operations\Search\IssuesAndPullRequests\Response\ApplicationJson\Ok|Schema\Operations\Search\Labels\Response\ApplicationJson\Ok|Schema\Operations\Search\Repos\Response\ApplicationJson\Ok|Schema\Operations\Search\Topics\Response\ApplicationJson\Ok|Schema\Operations\Search\Users\Response\ApplicationJson\Ok|iterable<int,Schema\SimpleUser>|Schema\Operations\Codespaces\ListForAuthenticatedUser\Response\ApplicationJson\Ok\Application\Json|iterable<int,Schema\Email>|iterable<int,Schema\GpgKey>|Schema\Operations\Apps\ListInstallationsForAuthenticatedUser\Response\ApplicationJson\Ok\Application\Json|iterable<int,Schema\Issue>|iterable<int,Schema\Key>|iterable<int,Schema\UserMarketplacePurchase>|iterable<int,Schema\Migration>|iterable<int,Schema\OrganizationSimple>|iterable<int,Schema\Package>|iterable<int,Schema\Repository>|iterable<int,Schema\RepositoryInvitation>|iterable<int,Schema\SocialAccount>|iterable<int,Schema\SshSigningKey>|iterable<int,Schema\MinimalRepository>|iterable<int,Schema\TeamFull> */
