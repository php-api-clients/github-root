...
final class Three
{
    ...
    /** @return Schema\GlobalAdvisory|iterable<int,Schema\IntegrationInstallationRequest>|WithoutBody|iterable<int,Schema\Installation>|Schema\Integration|Schema\ClassroomAssignment|Schema\Classroom|Schema\CodeOfConduct|iterable<int,Schema\BaseGist>|Schema\GistSimple|iterable<int,string>|Schema\Operations\Apps\ListReposAccessibleToInstallation\Response\ApplicationJson\Ok|Schema\License|iterable<int,Schema\MarketplaceListingPlan>|Schema\OrganizationFull|Schema\Project|Schema\Operations\Search\Code\Response\ApplicationJson\Ok|Schema\Operations\Search\Commits\Response\ApplicationJson\Ok|Schema\Operations\Search\IssuesAndPullRequests\Response\ApplicationJson\Ok|Schema\Operations\Search\Labels\Response\ApplicationJson\Ok|Schema\Operations\Search\Repos\Response\ApplicationJson\Ok|Schema\Operations\Search\Topics\Response\ApplicationJson\Ok|Schema\Operations\Search\Users\Response\ApplicationJson\Ok|Schema\TeamFull|iterable<int,Schema\SimpleUser>|Schema\Operations\Codespaces\ListForAuthenticatedUser\Response\ApplicationJson\Ok\Application\Json|iterable<int,Schema\Email>|iterable<int,Schema\GpgKey>|Schema\Operations\Apps\ListInstallationsForAuthenticatedUser\Response\ApplicationJson\Ok\Application\Json|Schema\InteractionLimitResponse|Schema\Operations\Interactions\GetRestrictionsForAuthenticatedUser\Response\ApplicationJson\Ok\Application\Json\One|iterable<int,Schema\Issue>|iterable<int,Schema\Key>|iterable<int,Schema\UserMarketplacePurchase>|iterable<int,Schema\Migration>|iterable<int,Schema\OrganizationSimple>|iterable<int,Schema\Package>|iterable<int,Schema\Repository>|iterable<int,Schema\RepositoryInvitation>|iterable<int,Schema\SocialAccount>|iterable<int,Schema\SshSigningKey>|iterable<int,Schema\MinimalRepository>|iterable<int,Schema\TeamFull>|Schema\PrivateUser|Schema\PublicUser */
