...
final class SecretScanning
{
    ...
    public function listOrgBypassRequests(array $params): iterable
    {
        ...
        unset($params['page']);
        $operator = new Internal\Operator\SecretScanning\ListOrgBypassRequests($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀BypassRequests🌀SecretScanning());
    ...
    public function listRepoBypassRequests(array $params): iterable
    {
        ...
        $arguments['page'] = $params['page'];
        unset($params['page']);
        $operator = new Internal\Operator\SecretScanning\ListRepoBypassRequests($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀BypassRequests🌀SecretScanning());
    ...
    public function getBypassRequest(array $params): SecretScanningBypassRequest
    {
        ...
        $operator = new Internal\Operator\SecretScanning\GetBypassRequest($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀BypassRequests🌀SecretScanning🌀BypassRequestNumber());
