...
final class Search
{
    ...
    /** @return */
    public function commits(array $params): \ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Search\Commits\Response\ApplicationJson\Ok|WithoutBody
    {
        $arguments = [];
        if (array_key_exists('q', $params) === false) {
            throw new InvalidArgumentException('Missing mandatory field: q');
    ...
    /** @return */
    public function issuesAndPullRequests(array $params): \ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Search\IssuesAndPullRequests\Response\ApplicationJson\Ok|WithoutBody
    {
        $arguments = [];
        if (array_key_exists('q', $params) === false) {
            throw new InvalidArgumentException('Missing mandatory field: q');
    ...
    /** @return */
    public function labels(array $params): \ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Search\Labels\Response\ApplicationJson\Ok|WithoutBody
    {
        $arguments = [];
    ...
    /** @return */
    public function repos(array $params): \ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Search\Repos\Response\ApplicationJson\Ok|WithoutBody
    {
        $arguments = [];
        if (array_key_exists('q', $params) === false) {
            throw new InvalidArgumentException('Missing mandatory field: q');
    ...
    /** @return */
    public function topics(array $params): \ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Search\Topics\Response\ApplicationJson\Ok|WithoutBody
    {
        $arguments = [];
        if (array_key_exists('q', $params) === false) {
            throw new InvalidArgumentException('Missing mandatory field: q');
    ...
    /** @return */
    public function users(array $params): \ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Search\Users\Response\ApplicationJson\Ok|WithoutBody
    {
        $arguments = [];
        if (array_key_exists('q', $params) === false) {
            throw new InvalidArgumentException('Missing mandatory field: q');
