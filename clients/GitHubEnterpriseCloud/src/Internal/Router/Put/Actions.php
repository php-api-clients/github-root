...
final class Actions
{
    ...
    /** @return */
    public function setActionsOidcCustomIssuerPolicyForEnterprise(array $params): WithoutBody
    {
        $arguments = [];
        ...
        $operator = new Internal\Operator\Actions\SetActionsOidcCustomIssuerPolicyForEnterprise($this->browser, $this->authentication, $this->requestSchemaValidator);
    ...
    /** @return */
    public function setGithubActionsDefaultWorkflowPermissionsEnterprise(array $params): WithoutBody
    {
        $arguments = [];
        if (array_key_exists('enterprise', $params) === false) {
            throw new InvalidArgumentException('Missing mandatory field: enterprise');
        ...
        $arguments['enterprise'] = $params['enterprise'];
        unset($params['enterprise']);
        $operator = new Internal\Operator\Actions\SetGithubActionsDefaultWorkflowPermissionsEnterprise($this->browser, $this->authentication, $this->requestSchemaValidator);
