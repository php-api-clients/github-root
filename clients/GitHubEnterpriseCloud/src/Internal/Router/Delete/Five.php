            ...
            if ($pathChunks[1] === 'app') {
                ...
                if ($pathChunks[2] === '{org}') {
                    if ($pathChunks[3] === 'blocks') {
                        ...
                        if ($pathChunks[4] === '{credential_id}') {
                            if ($call === 'DELETE /orgs/{org}/credential-authorizations/{credential_id}') {
                                return $this->routers->internal🔀Router🔀Delete🔀Orgs()->removeSamlSsoAuthorization($params);
                            }
                        }
                        ...
                        if ($pathChunks[4] === '{role_id}') {
                            if ($call === 'DELETE /orgs/{org}/custom-repository-roles/{role_id}') {
                                return $this->routers->internal🔀Router🔀Delete🔀Orgs()->deleteCustomRepoRole($params);
                            }
                        }
                    } elseif ($pathChunks[3] === 'custom_roles') {
                        if ($pathChunks[4] === '{role_id}') {
                            if ($call === 'DELETE /orgs/{org}/custom_roles/{role_id}') {
                                return $this->routers->internal🔀Router🔀Delete🔀Orgs()->deleteCustomRole($params);
                            }
                        }
                        ...
                        if ($pathChunks[4] === '{secret_name}') {
                            if ($call === 'DELETE /orgs/{org}/private-registries/{secret_name}') {
                                return $this->routers->internal🔀Router🔀Delete🔀PrivateRegistries()->deleteOrgPrivateRegistry($params);
                            }
                        }
