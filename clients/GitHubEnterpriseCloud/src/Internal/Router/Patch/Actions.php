...
final class Actions
{
    ...
    public function updateHostedRunnerForEnterprise(array $params): ActionsHostedRunner
    {
        ...
        $operator = new Internal\Operator\Actions\UpdateHostedRunnerForEnterprise($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀Actions🌀HostedRunners🌀HostedRunnerId());
