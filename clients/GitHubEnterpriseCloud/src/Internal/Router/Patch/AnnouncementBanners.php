...
final class AnnouncementBanners
{
    ...
    public function setAnnouncementBannerForEnterprise(array $params): AnnouncementBanner
    {
        ...
        $operator = new Internal\Operator\AnnouncementBanners\SetAnnouncementBannerForEnterprise($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀Announcement());
