...
final class Teams
{
    ...
    public function createOrUpdateIdpGroupConnectionsInOrg(array $params): GroupMapping
    {
        ...
        $arguments['team_slug'] = $params['team_slug'];
        unset($params['team_slug']);
        $operator = new Internal\Operator\Teams\CreateOrUpdateIdpGroupConnectionsInOrg($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Teams🌀TeamSlug🌀TeamSync🌀GroupMappings());
