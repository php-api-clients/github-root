...
final class Orgs
{
    ...
    public function createCustomRepoRole(array $params): OrganizationCustomRepositoryRole
    {
        ...
        unset($params['org']);
        $operator = new Internal\Operator\Orgs\CreateCustomRepoRole($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀CustomRepositoryRoles());
    ...
    public function createCustomRole(array $params): OrganizationCustomRepositoryRole
    {
        ...
        $arguments['org'] = $params['org'];
        unset($params['org']);
        $operator = new Internal\Operator\Orgs\CreateCustomRole($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀CustomRoles());
    ...
    public function createCustomOrganizationRole(array $params): OrganizationRole
    {
        ...
        $arguments['org'] = $params['org'];
        unset($params['org']);
        $operator = new Internal\Operator\Orgs\CreateCustomOrganizationRole($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀OrganizationRoles());
