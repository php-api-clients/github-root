...
final class Scim
{
    ...
    public function provisionAndInviteUser(array $params): ScimUser|array
    {
        ...
        unset($params['org']);
        $operator = new Internal\Operator\Scim\ProvisionAndInviteUser($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Scim🌀V2🌀Organizations🌀Org🌀Users());
