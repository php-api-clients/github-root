...
final class HostedCompute
{
    ...
    public function createNetworkConfigurationForEnterprise(array $params): NetworkConfiguration
    {
        ...
        $operator = new Internal\Operator\HostedCompute\CreateNetworkConfigurationForEnterprise($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀NetworkConfigurations());
