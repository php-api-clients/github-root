...
final class Actions
{
    ...
    public function generateRunnerJitconfigForEnterprise(array $params): Created
    {
        ...
        $operator = new Internal\Operator\Actions\GenerateRunnerJitconfigForEnterprise($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀Actions🌀Runners🌀GenerateJitconfig());
    ...
    public function generateRunnerJitconfigForOrg(array $params): Created
    {
        ...
        unset($params['org']);
        $operator = new Internal\Operator\Actions\GenerateRunnerJitconfigForOrg($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Actions🌀Runners🌀GenerateJitconfig());
    ...
    public function createRepoVariable(array $params): EmptyObject
    {
        ...
        unset($params['repo']);
        $operator = new Internal\Operator\Actions\CreateRepoVariable($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Actions🌀Variables());
    ...
    public function createHostedRunnerForEnterprise(array $params): ActionsHostedRunner
    {
        ...
        $arguments['enterprise'] = $params['enterprise'];
        unset($params['enterprise']);
        $operator = new Internal\Operator\Actions\CreateHostedRunnerForEnterprise($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀Actions🌀HostedRunners());
    ...
    public function createHostedRunnerForOrg(array $params): ActionsHostedRunner
    {
        ...
        $arguments['org'] = $params['org'];
        unset($params['org']);
        $operator = new Internal\Operator\Actions\CreateHostedRunnerForOrg($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Actions🌀HostedRunners());
    ...
    public function createOrgVariable(array $params): EmptyObject
    {
        ...
        $arguments['org'] = $params['org'];
        unset($params['org']);
        $operator = new Internal\Operator\Actions\CreateOrgVariable($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Actions🌀Variables());
    ...
    public function generateRunnerJitconfigForRepo(array $params): Created
    {
        ...
        $arguments['repo'] = $params['repo'];
        unset($params['repo']);
        $operator = new Internal\Operator\Actions\GenerateRunnerJitconfigForRepo($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Actions🌀Runners🌀GenerateJitconfig());
    ...
    public function approveWorkflowRun(array $params): EmptyObject
    {
        ...
        unset($params['run_id']);
        $operator = new Internal\Operator\Actions\ApproveWorkflowRun($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Actions🌀Runs🌀RunId🌀Approve());
    ...
    public function reviewCustomGatesForRun(array $params): WithoutBody
    {
        ...
        $arguments['run_id'] = $params['run_id'];
        unset($params['run_id']);
        $operator = new Internal\Operator\Actions\ReviewCustomGatesForRun($this->browser, $this->authentication, $this->requestSchemaValidator);
