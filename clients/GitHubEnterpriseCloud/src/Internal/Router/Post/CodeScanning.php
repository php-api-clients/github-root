...
final class CodeScanning
{
    ...
    public function createAutofix(array $params): CodeScanningAutofix|WithoutBody
    {
        ...
        $operator = new Internal\Operator\CodeScanning\CreateAutofix($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀CodeScanning🌀Alerts🌀AlertNumber🌀Autofix());
    ...
    public function commitAutofix(array $params): CodeScanningAutofixCommitsResponse|WithoutBody
    {
        ...
        $arguments['alert_number'] = $params['alert_number'];
        unset($params['alert_number']);
        $operator = new Internal\Operator\CodeScanning\CommitAutofix($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀CodeScanning🌀Alerts🌀AlertNumber🌀Autofix🌀Commits());
