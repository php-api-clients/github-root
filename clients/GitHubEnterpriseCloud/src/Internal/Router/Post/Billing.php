...
final class Billing
{
    ...
    public function addResourceToCostCenter(array $params): Ok
    {
        ...
        $operator = new Internal\Operator\Billing\AddResourceToCostCenter($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀Settings🌀Billing🌀CostCenters🌀CostCenterId🌀Resource());
