...
final class Operators
{
    ...
    private Internal\Operator\AnnouncementBanners\GetAnnouncementBannerForEnterprise|null $announcementBanners👷GetAnnouncementBannerForEnterprise                                   = null;
    private Internal\Operator\AnnouncementBanners\RemoveAnnouncementBannerForEnterprise|null $announcementBanners👷RemoveAnnouncementBannerForEnterprise                             = null;
    ...
    private Internal\Operator\Copilot\CopilotMetricsForEnterprise|null $copilot👷CopilotMetricsForEnterprise                                                                         = null;
    private Internal\Operator\Copilot\CopilotMetricsForEnterpriseListing|null $copilot👷CopilotMetricsForEnterpriseListing                                                           = null;
    ...
    private Internal\Operator\Copilot\CopilotMetricsForEnterpriseTeam|null $copilot👷CopilotMetricsForEnterpriseTeam                                                                 = null;
    private Internal\Operator\Copilot\CopilotMetricsForEnterpriseTeamListing|null $copilot👷CopilotMetricsForEnterpriseTeamListing                                                   = null;
    ...
    private Internal\Operator\Orgs\ListSamlSsoAuthorizations|null $orgs👷ListSamlSsoAuthorizations                                                                                   = null;
    private Internal\Operator\Orgs\ListSamlSsoAuthorizationsListing|null $orgs👷ListSamlSsoAuthorizationsListing                                                                     = null;
    private Internal\Operator\Orgs\RemoveSamlSsoAuthorization|null $orgs👷RemoveSamlSsoAuthorization                                                                                 = null;
    ...
    private Internal\Operator\Orgs\CreateCustomRole|null $orgs👷CreateCustomRole                                                                                                     = null;
    private Internal\Operator\Orgs\GetCustomRole|null $orgs👷GetCustomRole                                                                                                           = null;
    private Internal\Operator\Orgs\DeleteCustomRole|null $orgs👷DeleteCustomRole                                                                                                     = null;
    private Internal\Operator\Orgs\UpdateCustomRole|null $orgs👷UpdateCustomRole                                                                                                     = null;
    ...
    private Internal\Operator\Orgs\ListFineGrainedPermissions|null $orgs👷ListFineGrainedPermissions                                                                                 = null;
    ...
    private Internal\Operator\Teams\ListIdpGroupsInOrg|null $teams👷ListIdpGroupsInOrg                                                                                               = null;
    private Internal\Operator\Teams\CreateOrUpdateIdpGroupConnectionsInOrg|null $teams👷CreateOrUpdateIdpGroupConnectionsInOrg                                                       = null;
    ...
    private Internal\Operator\Scim\ListProvisionedIdentities|null $scim👷ListProvisionedIdentities                                                                                   = null;
    private Internal\Operator\Scim\ProvisionAndInviteUser|null $scim👷ProvisionAndInviteUser                                                                                         = null;
    private Internal\Operator\Scim\GetProvisioningInformationForUser|null $scim👷GetProvisioningInformationForUser                                                                   = null;
    private Internal\Operator\Scim\SetInformationForProvisionedUser|null $scim👷SetInformationForProvisionedUser                                                                     = null;
    private Internal\Operator\Scim\DeleteUserFromOrg|null $scim👷DeleteUserFromOrg                                                                                                   = null;
    private Internal\Operator\Scim\UpdateAttributeForUser|null $scim👷UpdateAttributeForUser                                                                                         = null;
    ...
    private Internal\Operator\Teams\ListIdpGroupsForLegacy|null $teams👷ListIdpGroupsForLegacy                                                                                       = null;
    private Internal\Operator\Teams\CreateOrUpdateIdpGroupConnectionsLegacy|null $teams👷CreateOrUpdateIdpGroupConnectionsLegacy                                                     = null;
    ...
    public function enterpriseAdmin👷GetServerStatistics(): Internal\Operator\EnterpriseAdmin\GetServerStatistics
    {
        if ($this->enterpriseAdmin👷GetServerStatistics instanceof Internal\Operator\EnterpriseAdmin\GetServerStatistics === false) {
            $this->enterpriseAdmin👷GetServerStatistics = new Internal\Operator\EnterpriseAdmin\GetServerStatistics($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀EnterpriseInstallation🌀EnterpriseOrOrg🌀ServerStatistics());
        }

        return $this->enterpriseAdmin👷GetServerStatistics;
    }
    ...
    public function actions👷SetActionsOidcCustomIssuerPolicyForEnterprise(): Internal\Operator\Actions\SetActionsOidcCustomIssuerPolicyForEnterprise
    {
        if ($this->actions👷SetActionsOidcCustomIssuerPolicyForEnterprise instanceof Internal\Operator\Actions\SetActionsOidcCustomIssuerPolicyForEnterprise === false) {
            $this->actions👷SetActionsOidcCustomIssuerPolicyForEnterprise = new Internal\Operator\Actions\SetActionsOidcCustomIssuerPolicyForEnterprise($this->browser, $this->authentication, $this->requestSchemaValidator);
        }

        return $this->actions👷SetActionsOidcCustomIssuerPolicyForEnterprise;
    }
    ...
    public function announcementBanners👷GetAnnouncementBannerForEnterprise(): Internal\Operator\AnnouncementBanners\GetAnnouncementBannerForEnterprise
    {
        if ($this->announcementBanners👷GetAnnouncementBannerForEnterprise instanceof Internal\Operator\AnnouncementBanners\GetAnnouncementBannerForEnterprise === false) {
            $this->announcementBanners👷GetAnnouncementBannerForEnterprise = new Internal\Operator\AnnouncementBanners\GetAnnouncementBannerForEnterprise($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀Announcement());
        }

        return $this->announcementBanners👷GetAnnouncementBannerForEnterprise;
    }

    public function announcementBanners👷RemoveAnnouncementBannerForEnterprise(): Internal\Operator\AnnouncementBanners\RemoveAnnouncementBannerForEnterprise
    {
        if ($this->announcementBanners👷RemoveAnnouncementBannerForEnterprise instanceof Internal\Operator\AnnouncementBanners\RemoveAnnouncementBannerForEnterprise === false) {
            $this->announcementBanners👷RemoveAnnouncementBannerForEnterprise = new Internal\Operator\AnnouncementBanners\RemoveAnnouncementBannerForEnterprise($this->browser, $this->authentication);
        }

        return $this->announcementBanners👷RemoveAnnouncementBannerForEnterprise;
    }

    public function announcementBanners👷SetAnnouncementBannerForEnterprise(): Internal\Operator\AnnouncementBanners\SetAnnouncementBannerForEnterprise
    {
        if ($this->announcementBanners👷SetAnnouncementBannerForEnterprise instanceof Internal\Operator\AnnouncementBanners\SetAnnouncementBannerForEnterprise === false) {
            $this->announcementBanners👷SetAnnouncementBannerForEnterprise = new Internal\Operator\AnnouncementBanners\SetAnnouncementBannerForEnterprise($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀Announcement());
        }

        return $this->announcementBanners👷SetAnnouncementBannerForEnterprise;
    }
    ...
    public function enterpriseAdmin👷GetConsumedLicenses(): Internal\Operator\EnterpriseAdmin\GetConsumedLicenses
    {
        if ($this->enterpriseAdmin👷GetConsumedLicenses instanceof Internal\Operator\EnterpriseAdmin\GetConsumedLicenses === false) {
            $this->enterpriseAdmin👷GetConsumedLicenses = new Internal\Operator\EnterpriseAdmin\GetConsumedLicenses($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀ConsumedLicenses());
        }
    ...
    public function copilot👷CopilotMetricsForEnterprise(): Internal\Operator\Copilot\CopilotMetricsForEnterprise
    {
        if ($this->copilot👷CopilotMetricsForEnterprise instanceof Internal\Operator\Copilot\CopilotMetricsForEnterprise === false) {
            $this->copilot👷CopilotMetricsForEnterprise = new Internal\Operator\Copilot\CopilotMetricsForEnterprise($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀Copilot🌀Metrics());
        }

        return $this->copilot👷CopilotMetricsForEnterprise;
    }

    public function copilot👷CopilotMetricsForEnterpriseListing(): Internal\Operator\Copilot\CopilotMetricsForEnterpriseListing
    {
        if ($this->copilot👷CopilotMetricsForEnterpriseListing instanceof Internal\Operator\Copilot\CopilotMetricsForEnterpriseListing === false) {
            $this->copilot👷CopilotMetricsForEnterpriseListing = new Internal\Operator\Copilot\CopilotMetricsForEnterpriseListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀Copilot🌀Metrics());
        }

        return $this->copilot👷CopilotMetricsForEnterpriseListing;
    }
    ...
    public function enterpriseAdmin👷GetLicenseSyncStatus(): Internal\Operator\EnterpriseAdmin\GetLicenseSyncStatus
    {
        if ($this->enterpriseAdmin👷GetLicenseSyncStatus instanceof Internal\Operator\EnterpriseAdmin\GetLicenseSyncStatus === false) {
            $this->enterpriseAdmin👷GetLicenseSyncStatus = new Internal\Operator\EnterpriseAdmin\GetLicenseSyncStatus($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀LicenseSyncStatus());
        }
    ...
    public function billing👷GetGithubActionsBillingGhe(): Internal\Operator\Billing\GetGithubActionsBillingGhe
    {
        if ($this->billing👷GetGithubActionsBillingGhe instanceof Internal\Operator\Billing\GetGithubActionsBillingGhe === false) {
            $this->billing👷GetGithubActionsBillingGhe = new Internal\Operator\Billing\GetGithubActionsBillingGhe($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀Settings🌀Billing🌀Actions());
        }

        return $this->billing👷GetGithubActionsBillingGhe;
    }
    ...
    public function billing👷GetGithubPackagesBillingGhe(): Internal\Operator\Billing\GetGithubPackagesBillingGhe
    {
        if ($this->billing👷GetGithubPackagesBillingGhe instanceof Internal\Operator\Billing\GetGithubPackagesBillingGhe === false) {
            $this->billing👷GetGithubPackagesBillingGhe = new Internal\Operator\Billing\GetGithubPackagesBillingGhe($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀Settings🌀Billing🌀Packages());
        }

        return $this->billing👷GetGithubPackagesBillingGhe;
    }

    public function billing👷GetSharedStorageBillingGhe(): Internal\Operator\Billing\GetSharedStorageBillingGhe
    {
        if ($this->billing👷GetSharedStorageBillingGhe instanceof Internal\Operator\Billing\GetSharedStorageBillingGhe === false) {
            $this->billing👷GetSharedStorageBillingGhe = new Internal\Operator\Billing\GetSharedStorageBillingGhe($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀Settings🌀Billing🌀SharedStorage());
        }
    ...
    public function copilot👷CopilotMetricsForEnterpriseTeam(): Internal\Operator\Copilot\CopilotMetricsForEnterpriseTeam
    {
        if ($this->copilot👷CopilotMetricsForEnterpriseTeam instanceof Internal\Operator\Copilot\CopilotMetricsForEnterpriseTeam === false) {
            $this->copilot👷CopilotMetricsForEnterpriseTeam = new Internal\Operator\Copilot\CopilotMetricsForEnterpriseTeam($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀Team🌀TeamSlug🌀Copilot🌀Metrics());
        }

        return $this->copilot👷CopilotMetricsForEnterpriseTeam;
    }

    public function copilot👷CopilotMetricsForEnterpriseTeamListing(): Internal\Operator\Copilot\CopilotMetricsForEnterpriseTeamListing
    {
        if ($this->copilot👷CopilotMetricsForEnterpriseTeamListing instanceof Internal\Operator\Copilot\CopilotMetricsForEnterpriseTeamListing === false) {
            $this->copilot👷CopilotMetricsForEnterpriseTeamListing = new Internal\Operator\Copilot\CopilotMetricsForEnterpriseTeamListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀Team🌀TeamSlug🌀Copilot🌀Metrics());
        }

        return $this->copilot👷CopilotMetricsForEnterpriseTeamListing;
    }
    ...
    public function orgs👷ListPushBypassRequests(): Internal\Operator\Orgs\ListPushBypassRequests
    {
        if ($this->orgs👷ListPushBypassRequests instanceof Internal\Operator\Orgs\ListPushBypassRequests === false) {
            $this->orgs👷ListPushBypassRequests = new Internal\Operator\Orgs\ListPushBypassRequests($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀BypassRequests🌀PushRules());
        }

        return $this->orgs👷ListPushBypassRequests;
    }

    public function orgs👷ListPushBypassRequestsListing(): Internal\Operator\Orgs\ListPushBypassRequestsListing
    {
        if ($this->orgs👷ListPushBypassRequestsListing instanceof Internal\Operator\Orgs\ListPushBypassRequestsListing === false) {
            $this->orgs👷ListPushBypassRequestsListing = new Internal\Operator\Orgs\ListPushBypassRequestsListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀BypassRequests🌀PushRules());
        }
    ...
    public function copilot👷CopilotMetricsForOrganization(): Internal\Operator\Copilot\CopilotMetricsForOrganization
    {
        if ($this->copilot👷CopilotMetricsForOrganization instanceof Internal\Operator\Copilot\CopilotMetricsForOrganization === false) {
            $this->copilot👷CopilotMetricsForOrganization = new Internal\Operator\Copilot\CopilotMetricsForOrganization($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Copilot🌀Metrics());
        }

        return $this->copilot👷CopilotMetricsForOrganization;
    }

    public function copilot👷CopilotMetricsForOrganizationListing(): Internal\Operator\Copilot\CopilotMetricsForOrganizationListing
    {
        if ($this->copilot👷CopilotMetricsForOrganizationListing instanceof Internal\Operator\Copilot\CopilotMetricsForOrganizationListing === false) {
            $this->copilot👷CopilotMetricsForOrganizationListing = new Internal\Operator\Copilot\CopilotMetricsForOrganizationListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Copilot🌀Metrics());
        }
    ...
    public function orgs👷ListSamlSsoAuthorizations(): Internal\Operator\Orgs\ListSamlSsoAuthorizations
    {
        if ($this->orgs👷ListSamlSsoAuthorizations instanceof Internal\Operator\Orgs\ListSamlSsoAuthorizations === false) {
            $this->orgs👷ListSamlSsoAuthorizations = new Internal\Operator\Orgs\ListSamlSsoAuthorizations($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀CredentialAuthorizations());
        }

        return $this->orgs👷ListSamlSsoAuthorizations;
    }

    public function orgs👷ListSamlSsoAuthorizationsListing(): Internal\Operator\Orgs\ListSamlSsoAuthorizationsListing
    {
        if ($this->orgs👷ListSamlSsoAuthorizationsListing instanceof Internal\Operator\Orgs\ListSamlSsoAuthorizationsListing === false) {
            $this->orgs👷ListSamlSsoAuthorizationsListing = new Internal\Operator\Orgs\ListSamlSsoAuthorizationsListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀CredentialAuthorizations());
        }

        return $this->orgs👷ListSamlSsoAuthorizationsListing;
    }

    public function orgs👷RemoveSamlSsoAuthorization(): Internal\Operator\Orgs\RemoveSamlSsoAuthorization
    {
        if ($this->orgs👷RemoveSamlSsoAuthorization instanceof Internal\Operator\Orgs\RemoveSamlSsoAuthorization === false) {
            $this->orgs👷RemoveSamlSsoAuthorization = new Internal\Operator\Orgs\RemoveSamlSsoAuthorization($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀CredentialAuthorizations🌀CredentialId());
        }

        return $this->orgs👷RemoveSamlSsoAuthorization;
    }
    ...
    public function orgs👷CreateCustomRole(): Internal\Operator\Orgs\CreateCustomRole
    {
        if ($this->orgs👷CreateCustomRole instanceof Internal\Operator\Orgs\CreateCustomRole === false) {
            $this->orgs👷CreateCustomRole = new Internal\Operator\Orgs\CreateCustomRole($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀CustomRoles());
        }

        return $this->orgs👷CreateCustomRole;
    }

    public function orgs👷GetCustomRole(): Internal\Operator\Orgs\GetCustomRole
    {
        if ($this->orgs👷GetCustomRole instanceof Internal\Operator\Orgs\GetCustomRole === false) {
            $this->orgs👷GetCustomRole = new Internal\Operator\Orgs\GetCustomRole($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀CustomRoles🌀RoleId());
        }

        return $this->orgs👷GetCustomRole;
    }

    public function orgs👷DeleteCustomRole(): Internal\Operator\Orgs\DeleteCustomRole
    {
        if ($this->orgs👷DeleteCustomRole instanceof Internal\Operator\Orgs\DeleteCustomRole === false) {
            $this->orgs👷DeleteCustomRole = new Internal\Operator\Orgs\DeleteCustomRole($this->browser, $this->authentication);
        }

        return $this->orgs👷DeleteCustomRole;
    }

    public function orgs👷UpdateCustomRole(): Internal\Operator\Orgs\UpdateCustomRole
    {
        if ($this->orgs👷UpdateCustomRole instanceof Internal\Operator\Orgs\UpdateCustomRole === false) {
            $this->orgs👷UpdateCustomRole = new Internal\Operator\Orgs\UpdateCustomRole($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀CustomRoles🌀RoleId());
        }

        return $this->orgs👷UpdateCustomRole;
    }
    ...
    public function orgs👷ListFineGrainedPermissions(): Internal\Operator\Orgs\ListFineGrainedPermissions
    {
        if ($this->orgs👷ListFineGrainedPermissions instanceof Internal\Operator\Orgs\ListFineGrainedPermissions === false) {
            $this->orgs👷ListFineGrainedPermissions = new Internal\Operator\Orgs\ListFineGrainedPermissions($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀FineGrainedPermissions());
        }

        return $this->orgs👷ListFineGrainedPermissions;
    }
    ...
    {
        if ($this->teams👷ListIdpGroupsForOrg instanceof Internal\Operator\Teams\ListIdpGroupsForOrg === false) {
            $this->teams👷ListIdpGroupsForOrg = new Internal\Operator\Teams\ListIdpGroupsForOrg($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀TeamSync🌀Groups());
        }

        return $this->teams👷ListIdpGroupsForOrg;
    }

    public function copilot👷CopilotMetricsForTeam(): Internal\Operator\Copilot\CopilotMetricsForTeam
    {
        if ($this->copilot👷CopilotMetricsForTeam instanceof Internal\Operator\Copilot\CopilotMetricsForTeam === false) {
            $this->copilot👷CopilotMetricsForTeam = new Internal\Operator\Copilot\CopilotMetricsForTeam($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Team🌀TeamSlug🌀Copilot🌀Metrics());
        }

        return $this->copilot👷CopilotMetricsForTeam;
    }

    public function copilot👷CopilotMetricsForTeamListing(): Internal\Operator\Copilot\CopilotMetricsForTeamListing
    {
        if ($this->copilot👷CopilotMetricsForTeamListing instanceof Internal\Operator\Copilot\CopilotMetricsForTeamListing === false) {
            $this->copilot👷CopilotMetricsForTeamListing = new Internal\Operator\Copilot\CopilotMetricsForTeamListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Team🌀TeamSlug🌀Copilot🌀Metrics());
        }
    ...
    public function teams👷ListIdpGroupsInOrg(): Internal\Operator\Teams\ListIdpGroupsInOrg
    {
        if ($this->teams👷ListIdpGroupsInOrg instanceof Internal\Operator\Teams\ListIdpGroupsInOrg === false) {
            $this->teams👷ListIdpGroupsInOrg = new Internal\Operator\Teams\ListIdpGroupsInOrg($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Teams🌀TeamSlug🌀TeamSync🌀GroupMappings());
        }

        return $this->teams👷ListIdpGroupsInOrg;
    }

    public function teams👷CreateOrUpdateIdpGroupConnectionsInOrg(): Internal\Operator\Teams\CreateOrUpdateIdpGroupConnectionsInOrg
    {
        if ($this->teams👷CreateOrUpdateIdpGroupConnectionsInOrg instanceof Internal\Operator\Teams\CreateOrUpdateIdpGroupConnectionsInOrg === false) {
            $this->teams👷CreateOrUpdateIdpGroupConnectionsInOrg = new Internal\Operator\Teams\CreateOrUpdateIdpGroupConnectionsInOrg($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Teams🌀TeamSlug🌀TeamSync🌀GroupMappings());
        }

        return $this->teams👷CreateOrUpdateIdpGroupConnectionsInOrg;
    }
    ...
    public function repos👷ListRepoPushBypassRequests(): Internal\Operator\Repos\ListRepoPushBypassRequests
    {
        if ($this->repos👷ListRepoPushBypassRequests instanceof Internal\Operator\Repos\ListRepoPushBypassRequests === false) {
            $this->repos👷ListRepoPushBypassRequests = new Internal\Operator\Repos\ListRepoPushBypassRequests($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀BypassRequests🌀PushRules());
        }

        return $this->repos👷ListRepoPushBypassRequests;
    }

    public function repos👷ListRepoPushBypassRequestsListing(): Internal\Operator\Repos\ListRepoPushBypassRequestsListing
    {
        if ($this->repos👷ListRepoPushBypassRequestsListing instanceof Internal\Operator\Repos\ListRepoPushBypassRequestsListing === false) {
            $this->repos👷ListRepoPushBypassRequestsListing = new Internal\Operator\Repos\ListRepoPushBypassRequestsListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀BypassRequests🌀PushRules());
        }

        return $this->repos👷ListRepoPushBypassRequestsListing;
    }

    public function repos👷GetRepoPushBypassRequest(): Internal\Operator\Repos\GetRepoPushBypassRequest
    {
        if ($this->repos👷GetRepoPushBypassRequest instanceof Internal\Operator\Repos\GetRepoPushBypassRequest === false) {
            $this->repos👷GetRepoPushBypassRequest = new Internal\Operator\Repos\GetRepoPushBypassRequest($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀BypassRequests🌀PushRules🌀BypassRequestNumber());
        }
    ...
    public function scim👷ListProvisionedIdentities(): Internal\Operator\Scim\ListProvisionedIdentities
    {
        if ($this->scim👷ListProvisionedIdentities instanceof Internal\Operator\Scim\ListProvisionedIdentities === false) {
            $this->scim👷ListProvisionedIdentities = new Internal\Operator\Scim\ListProvisionedIdentities($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Scim🌀V2🌀Organizations🌀Org🌀Users());
        }

        return $this->scim👷ListProvisionedIdentities;
    }

    public function scim👷ProvisionAndInviteUser(): Internal\Operator\Scim\ProvisionAndInviteUser
    {
        if ($this->scim👷ProvisionAndInviteUser instanceof Internal\Operator\Scim\ProvisionAndInviteUser === false) {
            $this->scim👷ProvisionAndInviteUser = new Internal\Operator\Scim\ProvisionAndInviteUser($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Scim🌀V2🌀Organizations🌀Org🌀Users());
        }

        return $this->scim👷ProvisionAndInviteUser;
    }

    public function scim👷GetProvisioningInformationForUser(): Internal\Operator\Scim\GetProvisioningInformationForUser
    {
        if ($this->scim👷GetProvisioningInformationForUser instanceof Internal\Operator\Scim\GetProvisioningInformationForUser === false) {
            $this->scim👷GetProvisioningInformationForUser = new Internal\Operator\Scim\GetProvisioningInformationForUser($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Scim🌀V2🌀Organizations🌀Org🌀Users🌀ScimUserId());
        }

        return $this->scim👷GetProvisioningInformationForUser;
    }

    public function scim👷SetInformationForProvisionedUser(): Internal\Operator\Scim\SetInformationForProvisionedUser
    {
        if ($this->scim👷SetInformationForProvisionedUser instanceof Internal\Operator\Scim\SetInformationForProvisionedUser === false) {
            $this->scim👷SetInformationForProvisionedUser = new Internal\Operator\Scim\SetInformationForProvisionedUser($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Scim🌀V2🌀Organizations🌀Org🌀Users🌀ScimUserId());
        }

        return $this->scim👷SetInformationForProvisionedUser;
    }

    public function scim👷DeleteUserFromOrg(): Internal\Operator\Scim\DeleteUserFromOrg
    {
        if ($this->scim👷DeleteUserFromOrg instanceof Internal\Operator\Scim\DeleteUserFromOrg === false) {
            $this->scim👷DeleteUserFromOrg = new Internal\Operator\Scim\DeleteUserFromOrg($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Scim🌀V2🌀Organizations🌀Org🌀Users🌀ScimUserId());
        }

        return $this->scim👷DeleteUserFromOrg;
    }

    public function scim👷UpdateAttributeForUser(): Internal\Operator\Scim\UpdateAttributeForUser
    {
        if ($this->scim👷UpdateAttributeForUser instanceof Internal\Operator\Scim\UpdateAttributeForUser === false) {
            $this->scim👷UpdateAttributeForUser = new Internal\Operator\Scim\UpdateAttributeForUser($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Scim🌀V2🌀Organizations🌀Org🌀Users🌀ScimUserId());
        }

        return $this->scim👷UpdateAttributeForUser;
    }
    ...
    public function teams👷ListIdpGroupsForLegacy(): Internal\Operator\Teams\ListIdpGroupsForLegacy
    {
        if ($this->teams👷ListIdpGroupsForLegacy instanceof Internal\Operator\Teams\ListIdpGroupsForLegacy === false) {
            $this->teams👷ListIdpGroupsForLegacy = new Internal\Operator\Teams\ListIdpGroupsForLegacy($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Teams🌀TeamId🌀TeamSync🌀GroupMappings());
        }

        return $this->teams👷ListIdpGroupsForLegacy;
    }

    public function teams👷CreateOrUpdateIdpGroupConnectionsLegacy(): Internal\Operator\Teams\CreateOrUpdateIdpGroupConnectionsLegacy
    {
        if ($this->teams👷CreateOrUpdateIdpGroupConnectionsLegacy instanceof Internal\Operator\Teams\CreateOrUpdateIdpGroupConnectionsLegacy === false) {
            $this->teams👷CreateOrUpdateIdpGroupConnectionsLegacy = new Internal\Operator\Teams\CreateOrUpdateIdpGroupConnectionsLegacy($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Teams🌀TeamId🌀TeamSync🌀GroupMappings());
        }

        return $this->teams👷CreateOrUpdateIdpGroupConnectionsLegacy;
    }
