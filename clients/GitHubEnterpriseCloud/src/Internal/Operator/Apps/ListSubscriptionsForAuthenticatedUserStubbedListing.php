...
final readonly class ListSubscriptionsForAuthenticatedUserStubbedListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Apps\ListSubscriptionsForAuthenticatedUserStubbedListing($this->responseSchemaValidator, $this->hydrator, $perPage, $page);
