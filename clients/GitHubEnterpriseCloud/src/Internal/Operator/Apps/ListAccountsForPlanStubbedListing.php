...
final readonly class ListAccountsForPlanStubbedListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Apps\ListAccountsForPlanStubbedListing($this->responseSchemaValidator, $this->hydrator, $planId, $direction, $sort, $perPage, $page);
