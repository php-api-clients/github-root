...
final readonly class GetInstallation
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Apps\GetInstallation($this->responseSchemaValidator, $this->hydrator, $installationId);
