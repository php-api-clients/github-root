...
final readonly class ListPlansListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Apps\ListPlansListing($this->responseSchemaValidator, $this->hydrator, $perPage, $page);
