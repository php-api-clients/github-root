...
final readonly class ListWatchedReposForAuthenticatedUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Activity\ListWatchedReposForAuthenticatedUserListing($this->responseSchemaValidator, $this->hydrator, $perPage, $page);
