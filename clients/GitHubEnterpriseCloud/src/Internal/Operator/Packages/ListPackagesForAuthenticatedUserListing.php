...
final readonly class ListPackagesForAuthenticatedUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Packages\ListPackagesForAuthenticatedUserListing($this->responseSchemaValidator, $this->hydrator, $packageType, $visibility, $page, $perPage);
