...
final readonly class DeletePackageForUser
{
    ...
    public function call(string $packageType, string $packageName, string $username): WithoutBody
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Packages\DeletePackageForUser($this->responseSchemaValidator, $this->hydrator, $packageType, $packageName, $username);
