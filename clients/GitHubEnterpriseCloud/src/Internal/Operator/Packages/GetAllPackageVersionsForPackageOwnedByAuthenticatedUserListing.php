...
final readonly class GetAllPackageVersionsForPackageOwnedByAuthenticatedUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Packages\GetAllPackageVersionsForPackageOwnedByAuthenticatedUserListing($this->responseSchemaValidator, $this->hydrator, $packageType, $packageName, $page, $perPage, $state);
