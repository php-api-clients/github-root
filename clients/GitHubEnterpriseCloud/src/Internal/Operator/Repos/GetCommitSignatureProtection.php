...
final readonly class GetCommitSignatureProtection
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Repos\GetCommitSignatureProtection($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $branch);
