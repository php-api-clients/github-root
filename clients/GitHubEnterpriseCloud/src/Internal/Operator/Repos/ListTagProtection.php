...
final readonly class ListTagProtection
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Repos\ListTagProtection($this->responseSchemaValidator, $this->hydrator, $owner, $repo);
