...
final readonly class ListForOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Repos\ListForOrg($this->responseSchemaValidator, $this->hydrator, $org, $type, $direction, $sort, $perPage, $page);
