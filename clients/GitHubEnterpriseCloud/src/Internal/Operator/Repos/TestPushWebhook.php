...
final readonly class TestPushWebhook
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Repos\TestPushWebhook($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $hookId);
