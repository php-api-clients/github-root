...
final readonly class CodeownersErrors
{
    ...
    public function call(string $owner, string $repo, string $ref): \ApiClients\Client\GitHubEnterpriseCloud\Schema\CodeownersErrors|array
    {
