...
final readonly class ListAutolinks
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Repos\ListAutolinks($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $page);
