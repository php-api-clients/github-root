...
final readonly class DeleteCommitComment
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Repos\DeleteCommitComment($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $commentId);
