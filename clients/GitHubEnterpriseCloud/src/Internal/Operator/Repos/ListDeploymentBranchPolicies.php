...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Repos\ListDeploymentBranchPolicies\Response\ApplicationJson\Ok;
...
final readonly class ListDeploymentBranchPolicies
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Repos\ListDeploymentBranchPolicies($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $environmentName, $perPage, $page);
