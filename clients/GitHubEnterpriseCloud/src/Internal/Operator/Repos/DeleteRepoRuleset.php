...
final readonly class DeleteRepoRuleset
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Repos\DeleteRepoRuleset($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $rulesetId);
