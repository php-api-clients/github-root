...
final readonly class DeleteAutolink
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Repos\DeleteAutolink($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $autolinkId);
