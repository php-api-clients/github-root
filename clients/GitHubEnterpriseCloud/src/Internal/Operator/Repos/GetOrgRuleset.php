...
final readonly class GetOrgRuleset
{
    ...
    public function call(string $org, int $rulesetId): RepositoryRuleset|array
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Repos\GetOrgRuleset($this->responseSchemaValidator, $this->hydrator, $org, $rulesetId);
