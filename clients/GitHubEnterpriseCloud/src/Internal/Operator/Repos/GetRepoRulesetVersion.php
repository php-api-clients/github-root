...
final readonly class GetRepoRulesetVersion
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Repos\GetRepoRulesetVersion($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $rulesetId, $versionId);
