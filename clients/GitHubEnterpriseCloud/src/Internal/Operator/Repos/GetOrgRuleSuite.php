...
final readonly class GetOrgRuleSuite
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Repos\GetOrgRuleSuite($this->responseSchemaValidator, $this->hydrator, $org, $ruleSuiteId);
