...
final readonly class GetRepoRuleSuite
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Repos\GetRepoRuleSuite($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $ruleSuiteId);
