...
final readonly class ListAttestations
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Repos\ListAttestations($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $before, $after, $subjectDigest, $perPage);
