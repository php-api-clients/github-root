...
final readonly class DeleteWebhook
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Repos\DeleteWebhook($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $hookId);
