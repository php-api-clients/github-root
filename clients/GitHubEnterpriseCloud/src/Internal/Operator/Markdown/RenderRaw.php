...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Operator\Markdown;
...
final readonly class RenderRaw
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Markdown\RenderRaw($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator);
