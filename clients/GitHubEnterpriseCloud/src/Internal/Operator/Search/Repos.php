...
final readonly class Repos
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Search\Repos($this->responseSchemaValidator, $this->hydrator, $q, $sort, $order, $perPage, $page);
