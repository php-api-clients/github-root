...
final readonly class Users
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Search\Users($this->responseSchemaValidator, $this->hydrator, $q, $sort, $order, $perPage, $page);
