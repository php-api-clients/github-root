...
final readonly class GetVariantAnalysis
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\CodeScanning\GetVariantAnalysis($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $codeqlVariantAnalysisId);
