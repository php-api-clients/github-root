...
final readonly class ListOrgBypassRequestsListing
{
    public const OPERATION_ID    = 'secret-scanning/list-org-bypass-requests';
    public const OPERATION_MATCH = 'LIST /orgs/{org}/bypass-requests/secret-scanning';
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\SecretScanning\ListOrgBypassRequestsListing($this->responseSchemaValidator, $this->hydrator, $org, $repositoryName, $reviewer, $requester, $timePeriod, $requestStatus, $perPage, $page);
