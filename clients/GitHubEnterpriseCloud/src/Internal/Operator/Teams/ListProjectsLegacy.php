...
final readonly class ListProjectsLegacy
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Teams\ListProjectsLegacy($this->responseSchemaValidator, $this->hydrator, $teamId, $perPage, $page);
