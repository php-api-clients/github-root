...
final readonly class DeleteDiscussionCommentInOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Teams\DeleteDiscussionCommentInOrg($org, $teamSlug, $discussionNumber, $commentNumber);
