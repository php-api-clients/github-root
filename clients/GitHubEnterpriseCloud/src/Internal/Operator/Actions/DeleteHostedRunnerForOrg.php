...
final readonly class DeleteHostedRunnerForOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Actions\DeleteHostedRunnerForOrg($this->responseSchemaValidator, $this->hydrator, $org, $hostedRunnerId);
