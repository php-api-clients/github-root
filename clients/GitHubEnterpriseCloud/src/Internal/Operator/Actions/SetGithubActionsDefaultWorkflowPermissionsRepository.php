...
final readonly class SetGithubActionsDefaultWorkflowPermissionsRepository
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Actions\SetGithubActionsDefaultWorkflowPermissionsRepository($this->requestSchemaValidator, $owner, $repo);
