...
final readonly class SetCustomLabelsForSelfHostedRunnerForRepo
{
    ...
    /** @return */
    public function call(string $owner, string $repo, int $runnerId, array $params): Ok|array
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Actions\SetCustomLabelsForSelfHostedRunnerForRepo($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $runnerId);
