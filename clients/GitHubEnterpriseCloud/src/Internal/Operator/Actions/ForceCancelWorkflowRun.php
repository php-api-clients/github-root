...
final readonly class ForceCancelWorkflowRun
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Actions\ForceCancelWorkflowRun($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $runId);
