...
final readonly class ListLabelsForSelfHostedRunnerForRepo
{
    ...
    /** @return */
    public function call(string $owner, string $repo, int $runnerId): Ok
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Actions\ListLabelsForSelfHostedRunnerForRepo($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $runnerId);
