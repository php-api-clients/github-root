...
final readonly class UpdateEnvironmentVariable
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Actions\UpdateEnvironmentVariable($this->requestSchemaValidator, $owner, $repo, $name, $environmentName);
