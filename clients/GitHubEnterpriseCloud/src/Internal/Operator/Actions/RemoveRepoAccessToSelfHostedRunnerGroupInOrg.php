...
final readonly class RemoveRepoAccessToSelfHostedRunnerGroupInOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Actions\RemoveRepoAccessToSelfHostedRunnerGroupInOrg($org, $runnerGroupId, $repositoryId);
