...
final readonly class SetSelectedReposForOrgSecret
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Actions\SetSelectedReposForOrgSecret($this->requestSchemaValidator, $org, $secretName);
