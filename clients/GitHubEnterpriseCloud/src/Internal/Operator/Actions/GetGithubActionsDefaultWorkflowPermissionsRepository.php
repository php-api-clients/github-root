...
final readonly class GetGithubActionsDefaultWorkflowPermissionsRepository
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $responseSchemaValidator, private Internal\Hydrator\Operation\Repos\Owner\Repo\Actions\Permissions\Workflow $hydrator)
    {
    }

    public function call(string $owner, string $repo): ActionsGetDefaultWorkflowPermissions
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Actions\GetGithubActionsDefaultWorkflowPermissionsRepository($this->responseSchemaValidator, $this->hydrator, $owner, $repo);
