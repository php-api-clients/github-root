...
final readonly class SetGithubActionsPermissionsRepository
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Actions\SetGithubActionsPermissionsRepository($this->requestSchemaValidator, $owner, $repo);
