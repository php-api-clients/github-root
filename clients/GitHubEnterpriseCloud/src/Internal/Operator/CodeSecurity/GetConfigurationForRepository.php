...
final readonly class GetConfigurationForRepository
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\CodeSecurity\GetConfigurationForRepository($this->responseSchemaValidator, $this->hydrator, $owner, $repo);
