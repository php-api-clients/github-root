...
final readonly class GetNetworkSettingsForOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\HostedCompute\GetNetworkSettingsForOrg($this->responseSchemaValidator, $this->hydrator, $org, $networkSettingsId);
