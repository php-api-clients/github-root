...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Operator\RateLimit;
...
final readonly class Get
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\RateLimit\Get($this->responseSchemaValidator, $this->hydrator);
