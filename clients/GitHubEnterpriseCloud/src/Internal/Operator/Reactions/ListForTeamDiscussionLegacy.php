...
final readonly class ListForTeamDiscussionLegacy
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Reactions\ListForTeamDiscussionLegacy($this->responseSchemaValidator, $this->hydrator, $teamId, $discussionNumber, $content, $perPage, $page);
