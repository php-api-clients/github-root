...
final readonly class ListAssignees
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Issues\ListAssignees($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
