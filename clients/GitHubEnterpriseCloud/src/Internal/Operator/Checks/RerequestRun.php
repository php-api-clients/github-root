...
final readonly class RerequestRun
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Checks\RerequestRun($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $checkRunId);
