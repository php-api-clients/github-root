...
final readonly class ListClassrooms
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Classroom\ListClassrooms($this->responseSchemaValidator, $this->hydrator, $page, $perPage);
