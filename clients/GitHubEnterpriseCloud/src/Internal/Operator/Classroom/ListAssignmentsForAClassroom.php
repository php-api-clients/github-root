...
final readonly class ListAssignmentsForAClassroom
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Classroom\ListAssignmentsForAClassroom($this->responseSchemaValidator, $this->hydrator, $classroomId, $page, $perPage);
