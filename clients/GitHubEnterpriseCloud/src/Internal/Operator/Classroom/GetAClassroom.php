...
final readonly class GetAClassroom
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Classroom\GetAClassroom($this->responseSchemaValidator, $this->hydrator, $classroomId);
