...
final readonly class ListClassroomsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Classroom\ListClassroomsListing($this->responseSchemaValidator, $this->hydrator, $page, $perPage);
