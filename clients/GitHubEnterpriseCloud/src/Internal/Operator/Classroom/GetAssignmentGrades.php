...
final readonly class GetAssignmentGrades
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Classroom\GetAssignmentGrades($this->responseSchemaValidator, $this->hydrator, $assignmentId);
