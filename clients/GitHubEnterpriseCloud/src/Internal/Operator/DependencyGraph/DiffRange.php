...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Operator\DependencyGraph;
...
final readonly class DiffRange
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\DependencyGraph\DiffRange($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $basehead, $name);
