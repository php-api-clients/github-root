...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\PullRequestReviewRequest;
...
final readonly class ListRequestedReviewers
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Pulls\ListRequestedReviewers($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $pullNumber);
