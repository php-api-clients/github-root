...
final readonly class DeleteOrgSecret
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Codespaces\DeleteOrgSecret($this->responseSchemaValidator, $this->hydrator, $org, $secretName);
