...
final readonly class CheckPermissionsForDevcontainer
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Codespaces\CheckPermissionsForDevcontainer($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $ref, $devcontainerPath);
