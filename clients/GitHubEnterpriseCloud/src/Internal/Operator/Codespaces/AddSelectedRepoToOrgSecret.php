...
final readonly class AddSelectedRepoToOrgSecret
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Codespaces\AddSelectedRepoToOrgSecret($this->responseSchemaValidator, $this->hydrator, $org, $secretName, $repositoryId);
