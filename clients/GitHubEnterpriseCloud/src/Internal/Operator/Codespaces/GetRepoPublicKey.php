...
final readonly class GetRepoPublicKey
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $responseSchemaValidator, private Internal\Hydrator\Operation\Repos\Owner\Repo\Codespaces\Secrets\PublicKey $hydrator)
    {
    }

    /** @return */
    public function call(string $owner, string $repo): CodespacesPublicKey|array
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Codespaces\GetRepoPublicKey($this->responseSchemaValidator, $this->hydrator, $owner, $repo);
