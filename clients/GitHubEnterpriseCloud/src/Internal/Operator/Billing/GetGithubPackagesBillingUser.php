...
final readonly class GetGithubPackagesBillingUser
{
    ...
    /** @return */
    public function call(string $username): PackagesBillingUsage
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Billing\GetGithubPackagesBillingUser($this->responseSchemaValidator, $this->hydrator, $username);
