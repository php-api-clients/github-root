...
final readonly class ListReposForOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Migrations\ListReposForOrg($this->responseSchemaValidator, $this->hydrator, $org, $migrationId, $perPage, $page);
