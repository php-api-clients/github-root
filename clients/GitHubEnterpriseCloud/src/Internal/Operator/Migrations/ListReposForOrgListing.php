...
final readonly class ListReposForOrgListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Migrations\ListReposForOrgListing($this->responseSchemaValidator, $this->hydrator, $org, $migrationId, $perPage, $page);
