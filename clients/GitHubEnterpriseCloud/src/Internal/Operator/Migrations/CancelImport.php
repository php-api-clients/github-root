...
final readonly class CancelImport
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Migrations\CancelImport($this->responseSchemaValidator, $this->hydrator, $owner, $repo);
