...
final readonly class GetEnterpriseRulesetHistory
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\EnterpriseAdmin\GetEnterpriseRulesetHistory($this->responseSchemaValidator, $this->hydrator, $enterprise, $rulesetId, $perPage, $page);
