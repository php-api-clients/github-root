...
final readonly class SetOrgAccessToSelfHostedRunnerGroupInEnterprise
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\EnterpriseAdmin\SetOrgAccessToSelfHostedRunnerGroupInEnterprise($this->requestSchemaValidator, $enterprise, $runnerGroupId);
