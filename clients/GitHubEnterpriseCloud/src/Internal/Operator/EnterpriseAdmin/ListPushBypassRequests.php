...
final readonly class ListPushBypassRequests
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\EnterpriseAdmin\ListPushBypassRequests($this->responseSchemaValidator, $this->hydrator, $enterprise, $organizationName, $reviewer, $requester, $timePeriod, $requestStatus, $perPage, $page);
