...
final readonly class UsageMetricsForEnterprise
{
    public const OPERATION_ID    = 'copilot/usage-metrics-for-enterprise';
    public const OPERATION_MATCH = 'GET /enterprises/{enterprise}/copilot/usage';
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Copilot\UsageMetricsForEnterprise($this->responseSchemaValidator, $this->hydrator, $enterprise, $since, $until, $page, $perPage);
