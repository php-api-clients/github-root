...
final readonly class GetCopilotSeatAssignmentDetailsForUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Copilot\GetCopilotSeatAssignmentDetailsForUser($this->responseSchemaValidator, $this->hydrator, $org, $username);
