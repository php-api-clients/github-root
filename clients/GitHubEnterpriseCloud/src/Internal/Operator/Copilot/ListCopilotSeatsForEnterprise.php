...
final readonly class ListCopilotSeatsForEnterprise
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Copilot\ListCopilotSeatsForEnterprise($this->responseSchemaValidator, $this->hydrator, $enterprise, $page, $perPage);
