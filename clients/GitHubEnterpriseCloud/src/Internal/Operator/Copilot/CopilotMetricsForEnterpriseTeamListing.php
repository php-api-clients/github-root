...
final readonly class CopilotMetricsForEnterpriseTeamListing
{
    public const OPERATION_ID    = 'copilot/copilot-metrics-for-enterprise-team';
    public const OPERATION_MATCH = 'LIST /enterprises/{enterprise}/team/{team_slug}/copilot/metrics';
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Copilot\CopilotMetricsForEnterpriseTeamListing($this->responseSchemaValidator, $this->hydrator, $enterprise, $teamSlug, $since, $until, $page, $perPage);
