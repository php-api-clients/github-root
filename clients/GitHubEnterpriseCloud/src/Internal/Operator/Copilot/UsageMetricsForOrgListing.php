...
final readonly class UsageMetricsForOrgListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Copilot\UsageMetricsForOrgListing($this->responseSchemaValidator, $this->hydrator, $org, $since, $until, $page, $perPage);
