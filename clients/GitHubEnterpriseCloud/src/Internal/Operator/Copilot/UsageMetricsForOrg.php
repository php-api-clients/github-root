...
final readonly class UsageMetricsForOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Copilot\UsageMetricsForOrg($this->responseSchemaValidator, $this->hydrator, $org, $since, $until, $page, $perPage);
