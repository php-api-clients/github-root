...
final readonly class ListForks
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Gists\ListForks($this->responseSchemaValidator, $this->hydrator, $gistId, $perPage, $page);
