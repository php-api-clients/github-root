...
final readonly class ListComments
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Gists\ListComments($this->responseSchemaValidator, $this->hydrator, $gistId, $perPage, $page);
