...
final readonly class ListForksListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Gists\ListForksListing($this->responseSchemaValidator, $this->hydrator, $gistId, $perPage, $page);
