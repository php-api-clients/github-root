...
final readonly class ListPublic
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Gists\ListPublic($this->responseSchemaValidator, $this->hydrator, $since, $perPage, $page);
