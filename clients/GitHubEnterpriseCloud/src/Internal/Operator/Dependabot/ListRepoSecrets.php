...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Dependabot\ListRepoSecrets\Response\ApplicationJson\Ok;
...
final readonly class ListRepoSecrets
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Dependabot\ListRepoSecrets($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
