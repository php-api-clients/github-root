...
final readonly class GetRepoPublicKey
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Dependabot\GetRepoPublicKey($this->responseSchemaValidator, $this->hydrator, $owner, $repo);
