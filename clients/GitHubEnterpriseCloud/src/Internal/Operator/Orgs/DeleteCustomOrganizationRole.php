...
final readonly class DeleteCustomOrganizationRole
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Orgs\DeleteCustomOrganizationRole($org, $roleId);
