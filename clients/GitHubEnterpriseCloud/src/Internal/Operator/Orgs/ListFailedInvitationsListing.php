...
final readonly class ListFailedInvitationsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Orgs\ListFailedInvitationsListing($this->responseSchemaValidator, $this->hydrator, $org, $perPage, $page);
