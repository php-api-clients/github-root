...
final readonly class ListOrgRoleTeams
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Orgs\ListOrgRoleTeams($this->responseSchemaValidator, $this->hydrator, $org, $roleId, $perPage, $page);
