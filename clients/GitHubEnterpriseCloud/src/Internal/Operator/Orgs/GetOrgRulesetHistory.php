...
final readonly class GetOrgRulesetHistory
{
    public const OPERATION_ID    = 'orgs/get-org-ruleset-history';
    public const OPERATION_MATCH = 'GET /orgs/{org}/rulesets/{ruleset_id}/history';
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Orgs\GetOrgRulesetHistory($this->responseSchemaValidator, $this->hydrator, $org, $rulesetId, $perPage, $page);
