...
final readonly class CheckBlockedUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Orgs\CheckBlockedUser($this->responseSchemaValidator, $this->hydrator, $org, $username);
