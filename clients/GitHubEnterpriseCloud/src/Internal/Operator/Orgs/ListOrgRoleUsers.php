...
final readonly class ListOrgRoleUsers
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Orgs\ListOrgRoleUsers($this->responseSchemaValidator, $this->hydrator, $org, $roleId, $perPage, $page);
