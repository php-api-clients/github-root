...
final readonly class ListAttestations
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Orgs\ListAttestations($this->responseSchemaValidator, $this->hydrator, $before, $after, $org, $subjectDigest, $perPage);
