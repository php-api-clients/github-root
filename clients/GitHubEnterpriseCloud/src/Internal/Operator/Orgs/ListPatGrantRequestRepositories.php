...
final readonly class ListPatGrantRequestRepositories
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Orgs\ListPatGrantRequestRepositories($this->responseSchemaValidator, $this->hydrator, $org, $patRequestId, $perPage, $page);
