...
final readonly class ListPublicMembers
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Orgs\ListPublicMembers($this->responseSchemaValidator, $this->hydrator, $org, $perPage, $page);
