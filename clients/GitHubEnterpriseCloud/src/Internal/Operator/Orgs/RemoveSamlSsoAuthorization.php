...
final readonly class RemoveSamlSsoAuthorization
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $responseSchemaValidator, private Internal\Hydrator\Operation\Orgs\Org\CredentialAuthorizations\CredentialId $hydrator)
    {
    }

    /** @return array{code:int} */
    public function call(string $org, int $credentialId): array
    {
