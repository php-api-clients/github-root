...
final readonly class ListOrganizationFineGrainedPermissions
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Orgs\ListOrganizationFineGrainedPermissions($this->responseSchemaValidator, $this->hydrator, $org);
