...
final readonly class CreateOrUpdateCustomPropertiesValuesForRepos
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Orgs\CreateOrUpdateCustomPropertiesValuesForRepos($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $org);
