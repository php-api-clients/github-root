...
final readonly class RemoveOutsideCollaborator
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Orgs\RemoveOutsideCollaborator($this->responseSchemaValidator, $this->hydrator, $org, $username);
