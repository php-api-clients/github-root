...
final readonly class ListCustomPropertiesValuesForRepos
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Orgs\ListCustomPropertiesValuesForRepos($this->responseSchemaValidator, $this->hydrator, $org, $repositoryQuery, $perPage, $page);
