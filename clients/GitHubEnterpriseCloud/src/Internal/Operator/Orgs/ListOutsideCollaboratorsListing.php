...
final readonly class ListOutsideCollaboratorsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Orgs\ListOutsideCollaboratorsListing($this->responseSchemaValidator, $this->hydrator, $org, $filter, $perPage, $page);
