...
final readonly class ListPatGrantRepositoriesListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Orgs\ListPatGrantRepositoriesListing($this->responseSchemaValidator, $this->hydrator, $org, $patId, $perPage, $page);
