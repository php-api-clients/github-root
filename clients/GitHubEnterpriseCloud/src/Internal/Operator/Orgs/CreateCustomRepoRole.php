...
final readonly class CreateCustomRepoRole
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $requestSchemaValidator, private SchemaValidator $responseSchemaValidator, private Internal\Hydrator\Operation\Orgs\Org\CustomRepositoryRoles $hydrator)
    {
    }

    /** @return Schema\OrganizationCustomRepositoryRole */
    public function call(string $org, array $params): OrganizationCustomRepositoryRole|array
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Orgs\CreateCustomRepoRole($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $org);
