...
final readonly class ListFailedInvitations
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Orgs\ListFailedInvitations($this->responseSchemaValidator, $this->hydrator, $org, $perPage, $page);
