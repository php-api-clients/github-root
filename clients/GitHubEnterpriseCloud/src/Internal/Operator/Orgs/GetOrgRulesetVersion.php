...
final readonly class GetOrgRulesetVersion
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Orgs\GetOrgRulesetVersion($this->responseSchemaValidator, $this->hydrator, $org, $rulesetId, $versionId);
