...
final readonly class ListOrgRoleUsersListing
{
    public const OPERATION_ID    = 'orgs/list-org-role-users';
    public const OPERATION_MATCH = 'LIST /orgs/{org}/organization-roles/{role_id}/users';
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\Orgs\ListOrgRoleUsersListing($this->responseSchemaValidator, $this->hydrator, $org, $roleId, $perPage, $page);
