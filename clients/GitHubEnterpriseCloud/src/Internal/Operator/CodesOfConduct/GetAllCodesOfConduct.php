...
namespace ApiClients\Client\GitHubEnterpriseCloud\Internal\Operator\CodesOfConduct;
...
final readonly class GetAllCodesOfConduct
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Internal\Operation\CodesOfConduct\GetAllCodesOfConduct($this->responseSchemaValidator, $this->hydrator);
