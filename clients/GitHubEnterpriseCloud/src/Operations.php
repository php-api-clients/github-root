...
final readonly class Operations implements OperationsInterface
{
    ...
    {
        return new Operation\AnnouncementBanners($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators);
    }
    ...
    {
        return new Operation\Scim($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators);
    }
