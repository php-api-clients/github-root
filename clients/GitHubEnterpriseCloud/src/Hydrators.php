...
final class Hydrators implements \EventSauce\ObjectHydrator\ObjectMapper
{
    ...
    private ?Hydrator\Operation\Enterprises\CbEnterpriseRcb\Actions\Oidc\Customization\Issuer $operation🌀Enterprises🌀CbEnterpriseRcb🌀Actions🌀Oidc🌀Customization🌀Issuer = null;
    ...
    private ?Hydrator\Operation\Orgs\CbOrgRcb\CredentialDashAuthorizations\CbCredentialIdRcb $operation🌀Orgs🌀CbOrgRcb🌀CredentialDashAuthorizations🌀CbCredentialIdRcb = null;
    private ?Hydrator\Operation\Orgs\CbOrgRcb\CustomRepositoryRoles $operation🌀Orgs🌀CbOrgRcb🌀CustomRepositoryRoles = null;
    private ?Hydrator\Operation\Orgs\CbOrgRcb\CustomDashRepositoryDashRoles\CbRoleIdRcb $operation🌀Orgs🌀CbOrgRcb🌀CustomDashRepositoryDashRoles🌀CbRoleIdRcb = null;
    private ?Hydrator\Operation\Orgs\CbOrgRcb\CustomRoles $operation🌀Orgs🌀CbOrgRcb🌀CustomRoles = null;
    private ?Hydrator\Operation\Orgs\CbOrgRcb\CustomRoles\CbRoleIdRcb $operation🌀Orgs🌀CbOrgRcb🌀CustomRoles🌀CbRoleIdRcb = null;
    ...
    private ?Hydrator\Operation\Orgs\CbOrgRcb\Teams\CbTeamSlugRcb\TeamDashSync\GroupDashMappings $operation🌀Orgs🌀CbOrgRcb🌀Teams🌀CbTeamSlugRcb🌀TeamDashSync🌀GroupDashMappings = null;
    ...
    private ?Hydrator\Operation\Scim\V2\Organizations\CbOrgRcb\Users\CbScimUserIdRcb $operation🌀Scim🌀V2🌀Organizations🌀CbOrgRcb🌀Users🌀CbScimUserIdRcb = null;
    ...
    private ?Hydrator\Operation\Teams\CbTeamIdRcb\TeamDashSync\GroupDashMappings $operation🌀Teams🌀CbTeamIdRcb🌀TeamDashSync🌀GroupDashMappings = null;
    ...
    public function hydrateObject(string $className, array $payload) : object
    {
        return match ($className) {
            ...
            'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\IntegrationInstallationRequest', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\SimpleUser' => $this->getObjectMapperOperation🌀App🌀InstallationRequests()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\Authorization', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\Authorization\\App' => $this->getObjectMapperOperation🌀Applications🌀CbClientIdRcb🌀Token()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\OrganizationProgrammaticAccessGrantRequest', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\OrganizationProgrammaticAccessGrantRequest\\Permissions' => $this->getObjectMapperOperation🌀Organizations🌀CbOrgRcb🌀PersonalAccessTokenRequests()->hydrateObject($className, $payload),
            'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\OrganizationProgrammaticAccessGrant' => $this->getObjectMapperOperation🌀Organizations🌀CbOrgRcb🌀PersonalAccessTokens()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\Package' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀Docker🌀Conflicts()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\Team', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\Team\\Permissions' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀Invitations🌀CbInvitationIdRcb🌀Teams()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\Operation\\Actions\\ListRepoOrganizationSecrets\\Response\\Applicationjson\\H200', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\ActionsSecret' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀Actions🌀OrganizationSecrets()->hydrateObject($className, $payload),
            'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\Operation\\Actions\\ListRepoOrganizationVariables\\Response\\Applicationjson\\H200', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\ActionsVariable' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀Actions🌀OrganizationVariables()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\CheckSuite', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\SimpleCommit', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\SimpleCommit\\Author' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀CheckSuites()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\Operation\\Codespaces\\RepoMachinesForAuthenticatedUser\\Response\\Applicationjson\\H200', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\CodespaceMachine' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀Codespaces🌀Machines()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\CommunityProfile', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\CommunityProfile\\Files' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀Community🌀Profile()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookFork', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookFork\\Forkee', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookFork\\Forkee\\License', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookFork\\Forkee\\Permissions' => $this->getObjectMapperWebHook🪝Fork()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookPersonalAccessTokenRequestApproved', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\PersonalAccessTokenRequest', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\PersonalAccessTokenRequest\\PermissionsAdded', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\PersonalAccessTokenRequest\\PermissionsUpgraded', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\PersonalAccessTokenRequest\\PermissionsResult', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookPersonalAccessTokenRequestCancelled', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookPersonalAccessTokenRequestCreated', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookPersonalAccessTokenRequestDenied' => $this->getObjectMapperWebHook🪝PersonalAccessTokenRequest()->hydrateObject($className, $payload),
    ...
    public function serializeObjectOfType(object $object, string $className) : mixed
    {
        return match ($className) {
            ...
            'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\IntegrationInstallationRequest', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\SimpleUser' => $this->getObjectMapperOperation🌀App🌀InstallationRequests()->serializeObject($object),
            ...
            'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\Authorization', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\Authorization\\App' => $this->getObjectMapperOperation🌀Applications🌀CbClientIdRcb🌀Token()->serializeObject($object),
            ...
            'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\OrganizationProgrammaticAccessGrantRequest', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\OrganizationProgrammaticAccessGrantRequest\\Permissions' => $this->getObjectMapperOperation🌀Organizations🌀CbOrgRcb🌀PersonalAccessTokenRequests()->serializeObject($object),
            'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\OrganizationProgrammaticAccessGrant' => $this->getObjectMapperOperation🌀Organizations🌀CbOrgRcb🌀PersonalAccessTokens()->serializeObject($object),
            ...
            'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\Package' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀Docker🌀Conflicts()->serializeObject($object),
            ...
            'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\Team', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\Team\\Permissions' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀Invitations🌀CbInvitationIdRcb🌀Teams()->serializeObject($object),
            ...
            'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\Operation\\Actions\\ListRepoOrganizationSecrets\\Response\\Applicationjson\\H200', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\ActionsSecret' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀Actions🌀OrganizationSecrets()->serializeObject($object),
            'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\Operation\\Actions\\ListRepoOrganizationVariables\\Response\\Applicationjson\\H200', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\ActionsVariable' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀Actions🌀OrganizationVariables()->serializeObject($object),
            ...
            'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\CheckSuite', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\SimpleCommit', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\SimpleCommit\\Author' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀CheckSuites()->serializeObject($object),
            ...
            'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\Operation\\Codespaces\\RepoMachinesForAuthenticatedUser\\Response\\Applicationjson\\H200', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\CodespaceMachine' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀Codespaces🌀Machines()->serializeObject($object),
            ...
            'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\CommunityProfile', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\CommunityProfile\\Files' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀Community🌀Profile()->serializeObject($object),
            ...
            'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookFork', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookFork\\Forkee', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookFork\\Forkee\\License', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookFork\\Forkee\\Permissions' => $this->getObjectMapperWebHook🪝Fork()->serializeObject($object),
            ...
            'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookIssueCommentCreated', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookIssueCommentCreated\\Comment', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookIssueCommentCreated\\Issue', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookIssueCommentCreated\\Issue\\Assignee', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookIssueCommentCreated\\Issue\\Milestone', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookIssueCommentCreated\\Issue\\PerformedViaGithubApp', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookIssueCommentCreated\\Issue\\PullRequest', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookIssueCommentDeleted', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookIssueCommentDeleted\\Comment', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookIssueCommentDeleted\\Issue', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookIssueCommentDeleted\\Issue\\PerformedViaGithubApp', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookIssueCommentEdited', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookIssueCommentEdited\\Changes', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookIssueCommentEdited\\Changes\\Body', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookIssueCommentEdited\\Issue', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookIssueCommentEdited\\Issue\\PerformedViaGithubApp', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookIssueCommentEdited\\Issue\\PerformedViaGithubApp\\Permissions' => $this->getObjectMapperWebHook🪝IssueComment()->serializeObject($object),
            ...
            'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookPersonalAccessTokenRequestApproved', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\PersonalAccessTokenRequest', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\PersonalAccessTokenRequest\\PermissionsAdded', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\PersonalAccessTokenRequest\\PermissionsUpgraded', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\PersonalAccessTokenRequest\\PermissionsResult', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookPersonalAccessTokenRequestCancelled', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookPersonalAccessTokenRequestCreated', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookPersonalAccessTokenRequestDenied' => $this->getObjectMapperWebHook🪝PersonalAccessTokenRequest()->serializeObject($object),
            ...
            'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookReleaseCreated', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookReleaseCreated\\Release', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookReleaseCreated\\Release\\Assets', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookReleaseDeleted', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookReleaseEdited', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookReleaseEdited\\Changes', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookReleaseEdited\\Changes\\MakeLatest', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookReleasePrereleased', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookReleasePublished', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookReleaseReleased', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookReleaseUnpublished' => $this->getObjectMapperWebHook🪝Release()->serializeObject($object),
            ...
            'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookWorkflowRunCompleted', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookWorkflowRunCompleted\\WorkflowRun', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookWorkflowRunCompleted\\WorkflowRun\\HeadRepository', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookWorkflowRunCompleted\\WorkflowRun\\PullRequests', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookWorkflowRunInProgress', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookWorkflowRunInProgress\\WorkflowRun', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookWorkflowRunRequested', 'ApiClients\\Client\\GitHubEnterpriseCloud\\Schema\\WebhookWorkflowRunRequested\\WorkflowRun' => $this->getObjectMapperWebHook🪝WorkflowRun()->serializeObject($object),
        };
    }
    ...
    public function getObjectMapperOperation🌀Enterprises🌀CbEnterpriseRcb🌀Actions🌀Oidc🌀Customization🌀Issuer() : Hydrator\Operation\Enterprises\CbEnterpriseRcb\Actions\Oidc\Customization\Issuer
    {
        if ($this->operation🌀Enterprises🌀CbEnterpriseRcb🌀Actions🌀Oidc🌀Customization🌀Issuer instanceof Hydrator\Operation\Enterprises\CbEnterpriseRcb\Actions\Oidc\Customization\Issuer === false) {
            $this->operation🌀Enterprises🌀CbEnterpriseRcb🌀Actions🌀Oidc🌀Customization🌀Issuer = new Hydrator\Operation\Enterprises\CbEnterpriseRcb\Actions\Oidc\Customization\Issuer();
        }
        return $this->operation🌀Enterprises🌀CbEnterpriseRcb🌀Actions🌀Oidc🌀Customization🌀Issuer;
    }
    ...
    public function getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀CredentialDashAuthorizations🌀CbCredentialIdRcb() : Hydrator\Operation\Orgs\CbOrgRcb\CredentialDashAuthorizations\CbCredentialIdRcb
    {
        if ($this->operation🌀Orgs🌀CbOrgRcb🌀CredentialDashAuthorizations🌀CbCredentialIdRcb instanceof Hydrator\Operation\Orgs\CbOrgRcb\CredentialDashAuthorizations\CbCredentialIdRcb === false) {
            $this->operation🌀Orgs🌀CbOrgRcb🌀CredentialDashAuthorizations🌀CbCredentialIdRcb = new Hydrator\Operation\Orgs\CbOrgRcb\CredentialDashAuthorizations\CbCredentialIdRcb();
        }
        return $this->operation🌀Orgs🌀CbOrgRcb🌀CredentialDashAuthorizations🌀CbCredentialIdRcb;
    }
    public function getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀CustomRepositoryRoles() : Hydrator\Operation\Orgs\CbOrgRcb\CustomRepositoryRoles
    {
        if ($this->operation🌀Orgs🌀CbOrgRcb🌀CustomRepositoryRoles instanceof Hydrator\Operation\Orgs\CbOrgRcb\CustomRepositoryRoles === false) {
            $this->operation🌀Orgs🌀CbOrgRcb🌀CustomRepositoryRoles = new Hydrator\Operation\Orgs\CbOrgRcb\CustomRepositoryRoles();
        }
        return $this->operation🌀Orgs🌀CbOrgRcb🌀CustomRepositoryRoles;
    }
    public function getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀CustomDashRepositoryDashRoles🌀CbRoleIdRcb() : Hydrator\Operation\Orgs\CbOrgRcb\CustomDashRepositoryDashRoles\CbRoleIdRcb
    {
        if ($this->operation🌀Orgs🌀CbOrgRcb🌀CustomDashRepositoryDashRoles🌀CbRoleIdRcb instanceof Hydrator\Operation\Orgs\CbOrgRcb\CustomDashRepositoryDashRoles\CbRoleIdRcb === false) {
            $this->operation🌀Orgs🌀CbOrgRcb🌀CustomDashRepositoryDashRoles🌀CbRoleIdRcb = new Hydrator\Operation\Orgs\CbOrgRcb\CustomDashRepositoryDashRoles\CbRoleIdRcb();
        }
        return $this->operation🌀Orgs🌀CbOrgRcb🌀CustomDashRepositoryDashRoles🌀CbRoleIdRcb;
    }
    ...
    public function getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀CustomRoles🌀CbRoleIdRcb() : Hydrator\Operation\Orgs\CbOrgRcb\CustomRoles\CbRoleIdRcb
    {
        if ($this->operation🌀Orgs🌀CbOrgRcb🌀CustomRoles🌀CbRoleIdRcb instanceof Hydrator\Operation\Orgs\CbOrgRcb\CustomRoles\CbRoleIdRcb === false) {
            $this->operation🌀Orgs🌀CbOrgRcb🌀CustomRoles🌀CbRoleIdRcb = new Hydrator\Operation\Orgs\CbOrgRcb\CustomRoles\CbRoleIdRcb();
        }
        return $this->operation🌀Orgs🌀CbOrgRcb🌀CustomRoles🌀CbRoleIdRcb;
    }
    ...
    public function getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀RepositoryFineGrainedPermissions() : Hydrator\Operation\Orgs\CbOrgRcb\RepositoryFineGrainedPermissions
    {
        if ($this->operation🌀Orgs🌀CbOrgRcb🌀RepositoryFineGrainedPermissions instanceof Hydrator\Operation\Orgs\CbOrgRcb\RepositoryFineGrainedPermissions === false) {
            $this->operation🌀Orgs🌀CbOrgRcb🌀RepositoryFineGrainedPermissions = new Hydrator\Operation\Orgs\CbOrgRcb\RepositoryFineGrainedPermissions();
        }
    ...
    public function getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀Teams🌀CbTeamSlugRcb🌀TeamDashSync🌀GroupDashMappings() : Hydrator\Operation\Orgs\CbOrgRcb\Teams\CbTeamSlugRcb\TeamDashSync\GroupDashMappings
    {
        if ($this->operation🌀Orgs🌀CbOrgRcb🌀Teams🌀CbTeamSlugRcb🌀TeamDashSync🌀GroupDashMappings instanceof Hydrator\Operation\Orgs\CbOrgRcb\Teams\CbTeamSlugRcb\TeamDashSync\GroupDashMappings === false) {
            $this->operation🌀Orgs🌀CbOrgRcb🌀Teams🌀CbTeamSlugRcb🌀TeamDashSync🌀GroupDashMappings = new Hydrator\Operation\Orgs\CbOrgRcb\Teams\CbTeamSlugRcb\TeamDashSync\GroupDashMappings();
        }
        return $this->operation🌀Orgs🌀CbOrgRcb🌀Teams🌀CbTeamSlugRcb🌀TeamDashSync🌀GroupDashMappings;
    }
    ...
    public function getObjectMapperOperation🌀Scim🌀V2🌀Organizations🌀CbOrgRcb🌀Users🌀CbScimUserIdRcb() : Hydrator\Operation\Scim\V2\Organizations\CbOrgRcb\Users\CbScimUserIdRcb
    {
        if ($this->operation🌀Scim🌀V2🌀Organizations🌀CbOrgRcb🌀Users🌀CbScimUserIdRcb instanceof Hydrator\Operation\Scim\V2\Organizations\CbOrgRcb\Users\CbScimUserIdRcb === false) {
            $this->operation🌀Scim🌀V2🌀Organizations🌀CbOrgRcb🌀Users🌀CbScimUserIdRcb = new Hydrator\Operation\Scim\V2\Organizations\CbOrgRcb\Users\CbScimUserIdRcb();
        }
        return $this->operation🌀Scim🌀V2🌀Organizations🌀CbOrgRcb🌀Users🌀CbScimUserIdRcb;
    }
    ...
    public function getObjectMapperOperation🌀Teams🌀CbTeamIdRcb🌀TeamDashSync🌀GroupDashMappings() : Hydrator\Operation\Teams\CbTeamIdRcb\TeamDashSync\GroupDashMappings
    {
        if ($this->operation🌀Teams🌀CbTeamIdRcb🌀TeamDashSync🌀GroupDashMappings instanceof Hydrator\Operation\Teams\CbTeamIdRcb\TeamDashSync\GroupDashMappings === false) {
            $this->operation🌀Teams🌀CbTeamIdRcb🌀TeamDashSync🌀GroupDashMappings = new Hydrator\Operation\Teams\CbTeamIdRcb\TeamDashSync\GroupDashMappings();
        }
        return $this->operation🌀Teams🌀CbTeamIdRcb🌀TeamDashSync🌀GroupDashMappings;
    }
