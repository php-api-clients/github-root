...
namespace ApiClients\Client\GitHubEnterpriseCloud\PHPStan;
...
final readonly class ClientCallReturnTypes implements DynamicMethodReturnTypeExtension
{
    ...
    public function getTypeFromMethodCall(MethodReflection $methodReflection, MethodCall $methodCall, Scope $scope): Type|null
    {
        ...
        if ($call === 'GET /assignments/{assignment_id}') {
            return $this->typeResolver->resolve('Schema\\ClassroomAssignment');
        }
        ...
        if ($call === 'GET /assignments/{assignment_id}/grades') {
            return $this->typeResolver->resolve('iterable<int,Schema\\ClassroomAssignmentGrade>');
        }

        if ($call === 'GET /classrooms') {
            return $this->typeResolver->resolve('iterable<int,Schema\\SimpleClassroom>');
        }
        ...
        if ($call === 'GET /classrooms/{classroom_id}') {
            return $this->typeResolver->resolve('Schema\\Classroom');
        }

        if ($call === 'GET /classrooms/{classroom_id}/assignments') {
            return $this->typeResolver->resolve('iterable<int,Schema\\SimpleClassroomAssignment>');
        }
        ...
        if ($call === 'GET /enterprise-installation/{enterprise_or_org}/server-statistics') {
            return $this->typeResolver->resolve('iterable<int,Schema\\ServerStatistics>');
        }
        ...
        if ($call === 'GET /enterprises/{enterprise}/settings/billing/actions') {
            return $this->typeResolver->resolve('Schema\\ActionsBillingUsage');
        }
        ...
        if ($call === 'GET /enterprises/{enterprise}/settings/billing/packages') {
            return $this->typeResolver->resolve('Schema\\PackagesBillingUsage');
        }

        if ($call === 'GET /enterprises/{enterprise}/settings/billing/shared-storage') {
            return $this->typeResolver->resolve('Schema\\CombinedBillingUsage');
        }
        ...
        if ($call === 'GET /marketplace_listing/accounts/{account_id}') {
            return $this->typeResolver->resolve('Schema\\MarketplacePurchase');
        }

        if ($call === 'GET /marketplace_listing/plans') {
            return $this->typeResolver->resolve('iterable<int,Schema\\MarketplaceListingPlan>');
        }
        ...
        if ($call === 'GET /marketplace_listing/plans/{plan_id}/accounts') {
            return $this->typeResolver->resolve('iterable<int,Schema\\MarketplacePurchase>');
        }
        ...
        if ($call === 'GET /marketplace_listing/stubbed/accounts/{account_id}') {
            return $this->typeResolver->resolve('Schema\\MarketplacePurchase|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
        ...
        if ($call === 'GET /orgs/{org}/codespaces') {
            return $this->typeResolver->resolve('Schema\\Operations\\Codespaces\\ListInOrganization\\Response\\ApplicationJson\\Ok|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
        ...
        if ($call === 'GET /orgs/{org}/codespaces/secrets') {
            return $this->typeResolver->resolve('Schema\\Operations\\Codespaces\\ListOrgSecrets\\Response\\ApplicationJson\\Ok');
        }

        if ($call === 'GET /orgs/{org}/codespaces/secrets/public-key') {
            return $this->typeResolver->resolve('Schema\\CodespacesPublicKey');
        }

        if ($call === 'GET /orgs/{org}/codespaces/secrets/{secret_name}') {
            return $this->typeResolver->resolve('Schema\\CodespacesOrgSecret');
        }
        ...
        if ($call === 'GET /orgs/{org}/codespaces/secrets/{secret_name}/repositories') {
            return $this->typeResolver->resolve('Schema\\Operations\\Codespaces\\ListSelectedReposForOrgSecret\\Response\\ApplicationJson\\Ok\\Application\\Json');
        }
        ...
        if ($call === 'GET /orgs/{org}/copilot/billing') {
            return $this->typeResolver->resolve('Schema\\CopilotOrganizationDetails');
        }
        ...
        if ($call === 'GET /orgs/{org}/credential-authorizations') {
            return $this->typeResolver->resolve('iterable<int,Schema\\CredentialAuthorization>');
        }
        ...
        if ($call === 'GET /orgs/{org}/failed_invitations') {
            return $this->typeResolver->resolve('iterable<int,Schema\\OrganizationInvitation>');
        }
        ...
        if ($call === 'GET /orgs/{org}/interaction-limits') {
            return $this->typeResolver->resolve('Schema\\InteractionLimitResponse|Schema\\Operations\\Interactions\\GetRestrictionsForOrg\\Response\\ApplicationJson\\Ok\\Application\\Json\\One');
        }

        if ($call === 'PUT /orgs/{org}/interaction-limits') {
            return $this->typeResolver->resolve('Schema\\InteractionLimitResponse');
        }
        ...
        if ($call === 'POST /orgs/{org}/invitations') {
            return $this->typeResolver->resolve('Schema\\OrganizationInvitation');
        }
        ...
        if ($call === 'GET /orgs/{org}/members/{username}/codespaces') {
            return $this->typeResolver->resolve('Schema\\Operations\\Codespaces\\GetCodespacesForUserInOrg\\Response\\ApplicationJson\\Ok\\Application\\Json|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }

        if ($call === 'DELETE /orgs/{org}/members/{username}/codespaces/{codespace_name}') {
            return $this->typeResolver->resolve('Schema\\Operations\\Codespaces\\DeleteFromOrganization\\Response\\ApplicationJson\\Accepted\\Application\\Json|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }

        if ($call === 'POST /orgs/{org}/members/{username}/codespaces/{codespace_name}/stop') {
            return $this->typeResolver->resolve('Schema\\Codespace|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
        ...
        if ($call === 'GET /orgs/{org}/properties/schema') {
            return $this->typeResolver->resolve('iterable<int,Schema\\OrgCustomProperty>');
        }
        ...
        if ($call === 'GET /orgs/{org}/properties/schema/{custom_property_name}') {
            return $this->typeResolver->resolve('Schema\\OrgCustomProperty');
        }
        ...
        if ($call === 'GET /orgs/{org}/properties/values') {
            return $this->typeResolver->resolve('iterable<int,Schema\\OrgRepoCustomPropertyValues>');
        }
        ...
        if ($call === 'GET /orgs/{org}/rulesets/rule-suites/{rule_suite_id}') {
            return $this->typeResolver->resolve('Schema\\RuleSuite');
        }
        ...
        if ($call === 'GET /orgs/{org}/security-advisories') {
            return $this->typeResolver->resolve('iterable<int,Schema\\RepositoryAdvisory>');
        }
        ...
        if ($call === 'GET /orgs/{org}/team-sync/groups') {
            return $this->typeResolver->resolve('Schema\\GroupMapping');
        }
        ...
        if ($call === 'GET /repos/{owner}/{repo}/code-scanning/codeql/databases') {
            return $this->typeResolver->resolve('iterable<int,Schema\\CodeScanningCodeqlDatabase>');
        }

        if ($call === 'GET /repos/{owner}/{repo}/code-scanning/codeql/databases/{language}') {
            return $this->typeResolver->resolve('Schema\\CodeScanningCodeqlDatabase|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
        ...
        if ($call === 'GET /repos/{owner}/{repo}/codespaces') {
            return $this->typeResolver->resolve('Schema\\Operations\\Codespaces\\ListInRepositoryForAuthenticatedUser\\Response\\ApplicationJson\\Ok\\Application\\Json');
        }

        if ($call === 'POST /repos/{owner}/{repo}/codespaces') {
            return $this->typeResolver->resolve('Schema\\Codespace');
        }

        if ($call === 'GET /repos/{owner}/{repo}/codespaces/devcontainers') {
            return $this->typeResolver->resolve('Schema\\Operations\\Codespaces\\ListDevcontainersInRepositoryForAuthenticatedUser\\Response\\ApplicationJson\\Ok');
        }

        if ($call === 'GET /repos/{owner}/{repo}/codespaces/machines') {
            return $this->typeResolver->resolve('Schema\\Operations\\Codespaces\\RepoMachinesForAuthenticatedUser\\Response\\ApplicationJson\\Ok|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }

        if ($call === 'GET /repos/{owner}/{repo}/codespaces/new') {
            return $this->typeResolver->resolve('Schema\\Operations\\Codespaces\\PreFlightWithRepoForAuthenticatedUser\\Response\\ApplicationJson\\Ok');
        }

        if ($call === 'GET /repos/{owner}/{repo}/codespaces/permissions_check') {
            return $this->typeResolver->resolve('Schema\\CodespacesPermissionsCheckForDevcontainer');
        }

        if ($call === 'GET /repos/{owner}/{repo}/codespaces/secrets') {
            return $this->typeResolver->resolve('Schema\\Operations\\Codespaces\\ListRepoSecrets\\Response\\ApplicationJson\\Ok');
        }
        ...
        if ($call === 'GET /repos/{owner}/{repo}/codespaces/secrets/{secret_name}') {
            return $this->typeResolver->resolve('Schema\\RepoCodespacesSecret');
        }
        ...
        if ($call === 'GET /repos/{owner}/{repo}/community/profile') {
            return $this->typeResolver->resolve('Schema\\CommunityProfile');
        }
        ...
        if ($call === 'GET /repos/{owner}/{repo}/import') {
            return $this->typeResolver->resolve('Schema\\Import');
        }
        ...
        if ($call === 'GET /repos/{owner}/{repo}/import/authors') {
            return $this->typeResolver->resolve('iterable<int,Schema\\PorterAuthor>');
        }

        if ($call === 'PATCH /repos/{owner}/{repo}/import/authors/{author_id}') {
            return $this->typeResolver->resolve('Schema\\PorterAuthor');
        }

        if ($call === 'GET /repos/{owner}/{repo}/import/large_files') {
            return $this->typeResolver->resolve('iterable<int,Schema\\PorterLargeFile>');
        }
        ...
        if ($call === 'GET /repos/{owner}/{repo}/interaction-limits') {
            return $this->typeResolver->resolve('Schema\\InteractionLimitResponse|Schema\\Operations\\Interactions\\GetRestrictionsForRepo\\Response\\ApplicationJson\\Ok\\Application\\Json\\One');
        }

        if ($call === 'PUT /repos/{owner}/{repo}/interaction-limits') {
            return $this->typeResolver->resolve('Schema\\InteractionLimitResponse|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
        ...
        if ($call === 'PUT /repos/{owner}/{repo}/notifications') {
            return $this->typeResolver->resolve('Schema\\Operations\\Activity\\MarkRepoNotificationsAsRead\\Response\\ApplicationJson\\Accepted|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
        ...
        if ($call === 'GET /repos/{owner}/{repo}/pages/health') {
            return $this->typeResolver->resolve('Schema\\PagesHealthCheck|Schema\\EmptyObject|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
        ...
        if ($call === 'GET /repos/{owner}/{repo}/properties/values') {
            return $this->typeResolver->resolve('iterable<int,Schema\\CustomPropertyValue>');
        }
        ...
        if ($call === 'POST /repos/{owner}/{repo}/security-advisories') {
            return $this->typeResolver->resolve('Schema\\RepositoryAdvisory');
        }
        ...
        if ($call === 'POST /repos/{owner}/{repo}/security-advisories/{ghsa_id}/cve') {
            return $this->typeResolver->resolve('Schema\\Operations\\SecurityAdvisories\\CreateRepositoryAdvisoryCveRequest\\Response\\ApplicationJson\\Accepted\\Application\\Json');
        }
        ...
        if ($call === 'GET /repos/{owner}/{repo}/traffic/clones') {
            return $this->typeResolver->resolve('Schema\\CloneTraffic');
        }

        if ($call === 'GET /repos/{owner}/{repo}/traffic/popular/paths') {
            return $this->typeResolver->resolve('iterable<int,Schema\\ContentTraffic>');
        }

        if ($call === 'GET /repos/{owner}/{repo}/traffic/popular/referrers') {
            return $this->typeResolver->resolve('iterable<int,Schema\\ReferrerTraffic>');
        }

        if ($call === 'GET /repos/{owner}/{repo}/traffic/views') {
            return $this->typeResolver->resolve('Schema\\ViewTraffic');
        }
        ...
        if ($call === 'GET /scim/v2/organizations/{org}/Users') {
            return $this->typeResolver->resolve('Schema\\ScimUserList|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }

        if ($call === 'POST /scim/v2/organizations/{org}/Users') {
            return $this->typeResolver->resolve('Schema\\ScimUser|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
        ...
        if ($call === 'GET /user/codespaces') {
            return $this->typeResolver->resolve('Schema\\Operations\\Codespaces\\ListForAuthenticatedUser\\Response\\ApplicationJson\\Ok\\Application\\Json|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
        ...
        if ($call === 'GET /user/codespaces/secrets') {
            return $this->typeResolver->resolve('Schema\\Operations\\Codespaces\\ListSecretsForAuthenticatedUser\\Response\\ApplicationJson\\Ok');
        }

        if ($call === 'GET /user/codespaces/secrets/public-key') {
            return $this->typeResolver->resolve('Schema\\CodespacesUserPublicKey');
        }

        if ($call === 'GET /user/codespaces/secrets/{secret_name}') {
            return $this->typeResolver->resolve('Schema\\CodespacesSecret');
        }
        ...
        if ($call === 'GET /user/codespaces/secrets/{secret_name}/repositories') {
            return $this->typeResolver->resolve('Schema\\Operations\\Codespaces\\ListRepositoriesForSecretForAuthenticatedUser\\Response\\ApplicationJson\\Ok\\Application\\Json');
        }
        ...
        if ($call === 'DELETE /user/codespaces/{codespace_name}') {
            return $this->typeResolver->resolve('Schema\\Operations\\Codespaces\\DeleteForAuthenticatedUser\\Response\\ApplicationJson\\Accepted\\Application\\Json|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
        ...
        if ($call === 'POST /user/codespaces/{codespace_name}/exports') {
            return $this->typeResolver->resolve('Schema\\CodespaceExportDetails');
        }
        ...
        if ($call === 'GET /user/codespaces/{codespace_name}/machines') {
            return $this->typeResolver->resolve('Schema\\Operations\\Codespaces\\CodespaceMachinesForAuthenticatedUser\\Response\\ApplicationJson\\Ok\\Application\\Json|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }

        if ($call === 'POST /user/codespaces/{codespace_name}/publish') {
            return $this->typeResolver->resolve('Schema\\CodespaceWithFullRepository');
        }
        ...
        if ($call === 'GET /user/interaction-limits') {
            return $this->typeResolver->resolve('Schema\\InteractionLimitResponse|Schema\\Operations\\Interactions\\GetRestrictionsForAuthenticatedUser\\Response\\ApplicationJson\\Ok\\Application\\Json\\One|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
        ...
        if ($call === 'GET /user/marketplace_purchases') {
            return $this->typeResolver->resolve('iterable<int,Schema\\UserMarketplacePurchase>|\\ApiClients\\Tools\\OpenApiClient\\Utils\\Response\\WithoutBody');
        }
