 ...
 * @internal
 */
final class RepositoryImport implements WebHookInterface
{
    private readonly SchemaValidator $requestSchemaValidator;
    private readonly Hydrator\WebHook\RepositoryImport $hydrator;

    public function __construct(SchemaValidator $requestSchemaValidator, Hydrator\WebHook\RepositoryImport $hydrator)
    {
    ...
    public function resolve(array $headers, array $data): Schema\WebhookRepositoryImport
    {
        ...
        if ($headers['content-type'] === 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($data, Reader::readFromJson(Schema\WebhookRepositoryImport::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
