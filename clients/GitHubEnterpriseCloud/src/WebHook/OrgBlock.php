 ...
 * @internal
 */
final class OrgBlock implements WebHookInterface
{
    private readonly SchemaValidator $requestSchemaValidator;
    private readonly Hydrator\WebHook\OrgBlock $hydrator;

    public function __construct(SchemaValidator $requestSchemaValidator, Hydrator\WebHook\OrgBlock $hydrator)
    {
    ...
    public function resolve(array $headers, array $data): Schema\WebhookOrgBlockBlocked|Schema\WebhookOrgBlockUnblocked
    {
        ...
        if ($headers['content-type'] === 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($data, Reader::readFromJson(Schema\WebhookOrgBlockBlocked::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
        ...
        if ($headers['content-type'] === 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($headers['x-github-delivery'], Reader::readFromJson(Schema\WebHookHeader\XGitHubDelivery::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                $this->requestSchemaValidator->validate($headers['x-hub-signature-256'], Reader::readFromJson(Schema\WebHookHeader\XHubSignature::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                $this->requestSchemaValidator->validate($data, Reader::readFromJson(Schema\WebhookOrgBlockUnblocked::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
