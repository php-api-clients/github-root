                    ...
                    if ($pathChunks[3] == 'blocks') {
                        ...
                        if ($pathChunks[4] == '{credential_id}') {
                            if ($call == 'DELETE /orgs/{org}/credential-authorizations/{credential_id}') {
                                ...
                                return $this->router[Router\Delete\Orgs::class]->removeSamlSsoAuthorization($params);
                            }
                        }
                        ...
                        if ($pathChunks[4] == '{role_id}') {
                            if ($call == 'DELETE /orgs/{org}/custom-repository-roles/{role_id}') {
                                ...
                                return $this->router[Router\Delete\Orgs::class]->deleteCustomRepoRole($params);
                            }
                        }
                        ...
                        if ($pathChunks[4] == '{role_id}') {
                            if ($call == 'DELETE /orgs/{org}/custom_roles/{role_id}') {
                                ...
                                return $this->router[Router\Delete\Orgs::class]->deleteCustomRole($params);
                            }
                        }
