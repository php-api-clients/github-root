...
final readonly class GetAllCommonlyUsedListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Licenses\GetAllCommonlyUsedListing($this->responseSchemaValidator, $this->hydrator, $featured, $perPage, $page);
