...
namespace ApiClients\Client\GitHubEnterpriseCloud\Operator\Licenses;
...
final readonly class GetAllCommonlyUsed
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Licenses\GetAllCommonlyUsed($this->responseSchemaValidator, $this->hydrator, $featured, $perPage, $page);
