...
final readonly class DiffRange
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\DependencyGraph\DiffRange($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $basehead, $name);
