...
final readonly class CreateRepositorySnapshot
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\DependencyGraph\CreateRepositorySnapshot($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo);
