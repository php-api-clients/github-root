...
final readonly class DeleteReviewComment
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Pulls\DeleteReviewComment($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $commentId);
