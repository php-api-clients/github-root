...
final readonly class ListForOrgListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Migrations\ListForOrgListing($this->responseSchemaValidator, $this->hydrator, $org, $exclude, $perPage, $page);
