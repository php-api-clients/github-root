...
final readonly class ListForOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Migrations\ListForOrg($this->responseSchemaValidator, $this->hydrator, $org, $exclude, $perPage, $page);
