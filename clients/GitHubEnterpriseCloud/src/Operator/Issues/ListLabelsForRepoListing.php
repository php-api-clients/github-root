...
final readonly class ListLabelsForRepoListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Issues\ListLabelsForRepoListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
