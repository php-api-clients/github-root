...
final readonly class ListForRepo
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Projects\ListForRepo($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $state, $perPage, $page);
