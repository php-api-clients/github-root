...
final readonly class ListCardsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Projects\ListCardsListing($this->responseSchemaValidator, $this->hydrator, $columnId, $archivedState, $perPage, $page);
