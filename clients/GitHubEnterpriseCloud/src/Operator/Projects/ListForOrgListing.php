...
final readonly class ListForOrgListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Projects\ListForOrgListing($this->responseSchemaValidator, $this->hydrator, $org, $state, $perPage, $page);
