...
final readonly class ListAlertsForRepo
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\SecretScanning\ListAlertsForRepo($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $state, $secretType, $resolution, $before, $after, $sort, $direction, $page, $perPage);
