...
final readonly class GetAlert
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\SecretScanning\GetAlert($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $alertNumber);
