...
final readonly class ListEmailsForAuthenticatedUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Users\ListEmailsForAuthenticatedUser($this->responseSchemaValidator, $this->hydrator, $perPage, $page);
