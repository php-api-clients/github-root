...
final readonly class ListGpgKeysForUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Users\ListGpgKeysForUser($this->responseSchemaValidator, $this->hydrator, $username, $perPage, $page);
