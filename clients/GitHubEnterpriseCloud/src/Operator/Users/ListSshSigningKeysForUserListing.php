...
final readonly class ListSshSigningKeysForUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Users\ListSshSigningKeysForUserListing($this->responseSchemaValidator, $this->hydrator, $username, $perPage, $page);
