...
final readonly class CheckBlocked
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Users\CheckBlocked($this->responseSchemaValidator, $this->hydrator, $username);
