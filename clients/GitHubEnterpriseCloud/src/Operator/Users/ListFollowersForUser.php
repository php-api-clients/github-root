...
final readonly class ListFollowersForUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Users\ListFollowersForUser($this->responseSchemaValidator, $this->hydrator, $username, $perPage, $page);
