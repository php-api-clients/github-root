...
final readonly class GetRestrictionsForRepo
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Interactions\GetRestrictionsForRepo($this->responseSchemaValidator, $this->hydrator, $owner, $repo);
