...
final readonly class DeletePackageForOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Packages\DeletePackageForOrg($this->responseSchemaValidator, $this->hydrator, $packageType, $packageName, $org);
