...
final readonly class DeletePackageForUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Packages\DeletePackageForUser($this->responseSchemaValidator, $this->hydrator, $packageType, $packageName, $username);
