...
namespace ApiClients\Client\GitHubEnterpriseCloud\Operator\Packages;
...
final readonly class GetAllPackageVersionsForPackageOwnedByOrgListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Packages\GetAllPackageVersionsForPackageOwnedByOrgListing($this->responseSchemaValidator, $this->hydrator, $packageType, $packageName, $org, $page, $perPage, $state);
