...
namespace ApiClients\Client\GitHubEnterpriseCloud\Operator\Oidc;
...
final readonly class UpdateOidcCustomSubTemplateForOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Oidc\UpdateOidcCustomSubTemplateForOrg($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $org);
