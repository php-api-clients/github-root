...
final readonly class CreateRepositoryAdvisoryCveRequest
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\SecurityAdvisories\CreateRepositoryAdvisoryCveRequest($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $ghsaId);
