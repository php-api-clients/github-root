...
final readonly class GetCodeqlDatabase
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\CodeScanning\GetCodeqlDatabase($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $language);
