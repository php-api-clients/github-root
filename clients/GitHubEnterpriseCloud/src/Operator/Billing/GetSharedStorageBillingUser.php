...
final readonly class GetSharedStorageBillingUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Billing\GetSharedStorageBillingUser($this->responseSchemaValidator, $this->hydrator, $username);
