...
final readonly class ListSubscriptionsForAuthenticatedUserListing
{
    public const OPERATION_ID    = 'apps/list-subscriptions-for-authenticated-user';
    public const OPERATION_MATCH = 'LIST /user/marketplace_purchases';
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Apps\ListSubscriptionsForAuthenticatedUserListing($this->responseSchemaValidator, $this->hydrator, $perPage, $page);
