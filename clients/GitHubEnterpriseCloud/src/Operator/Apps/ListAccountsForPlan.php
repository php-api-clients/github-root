...
final readonly class ListAccountsForPlan
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Apps\ListAccountsForPlan($this->responseSchemaValidator, $this->hydrator, $planId, $direction, $sort, $perPage, $page);
