...
final readonly class ListAccountsForPlanStubbedListing
{
    public const OPERATION_ID    = 'apps/list-accounts-for-plan-stubbed';
    public const OPERATION_MATCH = 'LIST /marketplace_listing/stubbed/plans/{plan_id}/accounts';
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Apps\ListAccountsForPlanStubbedListing($this->responseSchemaValidator, $this->hydrator, $planId, $direction, $sort, $perPage, $page);
