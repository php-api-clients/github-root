...
final readonly class ListInstallationRequestsForAuthenticatedAppListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Apps\ListInstallationRequestsForAuthenticatedAppListing($this->responseSchemaValidator, $this->hydrator, $perPage, $page);
