...
final readonly class ListSubscriptionsForAuthenticatedUserStubbedListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Apps\ListSubscriptionsForAuthenticatedUserStubbedListing($this->responseSchemaValidator, $this->hydrator, $perPage, $page);
