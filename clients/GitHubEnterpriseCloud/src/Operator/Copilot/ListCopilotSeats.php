...
final readonly class ListCopilotSeats
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $responseSchemaValidator, private Hydrator\Operation\Organizations\Org\Copilot\Billing\Seats $hydrator)
    {
    }
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Copilot\ListCopilotSeats($this->responseSchemaValidator, $this->hydrator, $org, $page, $perPage);
