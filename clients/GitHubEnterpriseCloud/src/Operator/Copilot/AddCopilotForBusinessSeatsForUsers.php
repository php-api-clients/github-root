...
final readonly class AddCopilotForBusinessSeatsForUsers
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Copilot\AddCopilotForBusinessSeatsForUsers($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $org);
