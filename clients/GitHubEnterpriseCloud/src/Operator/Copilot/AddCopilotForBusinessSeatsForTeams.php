...
final readonly class AddCopilotForBusinessSeatsForTeams
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Copilot\AddCopilotForBusinessSeatsForTeams($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $org);
