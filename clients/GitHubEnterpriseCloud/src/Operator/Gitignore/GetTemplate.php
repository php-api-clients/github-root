...
namespace ApiClients\Client\GitHubEnterpriseCloud\Operator\Gitignore;
...
final readonly class GetTemplate
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Gitignore\GetTemplate($this->responseSchemaValidator, $this->hydrator, $name);
