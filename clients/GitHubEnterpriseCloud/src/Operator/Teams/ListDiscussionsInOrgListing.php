...
final readonly class ListDiscussionsInOrgListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Teams\ListDiscussionsInOrgListing($this->responseSchemaValidator, $this->hydrator, $org, $teamSlug, $pinned, $direction, $perPage, $page);
