...
final readonly class CheckPermissionsForRepoInOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Teams\CheckPermissionsForRepoInOrg($this->responseSchemaValidator, $this->hydrator, $org, $teamSlug, $owner, $repo);
