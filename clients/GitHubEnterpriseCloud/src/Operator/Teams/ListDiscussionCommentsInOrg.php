...
final readonly class ListDiscussionCommentsInOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Teams\ListDiscussionCommentsInOrg($org, $teamSlug, $discussionNumber, $direction, $perPage, $page);
