...
final readonly class ListCustomRoles
{
    ...
    /** @return */
    public function call(string $organizationId): Ok|array
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Orgs\ListCustomRoles($this->responseSchemaValidator, $this->hydrator, $organizationId);
