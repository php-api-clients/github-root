...
final readonly class ListBlockedUsersListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Orgs\ListBlockedUsersListing($this->responseSchemaValidator, $this->hydrator, $org, $perPage, $page);
