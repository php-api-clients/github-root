...
final readonly class ListSamlSsoAuthorizationsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Orgs\ListSamlSsoAuthorizationsListing($this->responseSchemaValidator, $this->hydrator, $org, $page, $login, $perPage);
