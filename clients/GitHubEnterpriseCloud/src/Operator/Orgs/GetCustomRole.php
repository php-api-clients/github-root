...
final readonly class GetCustomRole
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $responseSchemaValidator, private Hydrator\Operation\Orgs\Org\CustomRoles\RoleId $hydrator)
    {
    }
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Orgs\GetCustomRole($this->responseSchemaValidator, $this->hydrator, $org, $roleId);
