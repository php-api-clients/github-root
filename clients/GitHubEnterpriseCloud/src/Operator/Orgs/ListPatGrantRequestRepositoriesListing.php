...
final readonly class ListPatGrantRequestRepositoriesListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Orgs\ListPatGrantRequestRepositoriesListing($this->responseSchemaValidator, $this->hydrator, $org, $patRequestId, $perPage, $page);
