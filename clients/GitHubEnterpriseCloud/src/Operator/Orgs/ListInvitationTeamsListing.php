...
final readonly class ListInvitationTeamsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Orgs\ListInvitationTeamsListing($this->responseSchemaValidator, $this->hydrator, $org, $invitationId, $perPage, $page);
