...
final readonly class ListPublicMembersListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Orgs\ListPublicMembersListing($this->responseSchemaValidator, $this->hydrator, $org, $perPage, $page);
