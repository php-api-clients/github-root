...
final readonly class ListMembershipsForAuthenticatedUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Orgs\ListMembershipsForAuthenticatedUserListing($this->responseSchemaValidator, $this->hydrator, $state, $perPage, $page);
