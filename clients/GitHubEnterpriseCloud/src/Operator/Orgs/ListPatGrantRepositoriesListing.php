...
final readonly class ListPatGrantRepositoriesListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Orgs\ListPatGrantRepositoriesListing($this->responseSchemaValidator, $this->hydrator, $org, $patId, $perPage, $page);
