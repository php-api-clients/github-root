...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Gists\CheckIsStarred\Response\ApplicationJson\NotFound;
...
final readonly class ConvertMemberToOutsideCollaborator
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Orgs\ConvertMemberToOutsideCollaborator($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $org, $username);
