...
final readonly class ListPendingInvitationsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Orgs\ListPendingInvitationsListing($this->responseSchemaValidator, $this->hydrator, $org, $perPage, $page, $role, $invitationSource);
