...
final readonly class ListOutsideCollaborators
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Orgs\ListOutsideCollaborators($this->responseSchemaValidator, $this->hydrator, $org, $filter, $perPage, $page);
