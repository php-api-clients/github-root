...
namespace ApiClients\Client\GitHubEnterpriseCloud\Operator\RateLimit;
...
final readonly class Get
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\RateLimit\Get($this->responseSchemaValidator, $this->hydrator);
