...
final readonly class ListForTeamDiscussionCommentLegacy
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Reactions\ListForTeamDiscussionCommentLegacy($teamId, $discussionNumber, $commentNumber, $content, $perPage, $page);
