...
final readonly class ListCommentsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Gists\ListCommentsListing($this->responseSchemaValidator, $this->hydrator, $gistId, $perPage, $page);
