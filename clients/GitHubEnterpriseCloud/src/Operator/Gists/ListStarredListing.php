...
final readonly class ListStarredListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Gists\ListStarredListing($this->responseSchemaValidator, $this->hydrator, $since, $perPage, $page);
