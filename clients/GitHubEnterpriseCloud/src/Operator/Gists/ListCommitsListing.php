...
final readonly class ListCommitsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Gists\ListCommitsListing($this->responseSchemaValidator, $this->hydrator, $gistId, $perPage, $page);
