...
final readonly class SetSelectedOrganizationsEnabledGithubActionsEnterprise
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\EnterpriseAdmin\SetSelectedOrganizationsEnabledGithubActionsEnterprise($this->requestSchemaValidator, $enterprise);
