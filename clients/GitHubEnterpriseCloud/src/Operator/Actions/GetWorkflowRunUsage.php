...
final readonly class GetWorkflowRunUsage
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Actions\GetWorkflowRunUsage($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $runId);
