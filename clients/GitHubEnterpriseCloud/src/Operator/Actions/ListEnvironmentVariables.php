...
final readonly class ListEnvironmentVariables
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Actions\ListEnvironmentVariables($this->responseSchemaValidator, $this->hydrator, $repositoryId, $environmentName, $perPage, $page);
