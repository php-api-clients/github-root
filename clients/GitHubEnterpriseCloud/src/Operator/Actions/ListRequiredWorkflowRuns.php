...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Actions\ListRequiredWorkflowRuns\Response\ApplicationJson\Ok;
...
final readonly class ListRequiredWorkflowRuns
{
    ...
    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $responseSchemaValidator, private Hydrator\Operation\Repos\Owner\Repo\Actions\RequiredWorkflows\RequiredWorkflowIdForRepo\Runs $hydrator)
    {
    }
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Actions\ListRequiredWorkflowRuns($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $requiredWorkflowIdForRepo, $actor, $branch, $event, $status, $created, $checkSuiteId, $headSha, $perPage, $page, $excludePullRequests);
