...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Actions\ListOrgSecrets\Response\ApplicationJson\Ok;
...
final readonly class ListOrgSecrets
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Actions\ListOrgSecrets($this->responseSchemaValidator, $this->hydrator, $org, $perPage, $page);
