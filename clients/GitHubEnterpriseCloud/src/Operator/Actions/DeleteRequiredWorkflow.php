...
final readonly class DeleteRequiredWorkflow
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Actions\DeleteRequiredWorkflow($org, $requiredWorkflowId);
