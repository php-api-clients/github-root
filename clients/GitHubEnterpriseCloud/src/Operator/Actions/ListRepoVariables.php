...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Actions\ListRepoVariables\Response\ApplicationJson\Ok\Application\Json;
...
final readonly class ListRepoVariables
{
    ...
    /** @return */
    public function call(string $owner, string $repo, int $perPage = 10, int $page = 1): Json|array
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Actions\ListRepoVariables($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
