...
final readonly class GenerateRunnerJitconfigForOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Actions\GenerateRunnerJitconfigForOrg($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $org);
