...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Actions\ListRepoRequiredWorkflows\Response\ApplicationJson\Ok;
...
final readonly class ListRepoRequiredWorkflows
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Actions\ListRepoRequiredWorkflows($this->responseSchemaValidator, $this->hydrator, $org, $repo, $perPage, $page);
