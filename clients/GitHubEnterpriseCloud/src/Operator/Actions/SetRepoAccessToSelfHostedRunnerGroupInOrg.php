...
final readonly class SetRepoAccessToSelfHostedRunnerGroupInOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Actions\SetRepoAccessToSelfHostedRunnerGroupInOrg($this->requestSchemaValidator, $org, $runnerGroupId);
