...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Actions\ListRepoWorkflows\Response\ApplicationJson\Ok;
...
final readonly class ListRepoWorkflows
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Actions\ListRepoWorkflows($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
