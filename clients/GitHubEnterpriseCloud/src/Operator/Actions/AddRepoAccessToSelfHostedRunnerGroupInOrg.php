...
final readonly class AddRepoAccessToSelfHostedRunnerGroupInOrg
{
    ...
    public function call(string $org, int $runnerGroupId, int $repositoryId): PromiseInterface
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Actions\AddRepoAccessToSelfHostedRunnerGroupInOrg($org, $runnerGroupId, $repositoryId);
