...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\Actions\ListRequiredWorkflows\Response\ApplicationJson\Ok;
...
final readonly class ListRequiredWorkflows
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Actions\ListRequiredWorkflows($this->responseSchemaValidator, $this->hydrator, $org, $perPage, $page);
