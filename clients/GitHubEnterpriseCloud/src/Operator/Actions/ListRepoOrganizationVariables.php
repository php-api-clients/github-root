...
final readonly class ListRepoOrganizationVariables
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Actions\ListRepoOrganizationVariables($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
