...
final readonly class ListSelectedRepositoriesEnabledGithubActionsOrganization
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Actions\ListSelectedRepositoriesEnabledGithubActionsOrganization($this->responseSchemaValidator, $this->hydrator, $org, $perPage, $page);
