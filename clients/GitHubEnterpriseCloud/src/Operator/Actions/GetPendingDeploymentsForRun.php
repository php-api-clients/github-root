...
final readonly class GetPendingDeploymentsForRun
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Actions\GetPendingDeploymentsForRun($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $runId);
