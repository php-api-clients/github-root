...
final readonly class ListReceivedPublicEventsForUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Activity\ListReceivedPublicEventsForUser($this->responseSchemaValidator, $this->hydrator, $username, $perPage, $page);
