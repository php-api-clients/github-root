...
final readonly class ListWatchersForRepo
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Activity\ListWatchersForRepo($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
