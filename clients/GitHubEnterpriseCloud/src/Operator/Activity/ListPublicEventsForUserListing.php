...
final readonly class ListPublicEventsForUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Activity\ListPublicEventsForUserListing($this->responseSchemaValidator, $this->hydrator, $username, $perPage, $page);
