...
final readonly class ListRepoNotificationsForAuthenticatedUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Activity\ListRepoNotificationsForAuthenticatedUser($owner, $repo, $since, $before, $all, $participating, $perPage, $page);
