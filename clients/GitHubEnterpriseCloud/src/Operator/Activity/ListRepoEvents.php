...
final readonly class ListRepoEvents
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Activity\ListRepoEvents($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
