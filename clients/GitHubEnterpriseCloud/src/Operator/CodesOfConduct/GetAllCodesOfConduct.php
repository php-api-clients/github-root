...
namespace ApiClients\Client\GitHubEnterpriseCloud\Operator\CodesOfConduct;
...
final readonly class GetAllCodesOfConduct
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\CodesOfConduct\GetAllCodesOfConduct($this->responseSchemaValidator, $this->hydrator);
