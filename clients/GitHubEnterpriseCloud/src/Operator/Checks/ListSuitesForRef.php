...
namespace ApiClients\Client\GitHubEnterpriseCloud\Operator\Checks;
...
final readonly class ListSuitesForRef
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Checks\ListSuitesForRef($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $ref, $appId, $checkName, $perPage, $page);
