...
final readonly class GetBranchRulesListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Repos\GetBranchRulesListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $branch, $perPage, $page);
