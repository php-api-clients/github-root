...
final readonly class ListWebhooksListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Repos\ListWebhooksListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
