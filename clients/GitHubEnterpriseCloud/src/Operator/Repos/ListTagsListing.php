...
final readonly class ListTagsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Repos\ListTagsListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
