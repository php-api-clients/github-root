...
final readonly class SetAdminBranchProtection
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Repos\SetAdminBranchProtection($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $branch);
