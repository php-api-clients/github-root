...
final readonly class DeleteCommitSignatureProtection
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Repos\DeleteCommitSignatureProtection($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $branch);
