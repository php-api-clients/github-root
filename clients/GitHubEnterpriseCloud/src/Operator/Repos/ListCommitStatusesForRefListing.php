...
final readonly class ListCommitStatusesForRefListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Repos\ListCommitStatusesForRefListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $ref, $perPage, $page);
