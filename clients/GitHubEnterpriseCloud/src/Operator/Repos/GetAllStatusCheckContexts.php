...
final readonly class GetAllStatusCheckContexts
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Repos\GetAllStatusCheckContexts($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $branch);
