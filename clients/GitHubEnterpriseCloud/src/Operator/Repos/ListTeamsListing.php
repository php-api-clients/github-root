...
final readonly class ListTeamsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Repos\ListTeamsListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
