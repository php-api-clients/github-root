...
final readonly class CheckAutomatedSecurityFixes
{
    ...
    /** @return PromiseInterface<(\ApiClients\Client\GitHubEnterpriseCloud\Schema\CheckAutomatedSecurityFixes|array)> **/
    public function call(string $owner, string $repo): PromiseInterface
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Repos\CheckAutomatedSecurityFixes($this->responseSchemaValidator, $this->hydrator, $owner, $repo);
