...
final readonly class GetBranchRules
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Repos\GetBranchRules($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $branch, $perPage, $page);
