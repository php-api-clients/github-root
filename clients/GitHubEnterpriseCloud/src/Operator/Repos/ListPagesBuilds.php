...
final readonly class ListPagesBuilds
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Repos\ListPagesBuilds($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
