...
final readonly class GetCommitComment
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Repos\GetCommitComment($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $commentId);
