...
final readonly class DeleteBranchProtection
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Repos\DeleteBranchProtection($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $branch);
