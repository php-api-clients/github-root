...
final readonly class DisableAutomatedSecurityFixes
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Repos\DisableAutomatedSecurityFixes($owner, $repo);
