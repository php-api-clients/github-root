...
final readonly class ListPagesBuildsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Repos\ListPagesBuildsListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
