...
final readonly class RemoveCollaborator
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Repos\RemoveCollaborator($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $username);
