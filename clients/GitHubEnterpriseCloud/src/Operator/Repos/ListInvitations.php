...
final readonly class ListInvitations
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterpriseCloud\Operation\Repos\ListInvitations($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
