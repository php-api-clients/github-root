...
final readonly class ActionsHostedRunner
{
    ...
    public const SCHEMA_TITLE        = 'GitHub-hosted hosted runner';
    public const SCHEMA_DESCRIPTION  = 'A Github-hosted hosted runner.';
     ...
     * machineSizeDetails: Provides details of a particular machine spec.
     ...
     */
    public function __construct(public int $id, public string $name, #[MapFrom('runner_group_id')]
    public int|null $runnerGroupId, #[MapFrom('image_details')]
    public Schema\ActionsHostedRunnerPoolImage|null $imageDetails, #[MapFrom('machine_size_details')]
    public Schema\ActionsHostedRunnerMachineSpec $machineSizeDetails, public string $status, public string $platform, #[MapFrom('maximum_runners')]
    public int|null $maximumRunners, #[MapFrom('public_ip_enabled')]
    public bool $publicIpEnabled, #[MapFrom('public_ips')]
    public array|null $publicIps, #[MapFrom('last_active_on')]
    public string|null $lastActiveOn,)
    {
    }
}
