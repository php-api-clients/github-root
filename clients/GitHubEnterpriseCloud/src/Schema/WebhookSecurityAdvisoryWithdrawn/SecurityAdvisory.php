...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAdvisoryWithdrawn;
...
final readonly class SecurityAdvisory
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"cvss":{"score":13,"vectorString":"generated_vector_string_null"},"cwes":[{"cweId":"generated_cwe_id_null","name":"generated_name_null"}],"description":"generated_description_null","ghsaId":"generated_ghsa_id_null","identifiers":[{"type":"generated_type_null","value":"generated_value_null"}],"publishedAt":"generated_published_at_null","references":[{"url":"https:\\/\\/example.com\\/"}],"severity":"generated_severity_null","summary":"generated_summary_null","updatedAt":"generated_updated_at_null","vulnerabilities":[{"firstPatchedVersion":{"identifier":"generated_identifier_null"},"package":{"ecosystem":"generated_ecosystem_null","name":"generated_name_null"},"severity":"generated_severity_null","vulnerableVersionRange":"generated_vulnerable_version_range_null"}],"withdrawnAt":"generated_withdrawn_at_null"}';
    /**
     * @param array<\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAdvisoryPublished\SecurityAdvisory\Cwes> $cwes
     * @param array<\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAdvisoryPublished\SecurityAdvisory\Identifiers> $identifiers
     * @param array<\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAdvisoryPublished\SecurityAdvisory\References> $references
     * @param array<\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAdvisoryPublished\SecurityAdvisory\Vulnerabilities> $vulnerabilities
     */
