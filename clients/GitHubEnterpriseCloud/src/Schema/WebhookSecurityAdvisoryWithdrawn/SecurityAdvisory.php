...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAdvisoryWithdrawn\SecurityAdvisory\Cwes;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAdvisoryWithdrawn\SecurityAdvisory\Identifiers;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAdvisoryWithdrawn\SecurityAdvisory\References;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAdvisoryWithdrawn\SecurityAdvisory\Vulnerabilities;
...
final readonly class SecurityAdvisory
{
     ...
     */
    public function __construct(public Schema\WebhookSecurityAdvisoryWithdrawn\SecurityAdvisory\Cvss $cvss, #[CastListToType(Schema\WebhookSecurityAdvisoryWithdrawn\SecurityAdvisory\Cwes::class)] public array $cwes, public string $description, #[MapFrom('ghsa_id')] public string $ghsaId, #[CastListToType(Schema\WebhookSecurityAdvisoryWithdrawn\SecurityAdvisory\Identifiers::class)] public array $identifiers, #[MapFrom('published_at')] public string $publishedAt, #[CastListToType(Schema\WebhookSecurityAdvisoryWithdrawn\SecurityAdvisory\References::class)] public array $references, public string $severity, public string $summary, #[MapFrom('updated_at')] public string $updatedAt, #[CastListToType(Schema\WebhookSecurityAdvisoryWithdrawn\SecurityAdvisory\Vulnerabilities::class)] public array $vulnerabilities, #[MapFrom('withdrawn_at')] public string $withdrawnAt)
    {
    }
}
