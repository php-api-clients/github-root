...
final readonly class SecurityAdvisory
{
    ...
    /**
     * @param array<\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAdvisoryWithdrawn\SecurityAdvisory\Cwes> $cwes
     * @param array<\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAdvisoryWithdrawn\SecurityAdvisory\Identifiers> $identifiers
     * @param array<\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAdvisoryWithdrawn\SecurityAdvisory\References> $references
     * @param array<\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookSecurityAdvisoryWithdrawn\SecurityAdvisory\Vulnerabilities> $vulnerabilities
     */
    public function __construct(public Schema\WebhookSecurityAdvisoryWithdrawn\SecurityAdvisory\Cvss $cvss, #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\WebhookSecurityAdvisoryWithdrawn\SecurityAdvisory\Cwes::class)] public array $cwes, public string $description, #[\EventSauce\ObjectHydrator\MapFrom('ghsa_id')] public string $ghsaId, #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\WebhookSecurityAdvisoryWithdrawn\SecurityAdvisory\Identifiers::class)] public array $identifiers, #[\EventSauce\ObjectHydrator\MapFrom('published_at')] public string $publishedAt, #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\WebhookSecurityAdvisoryWithdrawn\SecurityAdvisory\References::class)] public array $references, public string $severity, public string $summary, #[\EventSauce\ObjectHydrator\MapFrom('updated_at')] public string $updatedAt, #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\WebhookSecurityAdvisoryWithdrawn\SecurityAdvisory\Vulnerabilities::class)] public array $vulnerabilities, #[\EventSauce\ObjectHydrator\MapFrom('withdrawn_at')] public string $withdrawnAt)
    {
    }
}
