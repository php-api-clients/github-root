...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookDiscussionCategoryChanged;
...
final readonly class Changes
{
    ...
    public ?Schema\WebhookDiscussionCategoryChanged\Changes\Category $category;
    public function __construct(Schema\WebhookDiscussionCategoryChanged\Changes\Category $category)
    {
