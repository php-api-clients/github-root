...
final readonly class WebhookRepositoryRulesetEdited
{
     ...
     */
    public function __construct(public string $action, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimple|null $organization, public Schema\Repository|null $repository, #[MapFrom('repository_ruleset')]
    public Schema\RepositoryRuleset $repositoryRuleset, public Schema\WebhookRepositoryRulesetEdited\Changes|null $changes, public Schema\SimpleUser $sender,)
    {
    }
}
