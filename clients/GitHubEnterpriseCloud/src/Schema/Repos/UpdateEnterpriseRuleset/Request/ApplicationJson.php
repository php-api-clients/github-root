...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\Repos\UpdateEnterpriseRuleset\Request;

use ApiClients\Client\GitHubEnterpriseCloud\Internal\Attribute\CastUnionToType\Schema\Repos\UpdateEnterpriseRuleset\Request\ApplicationJson\Conditions;
...
final readonly class ApplicationJson
{
     ...
     * conditions: Conditions for an enterprise ruleset. The conditions object should contain either the `organization_id` or `organization_name` property and the `repository_name` or `repository_property` property. For branch and tag rulesets, the conditions object should also contain the `ref_name` property.
    ...
    public Schema\EnterpriseRulesetConditionsOrganizationNameTarget|Schema\EnterpriseRulesetConditionsOrganizationIdTarget|null $conditions, public array|null $rules,)
    {
    }
}
