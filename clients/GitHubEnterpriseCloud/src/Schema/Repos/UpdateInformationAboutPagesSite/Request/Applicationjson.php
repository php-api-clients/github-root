...
final readonly class Applicationjson
{
     ...
     */
    public ?bool $public;
    public function __construct(string $cname, bool $https_enforced, string $build_type, Schema\Repos\UpdateInformationAboutPagesSite\Request\Applicationjson\Source $source, bool $public)
    {
        $this->cname = $cname;
