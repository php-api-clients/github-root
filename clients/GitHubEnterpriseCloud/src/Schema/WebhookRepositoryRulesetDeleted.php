...
final readonly class WebhookRepositoryRulesetDeleted
{
    ...
    public const SCHEMA_TITLE        = 'repository ruleset deleted event';
     ...
     */
    public function __construct(public string $action, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks|null $repository, #[MapFrom('repository_ruleset')]
