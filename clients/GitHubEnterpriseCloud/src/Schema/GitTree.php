...
final readonly class GitTree
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"sha":"generated_sha","url":"generated_url","truncated":false,"tree":[{"path":"file.rb","mode":"100644","type":"blob","size":30,"sha":"44b4fc6d56897b048c772eb4087f854f46256132","url":"https:\\/\\/api.github.com\\/repos\\/octocat\\/Hello-World\\/git\\/blobs\\/44b4fc6d56897b048c772eb4087f854f46256132","properties":{"path":{"type":"string"},"mode":{"type":"string"},"type":{"type":"string"},"size":{"type":"integer"},"sha":{"type":"string"},"url":{"type":"string"}},"required":["path","mode","type","sha","url","size"]}]}';
    public ?string $sha;
    public ?string $url;
    public ?bool $truncated;
    /**
     * Objects specifying a tree structure
     * @var array<Schema\GitTree\Tree>
     */
    public ?array $tree;
