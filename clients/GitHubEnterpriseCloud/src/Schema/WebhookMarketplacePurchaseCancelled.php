...
final readonly class WebhookMarketplacePurchaseCancelled
{
    ...
    public Schema\WebhookMarketplacePurchaseCancelled\MarketplacePurchase $marketplacePurchase, public Schema\OrganizationSimple|null $organization, #[MapFrom('previous_marketplace_purchase')]
    public Schema\WebhookMarketplacePurchaseCancelled\PreviousMarketplacePurchase|null $previousMarketplacePurchase, public Schema\Repository|null $repository, public Schema\SimpleUser $sender,)
    {
    }
}
