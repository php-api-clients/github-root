...
final readonly class WebhookProjectsV2ItemRestored
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookProjectsV2ItemRestored\Changes $changes, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimple $organization, #[MapFrom('projects_v2_item')]
