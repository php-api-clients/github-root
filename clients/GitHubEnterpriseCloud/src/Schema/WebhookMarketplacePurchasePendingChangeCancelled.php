...
final readonly class WebhookMarketplacePurchasePendingChangeCancelled
{
    ...
    public Schema\WebhookMarketplacePurchasePendingChangeCancelled\MarketplacePurchase $marketplacePurchase, public Schema\OrganizationSimple|null $organization, #[MapFrom('previous_marketplace_purchase')]
    public Schema\WebhookMarketplacePurchasePendingChangeCancelled\PreviousMarketplacePurchase|null $previousMarketplacePurchase, public Schema\Repository|null $repository, public Schema\SimpleUser $sender,)
    {
    }
}
