...
final readonly class RepositoryRuleCommitterEmailPattern
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"type":"committer_email_pattern","parameters":{"name":"generated_name_null","negate":false,"operator":"starts_with","pattern":"generated_pattern_null"}}';

    public function __construct(public string $type, public ?Schema\RepositoryRuleCommitterEmailPattern\Parameters $parameters)
    {
    }
}
