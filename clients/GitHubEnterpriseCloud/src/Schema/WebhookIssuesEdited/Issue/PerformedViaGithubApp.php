...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookIssuesEdited\Issue;
...
final readonly class PerformedViaGithubApp
{
     ...
     */
    public Schema\WebhookIssuesAssigned\Issue\PerformedViaGithubApp\Permissions $permissions;
    /**
     * The slug name of the GitHub app
     */
    public string $slug;
    public ?string $updated_at;
    public function __construct(string $created_at, string $description, array $events, string $external_url, string $html_url, int $id, string $name, string $node_id, Schema\Discussion\AnswerChosenBy $owner, Schema\WebhookIssuesAssigned\Issue\PerformedViaGithubApp\Permissions $permissions, string $slug, string $updated_at)
    {
