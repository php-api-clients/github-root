...
final readonly class Dependency
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"package_url":"pkg:\\/npm\\/%40actions\\/http-client@1.0.11","metadata":"generated","relationship":"direct","scope":"runtime","dependencies":["@actions\\/http-client","@actions\\/http-client"]}';
     ...
     */
    public function __construct(#[MapFrom('package_url')] public ?string $packageUrl, public string $metadata, public ?string $relationship, public ?string $scope, public ?array $dependencies)
    {
    }
}
