...
final readonly class RepositoryRuleBranchNamePattern
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"type":"branch_name_pattern","parameters":{"name":"generated_name_null","negate":false,"operator":"starts_with","pattern":"generated_pattern_null"}}';

    public function __construct(public string $type, public ?Schema\RepositoryRuleBranchNamePattern\Parameters $parameters)
    {
    }
}
