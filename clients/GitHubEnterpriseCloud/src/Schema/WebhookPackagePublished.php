...
final readonly class WebhookPackagePublished
{
     ...
     */
    public function __construct(public string $action, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\WebhookPackagePublished\Package $package, public Schema\RepositoryWebhooks|null $repository, public Schema\SimpleUser $sender)
    {
    }
}
