...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookCheckSuiteRequested\CheckSuite;
...
final readonly class App
{
     ...
     */
    public Schema\WebhookCheckSuiteCompleted\CheckSuite\App\Permissions $permissions;
    /**
     * The slug name of the GitHub app
     */
    public string $slug;
    public ?string $updated_at;
    public function __construct(string $created_at, string $description, array $events, string $external_url, string $html_url, int $id, string $name, string $node_id, Schema\Discussion\AnswerChosenBy $owner, Schema\WebhookCheckSuiteCompleted\CheckSuite\App\Permissions $permissions, string $slug, string $updated_at)
    {
