...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookCodeScanningAlertAppearedInBranch;
...
final readonly class Alert
{
    ...
    public ?string $url;
    public function __construct(string $created_at, string $dismissed_at, Schema\Discussion\AnswerChosenBy $dismissed_by, string $dismissed_reason, string $html_url, Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\MostRecentInstance $most_recent_instance, int $number, Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\Rule $rule, string $state, Schema\WebhookCodeScanningAlertAppearedInBranch\Alert\Tool $tool, string $url)
    {
