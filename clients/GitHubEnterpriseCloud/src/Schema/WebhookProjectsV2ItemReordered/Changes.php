...
final readonly class Changes
{
    ...
    public function __construct(#[MapFrom('previous_projects_v2_item_node_id')] public ?Schema\WebhookProjectsV2ItemReordered\Changes\PreviousProjectsV2ItemNodeId $previousProjectsV2ItemNodeId)
    {
    }
}
