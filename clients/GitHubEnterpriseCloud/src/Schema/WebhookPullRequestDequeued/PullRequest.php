...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPullRequestDequeued;
...
final readonly class PullRequest
{
    ...
    public Schema\WebhookPullRequestDequeued\PullRequest\Links $links, #[MapFrom('active_lock_reason')]
    public string|null $activeLockReason, public int|null $additions, public Schema\WebhookPullRequestDequeued\PullRequest\Assignee|null $assignee, public array $assignees, #[MapFrom('author_association')]
    public string $authorAssociation, #[MapFrom('auto_merge')]
    public Schema\WebhookPullRequestDequeued\PullRequest\AutoMerge|null $autoMerge, public Schema\WebhookPullRequestDequeued\PullRequest\Base $base, public string|null $body, #[MapFrom('changed_files')]
    ...
    public string $diffUrl, public bool $draft, public Schema\WebhookPullRequestDequeued\PullRequest\Head $head, #[MapFrom('html_url')]
    ...
    public Schema\WebhookPullRequestDequeued\PullRequest\MergedBy|null $mergedBy, public Schema\WebhookPullRequestDequeued\PullRequest\Milestone|null $milestone, #[MapFrom('node_id')]
    ...
    public string $updatedAt, public string $url, public Schema\WebhookPullRequestDequeued\PullRequest\User|null $user,)
    {
    }
}
