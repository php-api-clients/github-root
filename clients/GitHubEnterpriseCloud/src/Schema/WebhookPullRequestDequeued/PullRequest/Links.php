...
final readonly class Links
{
    ...
    public function __construct(public Schema\WebhookPullRequestDequeued\PullRequest\Links\Comments $comments, public Schema\WebhookPullRequestDequeued\PullRequest\Links\Commits $commits, public Schema\WebhookPullRequestDequeued\PullRequest\Links\Html $html, public Schema\WebhookPullRequestDequeued\PullRequest\Links\Issue $issue, #[\EventSauce\ObjectHydrator\MapFrom('review_comment')] public Schema\WebhookPullRequestDequeued\PullRequest\Links\ReviewComment $reviewComment, #[\EventSauce\ObjectHydrator\MapFrom('review_comments')] public Schema\WebhookPullRequestDequeued\PullRequest\Links\ReviewComments $reviewComments, public Schema\WebhookPullRequestDequeued\PullRequest\Links\Self_ $self, public Schema\WebhookPullRequestDequeued\PullRequest\Links\Statuses $statuses)
    {
    }
}
