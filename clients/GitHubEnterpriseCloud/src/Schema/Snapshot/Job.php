...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\Snapshot;
...
final readonly class Job
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"id":"5622a2b0-63f6-4732-8c34-a1ab27e102a11","correlator":"yourworkflowname_yourjobname","htmlUrl":"http:\\/\\/example.com\\/build"}';
    /**
     ...
     */
    public function __construct(public string $id, public string $correlator, #[\EventSauce\ObjectHydrator\MapFrom('html_url')] public ?string $htmlUrl)
    {
    }
}
