...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPullRequestEnqueued;
...
final readonly class PullRequest
{
    ...
    public Schema\WebhookPullRequestEnqueued\PullRequest\Links $links, #[MapFrom('active_lock_reason')]
    public string|null $activeLockReason, public int|null $additions, public Schema\WebhookPullRequestEnqueued\PullRequest\Assignee|null $assignee, public array $assignees, #[MapFrom('author_association')]
    public string $authorAssociation, #[MapFrom('auto_merge')]
    public Schema\WebhookPullRequestEnqueued\PullRequest\AutoMerge|null $autoMerge, public Schema\WebhookPullRequestEnqueued\PullRequest\Base $base, public string|null $body, #[MapFrom('changed_files')]
    ...
    public string $diffUrl, public bool $draft, public Schema\WebhookPullRequestEnqueued\PullRequest\Head $head, #[MapFrom('html_url')]
    ...
    public Schema\WebhookPullRequestEnqueued\PullRequest\MergedBy|null $mergedBy, public Schema\WebhookPullRequestEnqueued\PullRequest\Milestone|null $milestone, #[MapFrom('node_id')]
    ...
    public string $updatedAt, public string $url, public Schema\WebhookPullRequestEnqueued\PullRequest\User|null $user,)
    {
    }
}
