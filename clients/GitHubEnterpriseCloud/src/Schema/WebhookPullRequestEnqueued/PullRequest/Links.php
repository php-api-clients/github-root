...
final readonly class Links
{
    ...
    public function __construct(public Schema\WebhookPullRequestEnqueued\PullRequest\Links\Comments $comments, public Schema\WebhookPullRequestEnqueued\PullRequest\Links\Commits $commits, public Schema\WebhookPullRequestEnqueued\PullRequest\Links\Html $html, public Schema\WebhookPullRequestEnqueued\PullRequest\Links\Issue $issue, #[\EventSauce\ObjectHydrator\MapFrom('review_comment')] public Schema\WebhookPullRequestEnqueued\PullRequest\Links\ReviewComment $reviewComment, #[\EventSauce\ObjectHydrator\MapFrom('review_comments')] public Schema\WebhookPullRequestEnqueued\PullRequest\Links\ReviewComments $reviewComments, public Schema\WebhookPullRequestEnqueued\PullRequest\Links\Self_ $self, public Schema\WebhookPullRequestEnqueued\PullRequest\Links\Statuses $statuses)
    {
    }
}
