...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\PagesHealthCheck;
...
final readonly class AltDomain
{
    ...
    public ?bool $dns_resolves;
    public ?bool $is_proxied;
    public ?bool $is_cloudflare_ip;
    public ?bool $is_fastly_ip;
    public ?bool $is_old_ip_address;
    public ?bool $is_a_record;
    public ?bool $has_cname_record;
    public ?bool $has_mx_records_present;
    public ?bool $is_valid_domain;
    public ?bool $is_apex_domain;
    public ?bool $should_be_a_record;
    public ?bool $is_cname_to_github_user_domain;
    public ?bool $is_cname_to_pages_dot_github_dot_com;
    public ?bool $is_cname_to_fastly;
    public ?bool $is_pointed_to_github_pages_ip;
    public ?bool $is_non_github_pages_ip_present;
    public ?bool $is_pages_domain;
    public ?bool $is_served_by_pages;
    public ?bool $is_valid;
    public ?string $reason;
    public ?bool $responds_to_https;
    public ?bool $enforces_https;
    public ?string $https_error;
    public ?bool $is_https_eligible;
