...
final readonly class WebhookSecretScanningScanCompleted
{
    ...
    public const SCHEMA_TITLE        = 'secret_scanning_scan completed event';
    ...
    "secret_types": null,
    "custom_pattern_name": "generated",
    "custom_pattern_scope": "enterprise",
    "repository": {
        "id": 42,
    ...
    /**
     * type: What type of scan was completed
     * source: What type of content was scanned
     * startedAt: The time that the alert was resolved in ISO 8601 format: `YYYY-MM-DDTHH:MM:SSZ`.
     * completedAt: The time that the alert was resolved in ISO 8601 format: `YYYY-MM-DDTHH:MM:SSZ`.
     * secretTypes: List of patterns that were updated. This will be empty for normal backfill scans or custom pattern updates
     * customPatternName: If the scan was triggered by a custom pattern update, this will be the name of the pattern that was updated
     * customPatternScope: If the scan was triggered by a custom pattern update, this will be the scope of the pattern that was updated
     ...
     */
    public function __construct(public string $action, public string $type, public string $source, #[MapFrom('started_at')]
    public string $startedAt, #[MapFrom('completed_at')]
    public string $completedAt, #[MapFrom('secret_types')]
    public array|null $secretTypes, #[MapFrom('custom_pattern_name')]
    public string|null $customPatternName, #[MapFrom('custom_pattern_scope')]
    public string|null $customPatternScope, public Schema\RepositoryWebhooks|null $repository, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\SimpleUser|null $sender,)
    {
    }
}
