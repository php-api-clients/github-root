...
final readonly class WebhookMarketplacePurchasePendingChange
{
    ...
    public Schema\WebhookMarketplacePurchasePendingChange\PreviousMarketplacePurchase|null $previousMarketplacePurchase, public Schema\RepositoryWebhooks|null $repository, public Schema\SimpleUser $sender,)
    {
    }
}
