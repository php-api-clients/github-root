...
final readonly class Changes
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"body":{"from":"generated_from"},"name":{"from":"generated_from"},"make_latest":{"to":false}}';
    public function __construct(public ?Schema\WebhookProjectEdited\Changes\Body $body, public ?Schema\WebhookLabelEdited\Changes\Name $name, public ?Schema\WebhookReleaseEdited\Changes\MakeLatest $make_latest)
    {
    }
}
