...
final readonly class DependencyGraphDiff
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"changeType":"added","manifest":"path\\/to\\/package-lock.json","ecosystem":"npm","name":"@actions\\/core","version":"1.0.0","packageUrl":"pkg:\\/npm\\/%40actions\\/core@1.1.0","license":"MIT","sourceRepositoryUrl":"https:\\/\\/github.com\\/github\\/actions","vulnerabilities":[{"severity":"critical","advisoryGhsaId":"GHSA-rf4j-j272-fj86","advisorySummary":"A summary of the advisory.","advisoryUrl":"https:\\/\\/github.com\\/advisories\\/GHSA-rf4j-j272-fj86"}],"scope":"unknown"}';
    /**
