...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\Organization;

use EventSauce\ObjectHydrator\MapFrom;

final readonly class Plan
{
    public const SCHEMA_JSON         = '{"type":"object","properties":{"name":{"type":"string"},"space":{"type":"integer"},"private_repos":{"type":"integer"},"filled_seats":{"type":"integer"},"seats":{"type":"integer"}}}';
