...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\DependencyGraphSpdxSbom\Sbom\Packages\ExternalRefs;
...
final readonly class Packages
{
     ...
     *
     * @param ?array<ExternalRefs> $externalRefs
     */
    public function __construct(#[MapFrom('SPDXID')] public ?string $spdxid, public ?string $name, public ?string $versionInfo, public ?string $downloadLocation, public ?bool $filesAnalyzed, public ?string $licenseConcluded, public ?string $licenseDeclared, public ?string $supplier, #[CastListToType(Schema\DependencyGraphSpdxSbom\Sbom\Packages\ExternalRefs::class)] public ?array $externalRefs)
    {
    }
}
