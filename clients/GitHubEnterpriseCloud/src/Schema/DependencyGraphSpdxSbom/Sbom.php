...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\DependencyGraphSpdxSbom\Sbom\Packages;
...
final readonly class Sbom
{
     ...
     */
    public function __construct(#[MapFrom('SPDXID')] public string $spdxid, public string $spdxVersion, public Schema\DependencyGraphSpdxSbom\Sbom\CreationInfo $creationInfo, public string $name, public string $dataLicense, public array $documentDescribes, public string $documentNamespace, #[CastListToType(Schema\DependencyGraphSpdxSbom\Sbom\Packages::class)] public array $packages)
    {
    }
}
