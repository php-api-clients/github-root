...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\DependencyGraphSpdxSbom;
...
final readonly class Sbom
{
     ...
     * @param array<string> $documentDescribes
     * documentNamespace: The namespace for the SPDX document.
     * @param array<\ApiClients\Client\GitHubEnterpriseCloud\Schema\DependencyGraphSpdxSbom\Sbom\Packages> $packages
     */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('SPDXID')] public string $spdxid, public string $spdxVersion, public Schema\DependencyGraphSpdxSbom\Sbom\CreationInfo $creationInfo, public string $name, public string $dataLicense, public array $documentDescribes, public string $documentNamespace, #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\DependencyGraphSpdxSbom\Sbom\Packages::class)] public array $packages)
    {
    }
}
