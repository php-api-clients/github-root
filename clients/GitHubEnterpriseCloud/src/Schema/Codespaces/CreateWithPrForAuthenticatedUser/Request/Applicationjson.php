...
final readonly class Applicationjson
{
     ...
     */
    public function __construct(public ?string $location, #[MapFrom('client_ip')] public ?string $clientIp, public ?string $machine, #[MapFrom('devcontainer_path')] public ?string $devcontainerPath, #[MapFrom('multi_repo_permissions_opt_out')] public ?bool $multiRepoPermissionsOptOut, #[MapFrom('working_directory')] public ?string $workingDirectory, #[MapFrom('idle_timeout_minutes')] public ?int $idleTimeoutMinutes, #[MapFrom('display_name')] public ?string $displayName, #[MapFrom('retention_period_minutes')] public ?int $retentionPeriodMinutes)
    {
    }
}
