...
final readonly class WebhookPullRequestReviewThreadUnresolved
{
    ...
    public Schema\WebhookPullRequestReviewThreadUnresolved\PullRequest $pullRequest, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUser|null $sender, public Schema\WebhookPullRequestReviewThreadUnresolved\Thread $thread,)
    {
    }
}
