...
final readonly class WebhookOrgBlockUnblocked
{
    ...
    public Schema\WebhookOrgBlockUnblocked\BlockedUser|null $blockedUser, public Schema\Enterprise|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks $organization, public Schema\RepositoryWebhooks|null $repository, public Schema\SimpleUserWebhooks $sender,)
    {
    }
}
