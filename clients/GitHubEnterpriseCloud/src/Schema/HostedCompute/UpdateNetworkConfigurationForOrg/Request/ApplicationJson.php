...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\HostedCompute\UpdateNetworkConfigurationForOrg\Request;
...
final readonly class ApplicationJson
{
     ...
     */
    public function __construct(public string|null $name, #[MapFrom('compute_service')]
    public string|null $computeService, #[MapFrom('network_settings_ids')]
    public array|null $networkSettingsIds,)
    {
    }
}
