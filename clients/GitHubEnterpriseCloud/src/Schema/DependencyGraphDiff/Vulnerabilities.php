...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\DependencyGraphDiff;
...
final readonly class Vulnerabilities
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"severity":"critical","advisoryGhsaId":"GHSA-rf4j-j272-fj86","advisorySummary":"A summary of the advisory.","advisoryUrl":"https:\\/\\/github.com\\/advisories\\/GHSA-rf4j-j272-fj86"}';
