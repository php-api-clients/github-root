...
final readonly class MinimalRepository
{
    ...
    public function __construct(int $id, string $node_id, string $name, string $full_name, Schema\SimpleUser $owner, bool $private, string $html_url, string $description, bool $fork, string $url, string $archive_url, string $assignees_url, string $blobs_url, string $branches_url, string $collaborators_url, string $comments_url, string $commits_url, string $compare_url, string $contents_url, string $contributors_url, string $deployments_url, string $downloads_url, string $events_url, string $forks_url, string $git_commits_url, string $git_refs_url, string $git_tags_url, string $git_url, string $issue_comment_url, string $issue_events_url, string $issues_url, string $keys_url, string $labels_url, string $languages_url, string $merges_url, string $milestones_url, string $notifications_url, string $pulls_url, string $releases_url, string $ssh_url, string $stargazers_url, string $statuses_url, string $subscribers_url, string $subscription_url, string $tags_url, string $teams_url, string $trees_url, string $clone_url, string $mirror_url, string $hooks_url, string $svn_url, string $homepage, string $language, int $forks_count, int $stargazers_count, int $watchers_count, int $size, string $default_branch, int $open_issues_count, bool $is_template, array $topics, bool $has_issues, bool $has_projects, bool $has_wiki, bool $has_pages, bool $has_downloads, bool $has_discussions, bool $archived, bool $disabled, string $visibility, string $pushed_at, string $created_at, string $updated_at, Schema\Repository\TemplateRepository\Permissions $permissions, string $role_name, string $temp_clone_token, bool $delete_branch_on_merge, int $subscribers_count, int $network_count, Schema\CodeOfConduct $code_of_conduct, Schema\MinimalRepository\License $license, int $forks, int $open_issues, int $watchers, bool $allow_forking, bool $web_commit_signoff_required, Schema\SecurityAndAnalysis $security_and_analysis)
    {
        $this->id = $id;
