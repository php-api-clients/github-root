...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookMarketplacePurchaseCancelled;
...
final readonly class PreviousMarketplacePurchase
{
    ...
    public function __construct(public ?Schema\WebhookMarketplacePurchaseCancelled\PreviousMarketplacePurchase\Account $account, public ?string $billing_cycle, public mixed $free_trial_ends_on, public ?string $next_billing_date, public ?bool $on_free_trial, public ?Schema\WebhookMarketplacePurchaseCancelled\PreviousMarketplacePurchase\Plan $plan, public ?int $unit_count)
    {
    }
}
