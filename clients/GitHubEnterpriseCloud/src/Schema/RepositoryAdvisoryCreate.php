...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\RepositoryAdvisoryCreate\Credits;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\RepositoryAdvisoryCreate\Vulnerabilities;
...
final readonly class RepositoryAdvisoryCreate
{
     ...
     */
    public function __construct(public string $summary, public string $description, #[MapFrom('cve_id')] public ?string $cveId, #[CastListToType(Schema\RepositoryAdvisoryCreate\Vulnerabilities::class)] public array $vulnerabilities, #[MapFrom('cwe_ids')] public ?array $cweIds, #[CastListToType(Schema\RepositoryAdvisoryCreate\Credits::class)] public ?array $credits, public ?string $severity, #[MapFrom('cvss_vector_string')] public ?string $cvssVectorString)
    {
    }
}
