...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\ActionsCacheList\ActionsCaches;
...
final readonly class ActionsCacheList
{
     ...
     *
     * @param array<ActionsCaches> $actionsCaches
     */
    public function __construct(#[MapFrom('total_count')] public int $totalCount, #[MapFrom('actions_caches')] #[CastListToType(Schema\ActionsCacheList\ActionsCaches::class)] public array $actionsCaches)
    {
    }
}
