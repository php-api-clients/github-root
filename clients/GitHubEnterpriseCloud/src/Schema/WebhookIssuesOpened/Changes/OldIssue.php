...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookIssuesOpened\Changes;
...
final readonly class OldIssue
{
    ...
    public const SCHEMA_DESCRIPTION  = 'The [issue](https://docs.github.com/enterprise-cloud@latest//rest/issues/issues#get-an-issue) itself.';
    ...
    public Schema\WebhookIssuesOpened\Changes\OldIssue\SubIssuesSummary|null $subIssuesSummary, public string|null $state, #[MapFrom('state_reason')]
