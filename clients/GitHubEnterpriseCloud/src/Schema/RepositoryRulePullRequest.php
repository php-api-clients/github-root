...
final readonly class RepositoryRulePullRequest
{
    ...
    public const SCHEMA_DESCRIPTION  = 'Parameters to be used for the pull_request rule';
    public const SCHEMA_EXAMPLE_DATA = '{"type":"pull_request","parameters":{"dismiss_stale_reviews_on_push":false,"require_code_owner_review":false,"require_last_push_approval":false,"required_approving_review_count":13,"required_review_thread_resolution":false}}';

    public function __construct(public string $type, public ?Schema\RepositoryRulePullRequest\Parameters $parameters)
    {
    }
}
