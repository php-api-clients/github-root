...
final readonly class WebhookMilestoneEdited
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookMilestoneEdited\Changes $changes, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\WebhooksMilestone $milestone, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUserWebhooks $sender)
    {
    }
}
