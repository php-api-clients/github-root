...
final readonly class AdvancedSecurityActiveCommittersRepository
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"name":"octocat\\/Hello-World","advancedSecurityCommitters":25,"advancedSecurityCommittersBreakdown":[{"userLogin":"generated_user_login_null","lastPushedDate":"2021-11-03"}]}';
    /**
     * @param array<\ApiClients\Client\GitHubEnterpriseCloud\Schema\AdvancedSecurityActiveCommittersUser> $advancedSecurityCommittersBreakdown
     */
