...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\GroupMapping\Groups;
...
final readonly class GroupMapping
{
     ...
     */
    public function __construct(#[CastListToType(Schema\GroupMapping\Groups::class)] public ?array $groups)
    {
    }
}
