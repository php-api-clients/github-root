...
final readonly class GroupMapping
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"groups":[{"group_id":"111a1a11-aaa1-1aaa-11a1-a1a1a1a1a1aa","group_name":"saml-azuread-test","group_description":"A group of Developers working on AzureAD SAML SSO"}]}';
    /**
