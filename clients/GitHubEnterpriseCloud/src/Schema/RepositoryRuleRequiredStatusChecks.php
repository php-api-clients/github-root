...
final readonly class RepositoryRuleRequiredStatusChecks
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"type":"required_status_checks","parameters":{"required_status_checks":[{"context":"generated_context_null","integration_id":13}],"strict_required_status_checks_policy":false}}';
