...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookReleasePrereleased;
...
final readonly class Release
{
    ...
    /**
     * @param array<\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookCheckSuiteCompleted\ActionsMeta> $assets
