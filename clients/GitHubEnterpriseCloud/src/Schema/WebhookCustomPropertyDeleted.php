...
final readonly class WebhookCustomPropertyDeleted
{
    ...
    public const SCHEMA_TITLE        = 'custom property deleted event';
     ...
     */
    public function __construct(public string $action, public Schema\WebhookCustomPropertyDeleted\Definition $definition, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\SimpleUser|null $sender)
    {
    }
}
