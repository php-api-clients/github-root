...
final readonly class WebhookMergeGroupChecksRequested
{
     ...
     */
    public function __construct(public string $action, public Schema\SimpleInstallation|null $installation, #[MapFrom('merge_group')]
