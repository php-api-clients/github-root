...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\RepositoryRuleRequiredDeployments;
...
final readonly class Parameters
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"required_deployment_environments":["generated_required_deployment_environments_null"]}';

    /**
     * requiredDeploymentEnvironments: The environments that must be successfully deployed to before branches can be merged.
     *
     * @param array<string> $requiredDeploymentEnvironments
     */
