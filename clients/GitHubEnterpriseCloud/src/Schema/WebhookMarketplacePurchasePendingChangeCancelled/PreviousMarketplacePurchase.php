...
final readonly class PreviousMarketplacePurchase
{
    ...
    public function __construct(public Schema\WebhookMarketplacePurchasePendingChangeCancelled\PreviousMarketplacePurchase\Account $account, #[\EventSauce\ObjectHydrator\MapFrom('billing_cycle')] public string $billingCycle, #[\EventSauce\ObjectHydrator\MapFrom('free_trial_ends_on')] public mixed $freeTrialEndsOn, #[\EventSauce\ObjectHydrator\MapFrom('next_billing_date')] public ?string $nextBillingDate, #[\EventSauce\ObjectHydrator\MapFrom('on_free_trial')] public bool $onFreeTrial, public Schema\WebhookMarketplacePurchasePendingChangeCancelled\PreviousMarketplacePurchase\Plan $plan, #[\EventSauce\ObjectHydrator\MapFrom('unit_count')] public int $unitCount)
    {
    }
}
