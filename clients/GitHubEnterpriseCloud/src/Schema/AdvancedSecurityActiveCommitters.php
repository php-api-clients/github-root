...
final readonly class AdvancedSecurityActiveCommitters
{
    ...
    /**
     * @param array<AdvancedSecurityActiveCommittersRepository> $repositories
     */
    public function __construct(#[MapFrom('total_advanced_security_committers')] public ?int $totalAdvancedSecurityCommitters, #[MapFrom('total_count')] public ?int $totalCount, #[CastListToType(Schema\AdvancedSecurityActiveCommittersRepository::class)] public array $repositories)
    {
    }
}
