...
final readonly class Job
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"id":21,"run_id":5,"run_url":"https:\\/\\/api.github.com\\/repos\\/github\\/hello-world\\/actions\\/runs\\/5","run_attempt":1,"node_id":"MDg6Q2hlY2tSdW40","head_sha":"009b8a3a9ccbb128af87f9b1c0f4c62e8a304f6d","url":"https:\\/\\/api.github.com\\/repos\\/github\\/hello-world\\/actions\\/jobs\\/21","html_url":"https:\\/\\/github.com\\/github\\/hello-world\\/runs\\/4","status":"queued","conclusion":"success","created_at":"2019-08-08T08:00:00-07:00","started_at":"2019-08-08T08:00:00-07:00","completed_at":"2019-08-08T08:00:00-07:00","name":"test-coverage","steps":[{"status":"queued","conclusion":"success","name":"test-coverage","number":1,"started_at":"2019-08-08T08:00:00-07:00","completed_at":"2019-08-08T08:00:00-07:00"}],"check_run_url":"https:\\/\\/api.github.com\\/repos\\/github\\/hello-world\\/check-runs\\/4","labels":["self-hosted"],"runner_id":1,"runner_name":"my runner","runner_group_id":2,"runner_group_name":"my runner group","workflow_name":"Build","head_branch":"main"}';
    /**
     * The id of the job.
     */
    public ?int $id;
    ...
    public function __construct(int $id, int $run_id, string $run_url, int $run_attempt, string $node_id, string $head_sha, string $url, string $html_url, string $status, string $conclusion, string $created_at, string $started_at, string $completed_at, string $name, array $steps, string $check_run_url, array $labels, int $runner_id, string $runner_name, int $runner_group_id, string $runner_group_name, string $workflow_name, string $head_branch)
    {
        $this->id = $id;
        $this->run_id = $run_id;
