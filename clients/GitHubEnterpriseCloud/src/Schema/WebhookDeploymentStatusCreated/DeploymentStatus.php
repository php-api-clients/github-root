...
final readonly class DeploymentStatus
{
    ...
    public const SCHEMA_DESCRIPTION  = 'The [deployment status](https://docs.github.com/enterprise-cloud@latest//rest/deployments/statuses#list-deployment-statuses).';
