...
final readonly class Changes
{
    ...
    public ?Schema\WebhookRepositoryRenamed\Changes\Repository $repository;
    public function __construct(Schema\WebhookRepositoryRenamed\Changes\Repository $repository)
    {
