...
final readonly class WebhookSubIssuesParentIssueRemoved
{
    ...
    public Schema\Issue $parentIssue, #[MapFrom('parent_issue_repo')]
    public Schema\Repository $parentIssueRepo, #[MapFrom('sub_issue_id')]
    public int|float $subIssueId, #[MapFrom('sub_issue')]
    public Schema\Issue $subIssue, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks|null $repository, public Schema\SimpleUserWebhooks|null $sender,)
    {
    }
}
