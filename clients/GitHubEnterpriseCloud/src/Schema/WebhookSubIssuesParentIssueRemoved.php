...
final readonly class WebhookSubIssuesParentIssueRemoved
{
    ...
    public Schema\Issue $subIssue, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks|null $repository, public Schema\SimpleUser|null $sender,)
    {
    }
}
