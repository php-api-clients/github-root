...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\MarketplacePurchase;
...
final readonly class MarketplacePurchase
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"billing_cycle":"generated","next_billing_date":"generated","is_installed":false,"unit_count":10,"on_free_trial":false,"free_trial_ends_on":"generated","updated_at":"generated","plan":{"url":"https:\\/\\/api.github.com\\/marketplace_listing\\/plans\\/1313","accounts_url":"https:\\/\\/api.github.com\\/marketplace_listing\\/plans\\/1313\\/accounts","id":1313,"number":3,"name":"Pro","description":"A professional-grade CI solution","monthly_price_in_cents":1099,"yearly_price_in_cents":11870,"price_model":"FLAT_RATE","has_free_trial":true,"unit_name":"generated","state":"published","bullets":["Up to 25 private repositories","Up to 25 private repositories"]}}';

    /**
     * plan: Marketplace Listing Plan
     */
    public function __construct(#[MapFrom('billing_cycle')] public ?string $billingCycle, #[MapFrom('next_billing_date')] public ?string $nextBillingDate, #[MapFrom('is_installed')] public ?bool $isInstalled, #[MapFrom('unit_count')] public ?int $unitCount, #[MapFrom('on_free_trial')] public ?bool $onFreeTrial, #[MapFrom('free_trial_ends_on')] public ?string $freeTrialEndsOn, #[MapFrom('updated_at')] public ?string $updatedAt, public ?Schema\MarketplaceListingPlan $plan)
    {
    }
}
