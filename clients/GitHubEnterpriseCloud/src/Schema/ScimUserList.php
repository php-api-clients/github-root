...
final readonly class ScimUserList
{
    ...
    /**
     * @var array<Schema\ScimUser>
     */
    public ?array $Resources;
    public function __construct(array $schemas, int $totalResults, int $itemsPerPage, int $startIndex, array $Resources)
    {
