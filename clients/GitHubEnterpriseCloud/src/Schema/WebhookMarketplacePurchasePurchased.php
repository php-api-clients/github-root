...
final readonly class WebhookMarketplacePurchasePurchased
{
    ...
    public Schema\WebhookMarketplacePurchasePurchased\MarketplacePurchase $marketplacePurchase, public Schema\OrganizationSimpleWebhooks|null $organization, #[MapFrom('previous_marketplace_purchase')]
    public Schema\WebhookMarketplacePurchasePurchased\PreviousMarketplacePurchase|null $previousMarketplacePurchase, public Schema\RepositoryWebhooks|null $repository, public Schema\SimpleUserWebhooks $sender,)
    {
    }
}
