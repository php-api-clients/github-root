...
final readonly class WebhookMarketplacePurchasePurchased
{
    ...
    public Schema\WebhooksPreviousMarketplacePurchase|null $previousMarketplacePurchase, public Schema\RepositoryWebhooks|null $repository, public Schema\SimpleUser $sender,)
    {
    }
}
