...
final readonly class OrganizationCustomRepositoryRoleUpdateSchema
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"name":"generated_name_null","description":"generated_description_null","base_role":"generated_base_role_null","permissions":["generated_permissions_null"]}';
    /**
