...
final readonly class OrganizationCustomRepositoryRoleUpdateSchema
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"name":"generated","description":"generated","base_role":"read","permissions":["generated","generated"]}';
     ...
     */
    public function __construct(public string|null $name, public string|null $description, #[MapFrom('base_role')]
    public string|null $baseRole, public array|null $permissions,)
    {
    }
}
