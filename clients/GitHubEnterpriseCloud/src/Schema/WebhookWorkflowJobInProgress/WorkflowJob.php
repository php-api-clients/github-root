...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobInProgress;
...
final readonly class WorkflowJob
{
     ...
     * labels: Custom labels for the job. Specified by the [`"runs-on"` attribute](https://docs.github.com/enterprise-cloud@latest//actions/reference/workflow-syntax-for-github-actions#jobsjob_idruns-on) in the workflow YAML.
     ...
     * @param ?array<\ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookWorkflowJobInProgress\WorkflowJob\Steps> $steps
     */
