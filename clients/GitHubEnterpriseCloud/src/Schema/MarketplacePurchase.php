...
final readonly class MarketplacePurchase
{
    ...
    public ?string $email;
    public ?Schema\MarketplacePurchase\MarketplacePendingChange $marketplace_pending_change;
    public ?Schema\MarketplacePurchase\MarketplacePurchase $marketplace_purchase;
    public function __construct(string $url, string $type, int $id, string $login, string $organization_billing_email, string $email, Schema\MarketplacePurchase\MarketplacePendingChange $marketplace_pending_change, Schema\MarketplacePurchase\MarketplacePurchase $marketplace_purchase)
    {
        $this->url = $url;
        $this->type = $type;
        $this->id = $id;
