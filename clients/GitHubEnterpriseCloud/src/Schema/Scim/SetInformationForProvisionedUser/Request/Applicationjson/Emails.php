...
final readonly class Emails
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"type":"generated_type","value":"generated_value","primary":false}';
    public string $type;
    public ?string $value;
    public bool $primary;
    public function __construct(string $type, string $value, bool $primary)
    {
        $this->type = $type;
        $this->value = $value;
