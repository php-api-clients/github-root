...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Scim\SetInformationForProvisionedUser\Request\Applicationjson\Emails;
...
final readonly class Applicationjson
{
     ...
     */
    public function __construct(public ?array $schemas, public ?string $displayName, public ?string $externalId, public ?array $groups, public ?bool $active, public string $userName, public Schema\Scim\SetInformationForProvisionedUser\Request\Applicationjson\Name $name, #[CastListToType(Schema\Scim\SetInformationForProvisionedUser\Request\Applicationjson\Emails::class)] public array $emails)
    {
    }
}
