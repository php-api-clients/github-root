...
final readonly class Applicationjson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"schemas":[null],"displayName":"Jon Doe","externalId":"generated_externalId","groups":[null],"active":false,"userName":"someone@example.com","name":{"givenName":"Jane","familyName":"User","formatted":"generated_formatted"},"emails":[{"value":"someone@example.com","primary":true}]}';
    /**
     * @var array<string>
     */
