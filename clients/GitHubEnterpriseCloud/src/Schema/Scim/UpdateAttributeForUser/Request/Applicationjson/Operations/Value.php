...
final readonly class Value
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"active":false,"userName":"generated_userName","externalId":"generated_externalId","givenName":"generated_givenName","familyName":"generated_familyName"}';
