...
final readonly class ApplicationJson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"userName":"someone@example.com","displayName":"Jon Doe","name":{"givenName":"Jane","familyName":"User","formatted":"generated"},"emails":[{"value":"another@example.com","primary":false,"type":"generated"}],"schemas":["generated","generated"],"externalId":"generated","groups":["generated","generated"],"active":false}';
     ...
     * emails: user emails
     */
    public function __construct(public string $userName, public ?string $displayName, public Schema\Scim\ProvisionAndInviteUser\Request\ApplicationJson\Name $name, public array $emails, public ?array $schemas, public ?string $externalId, public ?array $groups, public ?bool $active)
    {
    }
}
