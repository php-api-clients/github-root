...
final readonly class Applicationjson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"userName":"someone@example.com","displayName":"Jon Doe","name":{"givenName":"Jane","familyName":"User","formatted":"generated_formatted"},"emails":[{"value":"someone@example.com","primary":true,"type":"generated_type"}],"schemas":["generated_schemas"],"externalId":"generated_externalId","groups":["generated_groups"],"active":false}';
    /**
