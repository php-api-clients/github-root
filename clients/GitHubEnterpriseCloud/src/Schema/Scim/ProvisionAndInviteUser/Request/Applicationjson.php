...
final readonly class Applicationjson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"userName":"someone@example.com","displayName":"Jon Doe","name":{"givenName":"Jane","familyName":"User","formatted":"generated_formatted"},"emails":[{"value":"another@example.com","primary":false}],"schemas":[null],"externalId":"generated_externalId","groups":[null],"active":false}';
    /**
