...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Scim\ProvisionAndInviteUser\Request\Applicationjson\Emails;
...
final readonly class Applicationjson
{
     ...
     */
    public function __construct(public string $userName, public ?string $displayName, public Schema\Scim\ProvisionAndInviteUser\Request\Applicationjson\Name $name, #[CastListToType(Schema\Scim\ProvisionAndInviteUser\Request\Applicationjson\Emails::class)] public array $emails, public ?array $schemas, public ?string $externalId, public ?array $groups, public ?bool $active)
    {
    }
}
