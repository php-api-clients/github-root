...
final readonly class GpgKey
{
    ...
    /**
     * @param array<\ApiClients\Client\GitHubEnterpriseCloud\Schema\GpgKey\Emails> $emails
     * @param array<\ApiClients\Client\GitHubEnterpriseCloud\Schema\GpgKey\Subkeys> $subkeys
     */
