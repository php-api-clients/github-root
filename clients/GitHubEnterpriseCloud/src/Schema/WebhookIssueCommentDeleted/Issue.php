...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookIssueCommentDeleted;
...
final readonly class Issue
{
    ...
    public Schema\WebhookIssueCommentDeleted\Issue\SubIssuesSummary|null $subIssuesSummary, public string|null $state, #[MapFrom('state_reason')]
