...
final readonly class WebhookCheckSuiteRequested
{
    ...
    /**
     * checkSuite: The [check_suite](https://docs.github.com/enterprise-cloud@latest//rest/checks/suites#get-a-check-suite).
    ...
    public Schema\WebhookCheckSuiteRequested\CheckSuite $checkSuite, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUser $sender,)
    {
    }
}
