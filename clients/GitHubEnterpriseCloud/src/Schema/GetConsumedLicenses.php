...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\GetConsumedLicenses\Users;
...
final readonly class GetConsumedLicenses
{
     ...
     */
    public function __construct(#[MapFrom('total_seats_consumed')] public ?int $totalSeatsConsumed, #[MapFrom('total_seats_purchased')] public ?int $totalSeatsPurchased, #[CastListToType(Schema\GetConsumedLicenses\Users::class)] public ?array $users)
    {
    }
}
