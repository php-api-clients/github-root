...
final readonly class RunnerGroupsEnterprise
{
    ...
    public function __construct(int $id, string $name, string $visibility, bool $default, string $selected_organizations_url, string $runners_url, bool $allows_public_repositories, bool $workflow_restrictions_read_only, bool $restricted_to_workflows, array $selected_workflows)
    {
        $this->id = $id;
        $this->name = $name;
