...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\Operations\DependencyGraph\CreateRepositorySnapshot\Response\ApplicationJson;
...
final readonly class Created
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"id":2,"created_at":"generated","result":"generated","message":"generated"}';
     ...
     */
    public function __construct(public int $id, #[MapFrom('created_at')] public string $createdAt, public string $result, public string $message)
    {
    }
}
