...
final readonly class NpmMetadata
{
    ...
    public ?Schema\AuditLogEvent\Config $author;
    public ?Schema\AuditLogEvent\Config $bugs;
    public ?Schema\AuditLogEvent\Config $dependencies;
    public ?Schema\AuditLogEvent\Config $dev_dependencies;
    public ?Schema\AuditLogEvent\Config $peer_dependencies;
    public ?Schema\AuditLogEvent\Config $optional_dependencies;
    public ?string $description;
    public ?Schema\AuditLogEvent\Config $dist;
    public ?string $git_head;
    public ?string $homepage;
    public ?string $license;
    public ?string $main;
    public ?Schema\AuditLogEvent\Config $repository;
    public ?Schema\AuditLogEvent\Config $scripts;
    public ?string $id;
    ...
    public ?Schema\AuditLogEvent\Config $engines;
    /**
     * @var array<string>
     */
     ...
     */
    public ?array $files;
    public ?Schema\AuditLogEvent\Config $bin;
    public ?Schema\AuditLogEvent\Config $man;
    public ?Schema\AuditLogEvent\Config $directories;
    /**
     * @var array<string>
     */
    public ?array $os;
    ...
    public function __construct(string $name, string $version, string $npm_user, Schema\AuditLogEvent\Config $author, Schema\AuditLogEvent\Config $bugs, Schema\AuditLogEvent\Config $dependencies, Schema\AuditLogEvent\Config $dev_dependencies, Schema\AuditLogEvent\Config $peer_dependencies, Schema\AuditLogEvent\Config $optional_dependencies, string $description, Schema\AuditLogEvent\Config $dist, string $git_head, string $homepage, string $license, string $main, Schema\AuditLogEvent\Config $repository, Schema\AuditLogEvent\Config $scripts, string $id, string $node_version, string $npm_version, bool $has_shrinkwrap, array $maintainers, array $contributors, Schema\AuditLogEvent\Config $engines, array $keywords, array $files, Schema\AuditLogEvent\Config $bin, Schema\AuditLogEvent\Config $man, Schema\AuditLogEvent\Config $directories, array $os, array $cpu, string $readme, string $installation_command, int $release_id, string $commit_oid, bool $published_via_actions, int $deleted_by_id)
    {
        $this->name = $name;
