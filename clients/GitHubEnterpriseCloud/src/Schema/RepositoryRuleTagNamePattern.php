...
final readonly class RepositoryRuleTagNamePattern
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"type":"tag_name_pattern","parameters":{"name":"generated_name_null","negate":false,"operator":"starts_with","pattern":"generated_pattern_null"}}';
