...
final readonly class Permissions
{
    ...
    public ?Schema\WebhookTeamEdited\Changes\Repository\Permissions\From $from;
    public function __construct(Schema\WebhookTeamEdited\Changes\Repository\Permissions\From $from)
    {
        $this->from = $from;
    }
}
