...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookTeamEdited\Changes;
...
final readonly class Repository
{
    ...
    public ?Schema\WebhookTeamEdited\Changes\Repository\Permissions $permissions;
    public function __construct(Schema\WebhookTeamEdited\Changes\Repository\Permissions $permissions)
    {
