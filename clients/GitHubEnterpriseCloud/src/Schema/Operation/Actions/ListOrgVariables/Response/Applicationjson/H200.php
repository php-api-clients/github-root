...
final readonly class H200
{
    ...
    /**
     * @param array<OrganizationActionsVariable> $variables
     */
    public function __construct(#[MapFrom('total_count')] public int $totalCount, #[CastListToType(Schema\OrganizationActionsVariable::class)] public array $variables)
    {
    }
}
