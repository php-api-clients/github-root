...
final readonly class H200
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"total_count":13,"secrets":[{"name":"SECRET_NAME","created_at":"1970-01-01T00:00:00+00:00","updated_at":"1970-01-01T00:00:00+00:00","visibility":"generated_visibility_null","selected_repositories_url":"https:\\/\\/api.github.com\\/user\\/secrets\\/SECRET_NAME\\/repositories"}]}';
    /**
     * @param array<\ApiClients\Client\GitHubEnterpriseCloud\Schema\CodespacesSecret> $secrets
     */
    public function __construct(public int $total_count, #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\CodespacesSecret::class)] public array $secrets)
    {
    }
}
