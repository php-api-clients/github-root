...
final readonly class H200
{
    ...
    /**
     * @param array<CodespacesSecret> $secrets
     */
    public function __construct(#[MapFrom('total_count')] public int $totalCount, #[CastListToType(Schema\CodespacesSecret::class)] public array $secrets)
    {
    }
}
