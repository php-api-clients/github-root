...
final readonly class H200
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"totalCount":13,"devcontainers":[{"path":"generated_path_null","name":"generated_name_null","displayName":"generated_display_name_null"}]}';
    /**
