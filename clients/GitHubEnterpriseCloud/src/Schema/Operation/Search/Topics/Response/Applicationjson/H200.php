...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\Operation\Search\Topics\Response\Applicationjson;
...
final readonly class H200
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"total_count":13,"incomplete_results":false,"items":[null]}';
    public ?int $total_count;
    public ?bool $incomplete_results;
    /**
     * @var array<Schema\TopicSearchResultItem>
     */
    public ?array $items;
