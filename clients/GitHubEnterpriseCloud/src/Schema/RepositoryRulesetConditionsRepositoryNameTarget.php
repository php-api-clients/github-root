...
final readonly class RepositoryRulesetConditionsRepositoryNameTarget
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"repository_name":{"include":["generated_include_null"],"exclude":["generated_exclude_null"],"protected":false}}';

    public function __construct(#[MapFrom('repository_name')] public ?Schema\RepositoryRulesetConditionsRepositoryNameTarget\RepositoryName $repositoryName)
    {
    }
}
