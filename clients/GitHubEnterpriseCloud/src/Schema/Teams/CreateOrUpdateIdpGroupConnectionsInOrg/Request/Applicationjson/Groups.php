...
final readonly class Groups
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"groupId":"generated_group_id_null","groupName":"generated_group_name_null","groupDescription":"generated_group_description_null"}';
    /**
