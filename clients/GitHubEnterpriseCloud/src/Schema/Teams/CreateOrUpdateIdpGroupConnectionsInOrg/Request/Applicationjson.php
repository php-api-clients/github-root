...
final readonly class Applicationjson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"groups":[{"groupId":"generated_group_id_null","groupName":"generated_group_name_null","groupDescription":"generated_group_description_null"}]}';
    /**
