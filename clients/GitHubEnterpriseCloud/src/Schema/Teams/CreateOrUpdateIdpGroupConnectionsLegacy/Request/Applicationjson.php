...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\Teams\CreateOrUpdateIdpGroupConnectionsLegacy\Request\Applicationjson\Groups;
...
final readonly class Applicationjson
{
     ...
     */
    public function __construct(#[CastListToType(Schema\Teams\CreateOrUpdateIdpGroupConnectionsLegacy\Request\Applicationjson\Groups::class)] public array $groups, #[MapFrom('synced_at')] public ?string $syncedAt)
    {
    }
}
