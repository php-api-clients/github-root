...
final readonly class Applicationjson
{
     ...
     * @var array<Schema\Teams\CreateOrUpdateIdpGroupConnectionsLegacy\Request\Applicationjson\Groups>
     */
    public ?array $groups;
    public string $synced_at;
    public function __construct(array $groups, string $synced_at)
    {
        $this->groups = $groups;
