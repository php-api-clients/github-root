...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookCodeScanningAlertClosedByUser;
...
final readonly class Alert
{
    ...
    public Schema\WebhookCodeScanningAlertClosedByUser\Alert\MostRecentInstance|null $mostRecentInstance, public int $number, public Schema\WebhookCodeScanningAlertClosedByUser\Alert\Rule $rule, public string $state, public Schema\WebhookCodeScanningAlertClosedByUser\Alert\Tool $tool, public string $url, #[MapFrom('dismissal_approved_by')]
    public Schema\WebhookCodeScanningAlertClosedByUser\Alert\DismissalApprovedBy|null $dismissalApprovedBy,)
    {
    }
}
