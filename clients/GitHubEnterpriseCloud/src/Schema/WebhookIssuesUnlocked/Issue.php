...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookIssuesUnlocked;
...
final readonly class Issue
{
    ...
    public function __construct(mixed $active_lock_reason, Schema\WebhookCheckSuiteCompleted\ActionsMeta $assignee, array $assignees, string $author_association, string $body, string $closed_at, int $comments, string $comments_url, string $created_at, string $events_url, string $html_url, int $id, array $labels, string $labels_url, bool $locked, Schema\WebhookCheckSuiteCompleted\ActionsMeta $milestone, string $node_id, int $number, mixed $performed_via_github_app, Schema\WebhookDiscussionCreated\Discussion\Reactions $reactions, string $repository_url, string $state, string $timeline_url, string $title, string $updated_at, string $url, Schema\WebhookDeploymentCreated\WorkflowRun\HeadRepository\Owner $user)
    {
