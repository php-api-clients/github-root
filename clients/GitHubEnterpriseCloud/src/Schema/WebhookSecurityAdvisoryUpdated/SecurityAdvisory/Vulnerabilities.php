...
final readonly class Vulnerabilities
{
    ...
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('first_patched_version')] public ?Schema\WebhookSecurityAdvisoryUpdated\SecurityAdvisory\Vulnerabilities\FirstPatchedVersion $firstPatchedVersion, public Schema\WebhookSecurityAdvisoryUpdated\SecurityAdvisory\Vulnerabilities\Package $package, public string $severity, #[\EventSauce\ObjectHydrator\MapFrom('vulnerable_version_range')] public string $vulnerableVersionRange)
    {
    }
}
