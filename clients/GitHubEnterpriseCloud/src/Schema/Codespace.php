...
final readonly class Codespace
{
    ...
    public Schema\SimpleUser $billableOwner, public Schema\MinimalRepository $repository, public Schema\CodespaceMachine|null $machine, #[MapFrom('devcontainer_path')]
    ...
    public Schema\Codespace\GitStatus $gitStatus, public string $location, #[MapFrom('idle_timeout_minutes')]
    ...
    public Schema\Codespace\RuntimeConstraints|null $runtimeConstraints, #[MapFrom('pending_operation')]
