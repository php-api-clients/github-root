...
final readonly class PackageVersion
{
    ...
    public ?Schema\WebhookPackagePublished\Package\PackageVersion\ContainerMetadata $container_metadata;
    ...
    public ?string $name;
    public ?Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata $npm_metadata;
    /**
     * @var array<Schema\WebhookPackagePublished\Package\PackageVersion\NugetMetadata>
     */
    public ?array $nuget_metadata;
    /**
     * @var array<Schema\WebhookPackagePublished\Package\PackageVersion\PackageFiles>
     */
    public ?array $package_files;
    public string $package_url;
    public bool $prerelease;
    public Schema\WebhookPackagePublished\Package\PackageVersion\Release $release;
    /**
     * @var array<mixed>
     */
    ...
    public function __construct(Schema\Discussion\AnswerChosenBy $author, Schema\AuditLogEvent\Config $body, string $body_html, Schema\WebhookPackagePublished\Package\PackageVersion\ContainerMetadata $container_metadata, string $created_at, string $description, array $docker_metadata, bool $draft, string $html_url, int $id, string $installation_command, string $manifest, array $metadata, string $name, Schema\WebhookPackagePublished\Package\PackageVersion\NpmMetadata $npm_metadata, array $nuget_metadata, array $package_files, string $package_url, bool $prerelease, Schema\WebhookPackagePublished\Package\PackageVersion\Release $release, array $rubygems_metadata, string $source_url, string $summary, string $tag_name, string $target_commitish, string $target_oid, string $updated_at, string $version)
    {
        $this->author = $author;
        $this->body = $body;
