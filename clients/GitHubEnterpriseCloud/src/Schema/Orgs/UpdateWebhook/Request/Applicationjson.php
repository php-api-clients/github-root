...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\Orgs\UpdateWebhook\Request;
...
final readonly class Applicationjson
{
    ...
    /**
     * config: Key/value pairs to provide settings for this webhook. [These are defined below](https://docs.github.com/enterprise-cloud@latest//rest/reference/orgs#update-hook-config-params).
