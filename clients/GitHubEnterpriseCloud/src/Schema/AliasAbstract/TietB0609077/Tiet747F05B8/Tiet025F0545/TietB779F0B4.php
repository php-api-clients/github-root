...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\AliasAbstract\TietB0609077\Tiet747F05B8\Tiet025F0545;
...
abstract readonly class TietB779F0B4
{
    ...
    public function __construct(public Schema\WebhookMarketplacePurchaseCancelled\PreviousMarketplacePurchase\Account $account, #[MapFrom('billing_cycle')] public string $billingCycle, #[MapFrom('free_trial_ends_on')] public string $freeTrialEndsOn, #[MapFrom('next_billing_date')] public ?string $nextBillingDate, #[MapFrom('on_free_trial')] public bool $onFreeTrial, public Schema\WebhookMarketplacePurchaseCancelled\PreviousMarketplacePurchase\Plan $plan, #[MapFrom('unit_count')] public int $unitCount)
    {
    }
}
