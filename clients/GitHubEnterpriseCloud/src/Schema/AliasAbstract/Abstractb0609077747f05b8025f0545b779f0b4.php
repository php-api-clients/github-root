...
abstract readonly class Abstractb0609077747f05b8025f0545b779f0b4
{
    ...
    public function __construct(public Schema\WebhookMarketplacePurchaseCancelled\PreviousMarketplacePurchase\Account $account, #[MapFrom('billing_cycle')] public string $billingCycle, #[MapFrom('free_trial_ends_on')] public mixed $freeTrialEndsOn, #[MapFrom('next_billing_date')] public ?string $nextBillingDate, #[MapFrom('on_free_trial')] public bool $onFreeTrial, public Schema\WebhookMarketplacePurchaseCancelled\PreviousMarketplacePurchase\Plan $plan, #[MapFrom('unit_count')] public int $unitCount)
    {
    }
}
