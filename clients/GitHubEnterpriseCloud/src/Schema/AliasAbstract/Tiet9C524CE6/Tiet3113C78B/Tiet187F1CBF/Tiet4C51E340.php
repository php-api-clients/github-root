...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\AliasAbstract\Tiet9C524CE6\Tiet3113C78B\Tiet187F1CBF;

use ApiClients\Client\GitHubEnterpriseCloud\Schema;
use EventSauce\ObjectHydrator\MapFrom;

abstract readonly class Tiet4C51E340
{
     ...
     */
    public function __construct(public Schema\RepositoryAdvisoryCreate\Vulnerabilities\Package $package, #[MapFrom('vulnerable_version_range')] public ?string $vulnerableVersionRange, #[MapFrom('patched_versions')] public ?string $patchedVersions, #[MapFrom('vulnerable_functions')] public ?array $vulnerableFunctions)
    {
    }
}
