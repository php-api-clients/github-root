...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\AliasAbstract\TietDE8B8C33\TietDD3CC7C9\TietD567FBE1;

use EventSauce\ObjectHydrator\MapFrom;

abstract readonly class Tiet46B008A2
{
    ...
    public const SCHEMA_DESCRIPTION  = 'The [`deploy key`](https://docs.github.com/enterprise-cloud@latest//rest/deploy-keys/deploy-keys#get-a-deploy-key) resource.';
