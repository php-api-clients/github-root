...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\AliasAbstract\TietB194120A\TietB22ECFCE\TietE138646B;

use ApiClients\Client\GitHubEnterpriseCloud\Schema;
use EventSauce\ObjectHydrator\MapFrom;

abstract readonly class Tiet764000C9
{
    ...
    public const SCHEMA_DESCRIPTION  = 'The [comment](https://docs.github.com/enterprise-cloud@latest//rest/pulls/comments#get-a-review-comment-for-a-pull-request) itself.';
