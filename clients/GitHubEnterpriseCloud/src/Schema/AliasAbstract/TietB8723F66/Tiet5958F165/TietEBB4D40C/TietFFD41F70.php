...
abstract readonly class TietFFD41F70
{
    ...
    public function __construct(public Schema\WebhookMarketplacePurchaseCancelled\MarketplacePurchase\Account $account, #[MapFrom('billing_cycle')]
    ...
    public bool $onFreeTrial, public Schema\WebhookMarketplacePurchaseCancelled\MarketplacePurchase\Plan $plan, #[MapFrom('unit_count')]
