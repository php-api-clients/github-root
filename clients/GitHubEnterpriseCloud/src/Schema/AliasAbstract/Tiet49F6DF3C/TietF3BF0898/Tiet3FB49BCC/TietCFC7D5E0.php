...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\AliasAbstract\Tiet49F6DF3C\TietF3BF0898\Tiet3FB49BCC;

use ApiClients\Client\GitHubEnterpriseCloud\Schema;
use EventSauce\ObjectHydrator\MapFrom;

abstract readonly class TietCFC7D5E0
{
    ...
    public string $createdAt, public Schema\WebhooksIssue2\Milestone\Creator|null $creator, public string|null $description, #[MapFrom('due_on')]
