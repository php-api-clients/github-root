...
abstract readonly class Abstractdcad5e8f2eec4de5b5cb16bffb04ba48
{
    ...
    /**
     * @param array<\ApiClients\Client\GitHubEnterpriseCloud\Schema\CodespaceMachine> $machines
     */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('total_count')] public int $totalCount, #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\CodespaceMachine::class)] public array $machines)
    {
    }
}
