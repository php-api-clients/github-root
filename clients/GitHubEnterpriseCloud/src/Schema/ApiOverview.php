...
final readonly class ApiOverview
{
    ...
    public array|null $sshKeys, public array|null $hooks, public array|null $web, public array|null $api, public array|null $git, public array|null $packages, public array|null $pages, public array|null $importer, public array|null $actions, public array|null $dependabot, public Schema\ApiOverview\Domains|null $domains,)
    {
    }
}
