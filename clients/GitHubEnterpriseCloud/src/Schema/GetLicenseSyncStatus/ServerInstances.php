...
final readonly class ServerInstances
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"serverId":"generated_server_id_null","hostname":"generated_hostname_null","lastSync":{"date":"generated_date_null","status":"generated_status_null","error":"generated_error_null"}}';
