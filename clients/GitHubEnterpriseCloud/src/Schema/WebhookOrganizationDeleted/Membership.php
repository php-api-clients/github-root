...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookOrganizationDeleted;
...
final readonly class Membership
{
    ...
    public function __construct(string $organization_url, string $role, string $state, string $url, Schema\Discussion\AnswerChosenBy $user)
    {
