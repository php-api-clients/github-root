...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\Git\CreateTree\Request;
...
final readonly class Applicationjson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"tree":[null],"base_tree":"generated_base_tree"}';
    /**
     * Objects (of `path`, `mode`, `type`, and `sha`) specifying a tree structure.
     * @var array<Schema\Git\CreateTree\Request\Applicationjson\Tree>
     */
    public ?array $tree;
    /**
