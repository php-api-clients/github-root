...
final readonly class WebhookIssuesUntyped
{
    ...
    public const SCHEMA_TITLE        = 'issues untyped event';
     ...
     */
    public function __construct(public string $action, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\WebhooksIssue $issue, public Schema\IssueType|null $type, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUser $sender)
    {
    }
}
