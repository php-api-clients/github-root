...
final readonly class BranchRestrictionPolicy
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"url":"generated_url","users_url":"generated_users_url","teams_url":"generated_teams_url","apps_url":"generated_apps_url","users":[null],"teams":[null],"apps":[null]}';
    public ?string $url;
    public ?string $users_url;
    public ?string $teams_url;
    public ?string $apps_url;
    /**
     * @var array<Schema\Repository\TemplateRepository\Owner>
     */
    public ?array $users;
    /**
     * @var array<Schema\BranchRestrictionPolicy\Teams>
     */
    public ?array $teams;
    /**
     * @var array<Schema\BranchRestrictionPolicy\Apps>
     */
    public ?array $apps;
