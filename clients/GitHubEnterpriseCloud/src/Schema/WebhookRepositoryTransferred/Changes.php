...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookRepositoryTransferred;
...
final readonly class Changes
{
    ...
    public ?Schema\WebhookRepositoryTransferred\Changes\Owner $owner;
    public function __construct(Schema\WebhookRepositoryTransferred\Changes\Owner $owner)
    {
        $this->owner = $owner;
    }
}
