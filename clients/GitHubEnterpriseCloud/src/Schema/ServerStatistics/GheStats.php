...
final readonly class GheStats
{
    ...
    public ?Schema\ServerStatistics\GheStats\Comments $comments;
    public ?Schema\ServerStatistics\GheStats\Gists $gists;
    public ?Schema\ServerStatistics\GheStats\Hooks $hooks;
    public ?Schema\ServerStatistics\GheStats\Issues $issues;
    public ?Schema\ServerStatistics\GheStats\Milestones $milestones;
    public ?Schema\ServerStatistics\GheStats\Orgs $orgs;
    public ?Schema\ServerStatistics\GheStats\Pages $pages;
    public ?Schema\ServerStatistics\GheStats\Pulls $pulls;
    public ?Schema\ServerStatistics\GheStats\Repos $repos;
    public ?Schema\ServerStatistics\GheStats\Users $users;
    public function __construct(Schema\ServerStatistics\GheStats\Comments $comments, Schema\ServerStatistics\GheStats\Gists $gists, Schema\ServerStatistics\GheStats\Hooks $hooks, Schema\ServerStatistics\GheStats\Issues $issues, Schema\ServerStatistics\GheStats\Milestones $milestones, Schema\ServerStatistics\GheStats\Orgs $orgs, Schema\ServerStatistics\GheStats\Pages $pages, Schema\ServerStatistics\GheStats\Pulls $pulls, Schema\ServerStatistics\GheStats\Repos $repos, Schema\ServerStatistics\GheStats\Users $users)
    {
