...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookIssuesLabeled;
...
final readonly class Issue
{
    ...
    public Schema\WebhookIssuesLabeled\Issue\SubIssuesSummary|null $subIssuesSummary, public string|null $state, #[MapFrom('state_reason')]
