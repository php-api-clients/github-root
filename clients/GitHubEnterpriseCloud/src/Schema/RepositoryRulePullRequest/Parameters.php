...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\RepositoryRulePullRequest;
...
final readonly class Parameters
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"dismiss_stale_reviews_on_push":false,"require_code_owner_review":false,"require_last_push_approval":false,"required_approving_review_count":13,"required_review_thread_resolution":false}';
