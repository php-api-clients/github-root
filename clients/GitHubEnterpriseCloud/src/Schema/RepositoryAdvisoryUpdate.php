...
final readonly class RepositoryAdvisoryUpdate
{
     ...
     * @param ?array<\ApiClients\Client\GitHubEnterpriseCloud\Schema\RepositoryAdvisoryUpdate\Vulnerabilities> $vulnerabilities
     ...
     * @param ?array<\ApiClients\Client\GitHubEnterpriseCloud\Schema\RepositoryAdvisoryUpdate\Credits> $credits
     ...
     */
    public function __construct(public ?string $summary, public ?string $description, #[\EventSauce\ObjectHydrator\MapFrom('cve_id')] public ?string $cveId, #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\RepositoryAdvisoryUpdate\Vulnerabilities::class)] public ?array $vulnerabilities, #[\EventSauce\ObjectHydrator\MapFrom('cwe_ids')] public ?array $cweIds, #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\RepositoryAdvisoryUpdate\Credits::class)] public ?array $credits, public ?string $severity, #[\EventSauce\ObjectHydrator\MapFrom('cvss_vector_string')] public ?string $cvssVectorString, public ?string $state)
    {
    }
}
