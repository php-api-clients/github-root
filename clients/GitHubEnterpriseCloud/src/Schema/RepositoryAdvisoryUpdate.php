...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\RepositoryAdvisoryUpdate\Credits;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\RepositoryAdvisoryUpdate\Vulnerabilities;
