...
{
    public const SCHEMA_JSON         = '{"title":"Copilot for Business Seat Breakdown","type":"object","properties":{"total":{"type":"integer","description":"The total number of seats being billed for the organization as of the current billing cycle."},"added_this_cycle":{"type":"integer","description":"Seats added during the current billing cycle."},"pending_cancellation":{"type":"integer","description":"The number of seats that are pending cancellation at the end of the current billing cycle."},"pending_invitation":{"type":"integer","description":"The number of seats that have been assigned to users that have not yet accepted an invitation to this organization."},"active_this_cycle":{"type":"integer","description":"The number of seats that have used Copilot during the current billing cycle."},"inactive_this_cycle":{"type":"integer","description":"The number of seats that have not used Copilot during the current billing cycle."}},"description":"The breakdown of Copilot for Business seats for the organization."}';
    public const SCHEMA_TITLE        = 'Copilot for Business Seat Breakdown';
    public const SCHEMA_DESCRIPTION  = 'The breakdown of Copilot for Business seats for the organization.';
    public const SCHEMA_EXAMPLE_DATA = '{"total":5,"added_this_cycle":16,"pending_cancellation":20,"pending_invitation":18,"active_this_cycle":17,"inactive_this_cycle":19}';
