...
final readonly class WebhookMarketplacePurchaseChanged
{
    ...
    public Schema\WebhookMarketplacePurchaseChanged\MarketplacePurchase $marketplacePurchase, public Schema\OrganizationSimple|null $organization, #[MapFrom('previous_marketplace_purchase')]
    public Schema\WebhookMarketplacePurchaseChanged\PreviousMarketplacePurchase|null $previousMarketplacePurchase, public Schema\Repository|null $repository, public Schema\SimpleUser $sender,)
    {
    }
}
