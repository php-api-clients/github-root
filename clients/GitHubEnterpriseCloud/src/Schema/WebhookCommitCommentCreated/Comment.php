...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookCommitCommentCreated;
...
final readonly class Comment
{
    ...
    public const SCHEMA_DESCRIPTION  = 'The [commit comment](https://docs.github.com/enterprise-cloud@latest//rest/commits/comments#get-a-commit-comment) resource.';
