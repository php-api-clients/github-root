...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\CodeSecurity\UpdateEnterpriseConfiguration\Request;
...
final readonly class ApplicationJson
{
     ...
     * description: A description of the code security configuration
     * advancedSecurity: The enablement status of GitHub Advanced Security. Must be set to enabled if you want to enable any GHAS settings.
    ...
    public Schema\CodeSecurity\UpdateEnterpriseConfiguration\Request\ApplicationJson\DependencyGraphAutosubmitActionOptions|null $dependencyGraphAutosubmitActionOptions, #[MapFrom('dependabot_alerts')]
