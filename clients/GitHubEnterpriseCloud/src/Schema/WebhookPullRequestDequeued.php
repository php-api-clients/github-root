...
final readonly class WebhookPullRequestDequeued
{
    ...
    public const SCHEMA_TITLE        = 'pull_request dequeued event';
    ...
    public Schema\WebhookPullRequestDequeued\PullRequest $pullRequest, public string $reason, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUserWebhooks $sender,)
    {
    }
}
