...
final readonly class WebhookPullRequestDequeued
{
    ...
    public Schema\WebhookPullRequestDequeued\PullRequest $pullRequest, public string $reason, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUser $sender,)
    {
    }
}
