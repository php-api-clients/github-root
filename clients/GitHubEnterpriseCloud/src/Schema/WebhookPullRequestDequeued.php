...
final readonly class WebhookPullRequestDequeued
{
    ...
    public Schema\WebhookPullRequestDequeued\PullRequest $pullRequest, public string $reason, public Schema\Repository $repository, public Schema\SimpleUser $sender,)
    {
    }
}
