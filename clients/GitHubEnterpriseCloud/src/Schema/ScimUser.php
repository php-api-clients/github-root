...
final readonly class ScimUser
{
     ...
     * emails: user emails
     * @param array<\ApiClients\Client\Github\Schema\ScimUser\Emails> $emails
     * active: The active status of the User.
     * organizationId: The ID of the organization.
     * operations: Set of operations to be performed
     * @param ?array<\ApiClients\Client\Github\Schema\ScimUser\Operations> $operations
     * groups: associated groups
     * @param ?array<\ApiClients\Client\Github\Schema\ScimUser\Groups> $groups
     * @param ?array<\ApiClients\Client\Github\Schema\ScimUser\Roles> $roles
     */
