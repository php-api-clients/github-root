...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\ScimUser\Emails;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\ScimUser\Groups;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\ScimUser\Operations;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\ScimUser\Roles;
...
final readonly class ScimUser
{
     ...
     * emails: user emails
     * @param array<Emails>      $emails     active: The active status of the User.
     *          organizationId: The ID of the organization.
     *          operations: Set of operations to be performed
     * @param ?array<Operations> $operations groups: associated groups
     * @param ?array<Groups>     $groups
     * @param ?array<Roles>      $roles
     */
    public function __construct(public array $schemas, public string $id, public ?string $externalId, public ?string $userName, public ?string $displayName, public ?Schema\ScimUser\Name $name, #[CastListToType(Schema\ScimUser\Emails::class)] public array $emails, public bool $active, public Schema\ScimUser\Meta $meta, #[MapFrom('organization_id')] public ?int $organizationId, #[CastListToType(Schema\ScimUser\Operations::class)] public ?array $operations, #[CastListToType(Schema\ScimUser\Groups::class)] public ?array $groups, #[CastListToType(Schema\ScimUser\Roles::class)] public ?array $roles)
    {
    }
}
