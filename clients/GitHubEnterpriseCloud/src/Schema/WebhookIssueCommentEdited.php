...
final readonly class WebhookIssueCommentEdited
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhooksChanges $changes, public Schema\WebhooksIssueComment $comment, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\WebhookIssueCommentEdited\Issue $issue, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUser $sender)
    {
    }
}
