...
final readonly class WebhookExemptionRequestCancelled
{
    ...
    public const SCHEMA_TITLE        = 'Exemption request cancellation event';
    ...
    public Schema\ExemptionRequest $exemptionRequest, public Schema\SimpleUserWebhooks $sender,)
    {
    }
}
