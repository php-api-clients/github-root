...
use ApiClients\Client\GitHubEnterpriseCloud\Schema\TopicSearchResultItem\Aliases;
use ApiClients\Client\GitHubEnterpriseCloud\Schema\TopicSearchResultItem\Related;
