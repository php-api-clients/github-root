...
final readonly class ActionsBillingUsage
{
     ...
     */
    public ?int $total_minutes_used;
    /**
     * The total paid GitHub Actions minutes used.
     */
    public ?int $total_paid_minutes_used;
    /**
     * The amount of free GitHub Actions minutes available.
     */
    public ?int $included_minutes;
    public ?Schema\ActionsBillingUsage\MinutesUsedBreakdown $minutes_used_breakdown;
    public function __construct(int $total_minutes_used, int $total_paid_minutes_used, int $included_minutes, Schema\ActionsBillingUsage\MinutesUsedBreakdown $minutes_used_breakdown)
    {
