...
namespace ApiClients\Client\GitHubEnterpriseCloud\Schema\WebhookPullRequestAutoMergeEnabled\PullRequest\Head;
...
final readonly class Repo
{
    ...
    public string $languagesUrl, public Schema\WebhookPullRequestAutoMergeEnabled\PullRequest\Head\Repo\License|null $license, #[MapFrom('master_branch')]
    ...
    public int $openIssuesCount, public string|null $organization, public Schema\WebhookPullRequestAutoMergeEnabled\PullRequest\Head\Repo\Owner|null $owner, public Schema\WebhookPullRequestAutoMergeEnabled\PullRequest\Head\Repo\Permissions|null $permissions, public bool $private, public bool|null $public, #[MapFrom('pulls_url')]
