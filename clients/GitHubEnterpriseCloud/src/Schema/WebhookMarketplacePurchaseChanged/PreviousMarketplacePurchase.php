...
final readonly class PreviousMarketplacePurchase
{
    ...
    public function __construct(public Schema\WebhookMarketplacePurchaseCancelled\MarketplacePurchase\Account $account, #[MapFrom('billing_cycle')] public string $billingCycle, #[MapFrom('free_trial_ends_on')] public ?string $freeTrialEndsOn, #[MapFrom('next_billing_date')] public ?string $nextBillingDate, #[MapFrom('on_free_trial')] public ?bool $onFreeTrial, public Schema\WebhookMarketplacePurchaseCancelled\MarketplacePurchase\Plan $plan, #[MapFrom('unit_count')] public int $unitCount)
    {
    }
}
