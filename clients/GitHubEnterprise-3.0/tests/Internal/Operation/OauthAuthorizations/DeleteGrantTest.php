...
/** @covers \ApiClients\Client\GitHubEnterprise\Internal\Operation\OauthAuthorizations\DeleteGrant */
final class DeleteGrantTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/applications/grants/8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\OauthAuthorizations\DeleteGrant::OPERATION_MATCH, (static function (array $data): array {
            $data['grant_id'] = 8;
    ...
    public function operations_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/applications/grants/8', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->oauthAuthorizations()->deleteGrant(8);
    }
