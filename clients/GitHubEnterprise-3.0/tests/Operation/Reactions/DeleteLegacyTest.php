...
final class DeleteLegacyTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function httpCode_403_responseContentType_application_json()
    {
        ...
        $browser->request('DELETE', '/reactions/13', \Prophecy\Argument::type('array'), \Prophecy\Argument::any())->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterprise\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterprise\Operation\Reactions\DeleteLegacy::OPERATION_MATCH, (static function (array $data) : array {
            $data['reaction_id'] = 13;
            return $data;
        })(array()));
    }
