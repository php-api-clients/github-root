...
use ApiClients\Client\GitHubEnterprise\Operation\Git\ListMatchingRefs;
...
final class ListMatchingRefsTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/repos/generated_null/generated_null/git/matching-refs/generated_null?per_page=13&page=13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
