...
final class CancelWorkflowRunTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    {
        $response = new \React\Http\Message\Response(202, array('Content-Type' => 'application/json'), Schema\Operation\Actions\CancelWorkflowRun\Response\Applicationjson\H202::SCHEMA_EXAMPLE_DATA);
