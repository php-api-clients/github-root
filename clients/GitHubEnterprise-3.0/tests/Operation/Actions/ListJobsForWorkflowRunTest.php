...
final class ListJobsForWorkflowRunTest extends AsyncTestCase
{
    ...
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], Schema\Operations\Actions\ListJobsForWorkflowRun\Response\ApplicationJson\Ok::SCHEMA_EXAMPLE_DATA);
