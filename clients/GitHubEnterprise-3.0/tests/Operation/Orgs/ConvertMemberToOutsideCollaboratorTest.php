...
final class ConvertMemberToOutsideCollaboratorTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function httpCode_202_responseContentType_application_json()
    {
        ...
        $browser->request('PUT', '/orgs/generated_null/outside_collaborators/generated_null', \Prophecy\Argument::type('array'), \Prophecy\Argument::any())->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
