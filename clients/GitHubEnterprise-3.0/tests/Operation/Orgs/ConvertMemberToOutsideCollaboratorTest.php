...
final class ConvertMemberToOutsideCollaboratorTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function t202td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('PUT', '/orgs/generated_null/outside_collaborators/generated_null', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterprise\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterprise\Operation\Orgs\ConvertMemberToOutsideCollaborator::OPERATION_MATCH, array('org' => 'generated_null', 'username' => 'generated_null'));
    }
    /**
     * @test
     */
