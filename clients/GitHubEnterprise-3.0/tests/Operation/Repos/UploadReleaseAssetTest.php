...
use ApiClients\Client\GitHubEnterprise\Operation\Repos\UploadReleaseAsset;
...
final class UploadReleaseAssetTest extends AsyncTestCase
{
     ...
     * @test
     */
    public function httpCode_201_requestContentType___responseContentType_application_json(): void
    {
        ...
        $browser->request('POST', '/repos/generated_null/generated_null/releases/13/assets?name=generated_null&label=generated_null', Argument::type('array'), Schema\Repos\UploadReleaseAsset\Request\ObelixObelix::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
