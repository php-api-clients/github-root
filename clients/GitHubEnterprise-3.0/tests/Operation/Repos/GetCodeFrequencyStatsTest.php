...
final class GetCodeFrequencyStatsTest extends AsyncTestCase
{
    ...
    {
        $response = new Response(202, ['Content-Type' => 'application/json'], Schema\Operations\Repos\GetCodeFrequencyStats\Response\ApplicationJson\Accepted::SCHEMA_EXAMPLE_DATA);
