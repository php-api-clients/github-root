...
final class DeleteAuthorizationTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function t403td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('DELETE', '/authorizations/13', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterprise\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterprise\Operation\OauthAuthorizations\DeleteAuthorization::OPERATION_MATCH, array('authorization_id' => 13));
    }
    /**
     * @test
     */
