...
use ApiClients\Client\GitHubEnterprise\Operation\EnterpriseAdmin\GetMaintenanceStatus;
...
final class GetMaintenanceStatusTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $client->call(GetMaintenanceStatus::OPERATION_MATCH, (static function (array $data): array {
            return $data;
        })([]));
    }
}
