...
class Dismissals implements ObjectMapper
{
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️PullRequestReview(mixed $object): mixed
    {
        ...
        $links = $object->links;
        $links = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️TimelineReviewedEvent⚡️Links($links);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️TimelineReviewedEvent⚡️Links(mixed $object): mixed
    {
        ...
        $pullRequest = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️TimelineReviewedEvent⚡️Links⚡️Html($pullRequest);
