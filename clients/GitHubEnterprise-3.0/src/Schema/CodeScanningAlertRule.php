...
final readonly class CodeScanningAlertRule
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"id":"generated_id_null","name":"generated_name_null","severity":"generated_severity_null","description":"generated_description_null","full_description":"generated_full_description_null","tags":["generated_tags_null"],"help":"generated_help_null"}';
    /**
     ...
     */
    public function __construct(public ?string $id, public ?string $name, public ?string $severity, public ?string $description, public ?string $full_description, public ?array $tags, public ?string $help)
    {
    }
}
