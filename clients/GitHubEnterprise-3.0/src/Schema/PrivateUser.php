...
final readonly class PrivateUser
{
    ...
    public bool $siteAdmin, public string|null $name, public string|null $company, public string|null $blog, public string|null $location, public string|null $email, public bool|null $hireable, public string|null $bio, #[MapFrom('public_repos')]
