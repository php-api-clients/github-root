...
final readonly class Page
{
     ...
     */
    public function __construct(public string $url, public ?string $status, public ?string $cname, #[\EventSauce\ObjectHydrator\MapFrom('protected_domain_state')] public ?string $protectedDomainState, #[\EventSauce\ObjectHydrator\MapFrom('pending_domain_unverified_at')] public ?string $pendingDomainUnverifiedAt, #[\EventSauce\ObjectHydrator\MapFrom('custom_404')] public bool $custom404, #[\EventSauce\ObjectHydrator\MapFrom('html_url')] public ?string $htmlUrl, public ?Schema\PagesSourceHash $source, public bool $public, #[\EventSauce\ObjectHydrator\MapFrom('https_certificate')] public ?Schema\PagesHttpsCertificate $httpsCertificate, #[\EventSauce\ObjectHydrator\MapFrom('https_enforced')] public ?bool $httpsEnforced)
    {
    }
}
