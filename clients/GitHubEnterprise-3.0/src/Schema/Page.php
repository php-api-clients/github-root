...
final readonly class Page
{
     ...
     */
    public function __construct(public string $url, public ?string $status, public ?string $cname, public ?string $protected_domain_state, public ?string $pending_domain_unverified_at, public bool $custom_404, public ?string $html_url, public ?Schema\PagesSourceHash $source, public bool $public, public ?Schema\PagesHttpsCertificate $https_certificate, public ?bool $https_enforced)
    {
    }
}
