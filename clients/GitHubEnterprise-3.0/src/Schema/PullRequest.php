...
final readonly class PullRequest
{
    ...
    public string $authorAssociation, public bool|null $draft, public bool $merged, public bool|null $mergeable, public bool|null $rebaseable, #[MapFrom('mergeable_state')]
