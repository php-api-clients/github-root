...
final readonly class DismissalRestrictions
{
     ...
     */
    public ?array $teams;
    public function __construct(string $url, string $users_url, string $teams_url, array $users, array $teams)
    {
        $this->url = $url;
