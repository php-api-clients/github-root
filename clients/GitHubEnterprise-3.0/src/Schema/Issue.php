...
final readonly class Issue
{
    ...
    public string $htmlUrl, public int $number, public string $state, public string $title, public string|null $body, public Schema\SimpleUser|null $user, public array $labels, public Schema\SimpleUser|null $assignee, public array|null $assignees, public Schema\Milestone|null $milestone, public bool $locked, #[MapFrom('active_lock_reason')]
