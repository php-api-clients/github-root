...
namespace ApiClients\Client\GitHubEnterprise\Schema\AliasAbstract\Tiet447EC001\Tiet9A302D63\Tiet36B99B81;

use EventSauce\ObjectHydrator\MapFrom;

abstract readonly class TietA023D962
{
     ...
     * secret: If provided, the `secret` will be used as the `key` to generate the HMAC hex digest value in the [`X-Hub-Signature`](https://docs.github.com/enterprise-server@3.0/webhooks/event-payloads/#delivery-headers) header.
