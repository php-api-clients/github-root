...
namespace ApiClients\Client\GitHubEnterprise\Schema\AliasAbstract\Tiet809A531A\Tiet02430074\TietCEA65C5D;

use EventSauce\ObjectHydrator\MapFrom;

abstract readonly class Tiet8C01C54E
{
     ...
     * annotationLevel: The level of the annotation. Can be one of `notice`, `warning`, or `failure`.
