...
final readonly class Applicationjson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"required_status_checks":{"strict":false,"contexts":["generated_contexts"],"checks":[{"context":"generated_context","app_id":13}]},"enforce_admins":false,"required_pull_request_reviews":{"dismissal_restrictions":{"users":["generated_users"],"teams":["generated_teams"]},"dismiss_stale_reviews":false,"require_code_owner_reviews":false,"required_approving_review_count":13},"restrictions":{"users":["generated_users"],"teams":["generated_teams"],"apps":["generated_apps"]},"required_linear_history":false,"allow_force_pushes":false,"allow_deletions":false,"required_conversation_resolution":false,"contexts":["generated_contexts"]}';
    /**
