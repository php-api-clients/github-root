...
final readonly class Applicationjson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"dismissalRestrictions":{"users":["generated_users_null"],"teams":["generated_teams_null"]},"dismissStaleReviews":false,"requireCodeOwnerReviews":false,"requiredApprovingReviewCount":13}';
    /**
