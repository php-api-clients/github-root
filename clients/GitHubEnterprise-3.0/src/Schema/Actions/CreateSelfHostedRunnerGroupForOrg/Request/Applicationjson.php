...
final readonly class Applicationjson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"name":"generated_name","visibility":"generated_visibility","selected_repository_ids":[null],"runners":[null],"allows_public_repositories":false}';
    /**
