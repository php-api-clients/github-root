...
final readonly class ApplicationJson
{
    ...
    public string|null $commitId, public string|null $path, public int|null $position, public string|null $side, public int|null $line, #[MapFrom('start_line')]
