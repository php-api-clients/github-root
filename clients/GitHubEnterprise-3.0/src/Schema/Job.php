...
final readonly class Job
{
     ...
     */
    public function __construct(public int $id, #[\EventSauce\ObjectHydrator\MapFrom('run_id')] public int $runId, #[\EventSauce\ObjectHydrator\MapFrom('run_url')] public string $runUrl, #[\EventSauce\ObjectHydrator\MapFrom('run_attempt')] public ?int $runAttempt, #[\EventSauce\ObjectHydrator\MapFrom('node_id')] public string $nodeId, #[\EventSauce\ObjectHydrator\MapFrom('head_sha')] public string $headSha, public string $url, #[\EventSauce\ObjectHydrator\MapFrom('html_url')] public ?string $htmlUrl, public string $status, public ?string $conclusion, #[\EventSauce\ObjectHydrator\MapFrom('started_at')] public string $startedAt, #[\EventSauce\ObjectHydrator\MapFrom('completed_at')] public ?string $completedAt, public string $name, #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\Job\Steps::class)] public ?array $steps, #[\EventSauce\ObjectHydrator\MapFrom('check_run_url')] public string $checkRunUrl)
    {
    }
}
