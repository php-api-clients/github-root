...
final readonly class ApplicationGrant
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"id":1,"url":"https:\\/\\/api.github.com\\/applications\\/grants\\/1","app":{"client_id":"generated_client_id","name":"generated_name","url":"generated_url"},"created_at":"2011-09-06T17:26:27Z","updated_at":"2011-09-06T20:39:23Z","scopes":["public_repo"],"user":"generated_user"}';
    public ?int $id;
    public ?string $url;
    ...
    public ?array $scopes;
    public mixed $user;
    public function __construct(int $id, string $url, Schema\Authorization\App $app, string $created_at, string $updated_at, array $scopes, mixed $user)
    {
        $this->id = $id;
        $this->url = $url;
        $this->app = $app;
