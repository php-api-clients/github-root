...
final readonly class IssueSearchResultItem
{
    ...
    public string|null $activeLockReason, public array|null $assignees, public Schema\SimpleUser|null $user, public array $labels, public string $state, public Schema\SimpleUser|null $assignee, public Schema\Milestone|null $milestone, public int $comments, #[MapFrom('created_at')]
