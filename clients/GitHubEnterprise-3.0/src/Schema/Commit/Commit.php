...
final readonly class Commit
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"url":"https:\\/\\/api.github.com\\/repos\\/octocat\\/Hello-World\\/commits\\/6dcb09b5b57875f334f61aebed695e2e4193db5e","author":"generated_author","committer":"generated_committer","message":"Fix all the bugs","comment_count":0,"tree":{"sha":"827efc6d56897b048c772eb4087f854f46256132","url":"https:\\/\\/api.github.com\\/repos\\/octocat\\/Hello-World\\/tree\\/827efc6d56897b048c772eb4087f854f46256132"},"verification":{"verified":false,"reason":"generated_reason","payload":"generated_payload","signature":"generated_signature"}}';
    public ?string $url;
    public mixed $author;
    ...
    public function __construct(string $url, mixed $author, mixed $committer, string $message, int $comment_count, Schema\Commit\Commit\Tree $tree, Schema\Verification $verification)
    {
        $this->url = $url;
        $this->author = $author;
