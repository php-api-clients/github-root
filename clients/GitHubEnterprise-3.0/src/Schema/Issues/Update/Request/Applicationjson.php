...
final readonly class Applicationjson
{
     ...
     * @param ?array<\ApiClients\Client\GitHubEnterprise\Schema\Issues\Create\Request\Applicationjson\Labels> $labels
     ...
     */
    public function __construct(public ?int $title, public ?string $body, public ?string $assignee, public ?string $state, public ?int $milestone, #[\EventSauce\ObjectHydrator\PropertyCasters\CastListToType(Schema\Issues\Create\Request\Applicationjson\Labels::class)] public ?array $labels, public ?array $assignees)
    {
    }
}
