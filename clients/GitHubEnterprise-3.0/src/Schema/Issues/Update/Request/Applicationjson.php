...
final readonly class Applicationjson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"title":"generated_title","body":"generated_body","assignee":"generated_assignee","state":"generated_state","milestone":"generated_milestone","labels":[null],"assignees":[null]}';
    /**
    ...
    public function __construct(mixed $title, string $body, string $assignee, string $state, mixed $milestone, array $labels, array $assignees)
    {
        $this->title = $title;
        $this->body = $body;
