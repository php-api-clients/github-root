...
final class Operators
{
    ...
    public function apps👷CreateFromManifest(): Operator\Apps\CreateFromManifest
    {
        if ($this->apps👷CreateFromManifest instanceof Operator\Apps\CreateFromManifest === false) {
            $this->apps👷CreateFromManifest = new Operator\Apps\CreateFromManifest($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀AppManifests🌀Code🌀Conversions());
        }
    ...
    public function orgs👷ConvertMemberToOutsideCollaborator(): Operator\Orgs\ConvertMemberToOutsideCollaborator
    {
        if ($this->orgs👷ConvertMemberToOutsideCollaborator instanceof Operator\Orgs\ConvertMemberToOutsideCollaborator === false) {
            $this->orgs👷ConvertMemberToOutsideCollaborator = new Operator\Orgs\ConvertMemberToOutsideCollaborator($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀OutsideCollaborators🌀Username());
        }
    ...
    public function actions👷DownloadArtifact(): Operator\Actions\DownloadArtifact
    {
        if ($this->actions👷DownloadArtifact instanceof Operator\Actions\DownloadArtifact === false) {
            $this->actions👷DownloadArtifact = new Operator\Actions\DownloadArtifact($this->browser, $this->authentication);
        }
    ...
    public function actions👷DownloadArtifactStreaming(): Operator\Actions\DownloadArtifactStreaming
    {
        if ($this->actions👷DownloadArtifactStreaming instanceof Operator\Actions\DownloadArtifactStreaming === false) {
            $this->actions👷DownloadArtifactStreaming = new Operator\Actions\DownloadArtifactStreaming($this->browser, $this->authentication);
        }
    ...
    public function actions👷ReRunWorkflow(): Operator\Actions\ReRunWorkflow
    {
        if ($this->actions👷ReRunWorkflow instanceof Operator\Actions\ReRunWorkflow === false) {
            $this->actions👷ReRunWorkflow = new Operator\Actions\ReRunWorkflow($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Actions🌀Runs🌀RunId🌀Rerun());
        }
