...
final class ListForTeamDiscussionLegacyListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Teams\TeamId\Discussions\DiscussionNumber\Reactions $hydrator, private int $teamId, private int $discussionNumber, string $content, int $perPage = 30, int $page = 1)
    {
