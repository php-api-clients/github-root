...
final class ListForTeamDiscussionInOrg
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Orgs\Org\Teams\TeamSlug\Discussions\DiscussionNumber\Reactions $hydrator, private string $org, string $teamSlug, private int $discussionNumber, string $content, int $perPage = 30, int $page = 1)
    {
