...
final class ListForCommitComment
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Repos\Owner\Repo\Comments\CommentId\Reactions $hydrator, private string $owner, private string $repo, int $commentId, string $content, int $perPage = 30, int $page = 1)
    {
