...
final class Orgs
{
    ...
    public function convertMemberToOutsideCollaborator(string $org, string $username): Json|array
    {
        return $this->operators->orgs👷ConvertMemberToOutsideCollaborator()->call($org, $username);
    }
