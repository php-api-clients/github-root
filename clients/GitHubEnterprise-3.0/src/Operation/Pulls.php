...
final class Pulls
{
    ...
    public function listRequestedReviewers(string $owner, string $repo, int $pullNumber, int $perPage, int $page): Schema\PullRequestReviewRequest
    {
        ...
        return $this->operator[Operator\Pulls\ListRequestedReviewers::class]->call($owner, $repo, $pullNumber, $perPage, $page);
    }
