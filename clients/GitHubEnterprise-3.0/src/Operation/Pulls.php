...
final class Pulls
{
    ...
    public function listRequestedReviewers(string $owner, string $repo, int $pullNumber, int $perPage, int $page): PullRequestReviewRequest|array
    {
        return $this->operators->pulls👷ListRequestedReviewers()->call($owner, $repo, $pullNumber, $perPage, $page);
    }
