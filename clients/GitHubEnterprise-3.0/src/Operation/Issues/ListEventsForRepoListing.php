...
final class ListEventsForRepoListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Repos\Owner\Repo\Issues\Events $hydrator, private string $owner, private string $repo, int $perPage = 30, int $page = 1)
    {
