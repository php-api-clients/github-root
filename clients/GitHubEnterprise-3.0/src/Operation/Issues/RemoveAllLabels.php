...
final class RemoveAllLabels
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Repos\Owner\Repo\Issues\IssueNumber\Labels $hydrator, private string $owner, private string $repo, int $issueNumber)
    {
