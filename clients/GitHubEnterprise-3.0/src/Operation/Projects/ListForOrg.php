...
final class ListForOrg
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Orgs\Org\Projects $hydrator, private string $org, string $state = 'open', int $perPage = 30, int $page = 1)
    {
        $this->state   = $state;
