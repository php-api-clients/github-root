...
final class Actions
{
    ...
    /** @return */
    public function reRunWorkflow(string $owner, string $repo, int $runId): \ApiClients\Client\GitHubEnterprise\Schema\Operations\Actions\ReRunWorkflow\Response\ApplicationJson\Created\Application\Json|array
    {
        return $this->operators->actions👷ReRunWorkflow()->call($owner, $repo, $runId);
    }
