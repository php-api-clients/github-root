...
final class Get
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Orgs\Org $hydrator, private string $org)
    {
    }
