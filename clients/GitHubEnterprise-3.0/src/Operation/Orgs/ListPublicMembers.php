...
final class ListPublicMembers
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Orgs\CbOrgRcb\PublicMembers $hydrator, string $org, int $perPage = 30, int $page = 1)
    {
        $this->org = $org;
