...
final class ListWatchersForRepoListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Repos\Owner\Repo\Subscribers $hydrator, private string $owner, private string $repo, int $perPage = 30, int $page = 1)
    {
