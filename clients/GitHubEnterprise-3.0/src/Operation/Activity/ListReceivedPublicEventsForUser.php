...
final class ListReceivedPublicEventsForUser
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Users\Username\ReceivedEvents\Public_ $hydrator, private string $username, int $perPage = 30, int $page = 1)
    {
