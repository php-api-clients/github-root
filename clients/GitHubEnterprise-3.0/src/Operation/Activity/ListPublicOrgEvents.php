...
final class ListPublicOrgEvents
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Orgs\CbOrgRcb\Events $hydrator, string $org, int $perPage = 30, int $page = 1)
    {
        $this->org                     = $org;
