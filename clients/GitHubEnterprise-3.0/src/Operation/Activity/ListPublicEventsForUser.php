...
final class ListPublicEventsForUser
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Users\CbUsernameRcb\Events\Public_ $hydrator, string $username, int $perPage = 30, int $page = 1)
    {
