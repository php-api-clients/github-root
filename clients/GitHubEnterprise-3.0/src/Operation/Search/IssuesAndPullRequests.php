...
final class IssuesAndPullRequests
{
    ...
    /**
     * @return Schema\Operation\Search\IssuesAndPullRequests\Response\Applicationjson\H200|Schema\Operation\Activity\ListPublicEvents\Response\Applicationjson\H503|Schema\ValidationError|Schema\BasicError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\Operation\Search\IssuesAndPullRequests\Response\Applicationjson\H200|Schema\Operation\Activity\ListPublicEvents\Response\Applicationjson\H503|Schema\ValidationError|Schema\BasicError
    {
