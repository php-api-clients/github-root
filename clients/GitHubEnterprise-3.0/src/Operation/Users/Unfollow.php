...
final class Unfollow
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\User\Following\Username $hydrator, private string $username)
    {
    }
