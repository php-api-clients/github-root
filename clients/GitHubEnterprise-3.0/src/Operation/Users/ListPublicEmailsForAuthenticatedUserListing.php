...
final class ListPublicEmailsForAuthenticatedUserListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\User\PublicEmails $hydrator, int $perPage = 30, int $page = 1)
    {
