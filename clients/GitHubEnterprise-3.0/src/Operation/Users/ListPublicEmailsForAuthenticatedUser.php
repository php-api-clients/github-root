...
final class ListPublicEmailsForAuthenticatedUser
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\User\PublicEmails $hydrator, int $perPage = 30, int $page = 1)
    {
    ...
    /**
     * @return Observable<Schema\Email>
     */
                    ...
                    **/
                    case 200:
                        foreach ($body as $bodyItem) {
                            $this->responseSchemaValidator->validate($bodyItem, Reader::readFromJson(Schema\Email::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                        }
