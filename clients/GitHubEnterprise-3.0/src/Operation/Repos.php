...
final class Repos
{
    ...
    public function listCollaborators(string $owner, string $repo, string $affiliation, int $perPage, int $page): Schema\Collaborator
    {
    ...
    public function listCollaboratorsListing(string $owner, string $repo, string $affiliation, int $perPage, int $page): Schema\Collaborator
    {
        ...
        return $this->operator[Operator\Repos\ListCollaboratorsListing::class]->call($owner, $repo, $affiliation, $perPage, $page);
    }
    ...
    public function compareCommits(string $owner, string $repo, string $basehead): Schema\CommitComparison
    {
        ...
        return $this->operator[Operator\Repos\CompareCommits::class]->call($owner, $repo, $basehead);
    }
    ...
    public function getCommitActivityStats(string $owner, string $repo): Schema\CommitActivity|Schema\Operations\Repos\GetCodeFrequencyStats\Response\ApplicationJson\Accepted
    {
    ...
    public function getContributorsStats(string $owner, string $repo): Schema\ContributorActivity|Schema\Operations\Repos\GetCodeFrequencyStats\Response\ApplicationJson\Accepted
    {
