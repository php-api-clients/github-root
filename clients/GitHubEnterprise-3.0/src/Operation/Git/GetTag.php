...
final class GetTag
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Repos\Owner\Repo\Git\Tags\TagSha $hydrator, private string $owner, private string $repo, private string $tagSha)
    {
    }
