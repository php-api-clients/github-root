...
final class ListMatchingRefsListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Repos\Owner\Repo\Git\MatchingRefs\Ref $hydrator, private string $owner, private string $repo, string $ref, int $perPage = 30, int $page = 1)
    {
        $this->ref     = $ref;
