...
final class GetCommitComment
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Repos\Owner\Repo\Comments\CommentId $hydrator, private string $owner, private string $repo, int $commentId)
    {
