...
final class ListDeployKeysListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Repos\Owner\Repo\Keys $hydrator, private string $owner, private string $repo, int $perPage = 30, int $page = 1)
    {
