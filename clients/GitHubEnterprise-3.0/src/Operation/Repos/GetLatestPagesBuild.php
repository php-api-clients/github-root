...
final class GetLatestPagesBuild
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Repos\Owner\Repo\Pages\Builds\Latest $hydrator, private string $owner, private string $repo)
    {
    }
