...
final class GetCommit
{
    ...
    /**
     * @return Schema\Commit|Schema\ValidationError|Schema\BasicError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\Commit|Schema\ValidationError|Schema\BasicError
    {
