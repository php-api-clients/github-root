...
final class PingWebhook
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Repos\Owner\Repo\Hooks\HookId\Pings $hydrator, private string $owner, private string $repo, private int $hookId)
    {
    }
