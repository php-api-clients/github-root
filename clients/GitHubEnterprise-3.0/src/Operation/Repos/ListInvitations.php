...
final class ListInvitations
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Repos\Owner\Repo\Invitations $hydrator, private string $owner, private string $repo, int $perPage = 30, int $page = 1)
    {
