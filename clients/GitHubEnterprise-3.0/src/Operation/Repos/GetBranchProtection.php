...
final class GetBranchProtection
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Repos\Owner\Repo\Branches\Branch\Protection $hydrator, private string $owner, private string $repo, string $branch)
    {
        $this->branch = $branch;
    }
