...
final class ReplaceAllTopics
{
    ...
    /**
     * @return Schema\Topic|Schema\BasicError|Schema\ValidationErrorSimple|Schema\Operation\Apps\GetInstallation\Response\Applicationjson\H415
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\Topic|Schema\BasicError|Schema\ValidationErrorSimple|Schema\Operation\Apps\GetInstallation\Response\Applicationjson\H415
    {
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return $this->hydrator->hydrateObject('Schema\\Topic', $body);
                }
                break;
            /**Preview header missing**/
            case 404:
