...
final class GetLatestRelease
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Repos\Owner\Repo\Releases\Latest $hydrator, private string $owner, private string $repo)
    {
    }
