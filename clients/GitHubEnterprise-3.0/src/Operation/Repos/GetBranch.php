...
final class GetBranch
{
    ...
    /**
     * @return Schema\BranchWithProtection|Schema\BasicError|Schema\Operation\Apps\GetInstallation\Response\Applicationjson\H415
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\BranchWithProtection|Schema\BasicError|Schema\Operation\Apps\GetInstallation\Response\Applicationjson\H415
    {
