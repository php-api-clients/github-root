...
final class ListAuthorizations
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Authorizations $hydrator, string $clientId, int $perPage = 30, int $page = 1)
    {
