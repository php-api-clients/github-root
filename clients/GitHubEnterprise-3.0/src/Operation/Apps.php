...
final class Apps
{
    ...
    public function createFromManifest(string $code, array $params): PromiseInterface
    {
    ...
    public function revokeGrantForApplication(string $clientId, string $accessToken): PromiseInterface
    {
    ...
    public function checkAuthorization(string $clientId, string $accessToken): PromiseInterface
    {
    ...
    public function revokeAuthorizationForApplication(string $clientId, string $accessToken): PromiseInterface
    {
    ...
    public function createContentAttachment(string $owner, string $repo, int $contentReferenceId, array $params): PromiseInterface
    {
