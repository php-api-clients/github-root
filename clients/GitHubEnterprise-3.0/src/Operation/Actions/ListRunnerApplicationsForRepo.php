...
final class ListRunnerApplicationsForRepo
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Repos\Owner\Repo\Actions\Runners\Downloads $hydrator, private string $owner, private string $repo)
    {
    }
