...
final class DeleteWorkflowRunLogs
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Repos\Owner\Repo\Actions\Runs\RunId\Logs $hydrator, private string $owner, private string $repo, int $runId)
    {
        $this->runId = $runId;
    }
