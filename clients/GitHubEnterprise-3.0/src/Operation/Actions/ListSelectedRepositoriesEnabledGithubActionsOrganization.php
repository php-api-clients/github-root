...
final class ListSelectedRepositoriesEnabledGithubActionsOrganization
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Orgs\Org\Actions\Permissions\Repositories $hydrator, private string $org, int $perPage = 30, int $page = 1)
    {
