...
final class GetMembershipForUserInOrg
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Orgs\Org\Teams\TeamSlug\Memberships\Username $hydrator, private string $org, string $teamSlug, private string $username)
    {
