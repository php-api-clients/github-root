...
final class RemoveProjectLegacy
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Teams\TeamId\Projects\ProjectId $hydrator, private int $teamId, private int $projectId)
    {
    }
