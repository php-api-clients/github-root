...
final class ListDiscussionsLegacyListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Teams\TeamId\Discussions $hydrator, private int $teamId, string $direction = 'desc', int $perPage = 30, int $page = 1)
    {
