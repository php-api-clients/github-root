...
final class ListProjectsInOrgListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Orgs\Org\Teams\TeamSlug\Projects $hydrator, private string $org, string $teamSlug, int $perPage = 30, int $page = 1)
    {
