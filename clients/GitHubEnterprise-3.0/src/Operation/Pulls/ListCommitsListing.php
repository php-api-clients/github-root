...
final class ListCommitsListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Repos\Owner\Repo\Pulls\PullNumber\Commits $hydrator, private string $owner, private string $repo, private int $pullNumber, int $perPage = 30, int $page = 1)
    {
