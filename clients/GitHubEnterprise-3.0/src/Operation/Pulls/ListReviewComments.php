...
final class ListReviewComments
{
    ...
    public function __construct(private string $owner, private string $repo, private int $pullNumber, string $direction, string $since, string $sort = 'created', int $perPage = 30, int $page = 1)
    {
