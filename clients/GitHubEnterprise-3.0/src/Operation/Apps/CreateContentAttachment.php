...
final class CreateContentAttachment
{
    ...
    /**
     * @return Schema\ContentReferenceAttachment|Schema\ValidationError|Schema\BasicError|Schema\Operation\Apps\GetInstallation\Response\Applicationjson\H415
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\ContentReferenceAttachment|Schema\ValidationError|Schema\BasicError|Schema\Operation\Apps\GetInstallation\Response\Applicationjson\H415
    {
