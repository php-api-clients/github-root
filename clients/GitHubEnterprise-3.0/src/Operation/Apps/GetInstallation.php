...
final class GetInstallation
{
    ...
    /**
     * @return Schema\Installation|Schema\BasicError|Schema\Operation\Apps\GetInstallation\Response\Applicationjson\H415
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\Installation|Schema\BasicError|Schema\Operation\Apps\GetInstallation\Response\Applicationjson\H415
    {
