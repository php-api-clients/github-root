...
final class Issues
{
    ...
    public function listLabelsOnIssue(string $owner, string $repo, int $issueNumber, int $perPage, int $page): Schema\Label
    {
    ...
    public function listLabelsOnIssueListing(string $owner, string $repo, int $issueNumber, int $perPage, int $page): Schema\Label
    {
    ...
    public function setLabels(string $owner, string $repo, int $issueNumber, array $params): Schema\Label
    {
    ...
    public function addLabels(string $owner, string $repo, int $issueNumber, array $params): Schema\Label
    {
    ...
    public function removeAllLabels(string $owner, string $repo, int $issueNumber): ResponseInterface
    {
    ...
    public function removeLabel(string $owner, string $repo, int $issueNumber, string $name): Schema\Label
    {
