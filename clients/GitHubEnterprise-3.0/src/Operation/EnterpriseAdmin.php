...
final class EnterpriseAdmin
{
    ...
    public function listGlobalWebhooks(string $accept, int $perPage, int $page): PromiseInterface
    {
        ...
        return $this->operator[Operator\EnterpriseAdmin\ListGlobalWebhooks::class]->call($accept, $perPage, $page);
    }

    public function createGlobalWebhook(string $accept, array $params): PromiseInterface
    {
    ...
    public function getGlobalWebhook(int $hookId, string $accept): PromiseInterface
    {
    ...
    public function deleteGlobalWebhook(int $hookId, string $accept): PromiseInterface
    {
        ...
        return $this->operator[Operator\EnterpriseAdmin\DeleteGlobalWebhook::class]->call($hookId, $accept);
    }

    public function updateGlobalWebhook(int $hookId, string $accept, array $params): PromiseInterface
    {
    ...
    public function pingGlobalWebhook(int $hookId, string $accept): PromiseInterface
    {
        ...
        return $this->operator[Operator\EnterpriseAdmin\PingGlobalWebhook::class]->call($hookId, $accept);
    }
