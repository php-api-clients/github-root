...
final class Apps
{
    ...
    public function revokeGrantForApplication(array $params): array
    {
        ...
        $operator = new Operator\Apps\RevokeGrantForApplication($this->browser, $this->authentication);
    ...
    public function revokeAuthorizationForApplication(array $params): array
    {
        ...
        $arguments['access_token'] = $params['access_token'];
        unset($params['access_token']);
        $operator = new Operator\Apps\RevokeAuthorizationForApplication($this->browser, $this->authentication);
