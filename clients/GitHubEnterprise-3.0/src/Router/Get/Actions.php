...
use ApiClients\Client\GitHubEnterprise\Schema\Operation\Actions\ListSelectedRepositoriesEnabledGithubActionsOrganization\Response\Applicationjson\H200;
...
final class Actions
{
    ...
    public function downloadArtifact(array $params)
    {
        ...
        $operation = new Operation\Actions\DownloadArtifact($arguments['owner'], $arguments['repo'], $arguments['artifact_id'], $arguments['archive_format']);
        $request   = $operation->createRequest($params);
    ...
    public function downloadArtifactStreaming(array $params)
    {
        ...
        $arguments['archive_format'] = $params['archive_format'];
        unset($params['archive_format']);
        $operation = new Operation\Actions\DownloadArtifactStreaming($this->browser, $arguments['owner'], $arguments['repo'], $arguments['artifact_id'], $arguments['archive_format']);
        $request   = $operation->createRequest($params);
