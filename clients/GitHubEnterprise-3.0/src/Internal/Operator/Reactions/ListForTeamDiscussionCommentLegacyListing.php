...
final readonly class ListForTeamDiscussionCommentLegacyListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Reactions\ListForTeamDiscussionCommentLegacyListing($this->responseSchemaValidator, $this->hydrator, $teamId, $discussionNumber, $commentNumber, $content, $perPage, $page);
