...
final readonly class Create
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Teams\Create($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $org);
