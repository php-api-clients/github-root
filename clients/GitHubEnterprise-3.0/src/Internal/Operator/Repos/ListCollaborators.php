...
final readonly class ListCollaborators
{
    ...
    public function call(string $owner, string $repo, string $affiliation = 'all', int $perPage = 30, int $page = 1): iterable
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Repos\ListCollaborators($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $affiliation, $perPage, $page);
