...
final readonly class DeleteBranchProtection
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Repos\DeleteBranchProtection($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $branch);
