...
final class Operators
{
    ...
    private Internal\Operator\Git\ListMatchingRefsListing|null $git👷ListMatchingRefsListing                                                                                         = null;
    ...
    public function apps👷CreateFromManifest(): Internal\Operator\Apps\CreateFromManifest
    {
        if ($this->apps👷CreateFromManifest instanceof Internal\Operator\Apps\CreateFromManifest === false) {
            $this->apps👷CreateFromManifest = new Internal\Operator\Apps\CreateFromManifest($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀AppManifests🌀Code🌀Conversions());
        }
    ...
    public function orgs👷ConvertMemberToOutsideCollaborator(): Internal\Operator\Orgs\ConvertMemberToOutsideCollaborator
    {
        if ($this->orgs👷ConvertMemberToOutsideCollaborator instanceof Internal\Operator\Orgs\ConvertMemberToOutsideCollaborator === false) {
            $this->orgs👷ConvertMemberToOutsideCollaborator = new Internal\Operator\Orgs\ConvertMemberToOutsideCollaborator($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀OutsideCollaborators🌀Username());
        }
    ...
    public function actions👷DownloadArtifact(): Internal\Operator\Actions\DownloadArtifact
    {
        if ($this->actions👷DownloadArtifact instanceof Internal\Operator\Actions\DownloadArtifact === false) {
            $this->actions👷DownloadArtifact = new Internal\Operator\Actions\DownloadArtifact($this->browser, $this->authentication);
        }
    ...
    public function actions👷DownloadArtifactStreaming(): Internal\Operator\Actions\DownloadArtifactStreaming
    {
        if ($this->actions👷DownloadArtifactStreaming instanceof Internal\Operator\Actions\DownloadArtifactStreaming === false) {
            $this->actions👷DownloadArtifactStreaming = new Internal\Operator\Actions\DownloadArtifactStreaming($this->browser, $this->authentication);
        }
    ...
    public function actions👷ReRunWorkflow(): Internal\Operator\Actions\ReRunWorkflow
    {
        if ($this->actions👷ReRunWorkflow instanceof Internal\Operator\Actions\ReRunWorkflow === false) {
            $this->actions👷ReRunWorkflow = new Internal\Operator\Actions\ReRunWorkflow($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Actions🌀Runs🌀RunId🌀Rerun());
        }
    ...
    public function git👷ListMatchingRefsListing(): Internal\Operator\Git\ListMatchingRefsListing
    {
        if ($this->git👷ListMatchingRefsListing instanceof Internal\Operator\Git\ListMatchingRefsListing === false) {
            $this->git👷ListMatchingRefsListing = new Internal\Operator\Git\ListMatchingRefsListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Git🌀MatchingRefs🌀Ref());
        }
