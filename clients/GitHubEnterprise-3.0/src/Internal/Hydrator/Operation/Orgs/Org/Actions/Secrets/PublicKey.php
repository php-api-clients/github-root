...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Orgs\Org\Actions\Secrets;
...
class PublicKey implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️ActionsPublicKey(array $payload): ActionsPublicKey
    {
        $properties    = [];
        $missingFields = [];
        try {
