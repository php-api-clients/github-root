...
use ApiClients\Client\GitHubEnterprise\Schema\PagesHttpsCertificate;
use ApiClients\Client\GitHubEnterprise\Schema\PagesSourceHash;
...
class Pages implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Page(array $payload): Page
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️PagesSourceHash(array $payload): PagesSourceHash
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️PagesHttpsCertificate(array $payload): PagesHttpsCertificate
    {
        $properties    = [];
        $missingFields = [];
        try {
