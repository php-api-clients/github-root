...
final class Four
{
    ...
    /** @return Schema\GlobalHook|Schema\PreReceiveEnvironment|Schema\PreReceiveHook|Schema\WebhookConfig|Schema\Installation|Schema\ApplicationGrant|WithoutBody|Schema\LicenseInfo|Schema\EnterpriseOverview|Schema\EnterpriseCommentOverview|Schema\EnterpriseGistOverview|Schema\EnterpriseHookOverview|Schema\EnterpriseIssueOverview|Schema\EnterpriseMilestoneOverview|Schema\EnterpriseOrganizationOverview|Schema\EnterprisePageOverview|Schema\EnterprisePullRequestOverview|Schema\EnterpriseRepositoryOverview|Schema\EnterpriseUserOverview|iterable<int,Schema\GistComment>|iterable<int,Schema\GistCommit>|iterable<int,Schema\GistSimple>|Schema\GistSimple|Schema\GitignoreTemplate|Schema\Thread|iterable<int,Schema\Event>|iterable<int,Schema\OrgHook>|Schema\Operations\Orgs\ListAppInstallations\Response\ApplicationJson\Ok|iterable<int,Schema\Issue>|iterable<int,Schema\SimpleUser>|iterable<int,Schema\OrgPreReceiveHook>|iterable<int,Schema\Project>|iterable<int,Schema\MinimalRepository>|iterable<int,Schema\Team>|Schema\ProjectColumn|iterable<int,Schema\ProjectColumn>|Schema\FullRepository|Schema\BasicError|Schema\ConfigurationStatus|Schema\MaintenanceStatus|Schema\EnterpriseSettings|iterable<int,Schema\TeamDiscussion>|iterable<int,Schema\TeamProject>|Schema\GpgKey|Schema\Key|iterable<int,Schema\OrgMembership>|iterable<int,Schema\BaseGist>|iterable<int,Schema\GpgKey>|Schema\Hovercard|iterable<int,Schema\KeySimple>|iterable<int,Schema\OrganizationSimple>|Schema\StarredRepository|Schema\Repository */
    public function call(string $call, array $params, array $pathChunks): GlobalHook|PreReceiveEnvironment|PreReceiveHook|WebhookConfig|Installation|ApplicationGrant|WithoutBody|LicenseInfo|EnterpriseOverview|EnterpriseCommentOverview|EnterpriseGistOverview|EnterpriseHookOverview|EnterpriseIssueOverview|EnterpriseMilestoneOverview|EnterpriseOrganizationOverview|EnterprisePageOverview|EnterprisePullRequestOverview|EnterpriseRepositoryOverview|EnterpriseUserOverview|iterable|GistSimple|GitignoreTemplate|Thread|Ok|ProjectColumn|FullRepository|BasicError|ConfigurationStatus|MaintenanceStatus|EnterpriseSettings|GpgKey|Key|Hovercard|StarredRepository|Repository
    {
        if ($pathChunks[0] === '') {
