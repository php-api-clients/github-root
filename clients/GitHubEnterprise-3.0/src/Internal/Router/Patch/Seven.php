...
final class Seven
{
    ...
    /** @return Schema\TeamDiscussion|Schema\CodeScanningAlert|Schema\GitRef|Schema\WebhookConfig|Schema\IssueComment|Schema\PullRequestReviewComment|Schema\ReleaseAsset|Schema\TeamDiscussionComment */
