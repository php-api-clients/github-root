...
final class Actions
{
    ...
    public function reRunWorkflow(array $params): \ApiClients\Client\GitHubEnterprise\Schema\Operations\Actions\ReRunWorkflow\Response\ApplicationJson\Created\Application\Json
    {
        ...
        $arguments['run_id'] = $params['run_id'];
        unset($params['run_id']);
        $operator = new Internal\Operator\Actions\ReRunWorkflow($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Actions🌀Runs🌀RunId🌀Rerun());
