...
final class Nine
{
    ...
    /** @return iterable<string>|iterable<Schema\Integration>|iterable<Schema\Team>|iterable<Schema\SimpleUser>|Schema\PullRequestReviewComment|Schema\PullRequestReview */
