...
final class ListPublicEventsForUserListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Users\Username\Events\Public_ $hydrator, private string $username, int $perPage = 30, int $page = 1)
    {
