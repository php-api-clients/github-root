...
final class ListOrgEventsForAuthenticatedUserListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Users\Username\Events\Orgs\Org $hydrator, private string $username, private string $org, int $perPage = 30, int $page = 1)
    {
