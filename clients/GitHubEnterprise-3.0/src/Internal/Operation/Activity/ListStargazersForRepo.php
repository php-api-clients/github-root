...
final class ListStargazersForRepo
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Stargazers $hydrator, private string $owner, private string $repo, int $perPage = 30, int $page = 1)
    {
