...
final class ListReposWatchedByUser
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Users\Username\Subscriptions $hydrator, private string $username, int $perPage = 30, int $page = 1)
    {
