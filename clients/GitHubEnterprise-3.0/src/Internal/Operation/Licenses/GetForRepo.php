...
namespace ApiClients\Client\GitHubEnterprise\Internal\Operation\Licenses;
...
final class GetForRepo
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\License $hydrator, private string $owner, private string $repo)
    {
    }
