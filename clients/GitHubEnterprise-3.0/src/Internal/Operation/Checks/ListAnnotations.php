...
final class ListAnnotations
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\CheckRuns\CheckRunId\Annotations $hydrator, private string $owner, private string $repo, int $checkRunId, int $perPage = 30, int $page = 1)
    {
