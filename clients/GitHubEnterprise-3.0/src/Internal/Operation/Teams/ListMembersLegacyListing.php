...
final class ListMembersLegacyListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Teams\TeamId\Members $hydrator, private int $teamId, string $role = 'all', int $perPage = 30, int $page = 1)
    {
        $this->role    = $role;
