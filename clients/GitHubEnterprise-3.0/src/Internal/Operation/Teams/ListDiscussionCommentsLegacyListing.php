...
final class ListDiscussionCommentsLegacyListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Teams\TeamId\Discussions\DiscussionNumber\Comments $hydrator, private int $teamId, private int $discussionNumber, string $direction = 'desc', int $perPage = 30, int $page = 1)
    {
