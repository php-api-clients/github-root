...
final class GetRepoInstallation
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Installation $hydrator, private string $owner, private string $repo)
    {
    }
