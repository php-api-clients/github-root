...
final class GetCommit
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Git\Commits\CommitSha $hydrator, private string $owner, private string $repo, string $commitSha)
    {
