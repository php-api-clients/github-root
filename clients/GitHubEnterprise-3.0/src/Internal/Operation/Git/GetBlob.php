...
final class GetBlob
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Git\Blobs\FileSha $hydrator, private string $owner, private string $repo, private string $fileSha)
    {
    }
