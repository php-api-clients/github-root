...
final class ListPreReceiveHooksForRepoListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\PreReceiveHooks $hydrator, private string $owner, private string $repo, int $perPage = 30, int $page = 1, string $direction = 'desc', private string $sort = 'created')
    {
