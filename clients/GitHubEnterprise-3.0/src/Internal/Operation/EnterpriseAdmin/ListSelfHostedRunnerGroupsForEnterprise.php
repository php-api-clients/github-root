...
final class ListSelfHostedRunnerGroupsForEnterprise
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Enterprises\Enterprise\Actions\RunnerGroups $hydrator, string $enterprise, int $perPage = 30, int $page = 1)
    {
    ...
    {
        return new Request('GET', str_replace(['{enterprise}', '{per_page}', '{page}'], [$this->enterprise, $this->perPage, $this->page], '/enterprises/{enterprise}/actions/runner-groups' . '?per_page={per_page}&page={page}'));
    }
