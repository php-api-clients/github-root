...
final class ListCommentsForReviewListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Pulls\PullNumber\Reviews\ReviewId\Comments $hydrator, private string $owner, private string $repo, private int $pullNumber, int $reviewId, int $perPage = 30, int $page = 1)
    {
