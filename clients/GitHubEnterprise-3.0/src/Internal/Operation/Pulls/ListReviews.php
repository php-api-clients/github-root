...
final class ListReviews
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Pulls\PullNumber\Reviews $hydrator, private string $owner, private string $repo, private int $pullNumber, int $perPage = 30, int $page = 1)
    {
