...
final class ReRunWorkflow
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Actions\Runs\RunId\Rerun $hydrator, private string $owner, private string $repo, int $runId)
    {
        $this->runId = $runId;
    }
    ...
    {
        return new Request('POST', str_replace(['{owner}', '{repo}', '{run_id}'], [$this->owner, $this->repo, $this->runId], '/repos/{owner}/{repo}/actions/runs/{run_id}/rerun'));
    }
