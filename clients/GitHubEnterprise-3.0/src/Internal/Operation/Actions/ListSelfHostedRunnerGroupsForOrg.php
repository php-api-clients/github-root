...
final class ListSelfHostedRunnerGroupsForOrg
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Orgs\Org\Actions\RunnerGroups $hydrator, private string $org, int $perPage = 30, int $page = 1)
    {
