...
final class ListSelfHostedRunnersForOrg
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Orgs\Org\Actions\Runners $hydrator, private string $org, int $perPage = 30, int $page = 1)
    {
