...
final class CheckUserCanBeAssigned
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Assignees\Assignee $hydrator, private string $owner, private string $repo, private string $assignee)
    {
    }
