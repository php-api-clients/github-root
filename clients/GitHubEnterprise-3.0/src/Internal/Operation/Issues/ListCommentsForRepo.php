...
final class ListCommentsForRepo
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Issues\Comments $hydrator, private string $owner, private string $repo, string $direction, string $since, string $sort = 'created', int $perPage = 30, int $page = 1)
    {
