...
final class ListComments
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Issues\IssueNumber\Comments $hydrator, private string $owner, private string $repo, int $issueNumber, string $since, int $perPage = 30, int $page = 1)
    {
