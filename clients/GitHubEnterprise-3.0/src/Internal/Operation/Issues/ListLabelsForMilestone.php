...
final class ListLabelsForMilestone
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Milestones\MilestoneNumber\Labels $hydrator, private string $owner, private string $repo, int $milestoneNumber, int $perPage = 30, int $page = 1)
    {
