...
final class GetLabel
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Labels\Name $hydrator, private string $owner, private string $repo, private string $name)
    {
    }
