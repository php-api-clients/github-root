...
final class ListLabelsOnIssueListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Issues\IssueNumber\Labels $hydrator, private string $owner, private string $repo, int $issueNumber, int $perPage = 30, int $page = 1)
    {
