...
final class ListWebhooks
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Orgs\Org\Hooks $hydrator, private string $org, int $perPage = 30, int $page = 1)
    {
