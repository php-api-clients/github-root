...
final class ListOutsideCollaborators
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Orgs\Org\OutsideCollaborators $hydrator, private string $org, string $filter = 'all', int $perPage = 30, int $page = 1)
    {
        $this->filter  = $filter;
