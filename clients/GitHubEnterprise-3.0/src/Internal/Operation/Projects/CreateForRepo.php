...
final class CreateForRepo
{
    ...
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Projects $hydrator, private string $owner, private string $repo)
    {
    }
