...
final class ListColumns
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Projects\ProjectId\Columns $hydrator, private int $projectId, int $perPage = 30, int $page = 1)
    {
