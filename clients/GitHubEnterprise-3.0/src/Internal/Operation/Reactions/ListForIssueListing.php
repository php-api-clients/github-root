...
final class ListForIssueListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Issues\IssueNumber\Reactions $hydrator, private string $owner, private string $repo, int $issueNumber, string $content, int $perPage = 30, int $page = 1)
    {
