...
final class ListForIssueComment
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Issues\Comments\CommentId\Reactions $hydrator, private string $owner, private string $repo, int $commentId, string $content, int $perPage = 30, int $page = 1)
    {
