...
final class ListCollaboratorsListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Collaborators $hydrator, private string $owner, private string $repo, string $affiliation = 'all', int $perPage = 30, int $page = 1)
    {
