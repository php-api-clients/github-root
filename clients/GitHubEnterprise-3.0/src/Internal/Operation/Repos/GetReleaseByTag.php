...
final class GetReleaseByTag
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Releases\Tags\Tag $hydrator, private string $owner, private string $repo, string $tag)
    {
        $this->tag = $tag;
    }
