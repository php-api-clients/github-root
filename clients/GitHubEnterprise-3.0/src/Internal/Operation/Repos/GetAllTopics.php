...
final class GetAllTopics
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Topics $hydrator, private string $owner, private string $repo, int $page = 1, int $perPage = 30)
    {
        $this->page    = $page;
