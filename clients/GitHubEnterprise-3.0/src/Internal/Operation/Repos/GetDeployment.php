...
final class GetDeployment
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Deployments\DeploymentId $hydrator, private string $owner, private string $repo, int $deploymentId)
    {
