...
final class ListCommentsForCommitListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Commits\CommitSha\Comments $hydrator, private string $owner, private string $repo, string $commitSha, int $perPage = 30, int $page = 1)
    {
