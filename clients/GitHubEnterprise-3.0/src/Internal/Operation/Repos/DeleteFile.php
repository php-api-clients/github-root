...
final class DeleteFile
{
    ...
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Contents\Path $hydrator, private string $owner, private string $repo, string $path)
    {
        $this->path = $path;
    }
