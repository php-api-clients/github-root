...
final class ListContributorsListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Contributors $hydrator, private string $owner, private string $repo, string $anon, int $perPage = 30, int $page = 1)
    {
        $this->anon    = $anon;
