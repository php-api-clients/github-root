...
final class ListDeploymentStatusesListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Deployments\DeploymentId\Statuses $hydrator, private string $owner, private string $repo, int $deploymentId, int $perPage = 30, int $page = 1)
    {
