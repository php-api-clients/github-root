...
final class ListReleaseAssets
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Releases\ReleaseId\Assets $hydrator, private string $owner, private string $repo, int $releaseId, int $perPage = 30, int $page = 1)
    {
