...
final class ListBranchesForHeadCommit
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Commits\CommitSha\BranchesWhereHead $hydrator, private string $owner, private string $repo, string $commitSha)
    {
