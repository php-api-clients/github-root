...
final class GetDeploymentStatus
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Deployments\DeploymentId\Statuses\StatusId $hydrator, private string $owner, private string $repo, int $deploymentId, private int $statusId)
    {
