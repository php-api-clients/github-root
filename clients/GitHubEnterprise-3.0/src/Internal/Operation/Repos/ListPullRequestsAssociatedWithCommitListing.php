...
final class ListPullRequestsAssociatedWithCommitListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Commits\CommitSha\Pulls $hydrator, private string $owner, private string $repo, string $commitSha, int $perPage = 30, int $page = 1)
    {
