...
final class ListCommitsListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Commits $hydrator, private string $owner, private string $repo, string $sha, string $path, string $author, string $since, string $until, int $perPage = 30, int $page = 1)
    {
        $this->sha     = $sha;
        $this->path    = $path;
        $this->author  = $author;
