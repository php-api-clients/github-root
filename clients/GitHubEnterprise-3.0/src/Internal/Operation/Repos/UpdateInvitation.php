...
final class UpdateInvitation
{
    ...
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Invitations\InvitationId $hydrator, private string $owner, private string $repo, int $invitationId)
    {
