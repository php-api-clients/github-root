...
final class GetContent
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Contents\Path $hydrator, private string $owner, private string $repo, string $path, string $ref)
    {
        $this->path = $path;
        $this->ref  = $ref;
    }
