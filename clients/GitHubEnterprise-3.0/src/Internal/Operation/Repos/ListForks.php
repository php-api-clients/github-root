...
final class ListForks
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Forks $hydrator, private string $owner, private string $repo, string $sort = 'newest', int $perPage = 30, int $page = 1)
    {
        $this->sort    = $sort;
