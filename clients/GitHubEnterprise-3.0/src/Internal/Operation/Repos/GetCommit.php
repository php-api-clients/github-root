...
final class GetCommit
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Commits\Ref $hydrator, private string $owner, private string $repo, string $ref, int $page = 1, int $perPage = 30)
    {
        $this->ref     = $ref;
        $this->page    = $page;
