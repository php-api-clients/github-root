...
final readonly class ListNotificationsForAuthenticatedUserListing
{
    ...
    public function call(string $since, string $before, bool $all = false, bool $participating = false, int $perPage = 30, int $page = 1): iterable
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Activity\ListNotificationsForAuthenticatedUserListing($this->responseSchemaValidator, $this->hydrator, $since, $before, $all, $participating, $perPage, $page);
