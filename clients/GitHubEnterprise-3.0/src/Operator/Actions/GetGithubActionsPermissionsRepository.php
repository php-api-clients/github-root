...
final readonly class GetGithubActionsPermissionsRepository
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Actions\GetGithubActionsPermissionsRepository($this->responseSchemaValidator, $this->hydrator, $owner, $repo);
