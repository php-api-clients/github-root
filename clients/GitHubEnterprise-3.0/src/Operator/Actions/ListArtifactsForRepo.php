...
final readonly class ListArtifactsForRepo
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Actions\ListArtifactsForRepo($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
