...
final readonly class AddTeamAccessRestrictions
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Repos\AddTeamAccessRestrictions($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $branch);
