...
final readonly class Merge
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Repos\Merge($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo);
