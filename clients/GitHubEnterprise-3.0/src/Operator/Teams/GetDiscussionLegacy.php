...
final readonly class GetDiscussionLegacy
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Teams\GetDiscussionLegacy($this->responseSchemaValidator, $this->hydrator, $teamId, $discussionNumber);
