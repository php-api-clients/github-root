...
final readonly class ListForIssueComment
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Reactions\ListForIssueComment($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $commentId, $content, $perPage, $page);
