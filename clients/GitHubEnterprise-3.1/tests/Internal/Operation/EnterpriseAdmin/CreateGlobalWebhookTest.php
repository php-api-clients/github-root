...
/** @covers \ApiClients\Client\GitHubEnterprise\Internal\Operation\EnterpriseAdmin\CreateGlobalWebhook */
final class CreateGlobalWebhookTest extends AsyncTestCase
{
    ...
    public function operations_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/admin/hooks', Argument::type('array'), json_encode(json_decode(Schema\EnterpriseAdmin\CreateGlobalWebhook\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->enterpriseAdmin()->createGlobalWebhook('generated', json_decode(Schema\EnterpriseAdmin\CreateGlobalWebhook\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
}
