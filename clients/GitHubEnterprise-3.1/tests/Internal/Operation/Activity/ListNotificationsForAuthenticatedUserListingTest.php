...
/** @covers \ApiClients\Client\GitHubEnterprise\Internal\Operation\Activity\ListNotificationsForAuthenticatedUserListing */
final class ListNotificationsForAuthenticatedUserListingTest extends AsyncTestCase
{
    ...
    public function operations_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/notifications?since=1970-01-01T00:00:00+00:00&before=1970-01-01T00:00:00+00:00&all=&participating=&per_page=8&page=1', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->activity()->listNotificationsForAuthenticatedUserListing('1970-01-01T00:00:00+00:00', '1970-01-01T00:00:00+00:00', false, false, 8, 1);
        foreach ($result as $item) {
        }
    }
