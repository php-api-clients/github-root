...
use ApiClients\Client\GitHubEnterprise\Operation\EnterpriseAdmin\EnableOrDisableMaintenanceMode;
...
final class EnableOrDisableMaintenanceModeTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_x_www_form_urlencoded_responseContentType_application_json(): void
    {
        ...
        $client->call(EnableOrDisableMaintenanceMode::OPERATION_MATCH, (static function (array $data): array {
            return $data;
