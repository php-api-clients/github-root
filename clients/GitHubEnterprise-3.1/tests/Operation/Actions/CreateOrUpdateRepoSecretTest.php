...
/** @covers \ApiClients\Client\GitHubEnterprise\Operation\Actions\CreateOrUpdateRepoSecret */
final class CreateOrUpdateRepoSecretTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        $response = new Response(201, ['Content-Type' => 'application/json'], json_encode(json_decode(Schema\Operations\Actions\CreateOrUpdateRepoSecret\Response\ApplicationJson\Created\Application\Json::SCHEMA_EXAMPLE_DATA, true)));
