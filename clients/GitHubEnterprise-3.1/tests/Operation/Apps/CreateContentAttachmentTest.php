...
final class CreateContentAttachmentTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/repos/generated/generated/content_references/20/attachments', Argument::type('array'), Schema\Apps\CreateContentAttachment\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Operation\Apps\CreateContentAttachment::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_200_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/repos/generated/generated/content_references/20/attachments', Argument::type('array'), Schema\Apps\CreateContentAttachment\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = await($client->operations()->apps()->createContentAttachment('generated', 'generated', 20, json_decode(Schema\Apps\CreateContentAttachment\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)));
    }
