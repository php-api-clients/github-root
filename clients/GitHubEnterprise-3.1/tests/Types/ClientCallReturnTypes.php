...
assertType('', $client->call('DELETE /applications/{client_id}/grants/{access_token}'));
...
assertType('', $client->call('GET /applications/{client_id}/tokens/{access_token}'));
assertType('', $client->call('POST /applications/{client_id}/tokens/{access_token}'));
assertType('', $client->call('DELETE /applications/{client_id}/tokens/{access_token}'));
...
assertType('Observable<Schema\\SimpleUser>|WithoutBody', $client->call('GET /orgs/{org}/members'));
assertType('Observable<Schema\\SimpleUser>|WithoutBody', $client->call('LIST /orgs/{org}/members'));
...
assertType('', $client->call('DELETE /reactions/{reaction_id}'));
...
assertType('Observable<Schema\\CodeScanningAlertItems>', $client->call('GET /repos/{owner}/{repo}/code-scanning/alerts'));
assertType('Observable<Schema\\CodeScanningAlertItems>', $client->call('LIST /repos/{owner}/{repo}/code-scanning/alerts'));
...
assertType('', $client->call('POST /repos/{owner}/{repo}/content_references/{content_reference_id}/attachments'));
...
assertType('Observable<Schema\\GitRef>', $client->call('LIST /repos/{owner}/{repo}/git/matching-refs/{ref}'));
...
assertType('Observable<Schema\\Label>', $client->call('GET /repos/{owner}/{repo}/issues/{issue_number}/labels'));
assertType('Observable<Schema\\Label>', $client->call('LIST /repos/{owner}/{repo}/issues/{issue_number}/labels'));
assertType('Observable<Schema\\Label>', $client->call('PUT /repos/{owner}/{repo}/issues/{issue_number}/labels'));
assertType('Observable<Schema\\Label>', $client->call('POST /repos/{owner}/{repo}/issues/{issue_number}/labels'));
assertType('', $client->call('DELETE /repos/{owner}/{repo}/issues/{issue_number}/labels'));
assertType('Observable<Schema\\Label>', $client->call('DELETE /repos/{owner}/{repo}/issues/{issue_number}/labels/{name}'));
...
assertType('Observable<int>|Schema\\Operations\\Repos\\GetCodeFrequencyStats\\Response\\ApplicationJson\\Accepted|WithoutBody', $client->call('GET /repos/{owner}/{repo}/stats/code_frequency'));
assertType('Observable<Schema\\CommitActivity>|Schema\\Operations\\Repos\\GetCodeFrequencyStats\\Response\\ApplicationJson\\Accepted|WithoutBody', $client->call('GET /repos/{owner}/{repo}/stats/commit_activity'));
assertType('Observable<Schema\\ContributorActivity>|Schema\\Operations\\Repos\\GetCodeFrequencyStats\\Response\\ApplicationJson\\Accepted|WithoutBody', $client->call('GET /repos/{owner}/{repo}/stats/contributors'));
...
assertType('Observable<Schema\\SshKey>', $client->call('GET /setup/api/settings/authorized-keys'));
assertType('Observable<Schema\\SshKey>', $client->call('POST /setup/api/settings/authorized-keys'));
assertType('Observable<Schema\\SshKey>', $client->call('DELETE /setup/api/settings/authorized-keys'));
