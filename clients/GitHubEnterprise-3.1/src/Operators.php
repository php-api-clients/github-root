...
final class Operators
{
    ...
    private Operator\Apps\RevokeGrantForApplication|null $apps👷RevokeGrantForApplication                                                                                   = null;
    ...
    private Operator\Apps\CheckAuthorization|null $apps👷CheckAuthorization                                                                                                 = null;
    private Operator\Apps\ResetAuthorization|null $apps👷ResetAuthorization                                                                                                 = null;
    private Operator\Apps\RevokeAuthorizationForApplication|null $apps👷RevokeAuthorizationForApplication                                                                   = null;
    ...
    private Operator\Reactions\DeleteLegacy|null $reactions👷DeleteLegacy                                                                                                   = null;
    ...
    private Operator\Apps\CreateContentAttachment|null $apps👷CreateContentAttachment                                                                                       = null;
    ...
    private Operator\Git\ListMatchingRefsListing|null $git👷ListMatchingRefsListing                                                                                         = null;
    ...
    public function apps👷RevokeGrantForApplication(): Operator\Apps\RevokeGrantForApplication
    {
        if ($this->apps👷RevokeGrantForApplication instanceof Operator\Apps\RevokeGrantForApplication === false) {
            $this->apps👷RevokeGrantForApplication = new Operator\Apps\RevokeGrantForApplication($this->browser, $this->authentication);
        }
    ...
    public function apps👷CheckAuthorization(): Operator\Apps\CheckAuthorization
    {
        if ($this->apps👷CheckAuthorization instanceof Operator\Apps\CheckAuthorization === false) {
            $this->apps👷CheckAuthorization = new Operator\Apps\CheckAuthorization($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Applications🌀ClientId🌀Tokens🌀AccessToken());
        }
    ...
    public function apps👷RevokeAuthorizationForApplication(): Operator\Apps\RevokeAuthorizationForApplication
    {
        if ($this->apps👷RevokeAuthorizationForApplication instanceof Operator\Apps\RevokeAuthorizationForApplication === false) {
            $this->apps👷RevokeAuthorizationForApplication = new Operator\Apps\RevokeAuthorizationForApplication($this->browser, $this->authentication);
        }
    ...
    public function reactions👷DeleteLegacy(): Operator\Reactions\DeleteLegacy
    {
        if ($this->reactions👷DeleteLegacy instanceof Operator\Reactions\DeleteLegacy === false) {
            $this->reactions👷DeleteLegacy = new Operator\Reactions\DeleteLegacy($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Reactions🌀ReactionId());
        }
    ...
    public function repos👷RemoveCollaborator(): Operator\Repos\RemoveCollaborator
    {
        if ($this->repos👷RemoveCollaborator instanceof Operator\Repos\RemoveCollaborator === false) {
            $this->repos👷RemoveCollaborator = new Operator\Repos\RemoveCollaborator($this->browser, $this->authentication);
        }
    ...
    public function apps👷CreateContentAttachment(): Operator\Apps\CreateContentAttachment
    {
        if ($this->apps👷CreateContentAttachment instanceof Operator\Apps\CreateContentAttachment === false) {
            $this->apps👷CreateContentAttachment = new Operator\Apps\CreateContentAttachment($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀ContentReferences🌀ContentReferenceId🌀Attachments());
        }
    ...
    public function git👷ListMatchingRefsListing(): Operator\Git\ListMatchingRefsListing
    {
        if ($this->git👷ListMatchingRefsListing instanceof Operator\Git\ListMatchingRefsListing === false) {
            $this->git👷ListMatchingRefsListing = new Operator\Git\ListMatchingRefsListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Git🌀MatchingRefs🌀Ref());
        }

        return $this->git👷ListMatchingRefsListing;
    }
