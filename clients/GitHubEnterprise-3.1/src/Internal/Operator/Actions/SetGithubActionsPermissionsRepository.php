...
final readonly class SetGithubActionsPermissionsRepository
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Actions\SetGithubActionsPermissionsRepository($this->requestSchemaValidator, $owner, $repo);
