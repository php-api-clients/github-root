...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Repos\Owner\Repo\Releases\Tags;
...
class Tag implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Release(array $payload): Release
    {
        $properties    = [];
        $missingFields = [];
        try {
