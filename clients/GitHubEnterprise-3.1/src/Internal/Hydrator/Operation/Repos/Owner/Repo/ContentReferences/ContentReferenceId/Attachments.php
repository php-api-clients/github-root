...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Repos\Owner\Repo\ContentReferences\ContentReferenceId;

use ApiClients\Client\GitHubEnterprise\Schema\BasicError;
use ApiClients\Client\GitHubEnterprise\Schema\ContentReferenceAttachment;
use ApiClients\Client\GitHubEnterprise\Schema\Operations\Reactions\CreateForCommitComment\Response\ApplicationJson\UnsupportedMediaType;
...
class Attachments implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️ContentReferenceAttachment(array $payload): ContentReferenceAttachment
    {
        $properties    = [];
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(ContentReferenceAttachment::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new ContentReferenceAttachment(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\ContentReferenceAttachment', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Operations⚡️Reactions⚡️CreateForCommitComment⚡️Response⚡️ApplicationJson⚡️UnsupportedMediaType(array $payload): UnsupportedMediaType
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    {
        assert($object instanceof ContentReferenceAttachment);
        $result = [];
