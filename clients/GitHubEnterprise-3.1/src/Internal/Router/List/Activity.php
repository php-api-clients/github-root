...
final class Activity
{
    ...
    public function listPublicEventsListing(array $params): iterable|WithoutBody
    {
        $arguments = [];
        if (array_key_exists('per_page', $params) === false) {
            throw new InvalidArgumentException('Missing mandatory field: per_page');
    ...
    public function listNotificationsForAuthenticatedUserListing(array $params): iterable|WithoutBody
    {
        ...
        do {
            ...
            $items    = [...$operator->call($arguments['since'], $arguments['before'], $arguments['all'], $arguments['participating'], $arguments['per_page'], $arguments['page'])];
    ...
    public function listPublicOrgEventsListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Internal\Operator\Activity\ListPublicOrgEventsListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀Events());
    ...
    public function listReceivedEventsForUserListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Internal\Operator\Activity\ListReceivedEventsForUserListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Users🌀Username🌀ReceivedEvents());
            $items    = [...$operator->call($arguments['username'], $arguments['per_page'], $arguments['page'])];
    ...
    public function listPublicEventsForRepoNetworkListing(array $params): iterable|BasicError|WithoutBody
    {
        $arguments = [];
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Internal\Operator\Activity\ListPublicEventsForRepoNetworkListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Networks🌀Owner🌀Repo🌀Events());
    ...
    public function listPublicEventsForUserListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Internal\Operator\Activity\ListPublicEventsForUserListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Users🌀Username🌀Events🌀Public_());
            $items    = [...$operator->call($arguments['username'], $arguments['per_page'], $arguments['page'])];
    ...
    public function listReceivedPublicEventsForUserListing(array $params): iterable
    {
        ...
        $arguments['page'] = 1;
        do {
            $operator = new Internal\Operator\Activity\ListReceivedPublicEventsForUserListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Users🌀Username🌀ReceivedEvents🌀Public_());
            $items    = [...$operator->call($arguments['username'], $arguments['per_page'], $arguments['page'])];
