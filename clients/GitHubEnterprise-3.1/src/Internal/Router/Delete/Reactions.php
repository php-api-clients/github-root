...
final class Reactions
{
    ...
    public function deleteLegacy(array $params): WithoutBody
    {
        ...
        $operator = new Internal\Operator\Reactions\DeleteLegacy($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Reactions🌀ReactionId());
