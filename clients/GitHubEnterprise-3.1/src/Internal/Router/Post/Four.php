...
final class Four
{
    ...
    public function call(string $call, array $params, array $pathChunks): Integration|Authorization|GistComment|WithoutBody|BaseGist|OrgHook|Project|Repository|TeamFull|ProjectColumn|MaintenanceStatus|TeamDiscussion
    {
        if ($pathChunks[0] === '') {
