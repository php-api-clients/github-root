...
final class Issues
{
    ...
    public function listLabelsOnIssue(string $owner, string $repo, int $issueNumber, int $perPage, int $page): iterable
    {
        return $this->operators->issues👷ListLabelsOnIssue()->call($owner, $repo, $issueNumber, $perPage, $page);
    }

    /** @return Observable<Schema\Label> */
    public function listLabelsOnIssueListing(string $owner, string $repo, int $issueNumber, int $perPage, int $page): iterable
    {
        return $this->operators->issues👷ListLabelsOnIssueListing()->call($owner, $repo, $issueNumber, $perPage, $page);
    }

    /** @return Observable<Schema\Label> */
    public function setLabels(string $owner, string $repo, int $issueNumber, array $params): iterable
    {
        return $this->operators->issues👷SetLabels()->call($owner, $repo, $issueNumber, $params);
    }

    /** @return Observable<Schema\Label> */
    public function addLabels(string $owner, string $repo, int $issueNumber, array $params): iterable
    {
        return $this->operators->issues👷AddLabels()->call($owner, $repo, $issueNumber, $params);
    }

    /** @return */
    public function removeAllLabels(string $owner, string $repo, int $issueNumber): WithoutBody
    {
        return $this->operators->issues👷RemoveAllLabels()->call($owner, $repo, $issueNumber);
    }

    /** @return Observable<Schema\Label> */
    public function removeLabel(string $owner, string $repo, int $issueNumber, string $name): iterable
    {
