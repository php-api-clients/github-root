            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return $this->hydrator->hydrateObject('Schema\\PullRequestMergeResult', $body);
                }
                break;
            /**Resource not found**/
            case 405:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return $this->hydrator->hydrateObject('Schema\\Operation\\Orgs\\RemoveOutsideCollaborator\\Response\\Applicationjson\\H422', $body);
                }
                break;
            /**Resource not found**/
            case 409:
