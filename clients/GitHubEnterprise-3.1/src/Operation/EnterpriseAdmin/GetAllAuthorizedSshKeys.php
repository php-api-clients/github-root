...
final class GetAllAuthorizedSshKeys
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Setup\Api\Settings\AuthorizedKeys $hydrator)
    {
    }
