...
final class ListAlertInstances
{
    ...
    /**
     * @return \Rx\Observable<Schema\CodeScanningAlertInstance>|Schema\BasicError|Schema\Operation\Activity\ListPublicEvents\Response\Applicationjson\H503
     */
                ...
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return \Rx\Observable::fromArray($body, new \Rx\Scheduler\ImmediateScheduler())->map(function (array $body) : Schema\CodeScanningAlertInstance {
                            return $this->hydrator->hydrateObject('Schema\\CodeScanningAlertInstance', $body);
                        });
                }
                break;
            /**Service unavailable**/
