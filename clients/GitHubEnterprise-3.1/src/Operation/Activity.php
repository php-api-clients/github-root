...
final class Activity
{
    ...
    public function listPublicEvents(int $perPage, int $page): PromiseInterface
    {
    ...
    public function listPublicEventsForRepoNetwork(string $owner, string $repo, int $perPage, int $page): PromiseInterface
    {
    ...
    public function listNotificationsForAuthenticatedUser(string $since, string $before, bool $all, bool $participating, int $perPage, int $page): PromiseInterface
    {
        ...
        return $this->operator[Operator\Activity\ListNotificationsForAuthenticatedUser::class]->call($since, $before, $all, $participating, $perPage, $page);
    }
    ...
    public function listPublicOrgEvents(string $org, int $perPage, int $page): PromiseInterface
    {
    ...
    public function listPublicEventsForUser(string $username, int $perPage, int $page): PromiseInterface
    {
    ...
    public function listReceivedEventsForUser(string $username, int $perPage, int $page): PromiseInterface
    {
    ...
    public function listReceivedPublicEventsForUser(string $username, int $perPage, int $page): PromiseInterface
    {
