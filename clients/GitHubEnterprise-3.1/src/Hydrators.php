...
final class Hydrators implements \EventSauce\ObjectHydrator\ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload) : object
    {
        return match ($className) {
            ...
            'ApiClients\\Client\\GitHubEnterprise\\Schema\\Team', 'ApiClients\\Client\\GitHubEnterprise\\Schema\\Team\\Permissions', 'ApiClients\\Client\\GitHubEnterprise\\Schema\\TeamFull' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀Teams()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\GitHubEnterprise\\Schema\\Deployment\\Payload', 'ApiClients\\Client\\GitHubEnterprise\\Schema\\CodeScanningAnalysisDeletion', 'ApiClients\\Client\\GitHubEnterprise\\Schema\\ScimError' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀CodeDashScanning🌀Analyses🌀CbAnalysisIdRcb()->hydrateObject($className, $payload),
    ...
    public function serializeObject(object $object) : mixed
    {
        return match ($object::class) {
            ...
            'ApiClients\\Client\\GitHubEnterprise\\Schema\\Team', 'ApiClients\\Client\\GitHubEnterprise\\Schema\\Team\\Permissions', 'ApiClients\\Client\\GitHubEnterprise\\Schema\\TeamFull' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀Teams()->serializeObject($object),
