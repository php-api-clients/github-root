...
class Pulls implements ObjectMapper
{
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\Team',
        ...
        $base = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️PullRequestSimple⚡️Head($base);
        ...
        $_links = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️PullRequestSimple⚡️Links($_links);
        ...
        $auto_merge = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️AutoMerge($auto_merge);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️PullRequestSimple⚡️Links(mixed $object): mixed
    {
        ...
        $review_comments = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Link($review_comments);
        ...
        $review_comment = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Link($review_comment);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️AutoMerge(mixed $object): mixed
    {
        ...
        $enabled_by = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️SimpleUser($enabled_by);
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\TeamSimple',
        ...
        $merged_by = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️SimpleUser($merged_by);
