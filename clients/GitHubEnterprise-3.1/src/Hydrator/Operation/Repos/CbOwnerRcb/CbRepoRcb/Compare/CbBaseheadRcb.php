...
class CbBaseheadRcb implements ObjectMapper
{
  ...
  0 => 'ApiClients\\Client\\GitHubEnterprise\\Schema\\DiffEntry',
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️CommitComparison(mixed $object): mixed
    {
        ...
        $baseCommit = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Commit($baseCommit);
        after_baseCommit:        $result['base_commit'] = $baseCommit;

        
        $mergeBaseCommit = $object->mergeBaseCommit;
        $mergeBaseCommit = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Commit($mergeBaseCommit);
