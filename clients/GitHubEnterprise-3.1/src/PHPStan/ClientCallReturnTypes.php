...
final readonly class ClientCallReturnTypes implements DynamicMethodReturnTypeExtension
{
    ...
    public function getTypeFromMethodCall(MethodReflection $methodReflection, MethodCall $methodCall, Scope $scope): Type|null
    {
        ...
        if ($call === 'GET /repos/{owner}/{repo}/code-scanning/alerts') {
            return $this->typeResolver->resolve('Observable<Schema\\CodeScanningAlertItems>');
        }
        ...
        if ($call === 'GET /repos/{owner}/{repo}/stats/code_frequency') {
            return $this->typeResolver->resolve('Observable<int>|Schema\\Operations\\Repos\\GetCodeFrequencyStats\\Response\\ApplicationJson\\Accepted|WithoutBody');
        }

        if ($call === 'GET /repos/{owner}/{repo}/stats/commit_activity') {
            return $this->typeResolver->resolve('Observable<Schema\\CommitActivity>|Schema\\Operations\\Repos\\GetCodeFrequencyStats\\Response\\ApplicationJson\\Accepted|WithoutBody');
        }

        if ($call === 'GET /repos/{owner}/{repo}/stats/contributors') {
            return $this->typeResolver->resolve('Observable<Schema\\ContributorActivity>|Schema\\Operations\\Repos\\GetCodeFrequencyStats\\Response\\ApplicationJson\\Accepted|WithoutBody');
        }
        ...
        if ($call === 'GET /setup/api/settings/authorized-keys') {
            return $this->typeResolver->resolve('Observable<Schema\\SshKey>');
        }
