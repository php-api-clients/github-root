...
final readonly class ApplicationJson
{
    ...
    "properties": {
        "config": {
            ...
            "description": "Key\\/value pairs to provide settings for this webhook. [These are defined below](https:\\/\\/docs.github.com\\/enterprise-server@3.1\\/rest\\/reference\\/orgs#update-hook-config-params)."
        },
        "events": {
            "type": "array",
            "items": {
    ...
    /**
     * config: Key/value pairs to provide settings for this webhook. [These are defined below](https://docs.github.com/enterprise-server@3.1/rest/reference/orgs#update-hook-config-params).
