...
final readonly class OrgHook
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"id":1,"url":"https:\\/\\/api.github.com\\/orgs\\/octocat\\/hooks\\/1","ping_url":"https:\\/\\/api.github.com\\/orgs\\/octocat\\/hooks\\/1\\/pings","name":"web","events":["pull_request"],"active":true,"config":{"url":"\\"http:\\/\\/example.com\\/2\\"","insecure_ssl":"\\"0\\"","content_type":"\\"form\\"","secret":"\\"********\\""},"updated_at":"2011-09-06T20:39:23Z","created_at":"2011-09-06T17:26:27Z","type":"generated_type"}';
    public ?int $id;
    public ?string $url;
    ...
    public ?array $events;
    public ?bool $active;
    public ?Schema\OrgHook\Config $config;
    public ?string $updated_at;
    public ?string $created_at;
    public ?string $type;
    public function __construct(int $id, string $url, string $ping_url, string $name, array $events, bool $active, Schema\OrgHook\Config $config, string $updated_at, string $created_at, string $type)
    {
        $this->id = $id;
        $this->url = $url;
