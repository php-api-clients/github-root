...
final readonly class OrgHook
{
     ...
     */
    public function __construct(public int $id, public string $url, #[MapFrom('ping_url')] public string $pingUrl, public string $name, public array $events, public bool $active, public Schema\OrgHook\Config $config, #[MapFrom('updated_at')] public string $updatedAt, #[MapFrom('created_at')] public string $createdAt, public string $type)
    {
    }
}
