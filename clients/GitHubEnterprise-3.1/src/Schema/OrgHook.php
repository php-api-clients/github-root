...
final readonly class OrgHook
{
     ...
     */
    public function __construct(public ?int $id, public ?string $url, public ?string $ping_url, public ?string $name, public ?array $events, public ?bool $active, public ?Schema\OrgHook\Config $config, public ?string $updated_at, public ?string $created_at, public ?string $type)
    {
    }
}
