...
final readonly class TeamFull
{
    ...
    public string $htmlUrl, public string $name, public string $slug, public string|null $description, public string|null $privacy, public string $permission, #[MapFrom('members_url')]
    ...
    public string $updatedAt, public Schema\OrganizationFull $organization, #[MapFrom('ldap_dn')]
