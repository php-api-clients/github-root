...
final readonly class Hook
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"type":"generated_type_null","id":42,"name":"web","active":true,"events":["push"],"config":{"email":"\\"foo@bar.com\\"","password":"\\"foo\\"","room":"\\"roomer\\"","subdomain":"\\"foo\\"","url":"https:\\/\\/example.com\\/webhook","insecureSsl":"generated_insecure_ssl_null","contentType":"\\"json\\"","digest":"\\"sha256\\"","secret":"\\"********\\"","token":"\\"abc\\""},"updatedAt":"2011-09-06T20:39:23Z","createdAt":"2011-09-06T17:26:27Z","url":"https:\\/\\/api.github.com\\/repos\\/octocat\\/Hello-World\\/hooks\\/1","testUrl":"https:\\/\\/api.github.com\\/repos\\/octocat\\/Hello-World\\/hooks\\/1\\/test","pingUrl":"https:\\/\\/api.github.com\\/repos\\/octocat\\/Hello-World\\/hooks\\/1\\/pings","lastResponse":{"code":13,"status":"generated_status_null","message":"generated_message_null"}}';
    /**
     ...
     */
    public function __construct(public string $type, public int $id, public string $name, public bool $active, public array $events, public Schema\Hook\Config $config, #[\EventSauce\ObjectHydrator\MapFrom('updated_at')] public string $updatedAt, #[\EventSauce\ObjectHydrator\MapFrom('created_at')] public string $createdAt, public string $url, #[\EventSauce\ObjectHydrator\MapFrom('test_url')] public string $testUrl, #[\EventSauce\ObjectHydrator\MapFrom('ping_url')] public string $pingUrl, #[\EventSauce\ObjectHydrator\MapFrom('last_response')] public Schema\HookResponse $lastResponse)
    {
    }
}
