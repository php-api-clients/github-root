...
final readonly class Hook
{
     ...
     */
    public function __construct(public string $type, public int $id, public string $name, public bool $active, public array $events, public Schema\Hook\Config $config, #[MapFrom('updated_at')] public string $updatedAt, #[MapFrom('created_at')] public string $createdAt, public string $url, #[MapFrom('test_url')] public string $testUrl, #[MapFrom('ping_url')] public string $pingUrl, #[MapFrom('last_response')] public Schema\HookResponse $lastResponse)
    {
    }
}
