...
namespace ApiClients\Client\GitHubEnterprise\Schema\AliasAbstract\Tiet55E40A24\TietE62BD74C\Tiet14BEA908;

use EventSauce\ObjectHydrator\MapFrom;

abstract readonly class Tiet9538A90B
{
     ...
     * startLine: The start line of the annotation.
     * endLine: The end line of the annotation.
     * startColumn: The start column of the annotation. Annotations only support `start_column` and `end_column` on the same line. Omit this parameter if `start_line` and `end_line` have different values.
