...
final readonly class TeamRepository
{
    ...
    public string $fullName, public Schema\LicenseSimple|null $license, public int $forks, public Schema\TeamRepository\Permissions|null $permissions, public Schema\SimpleUser|null $owner, public bool $private, #[MapFrom('html_url')]
    ...
    public bool|null $allowSquashMerge, #[MapFrom('delete_branch_on_merge')]
    public bool|null $deleteBranchOnMerge, #[MapFrom('allow_merge_commit')]
    public bool|null $allowMergeCommit, #[MapFrom('allow_forking')]
    public bool|null $allowForking, #[MapFrom('subscribers_count')]
