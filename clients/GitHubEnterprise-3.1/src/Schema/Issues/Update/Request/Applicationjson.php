...
final readonly class Applicationjson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"title":13,"body":"generated_body","assignee":"generated_assignee","state":"generated_state","milestone":13,"labels":[null],"assignees":[null]}';
    /**
