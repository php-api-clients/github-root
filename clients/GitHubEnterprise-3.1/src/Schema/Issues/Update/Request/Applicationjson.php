...
final readonly class Applicationjson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"title":"generated_title_null","body":"generated_body_null","assignee":"generated_assignee_null","state":"generated_state_null","milestone":"generated_milestone_null","labels":["generated_labels_null"],"assignees":["generated_assignees_null"]}';
    /**
     ...
     */
    public function __construct(public ?string $title, public ?string $body, public ?string $assignee, public ?string $state, public ?string $milestone, public ?array $labels, public ?array $assignees)
    {
    }
}
