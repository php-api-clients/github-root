...
final readonly class CodeScanningAlert
{
    ...
    public function __construct(int $number, string $created_at, string $url, string $html_url, string $instances_url, string $state, mixed $dismissed_by, string $dismissed_at, string $dismissed_reason, Schema\CodeScanningAlertRule $rule, Schema\CodeScanningAnalysisTool $tool, Schema\CodeScanningAlertInstance $most_recent_instance, mixed $instances)
    {
        $this->number = $number;
