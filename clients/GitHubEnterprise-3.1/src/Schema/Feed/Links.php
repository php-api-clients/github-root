...
final readonly class Links
{
    ...
    public function __construct(Schema\LinkWithType $timeline, Schema\LinkWithType $user, Schema\LinkWithType $security_advisories, Schema\LinkWithType $current_user, Schema\LinkWithType $current_user_public, Schema\LinkWithType $current_user_actor, Schema\LinkWithType $current_user_organization, array $current_user_organizations)
    {
