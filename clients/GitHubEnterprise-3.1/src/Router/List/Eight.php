...
final class Eight
{
    ...
    /** @return iterable<Schema\TeamDiscussionComment>|iterable<Schema\Reaction>|iterable<Schema\CodeScanningAlertInstance> */
                                ...
                                if ($pathChunks[6] === '{comment_number}') {
                                    if ($pathChunks[7] === 'reactions') {
                                        if ($call === 'LIST /teams/{team_id}/discussions/{discussion_number}/comments/{comment_number}/reactions') {
                                            return $this->routers->router🔀List🔀Reactions()->listForTeamDiscussionCommentLegacyListing($params);
                                        }
                                    }
                                }
                            }
