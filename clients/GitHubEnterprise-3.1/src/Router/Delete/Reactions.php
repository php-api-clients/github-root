...
final class Reactions
{
    ...
    public function deleteLegacy(array $params): array
    {
        ...
        $operator = new Operator\Reactions\DeleteLegacy($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Reactions🌀ReactionId());
