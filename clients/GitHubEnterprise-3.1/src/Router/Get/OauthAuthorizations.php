...
final class OauthAuthorizations
{
    ...
    public function listGrants(array $params): iterable
    {
        ...
        unset($params['page']);
        $operator = new Operator\OauthAuthorizations\ListGrants($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Applications🌀Grants());
    ...
    public function getAuthorization(array $params): Authorization|array
    {
        ...
        $operator = new Operator\OauthAuthorizations\GetAuthorization($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Authorizations🌀AuthorizationId());
    ...
    public function getGrant(array $params): ApplicationGrant|array
    {
        ...
        $operator = new Operator\OauthAuthorizations\GetGrant($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Applications🌀Grants🌀GrantId());
    ...
    public function listAuthorizations(array $params): iterable
    {
        ...
        $arguments['page'] = $params['page'];
        unset($params['page']);
        $operator = new Operator\OauthAuthorizations\ListAuthorizations($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Authorizations());
