...
final class Six
{
    ...
    /** @return |iterable<Schema\RunnerApplication>|iterable<Schema\TeamDiscussion>|iterable<Schema\SimpleUser>|iterable<Schema\TeamProject>|iterable<Schema\MinimalRepository>|iterable<Schema\Team>|(Schema\ProjectCollaboratorPermission|array{code: int})|array{code: int}|iterable<Schema\CodeScanningAlertItems>|iterable<Schema\CodeScanningAnalysis>|(Schema\ContentDirectory|Schema\ContentFile|Schema\ContentSymlink|Schema\ContentSubmodule|iterable<Schema\IssueComment>|iterable<Schema\IssueEvent>|(Schema\Issue|Schema\BasicError|iterable<Schema\PageBuild>|iterable<Schema\PullRequestReviewComment>|(Schema\PullRequest|(iterable<Schema\SecretScanningAlert>|(iterable<int>|Schema\Operations\Repos\GetCodeFrequencyStats\Response\ApplicationJson\Accepted|(iterable<Schema\CommitActivity>|(iterable<Schema\ContributorActivity>|array{code: int, location: string}|iterable<Schema\TeamDiscussionComment>|iterable<Schema\Reaction>|(Schema\TeamRepository|iterable<Schema\Event> */
