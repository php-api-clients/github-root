...
final readonly class CreateDeployment
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Repos\CreateDeployment($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo);
