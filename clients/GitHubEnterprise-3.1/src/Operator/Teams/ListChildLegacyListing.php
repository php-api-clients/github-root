...
final readonly class ListChildLegacyListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Teams\ListChildLegacyListing($this->responseSchemaValidator, $this->hydrator, $teamId, $perPage, $page);
