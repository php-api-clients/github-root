...
final readonly class ListReposWatchedByUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Activity\ListReposWatchedByUser($this->responseSchemaValidator, $this->hydrator, $username, $perPage, $page);
