...
final readonly class ListRepoEventsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Activity\ListRepoEventsListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
