...
final readonly class CreateComment
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Issues\CreateComment($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $issueNumber);
