...
final readonly class ListComments
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Issues\ListComments($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $issueNumber, $since, $perPage, $page);
