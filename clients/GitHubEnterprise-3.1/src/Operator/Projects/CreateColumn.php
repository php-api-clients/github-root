...
final readonly class CreateColumn
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Projects\CreateColumn($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $projectId);
