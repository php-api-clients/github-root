...
final readonly class ScopeToken
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Apps\ScopeToken($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $clientId);
