...
final readonly class ListMatchingRefs
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Git\ListMatchingRefs($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $ref, $perPage, $page);
