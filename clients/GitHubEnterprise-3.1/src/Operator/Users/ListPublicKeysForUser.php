...
final readonly class ListPublicKeysForUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Users\ListPublicKeysForUser($this->responseSchemaValidator, $this->hydrator, $username, $perPage, $page);
