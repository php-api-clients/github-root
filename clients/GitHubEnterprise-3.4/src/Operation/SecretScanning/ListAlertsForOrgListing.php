...
final class ListAlertsForOrgListing
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Orgs\CbOrgRcb\SecretScanning\Alerts $hydrator, string $org, string $state, string $secret_type, string $resolution, int $page = 1, int $per_page = 30)
    {
        $this->org = $org;
        $this->state = $state;
