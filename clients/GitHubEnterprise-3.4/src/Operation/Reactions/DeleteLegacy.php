...
final class DeleteLegacy
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Reactions\ReactionId $hydrator, int $reactionId)
    {
