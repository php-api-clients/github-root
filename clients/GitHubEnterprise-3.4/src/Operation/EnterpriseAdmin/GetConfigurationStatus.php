...
final class GetConfigurationStatus
{
    ...
    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Setup\Api\Configcheck $hydrator)
    {
        ...
        switch ($contentType) {
            case 'application/json':
                ...
                switch ($code) {
                    ...
                    **/
                    case 200:
                        $this->responseSchemaValidator->validate($body, Reader::readFromJson(Schema\ConfigurationStatus::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
