...
final class GetTree
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\Repos\Owner\Repo\Git\Trees\TreeSha $hydrator, string $owner, string $repo, private string $treeSha, string $recursive)
    {
        $this->owner     = $owner;
        $this->repo      = $repo;
