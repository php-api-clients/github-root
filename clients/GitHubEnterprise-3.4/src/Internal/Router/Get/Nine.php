...
final class Nine
{
    ...
    /** @return Schema\TeamDiscussionComment|iterable<string>|iterable<Schema\Integration>|iterable<Schema\Team>|iterable<Schema\SimpleUser>|iterable<Schema\ReviewComment> */
