...
final class Eight
{
    ...
    /** @return Schema\Operations\Orgs\RedeliverWebhookDelivery\Response\ApplicationJson\Accepted\Application\Json|Schema\TeamDiscussionComment|Schema\Reaction|Schema\Operations\EnterpriseAdmin\ListLabelsForSelfHostedRunnerForEnterprise\Response\ApplicationJson\Ok|Schema\EmptyObject|iterable<int,Schema\Deployment>|WithoutBody|Schema\ProtectedBranchAdminEnforced */
    public function call(string $call, array $params, array $pathChunks): Json|TeamDiscussionComment|Reaction|Ok|EmptyObject|iterable|WithoutBody|ProtectedBranchAdminEnforced
    {
        if ($pathChunks[0] === '') {
