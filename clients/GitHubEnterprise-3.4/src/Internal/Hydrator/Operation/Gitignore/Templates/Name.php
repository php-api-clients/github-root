...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Gitignore\Templates;
...
class Name implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️GitignoreTemplate(array $payload): GitignoreTemplate
    {
        $properties    = [];
        $missingFields = [];
        try {
