...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Repos\Owner\Repo\Keys;
...
class KeyId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️DeployKey(array $payload): DeployKey
    {
        $properties    = [];
        $missingFields = [];
        try {
