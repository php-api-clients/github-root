...
use ApiClients\Client\GitHubEnterprise\Schema\LicenseContent\Links;
...
class License implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️LicenseContent(array $payload): LicenseContent
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️LicenseContent⚡️Links(array $payload): Links
    {
        $properties    = [];
        $missingFields = [];
        try {
