...
final readonly class ListCommitsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Gists\ListCommitsListing($this->responseSchemaValidator, $this->hydrator, $gistId, $perPage, $page);
