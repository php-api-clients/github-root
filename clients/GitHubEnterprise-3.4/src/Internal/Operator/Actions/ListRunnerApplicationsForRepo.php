...
final readonly class ListRunnerApplicationsForRepo
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Actions\ListRunnerApplicationsForRepo($this->responseSchemaValidator, $this->hydrator, $owner, $repo);
