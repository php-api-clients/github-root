...
final readonly class ListNotificationsForAuthenticatedUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Activity\ListNotificationsForAuthenticatedUserListing($this->responseSchemaValidator, $this->hydrator, $since, $before, $all, $participating, $page, $perPage);
