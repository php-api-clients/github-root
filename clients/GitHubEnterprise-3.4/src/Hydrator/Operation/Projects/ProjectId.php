...
class ProjectId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Operations⚡️Projects⚡️DeleteCard⚡️Response⚡️ApplicationJson⚡️Forbidden(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\Operations\Projects\DeleteCard\Response\ApplicationJson\Forbidden
    {
        $properties = []; 
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\Operations\Projects\DeleteCard\Response\ApplicationJson\Forbidden::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\Operations\Projects\DeleteCard\Response\ApplicationJson\Forbidden(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\Operations\Projects\DeleteCard\Response\ApplicationJson\Forbidden', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\Operations\Projects\DeleteCard\Response\ApplicationJson\Forbidden);
        $result = [];
