...
namespace ApiClients\Client\GitHubEnterprise\Operator\Gitignore;
...
final readonly class GetTemplate
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Gitignore\GetTemplate($this->responseSchemaValidator, $this->hydrator, $name);
