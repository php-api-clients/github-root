...
final readonly class SetCustomLabelsForSelfHostedRunnerForRepo
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Actions\SetCustomLabelsForSelfHostedRunnerForRepo($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $runnerId);
