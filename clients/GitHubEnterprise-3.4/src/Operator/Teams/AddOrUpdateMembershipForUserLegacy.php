...
final readonly class AddOrUpdateMembershipForUserLegacy
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Teams\AddOrUpdateMembershipForUserLegacy($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $teamId, $username);
