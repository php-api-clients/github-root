...
final readonly class ListPublicKeysForUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Users\ListPublicKeysForUserListing($this->responseSchemaValidator, $this->hydrator, $username, $perPage, $page);
