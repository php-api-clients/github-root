...
final readonly class ListFollowingForUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Users\ListFollowingForUser($this->responseSchemaValidator, $this->hydrator, $username, $perPage, $page);
