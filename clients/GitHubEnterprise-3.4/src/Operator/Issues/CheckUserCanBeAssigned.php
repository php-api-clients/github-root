...
final readonly class CheckUserCanBeAssigned
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Issues\CheckUserCanBeAssigned($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $assignee);
