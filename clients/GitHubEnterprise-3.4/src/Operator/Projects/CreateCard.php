...
final readonly class CreateCard
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Projects\CreateCard($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $columnId);
