...
final readonly class ListForUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Projects\ListForUserListing($this->responseSchemaValidator, $this->hydrator, $username, $state, $perPage, $page);
