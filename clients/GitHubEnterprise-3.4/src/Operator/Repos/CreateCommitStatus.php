...
final readonly class CreateCommitStatus
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Repos\CreateCommitStatus($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $sha);
