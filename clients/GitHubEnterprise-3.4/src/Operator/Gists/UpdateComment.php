...
final readonly class UpdateComment
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Gists\UpdateComment($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $gistId, $commentId);
