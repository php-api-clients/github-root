...
final readonly class ListForUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Gists\ListForUserListing($this->responseSchemaValidator, $this->hydrator, $username, $since, $perPage, $page);
