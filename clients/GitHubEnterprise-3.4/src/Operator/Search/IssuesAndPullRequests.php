...
final readonly class IssuesAndPullRequests
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Search\IssuesAndPullRequests($this->responseSchemaValidator, $this->hydrator, $q, $sort, $order, $perPage, $page);
