...
final readonly class DownloadArchiveForOrgStreaming
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Migrations\DownloadArchiveForOrgStreaming($this->responseSchemaValidator, $this->hydrator, $this->browser, $org, $migrationId);
