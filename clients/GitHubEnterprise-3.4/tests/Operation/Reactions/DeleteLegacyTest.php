...
use ApiClients\Client\GitHubEnterprise\Operation\Reactions\DeleteLegacy;
...
final class DeleteLegacyTest extends AsyncTestCase
{
    ...
    public function httpCode_403_responseContentType_application_json(): void
    {
        ...
        $browser->request('DELETE', '/reactions/13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
