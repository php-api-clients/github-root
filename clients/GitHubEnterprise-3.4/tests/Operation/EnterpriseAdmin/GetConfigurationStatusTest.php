...
use ApiClients\Client\GitHubEnterprise\Operation\EnterpriseAdmin\GetConfigurationStatus;
...
final class GetConfigurationStatusTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $client->call(GetConfigurationStatus::OPERATION_MATCH, (static function (array $data): array {
            return $data;
        })([]));
    }
}
