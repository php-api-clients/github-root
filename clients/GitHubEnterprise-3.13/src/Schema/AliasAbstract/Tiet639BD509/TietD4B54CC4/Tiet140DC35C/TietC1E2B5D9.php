...
namespace ApiClients\Client\GitHubEnterprise\Schema\AliasAbstract\Tiet639BD509\TietD4B54CC4\Tiet140DC35C;

use ApiClients\Client\GitHubEnterprise\Schema;
use EventSauce\ObjectHydrator\MapFrom;

abstract readonly class TietC1E2B5D9
{
    ...
    public const SCHEMA_DESCRIPTION  = 'The [comment](https://docs.github.com/enterprise-server@3.13/rest/pulls/comments#get-a-review-comment-for-a-pull-request) itself.';
