...
final readonly class WebhookCacheSync
{
    ...
    public string $cacheLocation, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public string $ref, public Schema\RepositoryWebhooks|null $repository, public Schema\SimpleUser|null $sender,)
    {
    }
}
