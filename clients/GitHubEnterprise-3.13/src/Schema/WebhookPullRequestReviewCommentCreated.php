...
final readonly class WebhookPullRequestReviewCommentCreated
{
    ...
    public Schema\WebhookPullRequestReviewCommentCreated\PullRequest $pullRequest, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUser $sender,)
    {
    }
}
