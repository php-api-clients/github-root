...
namespace ApiClients\Client\GitHubEnterprise\Internal\Operator\Licenses;
...
final readonly class GetAllCommonlyUsed
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Licenses\GetAllCommonlyUsed($this->responseSchemaValidator, $this->hydrator, $featured, $perPage, $page);
