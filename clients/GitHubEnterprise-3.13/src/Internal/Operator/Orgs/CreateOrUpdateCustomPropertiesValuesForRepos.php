...
final readonly class CreateOrUpdateCustomPropertiesValuesForRepos
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Orgs\CreateOrUpdateCustomPropertiesValuesForRepos($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $org);
