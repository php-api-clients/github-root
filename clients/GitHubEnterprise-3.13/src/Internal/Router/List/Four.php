...
final class Four
{
    ...
    /** @return iterable<int,Schema\AuditLogEvent>|iterable<int,Schema\GistComment>|WithoutBody|iterable<int,Schema\GistCommit>|iterable<int,Schema\GistSimple>|iterable<int,Schema\Event>|iterable<int,Schema\OrgHook>|iterable<int,Schema\Issue>|iterable<int,Schema\SimpleUser>|iterable<int,Schema\Migration>|iterable<int,Schema\Package>|iterable<int,Schema\OrganizationProgrammaticAccessGrantRequest>|iterable<int,Schema\OrganizationProgrammaticAccessGrant>|iterable<int,Schema\OrgPreReceiveHook>|iterable<int,Schema\Project>|iterable<int,Schema\MinimalRepository>|iterable<int,Schema\RepositoryRuleset>|iterable<int,Schema\Team>|iterable<int,Schema\ProjectColumn>|iterable<int,Schema\TeamDiscussion>|iterable<int,Schema\TeamProject>|iterable<int,Schema\OrgMembership>|iterable<int,Schema\BaseGist>|iterable<int,Schema\GpgKey>|iterable<int,Schema\KeySimple>|iterable<int,Schema\OrganizationSimple>|iterable<int,Schema\SocialAccount>|iterable<int,Schema\SshSigningKey> */
