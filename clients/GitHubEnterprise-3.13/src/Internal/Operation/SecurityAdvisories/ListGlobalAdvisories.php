...
namespace ApiClients\Client\GitHubEnterprise\Internal\Operation\SecurityAdvisories;
...
final class ListGlobalAdvisories
{
    ...
    For more information on the syntax of the date range, see "[Understanding the search syntax](https://docs.github.com/enterprise-server@3.13/search-github/getting-started-with-searching-on-github/understanding-the-search-syntax#query-for-dates)." **/
