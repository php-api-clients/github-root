...
final class ListPublicEmailsForAuthenticatedUserListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Internal\Hydrator\Operation\User\PublicEmails $hydrator, int $perPage = 30, int $page = 1)
    {
    ...
    {
        return new Request('GET', str_replace(['{per_page}', '{page}'], [$this->perPage, $this->page], '/user/public_emails' . '?per_page={per_page}&page={page}'));
    }
