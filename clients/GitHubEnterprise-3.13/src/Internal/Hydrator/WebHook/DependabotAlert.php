...
use ApiClients\Client\GitHubEnterprise\Schema\DependabotAlert\Dependency;
use ApiClients\Client\GitHubEnterprise\Schema\DependabotAlertPackage;
use ApiClients\Client\GitHubEnterprise\Schema\DependabotAlertSecurityAdvisory;
use ApiClients\Client\GitHubEnterprise\Schema\DependabotAlertSecurityAdvisory\Cvss;
use ApiClients\Client\GitHubEnterprise\Schema\DependabotAlertSecurityVulnerability;
use ApiClients\Client\GitHubEnterprise\Schema\DependabotAlertSecurityVulnerability\FirstPatchedVersion;
...
use ApiClients\Client\GitHubEnterprise\Schema\WebhookDependabotAlertAutoDismissed;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookDependabotAlertAutoReopened;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookDependabotAlertCreated;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookDependabotAlertDismissed;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookDependabotAlertFixed;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookDependabotAlertReintroduced;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookDependabotAlertReopened;
...
class DependabotAlert implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookDependabotAlertAutoDismissed' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDependabotAlertAutoDismissed($payload),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDependabotAlertAutoReopened' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDependabotAlertAutoReopened($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDependabotAlertCreated' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDependabotAlertCreated($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDependabotAlertDismissed' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDependabotAlertDismissed($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDependabotAlertFixed' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDependabotAlertFixed($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDependabotAlertReintroduced' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDependabotAlertReintroduced($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDependabotAlertReopened' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDependabotAlertReopened($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDependabotAlertAutoDismissed(array $payload): WebhookDependabotAlertAutoDismissed
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️DependabotAlert($value);
                } finally {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDependabotAlertAutoDismissed', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️DependabotAlert⚡️Dependency(array $payload): Dependency
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️DependabotAlertPackage(array $payload): DependabotAlertPackage
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️DependabotAlertSecurityAdvisory(array $payload): DependabotAlertSecurityAdvisory
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️DependabotAlertSecurityAdvisory⚡️Cvss(array $payload): Cvss
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️DependabotAlertSecurityVulnerability(array $payload): DependabotAlertSecurityVulnerability
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️DependabotAlertSecurityVulnerability⚡️FirstPatchedVersion(array $payload): FirstPatchedVersion
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDependabotAlertAutoReopened(array $payload): WebhookDependabotAlertAutoReopened
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDependabotAlertAutoReopened', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDependabotAlertCreated(array $payload): WebhookDependabotAlertCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDependabotAlertCreated', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDependabotAlertDismissed(array $payload): WebhookDependabotAlertDismissed
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDependabotAlertDismissed', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDependabotAlertFixed(array $payload): WebhookDependabotAlertFixed
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDependabotAlertFixed', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDependabotAlertReintroduced(array $payload): WebhookDependabotAlertReintroduced
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDependabotAlertReintroduced', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDependabotAlertReopened(array $payload): WebhookDependabotAlertReopened
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDependabotAlertReopened', $exception, stack: $this->hydrationStack);
        }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDependabotAlertAutoDismissed' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDependabotAlertAutoDismissed($object),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDependabotAlertAutoReopened' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDependabotAlertAutoReopened($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDependabotAlertCreated' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDependabotAlertCreated($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDependabotAlertDismissed' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDependabotAlertDismissed($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDependabotAlertFixed' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDependabotAlertFixed($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDependabotAlertReintroduced' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDependabotAlertReintroduced($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDependabotAlertReopened' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDependabotAlertReopened($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDependabotAlertAutoDismissed(mixed $object): mixed
    {
        ...
        $alert                               = $object->alert;
        $alert                               = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️DependabotAlert($alert);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️DependabotAlert(mixed $object): mixed
    {
        ...
        $securityAdvisory                                           = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️DependabotAlertSecurityAdvisory($securityAdvisory);
        after_securityAdvisory:        $result['security_advisory'] = $securityAdvisory;

        $securityVulnerability                                                = $object->securityVulnerability;
        $securityVulnerability                                                = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️DependabotAlertSecurityVulnerability($securityVulnerability);
        ...
        $dismissedBy                                      = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️SimpleUser($dismissedBy);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️DependabotAlertSecurityVulnerability(mixed $object): mixed
    {
        ...
        $firstPatchedVersion                                               = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️DependabotAlertSecurityVulnerability⚡️FirstPatchedVersion($firstPatchedVersion);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDependabotAlertAutoReopened(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDependabotAlertCreated(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDependabotAlertDismissed(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDependabotAlertFixed(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDependabotAlertReintroduced(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDependabotAlertReopened(mixed $object): mixed
    {
