...
use ApiClients\Client\GitHubEnterprise\Internal\Attribute\CastUnionToType\Schema\Deployment\Payload;
...
use ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentProtectionRuleRequested;
...
class DeploymentProtectionRule implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentProtectionRuleRequested' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentProtectionRuleRequested($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentProtectionRuleRequested(array $payload): WebhookDeploymentProtectionRuleRequested
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentProtectionRuleRequested', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Deployment(array $payload): Deployment
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentProtectionRuleRequested' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentProtectionRuleRequested($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentProtectionRuleRequested(mixed $object): mixed
    {
