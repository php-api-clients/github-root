...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Orgs\Org\Teams\TeamSlug\Discussions;
...
class DiscussionNumber implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️TeamDiscussion(array $payload): TeamDiscussion
    {
        $properties    = [];
        $missingFields = [];
        try {
