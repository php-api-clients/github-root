...
class Workflow implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️ActionsGetDefaultWorkflowPermissions(array $payload): ActionsGetDefaultWorkflowPermissions
    {
        $properties    = [];
        $missingFields = [];
        try {
