...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Repos\Owner\Repo\Rulesets;
...
class RulesetId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️RepositoryRuleset(array $payload): RepositoryRuleset
    {
        $properties    = [];
        $missingFields = [];
        try {
