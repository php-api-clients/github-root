...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Projects\Columns\Cards;

use ApiClients\Client\GitHubEnterprise\Schema\BasicError;
use ApiClients\Client\GitHubEnterprise\Schema\Operations\Projects\DeleteCard\Response\ApplicationJson\Forbidden;
...
class CardId implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubEnterprise\Schema\ProjectCard' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️ProjectCard($payload),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\Operations\Projects\DeleteCard\Response\ApplicationJson\Forbidden' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Operations⚡️Projects⚡️DeleteCard⚡️Response⚡️ApplicationJson⚡️Forbidden($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Operations⚡️Projects⚡️DeleteCard⚡️Response⚡️ApplicationJson⚡️Forbidden(array $payload): Forbidden
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\Operations\Projects\DeleteCard\Response\ApplicationJson\Forbidden', $exception, stack: $this->hydrationStack);
        }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\Operations\Projects\DeleteCard\Response\ApplicationJson\Forbidden' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Operations⚡️Projects⚡️DeleteCard⚡️Response⚡️ApplicationJson⚡️Forbidden($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Operations⚡️Projects⚡️DeleteCard⚡️Response⚡️ApplicationJson⚡️Forbidden(mixed $object): mixed
    {
