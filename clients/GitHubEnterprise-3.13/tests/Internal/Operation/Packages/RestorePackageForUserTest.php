...
/** @covers \ApiClients\Client\GitHubEnterprise\Internal\Operation\Packages\RestorePackageForUser */
final class RestorePackageForUserTest extends AsyncTestCase
{
    ...
    public function operations_httpCode_404_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/users/generated/packages/generated/generated/restore?token=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->packages()->restorePackageForUser('generated', 'generated', 'generated', 'generated');
    }
