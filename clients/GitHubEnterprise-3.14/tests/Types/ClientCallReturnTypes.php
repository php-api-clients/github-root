...
assertType('', $client->call('GET /manage/v1/cluster/status'));
assertType('', $client->call('GET /manage/v1/config/apply'));
assertType('', $client->call('POST /manage/v1/config/apply'));
assertType('', $client->call('GET /manage/v1/config/apply/events'));
assertType('', $client->call('POST /manage/v1/config/init'));
assertType('', $client->call('GET /manage/v1/config/license'));
assertType('', $client->call('PUT /manage/v1/config/license'));
...
assertType('', $client->call('DELETE /scim/v2/enterprises/{enterprise}/Users/{scim_user_id}'));
