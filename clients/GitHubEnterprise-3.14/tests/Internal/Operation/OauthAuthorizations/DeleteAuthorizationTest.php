...
/** @covers \ApiClients\Client\GitHubEnterprise\Internal\Operation\OauthAuthorizations\DeleteAuthorization */
final class DeleteAuthorizationTest extends AsyncTestCase
{
    ...
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/authorizations/16', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\OauthAuthorizations\DeleteAuthorization::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/authorizations/16', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->oauthAuthorizations()->deleteAuthorization(16);
    }
