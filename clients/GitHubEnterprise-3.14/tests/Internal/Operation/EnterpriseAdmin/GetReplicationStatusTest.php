...
/** @covers \ApiClients\Client\GitHubEnterprise\Internal\Operation\EnterpriseAdmin\GetReplicationStatus */
final class GetReplicationStatusTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(Schema\GhesReplicationStatus::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(Internal\Operation\EnterpriseAdmin\GetReplicationStatus::OPERATION_MATCH, (static function (array $data): array {
            $data['uuid']          = 'generated';
    ...
    public function operations_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/manage/v1/replication/status?uuid=generated&cluster_roles=generated', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->enterpriseAdmin()->getReplicationStatus('generated', 'generated');
    }
