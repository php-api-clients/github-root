...
/** @covers \ApiClients\Client\GitHubEnterprise\Internal\Operation\EnterpriseAdmin\SetManageMaintenance */
final class SetManageMaintenanceTest extends AsyncTestCase
{
    ...
    public function call_httpCode_400_requestContentType_application_json_empty(): void
    {
        ...
        $result = $client->call(Internal\Operation\EnterpriseAdmin\SetManageMaintenance::OPERATION_MATCH, (static function (array $data): array {
            return $data;
