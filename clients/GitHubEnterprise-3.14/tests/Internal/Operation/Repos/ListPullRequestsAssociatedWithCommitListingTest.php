...
/** @covers \ApiClients\Client\GitHubEnterprise\Internal\Operation\Repos\ListPullRequestsAssociatedWithCommitListing */
final class ListPullRequestsAssociatedWithCommitListingTest extends AsyncTestCase
{
    ...
    public function call_httpCode_409_responseContentType_application_json_zero(): void
    {
        ...
        $result = $client->call(Internal\Operation\Repos\ListPullRequestsAssociatedWithCommitListing::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_409_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repos/generated/generated/commits/generated/pulls?per_page=8&page=1', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->repos()->listPullRequestsAssociatedWithCommitListing('generated', 'generated', 'generated', 8, 1);
        foreach ($result as $item) {
        }
    }
}
