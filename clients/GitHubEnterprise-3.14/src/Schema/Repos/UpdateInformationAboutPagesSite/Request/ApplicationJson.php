...
final readonly class ApplicationJson
{
    ...
    "properties": {
        "cname": {
            ...
            "description": "Specify a custom domain for the repository. Sending a `null` value will remove the custom domain. For more about custom domains, see \\"[Using a custom domain with GitHub Pages](https:\\/\\/docs.github.com\\/enterprise-server@3.14\\/pages\\/configuring-a-custom-domain-for-your-github-pages-site).\\""
        },
        "https_enforced": {
            "type": "boolean",
    ...
    /**
     * cname: Specify a custom domain for the repository. Sending a `null` value will remove the custom domain. For more about custom domains, see "[Using a custom domain with GitHub Pages](https://docs.github.com/enterprise-server@3.14/pages/configuring-a-custom-domain-for-your-github-pages-site)."
