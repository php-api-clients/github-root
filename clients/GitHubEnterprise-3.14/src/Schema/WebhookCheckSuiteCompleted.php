...
final readonly class WebhookCheckSuiteCompleted
{
    ...
    "properties": {
        ...
        "check_suite": {
            ...
            "description": "The [check_suite](https:\\/\\/docs.github.com\\/enterprise-server@3.14\\/rest\\/checks\\/suites#get-a-check-suite)."
        },
        "enterprise": {
            "title": "Enterprise",
            "required": [
    ...
    /**
     * checkSuite: The [check_suite](https://docs.github.com/enterprise-server@3.14/rest/checks/suites#get-a-check-suite).
    ...
    public Schema\WebhookCheckSuiteCompleted\CheckSuite $checkSuite, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUser $sender,)
    {
    }
}
