...
final readonly class WebhookCheckRunCompleted
{
    ...
    public Schema\CheckRunWithSimpleCheckSuite $checkRun, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUser $sender,)
    {
    }
}
