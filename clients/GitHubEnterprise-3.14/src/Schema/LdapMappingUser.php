...
final readonly class LdapMappingUser
{
    ...
    public string|null $ldapDn, public string $login, public int $id, #[MapFrom('node_id')]
    ...
    public bool $twoFactorAuthentication, public Schema\LdapMappingUser\Plan|null $plan, #[MapFrom('suspended_at')]
    public string|null $suspendedAt, #[MapFrom('business_plus')]
    public bool|null $businessPlus, #[MapFrom('user_view_type')]
