...
final readonly class ApplicationJson
{
     ...
     * advancedSecurityEnabledForNewRepositories: **Endpoint closing down notice.** Please use [code security configurations](https://docs.github.com/enterprise-server@3.14/rest/code-security/configurations) instead.
    ...
    You can check which security and analysis features are currently enabled by using a `GET /orgs/{org}` request.
     * dependabotAlertsEnabledForNewRepositories: **Endpoint closing down notice.** Please use [code security configurations](https://docs.github.com/enterprise-server@3.14/rest/code-security/configurations) instead.
    ...
    You can check which security and analysis features are currently enabled by using a `GET /orgs/{org}` request.
     * dependabotSecurityUpdatesEnabledForNewRepositories: **Endpoint closing down notice.** Please use [code security configurations](https://docs.github.com/enterprise-server@3.14/rest/code-security/configurations) instead.
    ...
    You can check which security and analysis features are currently enabled by using a `GET /orgs/{org}` request.
     * dependencyGraphEnabledForNewRepositories: **Endpoint closing down notice.** Please use [code security configurations](https://docs.github.com/enterprise-server@3.14/rest/code-security/configurations) instead.
    ...
    You can check which security and analysis features are currently enabled by using a `GET /orgs/{org}` request.
     * secretScanningEnabledForNewRepositories: **Endpoint closing down notice.** Please use [code security configurations](https://docs.github.com/enterprise-server@3.14/rest/code-security/configurations) instead.
    ...
    You can check which security and analysis features are currently enabled by using a `GET /orgs/{org}` request.
     * secretScanningPushProtectionEnabledForNewRepositories: **Endpoint closing down notice.** Please use [code security configurations](https://docs.github.com/enterprise-server@3.14/rest/code-security/configurations) instead.
