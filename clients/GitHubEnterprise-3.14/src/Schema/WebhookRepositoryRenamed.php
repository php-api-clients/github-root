...
final readonly class WebhookRepositoryRenamed
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookRepositoryRenamed\Changes $changes, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUser $sender)
    {
    }
}
