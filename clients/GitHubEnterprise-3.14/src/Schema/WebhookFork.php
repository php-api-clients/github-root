...
final readonly class WebhookFork
{
    ...
    "properties": {
        ...
        "forkee": {
            ...
            "description": "The created [`repository`](https:\\/\\/docs.github.com\\/enterprise-server@3.14\\/rest\\/repos\\/repos#get-a-repository) resource."
        },
        "installation": {
    ...
    on an enterprise account or an organization that's part of an enterprise account. For more information,
    see "[About enterprise accounts](https://docs.github.com/enterprise-server@3.14/admin/overview/about-enterprise-accounts)."
     * forkee: The created [`repository`](https://docs.github.com/enterprise-server@3.14/rest/repos/repos#get-a-repository) resource.
     ...
     */
    public function __construct(public Schema\EnterpriseWebhooks|null $enterprise, public Schema\WebhookFork\Forkee $forkee, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUser $sender)
    {
    }
}
