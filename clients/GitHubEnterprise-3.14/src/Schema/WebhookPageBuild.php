...
final readonly class WebhookPageBuild
{
    ...
    "properties": {
        "build": {
            ...
            "description": "The [List GitHub Pages builds](https:\\/\\/docs.github.com\\/enterprise-server@3.14\\/rest\\/pages\\/pages#list-github-pages-builds) itself."
        },
        "enterprise": {
            "title": "Enterprise",
            "required": [
    ...
    /**
     * build: The [List GitHub Pages builds](https://docs.github.com/enterprise-server@3.14/rest/pages/pages#list-github-pages-builds) itself.
     ...
     */
    public function __construct(public Schema\WebhookPageBuild\Build $build, public Schema\EnterpriseWebhooks|null $enterprise, public int $id, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUser $sender)
    {
    }
}
