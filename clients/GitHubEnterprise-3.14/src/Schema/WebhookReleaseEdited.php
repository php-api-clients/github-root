...
final readonly class WebhookReleaseEdited
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookReleaseEdited\Changes $changes, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\WebhooksRelease $release, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUser|null $sender)
    {
    }
}
