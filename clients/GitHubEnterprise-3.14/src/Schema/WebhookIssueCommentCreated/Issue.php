...
namespace ApiClients\Client\GitHubEnterprise\Schema\WebhookIssueCommentCreated;
...
final readonly class Issue
{
    ...
    public Schema\WebhookIssueCommentCreated\Issue\SubIssuesSummary|null $subIssuesSummary, public string|null $state, #[MapFrom('state_reason')]
