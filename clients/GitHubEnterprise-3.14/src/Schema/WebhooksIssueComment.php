...
final readonly class WebhooksIssueComment
{
    ...
    "description": "The [comment](https:\\/\\/docs.github.com\\/enterprise-server@3.14\\/rest\\/issues\\/comments#get-an-issue-comment) itself."
}';
    public const SCHEMA_TITLE        = 'issue comment';
    public const SCHEMA_DESCRIPTION  = 'The [comment](https://docs.github.com/enterprise-server@3.14/rest/issues/comments#get-an-issue-comment) itself.';
    ...
    public Schema\Integration|null $performedViaGithubApp, public Schema\WebhooksIssueComment\Reactions $reactions, #[MapFrom('updated_at')]
    public string $updatedAt, public string $url, public Schema\WebhooksIssueComment\User|null $user,)
    {
    }
}
