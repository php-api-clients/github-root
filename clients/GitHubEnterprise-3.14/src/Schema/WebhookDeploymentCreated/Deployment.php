...
namespace ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentCreated;
...
final readonly class Deployment
{
    ...
    public const SCHEMA_DESCRIPTION  = 'The [deployment](https://docs.github.com/enterprise-server@3.14/rest/deployments/deployments#list-deployments).';
