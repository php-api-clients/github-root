...
namespace ApiClients\Client\GitHubEnterprise\Schema\WebhookIssuesClosed;
...
final readonly class Issue
{
    ...
    public Schema\WebhookIssuesClosed\Issue\SubIssuesSummary|null $subIssuesSummary, public string|null $state, #[MapFrom('state_reason')]
