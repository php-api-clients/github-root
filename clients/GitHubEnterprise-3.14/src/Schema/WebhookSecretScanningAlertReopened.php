...
final readonly class WebhookSecretScanningAlertReopened
{
        ...
        "alert": {
            ...
            "properties": {
                ...
                "secret_type_display_name": {
                    "type": "string",
                    "description": "User-friendly name for the detected secret, matching the `secret_type`.\\nFor a list of built-in patterns, see \\"[Supported secret scanning patterns](https:\\/\\/docs.github.com\\/enterprise-server@3.14\\/code-security\\/secret-scanning\\/introduction\\/supported-secret-scanning-patterns#supported-secrets).\\""
                },
                "validity": {
                    "enum": [
                        "active",
     ...
     */
    public function __construct(public string $action, public Schema\SecretScanningAlertWebhook $alert, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUser|null $sender)
    {
    }
}
