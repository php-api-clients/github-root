...
final readonly class DeploymentStatus
{
    ...
    "description": "The [deployment status](https:\\/\\/docs.github.com\\/enterprise-server@3.14\\/rest\\/deployments\\/statuses#list-deployment-statuses)."
}';
    public const SCHEMA_TITLE        = '';
    public const SCHEMA_DESCRIPTION  = 'The [deployment status](https://docs.github.com/enterprise-server@3.14/rest/deployments/statuses#list-deployment-statuses).';
