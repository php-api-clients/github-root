...
final readonly class Changes
{
    ...
    public Schema\WebhookBranchProtectionRuleEdited\Changes\LinearHistoryRequirementEnforcementLevel|null $linearHistoryRequirementEnforcementLevel, #[MapFrom('pull_request_reviews_enforcement_level')]
