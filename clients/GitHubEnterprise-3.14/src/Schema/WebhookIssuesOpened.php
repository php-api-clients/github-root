...
final readonly class WebhookIssuesOpened
{
     ...
     */
    public function __construct(public string $action, public Schema\WebhookIssuesOpened\Changes|null $changes, public Schema\EnterpriseWebhooks|null $enterprise, public Schema\SimpleInstallation|null $installation, public Schema\WebhookIssuesOpened\Issue $issue, public Schema\OrganizationSimpleWebhooks|null $organization, public Schema\RepositoryWebhooks $repository, public Schema\SimpleUser $sender)
    {
    }
}
