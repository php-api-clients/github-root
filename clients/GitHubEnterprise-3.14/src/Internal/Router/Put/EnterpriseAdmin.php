...
final class EnterpriseAdmin
{
    ...
    {
        $arguments = [];
        if (array_key_exists('apply', $params) === false) {
            throw new InvalidArgumentException('Missing mandatory field: apply');
        }

        $arguments['apply'] = $params['apply'];
        unset($params['apply']);
        $operator = new Internal\Operator\EnterpriseAdmin\LicenseUpload($this->browser, $this->authentication, $this->requestSchemaValidator);
