...
final class Five
{
    ...
    /** @return Schema\HookDelivery|Schema\ActionsEnterprisePermissions|Schema\Operations\EnterpriseAdmin\ListSelfHostedRunnerGroupsForEnterprise\Response\ApplicationJson\Ok|Schema\Operations\EnterpriseAdmin\ListSelfHostedRunnersForEnterprise\Response\ApplicationJson\Ok|iterable<int,Schema\CodeScanningOrganizationAlertItems>|iterable<int,Schema\DependabotAlertWithRepository>|WithoutBody|iterable<int,Schema\OrganizationSecretScanningAlert>|Schema\GistComment|iterable<int,Schema\GhesGetSsh>|Schema\GhesChecksSystemRequirements|Schema\GhesClusterStatus|Schema\Operations\EnterpriseAdmin\GetManageConfigApplyStatus\Response\ApplicationJson\Ok|Schema\GhesLicenseInfo|Schema\GhesConfigNodes|Schema\GhesGetSettings|Schema\GhesReplicationStatus|iterable<int,Schema\Event>|Schema\BasicError|Schema\ThreadSubscription|Schema\ActionsOrganizationPermissions|Schema\Operations\Actions\ListSelfHostedRunnerGroupsForOrg\Response\ApplicationJson\Ok|Schema\Operations\Actions\ListSelfHostedRunnersForOrg\Response\ApplicationJson\Ok|Schema\Operations\Actions\ListOrgSecrets\Response\ApplicationJson\Ok|Schema\Operations\Actions\ListOrgVariables\Response\ApplicationJson\Ok|Schema\OrganizationCustomRepositoryRole|Schema\Operations\Dependabot\ListOrgSecrets\Response\ApplicationJson\Ok|iterable<int,Schema\Package>|Schema\ExternalGroup|Schema\OrgHook|Schema\OrgMembership|Schema\Migration|Schema\OrganizationRole|Schema\OrgPreReceiveHook|iterable<int,Schema\CustomProperty>|iterable<int,Schema\OrgRepoCustomPropertyValues>|iterable<int,Schema\RuleSuites>|Schema\RepositoryRuleset|Schema\TeamFull|Schema\ProjectCard|iterable<int,Schema\ProjectCard>|iterable<int,Schema\Activity>|iterable<int,Schema\SimpleUser>|iterable<int,Schema\Autolink>|Schema\CheckAutomatedSecurityFixes|iterable<int,Schema\ShortBranch>|iterable<int,Schema\Collaborator>|iterable<int,Schema\CommitComment>|iterable<int,Schema\Commit>|iterable<int,Schema\Contributor>|iterable<int,Schema\Deployment>|Schema\Operations\Repos\GetAllEnvironments\Response\ApplicationJson\Ok|iterable<int,Schema\MinimalRepository>|iterable<int,Schema\Hook>|Schema\Installation|iterable<int,Schema\RepositoryInvitation>|iterable<int,Schema\Issue>|iterable<int,Schema\DeployKey>|iterable<int,Schema\Label>|Schema\Language|Schema\LicenseContent|iterable<int,Schema\Milestone>|iterable<int,Schema\Thread>|Schema\Page|iterable<int,Schema\RepositoryPreReceiveHook>|iterable<int,Schema\Project>|iterable<int,Schema\PullRequestSimple>|Schema\ContentFile|iterable<int,Schema\Release>|iterable<int,Schema\RepositoryRuleset>|Schema\SimpleUser|Schema\Stargazer|Schema\RepositorySubscription|iterable<int,Schema\Tag>|iterable<int,Schema\Team>|Schema\Topic|iterable<int,Schema\SshKey>|Schema\TeamDiscussion|Schema\TeamMembership|Schema\TeamProject|Schema\Operations\Apps\ListInstallationReposForAuthenticatedUser\Response\ApplicationJson\Ok|Schema\Package */
    public function call(string $call, array $params, array $pathChunks): HookDelivery|ActionsEnterprisePermissions|Ok|\ApiClients\Client\GitHubEnterprise\Schema\Operations\EnterpriseAdmin\ListSelfHostedRunnersForEnterprise\Response\ApplicationJson\Ok|iterable|WithoutBody|GistComment|GhesChecksSystemRequirements|GhesClusterStatus|\ApiClients\Client\GitHubEnterprise\Schema\Operations\EnterpriseAdmin\GetManageConfigApplyStatus\Response\ApplicationJson\Ok|GhesLicenseInfo|GhesConfigNodes|GhesGetSettings|GhesReplicationStatus|BasicError|ThreadSubscription|ActionsOrganizationPermissions|\ApiClients\Client\GitHubEnterprise\Schema\Operations\Actions\ListSelfHostedRunnerGroupsForOrg\Response\ApplicationJson\Ok|\ApiClients\Client\GitHubEnterprise\Schema\Operations\Actions\ListSelfHostedRunnersForOrg\Response\ApplicationJson\Ok|\ApiClients\Client\GitHubEnterprise\Schema\Operations\Actions\ListOrgSecrets\Response\ApplicationJson\Ok|\ApiClients\Client\GitHubEnterprise\Schema\Operations\Actions\ListOrgVariables\Response\ApplicationJson\Ok|OrganizationCustomRepositoryRole|\ApiClients\Client\GitHubEnterprise\Schema\Operations\Dependabot\ListOrgSecrets\Response\ApplicationJson\Ok|ExternalGroup|OrgHook|OrgMembership|Migration|OrganizationRole|OrgPreReceiveHook|RepositoryRuleset|TeamFull|ProjectCard|CheckAutomatedSecurityFixes|\ApiClients\Client\GitHubEnterprise\Schema\Operations\Repos\GetAllEnvironments\Response\ApplicationJson\Ok|Installation|Language|LicenseContent|Page|ContentFile|SimpleUser|Stargazer|RepositorySubscription|Topic|TeamDiscussion|TeamMembership|TeamProject|\ApiClients\Client\GitHubEnterprise\Schema\Operations\Apps\ListInstallationReposForAuthenticatedUser\Response\ApplicationJson\Ok|Package
    {
        if ($pathChunks[0] === '') {
            if ($pathChunks[1] === 'app') {
                ...
                if ($pathChunks[2] === 'v1') {
                    if ($pathChunks[3] === 'access') {
                        if ($pathChunks[4] === 'ssh') {
                            if ($call === 'GET /manage/v1/access/ssh') {
                                return $this->routers->internal🔀Router🔀Get🔀EnterpriseAdmin()->getManageSsh($params);
                            }
                        }
                    } elseif ($pathChunks[3] === 'checks') {
                        if ($pathChunks[4] === 'system-requirements') {
                            if ($call === 'GET /manage/v1/checks/system-requirements') {
                                return $this->routers->internal🔀Router🔀Get🔀EnterpriseAdmin()->getChecksSystemRequirements($params);
                            }
                        }
                    } elseif ($pathChunks[3] === 'cluster') {
                        if ($pathChunks[4] === 'status') {
                            if ($call === 'GET /manage/v1/cluster/status') {
                                return $this->routers->internal🔀Router🔀Get🔀EnterpriseAdmin()->getClusterStatus($params);
                            }
                        }
                    } elseif ($pathChunks[3] === 'config') {
                        if ($pathChunks[4] === 'apply') {
                            if ($call === 'GET /manage/v1/config/apply') {
                                return $this->routers->internal🔀Router🔀Get🔀EnterpriseAdmin()->getManageConfigApplyStatus($params);
                            }
                        } elseif ($pathChunks[4] === 'license') {
                            if ($call === 'GET /manage/v1/config/license') {
                                return $this->routers->internal🔀Router🔀Get🔀EnterpriseAdmin()->licenseInfo($params);
                            }
                        } elseif ($pathChunks[4] === 'nodes') {
                            if ($call === 'GET /manage/v1/config/nodes') {
                                return $this->routers->internal🔀Router🔀Get🔀EnterpriseAdmin()->getConfigNodes($params);
                            }
                        } elseif ($pathChunks[4] === 'settings') {
                            if ($call === 'GET /manage/v1/config/settings') {
                                return $this->routers->internal🔀Router🔀Get🔀EnterpriseAdmin()->getManageSettings($params);
                            }
                        }
