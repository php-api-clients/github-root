...
final class Four
{
    ...
    /** @return Schema\GlobalHook|Schema\PreReceiveEnvironment|Schema\PreReceiveHook|Schema\WebhookConfig|iterable<int,Schema\HookDeliveryItem>|Schema\Installation|Schema\ApplicationGrant|WithoutBody|Schema\LicenseInfo|Schema\EnterpriseOverview|Schema\EnterpriseCommentOverview|Schema\EnterpriseGistOverview|Schema\EnterpriseHookOverview|Schema\EnterpriseIssueOverview|Schema\EnterpriseMilestoneOverview|Schema\EnterpriseOrganizationOverview|Schema\EnterprisePageOverview|Schema\EnterprisePullRequestOverview|Schema\EnterpriseRepositoryOverview|Schema\EnterpriseSecurityProductsOverview|Schema\EnterpriseUserOverview|iterable<int,Schema\AuditLogEvent>|Schema\EnterpriseSecurityAnalysisSettings|iterable<int,Schema\GistComment>|iterable<int,Schema\GistCommit>|iterable<int,Schema\GistSimple>|Schema\GistSimple|Schema\GitignoreTemplate|iterable<int,Schema\GhesGetMaintenance>|iterable<int,Schema\GhesVersion>|Schema\Thread|Schema\Operations\Orgs\ListCustomRoles\Response\ApplicationJson\Ok|Schema\AnnouncementBanner|Schema\Operations\Orgs\ListCustomRepoRoles\Response\ApplicationJson\Ok\Application\Json|iterable<int,Schema\Event>|Schema\ExternalGroups|iterable<int,Schema\OrgHook>|Schema\Operations\Orgs\ListAppInstallations\Response\ApplicationJson\Ok|iterable<int,Schema\Issue>|iterable<int,Schema\SimpleUser>|iterable<int,Schema\Migration>|iterable<int,Schema\OrganizationFineGrainedPermission>|Schema\Operations\Orgs\ListOrgRoles\Response\ApplicationJson\Ok|iterable<int,Schema\Package>|iterable<int,Schema\OrganizationProgrammaticAccessGrantRequest>|iterable<int,Schema\OrganizationProgrammaticAccessGrant>|iterable<int,Schema\OrgPreReceiveHook>|iterable<int,Schema\Project>|iterable<int,Schema\MinimalRepository>|iterable<int,Schema\RepositoryFineGrainedPermission>|iterable<int,Schema\RepositoryRuleset>|iterable<int,Schema\TeamSimple>|iterable<int,Schema\Team>|Schema\ProjectColumn|iterable<int,Schema\ProjectColumn>|Schema\FullRepository|Schema\BasicError|Schema\ConfigurationStatus|Schema\MaintenanceStatus|Schema\EnterpriseSettings|iterable<int,Schema\TeamDiscussion>|iterable<int,Schema\TeamProject>|Schema\GpgKey|Schema\Key|iterable<int,Schema\OrgMembership>|Schema\SshSigningKey|iterable<int,Schema\BaseGist>|iterable<int,Schema\GpgKey>|Schema\Hovercard|iterable<int,Schema\KeySimple>|iterable<int,Schema\OrganizationSimple>|iterable<int,Schema\SocialAccount>|iterable<int,Schema\SshSigningKey>|Schema\StarredRepository|Schema\Repository */
