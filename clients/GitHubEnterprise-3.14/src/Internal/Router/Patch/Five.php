...
final class Five
{
    ...
    /** @return Schema\GistComment|Schema\OrganizationCustomRepositoryRole|Schema\OrgHook|Schema\OrganizationRole|Schema\OrgPreReceiveHook|iterable<int,Schema\CustomProperty>|WithoutBody|Schema\TeamFull|Schema\ProjectCard|Schema\TeamDiscussion|Schema\OrgMembership */
