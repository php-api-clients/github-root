...
final class Five
{
    ...
    /** @return WithoutBody|iterable<int,Schema\GhesDeleteSshResponse>|Schema\OrgPreReceiveHook|iterable<int,Schema\SshKey> */
            ...
            if ($pathChunks[1] === 'admin') {
                ...
                if ($pathChunks[2] === 'v1') {
                    if ($pathChunks[3] === 'access') {
                        if ($pathChunks[4] === 'ssh') {
                            if ($call === 'DELETE /manage/v1/access/ssh') {
                                return $this->routers->internal🔀Router🔀Delete🔀EnterpriseAdmin()->deleteManageSsh($params);
                            }
                        }
                    }
                }
