...
final readonly class CreateOrUpdateCustomPropertiesValues
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Repos\CreateOrUpdateCustomPropertiesValues($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo);
