...
final readonly class ListOrganizationFineGrainedPermissions
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Orgs\ListOrganizationFineGrainedPermissions($this->responseSchemaValidator, $this->hydrator, $org);
