...
final readonly class GetCustomProperty
{
    ...
    public function call(string $org, string $customPropertyName): CustomProperty
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Orgs\GetCustomProperty($this->responseSchemaValidator, $this->hydrator, $org, $customPropertyName);
