...
final readonly class ListOrgRoleTeamsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Orgs\ListOrgRoleTeamsListing($this->responseSchemaValidator, $this->hydrator, $org, $roleId, $perPage, $page);
