...
use ApiClients\Client\GitHubEnterprise\Internal\Attribute\CastUnionToType\Schema\WebhookDeploymentStatusCreated\Deployment\Payload;
...
use ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\CheckRun;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\Creator;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp\Owner;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp\Permissions;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\Actor;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\HeadRepository;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\Repository;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\TriggeringActor;
use ApiClients\Client\GitHubEnterprise\Schema\WebhooksWorkflow;
...
class DeploymentStatus implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\CheckRun' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️CheckRun($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\Creator' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️Creator($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️PerformedViaGithubApp($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp\Owner' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️PerformedViaGithubApp⚡️Owner($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp\Permissions' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️PerformedViaGithubApp⚡️Permissions($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\Creator' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus⚡️Creator($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\PerformedViaGithubApp' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus⚡️PerformedViaGithubApp($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\PerformedViaGithubApp\Owner' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus⚡️PerformedViaGithubApp⚡️Owner($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\PerformedViaGithubApp\Permissions' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus⚡️PerformedViaGithubApp⚡️Permissions($payload),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhooksWorkflow' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhooksWorkflow($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\Actor' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️Actor($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\HeadRepository' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️HeadRepository($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\HeadRepository\Owner' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️HeadRepository⚡️Owner($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\Repository' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️Repository($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\Repository\Owner' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️Repository⚡️Owner($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\TriggeringActor' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️TriggeringActor($payload),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentCreated\WorkflowRun\HeadRepository\Owner' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentCreated⚡️WorkflowRun⚡️HeadRepository⚡️Owner($payload),
            default => throw UnableToHydrateObject::noHydrationDefined($className, $this->hydrationStack),
        };
    }

    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated(array $payload): WebhookDeploymentStatusCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️CheckRun($value);
                } finally {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhooksWorkflow($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️CheckRun(array $payload): CheckRun
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\CheckRun', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment(array $payload): Deployment
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️Creator($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️PerformedViaGithubApp($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️Creator(array $payload): Creator
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\Creator', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️PerformedViaGithubApp(array $payload): PerformedViaGithubApp
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️PerformedViaGithubApp⚡️Owner($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️PerformedViaGithubApp⚡️Permissions($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️PerformedViaGithubApp⚡️Owner(array $payload): Owner
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp\Owner', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️PerformedViaGithubApp⚡️Permissions(array $payload): Permissions
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp\Permissions', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'creator';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus⚡️Creator($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'performedViaGithubApp';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus⚡️PerformedViaGithubApp($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus⚡️Creator(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\Creator
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\Creator', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\Creator::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\Creator(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\Creator', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus⚡️PerformedViaGithubApp(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\PerformedViaGithubApp
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'owner';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus⚡️PerformedViaGithubApp⚡️Owner($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'permissions';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus⚡️PerformedViaGithubApp⚡️Permissions($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\PerformedViaGithubApp', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\PerformedViaGithubApp::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\PerformedViaGithubApp(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\PerformedViaGithubApp', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus⚡️PerformedViaGithubApp⚡️Owner(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\PerformedViaGithubApp\Owner
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\PerformedViaGithubApp\Owner', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\PerformedViaGithubApp\Owner::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\PerformedViaGithubApp\Owner(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\PerformedViaGithubApp\Owner', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus⚡️PerformedViaGithubApp⚡️Permissions(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\PerformedViaGithubApp\Permissions
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\PerformedViaGithubApp\Permissions', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\PerformedViaGithubApp\Permissions::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\PerformedViaGithubApp\Permissions(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\PerformedViaGithubApp\Permissions', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhooksWorkflow(array $payload): WebhooksWorkflow
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhooksWorkflow', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun(array $payload): WorkflowRun
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️Actor($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️HeadRepository($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'repository';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️Repository($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️TriggeringActor($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️Actor(array $payload): Actor
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\Actor', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️HeadRepository(array $payload): HeadRepository
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    $this->hydrationStack[] = 'owner';
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentCreated⚡️WorkflowRun⚡️HeadRepository⚡️Owner($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\HeadRepository', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️HeadRepository⚡️Owner(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\HeadRepository\Owner
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\HeadRepository\Owner', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\HeadRepository\Owner::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\HeadRepository\Owner(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\HeadRepository\Owner', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️Repository(array $payload): Repository
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\Repository', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️Repository⚡️Owner(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\Repository\Owner
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\Repository\Owner', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\Repository\Owner::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\Repository\Owner(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\Repository\Owner', $exception, stack: $this->hydrationStack);
        }
    }

    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️TriggeringActor(array $payload): TriggeringActor
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\TriggeringActor', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentCreated⚡️WorkflowRun⚡️HeadRepository⚡️Owner(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentCreated\WorkflowRun\HeadRepository\Owner
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentCreated\WorkflowRun\HeadRepository\Owner', $exception, stack: $this->hydrationStack);
        }

        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentCreated\WorkflowRun\HeadRepository\Owner::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentCreated\WorkflowRun\HeadRepository\Owner(...$properties);
        } catch (Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentCreated\WorkflowRun\HeadRepository\Owner', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\CheckRun' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️CheckRun($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\Creator' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️Creator($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️PerformedViaGithubApp($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp\Owner' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️PerformedViaGithubApp⚡️Owner($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\Deployment\PerformedViaGithubApp\Permissions' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️PerformedViaGithubApp⚡️Permissions($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\Creator' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus⚡️Creator($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\PerformedViaGithubApp' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus⚡️PerformedViaGithubApp($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\PerformedViaGithubApp\Owner' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus⚡️PerformedViaGithubApp⚡️Owner($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\PerformedViaGithubApp\Permissions' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus⚡️PerformedViaGithubApp⚡️Permissions($object),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhooksWorkflow' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhooksWorkflow($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\Actor' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️Actor($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\HeadRepository' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️HeadRepository($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\HeadRepository\Owner' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️HeadRepository⚡️Owner($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\Repository' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️Repository($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\Repository\Owner' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️Repository⚡️Owner($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\TriggeringActor' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️TriggeringActor($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated(mixed $object): mixed
    {
        ...
        $checkRun                                   = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️CheckRun($checkRun);
        after_checkRun:        $result['check_run'] = $checkRun;

        $deployment                                    = $object->deployment;
        $deployment                                    = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment($deployment);
        after_deployment:        $result['deployment'] = $deployment;

        $deploymentStatus                                           = $object->deploymentStatus;
        $deploymentStatus                                           = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus($deploymentStatus);
        ...
        $workflow                                  = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhooksWorkflow($workflow);
        ...
        $workflowRun                                      = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun($workflowRun);
        after_workflowRun:        $result['workflow_run'] = $workflowRun;

        return $result;
    }

    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️CheckRun(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment(mixed $object): mixed
    {
        ...
        $creator                                 = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️Creator($creator);
        ...
        $performedViaGithubApp                                                  = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️PerformedViaGithubApp($performedViaGithubApp);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️Creator(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️PerformedViaGithubApp(mixed $object): mixed
    {
        ...
        $owner                               = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️PerformedViaGithubApp⚡️Owner($owner);
        ...
        $permissions                                     = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️PerformedViaGithubApp⚡️Permissions($permissions);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️PerformedViaGithubApp⚡️Owner(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️Deployment⚡️PerformedViaGithubApp⚡️Permissions(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus);
        $result = [];
        ...
        $creator                                 = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus⚡️Creator($creator);
        after_creator:        $result['creator'] = $creator;
        ...
        $performedViaGithubApp                                                  = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus⚡️PerformedViaGithubApp($performedViaGithubApp);
        after_performedViaGithubApp:        $result['performed_via_github_app'] = $performedViaGithubApp;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus⚡️Creator(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\Creator);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus⚡️PerformedViaGithubApp(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\PerformedViaGithubApp);
        $result = [];
        ...
        $owner                               = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus⚡️PerformedViaGithubApp⚡️Owner($owner);
        after_owner:        $result['owner'] = $owner;
        ...
        $permissions                                     = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus⚡️PerformedViaGithubApp⚡️Permissions($permissions);
        after_permissions:        $result['permissions'] = $permissions;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus⚡️PerformedViaGithubApp⚡️Owner(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\PerformedViaGithubApp\Owner);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️DeploymentStatus⚡️PerformedViaGithubApp⚡️Permissions(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\DeploymentStatus\PerformedViaGithubApp\Permissions);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhooksWorkflow(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun(mixed $object): mixed
    {
        ...
        $actor                               = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️Actor($actor);
        ...
        $headRepository                                         = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️HeadRepository($headRepository);
        ...
        $repository                                    = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️Repository($repository);
        after_repository:        $result['repository'] = $repository;
        ...
        $triggeringActor                                          = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️TriggeringActor($triggeringActor);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️Actor(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️HeadRepository(mixed $object): mixed
    {
        ...
        $owner                               = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentCreated⚡️WorkflowRun⚡️HeadRepository⚡️Owner($owner);
        after_owner:        $result['owner'] = $owner;
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️HeadRepository⚡️Owner(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\HeadRepository\Owner);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️Repository(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️Repository⚡️Owner(mixed $object): mixed
    {
        assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\WebhookDeploymentStatusCreated\WorkflowRun\Repository\Owner);
        $result = [];
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookDeploymentStatusCreated⚡️WorkflowRun⚡️TriggeringActor(mixed $object): mixed
    {
