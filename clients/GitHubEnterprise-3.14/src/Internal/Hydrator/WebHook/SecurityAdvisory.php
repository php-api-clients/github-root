...
use ApiClients\Client\GitHubEnterprise\Schema\CvssSeverities;
use ApiClients\Client\GitHubEnterprise\Schema\CvssSeverities\CvssVFour;
...
use ApiClients\Client\GitHubEnterprise\Schema\WebhooksSecurityAdvisory;
use ApiClients\Client\GitHubEnterprise\Schema\WebhooksSecurityAdvisory\Cvss;
...
class SecurityAdvisory implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookSecurityAdvisoryPublished' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookSecurityAdvisoryPublished($payload),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhooksSecurityAdvisory' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhooksSecurityAdvisory($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhooksSecurityAdvisory\Cvss' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhooksSecurityAdvisory⚡️Cvss($payload),
        ...
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhooksSecurityAdvisory($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhooksSecurityAdvisory(array $payload): WebhooksSecurityAdvisory
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhooksSecurityAdvisory⚡️Cvss($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️CvssSeverities($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhooksSecurityAdvisory', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhooksSecurityAdvisory⚡️Cvss(array $payload): Cvss
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhooksSecurityAdvisory\Cvss', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️CvssSeverities(array $payload): CvssSeverities
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️CvssSeverities⚡️CvssVThree($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️CvssSeverities⚡️CvssVFour($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\CvssSeverities', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️CvssSeverities⚡️CvssVThree(array $payload): CvssVThree
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\CvssSeverities\CvssVThree', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️CvssSeverities⚡️CvssVFour(array $payload): CvssVFour
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\CvssSeverities\CvssVFour', $exception, stack: $this->hydrationStack);
        }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhooksSecurityAdvisory' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhooksSecurityAdvisory($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhooksSecurityAdvisory\Cvss' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhooksSecurityAdvisory⚡️Cvss($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookSecurityAdvisoryPublished(mixed $object): mixed
    {
        ...
        $securityAdvisory                                           = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhooksSecurityAdvisory($securityAdvisory);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhooksSecurityAdvisory(mixed $object): mixed
    {
        assert($object instanceof WebhooksSecurityAdvisory);
        $result = [];

        $cvss                              = $object->cvss;
        $cvss                              = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhooksSecurityAdvisory⚡️Cvss($cvss);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhooksSecurityAdvisory⚡️Cvss(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️CvssSeverities(mixed $object): mixed
    {
        ...
        $cvssVThree                                 = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️CvssSeverities⚡️CvssVThree($cvssVThree);
        ...
        $cvssVFour                                 = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️CvssSeverities⚡️CvssVFour($cvssVFour);
        after_cvssVFour:        $result['cvss_v4'] = $cvssVFour;

        return $result;
    }

    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️CvssSeverities⚡️CvssVThree(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️CvssSeverities⚡️CvssVFour(mixed $object): mixed
    {
