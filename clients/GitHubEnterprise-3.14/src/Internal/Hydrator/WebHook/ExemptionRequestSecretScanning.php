...
use ApiClients\Client\GitHubEnterprise\Schema\WebhookExemptionRequestCancelled;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookExemptionRequestCompleted;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookExemptionRequestCreated;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookExemptionRequestResponseDismissed;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookExemptionRequestResponseSubmitted;
...
class ExemptionRequestSecretScanning implements ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload): object
    {
        return match ($className) {
            'ApiClients\Client\GitHubEnterprise\Schema\WebhookExemptionRequestCancelled' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookExemptionRequestCancelled($payload),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\ExemptionRequest' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️ExemptionRequest($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookExemptionRequestCompleted' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookExemptionRequestCompleted($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookExemptionRequestCreated' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookExemptionRequestCreated($payload),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookExemptionRequestResponseDismissed' => $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookExemptionRequestResponseDismissed($payload),
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookExemptionRequestCancelled(array $payload): WebhookExemptionRequestCancelled
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️ExemptionRequest($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookExemptionRequestCancelled', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️ExemptionRequest(array $payload): ExemptionRequest
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\ExemptionRequest', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookExemptionRequestCompleted(array $payload): WebhookExemptionRequestCompleted
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookExemptionRequestCompleted', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookExemptionRequestCreated(array $payload): WebhookExemptionRequestCreated
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookExemptionRequestCreated', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookExemptionRequestResponseDismissed(array $payload): WebhookExemptionRequestResponseDismissed
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            if (is_array($value)) {
                try {
                    ...
                    $value                  = $this->hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️ExemptionResponse($value);
                } finally {
                    array_pop($this->hydrationStack);
                }
            }
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookExemptionRequestResponseDismissed', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️ExemptionResponse(array $payload): ExemptionResponse
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\ExemptionResponse', $exception, stack: $this->hydrationStack);
        }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookExemptionRequestResponseSubmitted(array $payload): WebhookExemptionRequestResponseSubmitted
    {
        $properties    = [];
        $missingFields = [];
        try {
            ...
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\WebhookExemptionRequestResponseSubmitted', $exception, stack: $this->hydrationStack);
        }
    ...
    public function serializeObjectOfType(object $object, string $className): mixed
    {
        try {
            return match ($className) {
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookExemptionRequestCancelled' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookExemptionRequestCancelled($object),
                ...
                'ApiClients\Client\GitHubEnterprise\Schema\ExemptionRequest' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️ExemptionRequest($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookExemptionRequestCompleted' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookExemptionRequestCompleted($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookExemptionRequestCreated' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookExemptionRequestCreated($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookExemptionRequestResponseDismissed' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookExemptionRequestResponseDismissed($object),
                'ApiClients\Client\GitHubEnterprise\Schema\ExemptionResponse' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️ExemptionResponse($object),
                'ApiClients\Client\GitHubEnterprise\Schema\WebhookExemptionRequestResponseSubmitted' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookExemptionRequestResponseSubmitted($object),
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookExemptionRequestCancelled(mixed $object): mixed
    {
        ...
        $exemptionRequest                                           = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️ExemptionRequest($exemptionRequest);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️ExemptionRequest(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookExemptionRequestCompleted(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookExemptionRequestCreated(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookExemptionRequestResponseDismissed(mixed $object): mixed
    {
        ...
        $exemptionResponse                                            = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️ExemptionResponse($exemptionResponse);
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️ExemptionResponse(mixed $object): mixed
    {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookExemptionRequestResponseSubmitted(mixed $object): mixed
    {
