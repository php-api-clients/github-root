...
use ApiClients\Client\GitHubEnterprise\Schema\WebhookGithubAppAuthorizationRevoked;
...
class GithubAppAuthorization implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookGithubAppAuthorizationRevoked(array $payload): WebhookGithubAppAuthorizationRevoked
    {
        $properties    = [];
        $missingFields = [];
        try {
