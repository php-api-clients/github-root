...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Orgs\Org\Teams\TeamSlug\Discussions\DiscussionNumber\Comments;
...
class CommentNumber implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️TeamDiscussionComment(array $payload): TeamDiscussionComment
    {
        $properties    = [];
        $missingFields = [];
        try {
