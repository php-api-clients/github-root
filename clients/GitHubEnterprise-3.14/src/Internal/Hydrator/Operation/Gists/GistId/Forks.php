...
use ApiClients\Client\GitHubEnterprise\Schema\BaseGist\Files;
...
class Forks implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️BaseGist(array $payload): BaseGist
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️BaseGist⚡️Files(array $payload): Files
    {
        $properties    = [];
        $missingFields = [];
        try {
