...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\User\GpgKeys;
...
class GpgKeyId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️GpgKey(array $payload): GpgKey
    {
        $properties    = [];
        $missingFields = [];
        try {
