...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Repos\Owner\Repo\Issues\IssueNumber;
...
class Comments implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️IssueComment(array $payload): IssueComment
    {
        $properties    = [];
        $missingFields = [];
        try {
