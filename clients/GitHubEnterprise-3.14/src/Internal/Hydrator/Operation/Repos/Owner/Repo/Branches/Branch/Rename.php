...
use ApiClients\Client\GitHubEnterprise\Internal\Attribute\CastUnionToType\Schema\Commit\Author;
use ApiClients\Client\GitHubEnterprise\Internal\Attribute\CastUnionToType\Schema\Commit\Committer;
...
class Rename implements ObjectMapper
{
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Commit(mixed $object): mixed
    {
        ...
        $author = match ($author::class) {
                        'ApiClients\Client\GitHubEnterprise\Schema\SimpleUser' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️SimpleUser($author),
            'ApiClients\Client\GitHubEnterprise\Schema\EmptyObject' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️EmptyObject($author),
        };
        after_author:        $result['author'] = $author;

        $committer = $object->committer;
        $committer = match ($committer::class) {
                        'ApiClients\Client\GitHubEnterprise\Schema\SimpleUser' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️SimpleUser($committer),
            'ApiClients\Client\GitHubEnterprise\Schema\EmptyObject' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️EmptyObject($committer),
        };
