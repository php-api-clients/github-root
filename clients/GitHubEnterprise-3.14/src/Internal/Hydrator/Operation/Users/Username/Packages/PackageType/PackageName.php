...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Users\Username\Packages\PackageType;
...
class PackageName implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Package(array $payload): Package
    {
        $properties    = [];
        $missingFields = [];
        try {
