...
class RateLimit implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️RateLimitOverview(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\RateLimitOverview
    {
        $properties = []; 
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\RateLimitOverview::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\RateLimitOverview(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\RateLimitOverview', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️RateLimitOverview⚡️Resources(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\RateLimitOverview\Resources
    {
        $properties = []; 
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\RateLimitOverview\Resources::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\RateLimitOverview\Resources(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\RateLimitOverview\Resources', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\RateLimitOverview);
        $result = [];
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\RateLimitOverview\Resources);
        $result = [];
        ...
        $source_import = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️RateLimit($source_import);
        ...
        $integration_manifest = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️RateLimit($integration_manifest);
        ...
        $code_scanning_upload = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️RateLimit($code_scanning_upload);
        ...
        $actions_runner_registration = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️RateLimit($actions_runner_registration);
