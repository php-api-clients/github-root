...
final readonly class GpgKey
{
    ...
    /**
     * @var array<Schema\GpgKey\Emails>
     */
    public ?array $emails;
    /**
     * @var array<Schema\GpgKey\Subkeys>
     */
