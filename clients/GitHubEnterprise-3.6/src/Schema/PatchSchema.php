...
use ApiClients\Client\GitHubEnterprise\Schema\PatchSchema\Operations;
...
final readonly class PatchSchema
{
     ...
     */
    public function __construct(#[MapFrom('Operations')] #[CastListToType(Schema\PatchSchema\Operations::class)] public array $operations, public array $schemas)
    {
    }
}
