...
final readonly class ExternalGroup
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"group_id":1,"group_name":"group-azuread-test","updated_at":"2021-01-03 22:27:15:000 -700","teams":[{"team_id":1,"team_name":"team-test"}],"members":[{"member_id":2,"member_login":"octo-lisa_eocsaxrs","member_name":"Octo Lisa","member_email":"octo_lisa@github.com"}]}';
    /**
     ...
     * @param ?array<\ApiClients\Client\GitHubEnterprise\Schema\ExternalGroup\Teams> $teams
     * members: An array of external members linked to this group
     * @param ?array<\ApiClients\Client\GitHubEnterprise\Schema\ExternalGroup\Members> $members
     */
