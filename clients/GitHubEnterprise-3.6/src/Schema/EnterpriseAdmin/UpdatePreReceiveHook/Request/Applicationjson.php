...
final readonly class Applicationjson
{
     ...
     */
    public function __construct(public ?string $name, public ?string $script, #[MapFrom('script_repository')] public mixed $scriptRepository, public mixed $environment, public ?string $enforcement, #[MapFrom('allow_downstream_configuration')] public ?bool $allowDownstreamConfiguration)
    {
    }
}
