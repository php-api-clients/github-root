...
final readonly class Page
{
    ...
    public function __construct(string $url, string $status, string $cname, string $protected_domain_state, string $pending_domain_unverified_at, bool $custom_404, string $html_url, string $build_type, Schema\PagesSourceHash $source, bool $public, Schema\PagesHttpsCertificate $https_certificate, bool $https_enforced)
    {
        $this->url = $url;
        $this->status = $status;
        $this->cname = $cname;
