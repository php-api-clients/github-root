...
final readonly class UserResponse
{
    ...
    public Schema\UserNameResponse $name;
    /**
     ...
     * @var array<Schema\UserEmailsResponse>
     */
    public ?array $emails;
    /**
     ...
     */
    public array $roles;
    public function __construct(array $schemas, string $externalId, bool $active, string $userName, Schema\UserNameResponse $name, string $displayName, array $emails, array $roles)
    {
