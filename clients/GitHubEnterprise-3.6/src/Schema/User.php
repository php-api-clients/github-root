...
final readonly class User
{
     ...
     * @param array<UserEmails> $emails  roles: The roles assigned to the user.
     * @param ?array<UserRole>  $roles
     */
    public function __construct(public array $schemas, public string $externalId, public bool $active, public string $userName, public ?Schema\UserName $name, public string $displayName, #[CastListToType(Schema\UserEmails::class)] public array $emails, #[CastListToType(Schema\UserRole::class)] public ?array $roles)
    {
    }
}
