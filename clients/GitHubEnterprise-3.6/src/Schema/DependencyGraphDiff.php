...
use ApiClients\Client\GitHubEnterprise\Schema\DependencyGraphDiff\Vulnerabilities;
...
final readonly class DependencyGraphDiff
{
     ...
     */
    public function __construct(#[MapFrom('change_type')] public string $changeType, public string $manifest, public string $ecosystem, public string $name, public string $version, #[MapFrom('package_url')] public ?string $packageUrl, public ?string $license, #[MapFrom('source_repository_url')] public ?string $sourceRepositoryUrl, #[CastListToType(Schema\DependencyGraphDiff\Vulnerabilities::class)] public array $vulnerabilities)
    {
    }
}
