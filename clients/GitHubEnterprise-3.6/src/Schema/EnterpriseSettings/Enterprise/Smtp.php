...
final readonly class Smtp
{
    ...
    public function __construct(public ?bool $enabled, public ?string $address, public ?string $authentication, public ?string $port, public ?string $domain, public ?string $username, #[MapFrom('user_name')] public ?string $userName, #[MapFrom('enable_starttls_auto')] public ?bool $enableStarttlsAuto, public ?string $password, #[MapFrom('discard_MINUS_to_MINUS_noreply_MINUS_address')] public ?bool $discardMinusToMinusNoreplyMinusAddress, #[MapFrom('support_address')] public ?string $supportAddress, #[MapFrom('support_address_type')] public ?string $supportAddressType, #[MapFrom('noreply_address')] public ?string $noreplyAddress)
    {
    }
}
