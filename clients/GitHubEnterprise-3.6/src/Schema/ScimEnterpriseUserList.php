...
final readonly class ScimEnterpriseUserList
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"schemas":["urn:ietf:params:scim:api:messages:2.0:ListResponse"],"totalResults":1,"Resources":[null],"startIndex":1,"itemsPerPage":20}';
    /**
