...
final class Hydrators implements \EventSauce\ObjectHydrator\ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload) : object
    {
        return match ($className) {
            ...
            'ApiClients\\Client\\GitHubEnterprise\\Schema\\IntegrationInstallationRequest', 'ApiClients\\Client\\GitHubEnterprise\\Schema\\Enterprise' => $this->getObjectMapperOperation🌀App🌀InstallationRequests()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\GitHubEnterprise\\Schema\\ScimEnterpriseUserList', 'ApiClients\\Client\\GitHubEnterprise\\Schema\\ScimEnterpriseUserList\\Resources', 'ApiClients\\Client\\GitHubEnterprise\\Schema\\ScimEnterpriseUserResponse' => $this->getObjectMapperOperation🌀Scim🌀V2🌀Users()->hydrateObject($className, $payload),
    ...
    public function serializeObject(object $object) : mixed
    {
        return match ($object::class) {
            ...
            'ApiClients\\Client\\GitHubEnterprise\\Schema\\IntegrationInstallationRequest', 'ApiClients\\Client\\GitHubEnterprise\\Schema\\Enterprise' => $this->getObjectMapperOperation🌀App🌀InstallationRequests()->serializeObject($object),
            ...
            'ApiClients\\Client\\GitHubEnterprise\\Schema\\ScimEnterpriseUserList', 'ApiClients\\Client\\GitHubEnterprise\\Schema\\ScimEnterpriseUserList\\Resources', 'ApiClients\\Client\\GitHubEnterprise\\Schema\\ScimEnterpriseUserResponse' => $this->getObjectMapperOperation🌀Scim🌀V2🌀Users()->serializeObject($object),
