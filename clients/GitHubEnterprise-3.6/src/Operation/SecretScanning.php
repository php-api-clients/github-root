...
final class SecretScanning
{
    ...
    public function listAlertsForRepo(string $owner, string $repo, string $state, string $secretType, string $resolution, string $sort, string $direction, int $page, int $perPage): iterable
    {
    ...
    /** @return iterable<Schema\SecretScanningAlert>|array{code:int} */
    public function listAlertsForRepoListing(string $owner, string $repo, string $state, string $secretType, string $resolution, string $sort, string $direction, int $page, int $perPage): iterable
    {
