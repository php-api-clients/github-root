...
final class SecretScanning
{
    ...
    public function listAlertsForOrg(string $org, string $state, string $secretType, string $resolution, string $sort, string $direction, int $page, int $perPage): PromiseInterface
    {
    ...
    public function listAlertsForRepo(string $owner, string $repo, string $state, string $secretType, string $resolution, string $sort, string $direction, int $page, int $perPage): PromiseInterface
    {
