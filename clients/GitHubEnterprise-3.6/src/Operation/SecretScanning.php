...
final class SecretScanning
{
    ...
    public function listAlertsForOrg(string $org, string $state, string $secretType, string $resolution, string $sort, string $direction, int $page, int $perPage): Schema\OrganizationSecretScanningAlert
    {
        ...
        return $this->operator[Operator\SecretScanning\ListAlertsForOrg::class]->call($org, $state, $secretType, $resolution, $sort, $direction, $page, $perPage);
    }

    public function listAlertsForOrgListing(string $org, string $state, string $secretType, string $resolution, string $sort, string $direction, int $page, int $perPage): Schema\OrganizationSecretScanningAlert
    {
        ...
        return $this->operator[Operator\SecretScanning\ListAlertsForOrgListing::class]->call($org, $state, $secretType, $resolution, $sort, $direction, $page, $perPage);
    }

    public function listAlertsForRepo(string $owner, string $repo, string $state, string $secretType, string $resolution, string $sort, string $direction, int $page, int $perPage): Schema\SecretScanningAlert
    {
        ...
        return $this->operator[Operator\SecretScanning\ListAlertsForRepo::class]->call($owner, $repo, $state, $secretType, $resolution, $sort, $direction, $page, $perPage);
    }

    public function listAlertsForRepoListing(string $owner, string $repo, string $state, string $secretType, string $resolution, string $sort, string $direction, int $page, int $perPage): Schema\SecretScanningAlert
    {
        ...
        return $this->operator[Operator\SecretScanning\ListAlertsForRepoListing::class]->call($owner, $repo, $state, $secretType, $resolution, $sort, $direction, $page, $perPage);
    }
