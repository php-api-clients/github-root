...
final class GetActionsCacheUsageByRepoForOrg
{
    ...
    private readonly Hydrator\Operation\Orgs\Org\Actions\Cache\UsageByRepository $hydrator;

    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Orgs\Org\Actions\Cache\UsageByRepository $hydrator, string $org, int $perPage = 30, int $page = 1)
    {
        $this->org                     = $org;
