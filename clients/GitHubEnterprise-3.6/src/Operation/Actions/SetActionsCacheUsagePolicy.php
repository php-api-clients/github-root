...
final class SetActionsCacheUsagePolicy
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(Schema\ActionsCacheUsagePolicyForRepository::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));
