...
final class ReviewPendingDeploymentsForRun
{
    ...
    public function __construct(\League\OpenAPIValidation\Schema\SchemaValidator $requestSchemaValidator, \League\OpenAPIValidation\Schema\SchemaValidator $responseSchemaValidator, Hydrator\Operation\Repos\CbOwnerRcb\CbRepoRcb\Actions\Runs\CbRunIdRcb\PendingDeployments $hydrator, string $owner, string $repo, int $run_id)
    {
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(Schema\Actions\ReviewPendingDeploymentsForRun\Request\Applicationjson::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));
