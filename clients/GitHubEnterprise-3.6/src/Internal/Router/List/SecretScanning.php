...
final class SecretScanning
{
    ...
    public function listAlertsForOrgListing(array $params): iterable
    {
        ...
        do {
            ...
            $items    = [...$operator->call($arguments['org'], $arguments['state'], $arguments['secret_type'], $arguments['resolution'], $arguments['sort'], $arguments['direction'], $arguments['page'], $arguments['per_page'])];
    ...
    public function listAlertsForRepoListing(array $params): iterable|WithoutBody
    {
        ...
        do {
            ...
            $items    = [...$operator->call($arguments['owner'], $arguments['repo'], $arguments['state'], $arguments['secret_type'], $arguments['resolution'], $arguments['sort'], $arguments['direction'], $arguments['page'], $arguments['per_page'])];
