...
final readonly class ListCacheInfoListing
{
    public const OPERATION_ID    = 'repos/list-cache-info';
    public const OPERATION_MATCH = 'LIST /repos/{owner}/{repo}/replicas/caches';

    public function __construct(private Browser $browser, private AuthenticationInterface $authentication, private SchemaValidator $responseSchemaValidator, private Internal\Hydrator\Operation\Repos\Owner\Repo\Replicas\Caches $hydrator)
    {
    }
