...
final readonly class DeleteArchiveForOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Migrations\DeleteArchiveForOrg($this->responseSchemaValidator, $this->hydrator, $org, $migrationId);
