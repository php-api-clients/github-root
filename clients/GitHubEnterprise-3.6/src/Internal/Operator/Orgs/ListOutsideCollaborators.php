...
final readonly class ListOutsideCollaborators
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Orgs\ListOutsideCollaborators($this->responseSchemaValidator, $this->hydrator, $org, $filter, $perPage, $page);
