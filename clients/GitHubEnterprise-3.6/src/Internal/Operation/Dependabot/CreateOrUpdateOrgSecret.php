...
final class CreateOrUpdateOrgSecret
{
    ...
    public function createRequest(array $data): RequestInterface
    {
        ...
        return new Request('PUT', str_replace(['{org}', '{secret_name}'], [$this->org, $this->secretName], '/orgs/{org}/dependabot/secrets/{secret_name}'), ['Content-Type' => 'application/json'], json_encode($data));
    }
