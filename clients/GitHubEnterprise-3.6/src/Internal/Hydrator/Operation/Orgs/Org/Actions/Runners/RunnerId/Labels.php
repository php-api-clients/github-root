...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Orgs\Org\Actions\Runners\RunnerId;
...
class Labels implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Operations⚡️Actions⚡️RemoveAllCustomLabelsFromSelfHostedRunnerForOrg⚡️Response⚡️ApplicationJson⚡️Ok⚡️Application⚡️Json(array $payload): Json
    {
        $properties    = [];
        $missingFields = [];
        try {
