...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Notifications\Threads\ThreadId;
...
class Subscription implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️ThreadSubscription(array $payload): ThreadSubscription
    {
        $properties    = [];
        $missingFields = [];
        try {
