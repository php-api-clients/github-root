...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Repos\Owner\Repo\Pulls;

use ApiClients\Client\GitHubEnterprise\Schema\AutoMerge;
use ApiClients\Client\GitHubEnterprise\Schema\BasicError;
use ApiClients\Client\GitHubEnterprise\Schema\LicenseSimple;
use ApiClients\Client\GitHubEnterprise\Schema\Link;
...
use ApiClients\Client\GitHubEnterprise\Schema\PullRequest\Base;
use ApiClients\Client\GitHubEnterprise\Schema\PullRequest\Head;
use ApiClients\Client\GitHubEnterprise\Schema\PullRequest\Head\Repo;
use ApiClients\Client\GitHubEnterprise\Schema\PullRequest\Head\Repo\License;
use ApiClients\Client\GitHubEnterprise\Schema\PullRequest\Head\Repo\Owner;
use ApiClients\Client\GitHubEnterprise\Schema\PullRequest\Head\Repo\Permissions;
use ApiClients\Client\GitHubEnterprise\Schema\PullRequest\Head\User;
use ApiClients\Client\GitHubEnterprise\Schema\PullRequest\Links;
...
class PullNumber implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️PullRequest(array $payload): PullRequest
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️PullRequest⚡️Head(array $payload): Head
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️PullRequest⚡️Head⚡️Repo(array $payload): Repo
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️PullRequest⚡️Head⚡️Repo⚡️Owner(array $payload): Owner
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️PullRequest⚡️Head⚡️Repo⚡️Permissions(array $payload): Permissions
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️PullRequest⚡️Head⚡️Repo⚡️License(array $payload): License
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️PullRequest⚡️Head⚡️User(array $payload): User
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️PullRequest⚡️Base(array $payload): Base
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️PullRequest⚡️Links(array $payload): Links
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Link(array $payload): Link
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️AutoMerge(array $payload): AutoMerge
    {
        $properties    = [];
        $missingFields = [];
        try {
