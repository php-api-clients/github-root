...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Repos\Owner\Repo\Environments;

use ApiClients\Client\GitHubEnterprise\Schema\BasicError;
use ApiClients\Client\GitHubEnterprise\Schema\DeploymentBranchPolicySettings;
...
class EnvironmentName implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Environment(array $payload): Environment
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️DeploymentBranchPolicySettings(array $payload): DeploymentBranchPolicySettings
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Environment(mixed $object): mixed
    {
        ...
        $deploymentBranchPolicy                                                  = $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️DeploymentBranchPolicySettings($deploymentBranchPolicy);
