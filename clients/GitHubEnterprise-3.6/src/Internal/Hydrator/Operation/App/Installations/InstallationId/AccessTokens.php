...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\App\Installations\InstallationId;
...
class AccessTokens implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️InstallationToken(array $payload): InstallationToken
    {
        $properties    = [];
        $missingFields = [];
        try {
