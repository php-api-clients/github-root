...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Admin\Hooks;

use ApiClients\Client\GitHubEnterprise\Schema\GlobalHook;
use ApiClients\Client\GitHubEnterprise\Schema\GlobalHook\Config;
...
class HookId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️GlobalHook(array $payload): GlobalHook
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️GlobalHook⚡️Config(array $payload): Config
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️GlobalHook2(array $payload): GlobalHook2
    {
        $properties    = [];
        $missingFields = [];
        try {
