                    ...
                    if ($pathChunks[3] === '{repo}') {
                        if ($pathChunks[4] === 'assignees') {
                            ...
                            if ($call === 'LIST /repos/{owner}/{repo}/pre-receive-hooks') {
                                ...
                                return $this->router[Router\List\EnterpriseAdmin::class]->ListPreReceiveHooksForRepoListing($params);
                            }
