...
final readonly class CreateMilestone
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Issues\CreateMilestone($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo);
