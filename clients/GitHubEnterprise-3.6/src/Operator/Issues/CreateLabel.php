...
final readonly class CreateLabel
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Issues\CreateLabel($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo);
