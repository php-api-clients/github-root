...
final readonly class DeleteMilestone
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Issues\DeleteMilestone($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $milestoneNumber);
