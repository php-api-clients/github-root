...
final readonly class GetAllCommonlyUsed
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Licenses\GetAllCommonlyUsed($this->responseSchemaValidator, $this->hydrator, $featured, $perPage, $page);
