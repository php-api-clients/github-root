...
final readonly class ListCommits
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Pulls\ListCommits($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $pullNumber, $perPage, $page);
