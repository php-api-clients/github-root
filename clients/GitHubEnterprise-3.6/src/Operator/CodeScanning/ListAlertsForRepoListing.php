...
final readonly class ListAlertsForRepoListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\CodeScanning\ListAlertsForRepoListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $toolName, $toolGuid, $ref, $state, $page, $perPage, $direction, $sort);
