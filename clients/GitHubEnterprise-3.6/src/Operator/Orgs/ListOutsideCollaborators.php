...
final readonly class ListOutsideCollaborators
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Orgs\ListOutsideCollaborators($this->responseSchemaValidator, $this->hydrator, $org, $filter, $perPage, $page);
