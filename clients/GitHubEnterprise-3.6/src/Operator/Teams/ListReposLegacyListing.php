...
final readonly class ListReposLegacyListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Teams\ListReposLegacyListing($this->responseSchemaValidator, $this->hydrator, $teamId, $perPage, $page);
