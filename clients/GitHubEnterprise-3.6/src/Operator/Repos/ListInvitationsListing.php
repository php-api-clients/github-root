...
final readonly class ListInvitationsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Repos\ListInvitationsListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
