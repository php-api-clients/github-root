...
final readonly class ListBranchesForHeadCommit
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Repos\ListBranchesForHeadCommit($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $commitSha);
