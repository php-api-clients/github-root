...
final readonly class UpdateWebhook
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Repos\UpdateWebhook($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $hookId);
