...
final readonly class DeleteFile
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Repos\DeleteFile($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $path);
