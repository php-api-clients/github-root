...
final readonly class GetCommitSignatureProtection
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Repos\GetCommitSignatureProtection($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $branch);
