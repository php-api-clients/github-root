...
final readonly class ListCommits
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Repos\ListCommits($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $sha, $path, $author, $committer, $since, $until, $perPage, $page);
