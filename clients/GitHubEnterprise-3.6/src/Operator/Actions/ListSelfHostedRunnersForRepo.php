...
final readonly class ListSelfHostedRunnersForRepo
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Actions\ListSelfHostedRunnersForRepo($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
