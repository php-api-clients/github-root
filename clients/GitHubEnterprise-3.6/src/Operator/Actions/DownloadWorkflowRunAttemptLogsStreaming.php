...
final readonly class DownloadWorkflowRunAttemptLogsStreaming
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Actions\DownloadWorkflowRunAttemptLogsStreaming($this->browser, $owner, $repo, $runId, $attemptNumber);
