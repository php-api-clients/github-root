...
final readonly class GetPendingDeploymentsForRun
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Actions\GetPendingDeploymentsForRun($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $runId);
