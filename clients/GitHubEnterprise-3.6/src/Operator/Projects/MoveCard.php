...
final readonly class MoveCard
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Projects\MoveCard($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $cardId);
