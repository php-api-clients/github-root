...
namespace ApiClients\Client\GitHubEnterprise\Operator\Markdown;
...
final readonly class RenderRaw
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Markdown\RenderRaw($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator);
