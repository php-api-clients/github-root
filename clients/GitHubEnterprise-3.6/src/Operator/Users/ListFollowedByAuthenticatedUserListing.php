...
final readonly class ListFollowedByAuthenticatedUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Users\ListFollowedByAuthenticatedUserListing($this->responseSchemaValidator, $this->hydrator, $perPage, $page);
