...
use ApiClients\Client\GitHubEnterprise\Operation\OauthAuthorizations\CreateAuthorization;
...
final class CreateAuthorizationTest extends AsyncTestCase
{
    ...
    public function httpCode_201_requestContentType_application_json_responseContentType_application_json(): void
    {
        ...
        $client->call(CreateAuthorization::OPERATION_MATCH, (static function (array $data): array {
            return $data;
