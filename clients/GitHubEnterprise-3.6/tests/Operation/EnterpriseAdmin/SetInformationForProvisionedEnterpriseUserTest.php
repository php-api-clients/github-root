...
use ApiClients\Client\GitHubEnterprise\Operation\EnterpriseAdmin\SetInformationForProvisionedEnterpriseUser;
...
final class SetInformationForProvisionedEnterpriseUserTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_scim_json(): void
    {
        ...
        $browser->request('PUT', '/scim/v2/Users/generated_null', Argument::type('array'), Schema\User::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(SetInformationForProvisionedEnterpriseUser::OPERATION_MATCH, (static function (array $data): array {
