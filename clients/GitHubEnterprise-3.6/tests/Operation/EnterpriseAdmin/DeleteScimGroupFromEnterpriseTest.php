...
use ApiClients\Client\GitHubEnterprise\Operation\EnterpriseAdmin\DeleteScimGroupFromEnterprise;
...
final class DeleteScimGroupFromEnterpriseTest extends AsyncTestCase
{
    ...
    public function httpCode_400_responseContentType_application_json(): void
    {
        ...
        $browser->request('DELETE', '/scim/v2/Groups/generated_null', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(DeleteScimGroupFromEnterprise::OPERATION_MATCH, (static function (array $data): array {
