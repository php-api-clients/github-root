...
/** @covers \ApiClients\Client\GitHubEnterprise\Operation\EnterpriseAdmin\ProvisionEnterpriseUser */
final class ProvisionEnterpriseUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_201_requestContentType_application_json_responseContentType_application_scim_json_zero(): void
    {
        ...
        $browser->request('POST', '/scim/v2/Users', Argument::type('array'), json_encode(json_decode(Schema\User::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
    ...
    public function operations_httpCode_201_requestContentType_application_json_responseContentType_application_scim_json_zero(): void
    {
        ...
        $browser->request('POST', '/scim/v2/Users', Argument::type('array'), json_encode(json_decode(Schema\User::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->enterpriseAdmin()->provisionEnterpriseUser(json_decode(Schema\User::SCHEMA_EXAMPLE_DATA, true));
    }
