...
use ApiClients\Client\GitHubEnterprise\Operation\EnterpriseAdmin\UpdateAttributeForEnterpriseGroup;
...
final class UpdateAttributeForEnterpriseGroupTest extends AsyncTestCase
{
    ...
    public function httpCode_200_requestContentType_application_json_responseContentType_application_scim_json(): void
    {
        ...
        $browser->request('PATCH', '/scim/v2/Groups/generated_null', Argument::type('array'), Schema\PatchSchema::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(UpdateAttributeForEnterpriseGroup::OPERATION_MATCH, (static function (array $data): array {
