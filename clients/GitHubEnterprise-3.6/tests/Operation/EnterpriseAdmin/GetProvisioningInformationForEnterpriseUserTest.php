...
use ApiClients\Client\GitHubEnterprise\Operation\EnterpriseAdmin\GetProvisioningInformationForEnterpriseUser;
...
final class GetProvisioningInformationForEnterpriseUserTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_scim_json(): void
    {
        ...
        $browser->request('GET', '/scim/v2/Users/generated_null', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(GetProvisioningInformationForEnterpriseUser::OPERATION_MATCH, (static function (array $data): array {
