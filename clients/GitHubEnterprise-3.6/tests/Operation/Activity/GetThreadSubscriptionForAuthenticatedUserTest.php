...
final class GetThreadSubscriptionForAuthenticatedUserTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json()
    {
        ...
        $client->call(\ApiClients\Client\GitHubEnterprise\Operation\Activity\GetThreadSubscriptionForAuthenticatedUser::OPERATION_MATCH, (static function (array $data) : array {
            $data['thread_id'] = 13;
            return $data;
        })(array()));
    }
