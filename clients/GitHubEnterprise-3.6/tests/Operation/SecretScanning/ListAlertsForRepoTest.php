...
final class ListAlertsForRepoTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function t200td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('GET', '/repos/generated_null/generated_null/secret-scanning/alerts?state=generated_null&secret_type=generated_null&resolution=generated_null&sort=generated_null&direction=generated_null&page=13&per_page=13', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterprise\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterprise\Operation\SecretScanning\ListAlertsForRepo::OPERATION_MATCH, array('owner' => 'generated_null', 'repo' => 'generated_null', 'state' => 'generated_null', 'secret_type' => 'generated_null', 'resolution' => 'generated_null', 'sort' => 'generated_null', 'direction' => 'generated_null', 'page' => 13, 'per_page' => 13));
    }
    /**
     * @test
     */
