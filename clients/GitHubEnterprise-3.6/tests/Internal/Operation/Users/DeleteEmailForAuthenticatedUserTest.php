...
/** @covers \ApiClients\Client\GitHubEnterprise\Internal\Operation\Users\DeleteEmailForAuthenticatedUser */
final class DeleteEmailForAuthenticatedUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_404_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/user/emails', Argument::type('array'), json_encode(json_decode(Schema\Users\DeleteEmailForAuthenticatedUser\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\Users\DeleteEmailForAuthenticatedUser::OPERATION_MATCH, (static function (array $data): array {
            return $data;
    ...
    public function operations_httpCode_404_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/user/emails', Argument::type('array'), json_encode(json_decode(Schema\Users\DeleteEmailForAuthenticatedUser\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->users()->deleteEmailForAuthenticatedUser(json_decode(Schema\Users\DeleteEmailForAuthenticatedUser\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
