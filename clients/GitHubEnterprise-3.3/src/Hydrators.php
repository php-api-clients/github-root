...
final class Hydrators implements \EventSauce\ObjectHydrator\ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload) : object
    {
        return match ($className) {
            ...
            'ApiClients\\Client\\Github\\Schema\\OrganizationSecretScanningAlert', 'ApiClients\\Client\\Github\\Schema\\SimpleRepository' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀SecretScanning🌀Alerts()->hydrateObject($className, $payload),
            ...
            'ApiClients\\Client\\Github\\Schema\\ContentReferenceAttachment', 'ApiClients\\Client\\Github\\Schema\\Operation\\Apps\\CreateContentAttachment\\Response\\Applicationjson\\H415' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀ContentReferences🌀CbContentReferenceIdRcb🌀Attachments()->hydrateObject($className, $payload),
    ...
    public function serializeObjectOfType(object $object, string $className) : mixed
    {
        return match ($className) {
            ...
            'ApiClients\\Client\\Github\\Schema\\OrganizationSecretScanningAlert', 'ApiClients\\Client\\Github\\Schema\\SimpleRepository' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀SecretScanning🌀Alerts()->serializeObject($object),
            ...
            'ApiClients\\Client\\Github\\Schema\\ContentReferenceAttachment', 'ApiClients\\Client\\Github\\Schema\\Operation\\Apps\\CreateContentAttachment\\Response\\Applicationjson\\H415' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀ContentReferences🌀CbContentReferenceIdRcb🌀Attachments()->serializeObject($object),
