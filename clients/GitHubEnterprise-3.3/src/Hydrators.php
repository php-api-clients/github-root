...
final class Hydrators implements \EventSauce\ObjectHydrator\ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload) : object
    {
        return match ($className) {
            ...
            'ApiClients\\Client\\GitHubEnterprise\\Schema\\OrganizationSecretScanningAlert' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀SecretScanning🌀Alerts()->hydrateObject($className, $payload),
    ...
    public function serializeObject(object $object) : mixed
    {
        return match ($object::class) {
            ...
            'ApiClients\\Client\\GitHubEnterprise\\Schema\\OrganizationSecretScanningAlert' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀SecretScanning🌀Alerts()->serializeObject($object),
