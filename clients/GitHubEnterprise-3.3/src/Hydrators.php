...
final class Hydrators implements \EventSauce\ObjectHydrator\ObjectMapper
{
    ...
    public function hydrateObject(string $className, array $payload) : object
    {
        return match ($className) {
            ...
            'ApiClients\\Client\\GitHubEnterprise\\Schema\\OrganizationSecretScanningAlert', 'ApiClients\\Client\\GitHubEnterprise\\Schema\\SimpleRepository' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀SecretScanning🌀Alerts()->hydrateObject($className, $payload),
    ...
    public function serializeObject(object $object) : mixed
    {
        return match ($object::class) {
            ...
            'ApiClients\\Client\\GitHubEnterprise\\Schema\\OrganizationSecretScanningAlert', 'ApiClients\\Client\\GitHubEnterprise\\Schema\\SimpleRepository' => $this->getObjectMapperOperation🌀Orgs🌀CbOrgRcb🌀SecretScanning🌀Alerts()->serializeObject($object),
            ...
            'ApiClients\\Client\\GitHubEnterprise\\Schema\\ContentReferenceAttachment', 'ApiClients\\Client\\GitHubEnterprise\\Schema\\Operation\\Apps\\CreateContentAttachment\\Response\\Applicationjson\\H415' => $this->getObjectMapperOperation🌀Repos🌀CbOwnerRcb🌀CbRepoRcb🌀ContentReferences🌀CbContentReferenceIdRcb🌀Attachments()->serializeObject($object),
