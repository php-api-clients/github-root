...
final readonly class GetUsersWithAccessToProtectedBranch
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Repos\GetUsersWithAccessToProtectedBranch($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $branch);
