...
final readonly class GetCombinedStatusForRef
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Repos\GetCombinedStatusForRef($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $ref, $perPage, $page);
