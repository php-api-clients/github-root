...
final readonly class GetAuditLogListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Orgs\GetAuditLogListing($this->responseSchemaValidator, $this->hydrator, $org, $phrase, $after, $before, $order, $perPage, $page);
