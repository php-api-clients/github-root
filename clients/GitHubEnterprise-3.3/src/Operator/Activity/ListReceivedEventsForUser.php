...
final readonly class ListReceivedEventsForUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Activity\ListReceivedEventsForUser($this->responseSchemaValidator, $this->hydrator, $username, $perPage, $page);
