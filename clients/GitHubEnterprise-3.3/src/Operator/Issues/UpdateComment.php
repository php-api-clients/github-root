...
final readonly class UpdateComment
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Issues\UpdateComment($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $commentId);
