...
final readonly class CreateRegistrationTokenForRepo
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Actions\CreateRegistrationTokenForRepo($this->responseSchemaValidator, $this->hydrator, $owner, $repo);
