...
namespace ApiClients\Client\GitHubEnterprise\Internal\Attribute\CastUnionToType\Schema\PendingDeployment\Reviewers;
...
final class Reviewer implements PropertyCaster
{
    public function cast(mixed $value, ObjectMapper $hydrator): mixed
    {
        if (is_array($value)) {
            ...
            if ($signature === 'id|node_id|name|slug|description|privacy|permission|permissions|url|html_url|members_url|repositories_url|parent') {
                try {
