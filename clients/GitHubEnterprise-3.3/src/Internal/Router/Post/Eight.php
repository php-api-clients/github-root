...
final class Eight
{
    ...
    /** @return Schema\Operations\Orgs\RedeliverWebhookDelivery\Response\ApplicationJson\Accepted\Application\Json|Schema\TeamDiscussionComment|Schema\Reaction|Schema\EmptyObject|iterable<int,Schema\Deployment>|WithoutBody|Schema\ProtectedBranchAdminEnforced */
