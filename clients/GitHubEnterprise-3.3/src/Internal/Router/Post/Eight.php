...
final class Eight
{
    ...
    /** @return Schema\Operations\Orgs\RedeliverWebhookDelivery\Response\ApplicationJson\Accepted\Application\Json|Schema\TeamDiscussionComment|Schema\Reaction|Schema\EmptyObject|iterable<Schema\Deployment>|array{code:int}|Schema\ProtectedBranchAdminEnforced */
    public function call(string $call, array $params, array $pathChunks): Json|TeamDiscussionComment|Reaction|EmptyObject|iterable|ProtectedBranchAdminEnforced
    {
        if ($pathChunks[0] === '') {
