...
final class Three
{
    ...
    /** @return iterable<int,Schema\GlobalHook>|iterable<int,Schema\PublicKeyFull>|iterable<int,Schema\PreReceiveEnvironment>|iterable<int,Schema\PreReceiveHook>|iterable<int,Schema\Authorization>|iterable<int,Schema\Installation>|iterable<int,Schema\ApplicationGrant>|WithoutBody|iterable<int,Schema\BaseGist>|iterable<int,Schema\Email>|iterable<int,Schema\SimpleUser>|iterable<int,Schema\GpgKey>|iterable<int,Schema\Issue>|iterable<int,Schema\Key>|iterable<int,Schema\OrganizationSimple>|iterable<int,Schema\Repository>|iterable<int,Schema\RepositoryInvitation>|iterable<int,Schema\MinimalRepository>|iterable<int,Schema\TeamFull> */
