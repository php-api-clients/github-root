...
final readonly class ListReposInOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Teams\ListReposInOrg($this->responseSchemaValidator, $this->hydrator, $org, $teamSlug, $perPage, $page);
