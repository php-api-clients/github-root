...
final readonly class ListStarredListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Gists\ListStarredListing($this->responseSchemaValidator, $this->hydrator, $since, $perPage, $page);
