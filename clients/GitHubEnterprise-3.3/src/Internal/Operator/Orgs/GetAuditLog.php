...
final readonly class GetAuditLog
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Orgs\GetAuditLog($this->responseSchemaValidator, $this->hydrator, $org, $phrase, $after, $before, $order, $perPage, $page);
