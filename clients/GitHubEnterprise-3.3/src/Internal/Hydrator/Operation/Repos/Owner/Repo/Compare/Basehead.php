...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Repos\Owner\Repo\Compare;
...
class Basehead implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️CommitComparison(array $payload): CommitComparison
    {
        $properties    = [];
        $missingFields = [];
        try {
