        ...
        switch ($contentType) {
            case 'application/json':
                ...
                switch ($code) {
                    ...
                    case 415:
                        $this->responseSchemaValidator->validate($body, Reader::readFromJson(Schema\Operations\Apps\CreateContentAttachment\Response\ApplicationJson\UnsupportedMediaType::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));

                        throw new ErrorSchemas\Operations\Apps\CreateContentAttachment\Response\ApplicationJson\UnsupportedMediaType(415, $this->hydrator->hydrateObject(Schema\Operations\Apps\CreateContentAttachment\Response\ApplicationJson\UnsupportedMediaType::class, $body));
                    /**
                     * Forbidden
                     **/
