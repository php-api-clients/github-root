...
final class ListEmailsForAuthenticatedUserListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\User\Emails $hydrator, int $perPage = 30, int $page = 1)
    {
