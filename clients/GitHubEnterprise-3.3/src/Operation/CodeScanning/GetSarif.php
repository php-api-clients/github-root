...
final class GetSarif
{
    ...
    /**
     * @return Schema\CodeScanningSarifsStatus|Schema\BasicError|Schema\Operation\Activity\ListPublicEvents\Response\Applicationjson\H503
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\CodeScanningSarifsStatus|Schema\BasicError|Schema\Operation\Activity\ListPublicEvents\Response\Applicationjson\H503
    {
