...
final class GetAnalysis
{
    ...
    /**
     * @return Schema\CodeScanningAnalysis|Schema\AuditLogEvent\Data|Schema\BasicError|Schema\Operation\Activity\ListPublicEvents\Response\Applicationjson\H503
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\CodeScanningAnalysis|Schema\AuditLogEvent\Data|Schema\BasicError|Schema\Operation\Activity\ListPublicEvents\Response\Applicationjson\H503
    {
