...
final class Get
{
    ...
    /**
     * @return Schema\PullRequest|Schema\BasicError|Schema\Operation\Activity\ListPublicEvents\Response\Applicationjson\H503
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\PullRequest|Schema\BasicError|Schema\Operation\Activity\ListPublicEvents\Response\Applicationjson\H503
    {
