...
final class Users
{
    ...
    /**
     * @return Schema\Operation\Search\Users\Response\Applicationjson\H200|Schema\Operation\Activity\ListPublicEvents\Response\Applicationjson\H503|Schema\ValidationError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\Operation\Search\Users\Response\Applicationjson\H200|Schema\Operation\Activity\ListPublicEvents\Response\Applicationjson\H503|Schema\ValidationError
    {
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return $this->hydrator->hydrateObject('Schema\\Operation\\Search\\Users\\Response\\Applicationjson\\H200', $body);
                }
                break;
            /**Validation failed, or the endpoint has been spammed.**/
            case 503:
