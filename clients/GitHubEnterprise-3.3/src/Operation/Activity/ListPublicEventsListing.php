...
final class ListPublicEventsListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Events $hydrator, int $perPage = 30, int $page = 1)
    {
