...
final class ListAlertsForRepo
{
    ...
    /**
     * @return \Rx\Observable<Schema\SecretScanningAlert>|Schema\Operation\Activity\ListPublicEvents\Response\Applicationjson\H503
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : \Rx\Observable|Schema\Operation\Activity\ListPublicEvents\Response\Applicationjson\H503
    {
