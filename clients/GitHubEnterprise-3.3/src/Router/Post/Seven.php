...
final class Seven
{
    ...
    /** @return |(Schema\ContentReferenceAttachment|array{code: int})|(Schema\DeploymentBranchPolicy|array{code: int}|(iterable<Schema\Label>|Schema\BasicError)|(Schema\PullRequestSimple|(Schema\ReleaseAsset */
