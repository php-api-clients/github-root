...
final class Seven
{
    ...
    /** @return |Schema\ContentReferenceAttachment|array{code:int}|Schema\DeploymentBranchPolicy|iterable<Schema\Label>|Schema\BasicError|Schema\PullRequestSimple|Schema\ReleaseAsset */
