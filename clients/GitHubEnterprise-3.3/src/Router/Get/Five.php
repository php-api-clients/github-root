                    ...
                    if ($pathChunks[3] === 'tokens') {
                        if ($pathChunks[4] === '{access_token}') {
                            if ($call === 'GET /applications/{client_id}/tokens/{access_token}') {
                                return $this->routers->router🔀Get🔀Apps()->checkAuthorization($params);
                            }
                        }
                    }
                }
