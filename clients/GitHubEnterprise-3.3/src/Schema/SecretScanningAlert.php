...
final readonly class SecretScanningAlert
{
    ...
    public function __construct(int $number, string $created_at, mixed $updated_at, string $url, string $html_url, string $locations_url, string $state, string $resolution, string $resolved_at, mixed $resolved_by, string $secret_type, string $secret)
    {
        $this->number = $number;
