...
final readonly class RequiredPullRequestReviews
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"dismissal_restrictions":{"users":[null],"teams":[null],"apps":[null]},"dismiss_stale_reviews":false,"require_code_owner_reviews":false,"required_approving_review_count":13}';
    /**
