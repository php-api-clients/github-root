...
final readonly class RequiredPullRequestReviews
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"dismissal_restrictions":{"users":["generated_users"],"teams":["generated_teams"],"apps":["generated_apps"]},"dismiss_stale_reviews":false,"require_code_owner_reviews":false,"required_approving_review_count":13}';
    /**
     ...
     * require_code_owner_reviews: Blocks merging pull requests until [code owners](https://docs.github.com/enterprise-server@3.3/articles/about-code-owners/) review them.
     * required_approving_review_count: Specify the number of reviewers required to approve pull requests. Use a number between 1 and 6.
     */
