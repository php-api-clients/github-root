...
use ApiClients\Client\GitHubEnterprise\Schema\Checks\Create\Request\Applicationjson\Output\Annotations;
use ApiClients\Client\GitHubEnterprise\Schema\Checks\Create\Request\Applicationjson\Output\Images;
...
final readonly class Output
{
     ...
     */
    public function __construct(public string $title, public string $summary, public ?string $text, #[CastListToType(Schema\Checks\Create\Request\Applicationjson\Output\Annotations::class)] public ?array $annotations, #[CastListToType(Schema\Checks\Create\Request\Applicationjson\Output\Images::class)] public ?array $images)
    {
    }
}
