...
final readonly class LdapMappingUser
{
    ...
    public Schema\LdapMappingUser\Plan $plan;
    public string $suspended_at;
    public bool $business_plus;
    public function __construct(string $ldap_dn, string $login, int $id, string $node_id, string $avatar_url, string $gravatar_id, string $url, string $html_url, string $followers_url, string $following_url, string $gists_url, string $starred_url, string $subscriptions_url, string $organizations_url, string $repos_url, string $events_url, string $received_events_url, string $type, bool $site_admin, string $name, string $company, string $blog, string $location, string $email, bool $hireable, string $bio, string $twitter_username, int $public_repos, int $public_gists, int $followers, int $following, string $created_at, string $updated_at, int $private_gists, int $total_private_repos, int $owned_private_repos, int $disk_usage, int $collaborators, bool $two_factor_authentication, Schema\LdapMappingUser\Plan $plan, string $suspended_at, bool $business_plus)
    {
