...
final readonly class ProtectedBranchRequiredStatusCheck
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"url":"generated","enforcement_level":"generated","contexts":["generated","generated"],"contexts_url":"generated","strict":false}';

    public function __construct(public ?string $url, #[MapFrom('enforcement_level')] public ?string $enforcementLevel, public array $contexts, #[MapFrom('contexts_url')] public ?string $contextsUrl, public ?bool $strict)
    {
    }
}
