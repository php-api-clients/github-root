...
final class ListAlertsForRepoTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function t200td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('GET', '/repos/generated_null/generated_null/code-scanning/alerts?tool_name=generated_null&tool_guid=&ref=generated_null&state=generated_null&page=13&per_page=13', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterprise\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterprise\Operation\CodeScanning\ListAlertsForRepo::OPERATION_MATCH, array('owner' => 'generated_null', 'repo' => 'generated_null', 'tool_name' => 'generated_null', 'tool_guid' => null, 'ref' => 'generated_null', 'state' => 'generated_null', 'page' => 13, 'per_page' => 13));
    }
    /**
     * @test
     */
