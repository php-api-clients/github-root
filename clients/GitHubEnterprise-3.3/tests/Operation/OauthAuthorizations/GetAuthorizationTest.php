...
use ApiClients\Client\GitHubEnterprise\Operation\OauthAuthorizations\GetAuthorization;
...
final class GetAuthorizationTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/authorizations/13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(GetAuthorization::OPERATION_MATCH, (static function (array $data): array {
