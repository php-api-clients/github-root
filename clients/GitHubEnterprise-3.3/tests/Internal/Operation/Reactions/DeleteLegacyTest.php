...
namespace ApiClients\Tests\Client\GitHubEnterprise\Internal\Operation\Reactions;
...
/** @covers \ApiClients\Client\GitHubEnterprise\Internal\Operation\Reactions\DeleteLegacy */
final class DeleteLegacyTest extends AsyncTestCase
{
    ...
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/reactions/11', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\Reactions\DeleteLegacy::OPERATION_MATCH, (static function (array $data): array {
            $data['reaction_id'] = 11;
    ...
    public function operations_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('DELETE', '/reactions/11', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->reactions()->deleteLegacy(11);
    }
