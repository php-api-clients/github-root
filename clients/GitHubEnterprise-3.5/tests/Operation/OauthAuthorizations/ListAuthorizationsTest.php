...
use ApiClients\Client\GitHubEnterprise\Operation\OauthAuthorizations\ListAuthorizations;
...
final class ListAuthorizationsTest extends AsyncTestCase
{
    ...
    public function httpCode_200_responseContentType_application_json(): void
    {
        ...
        $browser->request('GET', '/authorizations?client_id=generated_null&per_page=13&page=13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $client->call(ListAuthorizations::OPERATION_MATCH, (static function (array $data): array {
