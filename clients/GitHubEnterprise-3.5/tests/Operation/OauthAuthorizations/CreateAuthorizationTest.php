...
final class CreateAuthorizationTest extends AsyncTestCase
{
    /**
     * @test
     */
    public function call_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/authorizations', Argument::type('array'), Schema\OauthAuthorizations\CreateAuthorization\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Operation\OauthAuthorizations\CreateAuthorization::OPERATION_MATCH, (static function (array $data): array {
            return $data;
        })(json_decode(Schema\OauthAuthorizations\CreateAuthorization\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)));
    }
    ...
    public function operations_httpCode_201_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/authorizations', Argument::type('array'), Schema\OauthAuthorizations\CreateAuthorization\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = await($client->operations()->oauthAuthorizations()->createAuthorization(json_decode(Schema\OauthAuthorizations\CreateAuthorization\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)));
    }
