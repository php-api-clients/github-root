...
use ApiClients\Client\GitHubEnterprise\Operation\OauthAuthorizations\DeleteAuthorization;
...
final class DeleteAuthorizationTest extends AsyncTestCase
{
    ...
    public function httpCode_403_responseContentType_application_json(): void
    {
        ...
        $browser->request('DELETE', '/authorizations/13', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
