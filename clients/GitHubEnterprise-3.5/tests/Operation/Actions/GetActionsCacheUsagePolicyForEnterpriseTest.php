...
final class GetActionsCacheUsagePolicyForEnterpriseTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function t200td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('GET', '/enterprises/generated_null/actions/cache/usage-policy', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterprise\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterprise\Operation\Actions\GetActionsCacheUsagePolicyForEnterprise::OPERATION_MATCH, array('enterprise' => 'generated_null'));
    }
}
