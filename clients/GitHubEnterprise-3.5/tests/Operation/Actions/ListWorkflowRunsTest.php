...
/** @covers \ApiClients\Client\GitHubEnterprise\Operation\Actions\ListWorkflowRuns */
final class ListWorkflowRunsTest extends AsyncTestCase
{
    ...
    public function operations_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repos/generated/generated/actions/workflows//runs?actor=generated&branch=generated&event=generated&status=generated&created=1970-01-01T00:00:00+00:00&check_suite_id=14&per_page=8&page=1&exclude_pull_requests=', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->actions()->listWorkflowRuns('generated', 'generated', null, 'generated', 'generated', 'generated', 'generated', '1970-01-01T00:00:00+00:00', 14, 8, 1, false);
    }
}
