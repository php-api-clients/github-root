...
final class ListOrgSecrets
{
    ...
    private readonly Hydrator\Operation\Orgs\Org\Dependabot\Secrets $hydrator;

    public function __construct(SchemaValidator $responseSchemaValidator, Hydrator\Operation\Orgs\Org\Dependabot\Secrets $hydrator, string $org, int $perPage = 30, int $page = 1)
    {
        $this->org                     = $org;
