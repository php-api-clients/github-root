...
final class AddStatusCheckContexts
{
    ...
    {
        $this->requestSchemaValidator->validate($data, \cebe\openapi\Reader::readFromJson(Schema\Operation\Gitignore\GetAllTemplates\Response\Applicationjson\H200::SCHEMA_JSON, \cebe\openapi\spec\Schema::class));
    ...
    /**
     * @return \Rx\Observable<Schema\Operation\Gitignore\GetAllTemplates\Response\Applicationjson\H200>|Schema\ValidationError|Schema\BasicError
     */
