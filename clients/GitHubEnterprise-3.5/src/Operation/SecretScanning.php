...
final class SecretScanning
{
    ...
    public function listAlertsForEnterprise(string $enterprise, string $state, string $secretType, string $resolution, string $before, string $after, int $perPage): Schema\OrganizationSecretScanningAlert
    {
        ...
        return $this->operator[Operator\SecretScanning\ListAlertsForEnterprise::class]->call($enterprise, $state, $secretType, $resolution, $before, $after, $perPage);
    }

    public function listAlertsForOrg(string $org, string $state, string $secretType, string $resolution, int $page, int $perPage): Schema\OrganizationSecretScanningAlert
    {
        ...
        return $this->operator[Operator\SecretScanning\ListAlertsForOrg::class]->call($org, $state, $secretType, $resolution, $page, $perPage);
    }

    public function listAlertsForOrgListing(string $org, string $state, string $secretType, string $resolution, int $page, int $perPage): Schema\OrganizationSecretScanningAlert
    {
        ...
        return $this->operator[Operator\SecretScanning\ListAlertsForOrgListing::class]->call($org, $state, $secretType, $resolution, $page, $perPage);
    }
