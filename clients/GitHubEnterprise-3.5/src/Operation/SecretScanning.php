...
final class SecretScanning
{
    ...
    public function listAlertsForEnterprise(string $enterprise, string $state, string $secretType, string $resolution, string $before, string $after, int $perPage): PromiseInterface
    {
    ...
    public function listAlertsForOrg(string $org, string $state, string $secretType, string $resolution, int $page, int $perPage): PromiseInterface
    {
