...
final class Repos
{
    ...
    public function listCacheInfo(string $owner, string $repo, int $perPage, int $page): Schema\Operations\Repos\ListCacheInfo\Response\ApplicationJson\Ok
    {
    ...
    public function listCacheInfoListing(string $owner, string $repo, int $perPage, int $page): Schema\Operations\Repos\ListCacheInfo\Response\ApplicationJson\Ok
    {
        if (array_key_exists(Operator\Repos\ListCacheInfoListing::class, $this->operator) === false) {
            $this->operator[Operator\Repos\ListCacheInfoListing::class] = new Operator\Repos\ListCacheInfoListing($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Replicas🌀Caches());
        }

        return $this->operator[Operator\Repos\ListCacheInfoListing::class]->call($owner, $repo, $perPage, $page);
    }
