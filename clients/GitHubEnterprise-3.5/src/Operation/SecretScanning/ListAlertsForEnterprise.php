...
final class ListAlertsForEnterprise
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{enterprise}', '{state}', '{secret_type}', '{resolution}', '{before}', '{after}', '{per_page}'), array($this->enterprise, $this->state, $this->secretType, $this->resolution, $this->before, $this->after, $this->perPage), self::PATH . '?state={state}&secretType={secret_type}&resolution={resolution}&before={before}&after={after}&perPage={per_page}'));
    }
    /**
