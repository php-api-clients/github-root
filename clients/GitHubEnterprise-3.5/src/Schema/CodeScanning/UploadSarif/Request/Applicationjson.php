...
final readonly class Applicationjson
{
    ...
    */
    ...
    public function __construct(string $commit_sha, string $ref, string $sarif, string $checkout_uri, string $started_at, string $tool_name)
    {
