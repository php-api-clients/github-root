...
use ApiClients\Client\GitHubEnterprise\Schema\TopicSearchResultItem\Aliases;
use ApiClients\Client\GitHubEnterprise\Schema\TopicSearchResultItem\Related;
