...
final readonly class SecretScanningAlert
{
    ...
    */
    public function __construct(public ?int $number, public ?string $created_at, public mixed $updated_at, public ?string $url, public ?string $html_url, public ?string $locations_url, public ?string $state, public ?string $resolution, public ?string $resolved_at, public mixed $resolved_by, public ?string $secret_type, public ?string $secret_type_display_name, public ?string $secret)
    {
    }
}
