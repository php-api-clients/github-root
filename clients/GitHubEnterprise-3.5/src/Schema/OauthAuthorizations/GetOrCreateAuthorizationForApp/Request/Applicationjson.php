...
final readonly class Applicationjson
{
     ...
     */
    public function __construct(#[\EventSauce\ObjectHydrator\MapFrom('client_secret')] public string $clientSecret, public ?array $scopes, public ?string $note, #[\EventSauce\ObjectHydrator\MapFrom('note_url')] public ?string $noteUrl, public ?string $fingerprint)
    {
    }
}
