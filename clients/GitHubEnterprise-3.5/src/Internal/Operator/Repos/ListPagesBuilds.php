...
final readonly class ListPagesBuilds
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Repos\ListPagesBuilds($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
