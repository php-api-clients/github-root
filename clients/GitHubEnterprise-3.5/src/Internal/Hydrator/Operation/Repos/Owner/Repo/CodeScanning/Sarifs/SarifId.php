...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Repos\Owner\Repo\CodeScanning\Sarifs;
...
class SarifId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️CodeScanningSarifsStatus(array $payload): CodeScanningSarifsStatus
    {
        $properties    = [];
        $missingFields = [];
        try {
