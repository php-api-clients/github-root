...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Repos\Owner\Repo\Commits\CommitSha;
...
class Comments implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️CommitComment(array $payload): CommitComment
    {
        $properties    = [];
        $missingFields = [];
        try {
