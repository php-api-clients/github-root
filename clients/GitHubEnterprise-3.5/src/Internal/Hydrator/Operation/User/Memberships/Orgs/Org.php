...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\User\Memberships\Orgs;
...
use ApiClients\Client\GitHubEnterprise\Schema\OrgMembership\Permissions;
...
class Org implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️OrgMembership(array $payload): OrgMembership
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️OrgMembership⚡️Permissions(array $payload): Permissions
    {
        $properties    = [];
        $missingFields = [];
        try {
