...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Orgs\Org\Teams;

use ApiClients\Client\GitHubEnterprise\Schema\BasicError;
use ApiClients\Client\GitHubEnterprise\Schema\TeamFull;
use ApiClients\Client\GitHubEnterprise\Schema\TeamOrganization;
use ApiClients\Client\GitHubEnterprise\Schema\TeamOrganization\Plan;
...
class TeamSlug implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️TeamOrganization(array $payload): TeamOrganization
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️TeamOrganization⚡️Plan(array $payload): Plan
    {
        $properties    = [];
        $missingFields = [];
        try {
