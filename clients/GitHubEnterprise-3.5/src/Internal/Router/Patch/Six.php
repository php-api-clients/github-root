...
final class Six
{
    ...
    /** @return Schema\LdapMappingTeam|Schema\LdapMappingUser|array{code:int}|Schema\RunnerGroupsEnterprise|Schema\RunnerGroupsOrg|Schema\WebhookConfig|Schema\CheckRun|Schema\CheckSuitePreference|Schema\CommitComment|Schema\Hook|Schema\RepositoryInvitation|Schema\Issue|Schema\BasicError|Schema\Label|Schema\Milestone|Schema\RepositoryPreReceiveHook|Schema\PullRequest|Schema\Release */
