...
final readonly class MergeUpstream
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Repos\MergeUpstream($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo);
