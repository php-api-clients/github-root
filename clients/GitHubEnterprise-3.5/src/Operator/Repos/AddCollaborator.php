...
final readonly class AddCollaborator
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Repos\AddCollaborator($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $username);
