...
final readonly class AddStatusCheckContexts
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Repos\AddStatusCheckContexts($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo, $branch);
