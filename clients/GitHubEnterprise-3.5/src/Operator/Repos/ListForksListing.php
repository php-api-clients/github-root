...
final readonly class ListForksListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Repos\ListForksListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $sort, $perPage, $page);
