...
final readonly class ListInstallationRequestsForAuthenticatedApp
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Apps\ListInstallationRequestsForAuthenticatedApp($this->responseSchemaValidator, $this->hydrator, $perPage, $page);
