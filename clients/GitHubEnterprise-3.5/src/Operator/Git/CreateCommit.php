...
final readonly class CreateCommit
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Git\CreateCommit($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo);
