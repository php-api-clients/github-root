...
final readonly class GetGithubActionsDefaultWorkflowPermissionsOrganization
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Actions\GetGithubActionsDefaultWorkflowPermissionsOrganization($this->responseSchemaValidator, $this->hydrator, $org);
