...
final readonly class ListRepoSecrets
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Dependabot\ListRepoSecrets($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $perPage, $page);
