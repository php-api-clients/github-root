...
final readonly class CreateForTeamDiscussionCommentLegacy
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Reactions\CreateForTeamDiscussionCommentLegacy($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $teamId, $discussionNumber, $commentNumber);
