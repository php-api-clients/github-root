...
final class ListAuthorizationsTest extends \WyriHaximus\AsyncTestUtilities\AsyncTestCase
{
    ...
    public function t200td1f5a9d446c6cec2cf63545e8163e585()
    {
        ...
        $browser->request('GET', '/authorizations?client_id=generated_null&per_page=13&page=13', \Prophecy\Argument::type('array'), '')->willReturn(\React\Promise\resolve($response))->shouldBeCalled();
        $client = new \ApiClients\Client\GitHubEnterprise\Client($auth->reveal(), $browser->reveal());
        $client->call(\ApiClients\Client\GitHubEnterprise\Operation\OauthAuthorizations\ListAuthorizations::OPERATION_MATCH, array('client_id' => 'generated_null', 'per_page' => 13, 'page' => 13));
    }
    /**
     * @test
     */
