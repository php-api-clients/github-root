...
/** @covers \ApiClients\Client\GitHubEnterprise\Operation\OauthAuthorizations\ListAuthorizations */
final class ListAuthorizationsTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/authorizations?client_id=generated&per_page=8&page=4', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Operation\OauthAuthorizations\ListAuthorizations::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_403_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/authorizations?client_id=generated&per_page=8&page=4', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->oauthAuthorizations()->listAuthorizations('generated', 8, 4);
    }
