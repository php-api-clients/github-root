...
/** @covers \ApiClients\Client\GitHubEnterprise\Internal\Operation\Apps\RedeliverWebhookDelivery */
final class RedeliverWebhookDeliveryTest extends AsyncTestCase
{
    ...
    {
        $response = new Response(202, ['Content-Type' => 'application/json'], json_encode(json_decode(Schema\Operations\Apps\RedeliverWebhookDelivery\Response\ApplicationJson\Accepted::SCHEMA_EXAMPLE_DATA, true)));
