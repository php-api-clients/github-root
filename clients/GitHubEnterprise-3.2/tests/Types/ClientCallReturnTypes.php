...
assertType('Observable<int>|Schema\\Operations\\Apps\\RedeliverWebhookDelivery\\Response\\ApplicationJson\\Accepted|WithoutBody', $client->call('GET /repos/{owner}/{repo}/stats/code_frequency'));
assertType('Observable<Schema\\CommitActivity>|Schema\\Operations\\Apps\\RedeliverWebhookDelivery\\Response\\ApplicationJson\\Accepted|WithoutBody', $client->call('GET /repos/{owner}/{repo}/stats/commit_activity'));
assertType('Observable<Schema\\ContributorActivity>|Schema\\Operations\\Apps\\RedeliverWebhookDelivery\\Response\\ApplicationJson\\Accepted|WithoutBody', $client->call('GET /repos/{owner}/{repo}/stats/contributors'));
