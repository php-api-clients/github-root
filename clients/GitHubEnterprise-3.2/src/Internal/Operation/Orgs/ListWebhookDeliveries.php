...
final class ListWebhookDeliveries
{
    ...
    {
        return new Request(self::METHOD, str_replace(['{org}', '{hook_id}', '{cursor}', '{per_page}'], [$this->org, $this->hookId, $this->cursor, $this->perPage], self::PATH . '?cursor={cursor}&per_page={per_page}'));
    }
