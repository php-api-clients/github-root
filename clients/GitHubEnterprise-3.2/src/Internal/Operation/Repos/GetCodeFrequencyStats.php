...
final class GetCodeFrequencyStats
{
    ...
    public function createResponse(ResponseInterface $response): Observable|Schema\Operations\Apps\RedeliverWebhookDelivery\Response\ApplicationJson\Accepted|WithoutBody
    {
