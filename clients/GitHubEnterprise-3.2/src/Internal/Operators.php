...
final class Operators
{
    ...
    private Internal\Operator\Apps\RevokeGrantForApplication|null $apps👷RevokeGrantForApplication                                                                                   = null;
    ...
    private Internal\Operator\Apps\CheckAuthorization|null $apps👷CheckAuthorization                                                                                                 = null;
    private Internal\Operator\Apps\ResetAuthorization|null $apps👷ResetAuthorization                                                                                                 = null;
    private Internal\Operator\Apps\RevokeAuthorizationForApplication|null $apps👷RevokeAuthorizationForApplication                                                                   = null;
    ...
    private Internal\Operator\Reactions\DeleteLegacy|null $reactions👷DeleteLegacy                                                                                                   = null;
    ...
    private Internal\Operator\Apps\CreateContentAttachment|null $apps👷CreateContentAttachment                                                                                       = null;
    ...
    public function apps👷RevokeGrantForApplication(): Internal\Operator\Apps\RevokeGrantForApplication
    {
        if ($this->apps👷RevokeGrantForApplication instanceof Internal\Operator\Apps\RevokeGrantForApplication === false) {
            $this->apps👷RevokeGrantForApplication = new Internal\Operator\Apps\RevokeGrantForApplication($this->browser, $this->authentication);
        }

        return $this->apps👷RevokeGrantForApplication;
    }
    ...
    public function apps👷CheckAuthorization(): Internal\Operator\Apps\CheckAuthorization
    {
        if ($this->apps👷CheckAuthorization instanceof Internal\Operator\Apps\CheckAuthorization === false) {
            $this->apps👷CheckAuthorization = new Internal\Operator\Apps\CheckAuthorization($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Applications🌀ClientId🌀Tokens🌀AccessToken());
        }

        return $this->apps👷CheckAuthorization;
    }
    ...
    public function apps👷RevokeAuthorizationForApplication(): Internal\Operator\Apps\RevokeAuthorizationForApplication
    {
        if ($this->apps👷RevokeAuthorizationForApplication instanceof Internal\Operator\Apps\RevokeAuthorizationForApplication === false) {
            $this->apps👷RevokeAuthorizationForApplication = new Internal\Operator\Apps\RevokeAuthorizationForApplication($this->browser, $this->authentication);
        }

        return $this->apps👷RevokeAuthorizationForApplication;
    }
    ...
    public function reactions👷DeleteLegacy(): Internal\Operator\Reactions\DeleteLegacy
    {
        if ($this->reactions👷DeleteLegacy instanceof Internal\Operator\Reactions\DeleteLegacy === false) {
            $this->reactions👷DeleteLegacy = new Internal\Operator\Reactions\DeleteLegacy($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Reactions🌀ReactionId());
        }

        return $this->reactions👷DeleteLegacy;
    }
    ...
    public function repos👷RemoveCollaborator(): Internal\Operator\Repos\RemoveCollaborator
    {
        if ($this->repos👷RemoveCollaborator instanceof Internal\Operator\Repos\RemoveCollaborator === false) {
            $this->repos👷RemoveCollaborator = new Internal\Operator\Repos\RemoveCollaborator($this->browser, $this->authentication);
        }
    ...
    public function apps👷CreateContentAttachment(): Internal\Operator\Apps\CreateContentAttachment
    {
        if ($this->apps👷CreateContentAttachment instanceof Internal\Operator\Apps\CreateContentAttachment === false) {
            $this->apps👷CreateContentAttachment = new Internal\Operator\Apps\CreateContentAttachment($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀ContentReferences🌀ContentReferenceId🌀Attachments());
        }

        return $this->apps👷CreateContentAttachment;
    }
