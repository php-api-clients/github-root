...
class UpdateBranch implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️Operations⚡️Pulls⚡️UpdateBranch⚡️Response⚡️ApplicationJson⚡️Accepted⚡️Application⚡️Json(array $payload): Json
    {
        $properties    = [];
        $missingFields = [];
        try {
