...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Repos\Owner\Repo\CodeScanning\Analyses;
...
class AnalysisId implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️CodeScanningAnalysis(array $payload): CodeScanningAnalysis
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️CodeScanningAnalysisDeletion(array $payload): CodeScanningAnalysisDeletion
    {
        $properties    = [];
        $missingFields = [];
        try {
