...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Repos\Owner\Repo\Pulls\PullNumber;
...
use ApiClients\Client\GitHubEnterprise\Schema\PullRequestSimple\Base;
use ApiClients\Client\GitHubEnterprise\Schema\PullRequestSimple\Head;
use ApiClients\Client\GitHubEnterprise\Schema\PullRequestSimple\Links;
...
class RequestedReviewers implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️PullRequestReviewRequest(array $payload): PullRequestReviewRequest
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️PullRequestSimple(array $payload): PullRequestSimple
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️PullRequestSimple⚡️Head(array $payload): Head
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️PullRequestSimple⚡️Base(array $payload): Base
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️PullRequestSimple⚡️Links(array $payload): Links
    {
        $properties    = [];
        $missingFields = [];
        try {
