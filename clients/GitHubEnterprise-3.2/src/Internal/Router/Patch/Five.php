...
final class Five
{
    ...
    /** @return Schema\GistComment|Schema\OrgHook|Schema\OrgPreReceiveHook|Schema\TeamFull|Schema\ProjectCard|array{code:int}|Schema\TeamDiscussion|Schema\OrgMembership */
