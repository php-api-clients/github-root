...
final class Repos
{
    ...
    public function getRelease(array $params): Release
    {
        $arguments = [];
        if (array_key_exists('owner', $params) === false) {
            throw new InvalidArgumentException('Missing mandatory field: owner');
    ...
    /** @return iterable<int,int>|Schema\Operations\Apps\RedeliverWebhookDelivery\Response\ApplicationJson\Accepted|WithoutBody */
    public function getCodeFrequencyStats(array $params): iterable|Accepted|WithoutBody
    {
        $arguments = [];
        if (array_key_exists('owner', $params) === false) {
            throw new InvalidArgumentException('Missing mandatory field: owner');
    ...
    /** @return iterable<int,Schema\CommitActivity>|Schema\Operations\Apps\RedeliverWebhookDelivery\Response\ApplicationJson\Accepted|WithoutBody */
    public function getCommitActivityStats(array $params): iterable|Accepted|WithoutBody
    {
        $arguments = [];
        if (array_key_exists('owner', $params) === false) {
            throw new InvalidArgumentException('Missing mandatory field: owner');
    ...
    public function getContributorsStats(array $params): iterable|Accepted|WithoutBody
    {
        $arguments = [];
        if (array_key_exists('owner', $params) === false) {
            throw new InvalidArgumentException('Missing mandatory field: owner');
