...
final class Five
{
    ...
    /** @return |Schema\GistComment|array{code:int}|Observable<Schema\Event>|Schema\BasicError|Schema\ThreadSubscription|array{code:int,location:string}|Schema\ProjectCard|Observable<Schema\ProjectCard>|Observable<Schema\SimpleUser>|Observable<Schema\ShortBranch>|Observable<Schema\Collaborator>|Observable<Schema\CommitComment>|Observable<Schema\Commit>|Observable<Schema\Contributor>|Observable<Schema\Deployment>|Observable<Schema\MinimalRepository>|Observable<Schema\Hook>|Observable<Schema\RepositoryInvitation>|Observable<Schema\Issue>|Observable<Schema\DeployKey>|Observable<Schema\Label>|Observable<Schema\Milestone>|Observable<Schema\Thread>|Observable<Schema\RepositoryPreReceiveHook>|Observable<Schema\Project>|Observable<Schema\PullRequestSimple>|Observable<Schema\Release>|Schema\RepositorySubscription|Observable<Schema\Tag>|Observable<Schema\Team>|Observable<Schema\SshKey>|Schema\TeamProject|Schema\Operations\Apps\ListInstallationReposForAuthenticatedUser\Response\ApplicationJson\Ok */
