...
final class Nine
{
    ...
    /** @return iterable<string>|iterable<Schema\Integration>|iterable<Schema\Team>|iterable<Schema\SimpleUser>|Schema\Operations\Apps\RedeliverWebhookDelivery\Response\ApplicationJson\Accepted|Schema\PullRequestReviewComment|Schema\PullRequestReview */
