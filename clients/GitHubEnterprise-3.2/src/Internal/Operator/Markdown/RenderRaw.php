...
namespace ApiClients\Client\GitHubEnterprise\Internal\Operator\Markdown;
...
final readonly class RenderRaw
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Markdown\RenderRaw($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator);
