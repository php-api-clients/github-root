...
final readonly class ListReleaseAssets
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Repos\ListReleaseAssets($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $releaseId, $perPage, $page);
