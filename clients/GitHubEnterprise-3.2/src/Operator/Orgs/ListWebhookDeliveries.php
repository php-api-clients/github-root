...
final readonly class ListWebhookDeliveries
{
     ...
     **/
    public function call(string $org, int $hookId, string $cursor, int $perPage = 30): PromiseInterface
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Orgs\ListWebhookDeliveries($this->responseSchemaValidator, $this->hydrator, $org, $hookId, $cursor, $perPage);
