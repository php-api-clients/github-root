...
final readonly class GetDeploymentBranchPolicy
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Repos\GetDeploymentBranchPolicy($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $environmentName, $branchPolicyId);
