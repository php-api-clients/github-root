...
final readonly class ListForRepoListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Projects\ListForRepoListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $state, $perPage, $page);
