...
final readonly class CreateRef
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Git\CreateRef($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo);
