...
final readonly class ListEventsListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Issues\ListEventsListing($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $issueNumber, $perPage, $page);
