...
final class CreateContentAttachment
{
    ...
    private int $content_reference_id;
    ...
    function createRequest(array $data = array()) : \Psr\Http\Message\RequestInterface
    {
        ...
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{owner}', '{repo}', '{content_reference_id}'), array($this->owner, $this->repo, $this->content_reference_id), self::PATH), array('Content-Type' => 'application/json'), json_encode($data));
    }
    /**
     * @return Schema\ContentReferenceAttachment|Schema\ValidationError|Schema\BasicError|Schema\Operation\Reactions\CreateForCommitComment\Response\Applicationjson\H415
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\ContentReferenceAttachment|Schema\ValidationError|Schema\BasicError|Schema\Operation\Reactions\CreateForCommitComment\Response\Applicationjson\H415
    {
            ...
            case 200:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return $this->hydrator->hydrateObject('Schema\\ContentReferenceAttachment', $body);
                }
                break;
            /**Forbidden**/
            case 422:
