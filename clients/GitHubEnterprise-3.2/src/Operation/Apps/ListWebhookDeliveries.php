...
final class ListWebhookDeliveries
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{cursor}', '{per_page}'), array($this->cursor, $this->perPage), self::PATH . '?cursor={cursor}&per_page={per_page}'));
    }
    /**
