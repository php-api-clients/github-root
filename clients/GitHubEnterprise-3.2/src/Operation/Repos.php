...
final class Repos
{
    ...
    public function listCommits(string $owner, string $repo, string $sha, string $path, string $author, string $since, string $until, int $perPage, int $page): Schema\Commit
    {
        ...
        return $this->operator[Operator\Repos\ListCommits::class]->call($owner, $repo, $sha, $path, $author, $since, $until, $perPage, $page);
    }

    public function listCommitsListing(string $owner, string $repo, string $sha, string $path, string $author, string $since, string $until, int $perPage, int $page): Schema\Commit
    {
        ...
        return $this->operator[Operator\Repos\ListCommitsListing::class]->call($owner, $repo, $sha, $path, $author, $since, $until, $perPage, $page);
    }
    ...
    public function listWebhookDeliveries(string $owner, string $repo, int $hookId, string $cursor, int $perPage): Schema\HookDeliveryItem
    {
        ...
        return $this->operator[Operator\Repos\ListWebhookDeliveries::class]->call($owner, $repo, $hookId, $cursor, $perPage);
    }
    ...
    public function redeliverWebhookDelivery(string $owner, string $repo, int $hookId, int $deliveryId): Schema\Operations\Apps\RedeliverWebhookDelivery\Response\ApplicationJson\Accepted
    {
    ...
    public function getCodeFrequencyStats(string $owner, string $repo): Schema\Operations\Repos\GetCodeFrequencyStats\Response\ApplicationJson\Ok|Schema\Operations\Apps\RedeliverWebhookDelivery\Response\ApplicationJson\Accepted
    {
    ...
    public function getCommitActivityStats(string $owner, string $repo): Schema\CommitActivity|Schema\Operations\Apps\RedeliverWebhookDelivery\Response\ApplicationJson\Accepted
    {
    ...
    public function getContributorsStats(string $owner, string $repo): Schema\ContributorActivity|Schema\Operations\Apps\RedeliverWebhookDelivery\Response\ApplicationJson\Accepted
    {
    ...
    public function listPublic(int $since, string $visibility): Schema\MinimalRepository
    {
