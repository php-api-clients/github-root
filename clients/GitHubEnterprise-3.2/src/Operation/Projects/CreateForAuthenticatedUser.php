...
final class CreateForAuthenticatedUser
{
    ...
    /**
     * @return Schema\Project|Schema\BasicError|Schema\ValidationErrorSimple|Schema\Operation\Reactions\CreateForCommitComment\Response\Applicationjson\H415
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\Project|Schema\BasicError|Schema\ValidationErrorSimple|Schema\Operation\Reactions\CreateForCommitComment\Response\Applicationjson\H415
    {
            ...
            case 201:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return $this->hydrator->hydrateObject('Schema\\Project', $body);
                }
                break;
            /**Preview header missing**/
            case 403:
