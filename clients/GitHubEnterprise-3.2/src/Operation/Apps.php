...
final class Apps
{
    ...
    public function listWebhookDeliveries(string $cursor, int $perPage): Schema\HookDeliveryItem
    {
        ...
        return $this->operator[Operator\Apps\ListWebhookDeliveries::class]->call($cursor, $perPage);
    }
