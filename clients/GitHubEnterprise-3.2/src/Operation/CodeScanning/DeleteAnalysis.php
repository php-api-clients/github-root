...
final class DeleteAnalysis
{
    ...
    /**
     * @return Schema\CodeScanningAnalysisDeletion|Schema\BasicError|Schema\ScimError|Schema\Operation\Activity\ListPublicEvents\Response\Applicationjson\H503
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\CodeScanningAnalysisDeletion|Schema\BasicError|Schema\ScimError|Schema\Operation\Activity\ListPublicEvents\Response\Applicationjson\H503
    {
