...
final class UpdateAlert
{
    ...
    /**
     * @return Schema\SecretScanningAlert|Schema\Operation\Activity\ListPublicEvents\Response\Applicationjson\H503
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\SecretScanningAlert|Schema\Operation\Activity\ListPublicEvents\Response\Applicationjson\H503
    {
