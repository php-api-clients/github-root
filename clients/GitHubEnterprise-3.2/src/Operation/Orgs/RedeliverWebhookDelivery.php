...
final class RedeliverWebhookDelivery
{
    ...
    /**
     * @return Schema\Operation\Apps\RedeliverWebhookDelivery\Response\Applicationjson\H202|Schema\BasicError|Schema\ScimError|Schema\ValidationError
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\Operation\Apps\RedeliverWebhookDelivery\Response\Applicationjson\H202|Schema\BasicError|Schema\ScimError|Schema\ValidationError
    {
            ...
            case 202:
                switch ($contentType) {
                    case 'application/json':
                        ...
                        return $this->hydrator->hydrateObject('Schema\\Operation\\Apps\\RedeliverWebhookDelivery\\Response\\Applicationjson\\H202', $body);
                }
                break;
            /**Validation failed, or the endpoint has been spammed.**/
            case 400:
