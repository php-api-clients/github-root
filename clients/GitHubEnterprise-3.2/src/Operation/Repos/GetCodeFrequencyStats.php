...
final class GetCodeFrequencyStats
{
     ...
     */
    public function createResponse(\Psr\Http\Message\ResponseInterface $response) : \Rx\Observable|Schema\Operation\Apps\RedeliverWebhookDelivery\Response\Applicationjson\H202
    {
