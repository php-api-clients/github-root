...
final class GetCommitActivityStats
{
    ...
    public function createResponse(ResponseInterface $response): Observable|Schema\Operations\Apps\RedeliverWebhookDelivery\Response\ApplicationJson\Accepted|array
    {
