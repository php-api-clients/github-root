...
final class GetCommit
{
    ...
    /**
     * @return Schema\Commit|Schema\ValidationError|Schema\BasicError|Schema\Operation\Activity\ListPublicEvents\Response\Applicationjson\H503
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\Commit|Schema\ValidationError|Schema\BasicError|Schema\Operation\Activity\ListPublicEvents\Response\Applicationjson\H503
    {
