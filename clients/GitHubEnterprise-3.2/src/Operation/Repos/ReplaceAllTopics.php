...
final class ReplaceAllTopics
{
    ...
    /**
     * @return Schema\Topic|Schema\BasicError|Schema\ValidationErrorSimple|Schema\Operation\Reactions\CreateForCommitComment\Response\Applicationjson\H415
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\Topic|Schema\BasicError|Schema\ValidationErrorSimple|Schema\Operation\Reactions\CreateForCommitComment\Response\Applicationjson\H415
    {
