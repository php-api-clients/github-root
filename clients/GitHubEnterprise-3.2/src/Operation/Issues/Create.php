...
final class Create
{
    ...
    /**
     * @return Schema\Issue|Schema\BasicError|Schema\ValidationError|Schema\Operation\Activity\ListPublicEvents\Response\Applicationjson\H503
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\Issue|Schema\BasicError|Schema\ValidationError|Schema\Operation\Activity\ListPublicEvents\Response\Applicationjson\H503
    {
