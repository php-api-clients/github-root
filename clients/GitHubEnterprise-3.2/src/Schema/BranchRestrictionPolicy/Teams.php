...
final readonly class Teams
{
    ...
    public string|null $htmlUrl, public string|null $name, public string|null $slug, public string|null $description, public string|null $privacy, public string|null $permission, #[MapFrom('members_url')]
