...
final readonly class PageBuild
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"url":"generated_url","status":"generated_status","error":{"message":"generated_message"},"pusher":"generated_pusher","commit":"generated_commit","duration":13,"created_at":"generated_created_at","updated_at":"generated_updated_at"}';
    public ?string $url;
    ...
    public function __construct(string $url, string $status, Schema\PageBuild\Error $error, mixed $pusher, string $commit, int $duration, string $created_at, string $updated_at)
    {
        $this->url = $url;
        $this->status = $status;
        $this->error = $error;
