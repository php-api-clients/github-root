...
final readonly class Applicationjson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"cname":"generated_cname_null","https_enforced":false,"public":false,"build_type":"legacy","source":"generated_source_null"}';
    /**
     ...
     */
    public function __construct(public ?string $cname, #[\EventSauce\ObjectHydrator\MapFrom('https_enforced')] public ?bool $httpsEnforced, public ?bool $public, #[\EventSauce\ObjectHydrator\MapFrom('build_type')] public ?string $buildType, public ?string $source)
    {
    }
}
