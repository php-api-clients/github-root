...
final readonly class ApplicationJson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"cname":"generated","https_enforced":false,"public":false,"build_type":"workflow","source":null}';
     ...
     */
    public function __construct(public ?string $cname, #[MapFrom('https_enforced')] public ?bool $httpsEnforced, public ?bool $public, #[MapFrom('build_type')] public ?string $buildType, public null|string|Schema\Repos\UpdateInformationAboutPagesSite\Request\ApplicationJson\Source\One $source)
    {
    }
}
