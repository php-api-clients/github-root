...
final readonly class Enterprise
{
    ...
    public int|null $configurationRunCount, public Schema\EnterpriseSettings\Enterprise\Avatar|null $avatar, public Schema\EnterpriseSettings\Enterprise\Customer|null $customer, public Schema\EnterpriseSettings\Enterprise\License|null $license, #[MapFrom('github_ssl')]
    public Schema\EnterpriseSettings\Enterprise\GithubSsl|null $githubSsl, public Schema\EnterpriseSettings\Enterprise\Ldap|null $ldap, public Schema\EnterpriseSettings\Enterprise\Cas|null $cas, public Schema\EnterpriseSettings\Enterprise\Saml|null $saml, #[MapFrom('github_oauth')]
    public Schema\EnterpriseSettings\Enterprise\GithubOauth|null $githubOauth, public Schema\EnterpriseSettings\Enterprise\Smtp|null $smtp, public Schema\EnterpriseSettings\Enterprise\Ntp|null $ntp, public string|null $timezone, public Schema\EnterpriseSettings\Enterprise\Snmp|null $snmp, public Schema\EnterpriseSettings\Enterprise\Syslog|null $syslog, public string|null $assets, public Schema\EnterpriseSettings\Enterprise\Pages|null $pages, public Schema\EnterpriseSettings\Enterprise\Collectd|null $collectd, public Schema\EnterpriseSettings\Enterprise\Mapping|null $mapping, #[MapFrom('load_balancer')]
