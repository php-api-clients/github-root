...
final readonly class ApplicationJson
{
    ...
    public string $commitId, public string $path, public int|null $position, public string|null $side, public int $line, #[MapFrom('start_line')]
