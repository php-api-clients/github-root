...
final readonly class Applicationjson
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"scopes":"user","add_scopes":[null],"remove_scopes":[null],"note":"Update all gems","note_url":"generated_note_url","fingerprint":"generated_fingerprint"}';
    /**
