...
final readonly class OrgMembership
{
    ...
    public function __construct(string $url, string $state, string $role, string $organization_url, Schema\OrganizationSimple $organization, mixed $user, Schema\OrgMembership\Permissions $permissions)
    {
        $this->url = $url;
        $this->state = $state;
        $this->role = $role;
