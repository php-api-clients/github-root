...
final readonly class Job
{
    ...
    public function __construct(int $id, int $run_id, string $run_url, string $node_id, string $head_sha, string $url, string $html_url, string $status, string $conclusion, string $started_at, string $completed_at, string $name, array $steps, string $check_run_url)
    {
        $this->id = $id;
        $this->run_id = $run_id;
