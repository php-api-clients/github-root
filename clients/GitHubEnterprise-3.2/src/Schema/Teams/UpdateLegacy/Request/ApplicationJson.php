...
final readonly class ApplicationJson
{
     ...
     */
    public function __construct(public string $name, public string|null $description, public string|null $privacy, public string|null $permission, #[MapFrom('parent_team_id')]
