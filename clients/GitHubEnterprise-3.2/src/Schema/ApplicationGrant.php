...
final readonly class ApplicationGrant
{
    ...
    public function __construct(public int $id, public string $url, public Schema\ApplicationGrant\App $app, #[MapFrom('created_at')]
    public string $createdAt, #[MapFrom('updated_at')]
    public string $updatedAt, public array $scopes, public Schema\SimpleUser|null $user,)
    {
    }
}
