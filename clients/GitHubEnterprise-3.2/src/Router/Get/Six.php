...
final class Six
{
    ...
    /** @return |Observable<Schema\RunnerApplication>|Observable<Schema\HookDeliveryItem>|Observable<Schema\TeamDiscussion>|Observable<Schema\SimpleUser>|Observable<Schema\TeamProject>|Observable<Schema\MinimalRepository>|Observable<Schema\Team>|(Schema\ProjectCollaboratorPermission|array{code: int})|array{code: int}|Observable<Schema\CodeScanningAlertItems>|Observable<Schema\CodeScanningAnalysis>|(Schema\ContentDirectory|Schema\ContentFile|Schema\ContentSymlink|Schema\ContentSubmodule|Observable<Schema\IssueComment>|Observable<Schema\IssueEvent>|(Schema\Issue|Schema\BasicError|Observable<Schema\PageBuild>|Observable<Schema\PullRequestReviewComment>|(Schema\PullRequest|(Observable<Schema\SecretScanningAlert>|(Observable<int>|Schema\Operations\Apps\RedeliverWebhookDelivery\Response\ApplicationJson\Accepted|(Observable<Schema\CommitActivity>|(Observable<Schema\ContributorActivity>|array{code: int, location: string}|Observable<Schema\TeamDiscussionComment>|Observable<Schema\Reaction>|(Schema\TeamRepository|Observable<Schema\Event> */
