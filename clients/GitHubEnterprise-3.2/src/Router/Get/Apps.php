...
final class Apps
{
    ...
    public function listWebhookDeliveries(array $params)
    {
        ...
        $operation = new Operation\Apps\ListWebhookDeliveries($this->responseSchemaValidator, $this->hydrator[Hydrator\Operation\App\Hook\Deliveries::class], $arguments['cursor'], $arguments['per_page']);
        $request   = $operation->createRequest($params);
