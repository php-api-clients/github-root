...
final class Apps
{
    ...
    public function checkAuthorization(array $params): Authorization|array
    {
        ...
        $operator = new Operator\Apps\CheckAuthorization($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Applications🌀ClientId🌀Tokens🌀AccessToken());
