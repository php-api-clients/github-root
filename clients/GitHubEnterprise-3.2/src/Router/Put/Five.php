...
final class Five
{
    ...
    /** @return array{code: int}||(Schema\ThreadSubscription|array{code: int})|(Schema\Operations\Orgs\ConvertMemberToOutsideCollaborator\Response\ApplicationJson\Accepted\Application\Json|(Schema\Operations\Activity\MarkRepoNotificationsAsRead\Response\ApplicationJson\Accepted\Application\Json|(Schema\TeamMembership */
