...
/** @covers \ApiClients\Client\GitHubEnterprise\Internal\Operation\CodeScanning\GetDefaultSetup */
final class GetDefaultSetupTest extends AsyncTestCase
{
    /** @test */
    public function call_httpCode_200_responseContentType_application_json_zero(): void
    {
        $response = new Response(200, ['Content-Type' => 'application/json'], json_encode(json_decode(Schema\CodeScanningDefaultSetup::SCHEMA_EXAMPLE_DATA, true)));
        ...
        $result = $client->call(Internal\Operation\CodeScanning\GetDefaultSetup::OPERATION_MATCH, (static function (array $data): array {
