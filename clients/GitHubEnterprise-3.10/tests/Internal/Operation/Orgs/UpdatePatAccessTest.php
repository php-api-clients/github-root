...
/** @covers \ApiClients\Client\GitHubEnterprise\Internal\Operation\Orgs\UpdatePatAccess */
final class UpdatePatAccessTest extends AsyncTestCase
{
    ...
    public function call_httpCode_500_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/orgs/generated/personal-access-tokens/6', Argument::type('array'), json_encode(json_decode(Schema\Orgs\UpdatePatAccess\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Internal\Operation\Orgs\UpdatePatAccess::OPERATION_MATCH, (static function (array $data): array {
            $data['org']    = 'generated';
            $data['pat_id'] = 6;

            return $data;
        })(json_decode(Schema\Orgs\UpdatePatAccess\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)));
    }
    ...
    public function operations_httpCode_500_requestContentType_application_json_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('POST', '/orgs/generated/personal-access-tokens/6', Argument::type('array'), json_encode(json_decode(Schema\Orgs\UpdatePatAccess\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true)))->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->orgs()->updatePatAccess('generated', 6, json_decode(Schema\Orgs\UpdatePatAccess\Request\ApplicationJson::SCHEMA_EXAMPLE_DATA, true));
    }
