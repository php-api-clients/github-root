...
/** @covers \ApiClients\Client\GitHubEnterprise\Operation\Repos\CheckAutomatedSecurityFixes */
final class CheckAutomatedSecurityFixesTest extends AsyncTestCase
{
    ...
    public function operations_httpCode_200_responseContentType_application_json_zero(): void
    {
        ...
        $browser->request('GET', '/repos/generated/generated/automated-security-fixes', Argument::type('array'), Argument::any())->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->operations()->repos()->checkAutomatedSecurityFixes('generated', 'generated');
    }
