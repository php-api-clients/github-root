...
final class SetInformationForProvisionedEnterpriseUserTest extends AsyncTestCase
{
    ...
    public function call_httpCode_200_requestContentType_application_json_responseContentType_application_scim_json_zero(): void
    {
        ...
        $browser->request('PUT', '/scim/v2/Users/generated', Argument::type('array'), Schema\User::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = $client->call(Operation\EnterpriseAdmin\SetInformationForProvisionedEnterpriseUser::OPERATION_MATCH, (static function (array $data): array {
    ...
    public function operations_httpCode_200_requestContentType_application_json_responseContentType_application_scim_json_zero(): void
    {
        ...
        $browser->request('PUT', '/scim/v2/Users/generated', Argument::type('array'), Schema\User::SCHEMA_EXAMPLE_DATA)->willReturn(resolve($response))->shouldBeCalled();
        $client = new Client($auth->reveal(), $browser->reveal());
        $result = await($client->operations()->enterpriseAdmin()->setInformationForProvisionedEnterpriseUser('generated', json_decode(Schema\User::SCHEMA_EXAMPLE_DATA, true)));
    }
