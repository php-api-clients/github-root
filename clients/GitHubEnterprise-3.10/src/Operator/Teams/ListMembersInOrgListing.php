...
final readonly class ListMembersInOrgListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Teams\ListMembersInOrgListing($this->responseSchemaValidator, $this->hydrator, $org, $teamSlug, $role, $perPage, $page);
