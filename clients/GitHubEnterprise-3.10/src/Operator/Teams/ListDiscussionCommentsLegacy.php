...
final readonly class ListDiscussionCommentsLegacy
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Teams\ListDiscussionCommentsLegacy($this->responseSchemaValidator, $this->hydrator, $teamId, $discussionNumber, $direction, $perPage, $page);
