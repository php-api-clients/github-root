...
final readonly class CreateTag
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Git\CreateTag($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo);
