...
final readonly class GetAnnouncementBannerForOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\AnnouncementBanners\GetAnnouncementBannerForOrg($this->responseSchemaValidator, $this->hydrator, $org);
