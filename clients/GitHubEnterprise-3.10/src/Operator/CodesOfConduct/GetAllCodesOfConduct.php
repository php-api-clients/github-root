...
namespace ApiClients\Client\GitHubEnterprise\Operator\CodesOfConduct;
...
final readonly class GetAllCodesOfConduct
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\CodesOfConduct\GetAllCodesOfConduct($this->responseSchemaValidator, $this->hydrator);
