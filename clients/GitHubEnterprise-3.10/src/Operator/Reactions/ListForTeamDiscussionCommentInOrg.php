...
final readonly class ListForTeamDiscussionCommentInOrg
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Reactions\ListForTeamDiscussionCommentInOrg($org, $teamSlug, $discussionNumber, $commentNumber, $content, $perPage, $page);
