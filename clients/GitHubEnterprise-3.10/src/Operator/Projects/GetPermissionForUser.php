...
final readonly class GetPermissionForUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Projects\GetPermissionForUser($this->responseSchemaValidator, $this->hydrator, $projectId, $username);
