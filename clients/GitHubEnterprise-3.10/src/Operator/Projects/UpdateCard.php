...
final readonly class UpdateCard
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Projects\UpdateCard($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $cardId);
