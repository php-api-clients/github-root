...
final readonly class GetPackageForOrganization
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Packages\GetPackageForOrganization($this->responseSchemaValidator, $this->hydrator, $packageType, $packageName, $org);
