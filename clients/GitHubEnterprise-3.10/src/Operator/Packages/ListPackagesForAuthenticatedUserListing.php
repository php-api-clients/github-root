...
final readonly class ListPackagesForAuthenticatedUserListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Packages\ListPackagesForAuthenticatedUserListing($this->responseSchemaValidator, $this->hydrator, $packageType, $visibility, $page, $perPage);
