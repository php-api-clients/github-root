...
final readonly class GetPackageVersionForUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Packages\GetPackageVersionForUser($this->responseSchemaValidator, $this->hydrator, $packageType, $packageName, $packageVersionId, $username);
