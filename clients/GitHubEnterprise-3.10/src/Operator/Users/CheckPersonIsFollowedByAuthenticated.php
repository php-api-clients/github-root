...
final readonly class CheckPersonIsFollowedByAuthenticated
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Users\CheckPersonIsFollowedByAuthenticated($this->responseSchemaValidator, $this->hydrator, $username);
