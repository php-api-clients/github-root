...
final readonly class GetCustomDeploymentProtectionRule
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Repos\GetCustomDeploymentProtectionRule($this->responseSchemaValidator, $this->hydrator, $owner, $repo, $environmentName, $protectionRuleId);
