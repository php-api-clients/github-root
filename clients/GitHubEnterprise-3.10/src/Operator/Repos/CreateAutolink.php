...
final readonly class CreateAutolink
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Repos\CreateAutolink($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $owner, $repo);
