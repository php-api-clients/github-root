...
final readonly class ConvertMemberToOutsideCollaborator
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Orgs\ConvertMemberToOutsideCollaborator($this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrator, $org, $username);
