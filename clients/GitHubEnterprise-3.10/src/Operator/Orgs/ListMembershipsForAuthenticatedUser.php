...
final readonly class ListMembershipsForAuthenticatedUser
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Operation\Orgs\ListMembershipsForAuthenticatedUser($this->responseSchemaValidator, $this->hydrator, $state, $perPage, $page);
