...
final readonly class WebhookFork
{
    ...
    "properties": {
        ...
        "forkee": {
            ...
            "description": "The created [`repository`](https:\\/\\/docs.github.com\\/enterprise-server@3.10\\/rest\\/repos\\/repos#get-a-repository) resource."
        },
        "installation": {
     ...
     * forkee: The created [`repository`](https://docs.github.com/enterprise-server@3.10/rest/repos/repos#get-a-repository) resource.
