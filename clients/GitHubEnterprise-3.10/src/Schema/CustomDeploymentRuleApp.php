...
final readonly class CustomDeploymentRuleApp
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"id":3515,"slug":"my-custom-app","integration_url":"https:\\/\\/api.github.com\\/apps\\/custom-app-slug","node_id":"MDQ6R2F0ZTM1MTU="}';
