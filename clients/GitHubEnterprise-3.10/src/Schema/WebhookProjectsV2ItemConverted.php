...
final readonly class WebhookProjectsV2ItemConverted
{
    ...
    public const SCHEMA_TITLE        = 'Projects v2 Item Converted Event';
     ...
     */
    public function __construct(public string $action, public Schema\WebhookProjectsV2ItemConverted\Changes $changes, public Schema\SimpleInstallation|null $installation, public Schema\OrganizationSimpleWebhooks $organization, #[MapFrom('projects_v2_item')]
