...
final readonly class ApplicationJson
{
    ...
    /**
     * config: Key/value pairs to provide settings for this webhook. [These are defined below](https://docs.github.com/enterprise-server@3.10/rest/reference/orgs#update-hook-config-params).
