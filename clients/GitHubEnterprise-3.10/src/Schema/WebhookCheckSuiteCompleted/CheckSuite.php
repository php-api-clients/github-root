...
namespace ApiClients\Client\GitHubEnterprise\Schema\WebhookCheckSuiteCompleted;
...
final readonly class CheckSuite
{
    ...
    public const SCHEMA_DESCRIPTION  = 'The [check_suite](https://docs.github.com/enterprise-server@3.10/rest/checks/suites#get-a-check-suite).';
