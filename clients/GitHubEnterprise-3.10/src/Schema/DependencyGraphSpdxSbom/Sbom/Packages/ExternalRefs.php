...
namespace ApiClients\Client\GitHubEnterprise\Schema\DependencyGraphSpdxSbom\Sbom\Packages;
...
final readonly class ExternalRefs
{
    ...
    public const SCHEMA_EXAMPLE_DATA = '{"referenceCategory":"PACKAGE-MANAGER","referenceLocator":"pkg:gem\\/rails@6.0.1","referenceType":"purl"}';
