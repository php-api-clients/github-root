...
final readonly class WebhookDeploymentStatusCreated
{
    ...
    "properties": {
        ...
        "deployment": {
            ...
            "description": "The [deployment](https:\\/\\/docs.github.com\\/enterprise-server@3.10\\/rest\\/deployments\\/deployments#list-deployments)."
        },
        "deployment_status": {
            "required": [
                "url",
    ...
    /**
     * deployment: The [deployment](https://docs.github.com/enterprise-server@3.10/rest/deployments/deployments#list-deployments).
     * deploymentStatus: The [deployment status](https://docs.github.com/enterprise-server@3.10/rest/deployments/statuses#list-deployment-statuses).
