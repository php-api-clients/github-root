...
final readonly class WebhookDelete
{
    ...
    "properties": {
        ...
        "ref": {
            "type": "string",
            "description": "The [`git ref`](https:\\/\\/docs.github.com\\/enterprise-server@3.10\\/rest\\/git\\/refs#get-a-reference) resource."
        },
        "ref_type": {
            "enum": [
                "tag",
     ...
     * ref: The [`git ref`](https://docs.github.com/enterprise-server@3.10/rest/git/refs#get-a-reference) resource.
