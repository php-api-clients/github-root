...
namespace ApiClients\Client\GitHubEnterprise\Schema\WebhookPullRequestReviewThreadResolved\Thread;
...
final readonly class Comments
{
    ...
    public const SCHEMA_DESCRIPTION  = 'The [comment](https://docs.github.com/enterprise-server@3.10/rest/pulls/comments#get-a-review-comment-for-a-pull-request) itself.';
