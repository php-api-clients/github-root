...
namespace ApiClients\Client\GitHubEnterprise\Schema\AliasAbstract\Tiet660BEF1D\TietC51A1A81\TietA8514BFA;

use EventSauce\ObjectHydrator\MapFrom;

abstract readonly class TietA4D13AC9
{
     ...
     * secret: If provided, the `secret` will be used as the `key` to generate the HMAC hex digest value in the [`X-Hub-Signature`](https://docs.github.com/enterprise-server@3.10/webhooks/event-payloads/#delivery-headers) header.
