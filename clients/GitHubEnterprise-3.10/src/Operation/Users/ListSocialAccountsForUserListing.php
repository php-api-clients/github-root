...
final class ListSocialAccountsForUserListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Users\Username\SocialAccounts $hydrator, string $username, int $perPage = 30, int $page = 1)
    {
