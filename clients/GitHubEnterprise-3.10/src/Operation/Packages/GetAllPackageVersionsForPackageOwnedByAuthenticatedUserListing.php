...
final class GetAllPackageVersionsForPackageOwnedByAuthenticatedUserListing
{
    ...
    public function __construct(private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\User\Packages\PackageType\PackageName\Versions $hydrator, string $packageType, string $packageName, int $page = 1, int $perPage = 30, string $state = 'active')
    {
