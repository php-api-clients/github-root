...
final class UpdateLdapMappingForTeam
{
    ...
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Admin\Ldap\Teams\TeamId\Mapping $hydrator, int $teamId)
    {
        $this->teamId = $teamId;
    }
