...
final class SetManageMaintenance
{
    ...
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly SchemaValidator $responseSchemaValidator, private readonly Hydrator\Operation\Manage\V1\Maintenance $hydrator)
    {
    }
                    ...
                    case 200:
                        return Observable::fromArray($body, new ImmediateScheduler())->map(function (array $body): Schema\GhesSetMaintenanceResponse {
                            ...
                            try {
                                ...
                                return $this->hydrator->hydrateObject(Schema\GhesSetMaintenanceResponse::class, $body);
