...
final class Actions
{
    ...
    public function getActionsCacheUsagePolicyForEnterprise(string $enterprise): PromiseInterface
    {
    ...
    public function setActionsCacheUsagePolicyForEnterprise(string $enterprise, array $params): PromiseInterface
    {
    ...
    public function getActionsCacheUsagePolicy(string $owner, string $repo): PromiseInterface
    {
    ...
    public function setActionsCacheUsagePolicy(string $owner, string $repo, array $params): PromiseInterface
    {
