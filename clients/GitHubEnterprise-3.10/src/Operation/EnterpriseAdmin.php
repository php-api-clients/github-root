...
final class EnterpriseAdmin
{
    ...
    /** @return Schema\EnterpriseSecurityProductsOverview */
    public function getSecurityProducts(): EnterpriseSecurityProductsOverview|array
    {
    ...
    public function getConfigNodes(string $uuid, string $clusterRoles): GhesConfigNodes|array
    {
    ...
    public function getManageMaintenance(string $uuid, string $clusterRoles): iterable
    {
    ...
    public function getReplicationStatus(string $uuid, string $clusterRoles): GhesReplicationStatus|array
    {
    ...
    public function getVersion(string $uuid, string $clusterRoles): iterable
    {
    ...
    public function listProvisionedIdentitiesEnterprise(string $filter, string $excludedAttributes, int $startIndex, int $count): ScimEnterpriseUserList|array
    {
        return $this->operators->enterpriseAdmin👷ListProvisionedIdentitiesEnterprise()->call($filter, $excludedAttributes, $startIndex, $count);
    }
