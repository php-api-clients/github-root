...
final class EnterpriseAdmin
{
    ...
    public function updateLdapMappingForTeam(int $teamId, array $params): PromiseInterface
    {
    ...
    public function syncLdapMappingForTeam(int $teamId): PromiseInterface
    {
    ...
    public function updateLdapMappingForUser(string $username, array $params): PromiseInterface
    {
    ...
    public function syncLdapMappingForUser(string $username): PromiseInterface
    {
    ...
    public function listPreReceiveHooks(int $perPage, int $page, string $direction, string $sort): PromiseInterface
    {
    ...
    public function createPreReceiveHook(array $params): PromiseInterface
    {
    ...
    public function getPreReceiveHook(int $preReceiveHookId): PromiseInterface
    {
    ...
    public function deletePreReceiveHook(int $preReceiveHookId): PromiseInterface
    {
    ...
    public function updatePreReceiveHook(int $preReceiveHookId, array $params): PromiseInterface
    {
    ...
    public function createUser(array $params): PromiseInterface
    {
    ...
    public function updateUsernameForUser(string $username, array $params): PromiseInterface
    {
    ...
    public function getSecurityProducts(): PromiseInterface
    {
        if (array_key_exists(Operator\EnterpriseAdmin\GetSecurityProducts::class, $this->operator) === false) {
            $this->operator[Operator\EnterpriseAdmin\GetSecurityProducts::class] = new Operator\EnterpriseAdmin\GetSecurityProducts($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprise🌀Stats🌀SecurityProducts());
        }

        return $this->operator[Operator\EnterpriseAdmin\GetSecurityProducts::class]->call();
    }
    ...
    public function listOrgAccessToSelfHostedRunnerGroupInEnterprise(string $enterprise, int $runnerGroupId, int $perPage, int $page): PromiseInterface
    {
    ...
    public function setOrgAccessToSelfHostedRunnerGroupInEnterprise(string $enterprise, int $runnerGroupId, array $params): PromiseInterface
    {
    ...
    public function addOrgAccessToSelfHostedRunnerGroupInEnterprise(string $enterprise, int $runnerGroupId, int $orgId): PromiseInterface
    {
    ...
    public function removeOrgAccessToSelfHostedRunnerGroupInEnterprise(string $enterprise, int $runnerGroupId, int $orgId): PromiseInterface
    {
    ...
    public function listLabelsForSelfHostedRunnerForEnterprise(string $enterprise, int $runnerId): PromiseInterface
    {
    ...
    public function setCustomLabelsForSelfHostedRunnerForEnterprise(string $enterprise, int $runnerId, array $params): PromiseInterface
    {
    ...
    public function addCustomLabelsToSelfHostedRunnerForEnterprise(string $enterprise, int $runnerId, array $params): PromiseInterface
    {
    ...
    public function removeAllCustomLabelsFromSelfHostedRunnerForEnterprise(string $enterprise, int $runnerId): PromiseInterface
    {
    ...
    public function removeCustomLabelFromSelfHostedRunnerForEnterprise(string $enterprise, int $runnerId, string $name): PromiseInterface
    {
    ...
    public function getAuditLog(string $enterprise, string $phrase, string $include, string $after, string $before, string $order, int $page, int $perPage): PromiseInterface
    {
    ...
    public function getManageMaintenance(string $uuid, string $clusterRoles): PromiseInterface
    {
        if (array_key_exists(Operator\EnterpriseAdmin\GetManageMaintenance::class, $this->operator) === false) {
            $this->operator[Operator\EnterpriseAdmin\GetManageMaintenance::class] = new Operator\EnterpriseAdmin\GetManageMaintenance($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Manage🌀V1🌀Maintenance());
        }

        return $this->operator[Operator\EnterpriseAdmin\GetManageMaintenance::class]->call($uuid, $clusterRoles);
    }

    public function setManageMaintenance(array $params): PromiseInterface
    {
        if (array_key_exists(Operator\EnterpriseAdmin\SetManageMaintenance::class, $this->operator) === false) {
            $this->operator[Operator\EnterpriseAdmin\SetManageMaintenance::class] = new Operator\EnterpriseAdmin\SetManageMaintenance($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Manage🌀V1🌀Maintenance());
        }

        return $this->operator[Operator\EnterpriseAdmin\SetManageMaintenance::class]->call($params);
    }
    ...
    public function getPreReceiveHookForOrg(string $org, int $preReceiveHookId): PromiseInterface
    {
    ...
    public function removePreReceiveHookEnforcementForOrg(string $org, int $preReceiveHookId): PromiseInterface
    {
    ...
    public function updatePreReceiveHookEnforcementForOrg(string $org, int $preReceiveHookId, array $params): PromiseInterface
    {
    ...
    public function listPreReceiveHooksForRepo(string $owner, string $repo, int $perPage, int $page, string $direction, string $sort): PromiseInterface
    {
    ...
    public function getPreReceiveHookForRepo(string $owner, string $repo, int $preReceiveHookId): PromiseInterface
    {
    ...
    public function removePreReceiveHookEnforcementForRepo(string $owner, string $repo, int $preReceiveHookId): PromiseInterface
    {
    ...
    public function updatePreReceiveHookEnforcementForRepo(string $owner, string $repo, int $preReceiveHookId, array $params): PromiseInterface
    {
    ...
    public function listProvisionedGroupsEnterprise(string $filter, string $excludedAttributes, int $startIndex, int $count): PromiseInterface
    {
        if (array_key_exists(Operator\EnterpriseAdmin\ListProvisionedGroupsEnterprise::class, $this->operator) === false) {
            $this->operator[Operator\EnterpriseAdmin\ListProvisionedGroupsEnterprise::class] = new Operator\EnterpriseAdmin\ListProvisionedGroupsEnterprise($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Scim🌀V2🌀Groups());
        }

        return $this->operator[Operator\EnterpriseAdmin\ListProvisionedGroupsEnterprise::class]->call($filter, $excludedAttributes, $startIndex, $count);
    }

    public function provisionEnterpriseGroup(array $params): PromiseInterface
    {
        if (array_key_exists(Operator\EnterpriseAdmin\ProvisionEnterpriseGroup::class, $this->operator) === false) {
            $this->operator[Operator\EnterpriseAdmin\ProvisionEnterpriseGroup::class] = new Operator\EnterpriseAdmin\ProvisionEnterpriseGroup($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Scim🌀V2🌀Groups());
        }

        return $this->operator[Operator\EnterpriseAdmin\ProvisionEnterpriseGroup::class]->call($params);
    }

    public function getProvisioningInformationForEnterpriseGroup(string $scimGroupId, string $excludedAttributes): PromiseInterface
    {
        if (array_key_exists(Operator\EnterpriseAdmin\GetProvisioningInformationForEnterpriseGroup::class, $this->operator) === false) {
            $this->operator[Operator\EnterpriseAdmin\GetProvisioningInformationForEnterpriseGroup::class] = new Operator\EnterpriseAdmin\GetProvisioningInformationForEnterpriseGroup($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Scim🌀V2🌀Groups🌀ScimGroupId());
        }

        return $this->operator[Operator\EnterpriseAdmin\GetProvisioningInformationForEnterpriseGroup::class]->call($scimGroupId, $excludedAttributes);
    }

    public function setInformationForProvisionedEnterpriseGroup(string $scimGroupId, array $params): PromiseInterface
    {
        if (array_key_exists(Operator\EnterpriseAdmin\SetInformationForProvisionedEnterpriseGroup::class, $this->operator) === false) {
            $this->operator[Operator\EnterpriseAdmin\SetInformationForProvisionedEnterpriseGroup::class] = new Operator\EnterpriseAdmin\SetInformationForProvisionedEnterpriseGroup($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Scim🌀V2🌀Groups🌀ScimGroupId());
        }

        return $this->operator[Operator\EnterpriseAdmin\SetInformationForProvisionedEnterpriseGroup::class]->call($scimGroupId, $params);
    }

    public function deleteScimGroupFromEnterprise(string $scimGroupId): PromiseInterface
    {
        if (array_key_exists(Operator\EnterpriseAdmin\DeleteScimGroupFromEnterprise::class, $this->operator) === false) {
            $this->operator[Operator\EnterpriseAdmin\DeleteScimGroupFromEnterprise::class] = new Operator\EnterpriseAdmin\DeleteScimGroupFromEnterprise($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Scim🌀V2🌀Groups🌀ScimGroupId());
        }

        return $this->operator[Operator\EnterpriseAdmin\DeleteScimGroupFromEnterprise::class]->call($scimGroupId);
    }

    public function updateAttributeForEnterpriseGroup(string $scimGroupId, array $params): PromiseInterface
    {
        if (array_key_exists(Operator\EnterpriseAdmin\UpdateAttributeForEnterpriseGroup::class, $this->operator) === false) {
            $this->operator[Operator\EnterpriseAdmin\UpdateAttributeForEnterpriseGroup::class] = new Operator\EnterpriseAdmin\UpdateAttributeForEnterpriseGroup($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Scim🌀V2🌀Groups🌀ScimGroupId());
        }

        return $this->operator[Operator\EnterpriseAdmin\UpdateAttributeForEnterpriseGroup::class]->call($scimGroupId, $params);
    }

    public function listProvisionedIdentitiesEnterprise(string $filter, string $excludedAttributes, int $startIndex, int $count): PromiseInterface
    {
        if (array_key_exists(Operator\EnterpriseAdmin\ListProvisionedIdentitiesEnterprise::class, $this->operator) === false) {
            $this->operator[Operator\EnterpriseAdmin\ListProvisionedIdentitiesEnterprise::class] = new Operator\EnterpriseAdmin\ListProvisionedIdentitiesEnterprise($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Scim🌀V2🌀Users());
        }

        return $this->operator[Operator\EnterpriseAdmin\ListProvisionedIdentitiesEnterprise::class]->call($filter, $excludedAttributes, $startIndex, $count);
    }

    public function provisionEnterpriseUser(array $params): PromiseInterface
    {
        if (array_key_exists(Operator\EnterpriseAdmin\ProvisionEnterpriseUser::class, $this->operator) === false) {
            $this->operator[Operator\EnterpriseAdmin\ProvisionEnterpriseUser::class] = new Operator\EnterpriseAdmin\ProvisionEnterpriseUser($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Scim🌀V2🌀Users());
        }

        return $this->operator[Operator\EnterpriseAdmin\ProvisionEnterpriseUser::class]->call($params);
    }

    public function getProvisioningInformationForEnterpriseUser(string $scimUserId): PromiseInterface
    {
        if (array_key_exists(Operator\EnterpriseAdmin\GetProvisioningInformationForEnterpriseUser::class, $this->operator) === false) {
            $this->operator[Operator\EnterpriseAdmin\GetProvisioningInformationForEnterpriseUser::class] = new Operator\EnterpriseAdmin\GetProvisioningInformationForEnterpriseUser($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Scim🌀V2🌀Users🌀ScimUserId());
        }

        return $this->operator[Operator\EnterpriseAdmin\GetProvisioningInformationForEnterpriseUser::class]->call($scimUserId);
    }

    public function setInformationForProvisionedEnterpriseUser(string $scimUserId, array $params): PromiseInterface
    {
        if (array_key_exists(Operator\EnterpriseAdmin\SetInformationForProvisionedEnterpriseUser::class, $this->operator) === false) {
            $this->operator[Operator\EnterpriseAdmin\SetInformationForProvisionedEnterpriseUser::class] = new Operator\EnterpriseAdmin\SetInformationForProvisionedEnterpriseUser($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Scim🌀V2🌀Users🌀ScimUserId());
        }

        return $this->operator[Operator\EnterpriseAdmin\SetInformationForProvisionedEnterpriseUser::class]->call($scimUserId, $params);
    }

    public function deleteUserFromEnterprise(string $scimUserId): PromiseInterface
    {
        if (array_key_exists(Operator\EnterpriseAdmin\DeleteUserFromEnterprise::class, $this->operator) === false) {
            $this->operator[Operator\EnterpriseAdmin\DeleteUserFromEnterprise::class] = new Operator\EnterpriseAdmin\DeleteUserFromEnterprise($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Scim🌀V2🌀Users🌀ScimUserId());
        }

        return $this->operator[Operator\EnterpriseAdmin\DeleteUserFromEnterprise::class]->call($scimUserId);
    }

    public function updateAttributeForEnterpriseUser(string $scimUserId, array $params): PromiseInterface
    {
        if (array_key_exists(Operator\EnterpriseAdmin\UpdateAttributeForEnterpriseUser::class, $this->operator) === false) {
            $this->operator[Operator\EnterpriseAdmin\UpdateAttributeForEnterpriseUser::class] = new Operator\EnterpriseAdmin\UpdateAttributeForEnterpriseUser($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Scim🌀V2🌀Users🌀ScimUserId());
        }

        return $this->operator[Operator\EnterpriseAdmin\UpdateAttributeForEnterpriseUser::class]->call($scimUserId, $params);
    }

    public function getConfigurationStatus(): PromiseInterface
    {
    ...
    public function startConfigurationProcess(): PromiseInterface
    {
    ...
    public function getMaintenanceStatus(): PromiseInterface
    {
    ...
    public function enableOrDisableMaintenanceMode(array $params): PromiseInterface
    {
    ...
    public function setSettings(array $params): PromiseInterface
    {
    ...
    public function getAllAuthorizedSshKeys(): PromiseInterface
    {
    ...
    public function addAuthorizedSshKey(array $params): PromiseInterface
    {
    ...
    public function removeAuthorizedSshKey(array $params): PromiseInterface
    {
    ...
    public function createEnterpriseServerLicense(array $params): PromiseInterface
    {
    ...
    public function upgradeLicense(array $params): PromiseInterface
    {
    ...
    public function promoteUserToBeSiteAdministrator(string $username): PromiseInterface
    {
    ...
    public function demoteSiteAdministrator(string $username): PromiseInterface
    {
