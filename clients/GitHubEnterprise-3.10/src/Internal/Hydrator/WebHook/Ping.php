...
use ApiClients\Client\GitHubEnterprise\Schema\WebhookPing;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookPing\Hook;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookPing\Hook\Config;
use ApiClients\Client\GitHubEnterprise\Schema\WebhookPingFormEncoded;
...
class Ping implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPing(array $payload): WebhookPing
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPing⚡️Hook(array $payload): Hook
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPing⚡️Hook⚡️Config(array $payload): Config
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️WebhookPingFormEncoded(array $payload): WebhookPingFormEncoded
    {
        $properties    = [];
        $missingFields = [];
        try {
