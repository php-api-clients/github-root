...
class SecretScanningAlertLocation implements ObjectMapper
{
    ...
    private function serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️SecretScanningLocation(mixed $object): mixed
    {
        ...
        $details = match ($details::class) {
                        'ApiClients\Client\GitHubEnterprise\Schema\SecretScanningLocationCommit' => $this->serializeObjectApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️SecretScanningLocationCommit($details),
