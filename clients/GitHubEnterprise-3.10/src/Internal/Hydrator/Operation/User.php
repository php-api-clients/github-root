...
use ApiClients\Client\GitHubEnterprise\Schema\PrivateUser\Plan;
...
class User implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️PrivateUser(array $payload): PrivateUser
    {
        $properties    = [];
        $missingFields = [];
        try {
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️PrivateUser⚡️Plan(array $payload): Plan
    {
        $properties    = [];
        $missingFields = [];
        try {
