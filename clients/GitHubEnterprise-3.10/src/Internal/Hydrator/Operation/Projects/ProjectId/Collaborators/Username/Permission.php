...
namespace ApiClients\Client\GitHubEnterprise\Internal\Hydrator\Operation\Projects\ProjectId\Collaborators\Username;
...
class Permission implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️ProjectCollaboratorPermission(array $payload): ProjectCollaboratorPermission
    {
        $properties    = [];
        $missingFields = [];
        try {
