...
final readonly class ListPatGrantRequestRepositoriesListing
{
    ...
    {
        $operation = new \ApiClients\Client\GitHubEnterprise\Internal\Operation\Orgs\ListPatGrantRequestRepositoriesListing($this->responseSchemaValidator, $this->hydrator, $org, $patRequestId, $perPage, $page);
