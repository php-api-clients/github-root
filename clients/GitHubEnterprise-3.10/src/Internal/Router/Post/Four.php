...
final class Four
{
    ...
    /** @return Schema\Integration|Schema\Authorization|Schema\GistComment|array{code:int}|Schema\BaseGist|iterable<Schema\GhesSetMaintenanceResponse>|Schema\OrganizationCustomRepositoryRole|Schema\OrgHook|Schema\Migration|Schema\Operations\Orgs\ReviewPatGrantRequestsInBulk\Response\ApplicationJson\Accepted\Application\Json|Schema\Operations\Orgs\UpdatePatAccesses\Response\ApplicationJson\Accepted\Application\Json|Schema\Project|Schema\Repository|Schema\TeamFull|Schema\ProjectColumn|Schema\GroupResponse|Schema\UserResponse|Schema\MaintenanceStatus|Schema\TeamDiscussion */
