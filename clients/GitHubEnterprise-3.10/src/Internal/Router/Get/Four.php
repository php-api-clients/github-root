...
final class Four
{
    ...
    /** @return Schema\GlobalHook|Schema\PreReceiveEnvironment|Schema\PreReceiveHook|Schema\WebhookConfig|iterable<Schema\HookDeliveryItem>|Schema\Installation|Schema\ApplicationGrant|array{code:int}|Schema\LicenseInfo|Schema\EnterpriseOverview|Schema\EnterpriseCommentOverview|Schema\EnterpriseGistOverview|Schema\EnterpriseHookOverview|Schema\EnterpriseIssueOverview|Schema\EnterpriseMilestoneOverview|Schema\EnterpriseOrganizationOverview|Schema\EnterprisePageOverview|Schema\EnterprisePullRequestOverview|Schema\EnterpriseRepositoryOverview|Schema\EnterpriseSecurityProductsOverview|Schema\EnterpriseUserOverview|iterable<Schema\AuditLogEvent>|Schema\EnterpriseSecurityAnalysisSettings|iterable<Schema\GistComment>|iterable<Schema\GistCommit>|iterable<Schema\GistSimple>|Schema\GistSimple|Schema\GitignoreTemplate|iterable<Schema\GhesGetMaintenance>|iterable<Schema\GhesVersion>|Schema\Thread|Schema\Operations\Orgs\ListCustomRoles\Response\ApplicationJson\Ok|Schema\AnnouncementBanner|Schema\Operations\Orgs\ListCustomRepoRoles\Response\ApplicationJson\Ok\Application\Json|iterable<Schema\Event>|Schema\ExternalGroups|iterable<Schema\OrgHook>|Schema\Operations\Orgs\ListAppInstallations\Response\ApplicationJson\Ok|iterable<Schema\Issue>|iterable<Schema\SimpleUser>|iterable<Schema\Migration>|iterable<Schema\Package>|iterable<Schema\OrganizationProgrammaticAccessGrantRequest>|iterable<Schema\OrganizationProgrammaticAccessGrant>|iterable<Schema\OrgPreReceiveHook>|iterable<Schema\Project>|iterable<Schema\MinimalRepository>|iterable<Schema\RepositoryFineGrainedPermission>|iterable<Schema\TeamSimple>|iterable<Schema\Team>|Schema\ProjectColumn|iterable<Schema\ProjectColumn>|Schema\FullRepository|Schema\BasicError|Schema\ScimEnterpriseGroupList|Schema\ScimEnterpriseUserList|Schema\ConfigurationStatus|Schema\MaintenanceStatus|Schema\EnterpriseSettings|iterable<Schema\TeamDiscussion>|iterable<Schema\TeamProject>|Schema\GpgKey|Schema\Key|iterable<Schema\OrgMembership>|Schema\SshSigningKey|iterable<Schema\BaseGist>|iterable<Schema\GpgKey>|Schema\Hovercard|iterable<Schema\KeySimple>|iterable<Schema\OrganizationSimple>|iterable<Schema\SocialAccount>|iterable<Schema\SshSigningKey>|Schema\StarredRepository|Schema\Repository */
