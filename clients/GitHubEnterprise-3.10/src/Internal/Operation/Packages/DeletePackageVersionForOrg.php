...
final class DeletePackageVersionForOrg
{
    ...
    {
        return new Request('DELETE', str_replace(['{package_type}', '{package_name}', '{org}', '{package_version_id}'], [$this->packageType, $this->packageName, $this->org, $this->packageVersionId], '/orgs/{org}/packages/{package_type}/{package_name}/versions/{package_version_id}'));
    }
