...
/** @internal */
final class Enterprise implements WebHookInterface
{
    public function __construct(private readonly SchemaValidator $requestSchemaValidator, private readonly Internal\Hydrator\WebHook\Enterprise $hydrator)
    {
    }
    ...
    public function resolve(array $headers, array $data): Schema\WebhookEnterpriseAnonymousAccessDisabled|Schema\WebhookEnterpriseAnonymousAccessEnabled
    {
        ...
        if ($headers['content-type'] === 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($data, Reader::readFromJson(Schema\WebhookEnterpriseAnonymousAccessDisabled::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
        ...
        if ($headers['content-type'] === 'application/json') {
            try {
                ...
                $this->requestSchemaValidator->validate($headers['x-github-enterprise-version'], Reader::readFromJson(Schema\WebHookHeader\XGitHubEnterpriseVersion::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                $this->requestSchemaValidator->validate($headers['x-github-enterprise-host'], Reader::readFromJson(Schema\WebHookHeader\XGitHubEnterpriseHost::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
                $this->requestSchemaValidator->validate($data, Reader::readFromJson(Schema\WebhookEnterpriseAnonymousAccessEnabled::SCHEMA_JSON, '\\cebe\\openapi\\spec\\Schema'));
