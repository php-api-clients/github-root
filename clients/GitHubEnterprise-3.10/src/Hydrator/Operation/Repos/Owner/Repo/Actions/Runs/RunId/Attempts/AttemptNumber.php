...
namespace ApiClients\Client\GitHubEnterprise\Hydrator\Operation\Repos\Owner\Repo\Actions\Runs\RunId\Attempts;
...
class AttemptNumber implements ObjectMapper
{
    ...
    private function hydrateApiClients⚡️Client⚡️GitHubEnterprise⚡️Schema⚡️SecurityAndAnalysis⚡️DependabotSecurityUpdates(array $payload): \ApiClients\Client\GitHubEnterprise\Schema\SecurityAndAnalysis\DependabotSecurityUpdates
    {
        $properties = []; 
        $missingFields = [];
        try {
        ...
        if (count($missingFields) > 0) {
            throw UnableToHydrateObject::dueToMissingFields(\ApiClients\Client\GitHubEnterprise\Schema\SecurityAndAnalysis\DependabotSecurityUpdates::class, $missingFields, stack: $this->hydrationStack);
        }

        try {
            return new \ApiClients\Client\GitHubEnterprise\Schema\SecurityAndAnalysis\DependabotSecurityUpdates(...$properties);
        } catch (\Throwable $exception) {
            throw UnableToHydrateObject::dueToError('ApiClients\Client\GitHubEnterprise\Schema\SecurityAndAnalysis\DependabotSecurityUpdates', $exception, stack: $this->hydrationStack);
        }
    }
    ...
    {
        \assert($object instanceof \ApiClients\Client\GitHubEnterprise\Schema\SecurityAndAnalysis\DependabotSecurityUpdates);
        $result = [];
