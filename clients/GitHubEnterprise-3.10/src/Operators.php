...
final class Operators
{
    ...
    private Operator\EnterpriseAdmin\GetSecurityProducts|null $enterpriseAdmin👷GetSecurityProducts                                                                         = null;
    ...
    private Operator\Actions\GenerateRunnerJitconfigForEnterprise|null $actions👷GenerateRunnerJitconfigForEnterprise                                                       = null;
    ...
    private Operator\EnterpriseAdmin\GetManageMaintenance|null $enterpriseAdmin👷GetManageMaintenance                                                                       = null;
    private Operator\EnterpriseAdmin\SetManageMaintenance|null $enterpriseAdmin👷SetManageMaintenance                                                                       = null;
    ...
    public function enterpriseAdmin👷GetSecurityProducts(): Operator\EnterpriseAdmin\GetSecurityProducts
    {
        if ($this->enterpriseAdmin👷GetSecurityProducts instanceof Operator\EnterpriseAdmin\GetSecurityProducts === false) {
            $this->enterpriseAdmin👷GetSecurityProducts = new Operator\EnterpriseAdmin\GetSecurityProducts($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprise🌀Stats🌀SecurityProducts());
        }
    ...
    public function actions👷GenerateRunnerJitconfigForEnterprise(): Operator\Actions\GenerateRunnerJitconfigForEnterprise
    {
        if ($this->actions👷GenerateRunnerJitconfigForEnterprise instanceof Operator\Actions\GenerateRunnerJitconfigForEnterprise === false) {
            $this->actions👷GenerateRunnerJitconfigForEnterprise = new Operator\Actions\GenerateRunnerJitconfigForEnterprise($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀Actions🌀Runners🌀GenerateJitconfig());
        }
    ...
    public function enterpriseAdmin👷GetManageMaintenance(): Operator\EnterpriseAdmin\GetManageMaintenance
    {
        if ($this->enterpriseAdmin👷GetManageMaintenance instanceof Operator\EnterpriseAdmin\GetManageMaintenance === false) {
            $this->enterpriseAdmin👷GetManageMaintenance = new Operator\EnterpriseAdmin\GetManageMaintenance($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Manage🌀V1🌀Maintenance());
        }

        return $this->enterpriseAdmin👷GetManageMaintenance;
    }

    public function enterpriseAdmin👷SetManageMaintenance(): Operator\EnterpriseAdmin\SetManageMaintenance
    {
        if ($this->enterpriseAdmin👷SetManageMaintenance instanceof Operator\EnterpriseAdmin\SetManageMaintenance === false) {
            $this->enterpriseAdmin👷SetManageMaintenance = new Operator\EnterpriseAdmin\SetManageMaintenance($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Manage🌀V1🌀Maintenance());
        }
