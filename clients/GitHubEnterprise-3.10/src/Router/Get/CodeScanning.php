...
final class CodeScanning
{
    ...
    public function getDefaultSetup(array $params): CodeScanningDefaultSetup|array
    {
        ...
        $arguments['repo'] = $params['repo'];
        unset($params['repo']);
        $operator = new Operator\CodeScanning\GetDefaultSetup($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀CodeScanning🌀DefaultSetup());
    ...
    public function listAlertsForEnterprise(array $params): iterable
    {
        ...
        $arguments['sort'] = $params['sort'];
        unset($params['sort']);
        $operator = new Operator\CodeScanning\ListAlertsForEnterprise($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀CodeScanning🌀Alerts());
