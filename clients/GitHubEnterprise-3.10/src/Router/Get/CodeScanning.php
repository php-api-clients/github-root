...
final class CodeScanning
{
    ...
    public function listAlertsForEnterprise(array $params)
    {
        ...
        $operator = new Operator\CodeScanning\ListAlertsForEnterprise($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrator[Hydrator\Operation\Enterprises\Enterprise\CodeScanning\Alerts::class]);
