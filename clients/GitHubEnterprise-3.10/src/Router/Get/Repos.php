...
final class Repos
{
    ...
    public function listCacheInfo(array $params): iterable
    {
        ...
        $arguments['page'] = $params['page'];
        unset($params['page']);
        $operator = new Operator\Repos\ListCacheInfo($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Replicas🌀Caches());
    ...
    public function listTagProtection(array $params): iterable
    {
        ...
        $arguments['repo'] = $params['repo'];
        unset($params['repo']);
        $operator = new Operator\Repos\ListTagProtection($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Tags🌀Protection());
    ...
    public function listPublic(array $params): iterable
    {
        ...
        $arguments['visibility'] = $params['visibility'];
        unset($params['visibility']);
        $operator = new Operator\Repos\ListPublic($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repositories());
    ...
    public function checkAutomatedSecurityFixes(array $params): CheckAutomatedSecurityFixes|array
    {
        ...
        $arguments['repo'] = $params['repo'];
        unset($params['repo']);
        $operator = new Operator\Repos\CheckAutomatedSecurityFixes($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀AutomatedSecurityFixes());
    ...
    /** @return */
    public function getAllDeploymentProtectionRules(array $params): \ApiClients\Client\GitHubEnterprise\Schema\Operations\Repos\GetAllDeploymentProtectionRules\Response\ApplicationJson\Ok|array
    {
        $arguments = [];
        if (array_key_exists('environment_name', $params) === false) {
            throw new InvalidArgumentException('Missing mandatory field: environment_name');
        ...
        $arguments['owner'] = $params['owner'];
        unset($params['owner']);
        $operator = new Operator\Repos\GetAllDeploymentProtectionRules($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Environments🌀EnvironmentName🌀DeploymentProtectionRules());
    ...
    /** @return */
    public function listCustomDeploymentRuleIntegrations(array $params): \ApiClients\Client\GitHubEnterprise\Schema\Operations\Repos\ListCustomDeploymentRuleIntegrations\Response\ApplicationJson\Ok|array
    {
        $arguments = [];
        if (array_key_exists('environment_name', $params) === false) {
            throw new InvalidArgumentException('Missing mandatory field: environment_name');
        ...
        $arguments['per_page'] = $params['per_page'];
        unset($params['per_page']);
        $operator = new Operator\Repos\ListCustomDeploymentRuleIntegrations($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Environments🌀EnvironmentName🌀DeploymentProtectionRules🌀Apps());
    ...
    public function getCustomDeploymentProtectionRule(array $params): DeploymentProtectionRule|array
    {
        ...
        $operator = new Operator\Repos\GetCustomDeploymentProtectionRule($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Repos🌀Owner🌀Repo🌀Environments🌀EnvironmentName🌀DeploymentProtectionRules🌀ProtectionRuleId());
