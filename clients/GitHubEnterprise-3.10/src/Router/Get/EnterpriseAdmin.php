...
final class EnterpriseAdmin
{
    ...
    /** @return */
    public function getSecurityProducts(array $params): EnterpriseSecurityProductsOverview|array
    {
        $matched = true;
        if (array_key_exists(Hydrator\Operation\Enterprise\Stats\SecurityProducts::class, $this->hydrator) === false) {
            $this->hydrator[Hydrator\Operation\Enterprise\Stats\SecurityProducts::class] = $this->hydrators->getObjectMapperOperation🌀Enterprise🌀Stats🌀SecurityProducts();
        }

        $operator = new Operator\EnterpriseAdmin\GetSecurityProducts($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrator[Hydrator\Operation\Enterprise\Stats\SecurityProducts::class]);
    ...
    public function getManageMaintenance(array $params): iterable
    {
        $matched   = true;
        $arguments = [];
        ...
        if (array_key_exists(Hydrator\Operation\Manage\V1\Maintenance::class, $this->hydrator) === false) {
            $this->hydrator[Hydrator\Operation\Manage\V1\Maintenance::class] = $this->hydrators->getObjectMapperOperation🌀Manage🌀V1🌀Maintenance();
        }

        $operator = new Operator\EnterpriseAdmin\GetManageMaintenance($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrator[Hydrator\Operation\Manage\V1\Maintenance::class]);

        return $operator->call($arguments['uuid'], $arguments['cluster_roles']);
    }

    /** @return (Observable<Schema\GhesVersion> | array{code: int}) */
    public function getVersion(array $params): iterable
    {
        $matched   = true;
        $arguments = [];
        if (array_key_exists('uuid', $params) === false) {
        ...
        $arguments['cluster_roles'] = $params['cluster_roles'];
        unset($params['cluster_roles']);
        if (array_key_exists(Hydrator\Operation\Manage\V1\Version::class, $this->hydrator) === false) {
            $this->hydrator[Hydrator\Operation\Manage\V1\Version::class] = $this->hydrators->getObjectMapperOperation🌀Manage🌀V1🌀Version();
        }

        $operator = new Operator\EnterpriseAdmin\GetVersion($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrator[Hydrator\Operation\Manage\V1\Version::class]);
    ...
    public function listProvisionedGroupsEnterprise(array $params): ScimEnterpriseGroupList|array
    {
        ...
        if (array_key_exists(Hydrator\Operation\Scim\V2\Groups::class, $this->hydrator) === false) {
            $this->hydrator[Hydrator\Operation\Scim\V2\Groups::class] = $this->hydrators->getObjectMapperOperation🌀Scim🌀V2🌀Groups();
        }

        $operator = new Operator\EnterpriseAdmin\ListProvisionedGroupsEnterprise($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrator[Hydrator\Operation\Scim\V2\Groups::class]);
    ...
    public function listProvisionedIdentitiesEnterprise(array $params): ScimEnterpriseUserList|array
    {
        ...
        if (array_key_exists(Hydrator\Operation\Scim\V2\Users::class, $this->hydrator) === false) {
            $this->hydrator[Hydrator\Operation\Scim\V2\Users::class] = $this->hydrators->getObjectMapperOperation🌀Scim🌀V2🌀Users();
        }

        $operator = new Operator\EnterpriseAdmin\ListProvisionedIdentitiesEnterprise($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrator[Hydrator\Operation\Scim\V2\Users::class]);
    ...
    public function getConfigNodes(array $params): GhesConfigNodes|array
    {
        $matched   = true;
        $arguments = [];
        if (array_key_exists('uuid', $params) === false) {
    ...
    public function getReplicationStatus(array $params): GhesReplicationStatus|array
    {
        $matched   = true;
        $arguments = [];
        if (array_key_exists('uuid', $params) === false) {
    ...
    public function getProvisioningInformationForEnterpriseGroup(array $params): GroupResponse|array
    {
        ...
        $operator = new Operator\EnterpriseAdmin\GetProvisioningInformationForEnterpriseGroup($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrator[Hydrator\Operation\Scim\V2\Groups\ScimGroupId::class]);
    ...
    public function getProvisioningInformationForEnterpriseUser(array $params): UserResponse|array
    {
        ...
        $operator = new Operator\EnterpriseAdmin\GetProvisioningInformationForEnterpriseUser($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrator[Hydrator\Operation\Scim\V2\Users\ScimUserId::class]);
