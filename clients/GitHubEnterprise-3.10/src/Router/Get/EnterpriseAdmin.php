...
final class EnterpriseAdmin
{
    ...
    {
        $operator = new Operator\EnterpriseAdmin\GetSecurityProducts($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprise🌀Stats🌀SecurityProducts());
    ...
    public function getManageMaintenance(array $params): iterable
    {
        ...
        $operator = new Operator\EnterpriseAdmin\GetManageMaintenance($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Manage🌀V1🌀Maintenance());
    ...
    public function getVersion(array $params): iterable
    {
        ...
        $arguments['cluster_roles'] = $params['cluster_roles'];
        unset($params['cluster_roles']);
        $operator = new Operator\EnterpriseAdmin\GetVersion($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Manage🌀V1🌀Version());
    ...
    public function listProvisionedGroupsEnterprise(array $params): ScimEnterpriseGroupList|array
    {
        ...
        unset($params['count']);
        $operator = new Operator\EnterpriseAdmin\ListProvisionedGroupsEnterprise($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Scim🌀V2🌀Groups());
    ...
    public function listProvisionedIdentitiesEnterprise(array $params): ScimEnterpriseUserList|array
    {
        ...
        $arguments['count'] = $params['count'];
        unset($params['count']);
        $operator = new Operator\EnterpriseAdmin\ListProvisionedIdentitiesEnterprise($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Scim🌀V2🌀Users());
    ...
    public function getConfigNodes(array $params): GhesConfigNodes|array
    {
        ...
        $arguments['cluster_roles'] = $params['cluster_roles'];
        unset($params['cluster_roles']);
        $operator = new Operator\EnterpriseAdmin\GetConfigNodes($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Manage🌀V1🌀Config🌀Nodes());
    ...
    public function getReplicationStatus(array $params): GhesReplicationStatus|array
    {
        ...
        $arguments['cluster_roles'] = $params['cluster_roles'];
        unset($params['cluster_roles']);
        $operator = new Operator\EnterpriseAdmin\GetReplicationStatus($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Manage🌀V1🌀Replication🌀Status());
    ...
    public function getProvisioningInformationForEnterpriseGroup(array $params): GroupResponse|array
    {
        ...
        $arguments['excludedAttributes'] = $params['excludedAttributes'];
        unset($params['excludedAttributes']);
        $operator = new Operator\EnterpriseAdmin\GetProvisioningInformationForEnterpriseGroup($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Scim🌀V2🌀Groups🌀ScimGroupId());
    ...
    public function getProvisioningInformationForEnterpriseUser(array $params): UserResponse|array
    {
        ...
        $operator = new Operator\EnterpriseAdmin\GetProvisioningInformationForEnterpriseUser($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Scim🌀V2🌀Users🌀ScimUserId());
    ...
    public function listLabelsForSelfHostedRunnerForEnterprise(array $params): \ApiClients\Client\GitHubEnterprise\Schema\Operations\EnterpriseAdmin\ListLabelsForSelfHostedRunnerForEnterprise\Response\ApplicationJson\Ok|array
    {
        ...
        $arguments['runner_id'] = $params['runner_id'];
        unset($params['runner_id']);
        $operator = new Operator\EnterpriseAdmin\ListLabelsForSelfHostedRunnerForEnterprise($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀Actions🌀Runners🌀RunnerId🌀Labels());
