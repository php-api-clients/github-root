...
final class EnterpriseAdmin
{
    ...
    public function getSecurityProducts(array $params)
    {
    ...
    public function getManageMaintenance(array $params)
    {
        $arguments = [];
        ...
        $operator = new Operator\EnterpriseAdmin\GetManageMaintenance($this->browser, $this->authentication);
    ...
    public function listProvisionedGroupsEnterprise(array $params)
    {
        $arguments = [];
    ...
    public function listProvisionedIdentitiesEnterprise(array $params)
    {
        $arguments = [];
        if (array_key_exists('filter', $params) === false) {
            throw new InvalidArgumentException('Missing mandatory field: filter');
    ...
    public function getProvisioningInformationForEnterpriseGroup(array $params)
    {
        $arguments = [];
    ...
    public function getProvisioningInformationForEnterpriseUser(array $params)
    {
        $arguments = [];
