...
final class SecretScanning
{
    ...
    public function getSecurityAnalysisSettingsForEnterprise(array $params): EnterpriseSecurityAnalysisSettings|array
    {
        ...
        $operator = new Operator\SecretScanning\GetSecurityAnalysisSettingsForEnterprise($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Enterprises🌀Enterprise🌀CodeSecurityAndAnalysis());
