...
final class EnterpriseAdmin
{
    ...
    public function setManageMaintenance(array $params)
    {
        $operator = new Operator\EnterpriseAdmin\SetManageMaintenance($this->browser, $this->authentication, $this->requestSchemaValidator);

        return $operator->call($params);
    }

    public function provisionEnterpriseGroup(array $params)
    {
    ...
    public function provisionEnterpriseUser(array $params)
    {
