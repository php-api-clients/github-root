...
final class Orgs
{
    ...
    public function reviewPatGrantRequest(array $params): array
    {
        ...
        $operator = new Operator\Orgs\ReviewPatGrantRequest($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀PersonalAccessTokenRequests🌀PatRequestId());
    ...
    public function updatePatAccess(array $params): array
    {
        ...
        unset($params['pat_id']);
        $operator = new Operator\Orgs\UpdatePatAccess($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀PersonalAccessTokens🌀PatId());
    ...
    public function reviewPatGrantRequestsInBulk(array $params): Json|array
    {
        ...
        $arguments['org'] = $params['org'];
        unset($params['org']);
        $operator = new Operator\Orgs\ReviewPatGrantRequestsInBulk($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀PersonalAccessTokenRequests());
    ...
    public function updatePatAccesses(array $params): \ApiClients\Client\GitHubEnterprise\Schema\Operations\Orgs\UpdatePatAccesses\Response\ApplicationJson\Accepted\Application\Json|array
    {
        ...
        $arguments['org'] = $params['org'];
        unset($params['org']);
        $operator = new Operator\Orgs\UpdatePatAccesses($this->browser, $this->authentication, $this->requestSchemaValidator, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org🌀PersonalAccessTokens());
