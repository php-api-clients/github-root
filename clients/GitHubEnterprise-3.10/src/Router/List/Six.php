                        ...
                        if ($pathChunks[4] === 'code-scanning') {
                            ...
                            if ($pathChunks[5] === 'caches') {
                                if ($call === 'LIST /repos/{owner}/{repo}/replicas/caches') {
                                    ...
                                    return $this->router[Router\List\Repos::class]->ListCacheInfoListing($params);
                                }
                            }
