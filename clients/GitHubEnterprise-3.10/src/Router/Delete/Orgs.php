...
final class Orgs
{
    ...
    public function deleteCustomRepoRole(array $params): array
    {
        ...
        $operator = new Operator\Orgs\DeleteCustomRepoRole($this->browser, $this->authentication);
    ...
    public function delete(array $params): Json|array
    {
        ...
        $arguments['org'] = $params['org'];
        unset($params['org']);
        $operator = new Operator\Orgs\Delete($this->browser, $this->authentication, $this->responseSchemaValidator, $this->hydrators->getObjectMapperOperation🌀Orgs🌀Org());
