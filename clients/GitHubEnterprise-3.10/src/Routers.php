...
final class Routers
{
    ...
    private Router\Get\AnnouncementBanners|null $router🔀Get🔀AnnouncementBanners       = null;
    ...
    private Router\Post\SecretScanning|null $router🔀Post🔀SecretScanning               = null;
    ...
    private Router\Delete\AnnouncementBanners|null $router🔀Delete🔀AnnouncementBanners = null;
    ...
    private Router\Patch\AnnouncementBanners|null $router🔀Patch🔀AnnouncementBanners   = null;
    ...
    public function router🔀Get🔀AnnouncementBanners(): Router\Get\AnnouncementBanners
    {
        if ($this->router🔀Get🔀AnnouncementBanners instanceof Router\Get\AnnouncementBanners === false) {
            $this->router🔀Get🔀AnnouncementBanners = new Router\Get\AnnouncementBanners(browser: $this->browser, authentication: $this->authentication, requestSchemaValidator: $this->requestSchemaValidator, responseSchemaValidator: $this->responseSchemaValidator, hydrators: $this->hydrators);
        }

        return $this->router🔀Get🔀AnnouncementBanners;
    }
    ...
    public function router🔀Post🔀SecretScanning(): Router\Post\SecretScanning
    {
        if ($this->router🔀Post🔀SecretScanning instanceof Router\Post\SecretScanning === false) {
            $this->router🔀Post🔀SecretScanning = new Router\Post\SecretScanning(browser: $this->browser, authentication: $this->authentication, requestSchemaValidator: $this->requestSchemaValidator, responseSchemaValidator: $this->responseSchemaValidator, hydrators: $this->hydrators);
        }

        return $this->router🔀Post🔀SecretScanning;
    }
    ...
    public function router🔀Delete🔀AnnouncementBanners(): Router\Delete\AnnouncementBanners
    {
        if ($this->router🔀Delete🔀AnnouncementBanners instanceof Router\Delete\AnnouncementBanners === false) {
            $this->router🔀Delete🔀AnnouncementBanners = new Router\Delete\AnnouncementBanners(browser: $this->browser, authentication: $this->authentication, requestSchemaValidator: $this->requestSchemaValidator, responseSchemaValidator: $this->responseSchemaValidator, hydrators: $this->hydrators);
        }

        return $this->router🔀Delete🔀AnnouncementBanners;
    }
    ...
    public function router🔀Patch🔀AnnouncementBanners(): Router\Patch\AnnouncementBanners
    {
        if ($this->router🔀Patch🔀AnnouncementBanners instanceof Router\Patch\AnnouncementBanners === false) {
            $this->router🔀Patch🔀AnnouncementBanners = new Router\Patch\AnnouncementBanners(browser: $this->browser, authentication: $this->authentication, requestSchemaValidator: $this->requestSchemaValidator, responseSchemaValidator: $this->responseSchemaValidator, hydrators: $this->hydrators);
        }

        return $this->router🔀Patch🔀AnnouncementBanners;
    }
